...
declare namespace gapi.client {
    ...
    namespace gameservices {
        ...
        interface KubernetesClusterState {
            ...
            /**
             * Output only. The cloud provider type reported by the first node's providerID in the list of nodes on the Kubernetes endpoint. On Kubernetes platforms that support zero-node clusters
             * (like GKE-on-GCP), the provider type will be empty.
             */
            provider?: string;
        ...
        interface GameServerClustersResource {
            ...
            get(request?: {
                 ...
                 * the state of the referenced Kubernetes cluster such as versions and provider info. The default/unset value is GAME_SERVER_CLUSTER_VIEW_UNSPECIFIED, same as BASIC, which does not
