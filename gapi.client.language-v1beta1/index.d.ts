/* Type definitions for non-npm package Cloud Natural Language API v1beta1 0.0 */
...
// Generated from: https://language.googleapis.com/$discovery/rest?version=v1beta1
// Revision: 20220813

/// <reference types="gapi.client" />

declare namespace gapi.client {
    /** Load Cloud Natural Language API v1beta1 */
    function load(urlOrObject: "https://language.googleapis.com/$discovery/rest?version=v1beta1"): Promise<void>;
    /** @deprecated Please load APIs with discovery documents. */
    function load(name: "language", version: "v1beta1"): Promise<void>;
    /** @deprecated Please load APIs with discovery documents. */
    function load(name: "language", version: "v1beta1", callback: () => any): void;
