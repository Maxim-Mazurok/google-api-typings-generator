...
declare namespace gapi.client {
    ...
    function load(name: "clouddeploy", version: "v1"): PromiseLike<void>;
    ...
    namespace clouddeploy {
        ...
        interface DeliveryPipeline {
            ...
            etag?: string;
            /**
             * Labels are attributes that can be set and used by both the user and by Google Cloud Deploy. Labels must meet the following constraints: Each resource is limited to 64 labels. Keys
             * must conform to the regexp: `a-zA-Z{0,62}`. Values must conform to the regexp: `[a-zA-Z0-9_-]{0,63}`. Both keys and values are additionally constrained to be <= 128 bytes in size.
             */
        ...
        interface Stage {
             ...
             * `projects/project/deliveryPipelines/pipeline/targets/my-target`). The parent `DeliveryPipeline` of the `Target` is inferred to be the parent `DeliveryPipeline` of the `Release` in
        ...
        interface Target {
            ...
            gke?: GkeCluster;
            /**
             * Optional. Labels are attributes that can be set and used by both the user and by Google Cloud Deploy. Labels must meet the following constraints: Each resource is limited to 64
             * labels. Keys must conform to the regexp: `a-zA-Z{0,62}`. Values must conform to the regexp: `[a-zA-Z0-9_-]{0,63}`. Both keys and values are additionally constrained to be <= 128
             * bytes in size.
             */
            labels?: { [P in string]: string };
