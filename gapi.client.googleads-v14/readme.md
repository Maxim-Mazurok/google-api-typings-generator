...
```
npm install @types/gapi.client.googleads-v14 --save-dev
```
...
```typescript
gapi.client.load('https://googleads.googleapis.com/$discovery/rest?version=v14', () => {
  // now we can use:
...
gapi.client.load('googleads', 'v14', () => {
  // now we can use:
  // gapi.client.googleads
});
```
