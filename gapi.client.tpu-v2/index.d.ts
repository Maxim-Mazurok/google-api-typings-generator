...
declare namespace gapi.client {
  ...
  /** @deprecated Please load APIs with discovery documents. */
  function load(name: 'tpu', version: 'v2', callback: () => any): void;
  ...
  namespace tpu {
    ...
    interface ListQueuedResourcesResponse {
      /** The next page token or empty if none. */
      nextPageToken?: string;
    ...
    interface ResetQueuedResourceRequest {}
    ...
    interface UpcomingMaintenance {
      ...
      maintenanceStatus?: 'UNKNOWN' | 'PENDING' | 'ONGOING';
      /** Defines the type of maintenance. */
      type?: 'UNKNOWN_TYPE' | 'SCHEDULED' | 'UNSCHEDULED';
    ...
    interface QueuedResourcesResource {
      ...
      list(request?: {
        ...
        /** Legacy upload protocol for media (e.g. "media", "multipart"). */
        uploadType?: string;
      }): Request<ListQueuedResourcesResponse>;
      ...
      reset(request: {
        ...
        uploadType?: string;
        /** Request body */
        resource: ResetQueuedResourceRequest;
      }): Request<Operation>;
      reset(
        request: {
          /** V1 error format. */
    ...
    interface LocationsResource {
      ...
      queuedResources: QueuedResourcesResource;
