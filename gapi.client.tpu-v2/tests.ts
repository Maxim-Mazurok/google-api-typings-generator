...
gapi.load('client', async () => {
  ...
  async function run() {
    ...
    await gapi.client.tpu.projects.locations.queuedResources.create(
      {
        parent: 'Test string',
        queuedResourceId: 'Test string',
      ...
      },
      {
        ...
        name: 'Test string',
        queueingPolicy: {
          validAfterDuration: 'Test string',
          validAfterTime: 'Test string',
          validInterval: {
            endTime: 'Test string',
            startTime: 'Test string',
          },
          validUntilDuration: 'Test string',
    ...
    await gapi.client.tpu.projects.locations.queuedResources.get({
      name: 'Test string',
    });
    /** Lists queued resources. */
    await gapi.client.tpu.projects.locations.queuedResources.list({
      pageSize: 42,
      pageToken: 'Test string',
      parent: 'Test string',
    });
