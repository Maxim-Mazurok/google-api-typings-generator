...
declare namespace gapi.client {
  ...
  namespace metastore {
    ...
    interface BigLakeMetastoreMigrationConfig {
      ...
      mode?: 'MIGRATION_MODE_UNSPECIFIED' | 'BACKFILL';
    ...
    interface CatalogReport {
      ...
      catalog?: string;
      /** The type of catalog. */
      catalogType?: 'CATALOG_TYPE_UNSPECIFIED' | 'HIVE' | 'ICEBERG';
      /** A map of database names to their respective reports. */
      databaseReports?: {[P in string]: DatabaseReport};
    }
    ...
    interface DatabaseReport {
      ...
      tableReports?: {[P in string]: TableReport};
    }
    interface DatabaseSummary {
      ...
      resultStatus?: 'STATE_UNSPECIFIED' | 'SUCCEEDED' | 'FAILED' | 'SKIPPED';
    ...
    interface MigrationExecution {
      ...
      phase?: 'PHASE_UNSPECIFIED' | 'REPLICATION' | 'CUTOVER';
    ...
    interface TableSummary {
      ...
      resultCounts?: {[P in string]: string};
    }
