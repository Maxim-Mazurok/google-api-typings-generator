...
{
  "compilerOptions": {
    "types": ["gapi", "gapi.auth2", "gapi.client", "gapi.client.ids-v1"]
  }
}
```
...
```typescript
gapi.client.load(
  'https://ids.googleapis.com/$discovery/rest?version=v1',
  () => {
    // now we can use:
    // gapi.client.ids
  },
...
After that you can use Cloud IDS API resources: <!-- TODO: make this work for multiple namespaces -->

```typescript

```

For provenance information see [Provenance section on NPM](https://www.npmjs.com/package/@maxim_mazurok/gapi.client.ids-v1#Provenance:~:text=none-,Provenance,-Built%20and%20signed)
