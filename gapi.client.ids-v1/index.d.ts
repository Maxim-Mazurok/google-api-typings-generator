...
declare namespace gapi.client {
    ...
    function load(urlOrObject: "https://ids.googleapis.com/$discovery/rest?version=v1"): Promise<void>;
    /** @deprecated Please load APIs with discovery documents. */
    function load(name: "ids", version: "v1"): Promise<void>;
    /** @deprecated Please load APIs with discovery documents. */
    ...
    namespace ids {
        ...
        interface EndpointsResource {
            ...
            patch(request: {
                ...
                requestId?: string;
                /**
                 * Field mask is used to specify the fields to be overwritten in the Endpoint resource by the update. The fields specified in the update_mask are relative to the resource, not the
