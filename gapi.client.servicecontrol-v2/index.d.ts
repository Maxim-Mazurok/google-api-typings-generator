...
declare namespace gapi.client {
    ...
    function load(urlOrObject: "https://servicecontrol.googleapis.com/$discovery/rest?version=v2"): Promise<void>;
    ...
    namespace servicecontrol {
        ...
        interface ResourceInfo {
             ...
             * `organizations/` Required for the policy enforcement on the container level (e.g. VPCSC, Location Policy check, Org Policy check).
             */
            container?:
                string;
