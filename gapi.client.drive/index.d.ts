    ...
    namespace drive {
        ...
        interface File {
            ...
            capabilities?: {
                ...
                /**
                 * Whether the current user can move this item within this shared drive. Note that a request to change the parent of the item may still fail depending on the new parent that is
                 * being added. Only populated for items in shared drives.
                 */
