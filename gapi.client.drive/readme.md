...
*/
await gapi.client.drives.create({ requestId: "requestId",  }); 
    
/* 
Permanently deletes a shared drive for which the user is an organizer. The shared drive cannot contain any untrashed items.  
*/
await gapi.client.drives.delete({ driveId: "driveId",  }); 
    
/* 
Gets a shared drive's metadata by ID.  
*/
await gapi.client.drives.get({ driveId: "driveId",  }); 
    
/* 
Hides a shared drive from the default view.  
*/
await gapi.client.drives.hide({ driveId: "driveId",  }); 
    
/* 
Lists the user's shared drives.  
*/
await gapi.client.drives.list({  }); 
    
/* 
Restores a shared drive to the default view.  
*/
await gapi.client.drives.unhide({ driveId: "driveId",  }); 
    
/* 
Updates the metadate for a shared drive.  
*/
await gapi.client.drives.update({ driveId: "driveId",  }); 
