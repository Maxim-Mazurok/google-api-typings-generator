...
declare namespace gapi.client {
    ...
    namespace cloudasset {
        ...
        interface ResourceSearchResult {
             ...
             * resource's proto contains it. To search against `create_time`: * use a field query (value in seconds). Example: `createTime >= 1594294238`
             */
            createTime?: string;
            /**
             ...
             * `folders`: * use a field query. Example: `folders:(123 OR 456)` * specify the `scope` field as this folder in your search request.
             */
            folders?: string[];
            /**
             ...
             * against `organization`: * use a field query. Example: `organization:123` * specify the `scope` field as this organization in your search request.
             */
            organization?: string;
            /**
             ...
             * use a field query. Example: `project:12345` * specify the `scope` field as this project in your search request.
             */
            project?: string;
            /**
             ...
             * available only when the resource's proto contains it. To search against `update_time`: * use a field query (value in seconds). Example: `updateTime < 1594294238`
             */
            updateTime?: string;
        }
        ...
        interface V1Resource {
            ...
            searchAllResources(request?: {
                 ...
                 * to find Cloud resources whose state contains "ACTIVE" as a word. * `createTime<1609459200` to find Cloud resources that were created before "2021-01-01 00:00:00 UTC". 1609459200
                 * is the epoch timestamp of "2021-01-01 00:00:00 UTC" in seconds. * `updateTime>1609459200` to find Cloud resources that were updated after "2021-01-01 00:00:00 UTC". 1609459200
                 * is the epoch timestamp of "2021-01-01 00:00:00 UTC" in seconds. * `Important` to find Cloud resources that contain "Important" as a word in any of the searchable fields. *
                 * `Impor*` to find Cloud resources that contain "Impor" as a prefix of any word in any of the searchable fields. * `Important location:(us-west1 OR global)` to find Cloud
                 * resources that contain "Important" as a word in any of the searchable fields and are also located in the "us-west1" region or the "global" location.
                 */
                query?: string;
                /** Available to use for quota purposes for server-side applications. Can be any arbitrary string assigned to a user, but should not exceed 40 characters. */
                quotaUser?: string;
