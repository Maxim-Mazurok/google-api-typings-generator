    ...
    namespace cloudasset {
        ...
        interface AssetsResource {
            ...
            list(request?: {
                ...
                pageToken?: string;
                /**
                 * Required. Name of the organization or project the assets belong to. Format: "organizations/[organization-number]" (such as "organizations/123"), "projects/[project-number]"
                 * (such as "projects/my-project-id"), or "projects/[project-id]" (such as "projects/12345").
                 */
                parent: string;
