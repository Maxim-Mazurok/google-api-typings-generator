...
declare namespace gapi.client {
    ...
    namespace cloudasset {
        ...
        interface ResourceSearchResult {
            ...
            state?: string;
            /**
             * TagKey namespaced names, in the format of {ORG_ID}/{TAG_KEY_SHORT_NAME}. To search against the `tagKeys`: * use a field query. Example: - `tagKeys:"123456789/e*"` -
             ...
             * `tagValues:"env"` - `tagValues:"env/prod"` - `tagValues:"123456789/env/pr*"` - `tagValues="123456789/env/prod"` * use a free text query. Example: - `prod`
             */
            tagValues?: string[];
            /**
