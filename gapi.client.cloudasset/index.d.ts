...
declare namespace gapi.client {
    ...
    namespace cloudasset {
        ...
        interface ResourceSearchResult {
             ...
             */
            relationships?: { [P in string]: RelatedResources };
            /**
        ...
        interface EffectiveIamPoliciesResource {
            ...
            batchGet(request?: {
                ...
                /** Legacy upload protocol for media (e.g. "media", "multipart"). */
                uploadType?: string;
            }): Request<BatchGetEffectiveIamPoliciesResponse>;
        }
        ...
        interface SavedQueriesResource {
            ...
            delete(request?: {
                ...
                key?: string;
                /**
                 * Required. The name of the saved query to delete. It must be in the format of: * projects/project_number/savedQueries/saved_query_id *
                 * folders/folder_number/savedQueries/saved_query_id * organizations/organization_number/savedQueries/saved_query_id
                 */
                name: string;
                /** OAuth 2.0 token for the current user. */
                oauth_token?: string;
            ...
            get(request?: {
                ...
                key?: string;
                /**
                 * Required. The name of the saved query and it must be in the format of: * projects/project_number/savedQueries/saved_query_id * folders/folder_number/savedQueries/saved_query_id
                 * * organizations/organization_number/savedQueries/saved_query_id
                 */
                name: string;
                /** OAuth 2.0 token for the current user. */
        ...
        interface V1Resource {
            ...
            searchAllResources(request?: {
                 ...
                 * to find Cloud resources whose state contains "ACTIVE" as a word. * `NOT state:ACTIVE` to find Cloud resources whose state doesn't contain "ACTIVE" as a word. *
                 ...
                 * not limited to (both snake_case and camelCase are supported): * name * assetType * project * displayName * description * location * labels * networkTags * kmsKey * createTime *
                 * updateTime * state * additionalAttributes * versionedResources If read_mask is not specified, all fields except versionedResources will be returned. If only '*' is specified,
                 * all fields including versionedResources will be returned. Any invalid field path will trigger INVALID_ARGUMENT error.
                 */
                readMask?: string;
                /**
        ...
        const effectiveIamPolicies: EffectiveIamPoliciesResource;

        const feeds: FeedsResource;

        const operations: OperationsResource;

        const savedQueries: SavedQueriesResource;
