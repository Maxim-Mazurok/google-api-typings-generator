...
declare namespace gapi.client {
    ...
    namespace cloudasset {
        ...
        interface IamPolicySearchResult {
            ...
            project?: string;
            /**
             * The full resource name of the resource associated with this IAM policy. For
             * example:
             * `//compute.googleapis.com/projects/my_project_123/zones/zone1/instances/instance1`.
        ...
        interface ResourceSearchResult {
             ...
             * one resource type to another. For example: "projectId" for Project,
            ...
            location?: string;
            /**
             * The full resource name of this resource. For example:
             * `//compute.googleapis.com/projects/my_project_123/zones/zone1/instances/instance1`.
             * See [Cloud Asset Inventory Resource Name
             * Format](https://cloud.google.com/asset-inventory/docs/resource-name-format)
             * for more information.
        ...
        interface V1Resource {
            ...
            searchAllIamPolicies(request?: {
                 ...
                 * An empty query can be specified to search all the IAM policies within the
                 * given `scope`. See [how to construct a
                 ...
                 * limited to the IAM policies within the `scope`. The allowed values are:
            ...
            searchAllResources(request?: {
                 ...
                 * search all the [supported asset
                 * types](https://cloud.google.com/asset-inventory/docs/supported-asset-types).
                 */
                 ...
                 * example, "location, name desc". See [supported resource metadata
                 ...
                 * "por" as a sub string of a word.
                 * &#42; "Important": to find Cloud resources which contain "Important" as a word
                 * in any of the searchable fields.
                 * An empty query can be specified to search all the resources of certain
                 * `asset_types` within the given `scope`. See [how to construct a
