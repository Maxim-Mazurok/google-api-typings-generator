...
gapi.load('client', async () => {
  ...
  async function run() {
    ...
    await gapi.client.cloudbilling.tasks.cancel(
      {
        name: 'Test string',
      },
      {
    ...
    await gapi.client.cloudbilling.tasks.get({
      historyLength: 42,
      name: 'Test string',
      tenant: 'Test string',
    });
    ...
    await gapi.client.cloudbilling.tasks.subscribe({
      name: 'Test string',
      tenant: 'Test string',
    });
    /** Set a push notification config for a task. */
    await gapi.client.cloudbilling.tasks.pushNotificationConfigs.create(
      {
    ...
    await gapi.client.cloudbilling.tasks.pushNotificationConfigs.delete({
      name: 'Test string',
      tenant: 'Test string',
    });
    /** Get a push notification config for a task. */
    await gapi.client.cloudbilling.tasks.pushNotificationConfigs.get({
      name: 'Test string',
      tenant: 'Test string',
    });
    /** Get a list of push notifications configured for a task. */
    await gapi.client.cloudbilling.tasks.pushNotificationConfigs.list({
      pageSize: 42,
      pageToken: 'Test string',
      parent: 'Test string',
      tenant: 'Test string',
    ...
    await gapi.client.cloudbilling.v1.getCard({
      tenant: 'Test string',
    });
  }
});
