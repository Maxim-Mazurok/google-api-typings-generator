...
declare namespace gapi.client {
    ...
    namespace orgpolicy {
        ...
        interface GoogleCloudOrgpolicyV2CustomConstraint {
             ...
             * Example : "organizations/123/customConstraints/custom.createOnlyE2TypeVms" The max length is 100 characters and the min length is 1. Note that the prefix
        ...
        interface CustomConstraintsResource {
            ...
            list(request?: {
                ...
                pageToken?: string;
                /**
                 * Required. The target Cloud resource that parents the set of custom constraints that will be returned from this call. Must be in one of the following forms: *
                 * `organizations/{organization_id}`
                 */
                parent: string;
                /** Returns response with indentations and line breaks. */
            ...
            patch(request: {
                 ...
                 * `organizations/{organization_id}/customConstraints/{custom_constraint_id}` Example : "organizations/123/customConstraints/custom.createOnlyE2TypeVms" The max length is 100
                 * characters and the min length is 1. Note that the prefix "organizations/{organization_id}/customConstraints/" is not counted.
                 */
                name: string;
                /** OAuth 2.0 token for the current user. */
                oauth_token?: string;
