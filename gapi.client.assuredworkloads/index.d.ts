...
declare namespace gapi.client {
    ...
    namespace assuredworkloads {
        ...
        interface GoogleCloudAssuredworkloadsV1beta1Workload {
            ...
            /**
             * Optional. The resource name of the workload. Format: organizations/{organization}/locations/{location}/workloads/{workload} Read-only. The UI extracts the location and workload name
             * from this string, since they aren't set directly on the workload object. If the format of this field changes, the UI should likely be updated. LINT.IfChange
        ...
        interface WorkloadsResource {
            ...
            patch(request: {
                ...
                key?: string;
                /**
                 * Optional. The resource name of the workload. Format: organizations/{organization}/locations/{location}/workloads/{workload} Read-only. The UI extracts the location and workload
                 * name from this string, since they aren't set directly on the workload object. If the format of this field changes, the UI should likely be updated. LINT.IfChange
                 * LINT.ThenChange(//depot/google3/cloud/console/web/compliance/assurant/common/workload_helper.ts)
                 */
                name: string;
                /** OAuth 2.0 token for the current user. */
