...
declare namespace gapi.client {
    ...
    namespace assuredworkloads {
        ...
        interface GoogleCloudAssuredworkloadsVersioningV1mainWorkload {
            ...
            complianceStatus?: GoogleCloudAssuredworkloadsVersioningV1mainWorkloadComplianceStatus;
            /** Output only. Immutable. The Workload creation timestamp. */
            createTime?: string;
            /**
             * Required. The user-assigned display name of the Workload. When present it must be between 4 to 30 characters. Allowed characters are: lowercase and uppercase letters, numbers,
        ...
        interface GoogleCloudAssuredworkloadsVersioningV1mainWorkloadComplianceStatus {
