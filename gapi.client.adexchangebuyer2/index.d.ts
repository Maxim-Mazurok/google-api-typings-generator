...
declare namespace gapi.client {
    ...
    namespace adexchangebuyer2 {
        ...
        interface FinalizedProposalsResource {
             ...
             * this method only applies to PG and PD deals. For PA deals, please call accounts.proposals.resume endpoint. It is a no-op to resume already-running deals. It is an error to call
             * ResumeProposalDeals for deals which are not part of the proposal of proposal_id or which are not finalized or renegotiating.
             */
            resume(request: {
                /** V1 error format. */
                "$.xgafv"?: string;
