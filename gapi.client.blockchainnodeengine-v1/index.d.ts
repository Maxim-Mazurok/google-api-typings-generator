...
declare namespace gapi.client {
    ...
    namespace blockchainnodeengine {
        ...
        interface PolygonEndpoints {
            /** Output only. The assigned URL for the node's block producer client's Prometheus metrics endpoint. */
            blockProducerClientMetricsApiEndpoint?:
                string;
        }
        interface Status {
