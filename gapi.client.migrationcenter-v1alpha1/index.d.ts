...
declare namespace gapi.client {
  ...
  namespace migrationcenter {
    ...
    interface AwsApplicationLoadBalancerDetails {}
    interface AwsAppSyncGraphqlApiDetails {}
    interface AwsAthenaWorkGroupDetails {}
    interface AwsAutoscalingGroupDetails {}
    interface AwsBatchComputeEnvironmentDetails {}
    interface AwsCloudFrontDistributionDetails {}
    interface AwsDynamoDBTableDetails {}
    interface AwsEbsVolumeDetails {}
    ...
    interface AwsElastiCacheClusterDetails {}
    interface AwsElasticIpAddressDetails {}
    interface AwsElasticNetworkInterfaceDetails {}
    interface AwsElbLoadBalancerDetails {}
    interface AwsEmrClusterDetails {}
    interface AwsFirehoseDetails {}
    interface AwsGlueJobDetails {}
    interface AwsInternetGatewayDetails {}
    ...
    interface DatabaseInstance {
      ...
      role?: 'ROLE_UNSPECIFIED' | 'PRIMARY' | 'SECONDARY' | 'ARBITER';
    }
    ...
    interface IssueCompatibilityIssue {
      ...
      category?: 'CATEGORY_UNSPECIFIED' | 'DATABASE_FLAG' | 'DATABASE_FEATURE';
    }
    ...
    interface ReportSummaryAssetAggregateStatsEstimatedUsageStats {
    ...
    interface SignedUriDestination {
      ...
      fileFormat?: 'FILE_FORMAT_UNSPECIFIED' | 'CSV' | 'XLSX';
    }
