/* Type definitions for non-npm package On-Demand Scanning API v1 0.0 */
...
declare namespace gapi.client {
    ...
    function load(urlOrObject: "https://ondemandscanning.googleapis.com/$discovery/rest?version=v1"): Promise<void>;
    /** @deprecated Please load APIs with discovery documents. */
    function load(name: "ondemandscanning", version: "v1"): Promise<void>;
    /** @deprecated Please load APIs with discovery documents. */
