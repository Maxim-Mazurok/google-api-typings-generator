...
declare namespace gapi.client {
    ...
    namespace dataplex {
        ...
        interface GoogleCloudDataplexV1TaskNotebookTaskConfig {
            ...
            /**
             * Required. Path to input notebook. This can be the GCS URI of the notebook file or the path to a Notebook Content. The execution args are accessible as environment variables
             * (TASK_key=value).
             */
            notebook?: string;
        }
