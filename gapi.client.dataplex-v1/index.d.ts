...
declare namespace gapi.client {
  ...
  namespace dataplex {
    interface CloudReliabilityZicyWs3DataplaneProtosAssetLocation {
      ...
      expected?: CloudReliabilityZicyWs3DataplaneProtosAssetLocationIsolationExpectations;
      /** Defines extra parameters required for specific asset types. */
      extraParameters?: CloudReliabilityZicyWs3DataplaneProtosExtraParameter[];
      /** Contains all kinds of physical location definitions for this asset. */
      locationData?: CloudReliabilityZicyWs3DataplaneProtosLocationData[];
      /** Defines parents assets if any in order to allow later generation of child_asset_location data via child assets. */
      parentAsset?: CloudReliabilityZicyWs3DataplaneProtosCloudAsset[];
    }
    interface CloudReliabilityZicyWs3DataplaneProtosAssetLocationIsolationExpectations {
      ...
      requirementOverride?: CloudReliabilityZicyWs3DataplaneProtosAssetLocationIsolationExpectationsRequirementOverride;
      ziOrgPolicy?: string;
    ...
    interface CloudReliabilityZicyWs3DataplaneProtosAssetLocationIsolationExpectationsRequirementOverride {
      ziOverride?: string;
      zsOverride?: string;
    }
    interface CloudReliabilityZicyWs3DataplaneProtosBlobstoreLocation {
      policyId?: string[];
    }
    interface CloudReliabilityZicyWs3DataplaneProtosCloudAsset {
      assetName?: string;
      assetType?: string;
    }
    interface CloudReliabilityZicyWs3DataplaneProtosCloudAssetComposition {
      childAsset?: CloudReliabilityZicyWs3DataplaneProtosCloudAsset[];
    }
    interface CloudReliabilityZicyWs3DataplaneProtosDirectLocationAssignment {
      location?: CloudReliabilityZicyWs3DataplaneProtosLocationAssignment[];
    }
    interface CloudReliabilityZicyWs3DataplaneProtosExtraParameter {
      /** Details about zones used by regional compute.googleapis.com/InstanceGroupManager to create instances. */
      regionalMigDistributionPolicy?: CloudReliabilityZicyWs3DataplaneProtosRegionalMigDistributionPolicy;
    }
    interface CloudReliabilityZicyWs3DataplaneProtosLocationAssignment {
      location?: string;
      locationType?: string;
    }
    interface CloudReliabilityZicyWs3DataplaneProtosLocationData {
      blobstoreLocation?: CloudReliabilityZicyWs3DataplaneProtosBlobstoreLocation;
      childAssetLocation?: CloudReliabilityZicyWs3DataplaneProtosCloudAssetComposition;
      directLocation?: CloudReliabilityZicyWs3DataplaneProtosDirectLocationAssignment;
      gcpProjectProxy?: CloudReliabilityZicyWs3DataplaneProtosTenantProjectProxy;
      placerLocation?: CloudReliabilityZicyWs3DataplaneProtosPlacerLocation;
      spannerLocation?: CloudReliabilityZicyWs3DataplaneProtosSpannerLocation;
    }
    interface CloudReliabilityZicyWs3DataplaneProtosPlacerLocation {
      /** Directory with a config related to it in placer (e.g. "/placer/prod/home/my-root/my-dir") */
      placerConfig?: string;
    }
    interface CloudReliabilityZicyWs3DataplaneProtosRegionalMigDistributionPolicy {
      /** The shape in which the group converges around distribution of resources. Instance of proto2 enum */
      targetShape?: number;
      /** Cloud zones used by regional MIG to create instances. */
      zones?: CloudReliabilityZicyWs3DataplaneProtosZoneConfiguration[];
    }
    interface CloudReliabilityZicyWs3DataplaneProtosSpannerLocation {
    ...
    interface CloudReliabilityZicyWs3DataplaneProtosTenantProjectProxy {
      projectNumbers?: string[];
    }
    interface CloudReliabilityZicyWs3DataplaneProtosZoneConfiguration {
      zone?: string;
    }
    interface Empty {}
