...
declare namespace gapi.client {
    ...
    namespace dataplex {
        ...
        interface GoogleCloudDataplexV1DataProfileResultProfileFieldProfileInfo {
            ...
            /**
             * The array of top N values of the field in the sampled data. Currently N is set as 10 or equal to distinct values in the field, whichever is smaller. This will be optional for
             * complex non-groupable data-types such as JSON, ARRAY, JSON, STRUCT.
             */
        ...
        interface GoogleCloudDataplexV1DataProfileResultProfileFieldProfileInfoDoubleFieldInfo {
            ...
            min?: number;
            /**
             * A quartile divide the numebr of data points into four parts, or quarters, of more-or-less equal size. Three main quartiles used are: The first quartile (Q1) splits off the lowest
             ...
             * as 75% of the data lies below this point. So, here the quartiles is provided as an ordered list of quartile values, occurring in order Q1, median, Q3.
             */
            quartiles?: number[];
        ...
        interface GoogleCloudDataplexV1DataProfileResultProfileFieldProfileInfoIntegerFieldInfo {
            ...
            min?: string;
            /**
             * A quartile divide the number of data points into four parts, or quarters, of more-or-less equal size. Three main quartiles used are: The first quartile (Q1) splits off the lowest
             * 25% of data from the highest 75%. It is also known as the lower or 25th empirical quartile, as 25% of the data is below this point. The second quartile (Q2) is the median of a data
             * set. So, 50% of the data lies below this point. The third quartile (Q3) splits off the highest 25% of data from the lowest 75%. It is known as the upper or 75th empirical quartile,
             * as 75% of the data lies below this point. So, here the quartiles is provided as an ordered list of quartile values, occurring in order Q1, median, Q3.
             */
        ...
        interface GoogleCloudDataplexV1DataQualityRuleResult {
            /**
             * The number of rows a rule was evaluated against. This field is only valid for ColumnMap type rules. Evaluated count can be configured to either (1) include all rows (default) - with
             * null rows automatically failing rule evaluation OR (2) exclude null rows from the evaluated_count, by setting ignore_nulls = true
             */
        ...
        interface GoogleCloudDataplexV1DataScanExecutionSpec {
            ...
            field?: string;
            /**
             * Optional. Spec related to how often and when a scan should be triggered. If not specified, the default is OnDemand, which means the scan will not run until the user calls
             * RunDataScan API.
             */
        ...
        interface GoogleCloudDataplexV1DataScanJob {
            ...
            message?: string;
            /**
             * Output only. The relative resource name of the DataScanJob, of the form: projects/{project}/locations/{location_id}/dataScans/{datascan_id}/jobs/{job_id}. where {project} refers to
        ...
        interface GoogleCloudDataplexV1TriggerSchedule {
            /**
             * Required. Cron schedule (https://en.wikipedia.org/wiki/Cron) for running scans periodically. To explicitly set a timezone to the cron tab, apply a prefix in the cron tab:
             * "CRON_TZ=${IANA_TIME_ZONE}" or "TZ=${IANA_TIME_ZONE}". The ${IANA_TIME_ZONE} may only be a valid string from IANA time zone database. For example, "CRON_TZ=America/New_York 1 * * *
             * *", or "TZ=America/New_York 1 * * * *". This field is required for Schedule scans.
             */
            cron?: string;
        }
        ...
        interface JobsResource {
            ...
            list(request?: {
                ...
                pageToken?: string;
                /**
                 * Required. The resource name of the parent environment: projects/{project}/locations/{location_id}/dataScans/{data_scan_id} where {project} refers to a project_id or
                 * project_number and location_id refers to a GCP region.
                 */
                parent: string;
                /** Returns response with indentations and line breaks. */
        ...
        interface DataScansResource {
            ...
            create(request: {
                ...
                callback?: string;
                /**
                 * Required. DataScan identifier. * Must contain only lowercase letters, numbers and hyphens. * Must start with a letter. * Must end with a number or a letter. * Must be between
                ...
                oauth_token?: string;
                /**
                 * Required. The resource name of the parent location: projects/{project}/locations/{location_id} where {project} refers to a project_id or project_number and location_id refers to
                 * a GCP region.
                 */
                parent: string;
                /** Returns response with indentations and line breaks. */
            ...
            run(request: {
                ...
                /**
                 * Required. The resource name of the DataScan: projects/{project}/locations/{location_id}/dataScans/{data_scan_id}. where {project} refers to a project_id or project_number and
                 * location_id refers to a GCP region. Only on-demand DataScans are allowed.
                 */
                name: string;
                /** OAuth 2.0 token for the current user. */
                oauth_token?: string;
