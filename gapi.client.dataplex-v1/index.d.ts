...
declare namespace gapi.client {
  ...
  namespace dataplex {
    ...
    interface GoogleCloudDataplexV1MetadataJobEvent {
      /** Import job results. Should only be populated on terminal states. */
      importResult?: GoogleCloudDataplexV1MetadataJobEventImportResult;
      /** Message describing failure or success event. */
      message?: string;
      /** The resource name associated with the event. Supported resources included, but not limited to EntryGroup, MetadataJob, and Entry. */
      resource?: string;
    }
    interface GoogleCloudDataplexV1MetadataJobEventImportResult {
