...
declare namespace gapi.client {
  ...
  namespace dataplex {
    ...
    interface GoogleCloudDataplexV1Entry {
      ...
      entryType?: string;
      /** Optional. A name for the entry that can be referenced by an external system. The maximum size of the field is 4000 characters. */
    ...
    interface GoogleCloudDataplexV1MetadataJob {
      ...
      labels?: {[P in string]: string};
      /** Output only. The name of the resource that the configuration is applied to, in the format projects/{project_number}/locations/{location_id}/metadataJobs/{metadata_job_id}. */
      name?: string;
