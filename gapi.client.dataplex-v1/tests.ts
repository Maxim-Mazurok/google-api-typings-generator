...
gapi.load('client', async () => {
  ...
  async function run() {
    ...
    await gapi.client.dataplex.projects.locations.lookupContext(
      {
        name: 'Test string',
      },
      {
    ...
    await gapi.client.dataplex.projects.locations.lookupEntryLinks({
      entry: 'Test string',
      entryLinkTypes: 'Test string',
      entryMode: 'Test string',
      name: 'Test string',
      pageSize: 42,
      pageToken: 'Test string',
    });
    /** Modifies an entry using the permission on the source system. */
    await gapi.client.dataplex.projects.locations.modifyEntry(
      {
        name: 'Test string',
      },
      {
    ...
    await gapi.client.dataplex.projects.locations.changeRequests.approve(
      {
        name: 'Test string',
      },
      {
    ...
    await gapi.client.dataplex.projects.locations.changeRequests.delete({
      etag: 'Test string',
      name: 'Test string',
    });
    /** Gets a ChangeRequest. */
    await gapi.client.dataplex.projects.locations.changeRequests.get({
      name: 'Test string',
    });
    /** Gets the access control policy for a resource. Returns an empty policy if the resource exists and does not have a policy set. */
    ...
    await gapi.client.dataplex.projects.locations.changeRequests.list({
      filter: 'Test string',
      orderBy: 'Test string',
      pageSize: 42,
      pageToken: 'Test string',
    ...
    await gapi.client.dataplex.projects.locations.changeRequests.patch(
      {
        name: 'Test string',
        updateMask: 'Test string',
      },
      {
        approver: 'Test string',
        author: 'Test string',
        ...
        dataProductAccessRequest: {
          accessGroupDisplayName: 'Test string',
          accessGroupId: 'Test string',
          parent: 'Test string',
          requestedPrincipal: 'Test string',
        },
        deleteEntry: {
          name: 'Test string',
        },
        ...
        name: 'Test string',
        rejectionComment: 'Test string',
        resource: 'Test string',
        reviewerComment: 'Test string',
        state: 'Test string',
        uid: 'Test string',
        updateEntry: {
          allowMissing: true,
    ...
    await gapi.client.dataplex.projects.locations.changeRequests.reject(
      {
        name: 'Test string',
      },
      {
    ...
    await gapi.client.dataplex.projects.locations.dataDomains.create(
      {
        dataDomainId: 'Test string',
        parent: 'Test string',
        validateOnly: true,
      },
      {
        contacts: {
          identities: [
            {
              contactId: 'Test string',
              contactName: 'Test string',
              contactRole: 'Test string',
            },
          ],
        },
        createTime: 'Test string',
    ...
    await gapi.client.dataplex.projects.locations.dataDomains.delete({
      name: 'Test string',
    });
    /** Retrieves a DataDomain resource. */
    await gapi.client.dataplex.projects.locations.dataDomains.get({
      name: 'Test string',
    });
    /** Gets the access control policy for a resource. Returns an empty policy if the resource exists and does not have a policy set. */
    await gapi.client.dataplex.projects.locations.dataDomains.getIamPolicy({
      'options.requestedPolicyVersion': 42,
      resource: 'Test string',
    });
    /** Lists DataDomain resources in a project and location. */
    await gapi.client.dataplex.projects.locations.dataDomains.list({
      filter: 'Test string',
      orderBy: 'Test string',
      pageSize: 42,
      pageToken: 'Test string',
    ...
    await gapi.client.dataplex.projects.locations.dataDomains.patch(
      {
        name: 'Test string',
        updateMask: 'Test string',
        validateOnly: true,
    ...
    /** Sets the access control policy on the specified resource. Replaces any existing policy.Can return NOT_FOUND, INVALID_ARGUMENT, and PERMISSION_DENIED errors. */
    await gapi.client.dataplex.projects.locations.dataDomains.setIamPolicy(
      {
        resource: 'Test string',
      },
      {
    ...
    /** Returns permissions that a caller has on the specified resource. If the resource does not exist, this will return an empty set of permissions, not a NOT_FOUND error.Note: This operation is designed to be used for building permission-aware UIs and command-line tools, not for authorization checking. This operation may "fail open" without warning. */
    await gapi.client.dataplex.projects.locations.dataDomains.testIamPermissions(
      {
        resource: 'Test string',
      },
      {
    ...
    await gapi.client.dataplex.projects.locations.dataDomains.bindings.create(
      {
        dataDomainBindingId: 'Test string',
        parent: 'Test string',
        validateOnly: true,
      },
      {
    ...
    await gapi.client.dataplex.projects.locations.dataDomains.bindings.delete({
      name: 'Test string',
    });
    /** Retrieves a DataDomainBinding resource. */
    await gapi.client.dataplex.projects.locations.dataDomains.bindings.get({
      name: 'Test string',
    });
    /** Lists DataDomainBinding resources under a DataDomain. */
    await gapi.client.dataplex.projects.locations.dataDomains.bindings.list({
      filter: 'Test string',
      orderBy: 'Test string',
      pageSize: 42,
      pageToken: 'Test string',
    ...
    await gapi.client.dataplex.projects.locations.dataProducts.requestAccess(
      {
        parent: 'Test string',
      },
      {
                ...
                fields: [
                  {
                    ...
                    description: 'Test string',
                    extractionHints: {
                      normalization: 'Test string',
                      synthesis: 'Test string',
                    },
                    fields: undefined,
                    metadataType: 'Test string',
                    mode: 'Test string',
                    name: 'Test string',
                  },
                ],
                foreignKeys: [
                  {
                    ...
                    fieldMappings: [
                      {
                        field: 'Test string',
                        referencedField: 'Test string',
                      },
                    ],
                    name: 'Test string',
                    referencedNodeType: 'Test string',
                  },
                ],
                name: 'Test string',
                sourceNodeType: 'Test string',
            ...
            nodeTypes: [
              {
                ...
                name: 'Test string',
                primaryKeys: ['Test string'],
              },
            ],
          },
          partialFailureMessage: 'Test string',
        },
        unstructuredDataProfileSpec: {
          customizedPrompt: 'Test string',
          globalEndpointEnabled: true,
    ...
    await gapi.client.dataplex.projects.locations.dataScans.jobs.cancel(
      {
        name: 'Test string',
      },
      {},
    ...
    await gapi.client.dataplex.projects.locations.entryGroups.entryLinks.patch(
      {
        allowMissing: true,
        aspectKeys: 'Test string',
        name: 'Test string',
