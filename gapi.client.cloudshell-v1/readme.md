...
{
  "compilerOptions": {
    "types": ["gapi", "gapi.auth2", "gapi.client", "gapi.client.cloudshell-v1"]
  }
}
```
...
For provenance information see [Provenance section on NPM](https://www.npmjs.com/package/@maxim_mazurok/gapi.client.cloudshell-v1#Provenance:~:text=none-,Provenance,-Built%20and%20signed)
