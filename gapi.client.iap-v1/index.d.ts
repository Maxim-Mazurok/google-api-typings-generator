...
declare namespace gapi.client {
    ...
    namespace iap {
        ...
        interface AttributePropagationSettings {
            ...
            enable?: boolean;
            /**
             * Raw string CEL expression. Expression should be of the form attributes.saml_attributes.filter(attribute, attribute.name in [{attribute_list}]). An example expression to select the
             * attributes "my_attr" and "other_attr": attributes.saml_attributes.filter(attribute, attribute.name in ["my_attr", "other_attr"])
             */
            expression?: string;
