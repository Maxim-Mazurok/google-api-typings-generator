/* This is stub file for gapi.client.cloudtasks-v2beta3 definition tests */
// IMPORTANT
...
gapi.load('client', async () => {
    ...
    await gapi.client.load('https://cloudtasks.googleapis.com/$discovery/rest?version=v2beta3');
    ...
    async function run() {
         ...
         * format: projects/PROJECT_ID/locations/LOCATION_ID/queues/QUEUE_ID/tasks:buffer. Note: This feature is in its experimental stage. You must request access to the API through the [Cloud
