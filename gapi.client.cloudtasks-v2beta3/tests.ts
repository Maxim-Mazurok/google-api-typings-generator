...
gapi.load('client', async () => {
  ...
  async function run() {
    ...
    await gapi.client.cloudtasks.projects.locations.operations.get({
      name: 'Test string',
    });
    ...
    await gapi.client.cloudtasks.projects.locations.queues.tasks.batchCreate(
      {
        parent: 'Test string',
      },
      {
    ...
    await gapi.client.cloudtasks.projects.locations.queues.tasks.batchDelete(
      {
        parent: 'Test string',
      },
      {
