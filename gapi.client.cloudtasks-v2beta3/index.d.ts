...
declare namespace gapi.client {
    ...
    namespace cloudtasks {
        ...
        interface HttpTarget {
             ...
             * Several predefined headers, prefixed with "X-Google-Cloud-Tasks-", can be used to define properties of the task. * Host: This will be computed by Cloud Tasks and derived from
