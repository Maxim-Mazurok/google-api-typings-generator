...
declare namespace gapi.client {
    ...
    namespace cloudtasks {
        ...
        interface HttpTarget {
            ...
            /**
             * The HTTP method to use for the request. When specified, it will override HttpRequest for the task. Note that if the value is set to HttpMethod the HttpRequest of the task will be
        ...
        interface UriOverride {
            /**
             * Host override. When specified, will replace the host part of the task URL. For example, if the task URL is "https://www.google.com", and host value is set to "example.net", the
             * overridden URI will be changed to "https://example.net". Host value cannot be an empty string.
             */
            host?: string;
            ...
            /**
             * Port override. When specified, will replace the port part of the task URI. For instance, for a URI http://www.google.com/foo and port=123, the overridden URI becomes
