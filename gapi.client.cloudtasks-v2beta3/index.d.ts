...
declare namespace gapi.client {
    ...
    namespace cloudtasks {
        ...
        interface TasksResource {
             ...
             * following format: projects/PROJECT_ID/locations/LOCATION_ID/queues/QUEUE_ID/tasks:buffer. Note: This feature is in its experimental stage. You must request access to the API through
             * the [Cloud Tasks BufferTask Experiment Signup form](https://forms.gle/X8Zr5hiXH5tTGFqh8).
             */
            buffer(request: {
                /** V1 error format. */
                "$.xgafv"?:
