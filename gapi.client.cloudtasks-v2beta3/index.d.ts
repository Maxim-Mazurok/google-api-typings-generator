...
declare namespace gapi.client {
  ...
  function load(
    urlOrObject: 'https://cloudtasks.googleapis.com/$discovery/rest?version=v2beta3',
  ): Promise<void>;
  ...
  namespace cloudtasks {
    ...
    interface Queue {
      ...
      type?: 'TYPE_UNSPECIFIED' | 'PULL' | 'PUSH';
    }
    ...
    interface TasksResource {
      ...
      batchCreate(request: {
        ...
        uploadType?: string;
        /** Request body */
        resource: BatchCreateTasksRequest;
      }): Request<Operation>;
      batchCreate(
        request: {
          /** V1 error format. */
      ...
      batchDelete(request: {
        ...
        uploadType?: string;
        /** Request body */
        resource: BatchDeleteTasksRequest;
      }): Request<Operation>;
      batchDelete(
        request: {
          /** V1 error format. */
