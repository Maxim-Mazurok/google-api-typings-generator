...
declare namespace gapi.client {
  ...
  namespace cloudidentity {
    ...
    interface CreateInboundOidcSsoProfileOperationMetadata {
      /** State of this Operation Will be "awaiting-multi-party-approval" when the operation is deferred due to the target customer having enabled [Multi-party approval for sensitive actions](https://support.google.com/a/answer/13790448). */
      state?: string;
    }
    ...
    interface DeleteInboundOidcSsoProfileOperationMetadata {}
    ...
    interface Device {
      ...
      browserProfiles?: BrowserAttributes[];
    ...
    interface EndpointVerificationSpecificAttributes {
      ...
      additionalSignals?: {[P in string]: any};
    ...
    interface GoogleAppsCloudidentityDevicesV1CertificateTemplate {
      /** The template id of the template. Example: "1.3.6.1.4.1.311.21.8.15608621.11768144.5720724.16068415.6889630.81.2472537.7784047". */
      id?: string;
      /** The Major version of the template. Example: 100. */
      majorVersion?: number;
    ...
    interface GoogleAppsCloudidentityDevicesV1EndpointVerificationSpecificAttributes {
      /** [Additional signals](https://cloud.google.com/endpoint-verification/docs/device-information) reported by Endpoint Verification. It includes the following attributes: * Non-configurable attributes: hotfixes, av_installed, av_enabled, windows_domain_name, is_os_native_firewall_enabled, and is_secure_boot_enabled. * [Configurable attributes](https://cloud.google.com/endpoint-verification/docs/collect-config-attributes): file, folder, and binary attributes; registry entries; and properties in a plist. */
      additionalSignals?: {[P in string]: any};
      /** Details of browser profiles reported by Endpoint Verification. */
      browserAttributes?: GoogleAppsCloudidentityDevicesV1BrowserAttributes[];
      /** Details of certificates. */
      certificateAttributes?: GoogleAppsCloudidentityDevicesV1CertificateAttributes[];
    }
    ...
    interface UpdateInboundOidcSsoProfileOperationMetadata {
      /** State of this Operation Will be "awaiting-multi-party-approval" when the operation is deferred due to the target customer having enabled [Multi-party approval for sensitive actions](https://support.google.com/a/answer/13790448). */
      state?: string;
    }
    ...
    interface AllowlistedDomainsResource {
      ...
      list(request?: {
        ...
        /** Legacy upload protocol for media (e.g. "media", "multipart"). */
        uploadType?: string;
      }): Request<ListAllowlistedDomainsResponse>;
    }
    ...
    interface InboundOidcSsoProfilesResource {
      ...
      list(request?: {
        ...
        /** Legacy upload protocol for media (e.g. "media", "multipart"). */
        uploadType?: string;
      }): Request<ListInboundOidcSsoProfilesResponse>;
    ...
    const allowlistedDomains: AllowlistedDomainsResource;
    ...
    const inboundOidcSsoProfiles: InboundOidcSsoProfilesResource;
