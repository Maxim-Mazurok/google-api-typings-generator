      ...
      {},
      {
        ...
        device: {
          ...
          antivirusInfo: [
            {
              ...
              productGuid: 'Test string',
              productState: 'Test string',
            },
          ],
          ...
          windowsSpecificDeviceAttributes: {
            hotfixes: ['Test string'],
            secureBootMode: 'Test string',
            windowsMachineDomain: 'Test string',
            windowsUserDomain: 'Test string',
          },
        },
      },
    );
