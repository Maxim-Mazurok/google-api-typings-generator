...
declare namespace gapi.client {
  ...
  namespace networkmanagement {
    ...
    interface DirectVpcIngressConnectionInfo {
    ...
    interface Endpoint {
      ...
      datastreamPrivateConnection?: string;
    ...
    interface PrivateConnectionInfo {
    ...
    interface Step {
      ...
      directVpcIngressConnection?: DirectVpcIngressConnectionInfo;
      ...
      state?:
        ...
        | 'ARRIVE_AT_GKE_POD'
        | 'ARRIVE_AT_DIRECT_VPC_INGRESS_CONNECTION'
    ...
    interface ViewerPermissionMissingInfo {
