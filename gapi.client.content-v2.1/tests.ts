...
gapi.load('client', async () => {
  ...
  async function run() {
    ...
    await gapi.client.content.accounts.businessmessageslinks.create(
      {
        accountId: 'Test string',
      },
      {
        agentId: 'Test string',
        businessMessagesLinkId: 'Test string',
      }
    );
    /** Deletes the specified `BusinessMessagesLink` resource from Merchant Center account. */
    await gapi.client.content.accounts.businessmessageslinks.delete({
      accountId: 'Test string',
      businessMessagesLinkId: 'Test string',
    });
    /** Retrieves `BusinessMessagesLink` in Merchant Center account. */
    await gapi.client.content.accounts.businessmessageslinks.get({
      accountId: 'Test string',
      businessMessagesLinkId: 'Test string',
    });
    /** Lists the `BusinessMessagesLink` resources for Merchant Center account. */
    await gapi.client.content.accounts.businessmessageslinks.list({
      accountId: 'Test string',
      pageSize: 42,
      pageToken: 'Test string',
    });
