...
gapi.load('client', async () => {
    ...
    async function run() {
        ...
        /**
         * Allows uploading one customer information entry. Adding a customer with loyalty data enables the customer to see personalized loyalty annotations on search. Uploading a previously
         * existing customer will overwrite the old entry.
         */
        await gapi.client.content.customers.create({
            merchantId: "Test string",
        }, {
            emailAddress: "Test string",
            loyaltyData: {
