...
declare namespace gapi.client {
    ...
    namespace content {
        ...
        interface CompetitiveVisibility {
             ...
             * organic traffic. The number is rounded and bucketed. Available only in `CompetitiveVisibilityTopMerchantView`. Cannot be filtered on in the 'WHERE' clause.
             */
            adsOrganicRatio?:
                number;
            /**
            ...
            date?:
                Date;
            /**
             * Domain of your competitor or your domain, if 'is_your_domain' is true. Available only in `CompetitiveVisibilityTopMerchantView`. Required in the `SELECT` clause for
            ...
            isYourDomain?:
                boolean;
            /**
             * Page overlap rate describes how frequently competing retailers’ offers are shown together with your offers on the same page. Available only in
             * `CompetitiveVisibilityTopMerchantView`. Cannot be filtered on in the 'WHERE' clause.
             */
            pageOverlapRate?:
                number;
             ...
             * only in `CompetitiveVisibilityTopMerchantView`. Cannot be filtered on in the 'WHERE' clause.
             */
            rank?:
                string;
            /**
             * Type of impression listing. Required in the `SELECT` clause for `CompetitiveVisibilityTopMerchantView` and `CompetitiveVisibilityMarketBenchmarkView`. Cannot be filtered on in the
             * 'WHERE' clause.
             */
            trafficSource?:
                string;
        ...
        interface ReportRow {
            ...
            brand?:
                Brand;
            /**
             * Competitive visibility fields requested by the merchant in the query. Field values are only set if the merchant queries `CompetitiveVisibilityTopMerchantView` or
