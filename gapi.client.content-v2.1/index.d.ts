        ...
        interface RecommendationsResource {
            ...
            generate(request?: {
                ...
                access_token?:
                    string;
                /**
                 * Optional. List of allowed tags. Tags are a set of predefined strings that describe the category that individual recommendation types. User can specify zero or more tags in this
                 * field to indicate what group of recommendations they want to receive. Current list of supported tags: - TREND
                 */
                allowedTag?:
                    string | string[];
                /** Data format for response. */
