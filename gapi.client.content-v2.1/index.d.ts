...
declare namespace gapi.client {
    ...
    namespace content {
        ...
        interface AccountIssue {
             ...
             * context, can use the 'i' as an icon. * `content-moderation` - marks the paragraph that explains how the issue was identified. * `overlay` - wrapper for the `popup` dialog. It should
             * be set to hidden by default. When the dialog is opened, the overlay should switch to be visible and cover the rest of the screen to highlight the dialog. * `popup` - dialog for
             * showing a long block of content * `popup-close` - a button to close the `popup` dialog * `new-element` - Present for new elements added to the pre-rendered content in the future. To
             * make sure that a new content element does not break your style, you can hide everything with this class.
             */
            prerenderedContent?:
                string;
            /** Title of the issue. */
