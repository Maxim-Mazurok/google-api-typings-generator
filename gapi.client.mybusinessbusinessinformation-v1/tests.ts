/* This is stub file for gapi.client.mybusinessbusinessinformation-v1 definition tests */
// IMPORTANT
...
gapi.load('client', async () => {
    ...
    await gapi.client.load('https://mybusinessbusinessinformation.googleapis.com/$discovery/rest?version=v1');
    ...
    async function run() {
        ...
        await gapi.client.mybusinessbusinessinformation.accounts.locations.create({
            parent: "Test string",
