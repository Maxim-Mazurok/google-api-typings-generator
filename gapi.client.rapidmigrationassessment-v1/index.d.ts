/* Type definitions for non-npm package Rapid Migration Assessment API v1 0.0 */
...
// Generated from: https://rapidmigrationassessment.googleapis.com/$discovery/rest?version=v1
// Revision: 20231103
...
declare namespace gapi.client {
    ...
    function load(urlOrObject: "https://rapidmigrationassessment.googleapis.com/$discovery/rest?version=v1"): Promise<void>;
    /** @deprecated Please load APIs with discovery documents. */
    function load(name: "rapidmigrationassessment", version: "v1"): Promise<void>;
    /** @deprecated Please load APIs with discovery documents. */
    function load(name: "rapidmigrationassessment", version: "v1", callback: () => any): void;
    ...
    namespace rapidmigrationassessment {
        ...
        interface PauseCollectorRequest {
            /**
        ...
        interface RegisterCollectorRequest {
            /**
             * Optional. An optional request ID to identify requests. Specify a unique request ID so that if you must retry your request, the server will know to ignore the request if it has
             * already been completed. The server will guarantee that for at least 60 minutes after the first request. For example, consider a situation where you make an initial request and the
             * request times out. If you make the request again with the same request ID, the server can check if original operation with the same request ID was received, and if so, will ignore
        ...
        interface ResumeCollectorRequest {
            /**
             * Optional. An optional request ID to identify requests. Specify a unique request ID so that if you must retry your request, the server will know to ignore the request if it has
             * already been completed. The server will guarantee that for at least 60 minutes after the first request. For example, consider a situation where you make an initial request and the
             * request times out. If you make the request again with the same request ID, the server can check if original operation with the same request ID was received, and if so, will ignore
        ...
        interface AnnotationsResource {
            ...
            body: Annotation): Request<Operation>;
        ...
        interface CollectorsResource {
            ...
            body: Collector): Request<Operation>;
            ...
            list(request?: {
                ...
                uploadType?:
                    string;
            }): Request<ListCollectorsResponse>;
            ...
            patch(request: {
                ...
                requestId?:
                    string;
                /**
                 * Required. Field mask is used to specify the fields to be overwritten in the Collector resource by the update. The fields specified in the update_mask are relative to the
            ...
            body: PauseCollectorRequest): Request<Operation>;
            ...
            body: RegisterCollectorRequest): Request<Operation>;
            ...
            body: ResumeCollectorRequest): Request<Operation>;
        }
