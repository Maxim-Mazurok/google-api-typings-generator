...
declare namespace gapi.client {
  ...
  namespace serviceconsumermanagement {
    ...
    interface V1Beta1ImportProducerQuotaPoliciesRequest {
    ...
    interface V1Beta1ListProducerQuotaPoliciesResponse {
      /** Token identifying which result to start with; returned by a previous list call. */
      nextPageToken?: string;
      /** Producer policies on this limit. */
      producerQuotaPolicies?: V1Beta1ProducerQuotaPolicy[];
    }
    ...
    interface V1Beta1PolicyInlineSource {
    ...
    interface ProducerQuotaPoliciesResource {
      ...
      create(request: {
        ...
        validateOnly?: boolean;
        /** Request body */
        resource: V1Beta1ProducerQuotaPolicy;
      }): Request<Operation>;
      create(
        request: {
          /** V1 error format. */
      ...
      list(request?: {
        ...
        /** Legacy upload protocol for media (e.g. "media", "multipart"). */
        uploadType?: string;
      }): Request<V1Beta1ListProducerQuotaPoliciesResponse>;
    ...
    interface LimitsResource {
      ...
      producerQuotaPolicies: ProducerQuotaPoliciesResource;
    }
    interface ConsumerQuotaMetricsResource {
      ...
      importProducerQuotaPolicies(request: {
        ...
        uploadType?: string;
        /** Request body */
        resource: V1Beta1ImportProducerQuotaPoliciesRequest;
      }): Request<Operation>;
