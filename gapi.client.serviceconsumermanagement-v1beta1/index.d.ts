...
// Generated from: https://serviceconsumermanagement.googleapis.com/$discovery/rest?version=v1beta1
// Revision: 20231116
...
declare namespace gapi.client {
    ...
    function load(urlOrObject: "https://serviceconsumermanagement.googleapis.com/$discovery/rest?version=v1beta1"): Promise<void>;
    /** @deprecated Please load APIs with discovery documents. */
    function load(name: "serviceconsumermanagement", version: "v1beta1"): Promise<void>;
    /** @deprecated Please load APIs with discovery documents. */
    function load(name: "serviceconsumermanagement", version: "v1beta1", callback: () => any): void;
    ...
    namespace serviceconsumermanagement {
        ...
        interface V1beta1AddVisibilityLabelsResponse {
        ...
        interface V1Beta1ConsumerProperty {
            /** Output only. The description of the property. */
            description?:
                string;
            /**
             * Output only. The resource name of this property. An example name would be: `services/serviceconsumermanagement.googleapis.com/projects/123/properties/SERVICE_LEVEL` The resource
             * name is intended to be opaque and should not be parsed for its component strings, since its representation could change in the future.
             */
            name?:
                string;
            /**
             * Output only. A long-running operation which tracks the propagation of recent changes to this resource to all affected backends. If this field is empty, all affected backends have
             * been notified of the change. If this field contains an operation in progress, then the most recent change to this resource has not yet been sent out to all backends. If this field
             * contains an operation that has failed with an error, the caller should retry the change.
             */
            propagation?:
                Operation;
        ...
        interface V1Beta1ConsumerQuotaLimit {
             ...
             * `services/compute.googleapis.com/projects/123/consumerQuotaMetrics/compute.googleapis.com%2Fcpus/limits/%2Fproject%2Fregion` The resource name is intended to be opaque and should
        ...
        interface V1Beta1ConsumerQuotaMetric {
             ...
             * `services/serviceconsumermanagement.googleapis.com/projects/123/consumerQuotaMetrics/compute.googleapis.com%2Fcpus` The resource name is intended to be opaque and should not be
             * parsed for its component strings, since its representation could change in the future.
             */
            name?:
                string;
        ...
        interface V1beta1DefaultIdentity {
        ...
        interface V1beta1GenerateDefaultIdentityResponse {
        ...
        interface V1beta1GenerateServiceAccountResponse {
        ...
        interface V1Beta1ImportProducerOverridesRequest {
            /**
        ...
        interface V1Beta1ListConsumerQuotaMetricsResponse {
        ...
        interface V1Beta1ListProducerOverridesResponse {
            /** Token identifying which result to start with; returned by a previous list call. */
            nextPageToken?:
                string;
        ...
        interface V1Beta1OverrideInlineSource {
            /**
        ...
        interface V1beta1RemoveVisibilityLabelsResponse {
            /** The updated set of visibility labels for this consumer on this service. */
            labels?:
                string[];
        }
        interface V1beta1ServiceAccount {
        ...
        interface ProducerOverridesResource {
            /**
             * Creates a producer override. A producer override is applied by the owner or administrator of a service to increase or decrease the amount of quota a consumer of the service is
             * allowed to use. To create multiple overrides at once, use ImportProducerOverrides instead. If an override with the specified dimensions already exists, this call will fail. To
             * overwrite an existing override if one is already present ("upsert" semantics), use ImportProducerOverrides instead.
             */
            create(request: {
                /** V1 error format. */
                "$.xgafv"?:
            ...
            body: V1Beta1QuotaOverride): Request<Operation>;
            ...
            list(request?: {
                ...
                uploadType?:
                    string;
            }): Request<V1Beta1ListProducerOverridesResponse>;
        ...
        interface LimitsResource {
            ...
            get(request?: {
                ...
                key?:
                    string;
                /**
                 * The resource name of the quota limit, returned by a ListConsumerQuotaMetrics or GetConsumerQuotaMetric call. An example name would be:
                 * `services/compute.googleapis.com/projects/123/consumerQuotaMetrics/compute.googleapis.com%2Fcpus/limits/%2Fproject%2Fregion`
                 */
                name:
                    string;
                ...
                view?:
                    string;
            }): Request<V1Beta1ConsumerQuotaLimit>;
            producerOverrides:
                ProducerOverridesResource;
        }
        interface ConsumerQuotaMetricsResource {
            ...
            get(request?: {
                ...
                key?:
                    string;
                /**
                 * The resource name of the quota metric, returned by a ListConsumerQuotaMetrics call. An example name would be:
                ...
                view?:
                    string;
            }): Request<V1Beta1ConsumerQuotaMetric>;
            /**
             * Create or update multiple producer overrides atomically, all on the same consumer, but on many different metrics or limits. The name field in the quota override message should not
             * be set.
             */
            ...
            body: V1Beta1ImportProducerOverridesRequest): Request<Operation>;
            /**
             * Retrieves a summary of all quota information about this consumer that is visible to the service producer, for each quota metric defined by the service. Each metric includes
             * information about all of its defined limits. Each limit includes the limit configuration (quota unit, preciseness, default value), the current effective limit value, and all of the
            ...
            list(request?: {
                ...
                view?:
                    string;
            }): Request<V1Beta1ListConsumerQuotaMetricsResponse>;
            limits:
                LimitsResource;
        }
        interface PropertiesResource {
            /**
             * Creates a consumer property. If the property already exists, this method fails with an ALREADY_EXISTS error. For this failure case, the Status details field will contain the
            ...
            }): Request<V1Beta1ConsumerProperty>;
            create(request: {
                /** V1 error format. */
                "$.xgafv"?:
                    string;
            ...
            body: V1Beta1ConsumerProperty): Request<V1Beta1ConsumerProperty>;
        }
