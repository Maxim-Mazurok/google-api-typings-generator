...
gapi.load('client', async () => {
    ...
    async function run() {
        ...
        /**
         * Creates a consumer property. If the property already exists, this method fails with an ALREADY_EXISTS error. For this failure case, the Status details field will contain the existing
         * property's value.
         */
        await gapi.client.serviceconsumermanagement.services.properties.create({
            parent: "Test string",
        }, {
