...
declare namespace gapi.client {
    ...
    namespace analyticsdata {
        ...
        interface ResponseMetaData {
            ...
            /**
             * If `thresholdingApplied` is true, this report has thresholding applied and only returns data that meets the minimum aggregation thresholds. This boolean only indicates if
             * thresholding was applied. It is possible for thresholding to be applied and no data is absent from the report, and this happens when all data is above the thresholds. To learn more,
             * see [Data thresholds](https://support.google.com/analytics/answer/9383630) and [About Demographics and Interests](https://support.google.com/analytics/answer/2799357).
             */
            thresholdingApplied?: boolean;
            /**
