...
declare namespace gapi.client {
    ...
    namespace analyticsdata {
        ...
        interface Pivot {
            ...
            fieldNames?: string[];
            /**
             * The number of rows to return in this pivot. If the `limit` parameter is unspecified, up to 10,000 rows are returned. The API returns a maximum of 100,000 rows per request, no matter
