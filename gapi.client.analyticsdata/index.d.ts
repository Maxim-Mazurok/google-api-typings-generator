...
declare namespace gapi.client {
    ...
    namespace analyticsdata {
        ...
        interface Dimension {
            ...
            /**
             * The name of the dimension. See the [API Dimensions](https://developers.google.com/analytics/trusted-testing/analytics-data/api-schema#dimensions) for the list of dimension names. If
        ...
        interface Metric {
            ...
            invisible?: boolean;
            /**
             * The name of the metric. See the [API Metrics](https://developers.google.com/analytics/trusted-testing/analytics-data/api-schema#metrics) for the list of metric names. If
             * `expression` is specified, `name` can be any string that you would like. For example if `expression` is `screenPageViews/sessions`, you could call that metric's name =
        ...
        interface RunReportResponse {
            ...
            /**
             * The total number of rows in the query result, regardless of the number of rows returned in the response. For example if a query returns 175 rows and includes limit = 50 in the API
             * request, the response will contain row_count = 175 but only 50 rows. To learn more about this pagination parameter, see [Pagination](basics#pagination).
             */
            rowCount?: number;
            /** Rows of dimension value combinations and metric values in the report. */
            rows?: Row[];
        ...
        interface PropertiesResource {
            ...
            getMetadata(request?: {
                 ...
                 * identifier. To learn more, see [where to find your Property ID](https://developers.google.com/analytics/trusted-testing/analytics-data/property-id). Example:
            ...
            runRealtimeReport(request: {
                 ...
                 * ID](https://developers.google.com/analytics/trusted-testing/analytics-data/property-id). Example: properties/1234
                 */
                property: string;
                /** Available to use for quota purposes for server-side applications. Can be any arbitrary string assigned to a user, but should not exceed 40 characters. */
                quotaUser?: string;
