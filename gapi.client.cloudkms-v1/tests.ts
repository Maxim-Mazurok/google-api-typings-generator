...
gapi.load('client', async () => {
  ...
  async function run() {
    ...
    await gapi.client.cloudkms.folders.getAutokeyConfig({
      name: 'Test string',
    });
    /** Gets the KeyAccessJustificationsPolicyConfig for a given organization, folder, or project. */
    await gapi.client.cloudkms.folders.getKajPolicyConfig({
      name: 'Test string',
    });
    ...
    await gapi.client.cloudkms.folders.updateAutokeyConfig(
      {
        name: 'Test string',
      ...
      },
      {
        ...
        keyProjectResolutionMode: 'Test string',
        name: 'Test string',
        state: 'Test string',
      },
    );
    /** Updates the KeyAccessJustificationsPolicyConfig for a given organization, folder, or project. */
    await gapi.client.cloudkms.folders.updateKajPolicyConfig(
      {
        name: 'Test string',
        updateMask: 'Test string',
      },
      {
        defaultKeyAccessJustificationPolicy: {
          allowedAccessReasons: ['Test string'],
        },
    ...
    /** Gets the KeyAccessJustificationsPolicyConfig for a given organization, folder, or project. */
    await gapi.client.cloudkms.organizations.getKajPolicyConfig({
      name: 'Test string',
    });
    /** Updates the KeyAccessJustificationsPolicyConfig for a given organization, folder, or project. */
    await gapi.client.cloudkms.organizations.updateKajPolicyConfig(
      {
        name: 'Test string',
        updateMask: 'Test string',
      },
    ...
    /** Returns the AutokeyConfig for a folder or project. */
    await gapi.client.cloudkms.projects.getAutokeyConfig({
      name: 'Test string',
    });
    /** Gets the KeyAccessJustificationsPolicyConfig for a given organization, folder, or project. */
    await gapi.client.cloudkms.projects.getKajPolicyConfig({
      name: 'Test string',
    });
    /** Returns the effective Cloud KMS Autokey configuration for a given project or folder. Note on permissions: - If called on a project (`projects/{project}`), requires `cloudkms.projects.showEffectiveAutokeyConfig`. - If called on a folder (`folders/{folder}`), requires `cloudkms.folders.showEffectiveAutokeyConfig`. */
    ...
    /** Updates the AutokeyConfig for a folder or a project. The caller must have both `cloudkms.autokeyConfigs.update` permission on the parent folder and `cloudkms.cryptoKeys.setIamPolicy` permission on the provided key project. A KeyHandle creation in the folder's descendant projects will use this configuration to determine where to create the resulting CryptoKey. */
    await gapi.client.cloudkms.projects.updateAutokeyConfig(
      {
        name: 'Test string',
        updateMask: 'Test string',
      },
    ...
    /** Updates the KeyAccessJustificationsPolicyConfig for a given organization, folder, or project. */
    await gapi.client.cloudkms.projects.updateKajPolicyConfig(
      {
        name: 'Test string',
        updateMask: 'Test string',
      },
    ...
    /** Lists KeyHandles. */
    await gapi.client.cloudkms.projects.locations.keyHandles.list({
      filter: 'Test string',
      pageSize: 42,
      pageToken: 'Test string',
      parent: 'Test string',
    ...
    await gapi.client.cloudkms.projects.locations.keyRings.delete({
      name: 'Test string',
    });
      ...
      },
      {
        ...
        primary: {
          ...
          externalProtectionLevelOptions: {
            ekmConnectionBackendOverride: 'Test string',
    ...
    await gapi.client.cloudkms.projects.locations.keyRings.cryptoKeys.delete({
      name: 'Test string',
    });
    ...
    await gapi.client.cloudkms.projects.locations.keyRings.cryptoKeys.cryptoKeyVersions.decapsulate(
      {
        name: 'Test string',
      },
      {
    ...
    await gapi.client.cloudkms.projects.locations.keyRings.cryptoKeys.cryptoKeyVersions.delete(
      {
        name: 'Test string',
      },
    );
    ...
    await gapi.client.cloudkms.projects.locations.keyRings.cryptoKeys.cryptoKeyVersions.exportTrustedKeyWrappedCryptoKeyVersion(
      {
        name: 'Test string',
        wrappingKey: 'Test string',
      },
    );
    ...
    await gapi.client.cloudkms.projects.locations.keyRings.cryptoKeys.cryptoKeyVersions.importTrustedKeyWrappedCryptoKeyVersion(
      {
        parent: 'Test string',
      },
      {
    ...
    await gapi.client.cloudkms.projects.locations.retiredResources.get({
      name: 'Test string',
    });
    ...
    await gapi.client.cloudkms.projects.locations.retiredResources.list({
      pageSize: 42,
      pageToken: 'Test string',
      parent: 'Test string',
    });
    ...
    await gapi.client.cloudkms.projects.locations.singleTenantHsmInstances.create(
      {
        parent: 'Test string',
        singleTenantHsmInstanceId: 'Test string',
      },
      {
        createTime: 'Test string',
        deleteTime: 'Test string',
        disableTime: 'Test string',
        keyPortabilityEnabled: true,
        name: 'Test string',
        quorumAuth: {
          requiredApproverCount: 42,
          totalApproverCount: 42,
          twoFactorPublicKeyPems: ['Test string'],
        },
        state: 'Test string',
        unrefreshedDurationUntilDisable: 'Test string',
      },
    );
    /** Returns metadata for a given SingleTenantHsmInstance. */
    await gapi.client.cloudkms.projects.locations.singleTenantHsmInstances.get({
      name: 'Test string',
    });
    /** Lists SingleTenantHsmInstances. */
    await gapi.client.cloudkms.projects.locations.singleTenantHsmInstances.list(
      {
        filter: 'Test string',
        orderBy: 'Test string',
        pageSize: 42,
    ...
    await gapi.client.cloudkms.projects.locations.singleTenantHsmInstances.proposals.approve(
      {
        name: 'Test string',
      },
      {
    ...
    await gapi.client.cloudkms.projects.locations.singleTenantHsmInstances.proposals.create(
      {
        parent: 'Test string',
        singleTenantHsmInstanceProposalId: 'Test string',
      },
      {
        addQuorumMember: {
          twoFactorPublicKeyPem: 'Test string',
        },
        createTime: 'Test string',
        ...
        quorumParameters: {
          approvedTwoFactorPublicKeyPems: ['Test string'],
          challenges: [
            {
    ...
    await gapi.client.cloudkms.projects.locations.singleTenantHsmInstances.proposals.delete(
      {
        name: 'Test string',
      },
    );
    ...
    await gapi.client.cloudkms.projects.locations.singleTenantHsmInstances.proposals.execute(
      {
        name: 'Test string',
      },
      {},
    ...
    await gapi.client.cloudkms.projects.locations.singleTenantHsmInstances.proposals.get(
      {
        name: 'Test string',
      },
    );
    /** Lists SingleTenantHsmInstanceProposals. */
    await gapi.client.cloudkms.projects.locations.singleTenantHsmInstances.proposals.list(
      {
        filter: 'Test string',
        orderBy: 'Test string',
        pageSize: 42,
