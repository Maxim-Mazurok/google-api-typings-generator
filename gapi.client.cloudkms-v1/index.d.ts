...
declare namespace gapi.client {
  ...
  namespace cloudkms {
    ...
    interface KeyAccessJustificationsPolicy {
      /** The list of allowed reasons for access to a CryptoKey. Zero allowed access reasons means all Encrypt, Decrypt, and Sign requests for the CryptoKey associated with this policy will fail. */
