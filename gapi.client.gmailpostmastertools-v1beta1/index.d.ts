...
declare namespace gapi.client {
    ...
    function load(urlOrObject: "https://gmailpostmastertools.googleapis.com/$discovery/rest?version=v1beta1"): Promise<void>;
    /** @deprecated Please load APIs with discovery documents. */
    function load(name: "gmailpostmastertools", version: "v1beta1"): Promise<void>;
    /** @deprecated Please load APIs with discovery documents. */
