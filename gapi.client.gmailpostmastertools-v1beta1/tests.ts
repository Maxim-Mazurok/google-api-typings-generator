/* This is stub file for gapi.client.gmailpostmastertools-v1beta1 definition tests */
// IMPORTANT
...
gapi.load('client', async () => {
    ...
    await gapi.client.load('https://gmailpostmastertools.googleapis.com/$discovery/rest?version=v1beta1');
