...
// Generated from: https://cloudasset.googleapis.com/$discovery/rest?version=v1p7beta1
// Revision: 20220826
...
declare namespace gapi.client {
    ...
    function load(urlOrObject: "https://cloudasset.googleapis.com/$discovery/rest?version=v1p7beta1"): Promise<void>;
    /** @deprecated Please load APIs with discovery documents. */
    function load(name: "cloudasset", version: "v1p7beta1"): Promise<void>;
    /** @deprecated Please load APIs with discovery documents. */
    function load(name: "cloudasset", version: "v1p7beta1", callback: () => any): void;
    ...
    namespace cloudasset {
        ...
        interface GoogleCloudAssetV1p7beta1BigQueryDestination {
            /**
        ...
        interface GoogleCloudAssetV1p7beta1ExportAssetsRequest {
            /**
            ...
            readTime?: string;
            /**
             * A list of relationship types to export, for example: `INSTANCE_TO_INSTANCEGROUP`. This field should only be specified if content_type=RELATIONSHIP. If specified, it will snapshot
             * [asset_types]' specified relationships, or give errors if any relationship_types' supported types are not in [asset_types]. If not specified, it will snapshot all [asset_types]'
             * supported relationships. An unspecified [asset_types] field means all supported asset_types. See [Introduction to Cloud Asset
             * Inventory](https://cloud.google.com/asset-inventory/docs/overview) for all supported asset types and relationship types.
             */
            relationshipTypes?: string[];
        }
        interface GoogleCloudAssetV1p7beta1GcsDestination {
            /**
             ...
             * "gs://bucket_name/object_name_prefix/{ASSET_TYPE}/{SHARD_NUMBER} and only contains assets for that type. starts from 0. Example:
             * "gs://bucket_name/object_name_prefix/compute.googleapis.com/Disk/0" is the first shard of output objects containing all compute.googleapis.com/Disk assets. An INVALID_ARGUMENT error
             * will be returned if file with the same name "gs://bucket_name/object_name_prefix" already exists.
             */
            uriPrefix?: string;
        }
        interface GoogleCloudAssetV1p7beta1OutputConfig {
        ...
        interface GoogleCloudAssetV1p7beta1PartitionSpec {
        ...
        interface V1p7beta1Resource {
             ...
             * Each line represents a google.cloud.asset.v1p7beta1.Asset in the JSON format; for BigQuery table destinations, the output table stores the fields in asset proto as columns. This API
            ...
            exportAssets(request: {
                ...
                uploadType?: string;
                /** Request body */
                resource: GoogleCloudAssetV1p7beta1ExportAssetsRequest;
            }): Request<Operation>;
            exportAssets(request: {
                /** V1 error format. */
                "$.xgafv"?: string;
            ...
            body: GoogleCloudAssetV1p7beta1ExportAssetsRequest): Request<Operation>;
        }

        const operations: OperationsResource;

        const v1p7beta1: V1p7beta1Resource;
    }
}
