...
declare namespace gapi.client {
  ...
  function load(
    urlOrObject: 'https://cloudasset.googleapis.com/$discovery/rest?version=v1beta1',
  ): Promise<void>;
  ...
  namespace cloudasset {
    ...
    interface ExportAssetsRequest {
      ...
      contentType?: 'CONTENT_TYPE_UNSPECIFIED' | 'RESOURCE' | 'IAM_POLICY';
    ...
    interface GoogleIdentityAccesscontextmanagerV1AddRequestHeader {
      /** HTTP header key. */
      key?: string;
      /** HTTP header value. */
      value?: string;
    ...
    interface GoogleIdentityAccesscontextmanagerV1Modifier {
    ...
    interface GoogleIdentityAccesscontextmanagerV1PrivateServiceConnectEndpoint {
    ...
    interface GoogleIdentityAccesscontextmanagerV1ServicePattern {
      /** Modifiers to apply to the requests that match the URL pattern. */
      modifiers?: GoogleIdentityAccesscontextmanagerV1Modifier[];
    ...
    interface GoogleIdentityAccesscontextmanagerV1VpcAccessibleServices {
      ...
      allowedServicePatterns?: GoogleIdentityAccesscontextmanagerV1ServicePattern[];
