    ...
    namespace cloudbuild {
        ...
        interface GitFileSource {
            ...
            path?:
                string;
            /**
             * The fully qualified resource name of the Repo API repository. Either uri or repository can be specified. If unspecified, the repo from which the trigger invocation originated is
