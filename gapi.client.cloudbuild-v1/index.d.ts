...
declare namespace gapi.client {
  ...
  namespace cloudbuild {
    ...
    interface Artifacts {
      ...
      genericArtifacts?: GenericArtifact[];
    ...
    interface DefaultServiceAccount {
    ...
    interface DeveloperConnectConfig {
    ...
    interface DeveloperConnectEventConfig {
      /** Required. The Developer Connect Git repository link, formatted as `projects/*‍/locations/*‍/connections/*‍/gitRepositoryLink/*`. */
      gitRepositoryLink?: string;
    ...
    interface GenericArtifactDependency {
    ...
    interface PrivateServiceConnect {
    ...
    interface Results {
      ...
      buildStepResults?: {[P in string]: BuildStepResults};
      /** Output only. Generic artifacts uploaded to Artifact Registry at the end of the build. */
      genericArtifacts?: UploadedGenericArtifact[];
      /** Optional. Go module artifacts uploaded to Artifact Registry at the end of the build. */
      goModules?: UploadedGoModule[];
    ...
    interface UploadedGenericArtifact {
    ...
    interface LocationsResource {
      ...
      getDefaultServiceAccount(request?: {
        /** V1 error format. */
        '$.xgafv'?: '1' | '2';
        /** OAuth access token. */
        access_token?: string;
