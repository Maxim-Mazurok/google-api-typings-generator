...
gapi.load('client', async () => {
    ...
    async function run() {
         ...
         * build source. * If the original build pulled source from Cloud Storage and specified the generation of the object, the new build will attempt to use the same object, which may or may
