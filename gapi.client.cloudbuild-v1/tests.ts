      ...
      },
      {
        ...
        artifacts: {
          genericArtifacts: [
            {
              folder: 'Test string',
              registryPath: 'Test string',
            },
          ],
          goModules: [
            {
              modulePath: 'Test string',
              moduleVersion: 'Test string',
              repositoryLocation: 'Test string',
              repositoryName: 'Test string',
              repositoryProjectId: 'Test string',
        ...
        gitConfig: {
          http: {
            proxySecretVersionName: 'Test string',
          },
        },
        id: 'Test string',
        images: ['Test string'],
        ...
        steps: [
          {
            ...
            results: [
              {
                attestationContent: 'Test string',
                attestationType: 'Test string',
                name: 'Test string',
              },
            ],
            script: 'Test string',
    ...
    await gapi.client.cloudbuild.projects.locations.triggers.create(
      ...
      },
      {
        ...
        developerConnectEventConfig: {
          gitRepositoryLink: 'Test string',
          gitRepositoryLinkType: 'Test string',
          pullRequest: {
            branch: 'Test string',
            commentControl: 'Test string',
            invertRegex: true,
