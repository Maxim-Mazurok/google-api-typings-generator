...
// Project: https://developers.google.com/workspace/admin/alertcenter/
...
declare namespace gapi.client {
  ...
  namespace alertcenter {
    ...
    interface ClientSideEncryptionServiceUnavailable {
      /** Identity providers impacted by an outage or misconfiguration. */
      idpError?: IdentityProviderError[];
    ...
    interface IdentityProviderError {
    ...
    interface RuleViolationInfo {
      ...
      agentType?: 'AGENT_TYPE_UNSPECIFIED' | 'STUDIO' | 'WORK_AGENT';
      /** Source of the data. */
      dataSource?:
      ...
      suppressedActionTypes?:
        ...
        | 'CHROME_BLOCK_DATA_COPIED'
        | 'CHROME_WARN_DATA_COPIED'
