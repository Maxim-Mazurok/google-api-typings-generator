  ...
  async function run() {
    ...
    await gapi.client.pubsub.projects.schemas.commit(
      ...
      },
      {
        schema: {
          compiledProtoSchema: {
            compiledBytes: 'Test string',
            rootMessage: 'Test string',
          },
    ...
    await gapi.client.pubsub.projects.topics.create(
      ...
      },
      {
        ingestionDataSourceSettings: {
          awsKinesis: {
            awsRoleArn: 'Test string',
            consumerArn: 'Test string',
            gcpServiceAccount: 'Test string',
            state: 'Test string',
            streamArn: 'Test string',
          },
          awsMsk: {
            awsRoleArn: 'Test string',
            clusterArn: 'Test string',
            gcpServiceAccount: 'Test string',
            state: 'Test string',
            topic: 'Test string',
          },
          ...
          cloudStorage: {
            ...
            minimumObjectCreateTime: 'Test string',
            pubsubAvroFormat: {},
            state: 'Test string',
            textFormat: {
          ...
          confluentCloud: {
            bootstrapServer: 'Test string',
            clusterId: 'Test string',
            gcpServiceAccount: 'Test string',
            identityPoolId: 'Test string',
            state: 'Test string',
            topic: 'Test string',
          },
        ...
        messageStoragePolicy: {
          allowedPersistenceRegions: ['Test string'],
