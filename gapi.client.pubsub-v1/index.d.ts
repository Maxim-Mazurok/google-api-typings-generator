...
declare namespace gapi.client {
    ...
    namespace pubsub {
        ...
        interface MessageStoragePolicy {
            /**
             * Optional. A list of IDs of GCP regions where messages that are published to the topic may be persisted in storage. Messages published by publishers running in non-allowed GCP
             * regions (or running outside of GCP altogether) will be routed for storage in one of the allowed regions. An empty list means that no regions are allowed, and is not a valid
             * configuration.
             */
        ...
        interface SnapshotsResource {
            ...
            create(request: {
                 ...
                 * subscription. Note that for REST API requests, you must specify a name. See the [resource name rules](https://cloud.google.com/pubsub/docs/admin#resource_names). Format is
