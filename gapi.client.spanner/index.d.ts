...
declare namespace gapi.client {
    ...
    namespace spanner {
        ...
        interface RequestOptions {
             ...
             * a transaction. This field is ignored for requests where it's not applicable (e.g. CommitRequest). `request_tag` must be a valid identifier of the form: `a-zA-Z` between 2 and 64
             ...
             * transaction_tag should be the same for all requests belonging to the same transaction. If this request doesn’t belong to any transaction, transaction_tag will be ignored.
