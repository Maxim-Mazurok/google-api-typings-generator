    ...
    namespace storage {
        ...
        interface Bucket {
                    ...
                    bucketPolicyOnly?:
                        {
                            ...
                            enabled?:
                                boolean;
                            /**
                             * The deadline for changing iamConfiguration.bucketPolicyOnly.enabled from true to false in RFC 3339 format. iamConfiguration.bucketPolicyOnly.enabled may be changed
                             * from true to false until the locked time, after which the field is immutable.
                             */
                            lockedTime?:
                                string;
                        };
                    ...
                    uniformBucketLevelAccess?:
                        {
                            ...
                            enabled?:
                                boolean;
                            /**
                             * The deadline for changing iamConfiguration.uniformBucketLevelAccess.enabled from true to false in RFC 3339  format. iamConfiguration.uniformBucketLevelAccess.enabled
                            ...
                            condition?:
                                {
                                    ...
                                    age?:
                                        number;
                                    /**
                                     * A date in RFC 3339 format with only the date part (for instance, "2013-01-15"). This condition is satisfied when an object is created before midnight of the
                                     * specified date in UTC.
                                     */
                                    createdBefore?:
                                        string;
                                    /**
                                     * A date in RFC 3339 format with only the date part (for instance, "2013-01-15"). This condition is satisfied when the custom time on an object is before this
                                     * date in UTC.
                                     */
                                    customTimeBefore?:
                                        string;
                                    /**
                                     * Number of days elapsed since the user-specified timestamp set on an object. The condition is satisfied if the days elapsed is at least this number. If no
                                     * custom timestamp is specified on an object, the condition does not apply.
                                     */
                                    daysSinceCustomTime?:
                                        number;
                                    /**
                                     * Number of days elapsed since the noncurrent timestamp of an object. The condition is satisfied if the days elapsed is at least this number. This condition is
                                     * relevant only for versioned objects. The value of the field must be a nonnegative integer. If it's zero, the object version will become eligible for
                                    ...
                                    isLive?:
                                        boolean;
                                    /**
                                     * A regular expression that satisfies the RE2 syntax. This condition is satisfied when the name of the object matches the RE2 pattern. Note: This feature is
                                     * currently in the "Early Access" launch stage and is only available to a whitelisted set of users; that means that this feature may be changed in
                                    ...
                                    matchesPrefix?:
                                        string[];
                                    /**
                                     * Objects having any of the storage classes specified by this condition will be matched. Values include MULTI_REGIONAL, REGIONAL, NEARLINE, COLDLINE, ARCHIVE,
                                    ...
                                    matchesSuffix?:
                                        string[];
                                    /**
                                     * A date in RFC 3339 format with only the date part (for instance, "2013-01-15"). This condition is satisfied when the noncurrent time on an object is before
                                     * this date in UTC. This condition is relevant only for versioned objects.
                                     */
                                    noncurrentTimeBefore?:
                                        string;
                                    /**
                                     * Relevant only for versioned objects. If the value is N, this condition is satisfied when there are at least N versions (including the live version) newer
            ...
            retentionPolicy?:
                {
                    ...
                    isLocked?:
                        boolean;
                    /**
                     * The duration in seconds that objects need to be retained. Retention duration must be greater than zero and less than 100 years. Note that enforcement of retention periods
                     * less than a day is not guaranteed. Such periods should only be used for testing purposes.
                     */
                    retentionPeriod?:
                        string;
                };
            ...
            website?:
                {
                    /**
                     * If the requested object path is missing, the service will ensure the path has a trailing '/', append this suffix, and attempt to retrieve the resulting object. This allows
                     * the creation of index.html objects to represent directory pages.
                     */
                    mainPageSuffix?:
                        string;
                    /**
            ...
            sourceObjects?:
                Array<{
                    ...
                    objectPreconditions?:
                        {
                            /**
                             * Only perform the composition if the generation of the source object that would be used matches this value. If this value and a generation are both specified, they
                             * must be the same value or the call will fail.
                             */
                            ifGenerationMatch?:
                                string;
                        };
        ...
        interface Object {
            ...
            generation?:
                string;
            /**
             * This is the time (in the future) when the soft-deleted object will no longer be restorable. It is equal to the soft delete time plus the current soft delete retention duration of
             * the bucket.
             */
            hardDeleteTime?:
                string;
        ...
        interface Policy {
            ...
            bindings?:
                Array<{
                     ...
                     * - roles/storage.legacyBucketOwner — Read and write access to existing buckets with object listing/creation/deletion. Equivalent to an ACL entry on a bucket with the OWNER
                     * role.
                     */
                    role?:
                        string;
        ...
        interface AnywhereCacheResource {
            ...
            body: AnywhereCache): Request<GoogleLongrunningOperation>;
        ...
        interface ObjectAccessControlsResource {
            ...
            delete(request?: {
                ...
                oauth_token?:
                    string;
                /**
                 * Name of the object. For information about how to URL encode object names to be path safe, see [Encoding URI Path
        ...
        interface ObjectsResource {
            ...
            compose(request: {
                ...
                destinationBucket:
                    string;
                /**
                 * Name of the new object. For information about how to URL encode object names to be path safe, see [Encoding URI Path
                 * Parts](https://cloud.google.com/storage/docs/request-endpoints#encoding).
                 */
                destinationObject:
                    string;
            ...
            copy(request: {
                 ...
                 * path safe, see [Encoding URI Path Parts](https://cloud.google.com/storage/docs/request-endpoints#encoding).
                 */
                destinationBucket:
                    string;
                /**
                ...
                sourceGeneration?:
                    string;
                /**
                 * Name of the source object. For information about how to URL encode object names to be path safe, see [Encoding URI Path
                 * Parts](https://cloud.google.com/storage/docs/request-endpoints#encoding).
                 */
                sourceObject:
                    string;
            ...
            insert(request: {
                 ...
                 * object names to be path safe, see [Encoding URI Path Parts](https://cloud.google.com/storage/docs/request-endpoints#encoding).
                 */
                name?:
                    string;
                /** OAuth 2.0 token for the current user. */
        ...
        const anywhereCache: AnywhereCacheResource;
