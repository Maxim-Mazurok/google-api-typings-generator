...
declare namespace gapi.client {
  ...
  namespace storage {
    ...
    interface RapidCachePolicy {
      ...
      ingestOnWrite?: 'enabled' | 'unspecified';
      /** The unique identifier of the rapid cache. */
      rapidCacheId?: string;
    }
    interface RapidCaches {
      /** The list of items. */
      items?: RapidCache[];
    ...
    const rapidCaches: RapidCachesResource;
  }
}
