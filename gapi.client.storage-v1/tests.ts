...
gapi.load('client', async () => {
  ...
  async function run() {
          ...
          rule: [
            {
              ...
              condition: {
                ...
                numNewerVersions: 42,
                sizeAboveBytes: 'Test string',
                sizeBelowBytes: 'Test string',
              },
            },
          ],
        },
    ...
    await gapi.client.storage.managedFolders.insert(
      ...
      },
      {
        ...
        rapidCacheConfig: {
          policies: {
            A: {
              ingestOnWrite: 'Test string',
              rapidCacheId: 'Test string',
            },
          },
        },
        selfLink: 'Test string',
        ...
        destination: {
          ...
          contexts: {
            custom: {
              A: {
                createTime: 'Test string',
                extendedDataTypeUrl: 'Test string',
                updateTime: 'Test string',
                value: 'Test string',
              },
            },
    ...
    await gapi.client.storage.rapidCaches.insert(
      {
        bucket: 'Test string',
      },
      {
    ...
    await gapi.client.storage.rapidCaches.list({
      bucket: 'Test string',
      pageSize: 42,
      pageToken: 'Test string',
    });
