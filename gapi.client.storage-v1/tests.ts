...
gapi.load('client', async () => {
    ...
    async function run() {
        ...
        await gapi.client.storage.anywhereCache.disable({
            anywhereCacheId: "Test string",
            bucket: "Test string",
        });
        /** Returns the metadata of an Anywhere Cache instance. */
        await gapi.client.storage.anywhereCache.get({
            anywhereCacheId: "Test string",
            bucket: "Test string",
        });
        /** Creates an Anywhere Cache instance. */
        await gapi.client.storage.anywhereCache.insert({
            bucket: "Test string",
        }, {
        ...
        await gapi.client.storage.anywhereCache.list({
            bucket: "Test string",
            pageSize: 42,
            pageToken: "Test string",
        });
        /** Pauses an Anywhere Cache instance. */
        await gapi.client.storage.anywhereCache.pause({
            anywhereCacheId: "Test string",
            bucket: "Test string",
        });
        /** Resumes a paused or disabled Anywhere Cache instance. */
        await gapi.client.storage.anywhereCache.resume({
            anywhereCacheId: "Test string",
            bucket: "Test string",
        });
        /** Updates the config(ttl and admissionPolicy) of an Anywhere Cache instance. */
        await gapi.client.storage.anywhereCache.update({
            anywhereCacheId: "Test string",
            bucket: "Test string",
        }, {
            admissionPolicy: "Test string",
