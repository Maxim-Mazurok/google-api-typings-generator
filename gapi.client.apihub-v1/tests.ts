...
gapi.load('client', async () => {
  ...
  async function run() {
                ...
                versions: [
                  {
                    ...
                    specs: [
                      {
                        deploymentResourceUris: ['Test string'],
                        originalCreateTime: 'Test string',
                        originalId: 'Test string',
                        originalUpdateTime: 'Test string',
                        spec: {
    ...
    await gapi.client.apihub.projects.locations.apiHubInstances.patch(
      {
        name: 'Test string',
    ...
    await gapi.client.apihub.projects.locations.servers.configureAndDeployServer(
      {
        parent: 'Test string',
      },
      {
