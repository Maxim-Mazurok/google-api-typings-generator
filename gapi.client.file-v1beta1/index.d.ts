    ...
    namespace file {
        ...
        interface FileShareConfig {
            ...
            capacityGb?:
                string;
            /**
             * Required. The name of the file share. Must use 1-16 characters for the basic service tier and 1-63 characters for all other service tiers. Must use lowercase letters, numbers, or
        ...
        interface Instance {
            ...
            networks?:
                NetworkConfig[];
            /**
             * Immutable. The protocol indicates the access protocol for all shares in the instance. This field is immutable and it cannot be changed after the instance has been created. Default
             * value: `NFS_V3`.
             */
            protocol?:
                string;
        ...
        interface ManagedActiveDirectoryConfig {
            /**
             * The computer name is used as a prefix to the mount remote target. Example: if the computer_name is `my-computer`, the mount command will look like: `$mount -o vers=4,sec=krb5
        ...
        interface Share {
            /**
             * Immutable. Full name of the Cloud Filestore Backup resource that this Share is restored from, in the format of projects/{project_id}/locations/{location_id}/backups/{backup_id}.
             * Empty, if the Share is created from scratch and not restored from a backup.
             */
            backup?:
                string;
        ...
        interface UpdatePolicy {
            ...
            channel?:
                string;
            /**
             * Deny Maintenance Period that is applied to resource to indicate when maintenance is forbidden. The protocol supports zero-to-many such periods, but the current SLM Rollout
        ...
        interface BackupsResource {
            ...
            create(request: {
                ...
                oauth_token?:
                    string;
                /**
                 * Required. The backup's project and location, in the format `projects/{project_id}/locations/{location}`. In Filestore, backup locations map to Google Cloud regions, for example
                 * **us-west1**.
                 */
                parent:
                    string;
            ...
            list(request?: {
                 ...
                 * Google Cloud regions, for example **us-west1**. To retrieve backup information for all locations, use "-" for the `{location}` value.
                 */
                parent:
                    string;
                /** Returns response with indentations and line breaks. */
        ...
        interface InstancesResource {
            ...
            create(request: {
                ...
                oauth_token?:
                    string;
                /**
                 * Required. The instance's project and location, in the format `projects/{project_id}/locations/{location}`. In Filestore, locations map to Google Cloud zones, for example
                 * **us-west1-b**.
                 */
                parent:
                    string;
            ...
            list(request?: {
                 ...
                 * Google Cloud zones, for example **us-west1-b**. To retrieve instance information for all locations, use "-" for the `{location}` value.
                 */
                parent:
                    string;
                /** Returns response with indentations and line breaks. */
