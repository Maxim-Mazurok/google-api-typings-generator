// Type definitions for non-npm package Google Cloud Translation API v2 2.0
...
declare namespace gapi.client {
    ...
    namespace translate {
        ...
        interface DetectionsResource {
            ...
            body: DetectLanguageRequest): Request<DetectionsListResponse>;
            /** Detects the language of text within a request. */
            list(request: {
                /** V1 error format. */
                "$.xgafv"?: string;
        ...
        interface TranslationsResource {
            ...
            body: TranslateTextRequest): Request<TranslationsListResponse>;
        }

        const detections: DetectionsResource;
