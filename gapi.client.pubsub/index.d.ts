...
declare namespace gapi.client {
    ...
    namespace pubsub {
        ...
        interface Subscription {
            ...
            ackDeadlineSeconds?: number;
            /**
             * If delivery to BigQuery is used with this subscription, this field is used to configure it. At most one of `pushConfig` and `bigQueryConfig` can be set. If both are empty, then the
