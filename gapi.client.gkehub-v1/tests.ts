/* This is stub file for gapi.client.gkehub-v1 definition tests */
// IMPORTANT
...
gapi.load('client', async () => {
  ...
  async function run() {
    ...
    await gapi.client.gkehub.projects.locations.features.create(
      ...
      },
      {
        ...
        spec: {
          ...
          mesh: {
            modernizationCompatibility: 'Test string',
            modernizationStrategy: 'Test string',
          },
          multiclusteringress: {
    ...
    await gapi.client.gkehub.projects.locations.rollouts.cancel(
      {
        name: 'Test string',
      },
      {},
    ...
    /** Removes a Rollout. */
    await gapi.client.gkehub.projects.locations.rollouts.delete({
      name: 'Test string',
      requestId: 'Test string',
    });
    /** Force-completes a rollout stage. Only the active stage of an active rollout can be force-completed. */
    await gapi.client.gkehub.projects.locations.rollouts.forceCompleteStage(
      {
        name: 'Test string',
      },
      {
    ...
    await gapi.client.gkehub.projects.locations.rollouts.pause(
      {
        name: 'Test string',
      },
      {},
    ...
    await gapi.client.gkehub.projects.locations.rollouts.resume(
      {
        name: 'Test string',
      },
      {
        scheduleOffset: 'Test string',
        validateOnly: true,
      },
    );
      ...
      },
      {
        autoUpgradeConfig: {
          ...
          rolloutCreationScope: {
            upgradeTypes: ['Test string'],
          },
        },
        computedReleaseChannel: 'Test string',
        createTime: 'Test string',
        deleteTime: 'Test string',
        displayName: 'Test string',
        ...
        lastQualifiedControlPlaneVersion: 'Test string',
        lastQualifiedNodeVersion: 'Test string',
        name: 'Test string',
        operationalState: {
          reasons: ['Test string'],
          state: 'Test string',
          stateChangeTime: 'Test string',
        },
        stages: [
          {
            clusterSelector: {
        ...
        targetControlPlaneVersion: 'Test string',
        targetNodeVersion: 'Test string',
        uid: 'Test string',
        updateTime: 'Test string',
      },
    );
    ...
    await gapi.client.gkehub.projects.locations.rolloutSequences.upgrade(
      {
        name: 'Test string',
      },
      {
        force: true,
        ignoreClusterDisruptionBudgets: true,
        ignoreMaintenancePolicies: true,
        patchOnly: true,
        soakDurationOverrideAllStages: 'Test string',
        soakDurationOverridePerStage: {
          stageOverrides: {
            A: 'Test string',
          },
        },
        upgradeType: 'Test string',
        version: 'Test string',
      },
    );
    /** Creates a Scope. */
