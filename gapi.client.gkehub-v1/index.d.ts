/* Type definitions for non-npm package GKE Hub API v1 0.0 */
...
declare namespace gapi.client {
  ...
  namespace gkehub {
    ...
    interface AutoUpgradeConfig {
      ...
      enforcedRollouts?: {[P in string]: string};
    ...
    interface ForceCompleteRolloutStageRequest {
    ...
    interface PauseRolloutRequest {}
    interface PerStageSoakDurationOverrides {
      ...
      stageOverrides?: {[P in string]: string};
    }
    interface Policy {
    ...
    interface ResumeRolloutRequest {
    ...
    interface Rollout {
      ...
      stageSoakDurationOverrides?: {[P in string]: string};
      ...
      trigger?: 'ROLLOUT_TRIGGER_UNSPECIFIED' | 'USER' | 'GKE';
    ...
    interface RolloutCreationScope {
    ...
    interface ServiceMeshFeatureSpec {
    ...
    interface UpgradeRolloutSequenceRequest {
      ...
      upgradeType?: 'UPGRADE_TYPE_UNSPECIFIED' | 'CONTROL_PLANE' | 'NODE';
    ...
    interface RolloutsResource {
      ...
      forceCompleteStage(request: {
        ...
        uploadType?: string;
        /** Request body */
        resource: ForceCompleteRolloutStageRequest;
      }): Request<Operation>;
      forceCompleteStage(
        request: {
          /** V1 error format. */
    ...
    interface RolloutSequencesResource {
      ...
      upgrade(request: {
        ...
        uploadType?: string;
        /** Request body */
        resource: UpgradeRolloutSequenceRequest;
      }): Request<Operation>;
      upgrade(
        request: {
          /** V1 error format. */
