...
// Generated from: https://analyticshub.googleapis.com/$discovery/rest?version=v1beta1
// Revision: 20260201
...
declare namespace gapi.client {
  ...
  namespace analyticshub {
    ...
    interface GoogleCloudBigqueryDataexchangeV1beta1DestinationDataset {
      /** Required. A reference that identifies the destination dataset. */
    ...
    interface GoogleCloudBigqueryDataexchangeV1beta1DestinationDatasetReference {
      /** Required. A unique ID for this dataset, without the project name. The ID must contain only letters (a-z, A-Z), numbers (0-9), or underscores (_). The maximum length is 1,024 characters. */
      datasetId?: string;
      /** Required. The ID of the project containing this dataset. */
      projectId?: string;
    }
    interface GoogleCloudMarketplaceInfo {
