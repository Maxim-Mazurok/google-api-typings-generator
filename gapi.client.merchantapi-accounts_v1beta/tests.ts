...
gapi.load('client', async () => {
  ...
  async function run() {
    ...
    await gapi.client.merchantapi.accounts.getBusinessIdentity({
      name: 'Test string',
    });
    /** Retrieves the business info of an account. */
    await gapi.client.merchantapi.accounts.getBusinessInfo({
      name: 'Test string',
    });
    /** Retrieves a store's homepage. */
    await gapi.client.merchantapi.accounts.getHomepage({
      name: 'Test string',
    });
    /** Retrieve shipping setting information. */
    await gapi.client.merchantapi.accounts.getShippingSettings({
      name: 'Test string',
    });
    ...
    await gapi.client.merchantapi.accounts.updateBusinessIdentity(
      {
        name: 'Test string',
        updateMask: 'Test string',
      },
    ...
    await gapi.client.merchantapi.accounts.updateBusinessInfo(
      {
        name: 'Test string',
        updateMask: 'Test string',
      },
    ...
    await gapi.client.merchantapi.accounts.updateHomepage(
      {
        name: 'Test string',
        updateMask: 'Test string',
      },
    ...
    await gapi.client.merchantapi.accounts.accounttax.get({
      name: 'Test string',
    });
    ...
    await gapi.client.merchantapi.accounts.accounttax.list({
      pageSize: 42,
      pageToken: 'Test string',
      parent: 'Test string',
    });
    /** Updates the tax settings of the account. */
    await gapi.client.merchantapi.accounts.accounttax.patch(
      {
        name: 'Test string',
        updateMask: 'Test string',
      },
        ...
        taxRules: [
          {
            ...
            regionCode: 'Test string',
            selfSpecifiedRateMicros: 'Test string',
            shippingTaxed: true,
            useGoogleRate: true,
          },
        ],
    ...
    await gapi.client.merchantapi.accounts.users.getEmailPreferences({
      name: 'Test string',
    });
    ...
    await gapi.client.merchantapi.accounts.users.updateEmailPreferences(
      {
        name: 'Test string',
        updateMask: 'Test string',
      },
