...
gapi.load('client', async () => {
  ...
  async function run() {
    ...
    await gapi.client.merchantapi.accounts.omnichannelSettings.gbpAccounts.linkGbpAccount(
      {
        parent: 'Test string',
      },
      {
    ...
    await gapi.client.merchantapi.accounts.omnichannelSettings.gbpAccounts.list(
      {
        pageSize: 42,
        pageToken: 'Test string',
        parent: 'Test string',
    ...
    await gapi.client.merchantapi.accounts.omnichannelSettings.lfpProviders.linkLfpProvider(
      ...
      {
        externalAccountId: 'Test string',
        lfpProviderId: 'Test string',
      }
    );
    /** List the LFP provider settings for a given merchant in a given country. */
    await gapi.client.merchantapi.accounts.omnichannelSettings.lfpProviders.list(
      {
        pageSize: 42,
        pageToken: 'Test string',
        parent: 'Test string',
