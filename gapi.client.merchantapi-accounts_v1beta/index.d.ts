...
declare namespace gapi.client {
  ...
  namespace merchantapi {
    ...
    interface GbpAccount {
      ...
      listingCount?: string;
      /** Identifier. The resource name of the GBP account. Format: `accounts/{account}/omnichannelSettings/{omnichannel_setting}/gbpAccount/{gbp_account}` */
      name?: string;
    ...
    interface LinkLfpProviderRequest {
      ...
      externalAccountId?: string;
      /** Required. The id of the LFP provider to link. */
      lfpProviderId?: string;
    }
    ...
    interface ListLfpProvidersResponse {
    ...
    interface OmnichannelSetting {
      ...
      lfpLink?: LfpLink;
      /** Optional. The Local Store Front ([LSF](https://support.google.com/merchants/answer/7178526)) type and state for this country. */
      lsfType?: LsfType;
    ...
    interface GbpAccountsResource {
      ...
      linkGbpAccount(request: {
        ...
        /** OAuth 2.0 token for the current user. */
        oauth_token?: string;
        /** Required. The name of the parent resource under which the GBP accounts are listed. Format: `accounts/{account}/omnichannelSettings/{omnichannel_setting}`. */
        parent: string;
        /** Returns response with indentations and line breaks. */
        prettyPrint?: boolean;
        /** Available to use for quota purposes for server-side applications. Can be any arbitrary string assigned to a user, but should not exceed 40 characters. */
    ...
    interface LfpProvidersResource {
      ...
      linkLfpProvider(request: {
        ...
        /** OAuth 2.0 token for the current user. */
        oauth_token?: string;
        /** Required. The name of the parent resource under which the LFP provider is linked. Format: `accounts/{account}/omnichannelSettings/{omnichannel_setting}`. */
        parent: string;
        /** Returns response with indentations and line breaks. */
        prettyPrint?: boolean;
        /** Available to use for quota purposes for server-side applications. Can be any arbitrary string assigned to a user, but should not exceed 40 characters. */
      ...
      list(request?: {
        ...
        pageSize?: number;
        /** Optional. A page token, received from a previous `ListLfpProviders` call. Provide the page token to retrieve the subsequent page. When paginating, all other parameters provided to `ListLfpProviders` must match the call that provided the page token. */
        pageToken?: string;
        /** Required. The name of the parent resource under which the LFP providers are listed. Format: `accounts/{account}/omnichannelSettings/{omnichannel_setting}`. */
        parent: string;
        /** Returns response with indentations and line breaks. */
        prettyPrint?: boolean;
        /** Available to use for quota purposes for server-side applications. Can be any arbitrary string assigned to a user, but should not exceed 40 characters. */
        ...
        /** Legacy upload protocol for media (e.g. "media", "multipart"). */
        uploadType?: string;
      }): Request<ListLfpProvidersResponse>;
    }
