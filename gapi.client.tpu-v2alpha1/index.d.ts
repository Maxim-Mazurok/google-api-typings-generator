...
declare namespace gapi.client {
  ...
  namespace tpu {
    ...
    interface GetMaintenanceInfoResponse {
      ...
      nodeUpcomingMaintenances?: NodeUpcomingMaintenanceInfo[];
    }
    ...
    interface NodeUpcomingMaintenanceInfo {
    ...
    interface PerformMaintenanceQueuedResourceRequest {
      /** The names of the nodes to perform maintenance on. */
      nodeNames?: string[];
    }
    interface PerformMaintenanceRequest {}
    ...
    interface Standard {
      ...
      capacityUnits?: 'CAPACITY_UNITS_UNSPECIFIED' | 'CORES' | 'CHIPS';
    ...
    interface NodesResource {
      ...
      performMaintenance(request: {
        ...
        uploadType?: string;
        /** Request body */
        resource: PerformMaintenanceRequest;
      }): Request<Operation>;
      performMaintenance(
        request: {
          /** V1 error format. */
    ...
    interface QueuedResourcesResource {
      ...
      getMaintenanceInfo(request?: {
        ...
        /** Legacy upload protocol for media (e.g. "media", "multipart"). */
        uploadType?: string;
      }): Request<GetMaintenanceInfoResponse>;
      ...
      performMaintenanceQueuedResource(request: {
        ...
        uploadType?: string;
        /** Request body */
        resource: PerformMaintenanceQueuedResourceRequest;
      }): Request<Operation>;
