...
gapi.load('client', async () => {
  ...
  async function run() {
    ...
    await gapi.client.tpu.projects.locations.queuedResources.getMaintenanceInfo(
      {
        name: 'Test string',
      },
    );
    ...
    await gapi.client.tpu.projects.locations.queuedResources.performMaintenanceQueuedResource(
      {
        name: 'Test string',
      },
      {
