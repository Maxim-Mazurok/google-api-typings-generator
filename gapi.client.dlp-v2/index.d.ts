...
declare namespace gapi.client {
  ...
  namespace dlp {
    ...
    interface GooglePrivacyDlpV2AllMessages {}
    ...
    interface GooglePrivacyDlpV2ContentMetadata {
      /** Optional. The file labels associated with the content. */
      fileLabels?: GooglePrivacyDlpV2FileLabel[];
      /** User provided key-value pairs of content metadata. */
      properties?: GooglePrivacyDlpV2KeyValueMetadataProperty[];
    }
    interface GooglePrivacyDlpV2ContentPolicy {
      ...
      loggingConfigs?: GooglePrivacyDlpV2LoggingConfig[];
      ...
      rules?: GooglePrivacyDlpV2PolicyRule[];
    ...
    interface GooglePrivacyDlpV2Conversation {
      ...
      messages?: GooglePrivacyDlpV2ConversationMessage[];
    }
    interface GooglePrivacyDlpV2ConversationLocation {
    ...
    interface GooglePrivacyDlpV2ConversationMessage {
      ...
      messageParts?: GooglePrivacyDlpV2MessagePart[];
      /** The type of message. */
      messageType?: 'MESSAGE_TYPE_UNSPECIFIED' | 'CONTENT' | 'CONTEXT';
    ...
    interface GooglePrivacyDlpV2CreateContentPolicyRequest {
    ...
    interface GooglePrivacyDlpV2DataProfilePubSubCondition {
      /** An expression. */
    ...
    interface GooglePrivacyDlpV2FileLabel {
    ...
    interface GooglePrivacyDlpV2FileLabelInfoType {
      /** Google Drive labels published by Google. */
    ...
    interface GooglePrivacyDlpV2InfoTypeCondition {
    ...
    interface GooglePrivacyDlpV2InfoTypes {
    ...
    interface GooglePrivacyDlpV2InfoTypeSummary {
    ...
    interface GooglePrivacyDlpV2LabelField {
      /** The identifier of the Label Field. */
      id?: string;
      /** The value of the Label Field to match. */
      value?: string;
    }
    interface GooglePrivacyDlpV2LabelFieldMetadata {
      /** The identifier of the Label Field. */
      id?: string;
    ...
    interface GooglePrivacyDlpV2ListContentPoliciesResponse {
      /** List of content policies. */
      contentPolicies?: GooglePrivacyDlpV2ContentPolicy[];
      /** Token to retrieve the next page of results. An empty value means there are no more results. */
      nextPageToken?: string;
    }
    ...
    interface GooglePrivacyDlpV2LogToBigQuery {
    ...
    interface GooglePrivacyDlpV2MessagePart {
    ...
    interface GooglePrivacyDlpV2PolicyAction {
      /** Optional. If set, the verdict will be returned to the user. */
      returnVerdict?: 'CONTENT_POLICY_VERDICT_UNSPECIFIED' | 'ALLOW' | 'BLOCK';
    }
    interface GooglePrivacyDlpV2PolicyCondition {
      /** A condition based on info types. */
      infoTypeCondition?: GooglePrivacyDlpV2InfoTypeCondition;
    }
    interface GooglePrivacyDlpV2PolicyRule {
      ...
      conditions?: GooglePrivacyDlpV2PolicyCondition[];
    }
    ...
    interface GooglePrivacyDlpV2PublishFindingsToDataplexCatalog {}
    ...
    interface GooglePrivacyDlpV2RequestedRiskAnalysisOptions {
    ...
    interface GooglePrivacyDlpV2SensitivityLabel {
      /** The GUID of the sensitivity label. */
      guid?: string;
    }
    interface GooglePrivacyDlpV2SensitivityLabelMetadata {
    ...
    interface GooglePrivacyDlpV2StringValueBatch {
    ...
    interface GooglePrivacyDlpV2TransformationConfig {
    ...
    interface GooglePrivacyDlpV2UpdateContentPolicyRequest {
    ...
    interface GooglePrivacyDlpV2VersionDescription {
    ...
    interface DiscoveryConfigsResource {
      ...
      create(request: {
        ...
        uploadType?: string;
        /** Request body */
        resource: GooglePrivacyDlpV2CreateDiscoveryConfigRequest;
      ...
      patch(request: {
        ...
        uploadType?: string;
        /** Request body */
        resource: GooglePrivacyDlpV2UpdateDiscoveryConfigRequest;
      }): Request<GooglePrivacyDlpV2DiscoveryConfig>;
      patch(
        request: {
          /** V1 error format. */
    ...
    interface ContentPoliciesResource {
      ...
      create(request: {
        ...
        uploadType?: string;
        /** Request body */
        resource: GooglePrivacyDlpV2CreateContentPolicyRequest;
      }): Request<GooglePrivacyDlpV2ContentPolicy>;
      create(
        request: {
          /** V1 error format. */
          '$.xgafv'?: '1' | '2';
      ...
      list(request?: {
        ...
        /** Legacy upload protocol for media (e.g. "media", "multipart"). */
        uploadType?: string;
      }): Request<GooglePrivacyDlpV2ListContentPoliciesResponse>;
      ...
      patch(request: {
        ...
        uploadType?: string;
        /** Request body */
        resource: GooglePrivacyDlpV2UpdateContentPolicyRequest;
      }): Request<GooglePrivacyDlpV2ContentPolicy>;
      patch(
        request: {
          /** V1 error format. */
    ...
    interface LocationsResource {
      ...
      contentPolicies: ContentPoliciesResource;
      deidentifyTemplates: DeidentifyTemplatesResource;
      discoveryConfigs: DiscoveryConfigsResource;
      dlpJobs: DlpJobsResource;
      fileStoreDataProfiles: FileStoreDataProfilesResource;
