...
gapi.load('client', async () => {
  ...
  async function run() {
            ...
            customInfoTypes: [
              {
                ...
                metadataKeyValueExpression: {
                  keyRegex: 'Test string',
                  valueRegex: 'Test string',
                },
                regex: {
                  groupIndexes: [42],
                  pattern: 'Test string',
    ...
    await gapi.client.dlp.organizations.locations.columnDataProfiles.list({
      filter: 'Test string',
      orderBy: 'Test string',
      pageSize: 42,
      pageToken: 'Test string',
    ...
    await gapi.client.dlp.organizations.locations.connections.create(
      {
        parent: 'Test string',
      },
      {
        connection: {
          cloudSql: {
            ...
            databaseEngine: 'Test string',
            maxConnections: 42,
            usernamePassword: {
              passwordSecretVersionName: 'Test string',
    ...
    await gapi.client.dlp.organizations.locations.connections.get({
      name: 'Test string',
    });
    /** Lists Connections in a parent. Use SearchConnections to see all connections within an organization. */
    await gapi.client.dlp.organizations.locations.connections.list({
      filter: 'Test string',
      pageSize: 42,
      pageToken: 'Test string',
      parent: 'Test string',
    ...
    /** Update a Connection. */
    await gapi.client.dlp.organizations.locations.connections.patch(
      {
        name: 'Test string',
      },
      {
          ...
          actions: [
            {
              ...
              tagResources: {
                lowerDataRiskToLow: true,
                profileGenerationsToTag: ['Test string'],
                tagConditions: [
                  {
                    sensitivityScore: {
                      score: 'Test string',
                ...
                filter: {
                  collection: {
                    includeRegexes: {
                      patterns: [
                        {
                          databaseRegex: 'Test string',
                          databaseResourceNameRegex: 'Test string',
                          instanceRegex: 'Test string',
                          projectIdRegex: 'Test string',
                        },
                      ],
                    },
              ...
              cloudStorageTarget: {
                conditions: {
                  cloudStorageConditions: {
                    includedBucketAttributes: ['Test string'],
                    includedObjectAttributes: ['Test string'],
                  },
                  createdAfter: 'Test string',
                  minAge: 'Test string',
                },
              ...
              otherCloudTarget: {
                conditions: {
                  amazonS3BucketConditions: {
                    bucketTypes: ['Test string'],
                    objectStorageClasses: ['Test string'],
                  },
                  minAge: 'Test string',
                },
                dataSourceType: {
              ...
              vertexDatasetTarget: {
                ...
                filter: {
                  ...
                  vertexDatasetResourceReference: {
                    datasetResourceName: 'Test string',
                  },
                },
                generationCadence: {
                  inspectTemplateModifiedCadence: {
    ...
    await gapi.client.dlp.organizations.locations.fileStoreDataProfiles.delete({
      name: 'Test string',
    });
    /** Gets a file store data profile. */
    await gapi.client.dlp.organizations.locations.fileStoreDataProfiles.get({
      name: 'Test string',
    });
    /** Lists file store data profiles for an organization. */
    await gapi.client.dlp.organizations.locations.fileStoreDataProfiles.list({
      filter: 'Test string',
      orderBy: 'Test string',
      pageSize: 42,
      pageToken: 'Test string',
    ...
    /** Returns a list of the sensitive information types that the DLP API supports. See https://cloud.google.com/sensitive-data-protection/docs/infotypes-reference to learn more. */
    await gapi.client.dlp.organizations.locations.infoTypes.list({
      filter: 'Test string',
      languageCode: 'Test string',
      locationId: 'Test string',
      parent: 'Test string',
            ...
            actions: [
              {
                deidentify: {
                  ...
                  fileTypesToTransform: ['Test string'],
            ...
            storageConfig: {
              ...
              cloudStorageOptions: {
                ...
                fileSet: {
                  regexFileSet: {
                    bucketName: 'Test string',
                    excludeRegex: ['Test string'],
                    includeRegex: ['Test string'],
                  },
                  url: 'Test string',
                },
              ...
              hybridOptions: {
                ...
                requiredFindingLabelKeys: ['Test string'],
                tableOptions: {
                  identifyingFields: [
                    {
                      name: 'Test string',
    ...
    await gapi.client.dlp.organizations.locations.projectDataProfiles.list({
      filter: 'Test string',
      orderBy: 'Test string',
      pageSize: 42,
      pageToken: 'Test string',
    ...
    await gapi.client.dlp.organizations.locations.tableDataProfiles.get({
      name: 'Test string',
    });
    /** Lists table data profiles for an organization. */
    await gapi.client.dlp.organizations.locations.tableDataProfiles.list({
      filter: 'Test string',
      orderBy: 'Test string',
      pageSize: 42,
      pageToken: 'Test string',
    ...
    /** Lists column data profiles for an organization. */
    await gapi.client.dlp.projects.locations.columnDataProfiles.list({
      filter: 'Test string',
      orderBy: 'Test string',
      pageSize: 42,
      pageToken: 'Test string',
    ...
    /** Create a Connection to an external data source. */
    await gapi.client.dlp.projects.locations.connections.create(
      {
        parent: 'Test string',
      },
      {
    ...
    /** Get a Connection by name. */
    await gapi.client.dlp.projects.locations.connections.get({
      name: 'Test string',
    });
    /** Lists Connections in a parent. Use SearchConnections to see all connections within an organization. */
    await gapi.client.dlp.projects.locations.connections.list({
      filter: 'Test string',
      pageSize: 42,
      pageToken: 'Test string',
      parent: 'Test string',
    ...
    /** Update a Connection. */
    await gapi.client.dlp.projects.locations.connections.patch(
      {
        name: 'Test string',
      },
      {
    ...
    await gapi.client.dlp.projects.locations.contentPolicies.create(
      {
        parent: 'Test string',
      },
      {
        ...
        contentPolicyId: 'Test string',
      },
    );
    /** Delete a ContentPolicy. */
    await gapi.client.dlp.projects.locations.contentPolicies.delete({
      name: 'Test string',
    });
    /** Get a ContentPolicy. */
    await gapi.client.dlp.projects.locations.contentPolicies.get({
      name: 'Test string',
    });
    /** Lists ContentPolicies in a parent. */
    await gapi.client.dlp.projects.locations.contentPolicies.list({
      pageSize: 42,
      pageToken: 'Test string',
      parent: 'Test string',
    });
    /** Update a ContentPolicy. */
    await gapi.client.dlp.projects.locations.contentPolicies.patch(
      {
        name: 'Test string',
      },
      {
    ...
    /** Delete a FileStoreDataProfile. Will not prevent the profile from being regenerated if the resource is still included in a discovery configuration. */
    await gapi.client.dlp.projects.locations.fileStoreDataProfiles.delete({
      name: 'Test string',
    });
    /** Gets a file store data profile. */
    await gapi.client.dlp.projects.locations.fileStoreDataProfiles.get({
      name: 'Test string',
    });
    /** Lists file store data profiles for an organization. */
    await gapi.client.dlp.projects.locations.fileStoreDataProfiles.list({
      filter: 'Test string',
      orderBy: 'Test string',
      pageSize: 42,
      pageToken: 'Test string',
    ...
    /** Returns a list of the sensitive information types that the DLP API supports. See https://cloud.google.com/sensitive-data-protection/docs/infotypes-reference to learn more. */
    await gapi.client.dlp.projects.locations.infoTypes.list({
      filter: 'Test string',
      languageCode: 'Test string',
      locationId: 'Test string',
      parent: 'Test string',
    ...
    /** Lists project data profiles for an organization. */
    await gapi.client.dlp.projects.locations.projectDataProfiles.list({
      filter: 'Test string',
      orderBy: 'Test string',
      pageSize: 42,
      pageToken: 'Test string',
    ...
    /** Gets a table data profile. */
    await gapi.client.dlp.projects.locations.tableDataProfiles.get({
      name: 'Test string',
    });
    /** Lists table data profiles for an organization. */
    await gapi.client.dlp.projects.locations.tableDataProfiles.list({
      filter: 'Test string',
      orderBy: 'Test string',
      pageSize: 42,
      pageToken: 'Test string',
