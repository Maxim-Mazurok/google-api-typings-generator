...
gapi.load('client', async () => {
  ...
  async function run() {
    ...
    /** Create an Instance. */
    await gapi.client.run.namespaces.instances.create(
      {
        dryRun: 'Test string',
        parent: 'Test string',
      },
    ...
    /** Delete an Instance. */
    await gapi.client.run.namespaces.instances.delete({
      apiVersion: 'Test string',
      dryRun: 'Test string',
      kind: 'Test string',
      name: 'Test string',
    ...
    /** Get an Instance. */
    await gapi.client.run.namespaces.instances.get({
      name: 'Test string',
    });
    /** List Instances. Results are sorted by creation time, descending. */
    await gapi.client.run.namespaces.instances.list({
      continue: 'Test string',
      fieldSelector: 'Test string',
      includeUninitialized: true,
      labelSelector: 'Test string',
    ...
    /** Replace an Instance. */
    await gapi.client.run.namespaces.instances.replaceInstance(
      {
        dryRun: 'Test string',
        name: 'Test string',
      },
    ...
    await gapi.client.run.namespaces.instances.start(
      {
        name: 'Test string',
      },
      {
    ...
    await gapi.client.run.namespaces.instances.stop(
      {
        name: 'Test string',
      },
      {
    ...
    await gapi.client.run.namespaces.workerpools.create(
      {
        dryRun: 'Test string',
        parent: 'Test string',
      },
    ...
    await gapi.client.run.namespaces.workerpools.delete({
      dryRun: 'Test string',
      name: 'Test string',
    });
    /** Gets information about a worker pool. */
    await gapi.client.run.namespaces.workerpools.get({
      name: 'Test string',
    });
    /** Lists worker pools for the given project and region. Results are sorted by creation time, descending. */
    await gapi.client.run.namespaces.workerpools.list({
      continue: 'Test string',
      labelSelector: 'Test string',
      limit: 42,
      parent: 'Test string',
    ...
    await gapi.client.run.namespaces.workerpools.replaceWorkerPool(
      {
        dryRun: 'Test string',
        name: 'Test string',
      },
    ...
    await gapi.client.run.projects.locations.instances.getIamPolicy({
      'options.requestedPolicyVersion': 42,
      resource: 'Test string',
    });
    /** Sets the IAM Access control policy for the specified instance. Overwrites any existing policy. */
    await gapi.client.run.projects.locations.instances.setIamPolicy(
      {
        resource: 'Test string',
      },
      {
    ...
    await gapi.client.run.projects.locations.instances.testIamPermissions(
      {
        resource: 'Test string',
      },
      {
    ...
    await gapi.client.run.projects.locations.workerpools.getIamPolicy({
      'options.requestedPolicyVersion': 42,
      resource: 'Test string',
    });
    /** Sets the IAM Access control policy for the specified worker pool. Overwrites any existing policy. */
    await gapi.client.run.projects.locations.workerpools.setIamPolicy(
      {
        resource: 'Test string',
      },
      {
    ...
    await gapi.client.run.projects.locations.workerpools.testIamPermissions(
      {
        resource: 'Test string',
      },
      {
