...
declare namespace gapi.client {
    ...
    namespace run {
        ...
        interface ObjectMeta {
            ...
            labels?: { [P in string]: string };
            /**
             * The immutable name of the resource. In Cloud Run, name is required when creating top-level resources (Service, Job), and must be unique within a Cloud Run project/region. More info:
             * https://kubernetes.io/docs/user-guide/identifiers#names If ObjectMeta is part of a CreateServiceRequest, name must contain fewer than 50 characters. Otherwise,
             */
            name?: string;
            ...
            /**
             * Optional. Opaque, system-generated value that represents the internal version of this object that can be used by clients to determine when objects have changed. May be used for
             * optimistic concurrency, change detection, and the watch operation on a resource or set of resources. Clients must treat these values as opaque and passed unmodified back to the
             * server or omit the value to disable conflict-detection. More info:
        ...
        interface ServiceStatus {
            ...
            address?: Addressable;
            /**
             * Communicates information about ongoing/complete reconciliation processes that bring the `spec` inline with the observed state of the world. Service-specific conditions include: *
             * `ConfigurationsReady`: `True` when the underlying Configuration is ready. * `RoutesReady`: `True` when the underlying Route is ready. * `Ready`: `True` when all underlying resources
             * are ready.
             */
            conditions?: GoogleCloudRunV1Condition[];
        ...
        interface TaskStatus {
             ...
             */
            completionTime?: string;
            /** Optional. The latest available observations of a task's current state. More info: https://kubernetes.io/docs/concepts/workloads/controllers/job/ */
            conditions?: GoogleCloudRunV1Condition[];
        ...
        interface Volume {
            /**
             * Adapts a ConfigMap into a volume. The contents of the target ConfigMap's Data field will be presented in a volume as files using the keys in the Data field as the file names, unless
        ...
        interface ServicesResource {
            ...
            create(request: {
                ...
                oauth_token?: string;
                /**
                 * The resource's parent. In Cloud Run, it may be one of the following: * `namespaces/{project_id_or_number}` * `projects/{project_id_or_number}/locations/{region}` *
            ...
            delete(request?: {
                ...
                kind?: string;
                /**
                 * The fully qualified name of the service to delete. It can be any of the following forms: * `namespaces/{project_id_or_number}/services/{service_name}` *
            ...
            get(request?: {
                ...
                key?: string;
                /**
                 * The fully qualified name of the service to retrieve. It can be any of the following forms: * `namespaces/{project_id_or_number}/services/{service_name}` *
                 * `projects/{project_id_or_number}/locations/{region}/services/{service_name}` * `projects/{project_id_or_number}/regions/{region}/services/{service_name}`
                 */
                name: string;
                /** OAuth 2.0 token for the current user. */
            ...
            list(request?: {
                ...
                oauth_token?: string;
                /**
                 * The parent from where the resources should be listed. In Cloud Run, it may be one of the following: * `namespaces/{project_id_or_number}` *
            ...
            replaceService(request: {
                ...
                key?: string;
                /**
                 * The fully qualified name of the service to replace. It can be any of the following forms: * `namespaces/{project_id_or_number}/services/{service_name}` *
                 * `projects/{project_id_or_number}/locations/{region}/services/{service_name}` * `projects/{project_id_or_number}/regions/{region}/services/{service_name}`
                 */
                name: string;
                /** OAuth 2.0 token for the current user. */
