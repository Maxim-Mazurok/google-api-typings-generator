...
declare namespace gapi.client {
    ...
    namespace smartdevicemanagement {
        ...
        interface GoogleHomeEnterpriseSdmV1Structure {
            ...
            parentRelations?: GoogleHomeEnterpriseSdmV1StructureParentRelation[];
            /** Structure traits. */
            traits?: { [P in string]: any };
        }
        interface GoogleHomeEnterpriseSdmV1StructureParentRelation {
        ...
        interface DevicesResource {
            ...
            list(request?: {
                ...
                fields?: string;
                /**
                 * Optional filter to list devices. Filters can match the exact assignee (could be a structure or a room). E.g. 'assignee=enterprises/XYZ/structures/abc' Also could filter by
                 * parent (group): 'parent=enterprises/XYZ/groups/jkl' or filter by device custom name (substring match): 'customName=wing'
                 */
                filter?: string;
                /** API key. Your API key identifies your project and provides you with API access, quota, and reports. Required unless you provide an OAuth 2.0 token. */
                key?: string;
        ...
        interface StructuresResource {
            ...
            list(request?: {
                ...
                fields?: string;
                /**
                 * Optional filter to list structures. Filters can match the exact album assigned to the structure. E.g. 'album=enterprises/XYZ/albums/abc' It also support filtering by parent
