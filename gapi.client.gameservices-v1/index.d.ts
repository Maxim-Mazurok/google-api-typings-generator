...
declare namespace gapi.client {
    ...
    function load(urlOrObject: "https://gameservices.googleapis.com/$discovery/rest?version=v1"): Promise<void>;
    /** @deprecated Please load APIs with discovery documents. */
    function load(name: "gameservices", version: "v1"): Promise<void>;
    /** @deprecated Please load APIs with discovery documents. */
