  ...
  async function run() {
    ...
    await gapi.client.bigquerydatatransfer.projects.locations.transferConfigs.create(
      ...
      },
      {
        ...
        managedTableType: 'Test string',
        metadataDestination: {
          dataplexConfiguration: {
            entryGroup: 'Test string',
          },
        },
        name: 'Test string',
        ...
        paramConfig: {
          secretManagerManagedParams: ['Test string'],
        },
        params: {
          A: 42,
        },
    ...
    await gapi.client.bigquerydatatransfer.projects.locations.transferConfigs.transferResources.get(
      {
        name: 'Test string',
      },
    );
    /** Returns information about transfer resources. */
    await gapi.client.bigquerydatatransfer.projects.locations.transferConfigs.transferResources.list(
      {
        filter: 'Test string',
        pageSize: 42,
        pageToken: 'Test string',
    ...
    /** Returns a transfer resource. */
    await gapi.client.bigquerydatatransfer.projects.transferConfigs.transferResources.get(
      {
        name: 'Test string',
      },
    );
    /** Returns information about transfer resources. */
    await gapi.client.bigquerydatatransfer.projects.transferConfigs.transferResources.list(
      {
        filter: 'Test string',
        pageSize: 42,
        pageToken: 'Test string',
