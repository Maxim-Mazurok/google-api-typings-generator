...
// Generated from: https://binaryauthorization.googleapis.com/$discovery/rest?version=v1beta1
// Revision: 20220909

/// <reference types="gapi.client" />

declare namespace gapi.client {
    /** Load Binary Authorization API v1beta1 */
    function load(urlOrObject: "https://binaryauthorization.googleapis.com/$discovery/rest?version=v1beta1"): Promise<void>;
    /** @deprecated Please load APIs with discovery documents. */
    function load(name: "binaryauthorization", version: "v1beta1"): Promise<void>;
    /** @deprecated Please load APIs with discovery documents. */
    function load(name: "binaryauthorization", version: "v1beta1", callback: () => any): void;
