...
declare namespace gapi.client {
    ...
    namespace sheets {
        ...
        interface CellFormat {
            ...
            /**
             * The format of the text in the cell (unless overridden by a format run). Setting a cell-level link will clear the cell's existing links. Setting a link in a format run will clear the
             * cell-level link.
             */
            textFormat?: TextFormat;
        ...
        interface TextFormat {
            ...
            italic?: boolean;
            /**
             * The link destination of the text, if any. Setting a link in a format run will clear an existing cell-level link. When a link is set, the text foreground color will be set to the
             * default link color and the text will be underlined. If these fields are modified in the same request, those values will be used instead of the link defaults.
             */
            link?: Link;
