...
// Generated from: https://googleads.googleapis.com/$discovery/rest?version=v6
// Revision: 20230424

/// <reference types="gapi.client" />

declare namespace gapi.client {
    /** Load Google Ads API v6 */
    function load(urlOrObject: "https://googleads.googleapis.com/$discovery/rest?version=v6"): Promise<void>;
    /** @deprecated Please load APIs with discovery documents. */
    function load(name: "googleads", version: "v6"): Promise<void>;
    /** @deprecated Please load APIs with discovery documents. */
    function load(name: "googleads", version: "v6", callback: () => any): void;
