/* This is stub file for gapi.client.doubleclickbidmanager-v1.1 definition tests */
// IMPORTANT
...
gapi.load('client', async () => {
    ...
    await gapi.client.load('https://doubleclickbidmanager.googleapis.com/$discovery/rest?version=v1.1');
