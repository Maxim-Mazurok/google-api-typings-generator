...
declare namespace gapi.client {
    ...
    function load(urlOrObject: "https://doubleclickbidmanager.googleapis.com/$discovery/rest?version=v1.1"): Promise<void>;
    /** @deprecated Please load APIs with discovery documents. */
    function load(name: "doubleclickbidmanager", version: "v1.1"): Promise<void>;
    /** @deprecated Please load APIs with discovery documents. */
