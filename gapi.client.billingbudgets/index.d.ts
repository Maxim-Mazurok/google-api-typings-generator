...
declare namespace gapi.client {
    ...
    namespace billingbudgets {
        ...
        interface GoogleCloudBillingBudgetsV1CustomPeriod {
            /** Optional. The end date of the time period. If unset, specifies to track all usage incurred since the start_date. */
        ...
        interface GoogleCloudBillingBudgetsV1Filter {
            /**
             * Optional. Specifies to track usage for recurring calendar period. E.g. Assume that CalendarPeriod.QUARTER is set. The budget will track usage from April 1 to June 30, when current
             * calendar month is April, May, June. After that, it will track usage from July 1 to September 30 when current calendar month is July, August, September, and so on.
             */
