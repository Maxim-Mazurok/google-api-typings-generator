...
declare namespace gapi.client {
    ...
    function load(urlOrObject: "https://datamigration.googleapis.com/$discovery/rest?version=v1beta1"): Promise<void>;
    /** @deprecated Please load APIs with discovery documents. */
    function load(name: "datamigration", version: "v1beta1"): Promise<void>;
    /** @deprecated Please load APIs with discovery documents. */
    function load(name: "datamigration", version: "v1beta1", callback: () => any): void;
