...
declare namespace gapi.client {
    /** Load Firebase Realtime Database API v1beta */
    function load(urlOrObject: "https://firebasedatabase.googleapis.com/$discovery/rest?version=v1beta"): Promise<void>;
    ...
    namespace firebasedatabase {
        ...
        // tslint:disable-next-line:no-empty-interface
        interface UndeleteDatabaseInstanceRequest {
        }
        interface InstancesResource {
            ...
            get(request?: {
                ...
                key?: string;
                /**
                 * Required. The fully qualified resource name of the database instance, in the form: `projects/{project-number}/locations/{location-id}/instances/{database-id}`. `database-id` is
                 * a globally unique identifier across all parent collections. For convenience, this method allows you to supply `-` as a wildcard character in place of specific collections under
                 * `projects` and `locations`. The resulting wildcarding form of the method is: `projects/-/locations/-/instances/{database-id}`.
                 */
                name: string;
                /** OAuth 2.0 token for the current user. */
                oauth_token?: string;
            ...
            list(request?: {
                ...
                pageToken?: string;
                /**
                 * Required. The parent project for which to list database instances, in the form: `projects/{project-number}/locations/{location-id}` To list across all locations, use a parent in
            ...
            undelete(request: {
                ...
                uploadType?: string;
                /** Request body */
                resource: UndeleteDatabaseInstanceRequest;
            }): Request<DatabaseInstance>;
            undelete(request: {
                /** V1 error format. */
                "$.xgafv"?: string;
            ...
            body: UndeleteDatabaseInstanceRequest): Request<DatabaseInstance>;
        }
