...
gapi.load('client', async () => {
  ...
  async function run() {
    ...
    await gapi.client.vmwareengine.projects.locations.announcements.get({
      name: 'Test string',
    });
    /** Lists `Announcements` for a given region and project */
    await gapi.client.vmwareengine.projects.locations.announcements.list({
      filter: 'Test string',
      orderBy: 'Test string',
      pageSize: 42,
      pageToken: 'Test string',
    ...
    await gapi.client.vmwareengine.projects.locations.datastores.create(
      {
      ...
      },
      {
        ...
        nfsDatastore: {
          googleFileService: {
            filestoreInstance: 'Test string',
            netappVolume: 'Test string',
          },
    ...
    await gapi.client.vmwareengine.projects.locations.datastores.delete({
      etag: 'Test string',
      name: 'Test string',
      requestId: 'Test string',
    });
    ...
    await gapi.client.vmwareengine.projects.locations.datastores.get({
      name: 'Test string',
    });
    /** Lists `Datastore` resources in a given project and location. */
    await gapi.client.vmwareengine.projects.locations.datastores.list({
      filter: 'Test string',
      orderBy: 'Test string',
      pageSize: 42,
      pageToken: 'Test string',
    ...
    await gapi.client.vmwareengine.projects.locations.datastores.patch(
      {
        name: 'Test string',
        requestId: 'Test string',
    ...
    await gapi.client.vmwareengine.projects.locations.privateClouds.migrateManagementVms(
      {
        name: 'Test string',
      },
      {
    ...
    await gapi.client.vmwareengine.projects.locations.privateClouds.privateCloudDeletionNow(
      {
        name: 'Test string',
      },
      {
        ...
        datastoreMountConfig: [
          {
            ...
            datastoreNetwork: {
              connectionCount: 42,
              mtu: 42,
              networkPeering: 'Test string',
              subnet: 'Test string',
            },
            fileShare: 'Test string',
            nfsVersion: 'Test string',
            servers: ['Test string'],
          },
        ],
        management: true,
    ...
    await gapi.client.vmwareengine.projects.locations.privateClouds.clusters.mountDatastore(
      {
        name: 'Test string',
      },
      {
    ...
    await gapi.client.vmwareengine.projects.locations.privateClouds.clusters.unmountDatastore(
      {
        name: 'Test string',
      },
      {
    ...
    await gapi.client.vmwareengine.projects.locations.privateClouds.upgrades.get(
      {
        name: 'Test string',
      },
    );
    /** Lists past, ongoing and upcoming `Upgrades` for the given private cloud. */
    await gapi.client.vmwareengine.projects.locations.privateClouds.upgrades.list(
      {
        filter: 'Test string',
        orderBy: 'Test string',
        pageSize: 42,
    ...
    await gapi.client.vmwareengine.projects.locations.privateClouds.upgrades.patch(
      {
        name: 'Test string',
        requestId: 'Test string',
        updateMask: 'Test string',
