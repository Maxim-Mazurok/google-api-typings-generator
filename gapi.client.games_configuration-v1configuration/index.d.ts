...
declare namespace gapi.client {
    ...
    function load(urlOrObject: "https://gamesconfiguration.googleapis.com/$discovery/rest?version=v1configuration"): Promise<void>;
    /** @deprecated Please load APIs with discovery documents. */
    function load(name: "gamesConfiguration", version: "v1configuration"): Promise<void>;
    /** @deprecated Please load APIs with discovery documents. */
