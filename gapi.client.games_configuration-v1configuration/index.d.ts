/* Type definitions for non-npm package Google Play Games Services Publishing API v1configuration 0.0 */
...
declare namespace gapi.client {
  /** Load Google Play Games Services Publishing API v1configuration */
  function load(
