...
declare namespace gapi.client {
    ...
    namespace assuredworkloads {
        ...
        interface GoogleCloudAssuredworkloadsVersioningV1beta1AnalyzeWorkloadMoveResponse {
        ...
        interface GoogleCloudAssuredworkloadsVersioningV1beta1ListViolationsResponse {
            /** The next page token. Returns empty if reached the last page. */
            nextPageToken?: string;
            /** List of Violations under a Workload. */
            violations?: GoogleCloudAssuredworkloadsVersioningV1beta1Violation[];
        }
        interface GoogleCloudAssuredworkloadsVersioningV1beta1ListWorkloadsResponse {
            /** The next page token. Return empty if reached the last page. */
            nextPageToken?: string;
            /** List of Workloads under a given parent. */
            workloads?: GoogleCloudAssuredworkloadsVersioningV1beta1Workload[];
        }
        interface GoogleCloudAssuredworkloadsVersioningV1beta1Violation {
        ...
        interface GoogleCloudAssuredworkloadsVersioningV1beta1Workload {
            /**
             * Optional. The billing account used for the resources which are direct children of workload. This billing account is initially associated with the resources created as part of
             * Workload creation. After the initial creation of these resources, the customer can change the assigned billing account. The resource name has the form
             * `billingAccounts/{billing_account_id}`. For example, `billingAccounts/012345-567890-ABCDEF`.
            ...
            cjisSettings?: GoogleCloudAssuredworkloadsVersioningV1beta1WorkloadCJISSettings;
            /** Required. Immutable. Compliance Regime associated with this workload. */
            complianceRegime?: string;
            /** Output only. Count of active Violations in the Workload. */
            complianceStatus?: GoogleCloudAssuredworkloadsVersioningV1beta1WorkloadComplianceStatus;
            /**
             * Output only. Urls for services which are compliant for this Assured Workload, but which are currently disallowed by the ResourceUsageRestriction org policy. Invoke
             * RestrictAllowedResources endpoint to allow your project developers to use these services in their environment."
             */
            ...
            fedrampHighSettings?: GoogleCloudAssuredworkloadsVersioningV1beta1WorkloadFedrampHighSettings;
            /** Required. Input only. Immutable. Settings specific to resources needed for FedRAMP Moderate. */
            fedrampModerateSettings?: GoogleCloudAssuredworkloadsVersioningV1beta1WorkloadFedrampModerateSettings;
            /** Required. Input only. Immutable. Settings specific to resources needed for IL4. */
            il4Settings?: GoogleCloudAssuredworkloadsVersioningV1beta1WorkloadIL4Settings;
            /** Output only. Represents the KAJ enrollment state of the given workload. */
            kajEnrollmentState?: string;
            /**
             * Input only. Settings used to create a CMEK crypto key. When set, a project with a KMS CMEK key is provisioned. This field is deprecated as of Feb 28, 2022. In order to create a
             * Keyring, callers should specify, ENCRYPTION_KEYS_PROJECT or KEYRING in ResourceSettings.resource_type field.
             */
            kmsSettings?: GoogleCloudAssuredworkloadsVersioningV1beta1WorkloadKMSSettings;
            /** Optional. Labels applied to the workload. */
            labels?: { [P in string]: string };
            /** Optional. The resource name of the workload. Format: organizations/{organization}/locations/{location}/workloads/{workload} Read-only. */
            name?: string;
             ...
             * will fail. Always read only.
             */
            resources?: GoogleCloudAssuredworkloadsVersioningV1beta1WorkloadResourceInfo[];
            /**
             * Input only. Resource properties that are used to customize workload resources. These properties (such as custom project id) will be used to create workload resources if possible.
             * This field is optional.
             */
            resourceSettings?: GoogleCloudAssuredworkloadsVersioningV1beta1WorkloadResourceSettings[];
            /**
             * Output only. Represents the SAA enrollment response of the given workload. SAA enrollment response is queried during GetWorkload call. In failure cases, user friendly error message
             * is shown in SAA details page.
             */
            saaEnrollmentResponse?: GoogleCloudAssuredworkloadsVersioningV1beta1WorkloadSaaEnrollmentResponse;
        }
        interface GoogleCloudAssuredworkloadsVersioningV1beta1WorkloadCJISSettings {
            /** Input only. Immutable. Settings used to create a CMEK crypto key. */
            kmsSettings?: GoogleCloudAssuredworkloadsVersioningV1beta1WorkloadKMSSettings;
        }
        interface GoogleCloudAssuredworkloadsVersioningV1beta1WorkloadComplianceStatus {
        ...
        interface GoogleCloudAssuredworkloadsVersioningV1beta1WorkloadFedrampHighSettings {
            /** Input only. Immutable. Settings used to create a CMEK crypto key. */
            kmsSettings?: GoogleCloudAssuredworkloadsVersioningV1beta1WorkloadKMSSettings;
        }
        interface GoogleCloudAssuredworkloadsVersioningV1beta1WorkloadFedrampModerateSettings {
            /** Input only. Immutable. Settings used to create a CMEK crypto key. */
            kmsSettings?: GoogleCloudAssuredworkloadsVersioningV1beta1WorkloadKMSSettings;
        }
        interface GoogleCloudAssuredworkloadsVersioningV1beta1WorkloadIL4Settings {
            /** Input only. Immutable. Settings used to create a CMEK crypto key. */
            kmsSettings?: GoogleCloudAssuredworkloadsVersioningV1beta1WorkloadKMSSettings;
        }
        interface GoogleCloudAssuredworkloadsVersioningV1beta1WorkloadKMSSettings {
            /** Required. Input only. Immutable. The time at which the Key Management Service will automatically create a new version of the crypto key and mark it as the primary. */
            nextRotationTime?: string;
            /**
             * Required. Input only. Immutable. [next_rotation_time] will be advanced by this period when the Key Management Service automatically rotates a key. Must be at least 24 hours and at
        ...
        interface GoogleCloudAssuredworkloadsVersioningV1beta1WorkloadResourceInfo {
            /** Resource identifier. For a project this represents project_number. */
            resourceId?: string;
            /** Indicates the type of resource. */
            resourceType?: string;
        }
        interface GoogleCloudAssuredworkloadsVersioningV1beta1WorkloadResourceSettings {
            /** User-assigned resource display name. If not empty it will be used to create a resource with the specified name. */
            displayName?: string;
            /**
             * Resource identifier. For a project this represents project_id. If the project is already taken, the workload creation will fail. For KeyRing, this represents the keyring_id. For a
        ...
        interface GoogleCloudAssuredworkloadsVersioningV1beta1WorkloadSaaEnrollmentResponse {
            /** Indicates SAA enrollment setup error if any. */
            setupErrors?: string[];
            /** Indicates SAA enrollment status of a given workload. */
            setupStatus?: string;
        ...
        interface WorkloadsResource {
            ...
            analyzeWorkloadMove(request?: {
                ...
                /** Legacy upload protocol for media (e.g. "media", "multipart"). */
                uploadType?: string;
            }): Request<GoogleCloudAssuredworkloadsVersioningV1beta1AnalyzeWorkloadMoveResponse>;
        }
        ...
        interface ViolationsResource {
            ...
            get(request?: {
                ...
                /** Legacy upload protocol for media (e.g. "media", "multipart"). */
                uploadType?: string;
            }): Request<GoogleCloudAssuredworkloadsVersioningV1beta1Violation>;
            /**
            ...
            list(request?: {
                ...
                /** Legacy upload protocol for media (e.g. "media", "multipart"). */
                uploadType?: string;
            }): Request<GoogleCloudAssuredworkloadsVersioningV1beta1ListViolationsResponse>;
        }
        interface WorkloadsResource {
            ...
            get(request?: {
                ...
                /** Legacy upload protocol for media (e.g. "media", "multipart"). */
                uploadType?: string;
            }): Request<GoogleCloudAssuredworkloadsVersioningV1beta1Workload>;
            ...
            list(request?: {
                ...
                /** Legacy upload protocol for media (e.g. "media", "multipart"). */
                uploadType?: string;
            }): Request<GoogleCloudAssuredworkloadsVersioningV1beta1ListWorkloadsResponse>;
            /**
            ...
            patch(request: {
                ...
                uploadType?: string;
                /** Request body */
                resource: GoogleCloudAssuredworkloadsVersioningV1beta1Workload;
            }): Request<GoogleCloudAssuredworkloadsVersioningV1beta1Workload>;
            patch(request: {
                /** V1 error format. */
                "$.xgafv"?: string;
            ...
            body: GoogleCloudAssuredworkloadsVersioningV1beta1Workload): Request<GoogleCloudAssuredworkloadsVersioningV1beta1Workload>;
            /**
