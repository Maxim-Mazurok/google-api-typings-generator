...
declare namespace gapi.client {
  ...
  namespace assuredworkloads {
    ...
    interface GoogleCloudAssuredworkloadsV1beta1AggregateDbFrameworkComplianceReportResponse {
      /** The list of aggregated compliance reports. */
      aggregatedComplianceReports?: GoogleCloudAssuredworkloadsV1beta1AggregatedComplianceReport[];
    }
    interface GoogleCloudAssuredworkloadsV1beta1AggregatedComplianceReport {
    ...
    interface GoogleCloudAssuredworkloadsV1beta1AnalyzeWorkloadMoveResponse {
      ...
      assetMoveAnalyses?: GoogleCloudAssuredworkloadsV1beta1AssetMoveAnalysis[];
    ...
    interface GoogleCloudAssuredworkloadsV1beta1ArchiveResourceEventsRequest {
    ...
    interface GoogleCloudAssuredworkloadsV1beta1ArchiveResourceEventsResponse {
    ...
    interface GoogleCloudAssuredworkloadsV1beta1AssetMoveAnalysis {
      ...
      analysisGroups?: GoogleCloudAssuredworkloadsV1beta1MoveAnalysisGroup[];
    ...
    interface GoogleCloudAssuredworkloadsV1beta1BatchAcknowledgeViolationsRequest {
    ...
    interface GoogleCloudAssuredworkloadsV1beta1BatchAcknowledgeViolationsResponse {
      /** Count of acknowledged violations. */
      acknowledgedViolationsCount?: number;
    }
    interface GoogleCloudAssuredworkloadsV1beta1CELExpression {
    ...
    interface GoogleCloudAssuredworkloadsV1beta1CloudControlAssessmentDetails {
    ...
    interface GoogleCloudAssuredworkloadsV1beta1CloudControlReport {
      ...
      rules?: GoogleCloudAssuredworkloadsV1beta1Rule[];
      /** The list of similar controls. */
      similarControls?: GoogleCloudAssuredworkloadsV1beta1SimilarControls[];
    }
    interface GoogleCloudAssuredworkloadsV1beta1ControlAssessmentDetails {
    ...
    interface GoogleCloudAssuredworkloadsV1beta1DbControlComplianceSummary {
      /** The list of cloud control reports. */
      cloudControlReports?: GoogleCloudAssuredworkloadsV1beta1CloudControlReport[];
    ...
    interface GoogleCloudAssuredworkloadsV1beta1DbFindingSummary {
    ...
    interface GoogleCloudAssuredworkloadsV1beta1DbFrameworkComplianceSummary {
      /** The control assessment details of the framework. */
      controlAssessmentDetails?: GoogleCloudAssuredworkloadsV1beta1ControlAssessmentDetails;
      ...
      targetResourceDetails?: GoogleCloudAssuredworkloadsV1beta1TargetResourceDetails[];
    }
    interface GoogleCloudAssuredworkloadsV1beta1EnableComplianceUpdatesResponse {}
    interface GoogleCloudAssuredworkloadsV1beta1EnableResourceMonitoringResponse {}
    interface GoogleCloudAssuredworkloadsV1beta1FetchDbFrameworkComplianceReportResponse {
      /** The control assessment details of the framework. */
      controlAssessmentDetails?: GoogleCloudAssuredworkloadsV1beta1ControlAssessmentDetails;
      /** The name of the framework. */
      framework?: string;
    ...
    interface GoogleCloudAssuredworkloadsV1beta1ListDbControlComplianceSummariesResponse {
      /** The list of control compliance details. */
      dbControlComplianceSummaries?: GoogleCloudAssuredworkloadsV1beta1DbControlComplianceSummary[];
      /** Output only. The token to retrieve the next page of results. */
      nextPageToken?: string;
    }
    interface GoogleCloudAssuredworkloadsV1beta1ListDbFindingSummariesResponse {
      /** List of finding summary by category. */
      dbFindingSummaries?: GoogleCloudAssuredworkloadsV1beta1DbFindingSummary[];
      /** Output only. The token to retrieve the next page of results. */
      nextPageToken?: string;
    }
    interface GoogleCloudAssuredworkloadsV1beta1ListDbFrameworkComplianceSummariesResponse {
      /** The list of framework compliance summaries. */
      dbFrameworkComplianceSummaries?: GoogleCloudAssuredworkloadsV1beta1DbFrameworkComplianceSummary[];
      /** Output only. The token to retrieve the next page of results. */
      nextPageToken?: string;
    }
    ...
    interface GoogleCloudAssuredworkloadsV1beta1ListWorkloadUpdatesResponse {
      /** The next page token. Return empty if reached the last page. */
      nextPageToken?: string;
      /** The list of workload updates for a given workload. */
      workloadUpdates?: GoogleCloudAssuredworkloadsV1beta1WorkloadUpdate[];
    }
    interface GoogleCloudAssuredworkloadsV1beta1ManualCloudControlAssessmentDetails {
    ...
    interface GoogleCloudAssuredworkloadsV1beta1MoveAnalysisResult {
      ...
      blockers?: GoogleCloudAssuredworkloadsV1beta1MoveImpact[];
      /** List of warnings. These are risks that may or may not result in compliance violations. */
      warnings?: GoogleCloudAssuredworkloadsV1beta1MoveImpact[];
    }
    interface GoogleCloudAssuredworkloadsV1beta1MoveImpact {
      /** Explanation of the impact. */
      detail?: string;
    }
    interface GoogleCloudAssuredworkloadsV1beta1OrgPolicy {
    ...
    interface GoogleCloudAssuredworkloadsV1beta1OrgPolicyPolicyRule {
    ...
    interface GoogleCloudAssuredworkloadsV1beta1OrgPolicyPolicyRuleStringValues {
      /** List of values allowed at this resource. */
      allowedValues?: string[];
      /** List of values denied at this resource. */
      deniedValues?: string[];
    }
    interface GoogleCloudAssuredworkloadsV1beta1OrgPolicyUpdate {
    ...
    interface GoogleCloudAssuredworkloadsV1beta1RevertArchivedResourceEventsRequest {
    ...
    interface GoogleCloudAssuredworkloadsV1beta1RevertArchivedResourceEventsResponse {
      /** The total number of events successfully moved to the original table. */
      movedEventsCount?: number;
    }
    interface GoogleCloudAssuredworkloadsV1beta1Rule {
    ...
    interface GoogleCloudAssuredworkloadsV1beta1SimilarControls {
      /** The ID of the control. */
      controlId?: string;
      /** The name of the framework. */
      framework?: string;
    }
    interface GoogleCloudAssuredworkloadsV1beta1StringList {
      /** Required. The strings in the list. */
      values?: string[];
    }
    interface GoogleCloudAssuredworkloadsV1beta1TargetResourceDetails {
    ...
    interface GoogleCloudAssuredworkloadsV1beta1Trend {
    ...
    interface GoogleCloudAssuredworkloadsV1beta1Violation {
      ...
      exceptionContexts?: GoogleCloudAssuredworkloadsV1beta1ViolationExceptionContext[];
    ...
    interface AssuredworkloadsResource {
      ...
      archiveResourceEvents(request: {
        ...
        uploadType?: string;
        /** Request body */
        resource: GoogleCloudAssuredworkloadsV1beta1ArchiveResourceEventsRequest;
      }): Request<GoogleCloudAssuredworkloadsV1beta1ArchiveResourceEventsResponse>;
      ...
      revertArchivedResourceEvents(request: {
        ...
        uploadType?: string;
        /** Request body */
        resource: GoogleCloudAssuredworkloadsV1beta1RevertArchivedResourceEventsRequest;
      }): Request<GoogleCloudAssuredworkloadsV1beta1RevertArchivedResourceEventsResponse>;
    ...
    interface DbFindingSummariesResource {
      ...
      list(request?: {
        ...
        /** Legacy upload protocol for media (e.g. "media", "multipart"). */
        uploadType?: string;
      }): Request<GoogleCloudAssuredworkloadsV1beta1ListDbFindingSummariesResponse>;
    }
    interface DbControlComplianceSummariesResource {
      ...
      list(request?: {
        ...
        /** Legacy upload protocol for media (e.g. "media", "multipart"). */
        uploadType?: string;
      }): Request<GoogleCloudAssuredworkloadsV1beta1ListDbControlComplianceSummariesResponse>;
    }
    interface DbFrameworkComplianceReportsResource {
      ...
      aggregate(request?: {
        ...
        /** Legacy upload protocol for media (e.g. "media", "multipart"). */
        uploadType?: string;
      }): Request<GoogleCloudAssuredworkloadsV1beta1AggregateDbFrameworkComplianceReportResponse>;
      ...
      fetch(request?: {
        ...
        /** Legacy upload protocol for media (e.g. "media", "multipart"). */
        uploadType?: string;
      }): Request<GoogleCloudAssuredworkloadsV1beta1FetchDbFrameworkComplianceReportResponse>;
    ...
    interface DbFrameworkComplianceSummariesResource {
      ...
      }): Request<GoogleCloudAssuredworkloadsV1beta1ListDbFrameworkComplianceSummariesResponse>;
    }
    ...
    interface ViolationsResource {
      ...
      batchAcknowledgeViolations(request: {
        ...
        uploadType?: string;
        /** Request body */
        resource: GoogleCloudAssuredworkloadsV1beta1BatchAcknowledgeViolationsRequest;
      }): Request<GoogleCloudAssuredworkloadsV1beta1BatchAcknowledgeViolationsResponse>;
    ...
    interface UpdatesResource {
      ...
      apply(request: {
        ...
        uploadType?: string;
        /** Request body */
        resource: GoogleCloudAssuredworkloadsV1beta1ApplyWorkloadUpdateRequest;
      }): Request<GoogleLongrunningOperation>;
      apply(
        request: {
          /** V1 error format. */
      ...
      list(request?: {
        ...
        /** Legacy upload protocol for media (e.g. "media", "multipart"). */
        uploadType?: string;
      }): Request<GoogleCloudAssuredworkloadsV1beta1ListWorkloadUpdatesResponse>;
    }
    interface ViolationsResource {
