...
gapi.load('client', async () => {
    ...
    async function run() {
        ...
        /** Gets the IAM Policy for a resource */
        await gapi.client.servicedirectory.projects.locations.registrationPolicies.getIamPolicy({
            resource: "Test string",
        }, {
            options: {
                requestedPolicyVersion: 42,
        ...
        /** Sets the IAM Policy for a resource */
        await gapi.client.servicedirectory.projects.locations.registrationPolicies.setIamPolicy({
            resource: "Test string",
        }, {
            policy: {
                bindings: [
        ...
        /** Tests IAM permissions for a resource (namespace, service or service workload only). */
        await gapi.client.servicedirectory.projects.locations.registrationPolicies.testIamPermissions({
            resource: "Test string",
        }, {
            permissions: [
                "Test string"
