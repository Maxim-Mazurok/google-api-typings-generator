...
gapi.load('client', async () => {
  ...
  async function run() {
    ...
    await gapi.client.securitycenter.folders.locations.muteConfigs.create(
      {
    ...
    /** Lists mute configs. */
    await gapi.client.securitycenter.folders.locations.muteConfigs.list({
      pageSize: 42,
      pageToken: 'Test string',
      parent: 'Test string',
    });
    ...
    /** Creates a mute config. */
    await gapi.client.securitycenter.organizations.locations.muteConfigs.create(
      {
        muteConfigId: 'Test string',
        parent: 'Test string',
      },
    ...
    /** Lists mute configs. */
    await gapi.client.securitycenter.organizations.locations.muteConfigs.list({
      pageSize: 42,
      pageToken: 'Test string',
      parent: 'Test string',
    });
    ...
    /** Creates a mute config. */
    await gapi.client.securitycenter.projects.locations.muteConfigs.create(
      {
        muteConfigId: 'Test string',
        parent: 'Test string',
      },
    ...
    /** Lists mute configs. */
    await gapi.client.securitycenter.projects.locations.muteConfigs.list({
      pageSize: 42,
      pageToken: 'Test string',
      parent: 'Test string',
    });
