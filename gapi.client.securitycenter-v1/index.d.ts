...
declare namespace gapi.client {
    ...
    function load(urlOrObject: "https://securitycenter.googleapis.com/$discovery/rest?version=v1"): Promise<void>;
    ...
    namespace securitycenter {
        ...
        interface GoogleCloudSecuritycenterV1LintError {
            location?: GoogleCloudSecuritycenterV1Location;
            /** The error message. The location of the issue */
            message?: string;
        }
        interface GoogleCloudSecuritycenterV1LintSecurityHealthAnalyticsCustomModuleExpressionRequest {
            /** CEL expression to be validated. */
            expression?: Expr;
            /** The kind of expression supported by SHA CEL Engine. */
            expressionKind?: string;
            /** Selection criteria for the resource type. */
            resourceSelector?: GoogleCloudSecuritycenterV1ResourceSelector;
        }
        interface GoogleCloudSecuritycenterV1LintSecurityHealthAnalyticsCustomModuleExpressionResponse {
            /** CEL based error set only for erroneous CEL expression. */
            errors?: GoogleCloudSecuritycenterV1LintError[];
        }
        interface GoogleCloudSecuritycenterV1Location {
        ...
        interface AssetsResource {
            ...
            list(request?: {
                ...
                pageToken?: string;
                /**
                 * Required. The name of the parent resource that contains the assets. The value that you can specify on parent depends on the method in which you specify parent. You can specify
                 * one of the following values: "organizations/[organization_id]", "folders/[folder_id]", or "projects/[project_id]".
                 */
                parent: string;
                /** Returns response with indentations and line breaks. */
                prettyPrint?: boolean;
        ...
        interface BigQueryExportsResource {
            ...
            delete(request?: {
                ...
                key?: string;
                /**
                 * Required. The name of the BigQuery export to delete. Its format is organizations/{organization}/bigQueryExports/{export_id}, folders/{folder}/bigQueryExports/{export_id}, or
            ...
            get(request?: {
                ...
                key?: string;
                /**
                 * Required. Name of the BigQuery export to retrieve. Its format is organizations/{organization}/bigQueryExports/{export_id}, folders/{folder}/bigQueryExports/{export_id}, or
                 * projects/{project}/bigQueryExports/{export_id}
                 */
                name: string;
                /** OAuth 2.0 token for the current user. */
        ...
        interface SecurityHealthAnalyticsSettingsResource {
            ...
            lintCustomModuleExpression(request: {
                /** V1 error format. */
                "$.xgafv"?: string;
                /** OAuth access token. */
                access_token?: string;
                ...
                oauth_token?: string;
                /**
                 * Required. Resource name of the scope to test the custom module expression. Its format is "organizations/{organization}/securityHealthAnalyticsSettings",
                 * "folders/{folder}/securityHealthAnalyticsSettings", or "projects/{project}/securityHealthAnalyticsSettings".
                 */
                parent: string;
                /** Returns response with indentations and line breaks. */
                ...
                uploadType?: string;
                /** Request body */
                resource: GoogleCloudSecuritycenterV1LintSecurityHealthAnalyticsCustomModuleExpressionRequest;
            }): Request<GoogleCloudSecuritycenterV1LintSecurityHealthAnalyticsCustomModuleExpressionResponse>;
            lintCustomModuleExpression(request: {
                /** V1 error format. */
                "$.xgafv"?: string;
                /** OAuth access token. */
            ...
            body: GoogleCloudSecuritycenterV1LintSecurityHealthAnalyticsCustomModuleExpressionRequest): Request<GoogleCloudSecuritycenterV1LintSecurityHealthAnalyticsCustomModuleExpressionResponse>;
        ...
        interface FindingsResource {
            ...
            setMute(request: {
                ...
                key?: string;
                /**
                 * Required. The [relative resource name](https://cloud.google.com/apis/design/resource_names#relative_resource_name) of the finding. Example:
