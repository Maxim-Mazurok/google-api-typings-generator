...
declare namespace gapi.client {
  ...
  namespace paymentsresellersubscription {
    ...
    interface GoogleCloudPaymentsResellerSubscriptionV1GenerateUserSessionResponse {
      /** The generated user session. The token size of proportional to the size of the intent payload. Therefore, please be mindful of keeping the request intent payload reasonably small. */
