...
declare namespace gapi.client {
    ...
    namespace paymentsresellersubscription {
        ...
        interface SubscriptionsResource {
            ...
            /**
             * [Deprecated] New partners should be on auto-extend by default. Used by partners to extend a subscription service for their customers on an ongoing basis for the subscription to
