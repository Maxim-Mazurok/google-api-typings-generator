...
gapi.load('client', async () => {
    ...
    async function run() {
        ...
        /**
         * [Deprecated] New partners should be on auto-extend by default. Used by partners to extend a subscription service for their customers on an ongoing basis for the subscription to remain
