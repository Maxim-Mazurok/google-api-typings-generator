...
// Generated from: https://googleads.googleapis.com/$discovery/rest?version=v8
// Revision: 20230502

/// <reference types="gapi.client" />

declare namespace gapi.client {
    /** Load Google Ads API v8 */
    function load(urlOrObject: "https://googleads.googleapis.com/$discovery/rest?version=v8"): Promise<void>;
    /** @deprecated Please load APIs with discovery documents. */
    function load(name: "googleads", version: "v8"): Promise<void>;
    /** @deprecated Please load APIs with discovery documents. */
    function load(name: "googleads", version: "v8", callback: () => any): void;
