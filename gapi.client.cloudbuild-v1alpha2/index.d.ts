...
// Generated from: https://cloudbuild.googleapis.com/$discovery/rest?version=v1alpha2
// Revision: 20220921

/// <reference types="gapi.client" />

declare namespace gapi.client {
    /** Load Cloud Build API v1alpha2 */
    function load(urlOrObject: "https://cloudbuild.googleapis.com/$discovery/rest?version=v1alpha2"): Promise<void>;
    /** @deprecated Please load APIs with discovery documents. */
    function load(name: "cloudbuild", version: "v1alpha2"): Promise<void>;
    /** @deprecated Please load APIs with discovery documents. */
    function load(name: "cloudbuild", version: "v1alpha2", callback: () => any): void;
    ...
    namespace cloudbuild {
        ...
        interface NetworkConfig {
            /**
             * Required. Immutable. The network definition that the workers are peered to. If this section is left empty, the workers will be peered to WorkerPool.project_id on the default
             * network. Must be in the format `projects/{project}/global/networks/{network}`, where {project} is a project number, such as `12345`, and {network} is the name of a VPC network in
             * the project.
             */
        ...
        interface WorkerPool {
            ...
            deleteTime?: string;
            /**
             * Output only. The resource name of the `WorkerPool`. Format of the name is `projects/{project_id}/workerPools/{worker_pool_id}`, where the value of {worker_pool_id} is provided in
        ...
        interface WorkerPoolsResource {
            ...
            patch(request: {
                ...
                key?: string;
                /**
                 * Output only. The resource name of the `WorkerPool`. Format of the name is `projects/{project_id}/workerPools/{worker_pool_id}`, where the value of {worker_pool_id} is provided
                 * in the CreateWorkerPool request.
                 */
                name: string;
                /** OAuth 2.0 token for the current user. */
                oauth_token?: string;
