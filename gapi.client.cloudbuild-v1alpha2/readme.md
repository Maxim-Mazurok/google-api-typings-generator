# TypeScript typings for Cloud Build API v1alpha2
...
```
npm install @types/gapi.client.cloudbuild-v1alpha2 --save-dev
```
...
```typescript
gapi.client.load('https://cloudbuild.googleapis.com/$discovery/rest?version=v1alpha2', () => {
  // now we can use:
...
gapi.client.load('cloudbuild', 'v1alpha2', () => {
  // now we can use:
  // gapi.client.cloudbuild
});
```
