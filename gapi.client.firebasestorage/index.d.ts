...
declare namespace gapi.client {
    ...
    function load(name: "firebasestorage", version: "v1beta"): PromiseLike<void>;
    ...
    namespace firebasestorage {
        ...
        interface BucketsResource {
            ...
            addFirebase(request: {
                ...
                alt?: string;
                /**
                 * Required. Resource name of the bucket, mirrors the ID of the underlying Google Cloud Storage bucket. Because bucket resource names are unique across projects, you may omit the
                 * project number, `projects/-/buckets/{bucket_id}`.
                 */
                bucket: string;
                /** JSONP */
                callback?: string;
