...
declare namespace gapi.client {
    ...
    namespace ondemandscanning {
        ...
        interface PackageData {
            ...
            package?: string;
            /**
             * The projectId of the package to which this data belongs. Most of Drydock's code does not set or use this field. This is added specifically so we can group packages by projects and
             * decide whether or not to apply NVD data to the packages belonging to a specific project.
             */
            projectId?: string;
