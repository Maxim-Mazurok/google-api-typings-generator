...
declare namespace gapi.client {
    ...
    namespace ondemandscanning {
        ...
        interface GrafeasV1SlsaProvenance_0_2SlsaBuilder {
            id?: string;
        }
        interface GrafeasV1SlsaProvenance_0_2SlsaCompleteness {
            environment?: boolean;
            materials?: boolean;
            parameters?: boolean;
        }
        interface GrafeasV1SlsaProvenance_0_2SlsaConfigSource {
            digest?: { [P in string]: string };
            entryPoint?: string;
            uri?: string;
        }
        interface GrafeasV1SlsaProvenance_0_2SlsaInvocation {
            configSource?: GrafeasV1SlsaProvenance_0_2SlsaConfigSource;
            environment?: { [P in string]: any };
            parameters?: { [P in string]: any };
        }
        interface GrafeasV1SlsaProvenance_0_2SlsaMaterial {
            digest?: { [P in string]: string };
            uri?: string;
        }
        interface GrafeasV1SlsaProvenance_0_2SlsaMetadata {
            buildFinishedOn?: string;
            buildInvocationId?: string;
            buildStartedOn?: string;
            completeness?: GrafeasV1SlsaProvenance_0_2SlsaCompleteness;
        ...
        interface InTotoStatement {
            ...
            slsaProvenance02?: SlsaProvenance_0_2;
            subject?: Subject[];
        }
        interface Jwt {
        ...
        interface SlsaProvenance_0_2 {
            buildConfig?: { [P in string]: any };
            builder?: GrafeasV1SlsaProvenance_0_2SlsaBuilder;
            buildType?: string;
            invocation?: GrafeasV1SlsaProvenance_0_2SlsaInvocation;
            materials?: GrafeasV1SlsaProvenance_0_2SlsaMaterial[];
            metadata?: GrafeasV1SlsaProvenance_0_2SlsaMetadata;
        }
