...
declare namespace gapi.client {
  ...
  namespace beyondcorp {
    ...
    interface GoogleCloudBeyondcorpSecuritygatewaysV1alphaApplication {
      ...
      endpointMatchers?: GoogleCloudBeyondcorpSecuritygatewaysV1alphaEndpointMatcher[];
      /** Identifier. Name of the resource. */
      name?: string;
      /** Output only. Timestamp when the resource was last modified. */
      updateTime?: string;
    }
    interface GoogleCloudBeyondcorpSecuritygatewaysV1alphaEndpointMatcher {
    ...
    interface GoogleCloudBeyondcorpSecuritygatewaysV1alphaNatGatewayConfig {
      /** Output only. List of NAT IPs that will be used for establishing connection to the endpoints. */
      natIps?: string[];
    }
    interface GoogleCloudBeyondcorpSecuritygatewaysV1alphaPeering {
    ...
    interface GoogleCloudBeyondcorpSecuritygatewaysV1alphaSecurityGateway {
      ...
      hubs?: {[P in string]: GoogleCloudBeyondcorpSecuritygatewaysV1alphaHub};
      /** Identifier. Name of the resource. */
      name?: string;
    ...
    interface GoogleCloudBeyondcorpSecuritygatewaysV1alphaSetPeeringRequest {
      /** Optional. An optional request ID to identify requests. Specify a unique request ID so that if you must retry your request, the server will know to ignore the request if it has already been completed. The server will guarantee that for at least 60 minutes since the first request. For example, consider a situation where you make an initial request and the request times out. If you make the request again with the same request ID, the server can check if original operation with the same request ID was received, and if so, will ignore the second request. This prevents clients from accidentally creating duplicate commitments. The request ID must be a valid UUID with the exception that zero UUID is not supported (00000000-0000-0000-0000-000000000000). */
      requestId?: string;
      /** Optional. If set, validates request by executing a dry-run which would not alter the resource in any way. */
      validateOnly?: boolean;
      /** Required. List of Peering connection information. */
      vpcPeerings?: GoogleCloudBeyondcorpSecuritygatewaysV1alphaPeering[];
    }
    interface GoogleCloudBeyondcorpSecuritygatewaysV1SecurityGatewayOperationMetadata {
      /** Output only. API version used to start the operation. */
      apiVersion?: string;
      /** Output only. The time the operation was created. */
      createTime?: string;
    ...
    interface SecurityGatewaysResource {
      ...
      setPeering(request: {
        ...
        uploadType?: string;
        /** Request body */
        resource: GoogleCloudBeyondcorpSecuritygatewaysV1alphaSetPeeringRequest;
      }): Request<GoogleLongrunningOperation>;
      setPeering(
        request: {
          /** V1 error format. */
