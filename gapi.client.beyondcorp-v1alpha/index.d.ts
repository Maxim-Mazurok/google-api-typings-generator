    ...
    namespace beyondcorp {
        ...
        interface PartnerTenantsResource {
            ...
            create(request: {
                ...
                oauth_token?:
                    string;
                /** Required. The resource name of the PartnerTenant using the form: `organizations/{organization_id}/locations/global` */
                parent:
                    string;
        ...
        interface ProxyConfigsResource {
            ...
            create(request: {
                ...
                oauth_token?:
                    string;
                /** Required. The resource name of the ProxyConfig using the form: `organizations/{organization_id}/locations/global/tenants/{tenant_id}` */
                parent:
                    string;
                /** Returns response with indentations and line breaks. */
                prettyPrint?:
            ...
            get(request?: {
                ...
                key?:
                    string;
                /** Required. The resource name of the Tenant using the form: `organizations/{organization_id}/locations/global/tenants/{tenant_id}/proxyConfigs/{proxy_config_id}` */
                name:
                    string;
                /** OAuth 2.0 token for the current user. */
                oauth_token?:
