...
declare namespace gapi.client {
    ...
    namespace beyondcorp {
        ...
        interface GoogleCloudBeyondcorpPartnerservicesV1alphaBrowserDlpRule {
        ...
        interface GoogleCloudBeyondcorpPartnerservicesV1alphaEncryptionInfo {
        ...
        interface GoogleCloudBeyondcorpPartnerservicesV1alphaGroup {
            /** The group email id */
            email?:
                string;
            /** Google group id */
        ...
        interface GoogleCloudBeyondcorpPartnerservicesV1alphaListPartnerTenantsResponse {
        ...
        interface GoogleCloudBeyondcorpPartnerservicesV1alphaPartnerMetadata {
            /** Optional. UUID used by the Partner to refer to the PartnerTenant in their internal systems. */
            partnerTenantId?:
                string;
        }
        interface GoogleCloudBeyondcorpPartnerservicesV1alphaPartnerServiceOperationMetadata {
            /** Output only. API version used to start the operation. */
            apiVersion?:
                string;
            /** Output only. The time the operation was created. */
        ...
        interface GoogleCloudBeyondcorpPartnerservicesV1alphaPartnerTenant {
            /** Output only. Timestamp when the resource was created. */
            createTime?:
                string;
        ...
        interface GoogleCloudBeyondcorpPartnerservicesV1alphaProxyConfig {
            /** Output only. Timestamp when the resource was created. */
            createTime?:
                string;
        ...
        interface GoogleCloudBeyondcorpPartnerservicesV1alphaRoutingInfo {
            /** Required. Proxy Auto-Configuration (PAC) URI. */
            pacUri?:
                string;
        }
        interface GoogleCloudBeyondcorpPartnerservicesV1alphaRuleSetting {
        ...
        interface GoogleCloudBeyondcorpPartnerservicesV1alphaTenant {
            /** Output only. Timestamp when the resource was created. */
            createTime?:
                string;
        ...
        interface GoogleCloudBeyondcorpPartnerservicesV1alphaTransportInfo {
        ...
        interface GoogleCloudBeyondcorpPartnerservicesV1mainPartnerServiceOperationMetadata {
            /** Output only. API version used to start the operation. */
            apiVersion?:
                string;
            /** Output only. The time the operation was created. */
        ...
        interface GoogleCloudBeyondcorpSaasplatformSubscriptionsV1alphaListSubscriptionsResponse {
            /** A token to retrieve the next page of results, or empty if there are no more results in the list. */
            nextPageToken?:
                string;
        ...
        interface GoogleCloudBeyondcorpSaasplatformSubscriptionsV1alphaSubscription {
        ...
        interface BrowserDlpRulesResource {
            ...
            body: GoogleCloudBeyondcorpPartnerservicesV1alphaBrowserDlpRule): Request<GoogleLongrunningOperation>;
            ...
            get(request?: {
                ...
                uploadType?:
                    string;
            }): Request<GoogleCloudBeyondcorpPartnerservicesV1alphaBrowserDlpRule>;
        ...
        interface ProxyConfigsResource {
            ...
            body: GoogleCloudBeyondcorpPartnerservicesV1alphaProxyConfig): Request<GoogleLongrunningOperation>;
            ...
            get(request?: {
                ...
                uploadType?:
                    string;
            }): Request<GoogleCloudBeyondcorpPartnerservicesV1alphaProxyConfig>;
            /** Gets the access control policy for a resource. Returns an empty policy if the resource exists and does not have a policy set. */
            getIamPolicy(request?: {
                /** V1 error format. */
                "$.xgafv"?:
        ...
        interface PartnerTenantsResource {
            ...
            body: GoogleCloudBeyondcorpPartnerservicesV1alphaPartnerTenant): Request<GoogleLongrunningOperation>;
            ...
            get(request?: {
                ...
                uploadType?:
                    string;
            }): Request<GoogleCloudBeyondcorpPartnerservicesV1alphaPartnerTenant>;
            /** Gets the access control policy for a resource. Returns an empty policy if the resource exists and does not have a policy set. */
            getIamPolicy(request?: {
                /** V1 error format. */
                "$.xgafv"?:
            ...
            list(request?: {
                ...
                fields?:
                    string;
                /**
                 * Optional. Filter partnerTenants to be returned. See [List Sub-Collections] (https://cloud.google.com/apis/design/design_patterns#list_sub-collections) for more details. All
                 * fields can be used in the filter. Usage: field_filter="fieldName1=fieldVal1 AND fieldName2=fieldVal2". NOTE: Only `AND` conditions are allowed.
                 */
                filter?:
                    string;
                /** API key. Your API key identifies your project and provides you with API access, quota, and reports. Required unless you provide an OAuth 2.0 token. */
                ...
                oauth_token?:
                    string;
                /**
                 * Optional. Specifies the ordering of results. Currently, only ordering by the "name" and "create_time" fields are supported. See [Sorting
                 * order](https://cloud.google.com/apis/design/design_patterns#sorting_order) for more information.
                 */
                orderBy?:
                    string;
                /**
                 * Optional. The maximum number of items to return. The service may return fewer than this value. If unspecified, at most 50 items will be returned. The maximum value is 1000;
                 * values above 1000 are coerced to 1000. Regardless of the page_size value, the response may include a partial list and a caller should only rely on response's next_page_token to
                ...
                uploadType?:
                    string;
            }): Request<GoogleCloudBeyondcorpPartnerservicesV1alphaListPartnerTenantsResponse>;
            ...
            patch(request: {
                ...
                requestId?:
                    string;
                /**
                 * Required. Field mask is used to specify the fields to be overwritten in the PartnerTenant resource by the update. The fields specified in the update_mask are relative to the
            ...
            body: GoogleIamV1TestIamPermissionsRequest): Request<GoogleIamV1TestIamPermissionsResponse>;
            browserDlpRules:
                BrowserDlpRulesResource;
            proxyConfigs:
                ProxyConfigsResource;
        }
        interface ProxyConfigsResource {
        ...
        interface TenantsResource {
            ...
            body: GoogleCloudBeyondcorpPartnerservicesV1alphaTenant): Request<GoogleLongrunningOperation>;
            ...
            get(request?: {
                ...
                uploadType?:
                    string;
            }): Request<GoogleCloudBeyondcorpPartnerservicesV1alphaTenant>;
            proxyConfigs:
                ProxyConfigsResource;
        }
        interface GlobalResource {
            partnerTenants:
                PartnerTenantsResource;
            tenants:
                TenantsResource;
        }
        ...
        interface SubscriptionsResource {
            ...
            create(request: {
                ...
                resource:
                    GoogleCloudBeyondcorpSaasplatformSubscriptionsV1alphaSubscription;
            }): Request<GoogleCloudBeyondcorpSaasplatformSubscriptionsV1alphaSubscription>;
            create(request: {
                /** V1 error format. */
                "$.xgafv"?:
                    string;
            ...
            body: GoogleCloudBeyondcorpSaasplatformSubscriptionsV1alphaSubscription): Request<GoogleCloudBeyondcorpSaasplatformSubscriptionsV1alphaSubscription>;
            ...
            list(request?: {
                ...
                uploadType?:
                    string;
            }): Request<GoogleCloudBeyondcorpSaasplatformSubscriptionsV1alphaListSubscriptionsResponse>;
        }
        ...
        interface LocationsResource {
            ...
            appConnectors:
                AppConnectorsResource;
            appGateways:
                AppGatewaysResource;
            applications:
                ApplicationsResource;
            clientConnectorServices:
                ClientConnectorServicesResource;
            clientGateways:
                ClientGatewaysResource;
            connections:
                ConnectionsResource;
            connectors:
                ConnectorsResource;
