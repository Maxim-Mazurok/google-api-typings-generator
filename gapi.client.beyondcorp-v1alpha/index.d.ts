...
declare namespace gapi.client {
    ...
    namespace beyondcorp {
        ...
        interface GoogleCloudBeyondcorpPartnerservicesV1alphaListBrowserDlpRulesResponse {
        ...
        interface GoogleCloudBeyondcorpPartnerservicesV1alphaListProxyConfigsResponse {
            /** A token to retrieve the next page of results, or empty if there are no more results in the list. */
            nextPageToken?:
                string;
        ...
        interface BrowserDlpRulesResource {
            ...
            list(request?: {
                ...
                uploadType?:
                    string;
            }): Request<GoogleCloudBeyondcorpPartnerservicesV1alphaListBrowserDlpRulesResponse>;
        ...
        interface ProxyConfigsResource {
            ...
            list(request?: {
                ...
                fields?:
                    string;
                /**
                 * Optional. A filter specifying constraints of a list operation. All fields in the ProxyConfig message are supported. For example, the following query will return the ProxyConfigs
                 * with displayName "test-config" organizations/${ORG_ID}/locations/global/partnerTenants/${PARTNER_TENANT_ID}/proxyConfigs?filter=displayName="test-config" Nested fields are also
                 * supported. The follow query will return ProxyConfigs with pacUri "example.com/pac.pac"
                 * organizations/${ORG_ID}/locations/global/partnerTenants/${PARTNER_TENANT_ID}/proxyConfigs?filter=routingInfo.pacUri="example.com/pac.pac" For more information, please refer to
                ...
                uploadType?:
                    string;
            }): Request<GoogleCloudBeyondcorpPartnerservicesV1alphaListProxyConfigsResponse>;
        ...
        interface PartnerTenantsResource {
            ...
            list(request?: {
                ...
                fields?:
                    string;
                /**
                 * Optional. A filter specifying constraints of a list operation. All fields in the PartnerTenant message are supported. For example, the following query will return the
                 * PartnerTenants with displayName "test-tenant" organizations/${ORG_ID}/locations/${LOCATION}/partnerTenants?filter=displayName="test-tenant" Nested fields are also supported. The
                 * follow query will return PartnerTenants with internal_tenant_id "1234"
                 * organizations/${ORG_ID}/locations/${LOCATION}/partnerTenants?filter=partnerMetadata.internalTenantId="1234" For more information, please refer to https://google.aip.dev/160.
                 */
                filter?:
                    string;
                /** API key. Your API key identifies your project and provides you with API access, quota, and reports. Required unless you provide an OAuth 2.0 token. */
            ...
            patch(request: {
                 ...
                 * resource, not the full request. A field will be overwritten if it is in the mask. If the user does not provide a mask then all fields will be overwritten. Mutable fields:
        ...
        interface ApplicationDomainsResource {
            /** Gets the access control policy for a resource. Returns an empty policy if the resource exists and does not have a policy set. */
            getIamPolicy(request?: {
                /** V1 error format. */
                "$.xgafv"?:
