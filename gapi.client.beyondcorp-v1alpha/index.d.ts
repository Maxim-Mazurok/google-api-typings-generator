...
declare namespace gapi.client {
  ...
  namespace beyondcorp {
    ...
    interface GoogleCloudBeyondcorpSecuritygatewaysV1alphaContextualHeaders {
      ...
      outputType?: 'OUTPUT_TYPE_UNSPECIFIED' | 'PROTOBUF' | 'JSON' | 'NONE';
    ...
    interface GoogleCloudBeyondcorpSecuritygatewaysV1alphaContextualHeadersDelegatedDispatchInfo {
    ...
    interface GoogleCloudBeyondcorpSecuritygatewaysV1alphaLoggingConfig {}
    interface GoogleCloudBeyondcorpSecuritygatewaysV1alphaProxyProtocolConfig {
      ...
      gatewayIdentity?: 'GATEWAY_IDENTITY_UNSPECIFIED' | 'RESOURCE_NAME';
    ...
    interface InsightsResource {
      ...
      get(request?: {
        ...
        view?: 'INSIGHT_VIEW_UNSPECIFIED' | 'BASIC' | 'FULL';
