...
gapi.load('client', async () => {
    ...
    async function run() {
        ...
        await gapi.client.beyondcorp.projects.locations.netConnections.create({
            netConnectionId: "Test string",
            parent: "Test string",
            requestId: "Test string",
            validateOnly: true,
        }, {
        ...
        await gapi.client.beyondcorp.projects.locations.netConnections.delete({
            name: "Test string",
            requestId: "Test string",
            validateOnly: true,
        });
        /** Gets details of a single NetConnection. */
        await gapi.client.beyondcorp.projects.locations.netConnections.get({
            name: "Test string",
        });
        /** Gets the access control policy for a resource. Returns an empty policy if the resource exists and does not have a policy set. */
        ...
        await gapi.client.beyondcorp.projects.locations.netConnections.list({
            filter: "Test string",
            orderBy: "Test string",
            pageSize: 42,
            pageToken: "Test string",
        ...
        await gapi.client.beyondcorp.projects.locations.netConnections.patch({
            allowMissing: true,
            name: "Test string",
            requestId: "Test string",
            updateMask: "Test string",
