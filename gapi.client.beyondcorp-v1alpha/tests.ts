...
gapi.load('client', async () => {
  ...
  async function run() {
    ...
    await gapi.client.beyondcorp.projects.locations.global.securityGateways.create(
      {
        parent: 'Test string',
        requestId: 'Test string',
    ...
    await gapi.client.beyondcorp.projects.locations.global.securityGateways.delete(
      {
        name: 'Test string',
        requestId: 'Test string',
        validateOnly: true,
    ...
    await gapi.client.beyondcorp.projects.locations.global.securityGateways.get(
      {
        name: 'Test string',
      }
    );
    /** Lists SecurityGateways in a given project and global location. */
    await gapi.client.beyondcorp.projects.locations.global.securityGateways.list(
      {
        filter: 'Test string',
        orderBy: 'Test string',
        pageSize: 42,
    ...
    await gapi.client.beyondcorp.projects.locations.global.securityGateways.patch(
      {
        name: 'Test string',
        requestId: 'Test string',
        updateMask: 'Test string',
