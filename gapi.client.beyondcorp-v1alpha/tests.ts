...
gapi.load('client', async () => {
  ...
  async function run() {
    ...
    await gapi.client.beyondcorp.projects.locations.global.securityGateways.hubs.create(
      {
        hubId: 'Test string',
        parent: 'Test string',
        requestId: 'Test string',
    ...
    await gapi.client.beyondcorp.projects.locations.global.securityGateways.hubs.patch(
      {
        name: 'Test string',
        requestId: 'Test string',
        updateMask: 'Test string',
    ...
    /** Returns permissions that a caller has on the specified resource. If the resource does not exist, this will return an empty set of permissions, not a `NOT_FOUND` error. Note: This operation is designed to be used for building permission-aware UIs and command-line tools, not for authorization checking. This operation may "fail open" without warning. */
    await gapi.client.beyondcorp.projects.locations.global.securityGateways.hubs.testIamPermissions(
      {
        resource: 'Test string',
      },
      {
    ...
    await gapi.client.beyondcorp.projects.locations.securityGateways.hubs.delete(
      {
        name: 'Test string',
        requestId: 'Test string',
        validateOnly: true,
    ...
    await gapi.client.beyondcorp.projects.locations.securityGateways.hubs.get({
      name: 'Test string',
    });
    /** Lists Hubs in a given project and location. */
    await gapi.client.beyondcorp.projects.locations.securityGateways.hubs.list({
      filter: 'Test string',
      orderBy: 'Test string',
      pageSize: 42,
      pageToken: 'Test string',
