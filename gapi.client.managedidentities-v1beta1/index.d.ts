/* Type definitions for non-npm package Managed Service for Microsoft Active Directory API v1beta1 0.0 */
...
// Generated from: https://managedidentities.googleapis.com/$discovery/rest?version=v1beta1
// Revision: 20230413

/// <reference types="gapi.client" />

declare namespace gapi.client {
    /** Load Managed Service for Microsoft Active Directory API v1beta1 */
    function load(urlOrObject: "https://managedidentities.googleapis.com/$discovery/rest?version=v1beta1"): Promise<void>;
    /** @deprecated Please load APIs with discovery documents. */
    function load(name: "managedidentities", version: "v1beta1"): Promise<void>;
    /** @deprecated Please load APIs with discovery documents. */
    function load(name: "managedidentities", version: "v1beta1", callback: () => any): void;
    ...
    namespace managedidentities {
        ...
        interface DomainJoinMachineRequest {
            ...
            force?:
                boolean;
            /**
             * Optional. OU name to which the VM needs to be domain joined. If the field is not provided, the VM is joined to the default OU which is created. The default OU for the domain join
             * api is created as GCE Instances under the Cloud OU. Example - OU=GCE Instances,OU=Cloud,DC=ad,DC=test,DC=com If the field is provided, then the custom OU is searched for under GCE
             * Instances OU. Example - if ou_name=test_ou then the VM is domain joined to the following OU: OU=test_ou,OU=GCE Instances,OU=Cloud,DC=ad,DC=test,DC=com if present. If OU is not
        ...
        interface DomainsResource {
            ...
            create(request: {
                ...
                callback?:
                    string;
                /**
                 * Required. A domain name, e.g. mydomain.myorg.com, with the following restrictions: * Must contain only lowercase letters, numbers, periods and hyphens. * Must start with a
                 * letter. * Must contain between 2-64 characters. * Must end with a number or a letter. * Must not start with period. * First segment length (mydomain form example above)
                 * shouldn't exceed 15 chars. * The last segment cannot be fully numeric. * Must be unique within the customer project.
                 */
                domainName?:
                    string;
                /** Selector specifying which fields to include in a partial response. */
