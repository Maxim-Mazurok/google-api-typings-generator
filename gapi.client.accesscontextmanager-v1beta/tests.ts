      ...
      },
      {
        basic: {
          ...
          conditions: [
            {
              devicePolicy: {
                allowedDeviceManagementLevels: ['Test string'],
                allowedEncryptionStatuses: ['Test string'],
                osConstraints: [
                  {
              ...
              ipSubnetworks: ['Test string'],
              members: ['Test string'],
              negate: true,
              regions: ['Test string'],
              requiredAccessLevels: ['Test string'],
            },
          ],
        },
        custom: {
    ...
    await gapi.client.accesscontextmanager.accessPolicies.servicePerimeters.create(
      ...
      },
      {
        ...
        status: {
          ...
          restrictedServices: ['Test string'],
          unrestrictedServices: ['Test string'],
          vpcAccessibleServices: {
            allowedServices: ['Test string'],
