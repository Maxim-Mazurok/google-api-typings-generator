# TypeScript typings for Google Ads API v12
...
```
npm install @types/gapi.client.googleads-v12 --save-dev
```
...
```typescript
gapi.client.load('https://googleads.googleapis.com/$discovery/rest?version=v12', () => {
  // now we can use:
...
gapi.client.load('googleads', 'v12', () => {
  // now we can use:
  // gapi.client.googleads
});
```
