...
declare namespace gapi.client {
    ...
    namespace documentai {
        ...
        interface GoogleCloudDocumentaiUiv1beta3CreateProcessorVersionMetadata {
            /** The creation time of the operation. */
            createTime?: string;
        ...
        interface GoogleCloudDocumentaiV1beta2FormExtractionParams {
            ...
            /**
             * Model version of the form extraction system. Default is "builtin/stable". Specify "builtin/latest" for the latest model. For custom form models, specify: “custom/{model_name}".
             * Model name format is "bucket_name/path/to/modeldir" corresponding to "gs://bucket_name/path/to/modeldir" where annotated examples are stored.
             */
            modelVersion?: string;
        }
        ...
        interface GoogleCloudDocumentaiV1beta2KeyValuePairHint {
            ...
            key?: string;
            /**
             * Type of the value. This is case-insensitive, and could be one of: ADDRESS, LOCATION, ORGANIZATION, PERSON, PHONE_NUMBER, ID, NUMBER, EMAIL, PRICE, TERMS, DATE, NAME. Types not in
        ...
        interface GoogleCloudDocumentaiV1beta2OcrParams {
            /**
             * List of languages to use for OCR. In most cases, an empty value yields the best results since it enables automatic language detection. For languages based on the Latin alphabet,
             * setting `language_hints` is not needed. In rare cases, when the language of the text in the image is known, setting a hint will help get better results (although it will be a
             * significant hindrance if the hint is wrong). Document processing returns an error if one or more of the specified languages is not one of the supported languages.
             */
        ...
        interface GoogleCloudDocumentaiV1beta2ProcessDocumentRequest {
            ...
            /**
             * Specifies a known document type for deeper structure detection. Valid values are currently "general" and "invoice". If not provided, "general"\ is used as default. If any other
            ...
            /**
             * Target project and location to make a call. Format: `projects/{project-id}/locations/{location-id}`. If no location is specified, a region will be chosen automatically. This field
             * is only populated when used in ProcessDocument method.
             */
            parent?: string;
        ...
        interface DocumentsResource {
            ...
            process(request: {
                ...
                oauth_token?: string;
                /**
                 * Target project and location to make a call. Format: `projects/{project-id}/locations/{location-id}`. If no location is specified, a region will be chosen automatically. This
