...
declare namespace gapi.client {
    ...
    namespace documentai {
        ...
        interface GoogleCloudDocumentaiV1ProcessorVersion {
            ...
            schema?: GoogleCloudDocumentaiV1Schema;
        ...
        interface GoogleCloudDocumentaiV1Schema {
            /** Description of the schema. */
            description?: string;
            /** Display name to show to users. */
            displayName?: string;
            /** Entity types of the schema. */
            entityTypes?: GoogleCloudDocumentaiV1SchemaEntityType[];
        }
        interface GoogleCloudDocumentaiV1SchemaEntityType {
            /**
             * Type of the entity. It must be one of the following: `document` - the entity represents a classification of a logical document. `object` - if the entity has properties it is likely
             * an object (or or a document.) `datetime` - the entity is a date or time value. `money` - the entity represents a money value amount. `number` - the entity is a number - integer or
             * floating point. `string` - the entity is a string value. `boolean` - the entity is a boolean value. `address` - the entity is a location address. `duration` - the entity is a
             * duration.
             */
            baseType?: string;
             ...
             */
            properties?: GoogleCloudDocumentaiV1SchemaEntityType[];
            /** Source of this entity type. */
            source?: string;
            /**
             * Name of the type. It must satisfy the following constraints: 1. Must be unique within the set of same level types (with case-insensitive match). 2. Maximum 50 characters. 3. Must
             * start with a letter. 4. Allowed characters: ASCII letters [a-zA-Z], ASCII digits [0-9], or one of the following punctuation characters: * underscore '_' (recommended) * hyphen '-'
             * (allowed, not recommended) * colon ':' (allowed, not recommended) NOTE: Whitespace characters are not allowed. 5. Cannot end with a punctuation character. 6. Cannot contain the
             * following restricted strings: "google", "DocumentAI" (case-insensitive match). 7. A slash character '/' is reserved as a separator in flattened representations of nested entity
             * types (e.g., "line_item/amount") in which case each part (e.g., "line_item", "amount") must comply with the rules defined above. We recommend using the snake case ("snake_case") in
             * entity type names.
             */
            type?: string;
        }
