/* Type definitions for non-npm package Cloud Document AI API v1beta3 1.0 */
...
declare namespace gapi.client {
    ...
    function load(name: "documentai", version: "v1beta3"): PromiseLike<void>;
    ...
    namespace documentai {
        ...
        interface GoogleCloudDocumentaiUiv1beta3EvaluateProcessorVersionResponse {
            ...
            evaluation?: GoogleCloudDocumentaiUiv1beta3Evaluation;
        }
        interface GoogleCloudDocumentaiUiv1beta3Evaluation {
            /** Metrics for all the entities in aggregate. */
            allEntitiesMetrics?: GoogleCloudDocumentaiUiv1beta3EvaluationMultiConfidenceMetrics;
            /** The time that the evaluation was created. */
            createTime?: string;
            /** Metrics across confidence levels, for different entities. */
            entityMetrics?: { [P in string]: GoogleCloudDocumentaiUiv1beta3EvaluationMultiConfidenceMetrics };
        ...
        interface GoogleCloudDocumentaiUiv1beta3EvaluationConfidenceLevelMetrics {
            /** The confidence level. */
            confidenceLevel?: number;
            /** The metrics at the specific confidence level. */
            metrics?: GoogleCloudDocumentaiUiv1beta3EvaluationMetrics;
        }
        ...
        interface GoogleCloudDocumentaiUiv1beta3EvaluationMultiConfidenceMetrics {
            /** Metrics across confidence levels. */
            confidenceLevelMetrics?: GoogleCloudDocumentaiUiv1beta3EvaluationConfidenceLevelMetrics[];
        }
        ...
        interface GoogleCloudDocumentaiUiv1beta3SchemaEntityType {
            /**
             * Type of the entity. It can be either a value type (such as "text", "numeric", "date" and "address"), or an object type which may contain nested entities (such as "document" and
             * "table").
             */
            baseType?: string;
            ...
            /**
             * Describing the nested structure of an entity. An EntityType may consist of several other EntityTypes. For example, in a document there can be an EntityType 'ID', which consists of
             * EntityType 'name' and 'address', with corresponding attributes, such as TEXT for both types and ONCE for occurrence types.
             */
        ...
        interface GoogleCloudDocumentaiUiv1beta3TrainProcessorVersionResponse {
            ...
            processorVersion?: GoogleCloudDocumentaiUiv1beta3ProcessorVersion;
        }
        ...
        interface GoogleCloudDocumentaiV1beta1Document {
            ...
            /**
             * Currently supports Google Cloud Storage URI of the form `gs://bucket_name/object_name`. Object versioning is not supported. See [Google Cloud Storage Request
        ...
        interface GoogleCloudDocumentaiV1beta1DocumentEntityNormalizedValue {
            ...
            /**
             * Required. Normalized entity value stored as a string. This field is populated for supported document type (e.g. Invoice). For some entity types, one of respective 'structured_value'
             * fields may also be populated. - Money/Currency type (`money_value`) is in the ISO 4217 text format. - Date type (`date_value`) is in the ISO 8601 text format. - Datetime type
        ...
        interface GoogleCloudDocumentaiV1beta3BatchProcessRequest {
            ...
            inputDocuments?: GoogleCloudDocumentaiV1beta3BatchProcessRequestBatchInputConfig;
            /** The overall output config for batch process. */
        ...
        interface GoogleCloudDocumentaiV1beta3Document {
            ...
            /** A list of translations on Document.text. For document shards, translations in this list may cross shard boundaries. */
            translations?: GoogleCloudDocumentaiV1beta3DocumentTranslation[];
            /**
             * Currently supports Google Cloud Storage URI of the form `gs://bucket_name/object_name`. Object versioning is not supported. See [Google Cloud Storage Request
             * URIs](https://cloud.google.com/storage/docs/reference-uris) for more info.
             */
        ...
        interface GoogleCloudDocumentaiV1beta3DocumentTranslation {
            /** The BCP-47 language code, such as "en-US" or "sr-Latn". For more information, see http://www.unicode.org/reports/tr35/#Unicode_locale_identifier. */
            languageCode?: string;
            /** The history of this annotation. */
            provenance?: GoogleCloudDocumentaiV1beta3DocumentProvenance[];
        ...
        interface GoogleCloudDocumentaiV1beta3HumanReviewStatus {
            /**
             * The name of the operation triggered by the processed document. Non-empty only when the [state] is [HUMAN_REVIEW_IN_PROGRESS]. It has the same response type and metadata as the long
        ...
        interface ProcessorVersionsResource {
            ...
            process(request: {
                 ...
                 * projects/{project}/locations/{location}/processors/{processor}, or projects/{project}/locations/{location}/processors/{processor}/processorVerions/{processorVersion}
                 */
                name: string;
                /** OAuth 2.0 token for the current user. */
                oauth_token?: string;
