...
declare namespace gapi.client {
    /** Load Cloud Firestore API v1beta1 */
    function load(urlOrObject: "https://firestore.googleapis.com/$discovery/rest?version=v1beta1"): Promise<void>;
    /** @deprecated Please load APIs with discovery documents. */
    function load(name: "firestore", version: "v1beta1"): Promise<void>;
    /** @deprecated Please load APIs with discovery documents. */
    ...
    namespace firestore {
        interface Aggregation {
             ...
             * AGGREGATE COUNT_UP_TO(1) AS count_up_to_1, COUNT_UP_TO(2), COUNT_UP_TO(3) AS count_up_to_3, COUNT(*) OVER ( ... ); ``` becomes: ``` AGGREGATE COUNT_UP_TO(1) AS count_up_to_1,
             * COUNT_UP_TO(2) AS field_1, COUNT_UP_TO(3) AS count_up_to_3, COUNT(*) AS field_2 OVER ( ... ); ``` Requires: * Must be unique across all aggregation aliases. * Conform to document
        ...
        interface ExistenceFilter {
             ...
             * match the target. The client can use the `unchanged_names` bloom filter to assist with this determination by testing ALL the document names against the filter; if the document name
             * is NOT in the filter, it means the document no longer matches the target.
             */
            count?:
                number;
            ...
            targetId?:
                number;
            /**
             * A bloom filter that, despite its name, contains the UTF-8 byte encodings of the resource names of ALL the documents that match target_id, in the form
             * `projects/{project_id}/databases/{database_id}/documents/{document_path}`. This bloom filter may be omitted at the server's discretion, such as if it is deemed that the client will
             * not make use of it or if it is too computationally expensive to calculate or transmit. Clients must gracefully handle this field being absent by falling back to the logic used
             * before this field existed; that is, re-add the target without a resume token to figure out which documents in the client's cache are out of sync.
             */
            unchangedNames?:
                BloomFilter;
        }
        ...
        interface GoogleFirestoreAdminV1beta1ExportDocumentsMetadata {
        ...
        interface GoogleFirestoreAdminV1beta1ExportDocumentsRequest {
        ...
        interface GoogleFirestoreAdminV1beta1ExportDocumentsResponse {
            /** Location of the output files. This can be used to begin an import into Cloud Firestore (this project or another project) after the operation completes successfully. */
            outputUriPrefix?:
                string;
        }
        interface GoogleFirestoreAdminV1beta1ImportDocumentsMetadata {
        ...
        interface GoogleFirestoreAdminV1beta1ImportDocumentsRequest {
        ...
        interface GoogleFirestoreAdminV1beta1Index {
        ...
        interface GoogleFirestoreAdminV1beta1IndexField {
            /**
             * The path of the field. Must match the field path specification described by google.firestore.v1beta1.Document.fields. Special field path `__name__` may be used by itself or at the
             * end of a path. `__type__` may be used only at the end of path.
             */
            fieldPath?:
                string;
            /** The field's mode. */
        ...
        interface GoogleFirestoreAdminV1beta1ListIndexesResponse {
            /** The indexes. */
            indexes?:
        ...
        // tslint:disable-next-line:no-empty-interface
        interface GoogleFirestoreAdminV1beta1LocationMetadata {
        }
        interface GoogleFirestoreAdminV1beta1Progress {
        ...
        interface RunAggregationQueryResponse {
            /**
             * The time at which the aggregate result was computed. This is always monotonically increasing; in this case, the previous AggregationResult in the result stream are guaranteed not to
             * have changed between their `read_time` and this one. If the query returns no results, a response with `read_time` and no `result` will be sent, and this represents the time at which
             * the query was run.
             */
            readTime?:
                string;
        ...
        interface Target {
            ...
            resumeToken?:
                string;
            /**
             * The target ID that identifies the target on the stream. Must be a positive number and non-zero. If `target_id` is 0 (or unspecified), the server will assign an ID for this target
             * and return that in a `TargetChange::ADD` event. Once a target with `target_id=0` is added, all subsequent targets must also have `target_id=0`. If an `AddTarget` request with
             * `target_id != 0` is sent to the server after a target with `target_id=0` is added, the server will immediately send a response with a `TargetChange::Remove` event. Note that if the
             * client sends multiple `AddTarget` requests without an ID, the order of IDs returned in `TargetChage.target_ids` are undefined. Therefore, clients should provide a target ID instead
             * of relying on the server to assign one. If `target_id` is non-zero, there must not be an existing active target on this stream with the same ID.
             */
            targetId?:
                number;
        }
        ...
        interface DocumentsResource {
            ...
            list(request?: {
                ...
                callback?:
                    string;
                /**
                 * Optional. The collection ID, relative to `parent`, to list. For example: `chatrooms` or `messages`. This is optional, and when not provided, Firestore will list documents from
                ...
                pageSize?:
                    number;
                /**
                 * Optional. A page token, received from a previous `ListDocuments` response. Provide this to retrieve the subsequent page. When paginating, all other parameters (with the
                 * exception of `page_size`) must match the values set in the request that generated the page token.
                 */
                pageToken?:
                    string;
                /**
                ...
                readTime?:
                    string;
                /**
                 * If the list should show missing documents. A document is missing if it does not exist, but there are sub-documents nested underneath it. When true, such missing documents will
                 * be returned with a key but will not have fields, `create_time`, or `update_time` set. Requests with `show_missing` may not specify `where` or `order_by`.
                 */
                showMissing?:
                    boolean;
            ...
            body: RunAggregationQueryRequest): Request<RunAggregationQueryResponse>;
            /** Runs a query. */
            runQuery(request: {
                /** V1 error format. */
                "$.xgafv"?:
        ...
        interface IndexesResource {
             ...
             * process can be recovered by fixing the data that caused the error, removing the index with delete, then re-creating the index with create. Indexes with a single field cannot be
             * created.
             */
            create(request: {
                /** V1 error format. */
            ...
            body: GoogleFirestoreAdminV1beta1Index): Request<GoogleLongrunningOperation>;
            /** Deletes an index. */
            delete(request?: {
                /** V1 error format. */
                "$.xgafv"?:
            ...
            list(request?: {
                ...
                uploadType?:
                    string;
            }): Request<GoogleFirestoreAdminV1beta1ListIndexesResponse>;
        }
        interface DatabasesResource {
            ...
            body: GoogleFirestoreAdminV1beta1ExportDocumentsRequest): Request<GoogleLongrunningOperation>;
            /**
            ...
            body: GoogleFirestoreAdminV1beta1ImportDocumentsRequest): Request<GoogleLongrunningOperation>;
            documents:
                DocumentsResource;
            indexes:
                IndexesResource;
