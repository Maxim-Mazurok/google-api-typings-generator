...
declare namespace gapi.client {
  ...
  function load(
    urlOrObject: 'https://firestore.googleapis.com/$discovery/rest?version=v1beta1',
  ): Promise<void>;
  ...
  namespace firestore {
    ...
    interface GoogleFirestoreAdminV1CloneDatabaseMetadata {
    ...
    interface GoogleFirestoreAdminV1PitrSnapshot {
    ...
    interface DocumentsResource {
      ...
      executePipeline(request: {
        ...
        uploadType?: string;
        /** Request body */
        resource: ExecutePipelineRequest;
      }): Request<ExecutePipelineResponse>;
      executePipeline(
        request: {
          /** V1 error format. */
          '$.xgafv'?: string;
