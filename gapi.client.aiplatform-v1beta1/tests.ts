...
gapi.load('client', async () => {
  ...
  async function run() {
    ...
    /** Creates a new Session in a given project and location. */
    await gapi.client.aiplatform.projects.locations.sessions.create(
      {
        parent: 'Test string',
      },
      {
    ...
    /** Deletes details of the specific Session. */
    await gapi.client.aiplatform.projects.locations.sessions.delete({
      name: 'Test string',
    });
    /** Gets details of the specific Session. */
    await gapi.client.aiplatform.projects.locations.sessions.get({
      name: 'Test string',
    });
    /** Lists Sessions in a given project and location. */
    await gapi.client.aiplatform.projects.locations.sessions.list({
      filter: 'Test string',
      orderBy: 'Test string',
      pageSize: 42,
      pageToken: 'Test string',
    ...
    /** Updates the specific Session. */
    await gapi.client.aiplatform.projects.locations.sessions.patch(
      {
        name: 'Test string',
        updateMask: 'Test string',
      },
