...
```
npm install @types/gapi.client.policytroubleshooter-v3 --save-dev
```
...
```json
{
  "compilerOptions": {
    "types": [
      ...
      "gapi.auth2",
      "gapi.client",
      "gapi.client.policytroubleshooter-v3"
    ]
  }
}
```
...
gapi.client.load('policytroubleshooter', 'v3', () => {
  // now we can use:
  // gapi.client.policytroubleshooter
});
```
...
For provenance information see [Provenance section on NPM](https://www.npmjs.com/package/@maxim_mazurok/gapi.client.policytroubleshooter-v3#Provenance:~:text=none-,Provenance,-Built%20and%20signed)
