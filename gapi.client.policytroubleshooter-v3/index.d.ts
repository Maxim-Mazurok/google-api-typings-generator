/* Type definitions for non-npm package Policy Troubleshooter API v3 0.0 */
...
// Generated from: https://policytroubleshooter.googleapis.com/$discovery/rest?version=v3
// Revision: 20260208

/// <reference types="gapi.client" />

declare namespace gapi.client {
  /** Load Policy Troubleshooter API v3 */
  function load(
    urlOrObject: 'https://policytroubleshooter.googleapis.com/$discovery/rest?version=v3',
  ): Promise<void>;
  /** @deprecated Please load APIs with discovery documents. */
  function load(name: 'policytroubleshooter', version: 'v3'): Promise<void>;
  /** @deprecated Please load APIs with discovery documents. */
  function load(
  ...
  namespace policytroubleshooter {
    interface GoogleCloudPolicytroubleshooterIamV3AccessTuple {
    ...
    interface GoogleCloudPolicytroubleshooterIamV3ConditionContext {
      ...
      effectiveTags?: GoogleCloudPolicytroubleshooterIamV3ConditionContextEffectiveTag[];
    ...
    interface GoogleCloudPolicytroubleshooterIamV3ConditionContextEffectiveTag {
    ...
    interface GoogleCloudPolicytroubleshooterIamV3ConditionContextRequest {
      /** Optional. The timestamp when the destination service receives the first byte of the request. */
      receiveTime?: string;
    }
    interface GoogleCloudPolicytroubleshooterIamV3ConditionContextResource {
    ...
    interface IamResource {
      ...
      troubleshoot(request: {
        ...
        uploadType?: string;
        /** Request body */
        resource: GoogleCloudPolicytroubleshooterIamV3TroubleshootIamPolicyRequest;
      }): Request<GoogleCloudPolicytroubleshooterIamV3TroubleshootIamPolicyResponse>;
      troubleshoot(
        request: {
          /** V1 error format. */
          '$.xgafv'?: string;
