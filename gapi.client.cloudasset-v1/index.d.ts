...
declare namespace gapi.client {
    ...
    namespace cloudasset {
        ...
        interface ResourceSearchResult {
            ...
            folders?: string[];
            /**
             * This field only presents for the purpose of backward-compatibility. Please use `kms_keys` field to retrieve KMS key information. This field will only be populated for the resource
             * types included in this [list](https://cloud.google.com/asset-inventory/docs/legacy-fields#resource_types_with_the_to_be_deprecated_kmskey_field) for backward compatible purpose. To
             * search against the `kms_key`: * Use a field query. Example: `kmsKey:key` * Use a free text query. Example: `key`
             */
            kmsKey?: string;
            /**
        ...
        interface V1Resource {
            ...
            searchAllResources(request?: {
                 ...
                 * networkTags * kmsKeys * createTime * updateTime * state * additionalAttributes * versionedResources If read_mask is not specified, all fields except versionedResources will be
