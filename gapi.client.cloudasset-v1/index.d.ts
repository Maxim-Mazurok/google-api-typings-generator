...
declare namespace gapi.client {
    ...
    namespace cloudasset {
        ...
        interface DeniedAccess {
            ...
            deniedAccessTuple?: GoogleCloudAssetV1DeniedAccessAccessTuple;
            /** The details about how denied_access_tuple is denied. */
            denyDetails?: GoogleCloudAssetV1DeniedAccessDenyDetail[];
        }
        ...
        interface GoogleCloudAssetV1DeniedAccessAccess {
            /** The IAM permission in [v1 format](https://cloud.google.com/iam/docs/permissions-reference) */
            permission?: string;
            /** The IAM role. */
            role?: string;
        }
        interface GoogleCloudAssetV1DeniedAccessAccessTuple {
            /** One access from IamPolicyAnalysisResult.AccessControlList.accesses. */
            access?: GoogleCloudAssetV1DeniedAccessAccess;
            /** One identity from IamPolicyAnalysisResult.IdentityList.identities. */
            identity?: GoogleCloudAssetV1DeniedAccessIdentity;
            /** One resource from IamPolicyAnalysisResult.AccessControlList.resources. */
            resource?: GoogleCloudAssetV1DeniedAccessResource;
        }
        interface GoogleCloudAssetV1DeniedAccessDenyDetail {
            /**
             * The denied accesses. If this deny_rule fully denies the denied_access_tuple, this field will be same as AccessTuple.access. Otherwise, this field can contain AccessTuple.access and
             * its descendant accesses, such as a subset of IAM permissions contained in an IAM role.
             */
            accesses?: GoogleCloudAssetV1DeniedAccessAccess[];
            /** A deny rule in an IAM deny policy. */
            denyRule?: GoogleIamV2DenyRule;
            /**
             * Whether the deny_rule fully denies all access granted by the denied_access_tuple. `True` means the deny rule fully blocks the access tuple. `False` means the deny rule partially
             * blocks the access tuple."
             */
            fullyDenied?: boolean;
            /**
             * If this deny_rule fully denies the denied_access_tuple, this field will be same as AccessTuple.identity. Otherwise, this field can contain AccessTuple.identity and its descendant
             * identities, such as a subset of users in a group.
             */
            identities?: GoogleCloudAssetV1DeniedAccessIdentity[];
            /**
             * The resources that the identities are denied access to. If this deny_rule fully denies the denied_access_tuple, this field will be same as AccessTuple.resource. Otherwise, this
             * field can contain AccessTuple.resource and its descendant resources.
             */
            resources?: GoogleCloudAssetV1DeniedAccessResource[];
        }
        interface GoogleCloudAssetV1DeniedAccessIdentity {
            /**
        ...
        interface GoogleCloudAssetV1DeniedAccessResource {
        ...
        interface IamPolicyAnalysis {
            ...
            /**
             * A list of DeniedAccess, which contains all access tuples in the analysis_results that are denied by IAM deny policies. If no access tuples are denied, the list is empty. This is
             * only populated when IamPolicyAnalysisQuery.Options.include_deny_policy_analysis is true.
             */
        ...
        interface Options {
            ...
            includeDenyPolicyAnalysis?: boolean;
