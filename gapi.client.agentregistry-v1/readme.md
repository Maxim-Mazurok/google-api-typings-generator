# TypeScript typings for Agent Registry API v1
...
```
npm install @types/gapi.client.agentregistry-v1 --save-dev
```
...
```typescript
gapi.client.load(
  'https://agentregistry.googleapis.com/$discovery/rest?version=v1',
  () => {
    // now we can use:
...
gapi.client.load('agentregistry', 'v1', () => {
  // now we can use:
  // gapi.client.agentregistry
});
```
...
For provenance information see [Provenance section on NPM](https://www.npmjs.com/package/@maxim_mazurok/gapi.client.agentregistry-v1#Provenance:~:text=none-,Provenance,-Built%20and%20signed)
