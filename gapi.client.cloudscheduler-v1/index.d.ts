...
declare namespace gapi.client {
    ...
    function load(urlOrObject: "https://cloudscheduler.googleapis.com/$discovery/rest?version=v1"): Promise<void>;
    /** @deprecated Please load APIs with discovery documents. */
    function load(name: "cloudscheduler", version: "v1"): Promise<void>;
    /** @deprecated Please load APIs with discovery documents. */
