...
declare namespace gapi.client {
  ...
  function load(
    urlOrObject: 'https://homegraph.googleapis.com/$discovery/rest?version=v1',
  ): Promise<void>;
  /** @deprecated Please load APIs with discovery documents. */
  function load(name: 'homegraph', version: 'v1'): Promise<void>;
  /** @deprecated Please load APIs with discovery documents. */
  ...
  namespace homegraph {
    ...
    interface CameraEventStreamTrait {}
    interface CommonEventDataStruct {
    ...
    interface ComponentTraitUpdates {
      /** Required. ID of the component from the device provider. */
      componentId?: string;
    ...
    interface DeviceMetadata {
      ...
      traitCommitTimestamps?: {[P in string]: string};
    }
    ...
    interface EveUtilityTrait {
      /** Required. Output only. Accepted command list for this trait */
      acceptedCommandList?: 'COMMANDS_UNSPECIFIED'[];
      accumulatedControlPoint?: string;
      airPressure?: number;
      altitude?: number;
      childLock?: boolean;
      current?: number;
      ...
      loggingControlPoint?: string;
      loggingData?: string;
      loggingMetadata?: string;
      loggingTime?: string;
    ...
    interface HomeTraitPayload {
      /** The root component of the device as reported by the provider. */
      rootComponent?: Component;
    }
    interface HomeTraitUpdates {
      /** Required. Trait updates for each component. */
      components?: ComponentTraitUpdates[];
      /** Required. Unique identifier for the device. */
      deviceId?: string;
    }
    interface MediaUrlsStruct {
    ...
    interface MotionEvent {
      ...
      zonesIsEmpty?: boolean;
    }
    interface PartnerPresenceSignalTrait {}
    ...
    interface QueryResponsePayload {
      ...
      deviceMetadata?: {[P in string]: DeviceMetadata};
    ...
    interface ReportStateAndNotificationResponse {
      ...
      deviceResults?: {[P in string]: Result};
    ...
    interface StructurePresenceStateChangeEvent {
    ...
    interface StructurePresenceStateChangeReasonStruct {
    ...
    interface ThermostatFanControlTrait {
    ...
    interface TraitData {
      ...
      trait?: {[P in string]: any};
    }
    interface UserBlameStruct {
