...
// Generated from: https://oslogin.googleapis.com/$discovery/rest?version=v1beta
// Revision: 20260201
...
declare namespace gapi.client {
  ...
  /** @deprecated Please load APIs with discovery documents. */
  function load(name: 'oslogin', version: 'v1beta', callback: () => any): void;

  namespace oslogin {
    interface Empty {}
    interface GoogleCloudOsloginControlplaneRegionalV1betaSignSshPublicKeyRequest {
    ...
    interface GoogleCloudOsloginControlplaneRegionalV1betaSignSshPublicKeyResponse {
    ...
    interface LocationsResource {
      ...
      signSshPublicKey(request: {
        ...
        uploadType?: string;
        /** Request body */
        resource: GoogleCloudOsloginControlplaneRegionalV1betaSignSshPublicKeyRequest;
      }): Request<GoogleCloudOsloginControlplaneRegionalV1betaSignSshPublicKeyResponse>;
      signSshPublicKey(
        request: {
          /** V1 error format. */
          '$.xgafv'?: string;
