...
declare namespace gapi.client {
    ...
    namespace memcache {
        ...
        interface GoogleCloudSaasacceleratorManagementProvidersV1Instance {
            ...
            /**
             * Unique name of the resource. It uses the form: `projects/{project_id|project_number}/locations/{location_id}/instances/{instance_id}` Note: Either project_id or project_number and
