...
// Generated from: https://publicca.googleapis.com/$discovery/rest?version=v1beta1
// Revision: 20230724

/// <reference types="gapi.client" />

declare namespace gapi.client {
    /** Load Public Certificate Authority API v1beta1 */
    function load(urlOrObject: "https://publicca.googleapis.com/$discovery/rest?version=v1beta1"): Promise<void>;
    /** @deprecated Please load APIs with discovery documents. */
    function load(name: "publicca", version: "v1beta1"): Promise<void>;
    /** @deprecated Please load APIs with discovery documents. */
    function load(name: "publicca", version: "v1beta1", callback: () => any): void;
