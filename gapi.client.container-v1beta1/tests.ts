...
gapi.load('client', async () => {
  ...
  async function run() {
    ...
    await gapi.client.container.projects.locations.clusters.completeControlPlaneUpgrade(
      {
        name: 'Test string',
      },
      {
    ...
    await gapi.client.container.projects.locations.clusters.create(
      ...
      },
      {
        cluster: {
          ...
          alphaClusterFeatureGates: ['Test string'],
          ...
          autopilot: {
            clusterPolicyConfig: {
              noStandardNodePools: true,
              noSystemImpersonation: true,
              noSystemMutation: true,
              noUnsafeWebhooks: true,
            },
            conversionStatus: {
              state: 'Test string',
            },
          ...
          autoscaling: {
            autopilotGeneralProfile: 'Test string',
              ...
              upgradeSettings: {
                blueGreenSettings: {
                  autoscaledRolloutPolicy: {
                    waitForDrainDuration: 'Test string',
                  },
          ...
          currentEmulatedVersion: 'Test string',
          ...
          maintenancePolicy: {
            disruptionBudget: {
              lastDisruptionTime: 'Test string',
              lastMinorVersionDisruptionTime: 'Test string',
              minorVersionDisruptionInterval: 'Test string',
              patchVersionDisruptionInterval: 'Test string',
            },
          ...
          master: {
            compatibilityStatus: {
              downgradableVersion: 'Test string',
              emulatedVersionTime: 'Test string',
            },
          },
          masterAuth: {
          ...
          nodeConfig: {
            ...
            consolidationDelay: 'Test string',
            containerdConfig: {
                  ...
                  hosts: [
                    {
                      ca: [
                        {
                          gcpSecretManagerSecretUri: 'Test string',
                        },
                      ],
            ...
            kubeletConfig: {
              ...
              crashLoopBackOff: {
                maxContainerRestartPeriod: 'Test string',
              },
              evictionMaxPodGracePeriodSeconds: 42,
              evictionMinimumReclaim: {
                imagefsAvailable: 'Test string',
                imagefsInodesFree: 'Test string',
                memoryAvailable: 'Test string',
                nodefsAvailable: 'Test string',
                nodefsInodesFree: 'Test string',
                pidAvailable: 'Test string',
              },
              evictionSoft: {
                imagefsAvailable: 'Test string',
                imagefsInodesFree: 'Test string',
              ...
              insecureKubeletReadonlyPortEnabled: true,
              maxParallelImagePulls: 42,
              memoryManager: {
                policy: 'Test string',
              },
              podPidsLimit: 'Test string',
              reservedResourcesConfig: {
                cpuReservedMillicore: 'Test string',
                effectiveCpuReservedMillicore: 'Test string',
                effectiveMemoryReservedMib: 'Test string',
                memoryReservedMib: 'Test string',
              },
              shutdownGracePeriodCriticalPodsSeconds: 42,
              shutdownGracePeriodSeconds: 42,
            ...
            linuxNodeConfig: {
              ...
              customNodeInit: {
                initScript: {
                  args: ['Test string'],
                  gcpSecretManagerSecretUri: 'Test string',
                  gcsGeneration: 'Test string',
                  gcsUri: 'Test string',
                },
              },
              diskIoScheduler: {
                nodeAttachedDiskIoScheduler: 'Test string',
                nodeSystemIoScheduler: 'Test string',
              },
              hugepages: {
                hugepageSize1g: 42,
                hugepageSize2m: 42,
              ...
              transparentHugepageDefrag: 'Test string',
              transparentHugepageEnabled: 'Test string',
            },
            ...
            tags: ['Test string'],
            taintConfig: {
              architectureTaintBehavior: 'Test string',
            },
            taints: [
              {
                effect: 'Test string',
          ...
          nodePools: [
            {
              ...
              instanceGroupUrls: ['Test string'],
              kubeletCertInfo: {
                nonTpmBootstrapCertExpireTime: 'Test string',
                tpmBootstrapCertExpireTime: 'Test string',
              },
              locations: ['Test string'],
              maintenancePolicy: {
              ...
              name: 'Test string',
              networkConfig: {
                acceleratorNetworkProfile: 'Test string',
              ...
              nodeDrainConfig: {
                graceTerminationDuration: 'Test string',
                pdbTimeoutDuration: 'Test string',
          ...
          rollbackSafeUpgrade: {
            controlPlaneSoakDuration: 'Test string',
          },
          satisfiesPzi: true,
          satisfiesPzs: true,
          ...
          userManagedKeysConfig: {
            ...
            controlPlaneDiskEncryptionKeyVersions: ['Test string'],
    ...
    await gapi.client.container.projects.locations.clusters.update(
      ...
      },
      {
        ...
        update: {
          ...
          desiredEmulatedVersion: 'Test string',
          ...
          desiredImage: 'Test string',
          desiredImageProject: 'Test string',
    ...
    /** CompleteControlPlaneUpgrade completes the rollback-safe upgrade by performing the step two upgrade for a specific cluster. */
    await gapi.client.container.projects.zones.clusters.completeControlPlaneUpgrade(
      {
        name: 'Test string',
      },
      {
