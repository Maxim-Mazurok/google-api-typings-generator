...
declare namespace gapi.client {
  ...
  namespace container {
    ...
    interface AdditionalIPRangesConfig {
      ...
      status?: 'STATUS_UNSPECIFIED' | 'ACTIVE' | 'DRAINING';
    ...
    interface AdditionalNodeNetworkConfig {
      ...
      stackType?: 'STACK_TYPE_UNSPECIFIED' | 'IPV4' | 'IPV4_IPV6' | 'IPV6';
    ...
    interface AnonymousAuthenticationConfig {
      ...
      mode?: 'MODE_UNSPECIFIED' | 'ENABLED' | 'LIMITED';
    }
    ...
    interface AutoMonitoringConfig {
      ...
      scope?: 'SCOPE_UNSPECIFIED' | 'ALL' | 'NONE';
    }
    interface Autopilot {
    ...
    interface ControlPlaneEgress {
      /** Defines the mode of control plane egress. */
      mode?: 'MODE_UNSPECIFIED' | 'VIA_CONTROL_PLANE' | 'NONE';
    }
    ...
    interface CrashLoopBackOffConfig {
    ...
    interface DesiredEnterpriseConfig {
      ...
      desiredTier?: 'CLUSTER_TIER_UNSPECIFIED' | 'STANDARD' | 'ENTERPRISE';
    }
    interface DiskIoScheduler {
    ...
    interface ExclusionUntilEndOfSupport {
    ...
    interface GkeAutoUpgradeConfig {
      ...
      patchMode?: 'PATCH_MODE_UNSPECIFIED' | 'ACCELERATED';
    }
    ...
    interface GPUDirectConfig {
      ...
      gpuDirectStrategy?: 'GPU_DIRECT_STRATEGY_UNSPECIFIED' | 'RDMA';
    }
    ...
    interface Location {
      ...
      type?: 'LOCATION_TYPE_UNSPECIFIED' | 'ZONE' | 'REGION';
    }
    ...
    interface ManagedMachineLearningDiagnosticsConfig {
    ...
    interface PodAutoscaling {
      ...
      hpaProfile?: 'HPA_PROFILE_UNSPECIFIED' | 'NONE' | 'PERFORMANCE';
    }
    ...
    interface RecurringMaintenanceWindow {
    ...
    interface ReleaseChannel {
      ...
      channel?: 'UNSPECIFIED' | 'RAPID' | 'REGULAR' | 'STABLE' | 'EXTENDED';
    }
    ...
    interface ReservedResourcesConfig {
      ...
      effectiveCpuReservedMillicore?: string;
      ...
      effectiveMemoryReservedMib?: string;
    ...
    interface RollbackSafeUpgradeStatus {
      ...
      mode?: 'MODE_UNSPECIFIED' | 'KCP_MINOR_UPGRADE_ROLLBACK_SAFE_MODE';
    ...
    interface ScheduleUpgradeConfig {
    ...
    interface UpgradeDetails {
      ...
      startType?: 'START_TYPE_UNSPECIFIED' | 'AUTOMATIC' | 'MANUAL';
      /** Output only. The state of the upgrade. */
      state?: 'UNKNOWN' | 'FAILED' | 'SUCCEEDED' | 'CANCELED' | 'RUNNING';
