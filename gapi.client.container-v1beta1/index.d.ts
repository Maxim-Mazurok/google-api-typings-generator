...
declare namespace gapi.client {
    ...
    namespace container {
        ...
        interface LocalNvmeSsdBlockConfig {
            /**
             * The number of raw-block local NVMe SSD disks to be attached to the node. Each local SSD is 375 GB in size. If zero, it means no raw-block local NVMe SSD disks to be attached to the
