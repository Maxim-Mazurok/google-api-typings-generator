# TypeScript typings for Google Ads API v23
...
```
npm install @types/gapi.client.googleads-v23 --save-dev
```
...
{
  "compilerOptions": {
    "types": ["gapi", "gapi.auth2", "gapi.client", "gapi.client.googleads-v23"]
  }
}
```
...
gapi.client.load('googleads', 'v23', () => {
  // now we can use:
  // gapi.client.googleads
});
```
...
For provenance information see [Provenance section on NPM](https://www.npmjs.com/package/@maxim_mazurok/gapi.client.googleads-v23#Provenance:~:text=none-,Provenance,-Built%20and%20signed)
