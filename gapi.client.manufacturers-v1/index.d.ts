...
declare namespace gapi.client {
  ...
  function load(
    urlOrObject: 'https://manufacturers.googleapis.com/$discovery/rest?version=v1'
  ): Promise<void>;
  /** @deprecated Please load APIs with discovery documents. */
  function load(name: 'manufacturers', version: 'v1'): Promise<void>;
  /** @deprecated Please load APIs with discovery documents. */
  function load(
    name: 'manufacturers',
    version: 'v1',
  ...
  namespace manufacturers {
    interface Attributes {
      ...
      certification?: GoogleShoppingManufacturersV1ProductCertification[];
