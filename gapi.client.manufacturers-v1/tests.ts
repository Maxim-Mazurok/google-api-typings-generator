  ...
  async function run() {
    ...
    await gapi.client.manufacturers.accounts.languages.productCertifications.patch(
      ...
      },
      {
        ...
        destinationStatuses: [
          {
            approvedCountries: ['Test string'],
            destination: 'Test string',
            disapprovedCountries: ['Test string'],
            pendingCountries: ['Test string'],
            status: 'Test string',
          },
        ],
        issues: [
    ...
    await gapi.client.manufacturers.accounts.products.update(
      ...
      },
      {
        ...
        excludedDestination: ['Test string'],
        featureDescription: [
          {
        ...
        includedDestination: ['Test string'],
        intendedCountry: ['Test string'],
