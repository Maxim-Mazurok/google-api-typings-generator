...
declare namespace gapi.client {
    ...
    namespace eventarc {
        ...
        interface GKE {
            ...
            cluster?: string;
            /**
             * Required. The name of the Google Compute Engine in which the cluster resides, which can either be compute zone (e.g. us-central1-a) for the zonal clusters or region (e.g.
            ...
            namespace?: string;
            /**
             * Optional. The relative path on the GKE service the events should be sent to. The value must conform to the definition of URI path segment (section 3.3 of RFC2396). Examples:
             * "/route", "route", "route/subroute".
             */
            path?: string;
        ...
        interface Trigger {
             ...
             * triggers, the service account should also have `roles/eventarc.eventReceiver` IAM role.
             */
            serviceAccount?: string;
            /**
             * Optional. In order to deliver messages, Eventarc may use other GCP products as transport intermediary. This field contains a reference to that transport intermediary. This
