...
gapi.load('client', async () => {
  ...
  async function run() {
    ...
    await gapi.client.iamcredentials.locations.workforcePools.getAllowedLocations(
      {
        name: 'Test string',
      },
    );
    /** Returns the trust boundary info for a given workload identity pool. */
    await gapi.client.iamcredentials.projects.locations.workloadIdentityPools.getAllowedLocations(
      {
        name: 'Test string',
      },
    );
