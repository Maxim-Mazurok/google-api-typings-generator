...
declare namespace gapi.client {
  ...
  namespace dataform {
    ...
    interface BigQueryUnitTestAction {
    ...
    interface CheckoutWorkspaceBranchRequest {
    ...
    interface EndUserAuthenticationConfig {
    ...
    interface FetchCurrentWorkspaceBranchResponse {
    ...
    interface FetchWorkspaceBranchesResponse {
    ...
    interface GcsRepositorySnapshotDestination {
    ...
    interface GcsRepositorySnapshotMetadata {
    ...
    interface SyncWorkspaceRefsRequest {
    ...
    interface SyncWorkspaceRefsResponse {}
    ...
    interface WorkspacesResource {
      ...
      checkout(request: {
        ...
        uploadType?: string;
        /** Request body */
        resource: CheckoutWorkspaceBranchRequest;
      }): Request<{}>;
      checkout(
        request: {
          /** V1 error format. */
      ...
      fetchBranches(request?: {
        ...
        /** Optional. Filter for the returned list. */
        filter?:
          'BRANCH_FILTER_UNSPECIFIED' | 'LOCAL_ONLY' | 'REMOTE_ONLY' | 'ALL';
        /** API key. Your API key identifies your project and provides you with API access, quota, and reports. Required unless you provide an OAuth 2.0 token. */
        key?: string;
        /** Required. The workspace resource name. Format: projects/{project}/locations/{location}/repositories/{repository}/workspaces/{workspace} */
        name: string;
        ...
        /** Legacy upload protocol for media (e.g. "media", "multipart"). */
        uploadType?: string;
      }): Request<FetchWorkspaceBranchesResponse>;
      /** Fetches the current branch of a Workspace. */
      fetchCurrentBranch(request?: {
        /** V1 error format. */
        '$.xgafv'?: '1' | '2';
        /** OAuth access token. */
        access_token?: string;
        ...
        /** Legacy upload protocol for media (e.g. "media", "multipart"). */
        uploadType?: string;
      }): Request<FetchCurrentWorkspaceBranchResponse>;
      ...
      syncWorkspaceRefs(request: {
        ...
        uploadType?: string;
        /** Request body */
        resource: SyncWorkspaceRefsRequest;
      }): Request<{}>;
      syncWorkspaceRefs(
        request: {
          /** V1 error format. */
