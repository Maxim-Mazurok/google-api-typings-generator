...
gapi.load('client', async () => {
  ...
  async function run() {
    ...
    await gapi.client.dataform.projects.locations.repositories.deleteLongRunning(
      {
        name: 'Test string',
      },
      {
    ...
    await gapi.client.dataform.projects.locations.repositories.workflowConfigs.create(
      ...
      },
      {
        ...
        workflowTriggerConfig: {
          ...
          lastSuccessfulEvaluationTime: 'Test string',
          maxWaitDuration: 'Test string',
          minExecutionDuration: 'Test string',
          recentTriggerEvaluationRecords: [
            {
              evaluationTime: 'Test string',
              status: {
                code: 42,
                details: [
                  {
    ...
    await gapi.client.dataform.projects.locations.repositories.workspaces.checkout(
      {
        name: 'Test string',
      },
      {
    ...
    await gapi.client.dataform.projects.locations.repositories.workspaces.deleteBranch(
      {
        name: 'Test string',
      },
      {
    ...
    await gapi.client.dataform.projects.locations.repositories.workspaces.fetchBranches(
      {
        filter: 'Test string',
        name: 'Test string',
        pageSize: 42,
    ...
    await gapi.client.dataform.projects.locations.repositories.workspaces.fetchCurrentBranch(
      {
        name: 'Test string',
      },
    );
    ...
    await gapi.client.dataform.projects.locations.repositories.workspaces.syncWorkspaceRefs(
      {
        name: 'Test string',
      },
      {
        deepen: 42,
        remoteBranchName: 'Test string',
      },
    );
    /** Returns permissions that a caller has on the specified resource. If the resource does not exist, this will return an empty set of permissions, not a `NOT_FOUND` error. Note: This operation is designed to be used for building permission-aware UIs and command-line tools, not for authorization checking. This operation may "fail open" without warning. */
