...
gapi.load('client', async () => {
  ...
  async function run() {
    ...
    /** Gets the access control policy for a resource. Returns an empty policy if the resource exists and does not have a policy set. */
    await gapi.client.dataform.projects.locations.repositories.commentThreads.getIamPolicy(
      {
        'options.requestedPolicyVersion': 42,
        resource: 'Test string',
      }
    ...
    /** Sets the access control policy on the specified resource. Replaces any existing policy. Can return `NOT_FOUND`, `INVALID_ARGUMENT`, and `PERMISSION_DENIED` errors. */
    await gapi.client.dataform.projects.locations.repositories.commentThreads.setIamPolicy(
      {
        resource: 'Test string',
      },
      {
    ...
    /** Gets the access control policy for a resource. Returns an empty policy if the resource exists and does not have a policy set. */
    await gapi.client.dataform.projects.locations.repositories.commentThreads.comments.getIamPolicy(
      {
        'options.requestedPolicyVersion': 42,
        resource: 'Test string',
      }
    ...
    /** Sets the access control policy on the specified resource. Replaces any existing policy. Can return `NOT_FOUND`, `INVALID_ARGUMENT`, and `PERMISSION_DENIED` errors. */
    await gapi.client.dataform.projects.locations.repositories.commentThreads.comments.setIamPolicy(
      {
        resource: 'Test string',
      },
      {
