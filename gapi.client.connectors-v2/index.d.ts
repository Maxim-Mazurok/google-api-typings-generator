...
declare namespace gapi.client {
  ...
  namespace connectors {
    ...
    interface ExecuteHttpRequestRequest {
    ...
    interface ExecuteHttpRequestResponse {
    ...
    interface GenerateCustomToolspecRequest {
    ...
    interface ConnectionsResource {
      ...
      executeHttpRequest(request: {
        ...
        uploadType?: string;
        /** Request body */
        resource: ExecuteHttpRequestRequest;
      }): Request<ExecuteHttpRequestResponse>;
      executeHttpRequest(
        request: {
          /** V1 error format. */
          '$.xgafv'?: '1' | '2';
      ...
      generateConnectionToolspecOverride(request: {
        /** V1 error format. */
        '$.xgafv'?: '1' | '2';
        /** OAuth access token. */
        access_token?: string;
        ...
        uploadType?: string;
        /** Request body */
        resource: GenerateCustomToolspecRequest;
      }): Request<GenerateCustomToolspecResponse>;
      ...
      listCustomToolNames(request?: {
        ...
        /** Legacy upload protocol for media (e.g. "media", "multipart"). */
        uploadType?: string;
      }): Request<ListCustomToolNamesResponse>;
