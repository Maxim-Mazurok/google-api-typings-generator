...
declare namespace gapi.client {
    ...
    function load(urlOrObject: "https://cloudfunctions.googleapis.com/$discovery/rest?version=v2alpha"): Promise<void>;
    /** @deprecated Please load APIs with discovery documents. */
    function load(name: "cloudfunctions", version: "v2alpha"): Promise<void>;
    /** @deprecated Please load APIs with discovery documents. */
    function load(name: "cloudfunctions", version: "v2alpha", callback: () => any): void;
