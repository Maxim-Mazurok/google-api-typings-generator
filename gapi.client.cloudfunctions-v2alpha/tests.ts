...
gapi.load('client', async () => {
    ...
    await gapi.client.load('https://cloudfunctions.googleapis.com/$discovery/rest?version=v2alpha');
    ...
    async function run() {
         ...
         * permissions to upload files to the URL. When making a HTTP PUT request, specify this header: * `content-type: application/zip` Do not specify this header: * `Authorization: Bearer
         * YOUR_TOKEN`
         */
