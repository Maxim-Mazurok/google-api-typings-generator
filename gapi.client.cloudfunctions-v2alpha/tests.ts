/* This is stub file for gapi.client.cloudfunctions-v2alpha definition tests */
// IMPORTANT
...
gapi.load('client', async () => {
  ...
  async function run() {
    ...
    await gapi.client.cloudfunctions.projects.locations.functions.abortFunctionUpgrade(
      {
        name: 'Test string',
      },
      {},
    ...
    await gapi.client.cloudfunctions.projects.locations.functions.commitFunctionUpgradeAsGen2(
      {
        name: 'Test string',
      },
      {},
    ...
    await gapi.client.cloudfunctions.projects.locations.functions.create(
      ...
      },
      {
        ...
        serviceConfig: {
          ...
          binaryAuthorizationPolicy: 'Test string',
          directVpcEgress: 'Test string',
    ...
    await gapi.client.cloudfunctions.projects.locations.functions.detachFunction(
      {
        name: 'Test string',
      },
      {},
    ...
    await gapi.client.cloudfunctions.projects.locations.functions.setupFunctionUpgradeConfig(
      ...
      },
      {
        ...
        triggerServiceAccount: 'Test string',
      },
    );
