...
declare namespace gapi.client {
    ...
    namespace sqladmin {
        ...
        interface MaintenanceDenyPeriod {
            /**
             * "maintenance deny period" end date. If the year of the end date is empty, the year of the start date also must be empty. In this case, it means the no maintenance interval recurs
             * every year. The date is in format yyyy-mm-dd i.e., 2020-11-01, or mm-dd, i.e., 11-01
             */
            endDate?: string;
            /**
             * "maintenance deny period" start date. If the year of the start date is empty, the year of the end date also must be empty. In this case, it means the no maintenance interval recurs
             * every year. The date is in format yyyy-mm-dd i.e., 2020-11-01, or mm-dd, i.e., 11-01
             */
            startDate?: string;
            /** Time in UTC when the "no maintenance interval" starts on start_date and ends on end_date. The time is in format: HH:mm:SS, i.e., 00:00:00 */
            time?: string;
        }
        ...
        interface Settings {
            ...
            maintenanceDenyPeriods?: MaintenanceDenyPeriod[];
