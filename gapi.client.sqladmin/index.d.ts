...
declare namespace gapi.client {
    ...
    namespace sqladmin {
        ...
        interface DatabaseInstance {
             ...
             * PostgreSQL instances: *POSTGRES_9_6*, *POSTGRES_10*, *POSTGRES_11*, *POSTGRES_12*, *POSTGRES_13* (default). SQL Server instances: *SQLSERVER_2019_STANDARD*,
        ...
        interface DemoteMasterContext {
            ...
            /**
             * Verify GTID consistency for demote operation. Default value: *True*. Setting this flag to false enables you to bypass GTID consistency check between on-premises primary instance and
             * Cloud SQL instance during the demotion operation but also exposes you to the risk of future replication failures. Change the value value only if you know the reason for the GTID
        ...
        interface InstancesResource {
             ...
             * more information, see the Overview of high availability page in the Cloud SQL documentation. If using Legacy HA (MySQL only), this causes the instance to failover to its failover
             * replica instance.
             */
            failover(request: {
                /** V1 error format. */
        ...
        interface UsersResource {
            ...
            list(request?: {
                ...
                /**
                 * The project ID of the project containing the Cloud SQL database. The Google apps domain is prefixed if applicable. Can be omitted for *update* since it is already specified on
                 * the URL.
                 */
                "body.project"?: string;
                /** If the user has been disabled */
                "body.sqlserverUserDetails.disabled"?: boolean;
                /** The server roles for this user */
                "body.sqlserverUserDetails.serverRoles"?: string | string[];
                /** The user type. It determines the method to authenticate the user during login. The default is the database's built-in user type. */
                "body.type"?: string;
                /** JSONP */
                callback?: string;
