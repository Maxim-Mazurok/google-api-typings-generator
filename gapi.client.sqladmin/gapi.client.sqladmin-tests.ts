...
gapi.load('client', () => {
    ...
    async function run() {
         ...
         * information, see the Overview of high availability page in the Cloud SQL documentation. If using Legacy HA (MySQL only), this causes the instance to failover to its failover replica
         * instance.
         */
        ...
        await gapi.client.sqladmin.users.list({
            "body.etag": "Test string",
            "body.host": "Test string",
            "body.instance": "Test string",
            "body.kind": "Test string",
            "body.name": "Test string",
            "body.password": "Test string",
            "body.project": "Test string",
            "body.sqlserverUserDetails.disabled": true,
            "body.sqlserverUserDetails.serverRoles": "Test string",
            "body.type": "Test string",
            instance: "Test string",
            project: "Test string",
        });
