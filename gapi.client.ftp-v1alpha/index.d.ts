/* Type definitions for non-npm package Cloud FTP API v1alpha 0.0 */
// Project: https://cloud.google.com/cloud-ftp/overview
...
// Generated from: https://ftp.googleapis.com/$discovery/rest?version=v1alpha
// Revision: 20260729

/// <reference types="gapi.client" />

declare namespace gapi.client {
  /** Load Cloud FTP API v1alpha */
  function load(
    urlOrObject: 'https://ftp.googleapis.com/$discovery/rest?version=v1alpha',
  ): Promise<void>;
  /** @deprecated Please load APIs with discovery documents. */
  function load(name: 'ftp', version: 'v1alpha'): Promise<void>;
  /** @deprecated Please load APIs with discovery documents. */
  function load(name: 'ftp', version: 'v1alpha', callback: () => any): void;
