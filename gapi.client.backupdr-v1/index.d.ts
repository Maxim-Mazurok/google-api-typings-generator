...
declare namespace gapi.client {
  ...
  namespace backupdr {
    ...
    interface ComputeInstanceBackupPlanProperties {
    ...
    interface DiskBackupPlanProperties {
    ...
    interface DiskExclusionLabels {
      /** Optional. Labels used to identify disks for exclusion from the backup. If a disk carries any of these labels, it will be excluded (OR logic). */
      labels?: LabelKeyValPair[];
    }
    ...
    interface FetchResourceBackupConfigsResponse {
    ...
    interface FilestoreInstanceBackupProperties {
      /** Output only. The source instance of the backup. */
      sourceInstance?: string;
    }
    interface FilestoreInstanceDataSourceProperties {
      /** Output only. The instance creation timestamp. */
      instanceCreateTime?: string;
      /** Output only. Name of the Filestore instance backed up by the datasource. */
      name?: string;
    }
    interface FilestoreInstanceDataSourceReferenceProperties {
      /** Output only. The instance creation timestamp. */
      instanceCreateTime?: string;
    ...
    interface GoogleCloudBackupdrV1OperationMetadata {
    ...
    interface RestoreDiskFromInstanceOptions {
    ...
    interface ResourceBackupConfigsResource {
      ...
      fetch(request?: {
        ...
        uploadType?: string;
      }): Request<FetchResourceBackupConfigsResponse>;
    }
