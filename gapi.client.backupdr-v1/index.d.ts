...
declare namespace gapi.client {
    ...
    function load(urlOrObject: "https://backupdr.googleapis.com/$discovery/rest?version=v1"): Promise<void>;
    ...
    namespace backupdr {
        ...
        interface ListManagementServersResponse {
            /**
             * The list of ManagementServer instances in the project for the specified location. If the `{location}` value in the request is "-", the response contains a list of instances from all
             * locations. In case any location is unreachable, the response will only return management servers in reachable locations and the 'unreachable' field will be populated with a list of
        ...
        interface ManagementServer {
            ...
            networks?:
                NetworkConfig[];
            /**
             * Output only. The OAuth 2.0 client id is required to make API calls to the BackupDR instance API of this ManagementServer. This is the value that should be provided in the ‘aud’
             * field of the OIDC ID Token (see openid specification https://openid.net/specs/openid-connect-core-1_0.html#IDToken).
             */
            oauth2ClientId?:
                string;
        ...
        interface ManagementServersResource {
            ...
            create(request: {
                ...
                oauth_token?:
                    string;
                /**
                 * Required. The management server project and location in the format `projects/{project_id}/locations/{location}`. In Cloud Backup and DR locations map to GCP regions, for example
                 * **us-central1**.
                 */
                parent:
                    string;
            ...
            body: ManagementServer): Request<Operation>;
            ...
            list(request?: {
                ...
                pageToken?:
                    string;
                /**
                 * Required. The project and location for which to retrieve management servers information, in the format `projects/{project_id}/locations/{location}`. In Cloud BackupDR, locations
                 * map to GCP regions, for example **us-central1**. To retrieve management servers for all locations, use "-" for the `{location}` value.
                 */
                parent:
                    string;
                /** Returns response with indentations and line breaks. */
