/* This is stub file for gapi.client.gkehub-v1beta1 definition tests */
// IMPORTANT
...
gapi.load('client', async () => {
    ...
    await gapi.client.load('https://gkehub.googleapis.com/$discovery/rest?version=v1beta1');
    ...
    async function run() {
        ...
        await gapi.client.gkehub.projects.locations.memberships.generateConnectManifest({
            "connectAgent.name": "Test string",
            "connectAgent.namespace": "Test string",
            "connectAgent.proxy": "Test string",
        ...
        /**
         * GenerateExclusivityManifest generates the manifests to update the exclusivity artifacts in the cluster if needed. Exclusivity artifacts include the Membership custom resource definition
         * (CRD) and the singleton Membership custom resource (CR). Combined with ValidateExclusivity, exclusivity artifacts guarantee that a Kubernetes cluster is only registered to a single GKE
         * Hub. The Membership CRD is versioned, and may require conversion when the GKE Hub API server begins serving a newer version of the CRD and corresponding CR. The response will be the
