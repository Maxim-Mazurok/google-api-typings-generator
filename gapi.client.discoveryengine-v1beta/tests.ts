...
gapi.load('client', async () => {
  ...
  async function run() {
    ...
    /** Provisions the project resource. During the process, related systems will get prepared and initialized. Caller must read the [Terms for data use](https://cloud.google.com/retail/data-use-terms), and optionally specify in request to provide consent to that service terms. */
    await gapi.client.discoveryengine.projects.locations.provision(
      {
        name: 'Test string',
      },
      {
    ...
    await gapi.client.discoveryengine.projects.locations.collections.dataStores.create(
      ...
      },
      {
        ...
        federatedSearchConfig: {
          alloyDbConfig: {
            alloydbAiNlConfig: {
              nlConfigId: 'Test string',
            },
            alloydbConnectionConfig: {
              authMode: 'Test string',
            ...
            returnedFields: ['Test string'],
          },
          notebooklmConfig: {
            searchConfig: 'Test string',
          },
    ...
    await gapi.client.discoveryengine.projects.locations.collections.dataStores.getIamPolicy(
      {
    ...
    await gapi.client.discoveryengine.projects.locations.collections.dataStores.setIamPolicy(
      {
        resource: 'Test string',
      },
      {
    ...
    await gapi.client.discoveryengine.projects.locations.collections.dataStores.servingConfigs.recommend(
      ...
      },
      {
        ...
        userEvent: {
          ...
          feedback: {
            comment: 'Test string',
            componentVersion: 'Test string',
            conversationInfo: {
              answerQueryToken: 'Test string',
              assistToken: 'Test string',
              query: {
                queryId: 'Test string',
                text: 'Test string',
              },
            ...
            feedbackSource: 'Test string',
            feedbackType: 'Test string',
            llmModelVersion: 'Test string',
            reasons: ['Test string'],
          },
          filter: 'Test string',
          mediaInfo: {
    ...
    await gapi.client.discoveryengine.projects.locations.collections.dataStores.servingConfigs.search(
      ...
      },
      {
        ...
        customRankingParams: {
          expressionsToPrecompute: ['Test string'],
        },
        dataStoreSpecs: [
          {
            boostSpec: {
    ...
    await gapi.client.discoveryengine.projects.locations.collections.dataStores.sessions.create(
      ...
      },
      {
        ...
        labels: ['Test string'],
        name: 'Test string',
        pendingAsyncAssistOperationId: 'Test string',
        startTime: 'Test string',
        state: 'Test string',
        turns: [
          {
    ...
    await gapi.client.discoveryengine.projects.locations.collections.engines.create(
      ...
      },
      {
        ...
        appType: 'Test string',
        associatedAgentRegistry: 'Test string',
        chatEngineConfig: {
          agentCreationConfig: {
        ...
        marketplaceAgentVisibility: 'Test string',
        ...
        procurementContactEmails: ['Test string'],
        searchEngineConfig: {
        ...
        sessionConfig: {
          sessionManagementPolicy: 'Test string',
          sessionTtl: {
            days: 42,
          },
        },
    ...
    /** Gets the IAM access control policy for a DataStore. A `NOT_FOUND` error is returned if the resource does not exist. An empty policy is returned if the resource exists but does not have a policy set on it. */
    await gapi.client.discoveryengine.projects.locations.dataStores.getIamPolicy(
      {
        'options.requestedPolicyVersion': 42,
        resource: 'Test string',
      },
    ...
    /** Sets the IAM access control policy for a DataStore. A `NOT_FOUND` error is returned if the resource does not exist. **Important:** When setting a policy directly on a DataStore resource, the only recommended roles in the bindings are: `roles/discoveryengine.admin` `roles/discoveryengine.agentspaceAdmin` `roles/discoveryengine.viewer` `roles/discoveryengine.agentspaceViewer` `roles/discoveryengine.user` `roles/discoveryengine.agentspaceUser` Attempting to grant any other role will result in a warning in logging. */
    await gapi.client.discoveryengine.projects.locations.dataStores.setIamPolicy(
      {
        resource: 'Test string',
      },
      {
    ...
    await gapi.client.discoveryengine.projects.locations.licenseConfigs.create(
      ...
      },
      {
        ...
        freeTrial: true,
        geminiBundle: true,
        lastUserUpdateTime: 'Test string',
        licenseCount: 'Test string',
        name: 'Test string',
        startDate: {
          day: 42,
    ...
    await gapi.client.discoveryengine.projects.locations.licenseConfigs.list({
      filter: 'Test string',
      pageSize: 42,
      pageToken: 'Test string',
      parent: 'Test string',
