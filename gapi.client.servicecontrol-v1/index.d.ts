...
declare namespace gapi.client {
  ...
  namespace servicecontrol {
    ...
    interface AuthenticationInfo {
      ...
      loggableShortLivedCredential?: {[P in string]: any};
    ...
    interface PrivilegedAccessManagerMetadata {
      ...
      pamBindingIds?: AuditPamBindingId[];
    }
    ...
    interface RabPolicyViolationInfo {
    ...
    interface ViolationInfo {
      ...
      constraintViolationInfo?: {[P in string]: any};
