...
declare namespace gapi.client {
    ...
    namespace servicenetworking {
        ...
        interface DnsRecordSetResource {
            ...
            get(request?: {
                ...
                quotaUser?:
                    string;
                /** Required. RecordSet Type eg. type='A'. See the list of [Supported DNS Types](https://dns.corp.google.com/docs/overview). */
                type?:
                    string;
                /** Upload protocol for media (e.g. "raw", "multipart"). */
                upload_protocol?:
