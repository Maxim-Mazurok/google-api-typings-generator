/* This is stub file for gapi.client.gkehub-v1alpha2 definition tests */
// IMPORTANT
...
gapi.load('client', async () => {
    ...
    await gapi.client.load('https://gkehub.googleapis.com/$discovery/rest?version=v1alpha2');
    ...
    async function run() {
        ...
        /**
         * Initializes the Hub in this project, which includes creating the default Hub Service Account and the Hub Workload Identity Pool. Initialization is optional, and happens automatically
         * when the first Membership is created. InitializeHub should be called when the first Membership cannot be registered without these resources. A common example is granting the Hub Service
         * Account access to another project, which requires the account to exist first.
         */
        await gapi.client.gkehub.projects.locations.global.memberships.initializeHub({
            project: "Test string",
        }, {
        });
        /**
        ...
        await gapi.client.gkehub.projects.locations.memberships.create({
            ...
            infrastructureType: "Test string",
            labels: {
                A: "Test string"
            },
