/* Type definitions for non-npm package GKE Hub API v1alpha2 0.0 */
...
// Generated from: https://gkehub.googleapis.com/$discovery/rest?version=v1alpha2
// Revision: 20220828

/// <reference types="gapi.client" />

declare namespace gapi.client {
    /** Load GKE Hub API v1alpha2 */
    function load(urlOrObject: "https://gkehub.googleapis.com/$discovery/rest?version=v1alpha2"): Promise<void>;
    /** @deprecated Please load APIs with discovery documents. */
    function load(name: "gkehub", version: "v1alpha2"): Promise<void>;
    /** @deprecated Please load APIs with discovery documents. */
    function load(name: "gkehub", version: "v1alpha2", callback: () => any): void;
    ...
    namespace gkehub {
        ...
        interface Authority {
             ...
             * from this issuer to authenticate within the workload_identity_pool. OIDC discovery will be performed on this URI to validate tokens from the issuer, unless `oidc_jwks` is set.
             * Clearing `issuer` disables Workload Identity. `issuer` cannot be directly modified; it must be cleared (and Workload Identity disabled) before using a new issuer (and re-enabling
             * Workload Identity).
             */
            issuer?: string;
            /**
        ...
        // tslint:disable-next-line:no-empty-interface
        interface InitializeHubRequest {
        }
        interface InitializeHubResponse {
        ...
        interface KubernetesResource {
             ...
             * present in the cluster during Create or Update, or leave this field empty if none exists. The CR manifest is used to validate the cluster has not been registered with another
             * Membership.
             */
        ...
        interface MembershipsResource {
            /**
             * Initializes the Hub in this project, which includes creating the default Hub Service Account and the Hub Workload Identity Pool. Initialization is optional, and happens
             * automatically when the first Membership is created. InitializeHub should be called when the first Membership cannot be registered without these resources. A common example is
             * granting the Hub Service Account access to another project, which requires the account to exist first.
             */
            initializeHub(request: {
                ...
                uploadType?: string;
                /** Request body */
                resource: InitializeHubRequest;
            }): Request<InitializeHubResponse>;
            initializeHub(request: {
                /** V1 error format. */
                "$.xgafv"?: string;
                /** OAuth access token. */
            ...
            body: InitializeHubRequest): Request<InitializeHubResponse>;
        }
