/* Type definitions for non-npm package sqladmin API (prod) v1beta4 0.0 */
...
declare namespace gapi.client {
    /** Load sqladmin API (prod) v1beta4 */
    function load(urlOrObject: "https://sqladmin.googleapis.com/$discovery/rest?version=v1beta4"): Promise<void>;
    ...
    namespace sql {
        ...
        interface ConnectSettings {
             ...
             * PostgreSQL instances: `POSTGRES_9_6`, `POSTGRES_10`, `POSTGRES_11` or `POSTGRES_12` (default), `POSTGRES_13`, or `POSTGRES_14`. SQL Server instances: `SQLSERVER_2017_STANDARD`
