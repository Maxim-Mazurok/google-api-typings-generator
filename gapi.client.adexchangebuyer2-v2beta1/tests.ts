  ...
  async function run() {
    ...
    await gapi.client.adexchangebuyer2.accounts.creatives.create(
      ...
      },
      {
            ...
            contexts: [
              {
                all: 'Test string',
                appType: {
                  appTypes: ['Test string'],
                },
                auctionType: {
                  auctionTypes: ['Test string'],
                },
                location: {
                  geoCriteriaIds: [42],
                },
                platform: {
                  platforms: ['Test string'],
                },
                securityType: {
                  securities: ['Test string'],
                },
              },
            ],
            details: ['Test string'],
        ...
        detectedAdvertiserIds: ['Test string'],
        ...
        deals: [
          {
            ...
            targeting: {
              ...
              placementTargeting: {
                ...
                urlTargeting: {
                  excludedUrls: ['Test string'],
                  targetedUrls: ['Test string'],
                },
              },
              technologyTargeting: {
    ...
    await gapi.client.adexchangebuyer2.bidders.accounts.filterSets.create(
      ...
      },
      {
        ...
        breakdownDimensions: ['Test string'],
        creativeId: 'Test string',
        dealId: 'Test string',
        ...
        name: 'Test string',
        platforms: ['Test string'],
        publisherIdentifiers: ['Test string'],
        realtimeTimeRange: {
    ...
    /** Retrieves the requested filter set for the account with the given account ID. */
    await gapi.client.adexchangebuyer2.buyers.filterSets.get({
      name: 'Test string',
    });
    /** Lists all filter sets for the account with the given account ID. */
    await gapi.client.adexchangebuyer2.buyers.filterSets.list({
      ownerName: 'Test string',
      pageSize: 42,
      pageToken: 'Test string',
    });
    /** Lists all metrics that are measured in terms of number of bids. */
    await gapi.client.adexchangebuyer2.buyers.filterSets.bidMetrics.list({
      filterSetName: 'Test string',
      pageSize: 42,
      pageToken: 'Test string',
    });
    /** List all errors that occurred in bid responses, with the number of bid responses affected for each reason. */
    await gapi.client.adexchangebuyer2.buyers.filterSets.bidResponseErrors.list(
      {
        filterSetName: 'Test string',
        pageSize: 42,
        pageToken: 'Test string',
    ...
    /** List all creatives associated with a specific reason for which bids were filtered, with the number of bids filtered for each creative. */
    await gapi.client.adexchangebuyer2.buyers.filterSets.filteredBids.creatives.list(
      {
        creativeStatusId: 42,
        filterSetName: 'Test string',
        pageSize: 42,
    ...
    /** List all reasons for which winning bids were not billable, with the number of bids not billed for each reason. */
    await gapi.client.adexchangebuyer2.buyers.filterSets.nonBillableWinningBids.list(
      {
        filterSetName: 'Test string',
        pageSize: 42,
        pageToken: 'Test string',
