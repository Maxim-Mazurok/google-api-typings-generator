...
declare namespace gapi.client {
    ...
    function load(urlOrObject: "https://firebasehosting.googleapis.com/$discovery/rest?version=v1"): Promise<void>;
    /** @deprecated Please load APIs with discovery documents. */
    function load(name: "firebasehosting", version: "v1"): Promise<void>;
    /** @deprecated Please load APIs with discovery documents. */
    function load(name: "firebasehosting", version: "v1", callback: () => any): void;
