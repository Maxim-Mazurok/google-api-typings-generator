...
// Generated from: https://ids.googleapis.com/$discovery/rest?version=v1
// Revision: 20220110

/// <reference types="gapi.client" />

declare namespace gapi.client {
    /** Load Cloud IDS API v1 */
    function load(name: "ids", version: "v1"): PromiseLike<void>;
    function load(name: "ids", version: "v1", callback: () => any): void;
    ...
    namespace ids {
        ...
        interface EndpointsResource {
            ...
            create(request: {
                ...
                callback?: string;
                /**
                 * Required. The endpoint identifier. This will be part of the endpoint's resource name. This value must start with a lowercase letter followed by up to 62 lowercase letters,
                 * numbers, or hyphens, and cannot end with a hyphen. Values that do not match this pattern will trigger an INVALID_ARGUMENT error.
                 */
                endpointId?: string;
                 ...
                 * been completed. The server will guarantee that for at least 60 minutes since the first request. For example, consider a situation where you make an initial request and t he
            ...
            body: Endpoint): Request<Operation>;
            ...
            list(request?: {
                ...
                pageSize?: number;
                /**
                 * Optional. A page token, received from a previous `ListEndpoints` call. Provide this to retrieve the subsequent page. When paginating, all other parameters provided to
