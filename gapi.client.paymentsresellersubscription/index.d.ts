...
declare namespace gapi.client {
    ...
    namespace paymentsresellersubscription {
        ...
        interface SubscriptionsResource {
            ...
            body: GoogleCloudPaymentsResellerSubscriptionV1Subscription): Request<GoogleCloudPaymentsResellerSubscriptionV1Subscription>;
            /**
             * Used by partners to revoke the pending cancellation of a subscription, which is currently in `STATE_WAITING_TO_CANCEL` state. If the subscription is already cancelled, the request
