...
declare namespace gapi.client {
    ...
    function load(urlOrObject: "https://eventarc.googleapis.com/$discovery/rest?version=v1"): Promise<void>;
    ...
    namespace eventarc {
        ...
        interface Destination {
            /**
             * The Cloud Function resource name. Cloud Functions V1 and V2 are supported. Format: `projects/{project}/locations/{location}/functions/{function}` This is a read-only field. Creating
             * Cloud Functions V1/V2 triggers is only supported via the Cloud Functions product. An error will be returned if the user sets this value.
             */
            cloudFunction?:
                string;
