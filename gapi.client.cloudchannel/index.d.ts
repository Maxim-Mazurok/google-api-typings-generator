...
declare namespace gapi.client {
    ...
    namespace cloudchannel {
        ...
        interface GoogleCloudChannelV1alpha1ProvisionedService {
            ...
            productId?: string;
            /**
             * Output only. Provisioning ID of the entitlement. For Google Workspace, this would be the underlying Subscription ID. For Google Cloud Platform, this would be the Billing Account ID
