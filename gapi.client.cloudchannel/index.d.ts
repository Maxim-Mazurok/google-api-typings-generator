...
declare namespace gapi.client {
    ...
    namespace cloudchannel {
        ...
        interface GoogleCloudChannelV1alpha1Entitlement {
             ...
             * following output-only Parameters: - assigned_units: The number of licenses assigned to a user. - max_units: The maximum assignable units for a flexible offer. - num_units: The total
