...
declare namespace gapi.client {
    ...
    namespace cloudchannel {
        ...
        interface CustomersResource {
             ...
             * Required request parameters are missing or invalid. * FAILED_PRECONDITION: The customer has existing entitlements. * NOT_FOUND: No Customer resource found for the name in the
             * request.
             */
            delete(request?: {
                /** V1 error format. */
             ...
             * * INVALID_ARGUMENT: Required request parameters are missing or invalid. * NOT_FOUND: The customer resource doesn't exist. Usually the result of an invalid name parameter. Return
             * value: The Customer resource.
             */
            get(request?: {
                /** V1 error format. */
                "$.xgafv"?: string;
        ...
        interface EntitlementsResource {
            ...
            /**
             * Returns a requested Entitlement resource. Possible error codes: * PERMISSION_DENIED: The customer doesn't belong to the reseller. * INVALID_ARGUMENT: Required request parameters are
