/* Type definitions for non-npm package Google Analytics API v3 0.0 */
...
declare namespace gapi.client {
    ...
    function load(urlOrObject: "https://analytics.googleapis.com/$discovery/rest?version=v3"): Promise<void>;
