...
gapi.load('client', async () => {
  ...
  async function run() {
    ...
    await gapi.client.parametermanager.projects.locations.templates.create(
      {
        parent: 'Test string',
        requestId: 'Test string',
    ...
    await gapi.client.parametermanager.projects.locations.templates.delete({
      name: 'Test string',
      requestId: 'Test string',
    });
    /** Gets details of a single Template. */
    await gapi.client.parametermanager.projects.locations.templates.get({
      name: 'Test string',
    });
    /** Lists Templates in a given project and location. */
    await gapi.client.parametermanager.projects.locations.templates.list({
      filter: 'Test string',
      orderBy: 'Test string',
      pageSize: 42,
      pageToken: 'Test string',
    ...
    await gapi.client.parametermanager.projects.locations.templates.patch(
      {
        name: 'Test string',
        requestId: 'Test string',
        updateMask: 'Test string',
    ...
    await gapi.client.parametermanager.projects.locations.templates.versions.create(
      {
        parent: 'Test string',
        requestId: 'Test string',
        templateVersionId: 'Test string',
      },
      {
        createTime: 'Test string',
        disabled: true,
    ...
    await gapi.client.parametermanager.projects.locations.templates.versions.delete(
      {
        name: 'Test string',
        requestId: 'Test string',
      },
    ...
    await gapi.client.parametermanager.projects.locations.templates.versions.get(
      {
        name: 'Test string',
        view: 'Test string',
      },
    ...
    await gapi.client.parametermanager.projects.locations.templates.versions.list(
      {
        filter: 'Test string',
        orderBy: 'Test string',
        pageSize: 42,
    ...
    await gapi.client.parametermanager.projects.locations.templates.versions.patch(
      {
        name: 'Test string',
        requestId: 'Test string',
        updateMask: 'Test string',
    ...
    await gapi.client.parametermanager.projects.locations.templates.versions.render(
      {
        name: 'Test string',
        parameterVersion: 'Test string',
      },
    );
  }
});
