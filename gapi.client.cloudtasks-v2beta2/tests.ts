...
gapi.load('client', async () => {
    ...
    async function run() {
        /**
         * Update queue list by uploading a queue.yaml file. The queue.yaml file is supplied in the request body as a YAML encoded string. This method was added to support gcloud clients versions
         * before 322.0.0. New clients should use CreateQueue instead of this method.
         */
        await gapi.client.cloudtasks.api.queue.update({
            appId: "Test string",
        }, {
