...
declare namespace gapi.client {
    ...
    namespace cloudtasks {
        ...
        interface QueueResource {
            /**
             * Update queue list by uploading a queue.yaml file. The queue.yaml file is supplied in the request body as a YAML encoded string. This method was added to support gcloud clients
             * versions before 322.0.0. New clients should use CreateQueue instead of this method.
             */
            update(request: {
                /** V1 error format. */
                "$.xgafv"?: string;
                ...
                alt?: string;
                /**
                 * Required. The App ID is supplied as an HTTP parameter. Unlike internal usage of App ID, it does not include a region prefix. Rather, the App ID represents the Project ID against
