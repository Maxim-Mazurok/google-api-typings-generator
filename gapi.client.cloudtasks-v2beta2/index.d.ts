...
declare namespace gapi.client {
    ...
    namespace cloudtasks {
        ...
        interface TasksResource {
            ...
            /**
             * Creates and buffers a new task without the need to explicitly define a Task message. The queue must have HTTP target. Note: This feature is in its experimental stage. You must
             * request access to the API through the [Cloud Tasks BufferTasks Experiment Signup form](https://forms.gle/X8Zr5hiXH5tTGFqh8).
             */
            buffer(request: {
                /** V1 error format. */
                "$.xgafv"?: string;
