...
declare namespace gapi.client {
    ...
    function load(urlOrObject: "https://localservices.googleapis.com/$discovery/rest?version=v1"): Promise<void>;
    /** @deprecated Please load APIs with discovery documents. */
    function load(name: "localservices", version: "v1"): Promise<void>;
    /** @deprecated Please load APIs with discovery documents. */
