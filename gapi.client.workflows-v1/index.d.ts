/* Type definitions for non-npm package Workflows API v1 0.0 */
...
declare namespace gapi.client {
    ...
    function load(urlOrObject: "https://workflows.googleapis.com/$discovery/rest?version=v1"): Promise<void>;
    ...
    namespace workflows {
        ...
        interface Workflow {
             ...
             * to be executed The format is "000001-a4d", where the first six characters define the zero-padded revision ordinal number. They are followed by a hyphen and three hexadecimal random
             * characters.
             */
            revisionId?:
                string;
        ...
        interface WorkflowsResource {
            ...
            get(request?: {
                ...
                quotaUser?:
                    string;
                /**
                 * Optional. The revision of the workflow to retrieve. If the revision_id is empty, the latest revision is retrieved. The format is "000001-a4d", where the first six characters
                 * define the zero-padded decimal revision number. They are followed by a hyphen and three hexadecimal characters.
                 */
                revisionId?:
                    string;
                /** Upload protocol for media (e.g. "raw", "multipart"). */
            ...
            list(request?: {
                ...
                fields?:
                    string;
                /**
                 * Filter to restrict results to specific workflows. For details, see AIP-160. For example, if you are using the Google APIs Explorer: `state="SUCCEEDED"` or
