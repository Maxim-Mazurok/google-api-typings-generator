...
declare namespace gapi.client {
  ...
  function load(
    urlOrObject: 'https://secretmanager.googleapis.com/$discovery/rest?version=v1',
  ): Promise<void>;
  ...
  namespace secretmanager {
    ...
    interface CloudSQLSingleUserCredentials {
    ...
    interface Empty {}
    interface EnableManagedRotationRequest {
    ...
    interface ManagedRotationStatus {
    ...
    interface SecretsResource {
      ...
      enableManagedRotation(request: {
        ...
        uploadType?: string;
        /** Request body */
        resource: EnableManagedRotationRequest;
      }): Request<SecretVersion>;
