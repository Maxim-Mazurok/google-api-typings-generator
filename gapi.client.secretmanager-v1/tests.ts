/* This is stub file for gapi.client.secretmanager-v1 definition tests */
// IMPORTANT
...
gapi.load('client', async () => {
  ...
  async function run() {
    ...
    await gapi.client.secretmanager.projects.locations.secrets.enableManagedRotation(
      {
        parent: 'Test string',
      },
      {
    ...
    await gapi.client.secretmanager.projects.locations.secrets.rotateSecret(
      {
        parent: 'Test string',
      },
      {},
    ...
    /** Enables the managed rotation feature for a Secret. This method can only be triggered once for a secret. In order to do further rotations, RotateSecret should be used. This method will add a secret version and update the password in Cloud SQL. */
    await gapi.client.secretmanager.projects.secrets.enableManagedRotation(
      {
        parent: 'Test string',
      },
      {
    ...
    /** Do a managed rotation for a Secret. This can only be triggered after Managed rotation has been enabled. This method will add a secret version and update the password in Cloud SQL. */
    await gapi.client.secretmanager.projects.secrets.rotateSecret(
      {
        parent: 'Test string',
      },
      {},
