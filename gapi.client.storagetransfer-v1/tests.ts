...
gapi.load('client', async () => {
    ...
    await gapi.client.load('https://storagetransfer.googleapis.com/$discovery/rest?version=v1');
    ...
    async function run() {
         ...
         * associated with one Google Cloud project. Users should add this service account to the Google Cloud Storage bucket ACLs to grant access to Storage Transfer Service. This service account
        ...
        /**
         * Starts a new operation for the specified transfer job. A `TransferJob` has a maximum of one active `TransferOperation`. If this method is called while a `TransferOperation` is active,
