...
declare namespace gapi.client {
    ...
    namespace admob {
        interface App {
            ...
            appId?: string;
            /**
             * The app store ID of the app; only present if the app is linked to an app store. If the app is added to the Google Play store, it will be the application ID of the app. For example:
             * "com.example.myapp". See https://developer.android.com/studio/build/application-id. If the app is added to the Apple App Store, it will be app store ID. For example "105169111".
             */
            appStoreId?: string;
            /** The information for an app that is not linked to any app store. After an app is linked, this information cannot be retrieved. */
        ...
        interface AppsResource {
            ...
            get(request?: {
                ...
                key?: string;
                /** Required. Resource name of the app to retrieve. Example: accounts/pub-9876543210987654/apps/0123456789 */
                name: string;
