...
declare namespace gapi.client {
    ...
    namespace analyticsadmin {
        ...
        interface PropertiesResource {
             ...
             * purged. https://support.google.com/analytics/answer/6154772 Returns an error if the target is not found, or is not an App+Web Property.
             */
            delete(request?: {
                /** V1 error format. */
                "$.xgafv"?: string;
            ...
            /**
             * Lookup for a single "App+Web" Property. Throws "Target not found" if no such property found, if property is not of the type "App+Web", or if caller does not have permissions to
             * access it.
             */
            get(request?: {
                /** V1 error format. */
