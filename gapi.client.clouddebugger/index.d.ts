// Type definitions for non-npm package Stackdriver Debugger API v2 2.0
    ...
    namespace clouddebugger {
        ...
        interface BreakpointsResource {
            ...
            update(request: {
                ...
                uploadType?: string;
                /** Request body */
                resource: UpdateActiveBreakpointRequest;
            }): Request<{}>;
            update(request: {
                /** V1 error format. */
                "$.xgafv"?: string;
            ...
            body: UpdateActiveBreakpointRequest): Request<{}>;
        }
        interface DebuggeesResource {
            ...
            register(request: {
                ...
                uploadType?: string;
                /** Request body */
                resource: RegisterDebuggeeRequest;
            ...
            body: RegisterDebuggeeRequest): Request<RegisterDebuggeeResponse>;
        ...
        interface BreakpointsResource {
            ...
            body: Breakpoint): Request<SetBreakpointResponse>;
        }
        interface DebuggeesResource {
        ...
        const controller: ControllerResource;
    }
}
