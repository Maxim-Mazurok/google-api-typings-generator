...
declare namespace gapi.client {
    ...
    namespace admob {
        interface AdUnit {
            /**
             * AdFormat of the ad unit. Possible values are as follows: "APP_OPEN" - App Open ad format. "BANNER" - Banner ad format. "BANNER_INTERSTITIAL" - Legacy format that can be used as
             * either banner or interstitial. This format can no longer be created but can be targeted by mediation groups. "INTERSTITIAL" - A full screen ad. Supported ad types are "RICH_MEDIA"
             * and "VIDEO". "NATIVE" - Native ad format. "REWARDED" - An ad that, once viewed, gets a callback verifying the view so that a reward can be given to the user. Supported ad types are
             * "RICH_MEDIA" (interactive) and video where video can not be excluded. "REWARDED_INTERSTITIAL" - Rewarded Interstitial ad format. Only supports video ad type. See
        ...
        interface ReportRow {
            ...
            dimensionValues?:
                { [P in string]: ReportRowDimensionValue };
            ...
            metricValues?:
                { [P in string]: ReportRowMetricValue };
        }
        ...
        interface AccountsResource {
            ...
            apps:
                AppsResource;
            mediationReport:
                MediationReportResource;
            networkReport:
                NetworkReportResource;
        }
