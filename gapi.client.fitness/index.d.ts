...
declare namespace gapi.client {
    ...
    namespace fitness {
        ...
        interface DataSourcesResource {
             ...
             *
             * Creates a new data source that is unique across all data sources belonging to this user. The dataStreamId field should be excluded. This will be
             * automatically generated by the server with the correct format. If a dataStreamId is included, it must match the format that the server would generate.
             * This format is a combination of some fields from the data source, and has a specific order. If it doesn't match, the request will fail with an error.
             *
