    ...
    await gapi.client.dialogflow.projects.locations.agents.updateGenerativeSettings(
      ...
      },
      {
        ...
        llmModelSettings: {
          model: 'Test string',
          parameters: {
            inputTokenLimit: 'Test string',
            outputTokenLimit: 'Test string',
            temperature: 42,
          },
          promptText: 'Test string',
        },
        ...
        actions: [
          {
            ...
            llmCall: {
              ...
              retrievedExamples: [
                {
                  exampleDisplayName: 'Test string',
                  exampleId: 'Test string',
                  matchedRetrievalLabel: 'Test string',
                  retrievalStrategy: 'Test string',
                },
              ],
              temperature: 42,
              tokenCount: {
                conversationContextTokenCount: 'Test string',
                exampleTokenCount: 'Test string',
                totalInputTokenCount: 'Test string',
                totalOutputTokenCount: 'Test string',
              },
            },
            playbookInvocation: {
              displayName: 'Test string',
              ...
              dataStoreToolTrace: {
                dataStoreConnectionSignals: {
                  ...
                  answerGenerationModelCallSignals: {
                    model: 'Test string',
                    modelOutput: 'Test string',
                    renderedPrompt: 'Test string',
                  },
                  answerParts: [
                    {
                      supportingIndices: [42],
                      text: 'Test string',
                    },
                  ],
                  citedSnippets: [
                  ...
                  rewrittenQuery: 'Test string',
                  safetySignals: {
                    bannedPhraseMatch: 'Test string',
                    decision: 'Test string',
                    matchedBannedPhrase: 'Test string',
                  },
                  searchSnippets: [
                    {
                      documentTitle: 'Test string',
