# TypeScript typings for Policy Troubleshooter API v3beta
...
```
npm install @types/gapi.client.policytroubleshooter-v3beta --save-dev
```
...
```json
{
  "compilerOptions": {
    "types": [
      ...
      "gapi.auth2",
      "gapi.client",
      "gapi.client.policytroubleshooter-v3beta"
    ]
  }
}
```
...
gapi.client.load('policytroubleshooter', 'v3beta', () => {
  // now we can use:
  // gapi.client.policytroubleshooter
});
```
