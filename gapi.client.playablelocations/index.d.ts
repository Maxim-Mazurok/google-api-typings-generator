...
declare namespace gapi.client {
    ...
    namespace playablelocations {
        interface GoogleMapsPlayablelocationsV3Impression {
            /**
             * An arbitrary, developer-defined type identifier for each type of game object used in your game. Since players interact with differ types of game
             * objects in different ways, this field allows you to segregate impression data by type for analysis. You should assign a unique `game_object_type` ID to
             * represent a distinct type of game object in your game. For example, 1=monster location, 2=powerup location.
             */
        ...
        interface GoogleMapsPlayablelocationsV3LogImpressionsRequest {
            ...
            /**
             * Required. A string that uniquely identifies the log impressions request. This allows you to detect duplicate requests. We recommend that you use UUIDs
             * for this value. The value must not exceed 50 characters. You should reuse the `request_id` only when retrying a request in case of failure. In this
        ...
        interface GoogleMapsPlayablelocationsV3LogPlayerReportsRequest {
            ...
            /**
             * Required. A string that uniquely identifies the log player reports request. This allows you to detect duplicate requests. We recommend that you use
             * UUIDs for this value. The value must not exceed 50 characters. You should reuse the `request_id` only when retrying a request in the case of a failure.
             * In that case, the request must be identical to the one that failed.
             */
            requestId?: string;
        }
        // tslint:disable-next-line:no-empty-interface
        ...
        interface GoogleMapsPlayablelocationsV3PlayerReport {
            /**
             * Language code (in BCP-47 format) indicating the language of the freeform description provided in `reason_details`. Examples are "en", "en-US" or
        ...
        interface GoogleMapsPlayablelocationsV3SampleAreaFilter {
            /**
             * Required. The S2 cell ID of the area you want. This must be between cell level 11 and 14 (inclusive). S2 cells are 64-bit integers that identify areas
             * on the Earth. They are hierarchical, and can therefore be used for spatial indexing. The S2 geometry library is available in a number of languages: &#42;
             * [C++](https://github.com/google/s2geometry) &#42; [Java](https://github.com/google/s2-geometry-library-java) &#42; [Go](https://github.com/golang/geo) &#42;
        ...
        interface GoogleMapsPlayablelocationsV3SampleCriterion {
            /**
             * Specifies which `PlayableLocation` fields are returned. `name` (which is used for logging impressions), `center_point` and `place_id` (or `plus_code`)
             * are always returned. The following fields are omitted unless you specify them here: &#42; snapped_point &#42; types Note: The more fields you include, the more
            ...
            /**
             * Required. An arbitrary, developer-defined identifier of the type of game object that the playable location is used for. This field allows you to
             * specify criteria per game object type when searching for playable locations. You should assign a unique `game_object_type` ID across all
             * `request_criteria` to represent a distinct type of game object. For example, 1=monster location, 2=powerup location. The response contains a map.
             */
            gameObjectType?: number;
        }
        interface GoogleMapsPlayablelocationsV3SampleFilter {
            ...
            /**
             * Specifies the maximum number of playable locations to return. This value must not be greater than 1000. The default value is 100. Only the top-ranking
        ...
        interface GoogleMapsPlayablelocationsV3SamplePlayableLocation {
            ...
            /**
             * A collection of [Playable Location Types](/maps/documentation/gaming/tt/types) for this playable location. The first type in the collection is the
             * primary type. Type information might not be available for all playable locations.
             */
            types?: string[];
        }
        ...
        interface GoogleMapsPlayablelocationsV3SamplePlayableLocationsResponse {
            ...
            /**
             * Required. Specifies the "time-to-live" for the set of playable locations. You can use this value to determine how long to cache the set of playable
             * locations. After this length of time, your back-end game server should issue a new SamplePlayableLocations request to get a fresh set of playable
             * locations (because for example, they might have been removed, a park might have closed for the day, a business might have closed permanently).
             */
            ttl?: string;
        }
        interface GoogleMapsPlayablelocationsV3SampleSpacingOptions {
            /**
             * Required. The minimum spacing between any two playable locations, measured in meters. The minimum value is 30. The maximum value is 1000. Inputs will
             * be rounded up to the next 10 meter interval. The default value is 200m. Set this field to remove tight clusters of playable locations. Note: The
             * spacing is a greedy algorithm. It optimizes for selecting the highest ranking locations first, not to maximize the number of locations selected.
             * Consider the following scenario: &#42; Rank: A: 2, B: 1, C: 3. &#42; Distance: A--200m--B--200m--C If spacing=250, it will pick the highest ranked location
             * [B], not [A, C]. Note: Spacing works within the game object type itself, as well as the previous ones. Suppose three game object types, each with the
             * following spacing: &#42; X: 400m, Y: undefined, Z: 200m. 1. Add locations for X, within 400m of each other. 2. Add locations for Y, without any spacing. 3.
             * Finally, add locations for Z within 200m of each other as well X and Y. The distance diagram between those locations end up as: &#42; From->To. &#42; X->X:
             * 400m &#42; Y->X, Y->Y: unspecified. &#42; Z->X, Z->Y, Z->Z: 200m.
             */
            minSpacingMeters?: number;
            /**
             * Specifies whether the minimum spacing constraint applies to the center-point or to the snapped point of playable locations. The default value is
             * `CENTER_POINT`. If a snapped point is not available for a playable location, its center-point is used instead. Set this to the point type used in your
             * game.
             */
            pointType?: string;
        }
