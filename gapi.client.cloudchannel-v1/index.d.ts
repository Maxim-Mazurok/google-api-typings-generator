...
declare namespace gapi.client {
    ...
    namespace cloudchannel {
        ...
        interface GoogleCloudChannelV1alpha1Entitlement {
             ...
             * additionally include the following output-only Parameters: - assigned_units: The number of licenses assigned to users. For GCP billing accounts, the following Parameter may be
