...
declare namespace gapi.client {
    ...
    namespace cloudchannel {
        ...
        interface GoogleCloudChannelV1alpha1DateRange {
            /**
             * The latest invoice date (exclusive). If your product uses monthly invoices, and this value is not the beginning of a month, this will adjust the date to the first day of the
             * following month.
             */
            invoiceEndDate?: GoogleTypeDate;
            /**
             * The earliest invoice date (inclusive). If your product uses monthly invoices, and this value is not the beginning of a month, this will adjust the date to the first day of the given
             * month.
             */
        ...
        interface GoogleCloudChannelV1alpha1Entitlement {
             ...
             * additionally include the following output-only Parameters: - assigned_units: The number of licenses assigned to users. For GCP billing subaccounts, the following Parameter may be
        ...
        interface ReportJobsResource {
            ...
            fetchReportResults(request: {
                ...
                uploadType?: string;
                /** Request body */
                resource: GoogleCloudChannelV1FetchReportResultsRequest;
        ...
        interface ReportsResource {
            ...
            run(request: {
                ...
                uploadType?: string;
                /** Request body */
                resource: GoogleCloudChannelV1RunReportJobRequest;
            }): Request<GoogleLongrunningOperation>;
            run(request: {
                /** V1 error format. */
                "$.xgafv"?: string;
