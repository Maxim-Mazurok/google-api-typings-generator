...
declare namespace gapi.client {
    ...
    function load(urlOrObject: "https://cloudresourcemanager.googleapis.com/$discovery/rest?version=v2beta1"): Promise<void>;
    /** @deprecated Please load APIs with discovery documents. */
    function load(name: "cloudresourcemanager", version: "v2beta1"): Promise<void>;
    /** @deprecated Please load APIs with discovery documents. */
