/* This is stub file for gapi.client.cloudresourcemanager-v2beta1 definition tests */
// IMPORTANT
...
gapi.load('client', async () => {
    ...
    await gapi.client.load('https://cloudresourcemanager.googleapis.com/$discovery/rest?version=v2beta1');
