...
declare namespace gapi.client {
    ...
    namespace firestore {
        interface Aggregation {
            /**
             * Required. The name of the field to store the result of the aggregation into. Requires: * Must be present. * Must be unique across all aggregation aliases. * Conform to existing
        ...
        interface Count {
             ...
             * High-Level Example: ``` SELECT COUNT_UP_TO(1000) FROM ( SELECT * FROM k ); ``` Requires: * Must be greater than zero when present.
             */
            upTo?: number;
        }
        interface Cursor {
