...
declare namespace gapi.client {
  ...
  namespace run {
    ...
    interface GoogleCloudRunV2EmptyDirVolumeSource {
      ...
      medium?: 'MEDIUM_UNSPECIFIED' | 'MEMORY' | 'DISK';
    ...
    interface GoogleCloudRunV2UploadSourceRequest {
      /** The name of Cloud Run Service upload source archive will be used for. */
      service?: string;
    }
    interface GoogleCloudRunV2UploadSourceResponse {
    ...
    interface GoogleCloudRunV2WorkloadIdentityConfig {
    ...
    interface SourceUploadsResource {
      ...
      upload(request: {
        ...
        uploadType?: string;
        /** Request body */
        resource: GoogleCloudRunV2UploadSourceRequest;
      }): Request<GoogleCloudRunV2UploadSourceResponse>;
      upload(
        request: {
          /** V1 error format. */
          '$.xgafv'?: '1' | '2';
    ...
    interface LocationsResource {
      ...
      sourceUploads: SourceUploadsResource;
