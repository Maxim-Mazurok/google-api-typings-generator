    ...
    namespace run {
        ...
        interface ServicesResource {
            ...
            create(request: {
                ...
                quotaUser?: string;
                /**
                 * Required. The unique identifier for the Service. It must begin with letter, and may not end with hyphen; must contain fewer than 50 characters. The name of the service becomes
