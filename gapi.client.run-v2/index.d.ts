...
declare namespace gapi.client {
    ...
    namespace run {
        ...
        interface GoogleCloudRunV2ServiceScaling {
            /** total min instances for the service. This number of instances will be divide among all revisions with specified traffic based on the percent of traffic they are receiving. (ALPHA) */
            minInstanceCount?:
                number;
        }
