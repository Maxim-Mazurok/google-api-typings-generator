...
declare namespace gapi.client {
  ...
  namespace run {
    ...
    interface GoogleCloudRunV2BuildConfig {
    ...
    interface GoogleCloudRunV2BuildpacksBuild {
    ...
    interface GoogleCloudRunV2Instance {
      annotations?: {[P in string]: string};
    ...
    interface GoogleCloudRunV2InstanceSplit {
    ...
    interface GoogleCloudRunV2ListInstancesResponse {
      /** The resulting list of Instances. */
      instances?: GoogleCloudRunV2Instance[];
    ...
    interface GoogleCloudRunV2ListWorkerPoolsResponse {
    ...
    interface GoogleCloudRunV2RevisionScaling {
      /** Optional. Determines a threshold for concurrency utilization before scaling begins. Accepted values are between `0.4` and `0.95` (inclusive) or `0.0` to disable concurrency utilization as threshold for scaling. */
      concurrencyUtilization?: number;
      /** Optional. Determines a threshold for CPU utilization before scaling begins. Accepted values are between `0.4` and `0.95` (inclusive) or `0.0` to disable CPU utilization as threshold for scaling. */
    ...
    interface GoogleCloudRunV2StartInstanceRequest {
    ...
    interface GoogleCloudRunV2StopInstanceRequest {
      /** Optional. A system-generated fingerprint for this version of the resource. This may be used to detect modification conflict during updates. */
      etag?: string;
      /** Optional. Indicates that the request should be validated without actually stopping any resources. */
      validateOnly?: boolean;
    }
    interface GoogleCloudRunV2StorageSource {
    ...
    interface GoogleCloudRunV2SubmitBuildRequest {
    ...
    interface GoogleCloudRunV2SubmitBuildResponse {
    ...
    interface GoogleCloudRunV2WorkerPool {
      ...
      instanceSplits?: GoogleCloudRunV2InstanceSplit[];
      ...
      instanceSplitStatuses?: GoogleCloudRunV2InstanceSplitStatus[];
    ...
    interface GoogleCloudRunV2WorkerPoolRevisionTemplate {
    ...
    interface GoogleCloudRunV2WorkerPoolScaling {
    ...
    interface BuildsResource {
      ...
      submit(request: {
        ...
        uploadType?: string;
        /** Request body */
        resource: GoogleCloudRunV2SubmitBuildRequest;
    ...
    interface InstancesResource {
      ...
      create(request: {
        ...
        validateOnly?: boolean;
        /** Request body */
        resource: GoogleCloudRunV2Instance;
      ...
      get(request?: {
        ...
        /** Legacy upload protocol for media (e.g. "media", "multipart"). */
        uploadType?: string;
      }): Request<GoogleCloudRunV2Instance>;
      ...
      list(request?: {
        ...
        /** Legacy upload protocol for media (e.g. "media", "multipart"). */
        uploadType?: string;
      }): Request<GoogleCloudRunV2ListInstancesResponse>;
      /** Starts an Instance. */
      start(request: {
        /** V1 error format. */
        '$.xgafv'?: string;
        ...
        uploadType?: string;
        /** Request body */
        resource: GoogleCloudRunV2StartInstanceRequest;
      }): Request<GoogleLongrunningOperation>;
      start(
        request: {
          /** V1 error format. */
      ...
      stop(request: {
        ...
        uploadType?: string;
        /** Request body */
        resource: GoogleCloudRunV2StopInstanceRequest;
      }): Request<GoogleLongrunningOperation>;
      stop(
        request: {
          /** V1 error format. */
    ...
    interface WorkerPoolsResource {
      ...
      create(request: {
        ...
        workerPoolId?: string;
        /** Request body */
        resource: GoogleCloudRunV2WorkerPool;
      }): Request<GoogleLongrunningOperation>;
      create(
        request: {
          /** V1 error format. */
      ...
      list(request?: {
        ...
        /** Legacy upload protocol for media (e.g. "media", "multipart"). */
        uploadType?: string;
      }): Request<GoogleCloudRunV2ListWorkerPoolsResponse>;
