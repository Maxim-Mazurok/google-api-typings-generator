    ...
    namespace run {
        ...
        interface ServicesResource {
            ...
            list(request?: {
                ...
                pageToken?: string;
                /**
                 * Required. The location and project to list resources on. Location must be a valid GCP region, and cannot be the "-" wildcard. Format: projects/{project}/locations/{location},
