...
gapi.load('client', async () => {
  ...
  async function run() {
    ...
    /** Creates an Instance. */
    await gapi.client.run.projects.locations.instances.create(
      {
      ...
      },
      {
        ...
        containers: [
          {
            args: ['Test string'],
            baseImageUri: 'Test string',
            buildInfo: {
              functionTarget: 'Test string',
              sourceLocation: 'Test string',
            },
            command: ['Test string'],
        ...
        encryptionKeyRevocationAction: 'Test string',
        encryptionKeyShutdownDuration: 'Test string',
        etag: 'Test string',
    ...
    /** Deletes an Instance */
    await gapi.client.run.projects.locations.instances.delete({
      etag: 'Test string',
      name: 'Test string',
      validateOnly: true,
    });
    /** Gets an Instance */
    await gapi.client.run.projects.locations.instances.get({
      name: 'Test string',
    });
    ...
    await gapi.client.run.projects.locations.instances.list({
      pageSize: 42,
    ...
    /** Updates an Instance. */
    await gapi.client.run.projects.locations.instances.patch(
      {
        allowMissing: true,
        name: 'Test string',
    ...
    /** Starts an Instance. */
    await gapi.client.run.projects.locations.instances.start(
      {
        name: 'Test string',
      },
      {
    ...
    /** Stops an Instance. */
    await gapi.client.run.projects.locations.instances.stop(
      {
        name: 'Test string',
      },
      {
    ...
    await gapi.client.run.projects.locations.sourceUploads.upload(
      {
        parent: 'Test string',
      },
      {
    ...
    await gapi.client.run.projects.locations.workerPools.create(
      {
        parent: 'Test string',
        validateOnly: true,
    ...
    await gapi.client.run.projects.locations.workerPools.delete({
      etag: 'Test string',
      name: 'Test string',
      validateOnly: true,
    });
    /** Gets information about a WorkerPool. */
    await gapi.client.run.projects.locations.workerPools.get({
      name: 'Test string',
    });
    ...
    await gapi.client.run.projects.locations.workerPools.list({
      pageSize: 42,
      pageToken: 'Test string',
      parent: 'Test string',
      showDeleted: true,
    ...
    await gapi.client.run.projects.locations.workerPools.patch(
      {
        allowMissing: true,
        forceNewRevision: true,
        name: 'Test string',
    ...
    /** Deletes a Revision. */
    await gapi.client.run.projects.locations.workerPools.revisions.delete({
      etag: 'Test string',
      name: 'Test string',
      validateOnly: true,
    });
    /** Gets information about a Revision. */
    await gapi.client.run.projects.locations.workerPools.revisions.get({
      name: 'Test string',
    });
    /** Lists Revisions from a given Service, or from a given location. Results are sorted by creation time, descending. */
    await gapi.client.run.projects.locations.workerPools.revisions.list({
      pageSize: 42,
      pageToken: 'Test string',
      parent: 'Test string',
      showDeleted: true,
