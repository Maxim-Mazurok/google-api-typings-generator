/* Type definitions for non-npm package My Business Place Actions API v1 0.0 */
...
declare namespace gapi.client {
    ...
    function load(urlOrObject: "https://mybusinessplaceactions.googleapis.com/$discovery/rest?version=v1"): Promise<void>;
    ...
    namespace mybusinessplaceactions {
        interface AvailableDay {
            ...
            /**
             * Unix timestamp. The last time till when, a user could place an order to be received by `fulfillment_date`. In other words, after last_ordering_time, fulfillment_date will no longer
        ...
        interface PlaceActionLink {
            ...
            orderOnlineMetadata?: OrderOnlineMetadata;
