...
declare namespace gapi.client {
    ...
    namespace securitycenter {
        ...
        interface KernelRootkit {
            ...
            /** Flag indicating presence of ftrace points with callbacks pointing to regions that are not in the expected kernel or module code range. */
            ...
            /** Flag indicating presence of kprobe points with callbacks pointing to regions that are not in the expected kernel or module code range. */
            unexpectedKprobeHandler?: boolean;
            /** Flag indicating unexpected process(es) in the scheduler run-queue, those that are in the run-queue, but not in the process task-list. */
            ...
            /** Flag indicating presence of system call handlers that are are not in the expected kernel, module code regions. */
