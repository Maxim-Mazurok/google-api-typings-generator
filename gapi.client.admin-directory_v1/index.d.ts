...
declare namespace gapi.client {
    ...
    function load(urlOrObject: "https://admin.googleapis.com/$discovery/rest?version=directory_v1"): Promise<void>;
    ...
    namespace admin {
        ...
        interface Channel {
            ...
            kind?:
                string;
            /**
             * Additional parameters controlling delivery channel behavior. Optional. For example, `params.ttl` specifies the time-to-live in seconds for the notification channel, where the
        ...
        interface OsUpdateStatus {
            ...
            targetKioskAppVersion?:
                string;
            /**
             * New platform version of the OS image being downloaded and applied. It is only set when update status is UPDATE_STATUS_DOWNLOAD_IN_PROGRESS or UPDATE_STATUS_NEED_REBOOT. Note this
             * could be a dummy "0.0.0.0" for UPDATE_STATUS_NEED_REBOOT for some edge cases, e.g. update engine is restarted without a reboot.
             */
            targetOsVersion?:
                string;
