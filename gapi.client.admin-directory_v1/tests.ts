...
gapi.load('client', async () => {
  ...
  async function run() {
    ...
    await gapi.client.admin.customer.devices.chromeos.countChromeOsDevices({
      customerId: 'Test string',
      filter: 'Test string',
    ...
    await gapi.client.directory.chromeosdevices.patch(
      ...
      },
      {
        ...
        osVersionCompliance: 'Test string',
