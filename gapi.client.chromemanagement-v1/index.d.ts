  ...
  namespace chromemanagement {
    ...
    interface ConnectorConfigsResource {
      ...
      delete(request?: {
        ...
        /** JSONP */
        callback?: string;
        /** Optional. The etag of the connector config. If an etag is provided and does not match the current etag of the connector config, deletion will be blocked and an ABORTED error will be returned. */
        etag?: string;
        /** Selector specifying which fields to include in a partial response. */
        fields?: string;
        /** API key. Your API key identifies your project and provides you with API access, quota, and reports. Required unless you provide an OAuth 2.0 token. */
