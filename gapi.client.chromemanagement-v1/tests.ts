...
gapi.load('client', async () => {
  ...
  async function run() {
    ...
    await gapi.client.chromemanagement.customers.connectorConfigs.create(
      {
        connectorConfigId: 'Test string',
        parent: 'Test string',
      },
      {
        details: {
          crowdStrikeConfig: {
            ...
            host: 'Test string',
            reportingSettings: {
              enabledDefaultEvents: ['Test string'],
              enabledDeviceEvents: ['Test string'],
              enabledOptInEvents: ['Test string'],
            },
          },
          ...
          crowdStrikeXdrConfig: {
            ...
            host: 'Test string',
            xdrSettings: {
              enableAllXdrEvents: true,
            },
          },
          deviceTrustConfig: {
            scope: 'Test string',
            serviceAccounts: ['Test string'],
            serviceProvider: 'Test string',
            urlMatchers: ['Test string'],
          },
          googleSecOpsConfig: {
            apiKey: 'Test string',
            host: 'Test string',
    ...
    await gapi.client.chromemanagement.customers.connectorConfigs.delete({
      name: 'Test string',
    });
    /** Gets a connector config with customer ID and config ID. */
    await gapi.client.chromemanagement.customers.connectorConfigs.get({
      name: 'Test string',
    });
    /** Lists connector configs of a customer. */
    await gapi.client.chromemanagement.customers.connectorConfigs.list({
      pageSize: 42,
      pageToken: 'Test string',
      parent: 'Test string',
    });
    /** Updates a connector config. */
    await gapi.client.chromemanagement.customers.connectorConfigs.patch(
      {
        name: 'Test string',
    ...
    await gapi.client.chromemanagement.customers.enterprise.securityInsights.checkEnablementStatus(
      {
        customer: 'Test string',
      },
    );
    /** Disables insights for the customer. */
    await gapi.client.chromemanagement.customers.enterprise.securityInsights.disable(
      {
        customer: 'Test string',
      },
      {},
    ...
    await gapi.client.chromemanagement.customers.enterprise.securityInsights.enable(
      {
        customer: 'Test string',
      },
      {
        targetOus: ['Test string'],
      },
    );
    /** Returns a high-level summary of content transfers for a given customer. */
    await gapi.client.chromemanagement.customers.enterprise.securityInsights.queryContentTransfers(
      {
        customer: 'Test string',
        filter: 'Test string',
      },
    ...
    await gapi.client.chromemanagement.customers.enterprise.securityInsights.queryContentTransfersBreakdowns(
      {
        breakdown: 'Test string',
        customer: 'Test string',
        filter: 'Test string',
        fixedTimeRange: 'Test string',
        metric: 'Test string',
        pageSize: 42,
        pageToken: 'Test string',
      },
    ...
    await gapi.client.chromemanagement.customers.enterprise.securityInsights.queryUrlVisits(
      {
        customer: 'Test string',
        filter: 'Test string',
      },
    ...
    await gapi.client.chromemanagement.customers.enterprise.securityInsights.queryUrlVisitsBreakdowns(
      {
        breakdown: 'Test string',
        customer: 'Test string',
        filter: 'Test string',
    ...
    await gapi.client.chromemanagement.customers.reports.countChromeProfileVersions(
      {
        customer: 'Test string',
        filter: 'Test string',
        orgUnitId: 'Test string',
    ...
    await gapi.client.chromemanagement.customers.reports.findInstalledAppProfiles(
      {
        appId: 'Test string',
        appType: 'Test string',
        customer: 'Test string',
    ...
    await gapi.client.chromemanagement.customers.reports.findSaasUsage({
      customer: 'Test string',
      filter: 'Test string',
      orderBy: 'Test string',
      pageSize: 42,
    ...
    await gapi.client.chromemanagement.customers.reports.findSaasUsageBrowsers({
      app: 'Test string',
      customer: 'Test string',
      filter: 'Test string',
      orderBy: 'Test string',
    ...
    await gapi.client.chromemanagement.customers.reports.findSaasUsageProfiles({
      app: 'Test string',
      customer: 'Test string',
      filter: 'Test string',
      orderBy: 'Test string',
