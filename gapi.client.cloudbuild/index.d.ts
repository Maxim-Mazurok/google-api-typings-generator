...
declare namespace gapi.client {
    ...
    namespace cloudbuild {
        ...
        interface BuildTrigger {
            ...
            disabled?: boolean;
            /**
             * Optional. EventType allows the user to explicitly set the type of event to which this BuildTrigger should respond. This field is optional but will be validated against the rest of
