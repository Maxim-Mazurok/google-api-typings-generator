...
declare namespace gapi.client {
    ...
    namespace cloudbuild {
        ...
        interface ApprovalResult {
            ...
            approvalTime?: string;
            /**
             * Output only. Email of the user that called the ApproveBuild API to approve or reject a build at the time that the API was called (the user's actual email that is tied to their GAIA
             * ID may have changed). This field is not stored, rather, it is calculated on the fly using approver_id.
             */
