...
declare namespace gapi.client {
    ...
    namespace cloudbuild {
        ...
        interface WorkerConfig {
            ...
            diskSizeGb?: string;
            /**
             * Machine type of a worker, such as `e2-medium`. See [Worker pool config file](https://cloud.google.com/cloud-build/docs/custom-workers/worker-pool-config-file). If left blank, Cloud
