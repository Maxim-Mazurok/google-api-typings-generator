/* Type definitions for non-npm package OS Config API v1 0.0 */
...
declare namespace gapi.client {
    ...
    function load(urlOrObject: "https://osconfig.googleapis.com/$discovery/rest?version=v1"): Promise<void>;
    ...
    namespace osconfig {
        ...
        interface PatchJobsResource {
            ...
            instanceDetails:
                InstanceDetailsResource;
        }
        interface ProjectsResource {
            locations:
                LocationsResource;
            patchDeployments:
                PatchDeploymentsResource;
            patchJobs:
                PatchJobsResource;
        }
