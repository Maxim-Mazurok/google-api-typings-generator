...
declare namespace gapi.client {
  ...
  namespace deploymentmanager {
    ...
    interface BulkInsertOperationStatus {
      ...
      status?: 'STATUS_UNSPECIFIED' | 'CREATING' | 'ROLLING_BACK' | 'DONE';
    ...
    interface CompositeType {
      ...
      selfLink?: string;
      status?: 'UNKNOWN_STATUS' | 'DEPRECATED' | 'EXPERIMENTAL' | 'SUPPORTED';
    ...
    interface QuotaExceededInfo {
      ...
      rolloutStatus?: 'ROLLOUT_STATUS_UNSPECIFIED' | 'IN_PROGRESS';
    }
    interface Resource {
    ...
    interface SetAutoscalerLinkOperationMetadata {
      ...
      zoneToIgmIds?: {[P in string]: string};
    }
    ...
    interface DeploymentsResource {
      ...
      insert(request: {
        ...
        createPolicy?: 'CREATE_OR_ACQUIRE' | 'ACQUIRE' | 'CREATE';
        /** Selector specifying which fields to include in a partial response. */
        fields?: string;
        'header.bypassBillingFilter'?: boolean;
        /** API key. Your API key identifies your project and provides you with API access, quota, and reports. Required unless you provide an OAuth 2.0 token. */
