/* Type definitions for non-npm package Google Health API v4beta 0.0 */
...
// Generated from: https://health.googleapis.com/$discovery/rest?version=v4beta
// Revision: 20260907

/// <reference types="gapi.client" />

declare namespace gapi.client {
  /** Load Google Health API v4beta */
  function load(
    urlOrObject: 'https://health.googleapis.com/$discovery/rest?version=v4beta',
  ): Promise<void>;
  /** @deprecated Please load APIs with discovery documents. */
  function load(name: 'health', version: 'v4beta'): Promise<void>;
  /** @deprecated Please load APIs with discovery documents. */
  function load(name: 'health', version: 'v4beta', callback: () => any): void;
  ...
  namespace health {
    ...
    interface GoogleDevicesandservicesHealthV4betaDataType {
    ...
    interface GoogleDevicesandservicesHealthV4betaUser {
    ...
    interface GoogleDevicesandservicesHealthV4betaWebhookNotificationCloudLog {
    ...
    interface HeartRateVariability {
      ...
      metadata?: HeartRateVariabilityMetadata;
    ...
    interface HeartRateVariabilityMetadata {
