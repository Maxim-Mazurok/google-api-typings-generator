/* Type definitions for non-npm package SAS Portal API v1alpha1 0.0 */
...
declare namespace gapi.client {
  ...
  function load(
    urlOrObject: 'https://sasportal.googleapis.com/$discovery/rest?version=v1alpha1'
  ): Promise<void>;
  /** @deprecated Please load APIs with discovery documents. */
  function load(name: 'sasportal', version: 'v1alpha1'): Promise<void>;
  /** @deprecated Please load APIs with discovery documents. */
  function load(
    name: 'sasportal',
    version: 'v1alpha1',
  ...
  namespace sasportal {
    ...
    interface CustomersResource {
      ...
      migrateOrganization(request: {
        ...
        uploadType?: string;
        /** Request body */
        resource: SasPortalMigrateOrganizationRequest;
      }): Request<SasPortalOperation>;
      migrateOrganization(
        request: {
          /** V1 error format. */
      ...
      setupSasAnalytics(request: {
        ...
        uploadType?: string;
        /** Request body */
        resource: SasPortalSetupSasAnalyticsRequest;
      }): Request<SasPortalOperation>;
      setupSasAnalytics(
        request: {
          /** V1 error format. */
