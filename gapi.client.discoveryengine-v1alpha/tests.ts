...
gapi.load('client', async () => {
  ...
  async function run() {
    ...
    await gapi.client.discoveryengine.projects.locations.getConfigurablePricingUsageStats(
      {
    ...
    await gapi.client.discoveryengine.projects.locations.notebooks.sources.uploadFile(
      {
        parent: 'Test string',
