...
declare namespace gapi.client {
  ...
  namespace discoveryengine {
    ...
    interface GoogleCloudDiscoveryengineV1alphaBatchCreateTargetSitesRequest {
      /** Required. The request message specifying the resources to create. A maximum of 20 TargetSites can be created in a batch. */
      requests?: GoogleCloudDiscoveryengineV1alphaCreateTargetSiteRequest[];
    }
    ...
    interface GoogleCloudDiscoveryengineV1alphaCreateTargetSiteRequest {
    ...
    interface GoogleCloudDiscoveryengineV1alphaListEnginesResponse {
      ...
      engines?: GoogleCloudDiscoveryengineV1alphaEngine[];
      /** Not supported. */
      nextPageToken?: string;
    }
    ...
    interface GoogleCloudDiscoveryengineV1alphaSearchResponse {
      ...
      facets?: GoogleCloudDiscoveryengineV1alphaSearchResponseFacet[];
    ...
    interface GoogleCloudDiscoveryengineV1alphaWidgetAnswerQueryRequest {
      /** Additional params for security and privacy enhancement. */
      additionalParams?: GoogleCloudDiscoveryengineV1alphaAdditionalParams;
      /** Required. The AnswerQueryRequest request to perform answer query. The ServingConfig id will be `default_search` by default. The session resource will be set as id. If set, the session id of answer query will be used for constructing session full resource name in ConversationalSearchService.AnswerQueryRequest. */
      answerQueryRequest?: GoogleCloudDiscoveryengineV1alphaAnswerQueryRequest;
      /** Required. The UUID of the WidgetConfig. This field is used to identify the widget configuration. */
      configId?: string;
    }
    interface GoogleCloudDiscoveryengineV1alphaWidgetAnswerQueryResponse {
      /** AnswerQueryResponse returned from ConversationalSearchService.AnswerQueryResponse. If session is present in request and is a valid session, the session resource returned will be sanitized with only session id. */
      answerQueryResponse?: GoogleCloudDiscoveryengineV1alphaAnswerQueryResponse;
    ...
    interface LocationsResource {
      ...
      widgetAnswerQuery(request: {
        ...
        /** API key. Your API key identifies your project and provides you with API access, quota, and reports. Required unless you provide an OAuth 2.0 token. */
        key?: string;
        /** Required. The location resource where widget answer query will be performed. Format: `locations/{location}` */
        location: string;
        /** OAuth 2.0 token for the current user. */
        oauth_token?: string;
        /** Returns response with indentations and line breaks. */
        ...
        uploadType?: string;
        /** Request body */
        resource: GoogleCloudDiscoveryengineV1alphaWidgetAnswerQueryRequest;
      }): Request<GoogleCloudDiscoveryengineV1alphaWidgetAnswerQueryResponse>;
      widgetAnswerQuery(
        request: {
          /** V1 error format. */
          '$.xgafv'?: string;
        ...
        body: GoogleCloudDiscoveryengineV1alphaWidgetAnswerQueryRequest
      ): Request<GoogleCloudDiscoveryengineV1alphaWidgetAnswerQueryResponse>;
    ...
    interface DocumentsResource {
      ...
      purge(request: {
        ...
        uploadType?: string;
        /** Request body */
        resource: GoogleCloudDiscoveryengineV1alphaPurgeDocumentsRequest;
      }): Request<GoogleLongrunningOperation>;
      purge(
        request: {
          /** V1 error format. */
    ...
    interface SchemasResource {
      ...
      create(request: {
        ...
        uploadType?: string;
        /** Request body */
        resource: GoogleCloudDiscoveryengineV1alphaSchema;
      }): Request<GoogleLongrunningOperation>;
      create(
        request: {
          /** V1 error format. */
    ...
    interface TargetSitesResource {
      ...
      create(request: {
        ...
        uploadType?: string;
        /** Request body */
        resource: GoogleCloudDiscoveryengineV1alphaTargetSite;
      }): Request<GoogleLongrunningOperation>;
      create(
        request: {
          /** V1 error format. */
      ...
      get(request?: {
        ...
        /** Legacy upload protocol for media (e.g. "media", "multipart"). */
        uploadType?: string;
      }): Request<GoogleCloudDiscoveryengineV1alphaTargetSite>;
      ...
      list(request?: {
        ...
        /** Legacy upload protocol for media (e.g. "media", "multipart"). */
        uploadType?: string;
      }): Request<GoogleCloudDiscoveryengineV1alphaListTargetSitesResponse>;
    ...
    interface SiteSearchEngineResource {
      ...
      batchVerifyTargetSites(request: {
        ...
        uploadType?: string;
        /** Request body */
        resource: GoogleCloudDiscoveryengineV1alphaBatchVerifyTargetSitesRequest;
      }): Request<GoogleLongrunningOperation>;
      ...
      disableAdvancedSiteSearch(request: {
        ...
        uploadType?: string;
        /** Request body */
        resource: GoogleCloudDiscoveryengineV1alphaDisableAdvancedSiteSearchRequest;
      }): Request<GoogleLongrunningOperation>;
      ...
      enableAdvancedSiteSearch(request: {
        ...
        uploadType?: string;
        /** Request body */
        resource: GoogleCloudDiscoveryengineV1alphaEnableAdvancedSiteSearchRequest;
      }): Request<GoogleLongrunningOperation>;
      ...
      recrawlUris(request: {
        ...
        uploadType?: string;
        /** Request body */
        resource: GoogleCloudDiscoveryengineV1alphaRecrawlUrisRequest;
      }): Request<GoogleLongrunningOperation>;
      recrawlUris(
        request: {
          /** V1 error format. */
    ...
    interface UserEventsResource {
      ...
      purge(request: {
        ...
        uploadType?: string;
        /** Request body */
        resource: GoogleCloudDiscoveryengineV1alphaPurgeUserEventsRequest;
      }): Request<GoogleLongrunningOperation>;
      purge(
        request: {
          /** V1 error format. */
    ...
    interface DataStoresResource {
      ...
      create(request: {
        ...
        uploadType?: string;
        /** Request body */
        resource: GoogleCloudDiscoveryengineV1alphaDataStore;
      }): Request<GoogleLongrunningOperation>;
      create(
        request: {
          /** V1 error format. */
      ...
      getSiteSearchEngine(request?: {
        ...
        /** Legacy upload protocol for media (e.g. "media", "multipart"). */
        uploadType?: string;
      }): Request<GoogleCloudDiscoveryengineV1alphaSiteSearchEngine>;
    ...
    interface EnginesResource {
      ...
      pause(request: {
        ...
        uploadType?: string;
        /** Request body */
        resource: GoogleCloudDiscoveryengineV1alphaPauseEngineRequest;
      }): Request<GoogleCloudDiscoveryengineV1alphaEngine>;
      pause(
        request: {
          /** V1 error format. */
      ...
      resume(request: {
        ...
        uploadType?: string;
        /** Request body */
        resource: GoogleCloudDiscoveryengineV1alphaResumeEngineRequest;
      }): Request<GoogleCloudDiscoveryengineV1alphaEngine>;
      resume(
        request: {
          /** V1 error format. */
      ...
      tune(request: {
        ...
        uploadType?: string;
        /** Request body */
        resource: GoogleCloudDiscoveryengineV1alphaTuneEngineRequest;
      }): Request<GoogleLongrunningOperation>;
      tune(
        request: {
          /** V1 error format. */
