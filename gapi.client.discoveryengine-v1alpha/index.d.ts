...
declare namespace gapi.client {
    ...
    namespace discoveryengine {
        ...
        interface GoogleCloudDiscoveryengineV1alphaGcsSource {
             ...
             * a pattern matching one or more files, such as `gs://bucket/directory/*.json`. A request can contain at most 100 files, and each file can be up to 2 GB.
             */
            inputUris?: string[];
        }
        ...
        interface GoogleCloudDiscoveryengineV1alphaUserEvent {
             ...
             * consistent between imported events and events provided with prediction requests. This lets the DiscoveryEngine API use those custom attributes when training models and serving
