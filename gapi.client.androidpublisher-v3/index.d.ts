...
declare namespace gapi.client {
  ...
  namespace androidpublisher {
    ...
    interface BatchDeleteOneTimeProductsRequest {
      /** Required. A list of delete requests of up to 100 elements. All requests must delete different one-time products. */
      requests?: DeleteOneTimeProductRequest[];
    }
    interface BatchDeletePurchaseOptionsRequest {
      ...
      requests?: DeletePurchaseOptionRequest[];
    }
    interface BatchGetOneTimeProductOffersRequest {
      /** Required. A list of get requests of up to 100 elements. All requests must retrieve different offers. */
      requests?: GetOneTimeProductOfferRequest[];
    }
    interface BatchGetOneTimeProductOffersResponse {
      /** The list of updated one-time product offers, in the same order as the request. */
      oneTimeProductOffers?: OneTimeProductOffer[];
    }
    interface BatchGetOneTimeProductsResponse {
    ...
    interface CancelSubscriptionPurchaseRequest {
    ...
    interface DeletePurchaseOptionRequest {
    ...
    interface ExternalContentLinkDetails {
    ...
    interface GetOneTimeProductOfferRequest {
    ...
    interface InGracePeriodStateContext {
    ...
    interface ListOneTimeProductOffersResponse {
      /** A token, which can be sent as `page_token` to retrieve the next page. If this field is omitted, there are no subsequent pages. */
      nextPageToken?: string;
      /** The one_time_product offers from the specified request. */
      oneTimeProductOffers?: OneTimeProductOffer[];
    }
    interface ListOneTimeProductsResponse {
      /** A token, which can be sent as `page_token` to retrieve the next page. If this field is omitted, there are no subsequent pages. */
      nextPageToken?: string;
    ...
    interface OneTimeProductBuyPurchaseOption {
    ...
    interface OneTimeProductDiscountedOffer {
    ...
    interface OneTimeProductGameRewardOffer {
      /** Optional. The number of times this offer can be redeemed. If unset or set to 0, allows for unlimited offer redemptions. Otherwise must be a number between 1 and 50 inclusive. */
      redemptionLimit?: string;
    }
    ...
    interface OneTimeProductOffer {
      ...
      regionalPricingAndAvailabilityConfigs?: OneTimeProductOfferRegionalPricingAndAvailabilityConfig[];
    ...
    interface OneTimeProductPreOrderOffer {
    ...
    interface OneTimeProductPurchaseOption {
      ...
      regionalPricingAndAvailabilityConfigs?: OneTimeProductPurchaseOptionRegionalPricingAndAvailabilityConfig[];
    ...
    interface OneTimeProductRentPurchaseOption {
    ...
    interface OrderHistory {
      ...
      partialRefundEvents?: PartialRefundEvent[];
    ...
    interface RenewalDeclinedContext {
    ...
    interface RevocationContextFullRefund {}
    interface RevocationContextItemBasedRefund {
    ...
    interface RotateAppSigningKeyRequest {
    ...
    interface UpdateOneTimeProductOfferRequest {
    ...
    interface UpdateOneTimeProductOfferStateRequest {
    ...
    interface UpdateOneTimeProductRequest {
    ...
    interface UpdatePurchaseOptionStateRequest {
    ...
    interface AppsigningResource {
      ...
      enrollApp(request: {
        ...
        uploadType?: string;
        /** Request body */
        resource: EnrollAppRequest;
      }): Request<EnrollAppResponse>;
      enrollApp(
        request: {
          /** V1 error format. */
          '$.xgafv'?: '1' | '2';
      ...
      rotateAppSigningKey(request: {
        ...
        uploadType?: string;
        /** Request body */
        resource: RotateAppSigningKeyRequest;
      }): Request<RotateAppSigningKeyResponse>;
      rotateAppSigningKey(
        request: {
          /** V1 error format. */
          '$.xgafv'?: '1' | '2';
    ...
    interface OffersResource {
      ...
      activate(request: {
        ...
        uploadType?: string;
        /** Request body */
        resource: ActivateOneTimeProductOfferRequest;
      }): Request<OneTimeProductOffer>;
      activate(
        request: {
          /** V1 error format. */
          '$.xgafv'?: '1' | '2';
      ...
      batchDelete(request: {
        ...
        uploadType?: string;
        /** Request body */
        resource: BatchDeleteOneTimeProductOffersRequest;
      }): Request<void>;
      batchDelete(
        request: {
          /** V1 error format. */
      ...
      batchGet(request: {
        ...
        uploadType?: string;
        /** Request body */
        resource: BatchGetOneTimeProductOffersRequest;
      }): Request<BatchGetOneTimeProductOffersResponse>;
      batchGet(
        request: {
          /** V1 error format. */
          '$.xgafv'?: '1' | '2';
      ...
      batchUpdate(request: {
        ...
        uploadType?: string;
        /** Request body */
        resource: BatchUpdateOneTimeProductOffersRequest;
      }): Request<BatchUpdateOneTimeProductOffersResponse>;
      batchUpdate(
        request: {
          /** V1 error format. */
          '$.xgafv'?: '1' | '2';
      ...
      batchUpdateStates(request: {
        ...
        uploadType?: string;
        /** Request body */
        resource: BatchUpdateOneTimeProductOfferStatesRequest;
      }): Request<BatchUpdateOneTimeProductOfferStatesResponse>;
      batchUpdateStates(
        request: {
          /** V1 error format. */
          '$.xgafv'?: '1' | '2';
      ...
      cancel(request: {
        ...
        uploadType?: string;
        /** Request body */
        resource: CancelOneTimeProductOfferRequest;
      }): Request<OneTimeProductOffer>;
      cancel(
        request: {
          /** V1 error format. */
      ...
      deactivate(request: {
        ...
        uploadType?: string;
        /** Request body */
        resource: DeactivateOneTimeProductOfferRequest;
      }): Request<OneTimeProductOffer>;
      deactivate(
        request: {
          /** V1 error format. */
      ...
      list(request?: {
        ...
        /** Legacy upload protocol for media (e.g. "media", "multipart"). */
        uploadType?: string;
      }): Request<ListOneTimeProductOffersResponse>;
    }
    interface PurchaseOptionsResource {
      ...
      batchDelete(request: {
        ...
        uploadType?: string;
        /** Request body */
        resource: BatchDeletePurchaseOptionsRequest;
      }): Request<void>;
      batchDelete(
        request: {
          /** V1 error format. */
      ...
      batchUpdateStates(request: {
        ...
        uploadType?: string;
        /** Request body */
        resource: BatchUpdatePurchaseOptionStatesRequest;
      }): Request<BatchUpdatePurchaseOptionStatesResponse>;
      batchUpdateStates(
        request: {
          /** V1 error format. */
          '$.xgafv'?: '1' | '2';
    ...
    interface OnetimeproductsResource {
      ...
      batchDelete(request: {
        ...
        uploadType?: string;
        /** Request body */
        resource: BatchDeleteOneTimeProductsRequest;
      }): Request<void>;
      batchDelete(
        request: {
          /** V1 error format. */
      ...
      batchGet(request?: {
        ...
        /** Legacy upload protocol for media (e.g. "media", "multipart"). */
        uploadType?: string;
      }): Request<BatchGetOneTimeProductsResponse>;
      ...
      batchUpdate(request: {
        ...
        uploadType?: string;
        /** Request body */
        resource: BatchUpdateOneTimeProductsRequest;
      }): Request<BatchUpdateOneTimeProductsResponse>;
      batchUpdate(
        request: {
          /** V1 error format. */
          '$.xgafv'?: '1' | '2';
      ...
      list(request?: {
        ...
        /** Legacy upload protocol for media (e.g. "media", "multipart"). */
        uploadType?: string;
      }): Request<ListOneTimeProductsResponse>;
      ...
      purchaseOptions: PurchaseOptionsResource;
    }
    interface OffersResource {
    ...
    interface OrdersResource {
      ...
      batchget(request?: {
        ...
        /** Legacy upload protocol for media (e.g. "media", "multipart"). */
        uploadType?: string;
      }): Request<BatchGetOrdersResponse>;
    ...
    interface Subscriptionsv2Resource {
      ...
      cancel(request: {
        ...
        uploadType?: string;
        /** Request body */
        resource: CancelSubscriptionPurchaseRequest;
      }): Request<{}>;
      cancel(
        request: {
          /** V1 error format. */
    ...
    const appsigning: AppsigningResource;
