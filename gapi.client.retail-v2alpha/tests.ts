...
gapi.load('client', async () => {
  ...
  async function run() {
    ...
    await gapi.client.retail.projects.getAlertConfig({
      name: 'Test string',
    });
    ...
    await gapi.client.retail.projects.updateAlertConfig(
      {
        name: 'Test string',
      ...
      },
      {
        alertPolicies: [
          {
            alertGroup: 'Test string',
            enrollStatus: 'Test string',
            recipients: [
              {
    ...
    await gapi.client.retail.projects.locations.catalogs.exportAnalyticsMetrics(
      {
        catalog: 'Test string',
      },
      {
    ...
    await gapi.client.retail.projects.locations.catalogs.getConversationalSearchCustomizationConfig(
      {
        name: 'Test string',
      },
    );
    ...
    await gapi.client.retail.projects.locations.catalogs.updateConversationalSearchCustomizationConfig(
      {
        catalog: 'Test string',
        updateMask: 'Test string',
      },
      {
        ...
        intentClassificationConfig: {
          blocklistKeywords: ['Test string'],
          disabledIntentTypes: ['Test string'],
          example: [
            {
              classifiedPositive: true,
              intentType: 'Test string',
              query: 'Test string',
              reason: 'Test string',
            },
          ],
          ...
          modelPreamble: 'Test string',
        },
        retailerDisplayName: 'Test string',
      },
    );
    ...
    /** Retrieves a Branch. */
    await gapi.client.retail.projects.locations.catalogs.branches.get({
      name: 'Test string',
      view: 'Test string',
    });
    /** Lists all instances of Branch under the specified parent Catalog. */
    await gapi.client.retail.projects.locations.catalogs.branches.list({
      parent: 'Test string',
      view: 'Test string',
    });
    ...
    await gapi.client.retail.projects.locations.catalogs.branches.products.create(
      ...
      },
      {
        ...
        collectionMemberIds: ['Test string'],
        colorInfo: {
          colorFamilies: ['Test string'],
          colors: ['Test string'],
        },
      ...
      },
      {
        ...
        rule: {
          ...
          doNotAssociateAction: {
            doNotAssociateTerms: ['Test string'],
            queryTerms: ['Test string'],
            terms: ['Test string'],
          },
          filterAction: {
            filter: 'Test string',
          ...
          ignoreAction: {
            ignoreTerms: ['Test string'],
          },
          onewaySynonymsAction: {
            onewayTerms: ['Test string'],
            queryTerms: ['Test string'],
    ...
    await gapi.client.retail.projects.locations.catalogs.placements.conversationalSearch(
      {
      ...
      },
      {
        ...
        conversationalFilteringSpec: {
          conversationalFilteringMode: 'Test string',
          enableConversationalFiltering: true,
          userAnswer: {
            selectedAnswer: {
    ...
    await gapi.client.retail.projects.locations.catalogs.placements.search(
      ...
      },
      {
        ...
        conversationalSearchSpec: {
          conversationId: 'Test string',
          followupConversationRequested: true,
          userAnswer: {
            selectedAnswer: {
              productAttributeValue: {
                name: 'Test string',
          ...
          appliedTiles: [
            {
              ...
              representativeProductId: 'Test string',
            },
          ],
          tileNavigationRequested: true,
        },
        userAttributes: {
          A: {
            values: ['Test string'],
    ...
    /** Performs a conversational search. This feature is only available for users who have Conversational Search enabled. */
    await gapi.client.retail.projects.locations.catalogs.servingConfigs.conversationalSearch(
      {
        placement: 'Test string',
      },
      {
