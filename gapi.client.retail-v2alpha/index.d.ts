...
declare namespace gapi.client {
    ...
    namespace retail {
        ...
        interface GoogleCloudRetailV2alphaCatalogAttribute {
            ...
            /**
             * Set manually for numerical attributes only. If the facet SearchResponse.FacetSpec.intervals are not set by the customer for a numerical attribute, then a weekly pipeline will
             * calculate some intervals using some percentiles on the distribution of all its product numerical attribute values. The latter computed intervals might not be ideal for the use case
             * of that attribute. For this reason, the customer can set them manually. As another option, for any numerical attribute that is passed as a facet key in the request along with some
             * given intervals, then these given intervals will be the facet intervals returned in the response.
             */
            facetIntervals?: GoogleCloudRetailV2alphaInterval[];
            /** Each instance represents a list of attribute values to ignore as facet values for a specific time range. */
            ignoredFacetValues?: GoogleCloudRetailV2alphaCatalogAttributeIgnoredFacetValues[];
            /**
        ...
        interface GoogleCloudRetailV2alphaCatalogAttributeIgnoredFacetValues {
