/* Type definitions for non-npm package Retail API v2alpha 0.0 */
...
// Generated from: https://retail.googleapis.com/$discovery/rest?version=v2alpha
// Revision: 20220811

/// <reference types="gapi.client" />

declare namespace gapi.client {
    /** Load Retail API v2alpha */
    function load(urlOrObject: "https://retail.googleapis.com/$discovery/rest?version=v2alpha"): Promise<void>;
    /** @deprecated Please load APIs with discovery documents. */
    function load(name: "retail", version: "v2alpha"): Promise<void>;
    /** @deprecated Please load APIs with discovery documents. */
    function load(name: "retail", version: "v2alpha", callback: () => any): void;
    ...
    namespace retail {
        ...
        // tslint:disable-next-line:no-empty-interface
        interface GoogleCloudRetailV2AddLocalInventoriesMetadata {
        }
        // tslint:disable-next-line:no-empty-interface
        interface GoogleCloudRetailV2AddLocalInventoriesResponse {
        }
        interface GoogleCloudRetailV2alphaAddCatalogAttributeRequest {
            /** Required. The CatalogAttribute to add. */
            catalogAttribute?: GoogleCloudRetailV2alphaCatalogAttribute;
        }
        interface GoogleCloudRetailV2alphaAddControlRequest {
        ...
        interface GoogleCloudRetailV2alphaAddFulfillmentPlacesRequest {
        ...
        interface GoogleCloudRetailV2alphaAddLocalInventoriesRequest {
            /**
             * Indicates which inventory fields in the provided list of LocalInventory to update. The field is updated to the provided value. If a field is set while the place does not have a
             * previous local inventory, the local inventory at that store is created. If a field is set while the value of that field is not provided, the original field value, if it exists, is
        ...
        interface GoogleCloudRetailV2alphaAttributesConfig {
             ...
             */
            catalogAttributes?: { [P in string]: GoogleCloudRetailV2alphaCatalogAttribute };
        ...
        interface GoogleCloudRetailV2alphaAudience {
            /**
        ...
        interface GoogleCloudRetailV2alphaBatchRemoveCatalogAttributesRequest {
        ...
        interface GoogleCloudRetailV2alphaBatchRemoveCatalogAttributesResponse {
            ...
            /**
             * Catalog attributes that were reset. Attributes that are in use by products cannot be deleted, however their configuration properties will reset to default values upon removal
             * request.
             */
        ...
        interface GoogleCloudRetailV2alphaBigQuerySource {
            /**
             ...
             * values for user events imports: * `user_event` (default): One JSON UserEvent per line. * `user_event_ga360`: The schema is available here:
             * https://support.google.com/analytics/answer/3437719. * `user_event_ga4`: The schema is available here: https://support.google.com/analytics/answer/7029846. Supported values for
             * auto-completion imports: * `suggestions` (default): One JSON completion suggestion per line. * `denylist`: One JSON deny suggestion per line. * `allowlist`: One JSON allow
             * suggestion per line.
             */
            dataSchema?: string;
        ...
        interface GoogleCloudRetailV2alphaCatalog {
        ...
        interface GoogleCloudRetailV2alphaCatalogAttribute {
            /**
             ...
             * field is `False` for pre-loaded CatalogAttributes. Only pre-loaded CatalogAttributes that are neither in use by products nor predefined can be deleted. CatalogAttributes that are
             * either in use by products or are predefined cannot be deleted; however, their configuration properties will reset to default values upon removal request. After catalog changes, it
             ...
             * characters and underscores. For example, an attribute named `attributes.abc_xyz` can be indexed, but an attribute named `attributes.abc-xyz` cannot be indexed.
             */
            key?: string;
            /**
        ...
        interface GoogleCloudRetailV2alphaColorInfo {
            /**
        ...
        interface GoogleCloudRetailV2alphaCompleteQueryResponse {
             ...
             * ordered from latest to oldest. * They are matched with CompleteQueryRequest.query case insensitively. * They are transformed to lower case. * They are UTF-8 safe. Recent searches
        ...
        interface GoogleCloudRetailV2alphaCompleteQueryResponseCompletionResult {
            /**
             ...
             */
            attributes?: { [P in string]: GoogleCloudRetailV2alphaCustomAttribute };
            /** The suggestion for the query. */
            suggestion?: string;
        }
        interface GoogleCloudRetailV2alphaCompleteQueryResponseRecentSearchResult {
            /** The recent search query. */
            recentSearch?: string;
        }
        interface GoogleCloudRetailV2alphaCompletionConfig {
        ...
        interface GoogleCloudRetailV2alphaCompletionDataInputConfig {
            /**
        ...
        interface GoogleCloudRetailV2alphaCompletionDetail {
        ...
        interface GoogleCloudRetailV2alphaCondition {
        ...
        interface GoogleCloudRetailV2alphaConditionQueryTerm {
            /** Whether this is supposed to be a full or partial match. */
            fullMatch?: boolean;
            /**
             * The value of the term to match on. Value cannot be empty. Value can have at most 3 terms if specified as a partial match. Each space separated string is considered as one term.
             * Example) "a b c" is 3 terms and allowed, " a b c d" is 4 terms and not allowed for partial match.
             */
            value?: string;
        }
        interface GoogleCloudRetailV2alphaConditionTimeRange {
            /** End of time range. Range is inclusive. */
            endTime?: string;
            /** Start of time range. Range is inclusive. */
            startTime?: string;
        }
        interface GoogleCloudRetailV2alphaControl {
            /**
             * Output only. List of serving configuration ids that that are associated with this control. Note the association is managed via the ServingConfig, this is an output only
             * denormalizeed view. Assumed to be in the same catalog.
             */
            ...
            /**
             * Required. Immutable. The solution types that the serving config is used for. Currently we support setting only one type of solution at creation time. Only `SOLUTION_TYPE_SEARCH`
        ...
        interface GoogleCloudRetailV2alphaCustomAttribute {
            /**
             ...
             * product-level attribute configuration, see [Configuration modes](https://cloud.google.com/retail/docs/attribute-config#config-modes). If true, custom attribute values are indexed,
        ...
        interface GoogleCloudRetailV2alphaFulfillmentInfo {
            /**
        ...
        interface GoogleCloudRetailV2alphaGcsSource {
            /**
             * The schema to use when parsing the data from the source. Supported values for product imports: * `product` (default): One JSON Product per line. Each product must have a valid
             * Product.id. * `product_merchant_center`: See [Importing catalog data from Merchant Center](https://cloud.google.com/retail/recommendations-ai/docs/upload-catalog#mc). Supported
        ...
        interface GoogleCloudRetailV2alphaGetDefaultBranchResponse {
        ...
        interface GoogleCloudRetailV2alphaImage {
        ...
        interface GoogleCloudRetailV2alphaImportCompletionDataRequest {
        ...
        interface GoogleCloudRetailV2alphaImportProductsRequest {
        ...
        interface GoogleCloudRetailV2alphaImportUserEventsRequest {
        ...
        interface GoogleCloudRetailV2alphaInterval {
        ...
        interface GoogleCloudRetailV2alphaListCatalogsResponse {
        ...
        interface GoogleCloudRetailV2alphaListControlsResponse {
            /** All the Controls for a given catalog. */
            controls?: GoogleCloudRetailV2alphaControl[];
            /** Pagination token, if not returned indicates the last page. */
            nextPageToken?: string;
        }
        interface GoogleCloudRetailV2alphaListModelsResponse {
            /** List of Models. */
            models?: GoogleCloudRetailV2alphaModel[];
            /** Pagination token, if not returned indicates the last page. */
            nextPageToken?: string;
        }
        interface GoogleCloudRetailV2alphaListProductsResponse {
            ...
            /**
             * The total count of matched Products irrespective of pagination. The total number of Products returned by pagination may be less than the total_size that matches. This field is
             * ignored if ListProductsRequest.require_total_size is not set or ListProductsRequest.page_token is not empty.
             */
            totalSize?: number;
        }
        interface GoogleCloudRetailV2alphaListServingConfigsResponse {
            /** Pagination token, if not returned indicates the last page. */
            nextPageToken?: string;
            /** All the ServingConfigs for a given catalog. */
            servingConfigs?: GoogleCloudRetailV2alphaServingConfig[];
        }
        interface GoogleCloudRetailV2alphaLocalInventory {
            /**
             ...
             * At most 30 attributes are allowed. * The key must be a UTF-8 encoded string with a length limit of 32 characters. * The key must match the pattern: `a-zA-Z0-9*`. For example,
             * key0LikeThis or KEY_1_LIKE_THIS. * The attribute values must be of the same type (text or number). * Only 1 value is allowed for each attribute. * For text values, the length limit
        ...
        interface GoogleCloudRetailV2alphaMerchantCenterLink {
            /**
        ...
        interface GoogleCloudRetailV2alphaMerchantCenterLinkingConfig {
        ...
        interface GoogleCloudRetailV2alphaModel {
             ...
             * depends on type of recommendation: `recommended-for-you` => `ctr` `others-you-may-like` => `ctr` `frequently-bought-together` => `revenue_per_order`
             */
        ...
        interface GoogleCloudRetailV2alphaModelPageOptimizationConfig {
            /**
             * Required. The type of UserEvent this page optimization is shown for. Each page has an associated event type - this will be the corresponding event type for the page that the page
             * optimization model is used on. Supported types: * `add-to-cart`: Products being added to cart. * `detail-page-view`: Products detail page viewed. * `home-page-view`: Homepage viewed
        ...
        // tslint:disable-next-line:no-empty-interface
        interface GoogleCloudRetailV2alphaPauseModelRequest {
        }
        interface GoogleCloudRetailV2alphaPredictRequest {
            /**
             ...
             * blocks all prediction results, the API will return generic (unfiltered) popular products. If you only want results strictly matching the filters, set `strictFiltering` to True in
             * `PredictRequest.params` to receive empty results instead. Note that the API will never return items with storageStatus of "EXPIRED" or "DELETED" regardless of filter choices. If
             * `filterSyntaxV2` is set to true under the `params` field, then attribute-based expressions are expected instead of the above described tag-based syntax. Examples: * (colors:
             * ANY("Red", "Blue")) AND NOT (categories: ANY("Phones")) * (availability: ANY("IN_STOCK")) AND (colors: ANY("Red") OR categories: ANY("Phones"))
             */
            filter?: string;
            /**
             ...
             * contain only lowercase letters, numeric characters, underscores, and dashes. All characters must use UTF-8 encoding, and international characters are allowed. * The key portion of a
        ...
        interface GoogleCloudRetailV2alphaPredictResponse {
        ...
        interface GoogleCloudRetailV2alphaPredictResponsePredictionResult {
        ...
        interface GoogleCloudRetailV2alphaPriceInfo {
            /**
        ...
        interface GoogleCloudRetailV2alphaPriceInfoPriceRange {
        ...
        interface GoogleCloudRetailV2alphaProduct {
            /**
             ...
             * fields in SearchResponse can increase response payload size and serving latency.
             */
        ...
        interface GoogleCloudRetailV2alphaProductDetail {
            /**
        ...
        interface GoogleCloudRetailV2alphaProductLevelConfig {
            /**
             ...
             * will default to Product.Type.PRIMARY if unset. * `variant` (incompatible with Retail Search): You can only ingest Product.Type.VARIANT Products. This means
        ...
        interface GoogleCloudRetailV2alphaPromotion {
            /**
             * Promotion identifier, which is the final component of name. For example, this field is "free_gift", if name is
             * `projects/*‍/locations/global/catalogs/default_catalog/promotions/free_gift`. The value must be a UTF-8 encoded string with a length limit of 128 characters, and match the pattern:
        ...
        interface GoogleCloudRetailV2alphaPurchaseTransaction {
            /**
        ...
        interface GoogleCloudRetailV2alphaPurgeProductsRequest {
            /**
             * Required. The filter string to specify the products to be deleted with a length limit of 5,000 characters. Empty string filter is not allowed. "*" implies delete all items in a
             * branch. The eligible fields for filtering are: * `availability`: Double quoted Product.availability string. * `create_time` : in ISO 8601 "zulu" format. Supported syntax: *
             * Comparators (">", "<", ">=", "<=", "="). Examples: * create_time <= "2015-02-13T17:05:46Z" * availability = "IN_STOCK" * Conjunctions ("AND") Examples: * create_time <=
             * "2015-02-13T17:05:46Z" AND availability = "PREORDER" * Disjunctions ("OR") Examples: * create_time <= "2015-02-13T17:05:46Z" OR availability = "IN_STOCK" * Can support nested
             * queries. Examples: * (create_time <= "2015-02-13T17:05:46Z" AND availability = "PREORDER") OR (create_time >= "2015-02-14T13:03:32Z" AND availability = "IN_STOCK") * Filter Limits:
             * * Filter should not contain more than 6 conditions. * Max nesting depth should not exceed 2 levels. Examples queries: * Delete back order products created before a timestamp.
        ...
        interface GoogleCloudRetailV2alphaPurgeUserEventsRequest {
            /**
        ...
        interface GoogleCloudRetailV2alphaRating {
        ...
        interface GoogleCloudRetailV2alphaRejoinUserEventsRequest {
            /**
        ...
        interface GoogleCloudRetailV2alphaRemoveCatalogAttributeRequest {
            /** Required. The attribute name key of the CatalogAttribute to remove. */
            key?: string;
        }
        interface GoogleCloudRetailV2alphaRemoveControlRequest {
        ...
        interface GoogleCloudRetailV2alphaRemoveFulfillmentPlacesRequest {
            /**
             * If set to true, and the Product is not found, the fulfillment information will still be processed and retained for at most 1 day and processed once the Product is created. If set to
             * false, a NOT_FOUND error is returned if the Product is not found.
             */
        ...
        interface GoogleCloudRetailV2alphaRemoveLocalInventoriesRequest {
            /**
        ...
        interface GoogleCloudRetailV2alphaReplaceCatalogAttributeRequest {
        ...
        // tslint:disable-next-line:no-empty-interface
        interface GoogleCloudRetailV2alphaResumeModelRequest {
        }
        interface GoogleCloudRetailV2alphaRule {
            /** A boost action. */
        ...
        interface GoogleCloudRetailV2alphaRuleBoostAction {
            /**
             * Strength of the condition boost, which must be in [-1, 1]. Negative boost means demotion. Default is 0.0. Setting to 1.0 gives the item a big promotion. However, it does not
        ...
        interface GoogleCloudRetailV2alphaRuleDoNotAssociateAction {
        ...
        interface GoogleCloudRetailV2alphaRuleFilterAction {
            /**
             * A filter to apply on the matching condition results. Supported features: * filter must be set. * Filter syntax is identical to SearchRequest.filter. See more details at the Retail
             * Search [user guide](/retail/search/docs/filter-and-order#filter). * To filter products with product ID "product_1" or "product_2", and color "Red" or "Blue": *(id: ANY("product_1",
             * "product_2")) * *AND * *(colorFamilies: ANY("Red", "Blue")) *
             */
            filter?: string;
        }
        interface GoogleCloudRetailV2alphaRuleIgnoreAction {
            /** Terms to ignore in the search query. */
            ignoreTerms?: string[];
        }
        interface GoogleCloudRetailV2alphaRuleOnewaySynonymsAction {
            /** Will be [deprecated = true] post migration; */
            onewayTerms?: string[];
        ...
        interface GoogleCloudRetailV2alphaRuleRedirectAction {
            /** URL must have length equal or less than 2000 characters. */
            redirectUri?: string;
        }
        interface GoogleCloudRetailV2alphaRuleReplacementAction {
        ...
        interface GoogleCloudRetailV2alphaRuleTwowaySynonymsAction {
            /** Defines a set of synonyms. Can specify up to 100 synonyms. Must specify at least 2 synonyms. */
            synonyms?: string[];
        }
        interface GoogleCloudRetailV2alphaSearchRequest {
            /**
             ...
             * such as query expansion is needed. For example, if a query does not have enough results, an expanded query with SearchRequest.canonical_filter will be returned as a supplement of
             * the original query. This field is strongly recommended to achieve high search quality. See SearchRequest.filter for more details about filter syntax.
             */
            ...
            /**
             * The relevance threshold of the search results. Defaults to RelevanceThreshold.HIGH, which means only the most relevant results are shown, and the least number of results are
             * returned. See more details at this [user guide](https://cloud.google.com/retail/docs/result-size#relevance_thresholding).
             */
             ...
             * inventory(place_id,attributes.key), where key is any key in the Product.local_inventories.attributes map. * attributes.key, where key is any key in the Product.attributes map. *
        ...
        interface GoogleCloudRetailV2alphaSearchRequestBoostSpec {
            /**
        ...
        interface GoogleCloudRetailV2alphaSearchRequestBoostSpecConditionBoostSpec {
            /**
        ...
        interface GoogleCloudRetailV2alphaSearchRequestDynamicFacetSpec {
            /** Mode of the DynamicFacet feature. Defaults to Mode.DISABLED if it's unset. */
            mode?: string;
        }
        interface GoogleCloudRetailV2alphaSearchRequestFacetSpec {
            /**
             ...
             * are 100 products with the color facet "Red" and 200 products with the color facet "Blue". A query containing the filter "colorFamilies:ANY("Red")" and having "colorFamilies" as
             * FacetKey.key would by default return only "Red" products in the search results, and also return "Red" with count 100 as the only color facet. Although there are also blue products
             * available, "Blue" would not be shown as an available facet value. If "colorFamilies" is listed in "excludedFilterKeys", then the query returns the facet values "Red" with count 100
        ...
        interface GoogleCloudRetailV2alphaSearchRequestFacetSpecFacetKey {
             ...
             * SearchResponse.Facet.values.value will be always "1" and SearchResponse.Facet.values.count will be the number of results that match the query. For example, you can set a customized
             * facet for "shipToStore", where FacetKey.key is "customizedShipToStore", and FacetKey.query is "availability: ANY(\"IN_STOCK\") AND shipToStore: ANY(\"123\")". Then the facet will
        ...
        interface GoogleCloudRetailV2alphaSearchRequestPersonalizationSpec {
            /** Defaults to Mode.AUTO. */
            mode?: string;
        }
        interface GoogleCloudRetailV2alphaSearchRequestQueryExpansionSpec {
            /** The condition under which query expansion should occur. Default to Condition.DISABLED. */
            condition?: string;
            /** Whether to pin unexpanded results. If this field is set to true, unexpanded products are always at the top of the search results, followed by the expanded results. */
            pinUnexpandedResults?: boolean;
        }
        interface GoogleCloudRetailV2alphaSearchRequestSpellCorrectionSpec {
            /** The mode under which spell correction should take effect to replace the original search query. Default to Mode.AUTO. */
            mode?: string;
        }
        interface GoogleCloudRetailV2alphaSearchResponse {
        ...
        interface GoogleCloudRetailV2alphaSearchResponseFacet {
        ...
        interface GoogleCloudRetailV2alphaSearchResponseFacetFacetValue {
        ...
        interface GoogleCloudRetailV2alphaSearchResponseQueryExpansionInfo {
        ...
        interface GoogleCloudRetailV2alphaSearchResponseSearchResult {
        ...
        interface GoogleCloudRetailV2alphaServingConfig {
            /**
             * Condition boost specifications. If a product matches multiple conditions in the specifications, boost scores from these specifications are all applied and combined in a non-linear
             * way. Maximum number of specifications is 100. Notice that if both ServingConfig.boost_control_ids and SearchRequest.boost_spec are set, the boost conditions from both places are
            ...
            /**
             * The id of the model to use at serving time. Currently only RecommendationModels are supported: https://cloud.google.com/retail/recommendations-ai/docs/create-models Can be changed
             * but only to a compatible model (e.g. others-you-may-like CTR to others-you-may-like CVR). Required when solution_types is SOLUTION_TYPE_RECOMMENDATION.
             */
            modelId?: string;
             ...
             * items first. This setting could result in a decrease in click-through and conversion rates. Allowed values are: * 'no-price-reranking' * 'low-price-raranking' *
        ...
        interface GoogleCloudRetailV2alphaSetDefaultBranchRequest {
            /**
        ...
        interface GoogleCloudRetailV2alphaSetInventoryRequest {
            /**
             ...
             * SetInventoryRequest.set_time. The caller can replace place IDs for a subset of fulfillment types in the following ways: * Adds "fulfillment_info" in SetInventoryRequest.set_mask *
             * Specifies only the desired fulfillment types and corresponding place IDs to update in SetInventoryRequest.inventory.fulfillment_info The caller can clear all place IDs from a subset
             * of fulfillment types in the following ways: * Adds "fulfillment_info" in SetInventoryRequest.set_mask * Specifies only the desired fulfillment types to clear in
             * SetInventoryRequest.inventory.fulfillment_info * Checks that only the desired fulfillment info types have empty SetInventoryRequest.inventory.fulfillment_info.place_ids The last
        ...
        // tslint:disable-next-line:no-empty-interface
        interface GoogleCloudRetailV2alphaTuneModelRequest {
        }
        // tslint:disable-next-line:no-empty-interface
        interface GoogleCloudRetailV2alphaTuneModelResponse {
        }
        interface GoogleCloudRetailV2alphaUserEvent {
            /**
             * Extra user event features to include in the recommendation model. If you provide custom attributes for ingested user events, also include them in the user events that you associate
             * with prediction requests. Custom attribute formatting must be consistent between imported events and events provided with prediction requests. This lets the Retail API use those
             * custom attributes when training models and serving predictions, which helps improve recommendation quality. This field needs to pass all below criteria, otherwise an
             * INVALID_ARGUMENT error is returned: * The key must be a UTF-8 encoded string with a length limit of 5,000 characters. * For text attributes, at most 400 values are allowed. Empty
             * values are not allowed. Each value must be a UTF-8 encoded string with a length limit of 256 characters. * For number attributes, at most 400 values are allowed. For product
             ...
             * of those users together, which results in degraded model quality. The field must be a UTF-8 encoded string with a length limit of 128 characters. Otherwise, an INVALID_ARGUMENT
        ...
        interface GoogleCloudRetailV2alphaUserEventInlineSource {
            /** Required. A list of user events to import. Recommended max of 10k items. */
            userEvents?: GoogleCloudRetailV2alphaUserEvent[];
        }
        interface GoogleCloudRetailV2alphaUserEventInputConfig {
        ...
        interface GoogleCloudRetailV2alphaUserInfo {
            /**
        ...
        // tslint:disable-next-line:no-empty-interface
        interface GoogleCloudRetailV2betaAddLocalInventoriesMetadata {
        }
        // tslint:disable-next-line:no-empty-interface
        ...
        // tslint:disable-next-line:no-empty-interface
        interface GoogleCloudRetailV2betaRemoveLocalInventoriesMetadata {
        }
        // tslint:disable-next-line:no-empty-interface
        ...
        // tslint:disable-next-line:no-empty-interface
        interface GoogleCloudRetailV2RemoveLocalInventoriesMetadata {
        }
        // tslint:disable-next-line:no-empty-interface
        interface GoogleCloudRetailV2RemoveLocalInventoriesResponse {
        }
        // tslint:disable-next-line:no-empty-interface
        ...
        interface AttributesConfigResource {
            ...
            addCatalogAttribute(request: {
                ...
                uploadType?: string;
                /** Request body */
                resource: GoogleCloudRetailV2alphaAddCatalogAttributeRequest;
            ...
            body: GoogleCloudRetailV2alphaAddCatalogAttributeRequest): Request<GoogleCloudRetailV2alphaAttributesConfig>;
            ...
            batchRemoveCatalogAttributes(request: {
                ...
                uploadType?: string;
                /** Request body */
                resource: GoogleCloudRetailV2alphaBatchRemoveCatalogAttributesRequest;
            ...
            body: GoogleCloudRetailV2alphaBatchRemoveCatalogAttributesRequest): Request<GoogleCloudRetailV2alphaBatchRemoveCatalogAttributesResponse>;
            ...
            removeCatalogAttribute(request: {
                ...
                uploadType?: string;
                /** Request body */
                resource: GoogleCloudRetailV2alphaRemoveCatalogAttributeRequest;
            }): Request<GoogleCloudRetailV2alphaAttributesConfig>;
            removeCatalogAttribute(request: {
                /** V1 error format. */
                "$.xgafv"?: string;
            ...
            body: GoogleCloudRetailV2alphaRemoveCatalogAttributeRequest): Request<GoogleCloudRetailV2alphaAttributesConfig>;
            /**
             * Replaces the specified CatalogAttribute in the AttributesConfig by updating the catalog attribute with the same CatalogAttribute.key. If the CatalogAttribute to replace does not
            ...
            replaceCatalogAttribute(request: {
                ...
                uploadType?: string;
                /** Request body */
                resource: GoogleCloudRetailV2alphaReplaceCatalogAttributeRequest;
            }): Request<GoogleCloudRetailV2alphaAttributesConfig>;
            replaceCatalogAttribute(request: {
                /** V1 error format. */
                "$.xgafv"?: string;
            ...
            body: GoogleCloudRetailV2alphaReplaceCatalogAttributeRequest): Request<GoogleCloudRetailV2alphaAttributesConfig>;
        }
        ...
        interface ProductsResource {
            ...
            addFulfillmentPlaces(request: {
                ...
                uploadType?: string;
                /** Request body */
                resource: GoogleCloudRetailV2alphaAddFulfillmentPlacesRequest;
            }): Request<GoogleLongrunningOperation>;
            addFulfillmentPlaces(request: {
                /** V1 error format. */
                "$.xgafv"?: string;
            ...
            body: GoogleCloudRetailV2alphaAddFulfillmentPlacesRequest): Request<GoogleLongrunningOperation>;
            /**
            ...
            addLocalInventories(request: {
                ...
                uploadType?: string;
                /** Request body */
                resource: GoogleCloudRetailV2alphaAddLocalInventoriesRequest;
            }): Request<GoogleLongrunningOperation>;
            addLocalInventories(request: {
                /** V1 error format. */
                "$.xgafv"?: string;
            ...
            body: GoogleCloudRetailV2alphaAddLocalInventoriesRequest): Request<GoogleLongrunningOperation>;
            /** Creates a Product. */
            create(request: {
                /** V1 error format. */
                "$.xgafv"?: string;
                ...
                uploadType?: string;
                /** Request body */
                resource: GoogleCloudRetailV2alphaProduct;
            ...
            body: GoogleCloudRetailV2alphaProduct): Request<GoogleCloudRetailV2alphaProduct>;
            /** Deletes a Product. */
            delete(request?: {
                /** V1 error format. */
                "$.xgafv"?: string;
            ...
            import(request: {
                ...
                uploadType?: string;
                /** Request body */
                resource: GoogleCloudRetailV2alphaImportProductsRequest;
            }): Request<GoogleLongrunningOperation>;
            import(request: {
                /** V1 error format. */
                "$.xgafv"?: string;
            ...
            body: GoogleCloudRetailV2alphaImportProductsRequest): Request<GoogleLongrunningOperation>;
            ...
            list(request?: {
                ...
                readMask?: string;
                /**
                 * If true and page_token is empty, ListProductsResponse.total_size is set to the total count of matched items irrespective of pagination. Notice that setting this field to true
                ...
                /** Legacy upload protocol for media (e.g. "media", "multipart"). */
                uploadType?: string;
            }): Request<GoogleCloudRetailV2alphaListProductsResponse>;
            /** Updates a Product. */
            patch(request: {
                /** V1 error format. */
                "$.xgafv"?: string;
            ...
            body: GoogleCloudRetailV2alphaProduct): Request<GoogleCloudRetailV2alphaProduct>;
            /**
             * Permanently deletes all selected Products under a branch. This process is asynchronous. If the request is valid, the removal will be enqueued and processed offline. Depending on the
             * number of Products, this operation could take hours to complete. Before the operation completes, some Products may still be returned by ProductService.GetProduct or
             * ProductService.ListProducts. Depending on the number of Products, this operation could take hours to complete. To get a sample of Products that would be deleted, set
            ...
            purge(request: {
                ...
                uploadType?: string;
                /** Request body */
                resource: GoogleCloudRetailV2alphaPurgeProductsRequest;
            }): Request<GoogleLongrunningOperation>;
            purge(request: {
                /** V1 error format. */
                "$.xgafv"?: string;
            ...
            body: GoogleCloudRetailV2alphaPurgeProductsRequest): Request<GoogleLongrunningOperation>;
            /**
            ...
            removeFulfillmentPlaces(request: {
                ...
                uploadType?: string;
                /** Request body */
                resource: GoogleCloudRetailV2alphaRemoveFulfillmentPlacesRequest;
            }): Request<GoogleLongrunningOperation>;
            removeFulfillmentPlaces(request: {
                /** V1 error format. */
                "$.xgafv"?: string;
            ...
            body: GoogleCloudRetailV2alphaRemoveFulfillmentPlacesRequest): Request<GoogleLongrunningOperation>;
            /**
            ...
            removeLocalInventories(request: {
                ...
                uploadType?: string;
                /** Request body */
                resource: GoogleCloudRetailV2alphaRemoveLocalInventoriesRequest;
            }): Request<GoogleLongrunningOperation>;
            removeLocalInventories(request: {
                /** V1 error format. */
                "$.xgafv"?: string;
            ...
            body: GoogleCloudRetailV2alphaRemoveLocalInventoriesRequest): Request<GoogleLongrunningOperation>;
            /**
             ...
             * are not immediately manifested in the Product queried by ProductService.GetProduct or ProductService.ListProducts. When inventory is updated with ProductService.CreateProduct and
             * ProductService.UpdateProduct, the specified inventory field value(s) will overwrite any existing value(s) while ignoring the last update time for this field. Furthermore, the last
            ...
            setInventory(request: {
                ...
                uploadType?: string;
                /** Request body */
                resource: GoogleCloudRetailV2alphaSetInventoryRequest;
            }): Request<GoogleLongrunningOperation>;
            setInventory(request: {
                /** V1 error format. */
                "$.xgafv"?: string;
            ...
            body: GoogleCloudRetailV2alphaSetInventoryRequest): Request<GoogleLongrunningOperation>;
        }
        ...
        interface CompletionDataResource {
             ...
             * suggestions are indexed successfully and ready for serving. The process takes hours. This feature is only available for users who have Retail Search enabled. Please enable Retail
             * Search on Cloud Console before using this feature.
             */
            import(request: {
                /** V1 error format. */
                ...
                uploadType?: string;
                /** Request body */
                resource: GoogleCloudRetailV2alphaImportCompletionDataRequest;
            }): Request<GoogleLongrunningOperation>;
            import(request: {
                /** V1 error format. */
                "$.xgafv"?: string;
            ...
            body: GoogleCloudRetailV2alphaImportCompletionDataRequest): Request<GoogleLongrunningOperation>;
        }
        interface ControlsResource {
            ...
            create(request: {
                ...
                uploadType?: string;
                /** Request body */
                resource: GoogleCloudRetailV2alphaControl;
            ...
            body: GoogleCloudRetailV2alphaControl): Request<GoogleCloudRetailV2alphaControl>;
            ...
            list(request?: {
                ...
                /** Legacy upload protocol for media (e.g. "media", "multipart"). */
                uploadType?: string;
            }): Request<GoogleCloudRetailV2alphaListControlsResponse>;
        ...
        interface ModelsResource {
            ...
            create(request: {
                ...
                uploadType?: string;
                /** Request body */
                resource: GoogleCloudRetailV2alphaModel;
            }): Request<GoogleLongrunningOperation>;
            create(request: {
                /** V1 error format. */
                "$.xgafv"?: string;
            ...
            body: GoogleCloudRetailV2alphaModel): Request<GoogleLongrunningOperation>;
            ...
            body: GoogleCloudRetailV2alphaModel): Request<GoogleCloudRetailV2alphaModel>;
            ...
            pause(request: {
                ...
                uploadType?: string;
                /** Request body */
                resource: GoogleCloudRetailV2alphaPauseModelRequest;
            }): Request<GoogleCloudRetailV2alphaModel>;
            pause(request: {
                /** V1 error format. */
                "$.xgafv"?: string;
            ...
            body: GoogleCloudRetailV2alphaPauseModelRequest): Request<GoogleCloudRetailV2alphaModel>;
            ...
            resume(request: {
                ...
                uploadType?: string;
                /** Request body */
                resource: GoogleCloudRetailV2alphaResumeModelRequest;
            }): Request<GoogleCloudRetailV2alphaModel>;
            resume(request: {
                /** V1 error format. */
                "$.xgafv"?: string;
            ...
            body: GoogleCloudRetailV2alphaResumeModelRequest): Request<GoogleCloudRetailV2alphaModel>;
            ...
            tune(request: {
                ...
                uploadType?: string;
                /** Request body */
                resource: GoogleCloudRetailV2alphaTuneModelRequest;
            }): Request<GoogleLongrunningOperation>;
            tune(request: {
                /** V1 error format. */
                "$.xgafv"?: string;
            ...
            body: GoogleCloudRetailV2alphaTuneModelRequest): Request<GoogleLongrunningOperation>;
        }
        interface OperationsResource {
            /** Gets the latest state of a long-running operation. Clients can use this method to poll the operation result at intervals as recommended by the API service. */
            get(request?: {
        ...
        interface PlacementsResource {
            ...
            predict(request: {
                 ...
                 * the Recommendations AI serving config or placement. Before you can request predictions from your model, you must create at least one serving config or placement for it. For more
                 * information, see [Managing serving configurations] (https://cloud.google.com/retail/docs/manage-configs). The full list of available serving configs can be seen at
                ...
                uploadType?: string;
                /** Request body */
                resource: GoogleCloudRetailV2alphaPredictRequest;
            ...
            body: GoogleCloudRetailV2alphaPredictRequest): Request<GoogleCloudRetailV2alphaPredictResponse>;
            ...
            search(request: {
                ...
                uploadType?: string;
                /** Request body */
                resource: GoogleCloudRetailV2alphaSearchRequest;
            ...
            body: GoogleCloudRetailV2alphaSearchRequest): Request<GoogleCloudRetailV2alphaSearchResponse>;
        }
        interface ServingConfigsResource {
            /**
             * Enables a Control on the specified ServingConfig. The control is added in the last position of the list of controls it belongs to (e.g. if it's a facet spec control it will be
             * applied in the last position of servingConfig.facetSpecIds) Returns a ALREADY_EXISTS error if the control has already been applied. Returns a FAILED_PRECONDITION error if the
             * addition could exceed maximum number of control allowed for that type of control.
             */
            addControl(request: {
                /** V1 error format. */
                "$.xgafv"?: string;
                ...
                uploadType?: string;
                /** Request body */
                resource: GoogleCloudRetailV2alphaAddControlRequest;
            ...
            body: GoogleCloudRetailV2alphaAddControlRequest): Request<GoogleCloudRetailV2alphaServingConfig>;
            ...
            create(request: {
                ...
                uploadType?: string;
                /** Request body */
                resource: GoogleCloudRetailV2alphaServingConfig;
            }): Request<GoogleCloudRetailV2alphaServingConfig>;
            create(request: {
                /** V1 error format. */
                "$.xgafv"?: string;
            ...
            body: GoogleCloudRetailV2alphaServingConfig): Request<GoogleCloudRetailV2alphaServingConfig>;
            ...
            list(request?: {
                ...
                /** Legacy upload protocol for media (e.g. "media", "multipart"). */
                uploadType?: string;
            }): Request<GoogleCloudRetailV2alphaListServingConfigsResponse>;
            ...
            removeControl(request: {
                ...
                uploadType?: string;
                /** Request body */
                resource: GoogleCloudRetailV2alphaRemoveControlRequest;
            }): Request<GoogleCloudRetailV2alphaServingConfig>;
            removeControl(request: {
                /** V1 error format. */
                "$.xgafv"?: string;
            ...
            body: GoogleCloudRetailV2alphaRemoveControlRequest): Request<GoogleCloudRetailV2alphaServingConfig>;
            /** Performs a search. This feature is only available for users who have Retail Search enabled. Please enable Retail Search on Cloud Console before using this feature. */
            search(request: {
                /** V1 error format. */
                "$.xgafv"?: string;
        ...
        interface UserEventsResource {
            ...
            import(request: {
                ...
                uploadType?: string;
                /** Request body */
                resource: GoogleCloudRetailV2alphaImportUserEventsRequest;
            }): Request<GoogleLongrunningOperation>;
            import(request: {
                /** V1 error format. */
                "$.xgafv"?: string;
            ...
            body: GoogleCloudRetailV2alphaImportUserEventsRequest): Request<GoogleLongrunningOperation>;
            /**
            ...
            purge(request: {
                ...
                uploadType?: string;
                /** Request body */
                resource: GoogleCloudRetailV2alphaPurgeUserEventsRequest;
            }): Request<GoogleLongrunningOperation>;
            purge(request: {
                /** V1 error format. */
                "$.xgafv"?: string;
            ...
            body: GoogleCloudRetailV2alphaPurgeUserEventsRequest): Request<GoogleLongrunningOperation>;
            /**
             * Starts a user event rejoin operation with latest product catalog. Events will not be annotated with detailed product information if product is missing from the catalog at the time
             * the user event is ingested, and these events are stored as unjoined events with a limited usage on training and serving. This method can be used to start a join operation on
             * specified events with latest version of product catalog. It can also be used to correct events joined with the wrong product catalog. A rejoin operation can take hours or days to
             * complete.
             */
            rejoin(request: {
                /** V1 error format. */
                ...
                uploadType?: string;
                /** Request body */
                resource: GoogleCloudRetailV2alphaRejoinUserEventsRequest;
            }): Request<GoogleLongrunningOperation>;
            rejoin(request: {
                /** V1 error format. */
                "$.xgafv"?: string;
            ...
            body: GoogleCloudRetailV2alphaRejoinUserEventsRequest): Request<GoogleLongrunningOperation>;
            ...
            write(request: {
                ...
                uploadType?: string;
                /** Request body */
                resource: GoogleCloudRetailV2alphaUserEvent;
            ...
            body: GoogleCloudRetailV2alphaUserEvent): Request<GoogleCloudRetailV2alphaUserEvent>;
        }
        interface CatalogsResource {
            /**
             * Completes the specified prefix with keyword suggestions. This feature is only available for users who have Retail Search enabled. Please enable Retail Search on Cloud Console before
             * using this feature.
             */
            completeQuery(request?: {
                 ...
                 */
                visitorId?: string;
            }): Request<GoogleCloudRetailV2alphaCompleteQueryResponse>;
            ...
            getDefaultBranch(request?: {
                ...
                /** Legacy upload protocol for media (e.g. "media", "multipart"). */
                uploadType?: string;
            }): Request<GoogleCloudRetailV2alphaGetDefaultBranchResponse>;
            ...
            list(request?: {
                ...
                /** Legacy upload protocol for media (e.g. "media", "multipart"). */
                uploadType?: string;
            }): Request<GoogleCloudRetailV2alphaListCatalogsResponse>;
            ...
            patch(request: {
                ...
                uploadType?: string;
                /** Request body */
                resource: GoogleCloudRetailV2alphaCatalog;
            ...
            body: GoogleCloudRetailV2alphaCatalog): Request<GoogleCloudRetailV2alphaCatalog>;
            /**
            ...
            setDefaultBranch(request: {
                ...
                uploadType?: string;
                /** Request body */
                resource: GoogleCloudRetailV2alphaSetDefaultBranchRequest;
            }): Request<{}>;
            setDefaultBranch(request: {
                /** V1 error format. */
                "$.xgafv"?: string;
            ...
            body: GoogleCloudRetailV2alphaSetDefaultBranchRequest): Request<{}>;
            /**
             ...
             * request will remain unchanged. Attributes that are assigned to products, but do not exist at the catalog level, are always included in the response. The product attribute is
             * assigned default values for missing catalog attribute fields, e.g., searchable and dynamic facetable options.
             */
            updateAttributesConfig(request: {
                ...
                uploadType?: string;
                /** Request body */
                resource: GoogleCloudRetailV2alphaAttributesConfig;
            }): Request<GoogleCloudRetailV2alphaAttributesConfig>;
            updateAttributesConfig(request: {
                /** V1 error format. */
                "$.xgafv"?: string;
            ...
            body: GoogleCloudRetailV2alphaAttributesConfig): Request<GoogleCloudRetailV2alphaAttributesConfig>;
            ...
            updateCompletionConfig(request: {
                ...
                uploadType?: string;
                /** Request body */
                resource: GoogleCloudRetailV2alphaCompletionConfig;
            }): Request<GoogleCloudRetailV2alphaCompletionConfig>;
            updateCompletionConfig(request: {
                /** V1 error format. */
                "$.xgafv"?: string;
            ...
            body: GoogleCloudRetailV2alphaCompletionConfig): Request<GoogleCloudRetailV2alphaCompletionConfig>;
