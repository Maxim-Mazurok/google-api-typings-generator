...
declare namespace gapi.client {
    ...
    namespace retail {
        ...
        // tslint:disable-next-line:no-empty-interface
        interface GoogleCloudRetailV2alphaAcceptTermsRequest {
        }
        ...
        interface GoogleCloudRetailV2alphaAttributesConfig {
             ...
             */
            catalogAttributes?:
                { [P in string]: GoogleCloudRetailV2alphaCatalogAttribute };
        ...
        interface GoogleCloudRetailV2alphaCatalog {
            ...
            displayName?:
                string;
            /**
             * The Merchant Center linking configuration. After a link is added, the data stream from Merchant Center to Cloud Retail will be enabled automatically. The requester must have access
        ...
        interface GoogleCloudRetailV2alphaCatalogAttribute {
             ...
             * SearchService.Search. Must be specified when AttributesConfig.attribute_config_level is CATALOG_LEVEL_ATTRIBUTE_CONFIG, otherwise throws INVALID_FORMAT error.
             */
            indexableOption?:
                string;
            /**
             ...
             * field is `False` for pre-loaded CatalogAttributes. Only pre-loaded catalog attributes that are neither in use by products nor predefined can be deleted. Catalog attributes that are
             ...
             * numerical attributes. Must be specified, when AttributesConfig.attribute_config_level is CATALOG_LEVEL_ATTRIBUTE_CONFIG, otherwise throws INVALID_FORMAT error.
             */
            searchableOption?:
                string;
        ...
        interface GoogleCloudRetailV2alphaCatalogAttributeFacetConfig {
            /**
             * If you don't set the facet SearchRequest.FacetSpec.FacetKey.intervals in the request to a numerical attribute, then we use the computed intervals with rounded bounds obtained from
             * all its product numerical attribute values. The computed intervals might not be ideal for some attributes. Therefore, we give you the option to overwrite them with the
             * facet_intervals field. The maximum of facet intervals per CatalogAttribute is 40. Each interval must have a lower bound or an upper bound. If both bounds are provided, then the
            ...
            /**
             * Each instance replaces a list of facet values by a merged facet value. If a facet value is not in any list, then it will stay the same. To avoid conflicts, only paths of length 1
             * are accepted. In other words, if "dark_blue" merged into "BLUE", then the latter can't merge into "blues" because this would create a path of length 2. The maximum number of
             * instances of MergedFacetValue per CatalogAttribute is 100. This feature is available only for textual custom attributes.
             */
            mergedFacetValues?:
                GoogleCloudRetailV2alphaCatalogAttributeFacetConfigMergedFacetValue[];
        }
        interface GoogleCloudRetailV2alphaCatalogAttributeFacetConfigIgnoredFacetValues {
             ...
             * empty, ignore always. If start time and end time are set, then start time must be before end time. If start time is not empty and end time is empty, then will ignore these facet
             * values after the start time.
             */
            startTime?:
                string;
            /**
             * List of facet values to ignore for the following time range. The facet values are the same as the attribute values. There is a limit of 10 values per instance of IgnoredFacetValues.
             * Each value can have at most 128 characters.
             */
            values?:
                string[];
        }
        interface GoogleCloudRetailV2alphaCatalogAttributeFacetConfigMergedFacetValue {
        ...
        interface GoogleCloudRetailV2alphaCompleteQueryResponse {
            ...
            /**
             * Deprecated. Matched recent searches of this user. The maximum number of recent searches is 10. This field is a restricted feature. If you want to enable it, contact Retail Search
             * support. This feature is only available when CompleteQueryRequest.visitor_id field is set and UserEvent is imported. The recent searches satisfy the follow rules: * They are ordered
             * from latest to oldest. * They are matched with CompleteQueryRequest.query case insensitively. * They are transformed to lower case. * They are UTF-8 safe. Recent searches are
        ...
        interface GoogleCloudRetailV2alphaCompleteQueryResponseAttributeResult {
        ...
        interface GoogleCloudRetailV2alphaCompleteQueryResponseCompletionResult {
             ...
             */
            attributes?:
                { [P in string]: GoogleCloudRetailV2alphaCustomAttribute };
            /**
             * Facet information for the suggestion term. Gives the number of items resulting from a search with this suggestion term for each facet. This is an experimental feature for limited
            ...
            suggestion?:
                string;
            /**
             * Total number of products associated with a search with this suggestion. This is an experimental feature for limited customers. If you want to receive this product count information,
        ...
        // tslint:disable-next-line:no-empty-interface
        interface GoogleCloudRetailV2alphaEnrollSolutionMetadata {
        }
        interface GoogleCloudRetailV2alphaEnrollSolutionRequest {
            /** Required. Solution to enroll. */
            solution?:
                string;
        }
        interface GoogleCloudRetailV2alphaEnrollSolutionResponse {
            /** Retail API solution that the project has enrolled. */
            enrolledSolution?:
                string;
        }
        interface GoogleCloudRetailV2alphaExperimentInfo {
            /**
        ...
        interface GoogleCloudRetailV2alphaExperimentInfoServingConfigExperiment {
            /**
        ...
        interface GoogleCloudRetailV2alphaListEnrolledSolutionsResponse {
            /** Retail API solutions that the project has enrolled. */
            enrolledSolutions?:
                string[];
        }
        interface GoogleCloudRetailV2alphaListMerchantCenterAccountLinksResponse {
            /** The links. */
        ...
        interface GoogleCloudRetailV2alphaLoggingConfig {
            ...
            name?:
                string;
            /**
             * Controls logging configurations more granularly for each supported service. This overrides the default_log_generation_rule for the services specified. For those not mentioned, they
        ...
        interface GoogleCloudRetailV2alphaLoggingConfigLogGenerationRule {
            /**
             * The log sample rate for INFO level log entries. You can use this to reduce the number of entries generated for INFO level logs. DO NOT set this field if the logging_level is not
             * LoggingLevel.LOG_ALL. Otherwise, an INVALID_ARGUMENT error is returned. Sample rate for INFO logs defaults to 1 when unset (generate and send all INFO logs to Cloud Logging). Its
        ...
        interface GoogleCloudRetailV2alphaLoggingConfigServiceLogGenerationRule {
            /** The log generation rule that applies to this service. */
            logGenerationRule?:
                GoogleCloudRetailV2alphaLoggingConfigLogGenerationRule;
            /**
             * Required. Supported service names: "CatalogService", "CompletionService", "ControlService", "MerchantCenterStreaming", "ModelService", "PredictionService", "ProductService",
        ...
        interface GoogleCloudRetailV2alphaMerchantCenterAccountLink {
            /**
             * Required. The branch ID (e.g. 0/1/2) within the catalog that products from merchant_center_account_id are streamed to. When updating this field, an empty value will use the
        ...
        interface GoogleCloudRetailV2alphaModel {
             ...
             * optimization_objective describe model metadata to use to control model training and serving. See https://cloud.google.com/retail/docs/models for more details on what the model
             ...
             * model training and serving. See https://cloud.google.com/retail/docs/models for more details on what the model metadata control and which combination of parameters are valid. For
        ...
        interface GoogleCloudRetailV2alphaModelFrequentlyBoughtTogetherFeaturesConfig {
            /**
             * Optional. Specifies the context of the model when it is used in predict requests. Can only be set for the `frequently-bought-together` type. If it isn't specified, it defaults to
        ...
        interface GoogleCloudRetailV2alphaPredictRequest {
             ...
             * blocks all prediction results, the API will return *no* results. If instead you want empty result sets to return generic (unfiltered) popular products, set `strictFiltering` to
             * False in `PredictRequest.params`. Note that the API will never return items with storageStatus of "EXPIRED" or "DELETED" regardless of filter choices. If `filterSyntaxV2` is set to
             * true under the `params` field, then attribute-based expressions are expected instead of the above described tag-based syntax. Examples: * (colors: ANY("Red", "Blue")) AND NOT
             ...
             * `results.metadata` field in the prediction response. The given 'score' indicates the probability of a product being clicked/purchased given the user's context and history. *
        ...
        interface GoogleCloudRetailV2alphaProduct {
            ...
            availableTime?:
                string;
            /**
             * The brands of the product. A maximum of 30 brands are allowed unless overridden through the Google Cloud console. Each brand must be a UTF-8 encoded string with a length limit of
             * 1,000 characters. Otherwise, an INVALID_ARGUMENT error is returned. Corresponding properties: Google Merchant Center property
             * [brand](https://support.google.com/merchants/answer/6324351). Schema.org property [Product.brand](https://schema.org/brand).
             */
            brands?:
                string[];
            /**
             ...
             * "categories": [ "Shoes & Accessories > Shoes", "Sports & Fitness > Athletic Clothing > Shoes" ] Must be set for Type.PRIMARY Product otherwise an INVALID_ARGUMENT error is returned.
             * At most 250 values are allowed per Product. Empty values are not allowed. Each value must be a UTF-8 encoded string with a length limit of 5,000 characters. Otherwise, an
             ...
             * SearchService.Search after expire_time. However, the product can still be retrieved by ProductService.GetProduct and ProductService.ListProducts. expire_time must be later than
        ...
        interface GoogleCloudRetailV2alphaProject {
        ...
        interface GoogleCloudRetailV2alphaRuleFilterAction {
            /**
             * A filter to apply on the matching condition results. Supported features: * filter must be set. * Filter syntax is identical to SearchRequest.filter. For more information, see
        ...
        interface GoogleCloudRetailV2alphaRuleForceReturnFacetAction {
        ...
        interface GoogleCloudRetailV2alphaRuleForceReturnFacetActionFacetPositionAdjustment {
        ...
        interface GoogleCloudRetailV2alphaRuleRemoveFacetAction {
            /**
             * The attribute names (i.e. facet keys) to remove from the dynamic facets (if present in the request). There can't be more 3 attribute names. Each attribute name should be a valid
        ...
        interface GoogleCloudRetailV2alphaSearchRequest {
            /**
             * Boost specification to boost certain products. For more information, see [Boost results](https://cloud.google.com/retail/docs/boosting). Notice that if both
             ...
             * returned. For more information, see [Adjust result size](https://cloud.google.com/retail/docs/result-size#relevance_thresholding).
             */
            relevanceThreshold?:
                string;
        ...
        interface GoogleCloudRetailV2alphaSearchRequestFacetSpec {
            /**
             * Enables dynamic position for this facet. If set to true, the position of this facet among all facets in the response is determined by Google Retail Search. It is ordered together
             * with dynamic facets if dynamic facets is enabled. If set to false, the position of this facet in the response is the same as in the request, and it is ranked before the facets with
             * dynamic position enable and all dynamic facets. For example, you may always want to have rating facet returned in the response, but it's not necessarily to always display the rating
             * facet at the top. In that case, you can set enable_dynamic_position to true so that the position of rating facet in response is determined by Google Retail Search. Another example,
             * assuming you have the following facets in the request: * "rating", enable_dynamic_position = true * "price", enable_dynamic_position = false * "brands", enable_dynamic_position =
             * false And also you have a dynamic facets enable, which generates a facet "gender". Then, the final order of the facets in the response can be ("price", "brands", "rating", "gender")
        ...
        interface GoogleCloudRetailV2alphaSearchRequestFacetSpecFacetKey {
             ...
             * SearchResponse.Facet.values.value is always "1" and SearchResponse.Facet.values.count is the number of results that match the query. For example, you can set a customized facet for
        ...
        interface GoogleCloudRetailV2betaPurgeProductsMetadata {
            /** Operation create time. */
            createTime?:
                string;
            /** Count of entries that encountered errors while processing. */
        ...
        interface GoogleCloudRetailV2betaPurgeProductsResponse {
            /** The total count of products purged as a result of the operation. */
            purgeCount?:
                string;
            /** A sample of the product names that will be deleted. Only populated if `force` is set to false. A max of 100 names will be returned and the names are chosen at random. */
        ...
        // tslint:disable-next-line:no-empty-interface
        interface GoogleCloudRetailV2betaTuneModelResponse {
        }
        ...
        interface GoogleCloudRetailV2PurgeProductsMetadata {
            /** Operation create time. */
            createTime?:
                string;
            /** Count of entries that encountered errors while processing. */
        ...
        interface GoogleCloudRetailV2PurgeProductsResponse {
            /** The total count of products purged as a result of the operation. */
            purgeCount?:
                string;
            /** A sample of the product names that will be deleted. Only populated if `force` is set to false. A max of 100 names will be returned and the names are chosen at random. */
        ...
        interface ProductsResource {
            /**
             * We recommend that you use the ProductService.AddLocalInventories method instead of the ProductService.AddFulfillmentPlaces method. ProductService.AddLocalInventories achieves the
             * same results but provides more fine-grained control over ingesting local inventory data. Incrementally adds place IDs to Product.fulfillment_info.place_ids. This process is
             * asynchronous and does not require the Product to exist before updating fulfillment information. If the request is valid, the update will be enqueued and processed downstream. As a
             * consequence, when a response is returned, the added place IDs are not immediately manifested in the Product queried by ProductService.GetProduct or ProductService.ListProducts. The
             * returned Operations will be obsolete after 1 day, and GetOperation API will return NOT_FOUND afterwards. If conflicting updates are issued, the Operations associated with the stale
            ...
            delete(request?: {
                ...
                fields?:
                    string;
                /**
                 * This value only applies to the case when the target product is of type PRIMARY. When deleting a product of VARIANT/COLLECTION type, this value will be ignored. When set to true,
                 * the subsequent variant products will be deleted. When set to false, if the primary product has active variant products, an error will be returned.
                 */
                force?:
                    boolean;
                /** API key. Your API key identifies your project and provides you with API access, quota, and reports. Required unless you provide an OAuth 2.0 token. */
            ...
            /**
             * We recommend that you use the ProductService.RemoveLocalInventories method instead of the ProductService.RemoveFulfillmentPlaces method. ProductService.RemoveLocalInventories
             * achieves the same results but provides more fine-grained control over ingesting local inventory data. Incrementally removes place IDs from a Product.fulfillment_info.place_ids. This
             * process is asynchronous and does not require the Product to exist before updating fulfillment information. If the request is valid, the update will be enqueued and processed
             * downstream. As a consequence, when a response is returned, the removed place IDs are not immediately manifested in the Product queried by ProductService.GetProduct or
             * ProductService.ListProducts. The returned Operations will be obsolete after 1 day, and GetOperation API will return NOT_FOUND afterwards. If conflicting updates are issued, the
             ...
             * associated with the stale updates will not be marked as done until being obsolete.
             */
             ...
             * exist before updating fulfillment information. If the request is valid, the update is enqueued and processed downstream. As a consequence, when a response is returned, updates are
             * not immediately manifested in the Product queried by ProductService.GetProduct or ProductService.ListProducts. When inventory is updated with ProductService.CreateProduct and
             ...
             * ProductService.RemoveFulfillmentPlaces. The returned Operations is obsolete after one day, and the GetOperation API returns `NOT_FOUND` afterwards. If conflicting updates are
             * issued, the Operations associated with the stale updates are not marked as done until they are obsolete.
             */
        ...
        interface MerchantCenterAccountLinksResource {
            ...
            body: GoogleCloudRetailV2alphaMerchantCenterAccountLink): Request<GoogleLongrunningOperation>;
            ...
            list(request?: {
                ...
                uploadType?:
                    string;
            }): Request<GoogleCloudRetailV2alphaListMerchantCenterAccountLinksResponse>;
        }
        ...
        interface UserEventsResource {
            ...
            /**
             * Starts a user-event rejoin operation with latest product catalog. Events are not annotated with detailed product information for products that are missing from the catalog when the
             * user event is ingested. These events are stored as unjoined events with limited usage on training and serving. You can use this method to start a join operation on specified events
             * with the latest version of product catalog. You can also use this method to correct events joined with the wrong product catalog. A rejoin operation can take hours or days to
             * complete.
             */
            rejoin(request: {
                /** V1 error format. */
        ...
        interface CatalogsResource {
            /**
             * Completes the specified prefix with keyword suggestions. This feature is only available for users who have Retail Search enabled. Enable Retail Search on Cloud Console before using
             * this feature.
             */
        ...
        interface RetailProjectResource {
            ...
            body: GoogleCloudRetailV2alphaAcceptTermsRequest): Request<GoogleCloudRetailV2alphaProject>;
        }
        interface ProjectsResource {
            /**
             * The method enrolls a solution of type Retail Search into a project. The Recommendations AI solution type is enrolled by default when your project enables Retail API, so you don't
            ...
            body: GoogleCloudRetailV2alphaEnrollSolutionRequest): Request<GoogleLongrunningOperation>;
            ...
            listEnrolledSolutions(request?: {
                ...
                uploadType?:
                    string;
            }): Request<GoogleCloudRetailV2alphaListEnrolledSolutionsResponse>;
            ...
            updateLoggingConfig(request: {
                ...
                quotaUser?:
                    string;
                /**
                 * Indicates which fields in the provided LoggingConfig to update. The following are the only supported fields: * default_log_generation_rule * per_service_log_generation_rules If
            ...
            body: GoogleCloudRetailV2alphaLoggingConfig): Request<GoogleCloudRetailV2alphaLoggingConfig>;
            locations:
                LocationsResource;
            operations:
                OperationsResource;
            retailProject:
                RetailProjectResource;
        }
