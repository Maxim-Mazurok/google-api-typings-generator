    ...
    namespace retail {
        ...
        interface GoogleCloudRetailV2alphaCatalogAttribute {
            ...
            exactSearchableOption?:
                string;
            /**
             * If you don't set the facet SearchRequest.FacetSpec.FacetKey.intervals to a numerical attribute, then a weekly pipeline calculates intervals using some percentiles on the
             * distribution of all its product numerical attribute values. The calculated intervals might not be ideal for some attributes. Therefore, we give you the option the overwrite them.
             * For any numerical attribute that is passed as a facet key in the request along with given intervals, the given intervals are the facet intervals returned in the response.
             */
            facetIntervals?:
            ...
            ignoredFacetValues?:
                GoogleCloudRetailV2alphaCatalogAttributeIgnoredFacetValues[];
            /**
