...
declare namespace gapi.client {
    ...
    namespace retail {
        ...
        interface GoogleCloudRetailV2alphaCatalogAttribute {
             ...
             * characters and underscores. For example, an attribute named `attributes.abc_xyz` can be indexed, but an attribute named `attributes.abc-xyz` cannot be indexed. For attributes whoes
             * key start with `attributes.`, we refer them as custom attributes. Otherwise they are built-in attributes such as `color` and `brands`.
             */
            key?: string;
            /**
