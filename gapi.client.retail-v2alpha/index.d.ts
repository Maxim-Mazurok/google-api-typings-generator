...
declare namespace gapi.client {
  ...
  namespace retail {
    ...
    interface GoogleCloudRetailV2alphaModelModelFeaturesConfig {
      ...
      llmEmbeddingConfig?: GoogleCloudRetailV2alphaModelModelFeaturesConfigLlmEmbeddingConfig;
    }
    interface GoogleCloudRetailV2alphaModelModelFeaturesConfigLlmEmbeddingConfig {
      /** Optional. The LLM embedding version to use. Currently only `v0` is supported. If not specified, feature will not be turned on. */
      llmEmbeddingVersion?: string;
    }
