...
declare namespace gapi.client {
    ...
    namespace retail {
        ...
        interface GoogleCloudRetailV2alphaPredictRequest {
             ...
             * (categories: ANY("Phones")) * (brands: ANY("Pixel")) AND (colors: ANY("Red") OR categories: ANY("Phones")) For more information, see [Filter
        ...
        interface GoogleCloudRetailV2alphaUserEvent {
            ...
            /**
             * Represents the domain of the user event, for projects that combine domains. For example: retailer can have events from multiple domains like retailer-main, retailer-baby,
