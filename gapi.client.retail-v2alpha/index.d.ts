...
declare namespace gapi.client {
    ...
    namespace retail {
        ...
        interface GoogleCloudRetailV2alphaCompleteQueryResponse {
            ...
            attributeResults?: { [P in string]: GoogleCloudRetailV2alphaCompleteQueryResponseAttributeResult };
            /**
        ...
        interface GoogleCloudRetailV2alphaCompleteQueryResponseCompletionResult {
            ...
            suggestion?: string;
            /**
             * Total number of products associated with a search with this suggestion. This is an experimental feature for limited customers. Please reach out to the support team if you would like
        ...
        interface GoogleCloudRetailV2alphaSearchRequest {
             ...
             * To represent full path of category, use '>' sign to separate different hierarchies. If '>' is part of the category name, replace it with other character(s). Category pages include
             * special pages such as sales or promotions. For instance, a special sale page may have the category hierarchy: "pageCategories" : ["Sales > 2017 Black Friday Deals"].
             */
        ...
        interface GoogleCloudRetailV2alphaSearchRequestFacetSpecFacetKey {
             ...
             * model assigns a high score to a numerical facet key and its intervals are not specified in the search request, these percentiles will become the bounds for its intervals and will be
             * returned in the response. If the facet key intervals are specified in the request, then the specified intervals will be returned instead.
             */
        ...
        interface GoogleCloudRetailV2alphaUserEvent {
            ...
            /**
             * The entity for customers that may run multiple different entities, domains, sites or regions, for example, "Google US", "Google Ads", "Waymo", "google.com", "youtube.com", etc. It
             * is recommended to set this field to get better per-entity search, completion and prediction results.
             */
            entity?: string;
        ...
        interface ProductsResource {
            /**
             * It is recommended to use the ProductService.AddLocalInventories method instead of ProductService.AddFulfillmentPlaces. ProductService.AddLocalInventories achieves the same results
             * but provides more fine-grained control over ingesting local inventory data. Incrementally adds place IDs to Product.fulfillment_info.place_ids. This process is asynchronous and does
             * not require the Product to exist before updating fulfillment information. If the request is valid, the update will be enqueued and processed downstream. As a consequence, when a
             * response is returned, the added place IDs are not immediately manifested in the Product queried by ProductService.GetProduct or ProductService.ListProducts. The returned Operations
             * will be obsolete after 1 day, and GetOperation API will return NOT_FOUND afterwards. If conflicting updates are issued, the Operations associated with the stale updates will not be
            ...
            /**
             * It is recommended to use the ProductService.RemoveLocalInventories method instead of ProductService.RemoveFulfillmentPlaces. ProductService.RemoveLocalInventories achieves the same
             * results but provides more fine-grained control over ingesting local inventory data. Incrementally removes place IDs from a Product.fulfillment_info.place_ids. This process is
             ...
             * consequence, when a response is returned, the removed place IDs are not immediately manifested in the Product queried by ProductService.GetProduct or ProductService.ListProducts.
             * The returned Operations will be obsolete after 1 day, and GetOperation API will return NOT_FOUND afterwards. If conflicting updates are issued, the Operations associated with the
        ...
        interface MerchantCenterAccountLinksResource {
            ...
            createMerchantCenterAccountLink(request: {
                ...
                uploadType?: string;
                /** Request body */
                resource: GoogleCloudRetailV2alphaMerchantCenterAccountLink;
            }): Request<GoogleLongrunningOperation>;
            createMerchantCenterAccountLink(request: {
                /** V1 error format. */
                "$.xgafv"?: string;
        ...
        interface PlacementsResource {
            ...
            search(request: {
                 ...
                 * config name and the set of models that will be used to make the search.
                 */
                placement: string;
                /** Returns response with indentations and line breaks. */
                prettyPrint?: boolean;
        ...
        interface CatalogsResource {
            ...
            completeQuery(request?: {
                 ...
                 * If this is set, it should be exactly matched with UserEvent.entity to get per-entity autocomplete results.
                 */
                entity?: string;
                /** Selector specifying which fields to include in a partial response. */
                fields?: string;
            ...
            merchantCenterAccountLinks: MerchantCenterAccountLinksResource;
