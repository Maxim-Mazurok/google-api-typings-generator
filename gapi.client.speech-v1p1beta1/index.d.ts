...
// Generated from: https://speech.googleapis.com/$discovery/rest?version=v1p1beta1
// Revision: 20230418

/// <reference types="gapi.client" />

declare namespace gapi.client {
    /** Load Cloud Speech-to-Text API v1p1beta1 */
    function load(urlOrObject: "https://speech.googleapis.com/$discovery/rest?version=v1p1beta1"): Promise<void>;
    /** @deprecated Please load APIs with discovery documents. */
    function load(name: "speech", version: "v1p1beta1"): Promise<void>;
    /** @deprecated Please load APIs with discovery documents. */
    function load(name: "speech", version: "v1p1beta1", callback: () => any): void;
    ...
    namespace speech {
        ...
        interface RecognitionConfig {
            ...
            /**
             * If set, specifies the estimated number of speakers in the conversation. Defaults to '2'. Ignored unless enable_speaker_diarization is set to true. Note: Use diarization_config
             * instead.
             */
            ...
            /**
             * If 'true', enables speaker detection for each recognized word in the top alternative of the recognition result using a speaker_label provided in the WordInfo. Note: Use
            ...
            /**
             * Use transcription normalization to automatically replace parts of the transcript with phrases of your choosing. For StreamingRecognize, this normalization only applies to stable
