...
```
npm install @types/gapi.client.merchantapi-products_v1beta --save-dev
```
...
```json
{
  "compilerOptions": {
    "types": [
      ...
      "gapi.auth2",
      "gapi.client",
      "gapi.client.merchantapi-products_v1beta"
    ]
  }
}
```
...
gapi.client.load('merchantapi', 'products_v1beta', () => {
  // now we can use:
  // gapi.client.merchantapi
});
```
...
For provenance information see [Provenance section on NPM](https://www.npmjs.com/package/@maxim_mazurok/gapi.client.merchantapi-products_v1beta#Provenance:~:text=none-,Provenance,-Built%20and%20signed)
