/* Type definitions for non-npm package Gemini Enterprise for Customer Experience API v1 0.0 */
...
// Generated from: https://ces.googleapis.com/$discovery/rest?version=v1
// Revision: 20260209

/// <reference types="gapi.client" />

declare namespace gapi.client {
  /** Load Gemini Enterprise for Customer Experience API v1 */
  function load(
    urlOrObject: 'https://ces.googleapis.com/$discovery/rest?version=v1',
  ): Promise<void>;
  /** @deprecated Please load APIs with discovery documents. */
  function load(name: 'ces', version: 'v1'): Promise<void>;
  /** @deprecated Please load APIs with discovery documents. */
  function load(name: 'ces', version: 'v1', callback: () => any): void;
