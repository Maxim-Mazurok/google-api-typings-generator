...
declare namespace gapi.client {
    ...
    namespace mybusinessbusinessinformation {
        ...
        interface Location {
             ...
             * requests if the user-provided `latlng` value was accepted during create, or the `latlng` value was updated through the Google My Business website. This field can only be updated by
             * approved clients.
             */
            latlng?: LatLng;
        ...
        interface LocationsResource {
            ...
            /**
             * Deletes a location. If this location cannot be deleted using the API and it is marked so in the `google.mybusiness.businessinformation.v1.LocationState`, use the [Google My
