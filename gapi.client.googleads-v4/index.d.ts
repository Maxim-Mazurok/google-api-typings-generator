...
declare namespace gapi.client {
    ...
    namespace googleads {
        ...
        interface GoogleAdsGoogleadsV10Common__PolicyViolationKey {
            ...
            policyName?: string;
            /**
             * The text that violates the policy if specified. Otherwise, refers to the policy in general (e.g., when requesting to be exempt from the whole policy). If not specified for criterion
