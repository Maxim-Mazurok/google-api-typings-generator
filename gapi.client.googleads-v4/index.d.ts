/* Type definitions for non-npm package Google Ads API v4 0.0 */
...
// Generated from: https://googleads.googleapis.com/$discovery/rest?version=v4
// Revision: 20230502

/// <reference types="gapi.client" />

declare namespace gapi.client {
    /** Load Google Ads API v4 */
    function load(urlOrObject: "https://googleads.googleapis.com/$discovery/rest?version=v4"): Promise<void>;
    /** @deprecated Please load APIs with discovery documents. */
    function load(name: "googleads", version: "v4"): Promise<void>;
    /** @deprecated Please load APIs with discovery documents. */
    function load(name: "googleads", version: "v4", callback: () => any): void;
