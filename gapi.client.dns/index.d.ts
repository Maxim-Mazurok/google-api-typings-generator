/* Type definitions for non-npm package Cloud DNS API v2 2.0 */
...
// Generated from: https://dns.googleapis.com/$discovery/rest?version=v2
// Revision: 20220331

/// <reference types="gapi.client" />

declare namespace gapi.client {
    /** Load Cloud DNS API v2 */
    function load(name: "dns", version: "v2"): PromiseLike<void>;
    function load(name: "dns", version: "v2", callback: () => any): void;
