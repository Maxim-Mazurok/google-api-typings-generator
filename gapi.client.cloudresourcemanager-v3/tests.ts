/* This is stub file for gapi.client.cloudresourcemanager-v3 definition tests */
// IMPORTANT
...
gapi.load('client', async () => {
  ...
  async function run() {
    ...
    await gapi.client.cloudresourcemanager.folders.capabilities.get({
      name: 'Test string',
    });
    /** Updates the Capability. */
    await gapi.client.cloudresourcemanager.folders.capabilities.patch(
      {
        name: 'Test string',
        updateMask: 'Test string',
      },
    ...
    await gapi.client.cloudresourcemanager.folders.capabilityConfigs.create(
      {
        capabilityConfigId: 'Test string',
        parent: 'Test string',
      },
      {
        boundaries: ['Test string'],
        createTime: 'Test string',
        displayName: 'Test string',
        etag: 'Test string',
        managementProject: 'Test string',
    ...
    await gapi.client.cloudresourcemanager.folders.capabilityConfigs.delete({
      name: 'Test string',
    });
    ...
    await gapi.client.cloudresourcemanager.folders.capabilityConfigs.get({
      name: 'Test string',
    });
    /** Lists CapabilityConfigs that are direct children of the specified organization, folder or project resource. */
    await gapi.client.cloudresourcemanager.folders.capabilityConfigs.list({
      pageSize: 42,
      pageToken: 'Test string',
      parent: 'Test string',
    });
    ...
    await gapi.client.cloudresourcemanager.folders.capabilityConfigs.patch(
      {
        name: 'Test string',
        updateMask: 'Test string',
      },
    ...
    await gapi.client.cloudresourcemanager.locations.effectiveTagBindingCollections.get(
      {
        name: 'Test string',
      },
    );
    /** Returns tag bindings directly attached to a GCP resource. */
    await gapi.client.cloudresourcemanager.locations.tagBindingCollections.get({
      name: 'Test string',
    });
    /** Updates tag bindings directly attached to a GCP resource. Update_mask can be kept empty or "*". */
    await gapi.client.cloudresourcemanager.locations.tagBindingCollections.patch(
      {
        name: 'Test string',
        updateMask: 'Test string',
      },
    ...
    /** Creates a CapabilityConfig under a parent Organization, Folder or Project. Creating a CapabilityConfig triggers the creation of a Management Project if one is not supplied. */
    await gapi.client.cloudresourcemanager.organizations.capabilityConfigs.create(
      {
        capabilityConfigId: 'Test string',
        parent: 'Test string',
      },
    ...
    /** Deletes the CapabilityConfig identified by the specified `name` (for example, `folders/123456789/capabilityConfigs/my-capability-config`). */
    await gapi.client.cloudresourcemanager.organizations.capabilityConfigs.delete(
      {
        name: 'Test string',
      },
    );
    /** Retrieves the Capability Config identified by the specified `name` (for example, `folders/123456789/capabilityConfigs/my-capability-config`). */
    await gapi.client.cloudresourcemanager.organizations.capabilityConfigs.get({
      name: 'Test string',
    });
    /** Lists CapabilityConfigs that are direct children of the specified organization, folder or project resource. */
    await gapi.client.cloudresourcemanager.organizations.capabilityConfigs.list(
      {
        pageSize: 42,
        pageToken: 'Test string',
        parent: 'Test string',
    ...
    /** Updates the `display_name`, `types` and `boundaries` of the CapabilityConfig identified by the specified `name` (for example, `folders/123456789/capabilityConfigs/my-capability-config`). */
    await gapi.client.cloudresourcemanager.organizations.capabilityConfigs.patch(
      {
        name: 'Test string',
        updateMask: 'Test string',
      },
    ...
    /** Creates a CapabilityConfig under a parent Organization, Folder or Project. Creating a CapabilityConfig triggers the creation of a Management Project if one is not supplied. */
    await gapi.client.cloudresourcemanager.projects.capabilityConfigs.create(
      {
        capabilityConfigId: 'Test string',
        parent: 'Test string',
      },
    ...
    /** Deletes the CapabilityConfig identified by the specified `name` (for example, `folders/123456789/capabilityConfigs/my-capability-config`). */
    await gapi.client.cloudresourcemanager.projects.capabilityConfigs.delete({
      name: 'Test string',
    });
    /** Retrieves the Capability Config identified by the specified `name` (for example, `folders/123456789/capabilityConfigs/my-capability-config`). */
    await gapi.client.cloudresourcemanager.projects.capabilityConfigs.get({
      name: 'Test string',
    });
    /** Lists CapabilityConfigs that are direct children of the specified organization, folder or project resource. */
    await gapi.client.cloudresourcemanager.projects.capabilityConfigs.list({
      pageSize: 42,
      pageToken: 'Test string',
      parent: 'Test string',
    });
    /** Updates the `display_name`, `types` and `boundaries` of the CapabilityConfig identified by the specified `name` (for example, `folders/123456789/capabilityConfigs/my-capability-config`). */
    await gapi.client.cloudresourcemanager.projects.capabilityConfigs.patch(
      {
        name: 'Test string',
        updateMask: 'Test string',
      },
    ...
    await gapi.client.cloudresourcemanager.tagKeys.create(
      ...
      {
        allowedValuesRegex: 'Test string',
        createTime: 'Test string',
        description: 'Test string',
        etag: 'Test string',
        name: 'Test string',
    ...
    await gapi.client.cloudresourcemanager.v3.fetchResourceSemantics({
      fullResourceName: 'Test string',
    });
  }
});
