...
declare namespace gapi.client {
    ...
    namespace displayvideo {
        ...
        interface AssignedTargetingOption {
             ...
             * `assignedTargetingOptionId` when retrieving or deleting existing targeting. This field will only be supported for assigned targeting options of the following targeting types: *
             * `TARGETING_TYPE_AGE_RANGE` * `TARGETING_TYPE_CONTENT_INSTREAM_POSITION` * `TARGETING_TYPE_CONTENT_OUTSTREAM_POSITION` * `TARGETING_TYPE_DEVICE_TYPE` *
