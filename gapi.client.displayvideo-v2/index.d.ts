...
declare namespace gapi.client {
    ...
    namespace displayvideo {
        ...
        interface BulkListAdGroupAssignedTargetingOptionsResponse {
             ...
             * page of results. This token will be absent if there are no more youtube_ad_group_assigned_targeting_options to return.
             */
            nextPageToken?:
                string;
        ...
        interface LineItem {
            ...
            reservationType?:
                string;
            /**
             * The [targeting expansion](//support.google.com/displayvideo/answer/10191558) settings of the line item. This config is only applicable when eligible audience list targeting is
             * assigned to the line item. Beginning **March 25, 2023**, these settings may represent the [optimized targeting feature](//support.google.com/displayvideo/answer/12060859) in place
             * of targeting expansion. This feature will be rolled out to all partners by early May 2023.
             */
            targetingExpansion?:
        ...
        interface TargetingExpansionConfig {
            /**
             * Required. Whether to exclude first-party audiences from use in targeting expansion or optimized targeting. Similar audiences of the excluded first-party lists will not be excluded.
             * Only applicable when a first-party audience is positively targeted (directly or included in a combined audience), otherwise this selection will be ignored. Beginning **March 25,
             * 2023**, this field may be deprecated with the replacement of targeting expansion with [optimized targeting](//support.google.com/displayvideo/answer/12060859). Upon deprecation,
             * this field will be set to `false`. If this field is set to `true` when deprecated, all positive first-party audience targeting assigned to this line item will be replaced with
             * negative targeting of the same first-party audiences to ensure the continued exclusion of those audiences. This field will be deprecated for all partners by early May 2023.
             */
            excludeFirstPartyAudience?:
                boolean;
            /**
             * Required. Magnitude of expansion for applicable targeting under this line item. Beginning **March 25, 2023**, the behavior of this field may change in the following ways with the
             * replacement of targeting expansion with [optimized targeting](//support.google.com/displayvideo/answer/12060859): * This field will represent the optimized targeting checkbox, with
             * a `NO_EXPANSION` value representing optimized targeting turned off and a `LEAST_EXPANSION` value representing optimized targeting turned on. * `NO_EXPANSION` will be the default
             * value for the field and will be automatically assigned if you do not set the field. * If you set the field to any value other than `NO_EXPANSION`, it will automatically be set to
             * `LEAST_EXPANSION`. This behavior will be rolled out to all partners by early May 2023.
             */
        ...
        interface YoutubeAndPartnersBiddingStrategy {
             ...
             * `YOUTUBE_AND_PARTNERS_BIDDING_STRATEGY_TYPE_TARGET_CPA` When the bidding strategy is assigned at the ad group level, this field is only applicable for the following strategy types:
             * * `YOUTUBE_AND_PARTNERS_BIDDING_STRATEGY_TYPE_MANUAL_CPM` * `YOUTUBE_AND_PARTNERS_BIDDING_STRATEGY_TYPE_MANUAL_CPV` * `YOUTUBE_AND_PARTNERS_BIDDING_STRATEGY_TYPE_TARGET_CPA` *
        ...
        interface LineItemsResource {
             ...
             * following requests updating the same line item: * BulkUpdate * UpdateLineItem * CreateLineItemAssignedTargetingOption * DeleteLineItemAssignedTargetingOption
             */
        ...
        interface ManualTriggersResource {
             ...
             * triggers will stop serving in Display & Video 360 on **May 17, 2023**. Read our [feature deprecation announcement](/display-video/api/deprecations#features.manual_triggers) for more
             * information.
             */
            activate(request: {
                /** V1 error format. */
            ...
            /**
             * Creates a new manual trigger. Returns the newly created manual trigger if successful. **Warning:** Line Items using manual triggers will stop serving in Display & Video 360 on **May
             * 17, 2023**. Read our [feature deprecation announcement](/display-video/api/deprecations#features.manual_triggers) for more information.
             */
            create(request: {
                /** V1 error format. */
                "$.xgafv"?:
            ...
            /**
             * Deactivates a manual trigger. **Warning:** Line Items using manual triggers will stop serving in Display & Video 360 on **May 17, 2023**. Read our [feature deprecation
            ...
            /**
             * Gets a manual trigger. **Warning:** Line Items using manual triggers will stop serving in Display & Video 360 on **May 17, 2023**. Read our [feature deprecation
             * announcement](/display-video/api/deprecations#features.manual_triggers) for more information.
             */
            get(request?: {
                /** V1 error format. */
             ...
             * **Warning:** Line Items using manual triggers will stop serving in Display & Video 360 on **May 17, 2023**. Read our [feature deprecation
             * announcement](/display-video/api/deprecations#features.manual_triggers) for more information.
             */
            list(request?: {
                /** V1 error format. */
            ...
            /**
             * Updates a manual trigger. Returns the updated manual trigger if successful. **Warning:** Line Items using manual triggers will stop serving in Display & Video 360 on **May 17,
             * 2023**. Read our [feature deprecation announcement](/display-video/api/deprecations#features.manual_triggers) for more information.
             */
            patch(request: {
                /** V1 error format. */
                "$.xgafv"?:
        ...
        interface YoutubeAdGroupsResource {
            ...
            bulkListAdGroupAssignedTargetingOptions(request?: {
                ...
                oauth_token?:
                    string;
                /**
                 * Field by which to sort the list. Acceptable values are: * `youtubeAdGroupId` (default) * `assignedTargetingOption.targetingType` The default sorting order is ascending. To
