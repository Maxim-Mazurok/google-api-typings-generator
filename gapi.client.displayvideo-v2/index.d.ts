    ...
    namespace displayvideo {
        ...
        interface AssignedLocation {
            ...
            name?:
                string;
            /**
             * Required. The ID of the targeting option assigned to the location list. Assigned locations can only be modified in TARGETING_LOCATION_TYPE_REGIONAL location lists. When creating or
             * deleting assigned locations, this value must be of type TARGETING_TYPE_GEO_REGION.
             */
            targetingOptionId?:
                string;
        }
        ...
        interface BulkListAdGroupAssignedTargetingOptionsResponse {
             ...
             * page of results. This token will be absent if there are no more youtube_ad_group_assigned_targeting_options or ad_group_assigned_targeting_options to return.
             */
            nextPageToken?:
                string;
        ...
        interface YoutubeAdGroupsResource {
            ...
            bulkListAdGroupAssignedTargetingOptions(request?: {
                ...
                oauth_token?:
                    string;
                /**
                 * Optional. Field by which to sort the list. Acceptable values are: * `youtubeAdGroupId` (acceptable in v2) * `adGroupId` (acceptable in v3) *
                 * `assignedTargetingOption.targetingType` The default sorting order is ascending. To specify descending order for a field, a suffix "desc" should be added to the field name.
