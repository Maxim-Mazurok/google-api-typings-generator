...
declare namespace gapi.client {
    ...
    namespace displayvideo {
        ...
        interface YoutubeAndPartnersBiddingStrategy {
             ...
             * `YOUTUBE_AND_PARTNERS_BIDDING_STRATEGY_TYPE_TARGET_CPA` * `YOUTUBE_AND_PARTNERS_BIDDING_STRATEGY_TYPE_TARGET_CPM` If not using an applicable strategy, the value of this field will
             * be 0.
             */
            value?:
                string;
