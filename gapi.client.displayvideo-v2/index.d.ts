...
declare namespace gapi.client {
    ...
    namespace displayvideo {
        ...
        interface Asset {
            ...
            content?: string;
            /**
             * Media ID of the uploaded asset. This is a unique identifier for the asset. This ID can be passed to other API calls, e.g. CreateCreative to associate the asset with a creative. **On
             * April 5, 2023, the value of this ID will be updated. Before this date, we recommend that you stop using any cached media IDs when creating or updating creatives, and instead upload
             * assets immediately before using them for creative production.** **After April 5, you can update cached media IDs to the new values by retrieving them from associated creative
        ...
        interface InStreamAd {
            ...
            customParameters?: { [P in string]: string };
        }
        ...
        interface LineItem {
             ...
             * of targeting expansion. This feature will be rolled out to all partners by mid-April 2023.
             */
        ...
        interface TargetingExpansionConfig {
             ...
             * negative targeting of the same first-party audiences to ensure the continued exclusion of those audiences. This field will be deprecated for all partners by mid-April 2023.
             */
             ...
             * `LEAST_EXPANSION`. This behavior will be rolled out to all partners by mid-April 2023.
             */
        ...
        interface LineItemsResource {
            ...
            bulkEditAssignedTargetingOptions(request: {
                ...
                uploadType?: string;
                /** Request body */
                resource: BulkEditAssignedTargetingOptionsRequest;
            ...
            bulkUpdate(request: {
                ...
                uploadType?: string;
                /** Request body */
                resource: BulkUpdateLineItemsRequest;
        ...
        interface YoutubeAdGroupsResource {
            ...
            bulkListAdGroupAssignedTargetingOptions(request?: {
                ...
                youtubeAdGroupIds?: string | string[];
        ...
        interface AdvertisersResource {
            ...
            targetingTypes: TargetingTypesResource;
            youtubeAdGroupAds: YoutubeAdGroupAdsResource;
            youtubeAdGroups: YoutubeAdGroupsResource;
        }
