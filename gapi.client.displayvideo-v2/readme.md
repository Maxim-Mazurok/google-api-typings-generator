...
*/
await gapi.client.displayvideo.advertisers.editAssignedTargetingOptions({ advertiserId: "advertiserId",  });
...
*/
await gapi.client.displayvideo.advertisers.listAssignedTargetingOptions({ advertiserId: "advertiserId",  });
...
*/
await gapi.client.displayvideo.partners.editAssignedTargetingOptions({ partnerId: "partnerId",  });
