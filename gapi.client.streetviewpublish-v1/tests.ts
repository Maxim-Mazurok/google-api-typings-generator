/* This is stub file for gapi.client.streetviewpublish-v1 definition tests */
// IMPORTANT
...
gapi.load('client', async () => {
    ...
    await gapi.client.load('https://streetviewpublish.googleapis.com/$discovery/rest?version=v1');
    ...
    async function run() {
        ...
        await gapi.client.streetviewpublish.photoSequence.create({
            ...
            failureDetails: {
                ...
                noOverlapGpsDetails: {
                    gpsEndTime: "Test string",
                    gpsStartTime: "Test string",
                    videoEndTime: "Test string",
