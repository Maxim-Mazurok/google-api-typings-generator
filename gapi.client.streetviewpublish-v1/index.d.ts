    ...
    namespace streetviewpublish {
        ...
        interface PhotoSequencesResource {
            ...
            list(request?: {
                 ...
                 * `min_longitude`, `max_longitude`, `filename_query`, `min_capture_time_seconds`, and `max_capture_time_seconds`. See https://google.aip.dev/160 for more information. Filename
                 * queries should sent as a Phrase in order to support multiple words and special characters by adding escaped quotes. Ex: filename_query="example of a phrase.mp4"
                 */
                filter?:
                    string;
                /** API key. Your API key identifies your project and provides you with API access, quota, and reports. Required unless you provide an OAuth 2.0 token. */
