/* Type definitions for non-npm package Street View Publish API v1 0.0 */
...
declare namespace gapi.client {
    ...
    function load(urlOrObject: "https://streetviewpublish.googleapis.com/$discovery/rest?version=v1"): Promise<void>;
    ...
    namespace streetviewpublish {
        ...
        interface NoOverlapGpsFailureDetails {
        ...
        interface UpdatePhotoRequest {
             ...
             * update fails if invalid fields are specified. Multiple fields can be specified in a comma-delimited list. The following fields are valid: * `pose.heading` * `pose.lat_lng_pair` *
        ...
        interface PhotoResource {
            ...
            update(request: {
                 ...
                 * `pose.lat_lng_pair` * `pose.pitch` * `pose.roll` * `pose.level` * `pose.altitude` * `connections` * `places` > Note: When updateMask contains repeated fields, the entire set of
        ...
        interface PhotosResource {
            ...
            list(request?: {
                ...
                fields?:
                    string;
                /**
                 * Optional. The filter expression. For example: `placeId=ChIJj61dQgK6j4AR4GeTYWZsKWw`. The filters supported are: `placeId`, `min_latitude`, `max_latitude`, `min_longitude`,
                 * `max_longitude`, 'min_capture_time_seconds', and 'max_capture_time_seconds'. See https://google.aip.dev/160 for more information.
                 */
                filter?:
                    string;
                /** API key. Your API key identifies your project and provides you with API access, quota, and reports. Required unless you provide an OAuth 2.0 token. */
        ...
        interface PhotoSequencesResource {
            ...
            list(request?: {
                 ...
                 * `min_longitude`, `max_longitude`, and `filename_query`. See https://google.aip.dev/160 for more information. Filename queries should sent as a Phrase in order to support
                 * multiple words and special characters by adding escaped quotes. Ex: filename_query="example of a phrase.mp4"
                 */
                filter?:
                    string;
                /** API key. Your API key identifies your project and provides you with API access, quota, and reports. Required unless you provide an OAuth 2.0 token. */
