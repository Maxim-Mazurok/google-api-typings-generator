...
declare namespace gapi.client {
    ...
    namespace places {
        ...
        interface GoogleMapsPlacesV1Photo {
            ...
            heightPx?:
                number;
            /** Output only. A reference representing this place photo which may be used to look up this place photo again (a.k.a. the API "resource" name: places/{place_id}/photos/{photo}). */
            name?:
                string;
        ...
        interface GoogleMapsPlacesV1Review {
            ...
            authorAttribution?:
                GoogleMapsPlacesV1AuthorAttribution;
            /** Output only. A reference representing this place review which may be used to look up this place review again (a.k.a. the API "resource" name: places/{place_id}/reviews/{review}). */
            name?:
                string;
        ...
        interface PhotosResource {
            ...
            getMedia(request?: {
                ...
                maxWidthPx?:
                    number;
                /** Required. The resource name of a photo as returned in a Place object's photos.name field. Format: places/place_id/photos/photo_reference. */
                name:
                    string;
                 ...
                 * issued to redirect the call to the image midea. This option is ignored for non-HTTP requests.
                 */
                skipHttpRedirect?:
                    boolean;
