...
// Generated from: https://googleads.googleapis.com/$discovery/rest?version=v10
// Revision: 20231018

/// <reference types="gapi.client" />

declare namespace gapi.client {
  /** Load Google Ads API v10 */
  function load(
    urlOrObject: 'https://googleads.googleapis.com/$discovery/rest?version=v10'
  ): Promise<void>;
  /** @deprecated Please load APIs with discovery documents. */
  function load(name: 'googleads', version: 'v10'): Promise<void>;
  /** @deprecated Please load APIs with discovery documents. */
  function load(name: 'googleads', version: 'v10', callback: () => any): void;
  ...
  namespace googleads {
    ...
    interface GoogleAdsGoogleadsV13Errors__ErrorCode {
      ...
      customerSkAdNetworkConversionValueSchemaError?: string;
      /** The reasons for the customer user access mutate error */
      customerUserAccessError?: string;
      /** The reasons for the custom interest error */
      customInterestError?: string;
    ...
    interface GoogleAdsGoogleadsV14Common__PolicyTopicConstraint {
      /** Countries where the resource's domain is not covered by the certificates associated with it. */
      certificateDomainMismatchInCountryList?: GoogleAdsGoogleadsV14Common_PolicyTopicConstraint_CountryConstraintList;
      /** Countries where a certificate is required for serving. */
      certificateMissingInCountryList?: GoogleAdsGoogleadsV14Common_PolicyTopicConstraint_CountryConstraintList;
      /** Countries where the resource cannot serve. */
      countryConstraintList?: GoogleAdsGoogleadsV14Common_PolicyTopicConstraint_CountryConstraintList;
      /** Reseller constraint. */
      resellerConstraint?: any;
    }
    interface GoogleAdsGoogleadsV14Common__PolicyTopicEntry {
      /** Indicates how serving of this resource may be affected (for example, not serving in a country). */
      constraints?: GoogleAdsGoogleadsV14Common__PolicyTopicConstraint[];
      /** Additional information that explains policy finding (for example, the brand name for a trademark finding). */
      evidences?: GoogleAdsGoogleadsV14Common__PolicyTopicEvidence[];
      /** Policy topic this finding refers to. For example, "ALCOHOL", "TRADEMARKS_IN_AD_TEXT", or "DESTINATION_NOT_WORKING". The set of possible policy topics is not fixed for a particular API version and may change at any time. */
      topic?: string;
      /** Describes the negative or positive effect this policy will have on serving. */
      type?: string;
    ...
    interface GoogleAdsGoogleadsV14Common__PolicyTopicEvidence {
      /** Mismatch between the destinations of a resource's URLs. */
      destinationMismatch?: GoogleAdsGoogleadsV14Common_PolicyTopicEvidence_DestinationMismatch;
      /** Details when the destination is returning an HTTP error code or isn't functional in all locations for commonly used devices. */
      destinationNotWorking?: GoogleAdsGoogleadsV14Common_PolicyTopicEvidence_DestinationNotWorking;
      /** The text in the destination of the resource that is causing a policy finding. */
      destinationTextList?: GoogleAdsGoogleadsV14Common_PolicyTopicEvidence_DestinationTextList;
      /** The language the resource was detected to be written in. This is an IETF language tag such as "en-US". */
      languageCode?: string;
      /** List of evidence found in the text of a resource. */
      textList?: GoogleAdsGoogleadsV14Common_PolicyTopicEvidence_TextList;
      /** List of websites linked with this resource. */
      websiteList?: GoogleAdsGoogleadsV14Common_PolicyTopicEvidence_WebsiteList;
    }
    ...
    interface GoogleAdsGoogleadsV14Common_PolicyTopicConstraint_CountryConstraintList {
      /** Countries in which serving is restricted. */
      countries?: GoogleAdsGoogleadsV14Common_PolicyTopicConstraint_CountryConstraint[];
      /** Total number of countries targeted by the resource. */
      totalTargetedCountries?: number;
    }
    ...
    interface GoogleAdsGoogleadsV14Errors__ErrorDetails {
      /** Describes policy violation findings. */
      policyFindingDetails?: GoogleAdsGoogleadsV14Errors__PolicyFindingDetails;
      /** Describes an ad policy violation. */
      policyViolationDetails?: GoogleAdsGoogleadsV14Errors__PolicyViolationDetails;
      /** Details on the quota error, including the scope (account or developer), the rate bucket name and the retry delay. */
      quotaErrorDetails?: GoogleAdsGoogleadsV14Errors__QuotaErrorDetails;
      /** Details for a resource count limit exceeded error. */
      resourceCountDetails?: GoogleAdsGoogleadsV14Errors__ResourceCountDetails;
      /** The error code that should have been returned, but wasn't. This is used when the error code is not published in the client specified version. */
      unpublishedErrorCode?: string;
    }
    interface GoogleAdsGoogleadsV14Errors__ErrorLocation {
      /** A field path that indicates which field was invalid in the request. */
      fieldPathElements?: GoogleAdsGoogleadsV14Errors_ErrorLocation_FieldPathElement[];
    }
    interface GoogleAdsGoogleadsV14Errors__GoogleAdsError {
      /** Additional error details, which are returned by certain error codes. Most error codes do not include details. */
      details?: GoogleAdsGoogleadsV14Errors__ErrorDetails;
      /** An enum value that indicates which error occurred. */
      errorCode?: GoogleAdsGoogleadsV14Errors__ErrorCode;
      /** Describes the part of the request proto that caused the error. */
      location?: GoogleAdsGoogleadsV14Errors__ErrorLocation;
      /** A human-readable description of the error. */
      message?: string;
      /** The value that triggered the error. */
      trigger?: GoogleAdsGoogleadsV14Common__Value;
    }
    interface GoogleAdsGoogleadsV14Errors__GoogleAdsFailure {
      /** The list of errors that occurred. */
      errors?: GoogleAdsGoogleadsV14Errors__GoogleAdsError[];
      /** The unique ID of the request that is used for debugging purposes. */
      requestId?: string;
    }
    interface GoogleAdsGoogleadsV14Errors__PolicyFindingDetails {
      /** The list of policy topics for the resource. Contains the PROHIBITED or FULLY_LIMITED policy topic entries that prevented the resource from being saved (among any other entries the resource may also have). */
      policyTopicEntries?: GoogleAdsGoogleadsV14Common__PolicyTopicEntry[];
    }
    interface GoogleAdsGoogleadsV14Errors__PolicyViolationDetails {
      ...
      isExemptible?: boolean;
      /** Unique identifier for this violation. If policy is exemptible, this key may be used to request exemption. */
      key?: GoogleAdsGoogleadsV14Common__PolicyViolationKey;
    }
    ...
    interface GoogleAdsGoogleadsV15Common__PolicyTopicConstraint {
      /** Countries where the resource's domain is not covered by the certificates associated with it. */
      certificateDomainMismatchInCountryList?: GoogleAdsGoogleadsV15Common_PolicyTopicConstraint_CountryConstraintList;
      /** Countries where a certificate is required for serving. */
      certificateMissingInCountryList?: GoogleAdsGoogleadsV15Common_PolicyTopicConstraint_CountryConstraintList;
      /** Countries where the resource cannot serve. */
      countryConstraintList?: GoogleAdsGoogleadsV15Common_PolicyTopicConstraint_CountryConstraintList;
      /** Reseller constraint. */
      resellerConstraint?: any;
    }
    interface GoogleAdsGoogleadsV15Common__PolicyTopicEntry {
      /** Indicates how serving of this resource may be affected (for example, not serving in a country). */
      constraints?: GoogleAdsGoogleadsV15Common__PolicyTopicConstraint[];
      /** Additional information that explains policy finding (for example, the brand name for a trademark finding). */
      evidences?: GoogleAdsGoogleadsV15Common__PolicyTopicEvidence[];
      /** Policy topic this finding refers to. For example, "ALCOHOL", "TRADEMARKS_IN_AD_TEXT", or "DESTINATION_NOT_WORKING". The set of possible policy topics is not fixed for a particular API version and may change at any time. */
      topic?: string;
      /** Describes the negative or positive effect this policy will have on serving. */
      type?: string;
    ...
    interface GoogleAdsGoogleadsV15Common__PolicyTopicEvidence {
      /** Mismatch between the destinations of a resource's URLs. */
      destinationMismatch?: GoogleAdsGoogleadsV15Common_PolicyTopicEvidence_DestinationMismatch;
      /** Details when the destination is returning an HTTP error code or isn't functional in all locations for commonly used devices. */
      destinationNotWorking?: GoogleAdsGoogleadsV15Common_PolicyTopicEvidence_DestinationNotWorking;
      /** The text in the destination of the resource that is causing a policy finding. */
      destinationTextList?: GoogleAdsGoogleadsV15Common_PolicyTopicEvidence_DestinationTextList;
      /** The language the resource was detected to be written in. This is an IETF language tag such as "en-US". */
      languageCode?: string;
      /** List of evidence found in the text of a resource. */
      textList?: GoogleAdsGoogleadsV15Common_PolicyTopicEvidence_TextList;
      /** List of websites linked with this resource. */
      websiteList?: GoogleAdsGoogleadsV15Common_PolicyTopicEvidence_WebsiteList;
    }
    ...
    interface GoogleAdsGoogleadsV15Common_PolicyTopicConstraint_CountryConstraintList {
      /** Countries in which serving is restricted. */
      countries?: GoogleAdsGoogleadsV15Common_PolicyTopicConstraint_CountryConstraint[];
      /** Total number of countries targeted by the resource. */
      totalTargetedCountries?: number;
    }
    ...
    interface GoogleAdsGoogleadsV15Errors__ErrorCode {
      ...
      campaignLifecycleGoalError?: string;
      /** The reasons for the campaign shared set error */
      campaignSharedSetError?: string;
      /** The reasons for the change event error */
      changeEventError?: string;
      ...
      customerLifecycleGoalError?: string;
      /** The reasons for the customer manager link error */
      customerManagerLinkError?: string;
      /** The reasons for the customer SK Ad network conversion value schema error */
      customerSkAdNetworkConversionValueSchemaError?: string;
      ...
      productLinkInvitationError?: string;
      /** An error with an AWQL query */
      queryError?: string;
      /** An error with the amount of quota remaining. */
      quotaError?: string;
      ...
      recommendationSubscriptionError?: string;
      /** The reasons for the region code error */
      regionCodeError?: string;
      /** An error caused by the request */
      requestError?: string;
    ...
    interface GoogleAdsGoogleadsV15Errors__ErrorDetails {
      /** Describes policy violation findings. */
      policyFindingDetails?: GoogleAdsGoogleadsV15Errors__PolicyFindingDetails;
      /** Describes an ad policy violation. */
      policyViolationDetails?: GoogleAdsGoogleadsV15Errors__PolicyViolationDetails;
      /** Details on the quota error, including the scope (account or developer), the rate bucket name and the retry delay. */
      quotaErrorDetails?: GoogleAdsGoogleadsV15Errors__QuotaErrorDetails;
      /** Details for a resource count limit exceeded error. */
      resourceCountDetails?: GoogleAdsGoogleadsV15Errors__ResourceCountDetails;
      /** The error code that should have been returned, but wasn't. This is used when the error code is not published in the client specified version. */
      unpublishedErrorCode?: string;
    }
    interface GoogleAdsGoogleadsV15Errors__ErrorLocation {
      /** A field path that indicates which field was invalid in the request. */
      fieldPathElements?: GoogleAdsGoogleadsV15Errors_ErrorLocation_FieldPathElement[];
    }
    interface GoogleAdsGoogleadsV15Errors__GoogleAdsError {
      /** Additional error details, which are returned by certain error codes. Most error codes do not include details. */
      details?: GoogleAdsGoogleadsV15Errors__ErrorDetails;
      /** An enum value that indicates which error occurred. */
      errorCode?: GoogleAdsGoogleadsV15Errors__ErrorCode;
      /** Describes the part of the request proto that caused the error. */
      location?: GoogleAdsGoogleadsV15Errors__ErrorLocation;
      /** A human-readable description of the error. */
      message?: string;
      /** The value that triggered the error. */
      trigger?: GoogleAdsGoogleadsV15Common__Value;
    }
    interface GoogleAdsGoogleadsV15Errors__GoogleAdsFailure {
      /** The list of errors that occurred. */
      errors?: GoogleAdsGoogleadsV15Errors__GoogleAdsError[];
      /** The unique ID of the request that is used for debugging purposes. */
      requestId?: string;
    }
    interface GoogleAdsGoogleadsV15Errors__PolicyFindingDetails {
      /** The list of policy topics for the resource. Contains the PROHIBITED or FULLY_LIMITED policy topic entries that prevented the resource from being saved (among any other entries the resource may also have). */
      policyTopicEntries?: GoogleAdsGoogleadsV15Common__PolicyTopicEntry[];
    }
    interface GoogleAdsGoogleadsV15Errors__PolicyViolationDetails {
      ...
      isExemptible?: boolean;
      /** Unique identifier for this violation. If policy is exemptible, this key may be used to request exemption. */
      key?: GoogleAdsGoogleadsV15Common__PolicyViolationKey;
    }
