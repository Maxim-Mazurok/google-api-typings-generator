...
gapi.load('client', async () => {
  ...
  async function run() {
    ...
    /** Gets IAM policies on a WorkforcePool. */
    await gapi.client.iam.locations.workforcePools.providers.scimTenants.getIamPolicy(
      {
        resource: 'Test string',
      },
      {
    ...
    /** Sets IAM policies on a WorkforcePool. */
    await gapi.client.iam.locations.workforcePools.providers.scimTenants.setIamPolicy(
      {
        resource: 'Test string',
      },
      {
    ...
    /** Returns the caller's permissions on the WorkforcePool. If the pool doesn't exist, this call returns an empty set of permissions. It doesn't return a `NOT_FOUND` error. */
    await gapi.client.iam.locations.workforcePools.providers.scimTenants.testIamPermissions(
      {
        resource: 'Test string',
      },
      {
    ...
    await gapi.client.iam.projects.locations.workloadIdentityPools.addAttestationRule(
      {
        resource: 'Test string',
      },
      {
    ...
    await gapi.client.iam.projects.locations.workloadIdentityPools.listAttestationRules(
      {
        filter: 'Test string',
        pageSize: 42,
        pageToken: 'Test string',
    ...
    await gapi.client.iam.projects.locations.workloadIdentityPools.removeAttestationRule(
      {
        resource: 'Test string',
      },
      {
    ...
    await gapi.client.iam.projects.locations.workloadIdentityPools.setAttestationRules(
      {
        resource: 'Test string',
      },
      {
