...
gapi.load('client', async () => {
  ...
  async function run() {
    ...
    await gapi.client.iam.projects.serviceAccounts.keys.patch(
      {
        name: 'Test string',
      },
      {
        serviceAccountKey: {
          ...
          keyAlgorithm: 'Test string',
          keyOrigin: 'Test string',
          keyType: 'Test string',
          name: 'Test string',
          privateKeyData: 'Test string',
          privateKeyType: 'Test string',
          publicKeyData: 'Test string',
          validAfterTime: 'Test string',
          validBeforeTime: 'Test string',
        },
        updateMask: 'Test string',
      }
    );
