...
// Generated from: https://eventarc.googleapis.com/$discovery/rest?version=v1beta1
// Revision: 20230519
...
declare namespace gapi.client {
    ...
    function load(urlOrObject: "https://eventarc.googleapis.com/$discovery/rest?version=v1beta1"): Promise<void>;
    /** @deprecated Please load APIs with discovery documents. */
    function load(name: "eventarc", version: "v1beta1"): Promise<void>;
    /** @deprecated Please load APIs with discovery documents. */
    function load(name: "eventarc", version: "v1beta1", callback: () => any): void;
    ...
    namespace eventarc {
        ...
        interface Pubsub {
            ...
            subscription?:
                string;
            /**
             * Optional. The name of the Pub/Sub topic created and managed by Eventarc system as a transport for the event delivery. Format: `projects/{PROJECT_ID}/topics/{TOPIC_NAME}`. You may
             * set an existing topic for triggers of the type `google.cloud.pubsub.topic.v1.messagePublished` only. The topic you provide here will not be deleted by Eventarc at trigger deletion.
             */
            topic?:
                string;
        }
        ...
        interface Trigger {
            ...
            serviceAccount?:
                string;
            /**
             * Output only. In order to deliver messages, Eventarc may use other Google Cloud products as transport intermediary. This field contains a reference to that transport intermediary.
        ...
        interface TriggersResource {
            ...
            body: Trigger): Request<Operation>;
