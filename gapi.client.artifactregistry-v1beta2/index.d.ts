/* Type definitions for non-npm package Artifact Registry API v1beta2 0.0 */
...
// Generated from: https://artifactregistry.googleapis.com/$discovery/rest?version=v1beta2
// Revision: 20230726
...
declare namespace gapi.client {
    ...
    function load(urlOrObject: "https://artifactregistry.googleapis.com/$discovery/rest?version=v1beta2"): Promise<void>;
    /** @deprecated Please load APIs with discovery documents. */
    function load(name: "artifactregistry", version: "v1beta2"): Promise<void>;
    /** @deprecated Please load APIs with discovery documents. */
    function load(name: "artifactregistry", version: "v1beta2", callback: () => any): void;
    ...
    namespace artifactregistry {
        ...
        interface GoogleDevtoolsArtifactregistryV1beta2File {
        ...
        interface Version {
            ...
            description?:
                string;
            /**
             * Output only. Repository-specific Metadata stored against this version. The fields returned are defined by the underlying repository-specific resource. Currently, the resources could
             * be: DockerImage MavenArtifact
             */
            metadata?:
                { [P in string]: any };
            /**
        ...
        interface FilesResource {
            ...
            get(request?: {
                ...
                uploadType?:
                    string;
            }): Request<GoogleDevtoolsArtifactregistryV1beta2File>;
            /** Lists files. */
            list(request?: {
                /** V1 error format. */
                "$.xgafv"?:
        ...
        interface RepositoriesResource {
            ...
            aptArtifacts:
                AptArtifactsResource;
            files:
                FilesResource;
            packages:
                PackagesResource;
            yumArtifacts:
                YumArtifactsResource;
        }
