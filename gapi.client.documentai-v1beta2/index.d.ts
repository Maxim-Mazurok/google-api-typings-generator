...
declare namespace gapi.client {
    ...
    function load(urlOrObject: "https://documentai.googleapis.com/$discovery/rest?version=v1beta2"): Promise<void>;
    /** @deprecated Please load APIs with discovery documents. */
    function load(name: "documentai", version: "v1beta2"): Promise<void>;
    /** @deprecated Please load APIs with discovery documents. */
