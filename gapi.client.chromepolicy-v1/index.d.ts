...
declare namespace gapi.client {
    ...
    namespace chromepolicy {
        ...
        interface GoogleChromePolicyV1DefineCertificateRequest {
            ...
            settings?: GoogleChromePolicyV1NetworkSetting[];
        ...
        interface GoogleChromePolicyV1DefineCertificateResponse {
        ...
        interface GoogleChromePolicyV1DefineNetworkRequest {
        ...
        interface GoogleChromePolicyV1DefineNetworkResponse {
        ...
        interface GoogleChromePolicyV1RemoveCertificateResponse {
        }
        interface GoogleChromePolicyV1RemoveNetworkRequest {
        ...
        // tslint:disable-next-line:no-empty-interface
        interface GoogleChromePolicyV1RemoveNetworkResponse {
        }
        ...
        interface GoogleChromePolicyVersionsV1ResolveRequest {
             ...
             * schema namespaces. For example: Valid: "chrome.users.*", "chrome.users.apps.*", "chrome.printers.*" Invalid: "*", "*.users", "chrome.*", "chrome.*.apps.*"
             */
        ...
        interface NetworksResource {
            ...
            defineCertificate(request: {
                ...
                uploadType?: string;
                /** Request body */
                resource: GoogleChromePolicyV1DefineCertificateRequest;
            }): Request<GoogleChromePolicyV1DefineCertificateResponse>;
            defineCertificate(request: {
                /** V1 error format. */
                "$.xgafv"?: string;
                /** OAuth access token. */
            ...
            body: GoogleChromePolicyV1DefineCertificateRequest): Request<GoogleChromePolicyV1DefineCertificateResponse>;
            ...
            defineNetwork(request: {
                ...
                uploadType?: string;
                /** Request body */
                resource: GoogleChromePolicyV1DefineNetworkRequest;
            }): Request<GoogleChromePolicyV1DefineNetworkResponse>;
            defineNetwork(request: {
                /** V1 error format. */
                "$.xgafv"?: string;
                /** OAuth access token. */
            ...
            body: GoogleChromePolicyV1DefineNetworkRequest): Request<GoogleChromePolicyV1DefineNetworkResponse>;
            ...
            removeCertificate(request: {
                ...
                uploadType?: string;
                /** Request body */
                resource: GoogleChromePolicyV1RemoveCertificateRequest;
            }): Request<{}>;
            removeCertificate(request: {
                /** V1 error format. */
                "$.xgafv"?: string;
            ...
            body: GoogleChromePolicyV1RemoveCertificateRequest): Request<{}>;
            ...
            removeNetwork(request: {
                ...
                uploadType?: string;
                /** Request body */
                resource: GoogleChromePolicyV1RemoveNetworkRequest;
            }): Request<{}>;
            removeNetwork(request: {
                /** V1 error format. */
                "$.xgafv"?: string;
            ...
            body: GoogleChromePolicyV1RemoveNetworkRequest): Request<{}>;
        }
