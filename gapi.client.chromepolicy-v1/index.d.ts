...
declare namespace gapi.client {
    ...
    namespace chromepolicy {
        ...
        interface GoogleChromePolicyVersionsV1BatchDeleteGroupPoliciesRequest {
            /**
        ...
        interface GoogleChromePolicyVersionsV1BatchInheritOrgUnitPoliciesRequest {
            /**
        ...
        interface GoogleChromePolicyVersionsV1BatchModifyOrgUnitPoliciesRequest {
            /**
             * List of policies to modify as defined by the `requests`. All requests in the list must follow these restrictions: 1. All schemas in the list must have the same root namespace. 2.
        ...
        interface GoogleChromePolicyVersionsV1FieldConstraints {
        ...
        interface GoogleChromePolicyVersionsV1ModifyGroupPolicyRequest {
            /** Required. The key of the target for which we want to modify a policy. The target resource must point to a Group. */
            policyTargetKey?:
                GoogleChromePolicyVersionsV1PolicyTargetKey;
        ...
        interface GoogleChromePolicyVersionsV1PolicyApiLifecycle {
            /**
             * In the event that this policy was deprecated in favor of another policy, the fully qualified namespace(s) of the new policies as they will show in PolicyAPI. Could only be set if
            ...
            description?:
                string;
            /**
             * End supporting date for current policy. Attempting to modify a policy after its end support date will result in a Bad Request (400 error). Could only be set if
             * policy_api_lifecycle_stage is API_DEPRECATED.
             */
            endSupport?:
                GoogleTypeDate;
            ...
            policyApiLifecycleStage?:
                string;
            /**
             * Corresponding to deprecated_in_favor_of, the fully qualified namespace(s) of the old policies that will be deprecated because of introduction of this policy. This field should not
             * be manually set but will be set and exposed through PolicyAPI automatically.
             */
        ...
        interface GoogleChromePolicyVersionsV1PolicyModificationErrorDetails {
        ...
        interface GoogleChromePolicyVersionsV1PolicySchemaFieldDescription {
            ...
            name?:
                string;
            /**
             * Output only. Provides the description of the fields nested in this field, if the field is a message type that defines multiple fields. Fields are suggested to be displayed by the
        ...
        interface GoogleChromePolicyVersionsV1RemoveCertificateRequest {
        ...
        interface GoogleChromePolicyVersionsV1RemoveCertificateResponse {
        }
        ...
        // tslint:disable-next-line:no-empty-interface
        interface GoogleChromePolicyVersionsV1RemoveNetworkResponse {
        }
        ...
        interface GoogleChromePolicyVersionsV1ResolveRequest {
            ...
            pageToken?:
                string;
            /**
             * Required. The schema filter to apply to the resolve request. Specify a schema name to view a particular schema, for example: chrome.users.ShowLogoutButton Wildcards are supported,
             * but only in the leaf portion of the schema name. Wildcards cannot be used in namespace directly. Please read https://developers.google.com/chrome/policy/guides/policy-schemas for
             * details on schema namespaces. For example: Valid: "chrome.users.*", "chrome.users.apps.*", "chrome.printers.*" Invalid: "*", "*.users", "chrome.*", "chrome.*.apps.*"
             */
            policySchemaFilter?:
                string;
        ...
        interface GoogleChromePolicyVersionsV1UpdateGroupPriorityOrderingRequest {
        ...
        interface Proto2FieldDescriptorProto {
            ...
            oneofIndex?:
                number;
            /**
             * If true, this is a proto3 "optional". When a proto3 field is optional, it tracks presence regardless of field type. When proto3_optional is true, this field must belong to a oneof
             * to signal to old proto3 clients that presence is tracked for this field. This oneof is known as a "synthetic" oneof, and this field must be its sole member (each proto3 optional
             * field gets its own synthetic oneof). Synthetic oneofs exist in the descriptor only, and do not generate any API. Synthetic oneofs must be ordered after all "real" oneofs. For
             * message fields, proto3_optional doesn't create any semantic change, since non-repeated message fields always track presence. However it still indicates the semantic detail of
        ...
        interface GroupsResource {
            ...
            body: GoogleChromePolicyVersionsV1BatchDeleteGroupPoliciesRequest): Request<{}>;
            /**
            ...
            body: GoogleChromePolicyVersionsV1BatchModifyGroupPoliciesRequest): Request<{}>;
            /**
            ...
            body: GoogleChromePolicyVersionsV1ListGroupPriorityOrderingRequest): Request<GoogleChromePolicyVersionsV1ListGroupPriorityOrderingResponse>;
            /**
            ...
            body: GoogleChromePolicyVersionsV1UpdateGroupPriorityOrderingRequest): Request<{}>;
        }
        interface NetworksResource {
            ...
            body: GoogleChromePolicyVersionsV1DefineCertificateRequest): Request<GoogleChromePolicyVersionsV1DefineCertificateResponse>;
            ...
            body: GoogleChromePolicyVersionsV1DefineNetworkRequest): Request<GoogleChromePolicyVersionsV1DefineNetworkResponse>;
            ...
            body: GoogleChromePolicyVersionsV1RemoveCertificateRequest): Request<{}>;
            ...
            body: GoogleChromePolicyVersionsV1RemoveNetworkRequest): Request<{}>;
        }
        interface OrgunitsResource {
            ...
            body: GoogleChromePolicyVersionsV1BatchInheritOrgUnitPoliciesRequest): Request<{}>;
            /**
            ...
            body: GoogleChromePolicyVersionsV1BatchModifyOrgUnitPoliciesRequest): Request<{}>;
        }
        interface PoliciesResource {
            ...
            body: GoogleChromePolicyVersionsV1ResolveRequest): Request<GoogleChromePolicyVersionsV1ResolveResponse>;
            groups:
                GroupsResource;
            networks:
                NetworksResource;
        ...
        interface PolicySchemasResource {
            ...
            get(request?: {
                ...
                uploadType?:
                    string;
            }): Request<GoogleChromePolicyVersionsV1PolicySchema>;
            ...
            list(request?: {
                ...
                uploadType?:
                    string;
            }): Request<GoogleChromePolicyVersionsV1ListPolicySchemasResponse>;
        }
        ...
        interface MediaResource {
            ...
            body: GoogleChromePolicyVersionsV1UploadPolicyFileRequest): Request<GoogleChromePolicyVersionsV1UploadPolicyFileResponse>;
        }
