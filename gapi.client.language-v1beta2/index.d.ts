...
declare namespace gapi.client {
    ...
    function load(urlOrObject: "https://language.googleapis.com/$discovery/rest?version=v1beta2"): Promise<void>;
    ...
    namespace language {
        ...
        interface Document {
            /**
             * Indicates how detected boilerplate(e.g. advertisements, copyright declarations, banners) should be handled for this document. If not specified, boilerplate will be treated the same
             * as content.
             */
        ...
        interface Features {
            /**
             * Classify the full document into categories. If this is true, the API will use the default model which classifies into a [predefined
