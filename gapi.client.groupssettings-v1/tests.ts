/* This is stub file for gapi.client.groupssettings-v1 definition tests */
// IMPORTANT
...
gapi.load('client', async () => {
    ...
    await gapi.client.load('https://groupssettings.googleapis.com/$discovery/rest?version=v1');
