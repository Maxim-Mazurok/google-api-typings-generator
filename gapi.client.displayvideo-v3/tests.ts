  ...
  async function run() {
    ...
    await gapi.client.displayvideo.advertisers.create(
      {},
      {
        ...
        containsEuPoliticalAds: 'Test string',
        creativeConfig: {
        ...
        defaultBusinessName: 'Test string',
        defaultLogoAssetId: 'Test string',
            ...
            assignedTargetingOptions: [
              {
                ...
                keywordDetails: {
                  exemptedPolicyNames: ['Test string'],
                  keyword: 'Test string',
                  negative: true,
                },
                languageDetails: {
    ...
    await gapi.client.displayvideo.advertisers.adGroupAds.create(
      ...
      },
      {
        ...
        adPolicy: {
          adPolicyApprovalStatus: 'Test string',
          adPolicyReviewStatus: 'Test string',
          adPolicyTopicEntry: [
            {
              appealInfo: {
                appealFormLink: 'Test string',
                appealType: 'Test string',
              },
              helpCenterLink: 'Test string',
              policyDecisionType: 'Test string',
              policyEnforcementMeans: 'Test string',
              policyLabel: 'Test string',
              ...
              policyTopicConstraints: [
                {
                  certificateDomainMismatchCountryList: {
                    countries: [
                      {
                        countryCriterionId: 'Test string',
                        countryLabel: 'Test string',
                      },
                    ],
                  },
                  ...
                  requestCertificateFormLink: 'Test string',
                  resellerConstraint: {},
                },
              ],
              policyTopicDescription: 'Test string',
              policyTopicEvidences: [
                {
                  ...
                  destinationMismatch: {
                    uriTypes: ['Test string'],
                  },
                  destinationNotWorking: {
                    device: 'Test string',
                    dnsErrorType: 'Test string',
                    expandedUri: 'Test string',
                    httpErrorCode: 'Test string',
                    lastCheckedTime: 'Test string',
                  },
                  destinationTextList: {
                    destinationTexts: ['Test string'],
                  },
                  httpCode: 42,
                  languageCode: 'Test string',
                  legalRemoval: {
                    complaintType: 'Test string',
                    countryRestrictions: [
                      {
                        countryCriterionId: 'Test string',
                        countryLabel: 'Test string',
                    ...
                    dmca: {
                      complainant: 'Test string',
                    },
                    localLegal: {
                      lawType: 'Test string',
                    },
                    restrictedUris: ['Test string'],
                  },
                  ...
                  websiteList: {
                    websites: ['Test string'],
                  },
                },
              ],
              policyTopicType: 'Test string',
            },
          ],
        },
        adUrls: [
        ...
        advertiserId: 'Test string',
        audioAd: {
          displayUrl: 'Test string',
          finalUrl: 'Test string',
          trackingUrl: 'Test string',
          video: {
            id: 'Test string',
            unavailableReason: 'Test string',
            videoAssetId: 'Test string',
          },
        },
        bumperAd: {
          commonInStreamAttribute: {
            actionButtonLabel: 'Test string',
            actionHeadline: 'Test string',
            companionBanner: {
              assetId: 'Test string',
        ...
        demandGenCarouselAd: {
          ...
          trackingUrl: 'Test string',
          userSpecifiedTrackingUrl: 'Test string',
        },
        demandGenImageAd: {
          businessName: 'Test string',
          callToAction: 'Test string',
          ...
          descriptions: ['Test string'],
          finalMobileUrl: 'Test string',
          finalUrl: 'Test string',
          finalUrlSuffix: 'Test string',
          headlines: ['Test string'],
          logoImages: [
            {
              assetId: 'Test string',
              fileSize: 'Test string',
        ...
        demandGenProductAd: {
          ...
          description: 'Test string',
          displayUrlBreadcrumb1: 'Test string',
          displayUrlBreadcrumb2: 'Test string',
          finalUrl: 'Test string',
          finalUrlSuffix: 'Test string',
          headline: 'Test string',
          logo: {
        ...
        mastheadAd: {
          autoplayVideoDuration: 'Test string',
          autoplayVideoStartMillisecond: 'Test string',
          callToActionButtonLabel: 'Test string',
          callToActionFinalUrl: 'Test string',
          callToActionTrackingUrl: 'Test string',
        ...
        videoDiscoverAd: {
          description1: 'Test string',
          description2: 'Test string',
          headline: 'Test string',
          thumbnail: 'Test string',
          video: {
            id: 'Test string',
            unavailableReason: 'Test string',
            videoAssetId: 'Test string',
        ...
        videoPerformanceAd: {
          actionButtonLabels: ['Test string'],
          companionBanners: [
            {
              assetId: 'Test string',
              fileSize: 'Test string',
    ...
    await gapi.client.displayvideo.advertisers.adGroups.create(
      ...
      {
        adGroupFormat: 'Test string',
        adGroupId: 'Test string',
        adGroupInventoryControl: {
          adGroupInventoryStrategy: 'Test string',
          selectedInventories: {
            allowDiscover: true,
            allowGmail: true,
            allowGoogleDisplayNetwork: true,
            allowYoutubeFeed: true,
        ...
        bidStrategy: {
          demandGenBid: {
            effectiveBiddingValue: 'Test string',
            effectiveBiddingValueSource: 'Test string',
            type: 'Test string',
            value: 'Test string',
          },
          fixedBid: {
    ...
    await gapi.client.displayvideo.advertisers.creatives.create(
      ...
      },
      {
        ...
        skippable: true,
        syntheticContentAttestationStatus: 'Test string',
      ...
      },
      {
        ...
        targetLineItem: {
          ...
          conversionCounting: {
            ...
            primaryAttributionModelId: 'Test string',
          },
          creativeIds: ['Test string'],
          demandGenSettings: {
            geoLanguageTargetingEnabled: true,
          ...
          youtubeAndPartnersSettings: {
            ...
            videoAdInventoryControl: {
              allowInFeed: true,
              allowInStream: true,
              allowNonSkippableInStream: true,
              allowShorts: true,
            },
