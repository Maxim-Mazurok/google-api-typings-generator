/* Type definitions for non-npm package Display & Video 360 API v3 0.0 */
...
declare namespace gapi.client {
    /** Load Display & Video 360 API v3 */
    function load(urlOrObject: "https://displayvideo.googleapis.com/$discovery/rest?version=v3"): Promise<void>;
    /** @deprecated Please load APIs with discovery documents. */
    function load(name: "displayvideo", version: "v3"): Promise<void>;
    /** @deprecated Please load APIs with discovery documents. */
    function load(name: "displayvideo", version: "v3", callback: () => any): void;
    ...
    namespace displayvideo {
        ...
        interface AdGroup {
            ...
            advertiserId?:
                string;
            /** The bidding strategy used by the ad group. Only BiddingStrategy.youtube_and_partners_bid can be used here. */
            bidStrategy?:
                BiddingStrategy;
        ...
        interface BiddingStrategy {
            ...
            /** A bid strategy used by YouTube and Partners resources. It can only be used for a YouTube and Partners line item and ad group entity. */
        ...
        interface CustomBiddingAlgorithmRulesRef {
            /**
             * A resource name to be used in media.download to download the rules files. Or media.upload to upload the rules files. Resource names have the format
        ...
        interface Kpi {
            /**
             * The goal amount, in micros of the advertiser's currency. Applicable when kpi_type is one of: * `KPI_TYPE_CPM` * `KPI_TYPE_CPC` * `KPI_TYPE_CPA` * `KPI_TYPE_CPIAVC` * `KPI_TYPE_VCPM`
             * For example: 1500000 represents 1.5 standard units of the currency.
             */
            kpiAmountMicros?:
                string;
            /**
             * The decimal representation of the goal percentage in micros. Applicable when kpi_type is one of: * `KPI_TYPE_CTR` * `KPI_TYPE_VIEWABILITY` * `KPI_TYPE_CLICK_CVR` *
             * `KPI_TYPE_IMPRESSION_CVR` * `KPI_TYPE_VTR` * `KPI_TYPE_AUDIO_COMPLETION_RATE` * `KPI_TYPE_VIDEO_COMPLETION_RATE` For example: 70000 represents 7% (decimal 0.07).
             */
            kpiPercentageMicros?:
                string;
            /** A KPI string, which can be empty. Must be UTF-8 encoded with a length of no more than 100 characters. Applicable when kpi_type][Kpi.kpi_type] is `KPI_TYPE_OTHER`. */
            kpiString?:
                string;
        ...
        interface ListAdGroupAssignedTargetingOptionsResponse {
            ...
            assignedTargetingOptions?:
                AssignedTargetingOption[];
            /**
             * A token identifying the next page of results. This value should be specified as the pageToken in a subsequent ListAdGroupAssignedTargetingOptionsRequest to fetch the next page of
        ...
        interface ListCustomBiddingAlgorithmRulesResponse {
            ...
            /**
             * A token to retrieve the next page of results. Pass this value in the page_token field in the subsequent call to `ListCustomBiddingAlgorithmRulesRequest` method to retrieve the next
             * page of results. If this field is null, it means this is the last page.
             */
            nextPageToken?:
                string;
        }
        ...
        interface TargetingExpansionConfig {
            /** Magnitude of expansion for eligible 1p user list under this ad group. */
        ...
        interface ThirdPartyMeasurementConfigs {
            ...
            /**
             * Optional. The third-party vendors measuring brand safety. The following third-party vendors are applicable: * `THIRD_PARTY_VENDOR_ZERF` * `THIRD_PARTY_VENDOR_DOUBLE_VERIFY` *
             * `THIRD_PARTY_VENDOR_INTEGRAL_AD_SCIENCE`
             */
            brandSafetyVendorConfigs?:
                ThirdPartyVendorConfig[];
            /**
             * Optional. The third-party vendors measuring reach. The following third-party vendors are applicable: * `THIRD_PARTY_VENDOR_NIELSEN` * `THIRD_PARTY_VENDOR_COMSCORE` *
             * `THIRD_PARTY_VENDOR_KANTAR`
             */
            reachVendorConfigs?:
                ThirdPartyVendorConfig[];
            /**
             * Optional. The third-party vendors measuring viewability. The following third-party vendors are applicable: * `THIRD_PARTY_VENDOR_MOAT` * `THIRD_PARTY_VENDOR_DOUBLE_VERIFY` *
        ...
        interface YoutubeAndPartnersInventorySourceConfig {
            /** Whether to target inventory on YouTube. This is a consolidation of the search and video networks - see go/dv3-yt-oyn-dd for more details. */
            includeYoutube?:
                boolean;
        ...
        interface AdGroupAdsResource {
            ...
            list(request?: {
                ...
                fields?:
                    string;
                /**
                 * Optional. Allows filtering by custom ad group ad fields. Supported syntax: * Filter expressions are made up of one or more restrictions. * Restrictions can be combined by `AND`
                ...
                oauth_token?:
                    string;
                /**
                 * Optional. Field by which to sort the list. Acceptable values are: * `displayName` (default) * `entityStatus` The default sorting order is ascending. To specify descending order
                ...
                pageSize?:
                    number;
                /**
                 * Optional. A token identifying a page of results the server should return. Typically, this is the value of next_page_token returned from the previous call to `ListAdGroupAds`
        ...
        interface AssignedTargetingOptionsResource {
            ...
            list(request?: {
                 ...
                 * the logical operator `OR`. * A restriction has the form of `{field} {operator} {value}`. * All fields must use the `EQUALS (=)` operator. Supported fields: *
                ...
                oauth_token?:
                    string;
                /**
                 * Optional. Field by which to sort the list. Acceptable values are: * `assignedTargetingOptionId` (default) The default sorting order is ascending. To specify descending order for
                 * a field, a suffix "desc" should be added to the field name. Example: `assignedTargetingOptionId desc`.
                 */
                orderBy?:
                    string;
                ...
                pageSize?:
                    number;
                /**
                 * Optional. A token identifying a page of results the server should return. Typically, this is the value of next_page_token returned from the previous call to
                 * `ListAdGroupAssignedTargetingOptions` method. If not specified, the first page of results will be returned.
                 */
                pageToken?:
                    string;
                /** Returns response with indentations and line breaks. */
        ...
        interface AdGroupsResource {
            ...
            list(request?: {
                ...
                fields?:
                    string;
                /**
                 * Optional. Allows filtering by custom ad group fields. Supported syntax: * Filter expressions are made up of one or more restrictions. * Restrictions can be combined by `AND` and
                 ...
                 * `ENTITY_STATUS_ACTIVE` or `ENTITY_STATUS_PAUSED` `AD_GROUP_FORMAT_IN_STREAM` ad groups under an advertiser: `(entityStatus="ENTITY_STATUS_ACTIVE" OR
                 * entityStatus="ENTITY_STATUS_PAUSED") AND adGroupFormat="AD_GROUP_FORMAT_IN_STREAM"` The length of this field should be no more than 500 characters. Reference our [filter `LIST`
                ...
                pageSize?:
                    number;
                /**
                 * Optional. A token identifying a page of results the server should return. Typically, this is the value of next_page_token returned from the previous call to `ListAdGroups`
                 * method. If not specified, the first page of results will be returned.
                 */
                pageToken?:
                    string;
        ...
        interface RulesResource {
            ...
            body: CustomBiddingAlgorithmRules): Request<CustomBiddingAlgorithmRules>;
            ...
            list(request?: {
                ...
                /**
                 * A token identifying a page of results the server should return. Typically, this is the value of next_page_token returned from the previous call to
                 * `ListCustomBiddingAlgorithmRules` method. If not specified, the first page of results will be returned.
                 */
                pageToken?:
                    string;
                /** The ID of the partner that owns the parent custom bidding algorithm. */
        ...
        interface CustomBiddingAlgorithmsResource {
            ...
            body: CustomBiddingAlgorithm): Request<CustomBiddingAlgorithm>;
            /**
             * Creates a rules reference object. The resulting reference object provides a resource path where the rules file should be uploaded. This reference object should be included when
             * creating a new rules resource.
             */
            uploadRules(request?: {
                /** V1 error format. */
                "$.xgafv"?:
        ...
        interface InventorySourcesResource {
            ...
            get(request?: {
                ...
                access_token?:
                    string;
                /**
                 * Optional. The ID of the DV360 advertiser to which the fetched inventory source is permissioned. If the user only has access to the advertiser and not the parent partner, use
                 * this field to specify the relevant advertiser.
                 */
                advertiserId?:
                    string;
                /** Data format for response. */
