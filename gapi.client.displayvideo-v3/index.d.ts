...
declare namespace gapi.client {
  ...
  function load(
    urlOrObject: 'https://displayvideo.googleapis.com/$discovery/rest?version=v3'
  ): Promise<void>;
  ...
  namespace displayvideo {
    ...
    interface TargetingExpansionConfig {
      ...
      /** Required. Whether to enable Optimized Targeting for the line item. *Warning*: Starting on **September 30, 2024**, optimized targeting will no longer be compatible with a subset of bid strategies. [Read more about this announced change](/display-video/api/deprecations#features.ot_bid_strategies). */
