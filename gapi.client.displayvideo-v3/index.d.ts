  ...
  namespace displayvideo {
    ...
    interface FirstAndThirdPartyAudiencesResource {
      ...
      list(request?: {
        ...
        orderBy?: string;
        /** Requested page size. Must be between `1` and `5000`. If unspecified, this value defaults to `100`. Returns error code `INVALID_ARGUMENT` if an invalid value is specified. *Warning*: Starting **March 6, 2025**, this value will default to `5000` if not set. */
        pageSize?: number;
