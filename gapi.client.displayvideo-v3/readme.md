...
```
npm install @types/gapi.client.displayvideo-v3 --save-dev
```
...
```typescript
gapi.client.load('https://displayvideo.googleapis.com/$discovery/rest?version=v3', () => {
  // now we can use:
...
gapi.client.load('displayvideo', 'v3', () => {
  // now we can use:
  // gapi.client.displayvideo
});
```
