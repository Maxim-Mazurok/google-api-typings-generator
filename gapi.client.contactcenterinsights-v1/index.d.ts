...
declare namespace gapi.client {
  ...
  namespace contactcenterinsights {
    ...
    interface GoogleCloudContactcenterinsightsV1alpha1DiagnoseConversationsRequest {
      ...
      appId?: string;
      /** Optional. Optional but highly recommended. ces app version. If provided, specific version of agent instruction will be retrieved. If empty or set to '-', will use the latest draft version of instruction. */
      appVersion?: string;
