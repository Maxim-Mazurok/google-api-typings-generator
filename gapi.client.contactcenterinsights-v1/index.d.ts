...
declare namespace gapi.client {
  ...
  namespace contactcenterinsights {
    ...
    interface GoogleCloudCesV1mainAgentTransfer {
    ...
    interface GoogleCloudCesV1mainBlob {
      /** Required. Raw bytes of the blob. */
      data?: string;
      /** Required. The IANA standard MIME type of the source data. */
      mimeType?: string;
    }
    interface GoogleCloudCesV1mainChunk {
    ...
    interface GoogleCloudCesV1mainMessage {
      /** Optional. Content of the message as a series of chunks. */
      chunks?: GoogleCloudCesV1mainChunk[];
    ...
    interface GoogleCloudCesV1mainSpan {
      /** Output only. Key-value attributes associated with the span. */
      attributes?: {[P in string]: any};
      /** Output only. The child spans that are nested under this span. */
      childSpans?: GoogleCloudCesV1mainSpan[];
    ...
    interface GoogleCloudCesV1mainToolCall {
    ...
    interface GoogleCloudCesV1mainToolResponse {
      /** Output only. Display name of the tool. */
      displayName?: string;
    ...
    interface GoogleCloudCesV1mainToolsetTool {
    ...
    interface GoogleCloudContactcenterinsightsV1alpha1CesEndSessionAnnotation {
      /** End session signal from CES. */
      endSession?: GoogleCloudCesV1mainEndSession;
    }
    interface GoogleCloudContactcenterinsightsV1alpha1CesTurnAnnotation {
      /** The messages in the turn. */
      messages?: GoogleCloudCesV1mainMessage[];
    ...
    interface GoogleCloudContactcenterinsightsV1alpha1ConversationDataSource {
      ...
      turnLevelAudios?: GoogleCloudContactcenterinsightsV1alpha1ConversationDataSourceTurnLevelAudio[];
    }
    interface GoogleCloudContactcenterinsightsV1alpha1ConversationDataSourceTurnLevelAudio {
    ...
    interface GoogleCloudContactcenterinsightsV1alpha1ConversationTranscriptTranscriptSegment {
      ...
      turnLevelAudio?: GoogleCloudContactcenterinsightsV1alpha1ConversationDataSourceTurnLevelAudio;
    ...
    interface GoogleCloudContactcenterinsightsV1alpha1DiagnoseConversationsMetadata {
      ...
      metricType?:
        ...
        | 'ESCALATION'
        | 'CONTAINMENT';
      /** Output only. Deprecated: Use partial_trajectory_steps instead. Output only. The intermediate trajectory updates (partial trajectory). */
      partialTrajectories?: string[];
      ...
      partialTrajectorySteps?: GoogleCloudContactcenterinsightsV1alpha1SherlockStep[];
    ...
    interface GoogleCloudContactcenterinsightsV1alpha1DiagnoseConversationsRequest {
      ...
      appId?: string;
      /** Required. The CES App version of the agent. Setting to "-" uses the latest draft version. Note that the agent active during the conversation history may have different instructions or tool definitions compared with the latest draft version. */
      appVersion?: string;
      /** Optional. Deprecated: If true, the request will be validated and a simulation of the analysis will be performed without actually executing the task. This field is unused. Use validate_only instead. */
      dryRun?: boolean;
      /** Optional. AIP-160 compliant filter for selecting target conversations. */
      filter?: string;
      /** Optional. Deprecated: If true, the agent will generate a full diagnostic report for all sub-agents. Subagent reporting configuration is unused. The final diagnostic details are already persisted inside the Diagnostic resource instead. */
      fullReport?: boolean;
      /** Optional. A unique identifier used to group multiple diagnostic requests triggered under the same run batch or cron job. */
      groupId?: string;
      ...
      metricType?:
        ...
        | 'ESCALATION'
        | 'CONTAINMENT';
      /** Optional. Deprecated: The configuration for the output of the task. The export destination is unused. Detailed markdown and conversation slices are already persisted inside the Diagnostic resource instead. */
    ...
    interface GoogleCloudContactcenterinsightsV1alpha1DiagnoseConversationsResponse {
      /** Output only. Deprecated: Output only. The final, high-level answer or diagnostic summary returned by the Sherlock worker is deprecated. The persistent analysis summary is stored inside the Diagnostic resource instead. */
      answer?: string;
      /** Output only. Deprecated: Output only. If an external destination was requested, the URI of the exported data is deprecated. The persistent diagnostic details are stored inside the Diagnostic resource instead. */
      exportUri?: string;
      ...
      fullTrajectories?: string[];
      /** Output only. Deprecated: Output only. The complete sequence of thoughts and actions taken by the agent is deprecated under LRO response completions. Use the persistent details inside the Diagnostic resource instead. */
      fullTrajectorySteps?: GoogleCloudContactcenterinsightsV1alpha1SherlockStep[];
    }
    interface GoogleCloudContactcenterinsightsV1alpha1DiagnosticReport {
      /** Output only. A map of conversation slices used in the report. */
      conversationSlices?: {
        [P in string]: GoogleCloudContactcenterinsightsV1alpha1DiagnosticReportConversationSlice;
      };
      /** Output only. Deprecated: Intent breakdowns are no longer used. */
      intentStats?: GoogleCloudContactcenterinsightsV1alpha1DiagnosticReportIntentStats[];
      /** Output only. A list of loss patterns identified for the entire project/dataset. */
      lossPatterns?: GoogleCloudContactcenterinsightsV1alpha1LossPattern[];
      /** Output only. Deprecated: The type of the metric. Metrics for Outcome Based Insights derived from QueryMetrics. */
      metrics?: {
        [P in string]: GoogleCloudContactcenterinsightsV1alpha1MetricValue;
      };
      /** Output only. The final report in markdown format. */
      report?: string;
    }
    interface GoogleCloudContactcenterinsightsV1alpha1DiagnosticReportConversationSlice {
      /** The list of conversation IDs that match this slice. */
      conversationIds?: string[];
    }
    interface GoogleCloudContactcenterinsightsV1alpha1DiagnosticReportIntentStats {
    ...
    interface GoogleCloudContactcenterinsightsV1alpha1GenerativeInsightConversationTranscriptMessageSystemMessageTextOutput {
      ...
      textType?: 'TYPE_UNSPECIFIED' | 'THOUGHT' | 'FINAL_RESPONSE' | 'PROGRESS';
    }
    ...
    interface GoogleCloudContactcenterinsightsV1alpha1LossPattern {
      ...
      links?: GoogleCloudContactcenterinsightsV1alpha1LossPatternLink[];
    ...
    interface GoogleCloudContactcenterinsightsV1alpha1LossPatternLink {
      /** A link to a bot instruction. */
      botInstructionLink?: GoogleCloudContactcenterinsightsV1alpha1LossPatternLinkBotInstructionLink;
      /** A link to a conversation. */
      conversationLink?: GoogleCloudContactcenterinsightsV1alpha1LossPatternLinkConversationLink;
    ...
    interface GoogleCloudContactcenterinsightsV1alpha1LossPatternLinkBotInstructionLink {
    ...
    interface GoogleCloudContactcenterinsightsV1alpha1LossPatternLinkConversationLink {
      /** The conversation ID. */
      conversationId?: string;
    }
    interface GoogleCloudContactcenterinsightsV1alpha1MetricValue {
      ...
      hitCount?: number;
      /** Output only. Deprecated: The type of the metric. Metrics for Outcome Based Insights derived from QueryMetrics. */
      metricType?: 'METRIC_TYPE_UNSPECIFIED' | 'ESCALATION' | 'CONTAINMENT';
    ...
    interface GoogleCloudContactcenterinsightsV1alpha1OutputConfig {
      /** Optional. Export to BigQuery. */
      bigqueryDestination?: GoogleCloudContactcenterinsightsV1alpha1OutputConfigBigQueryDestination;
      ...
      googleSheetsDestination?: GoogleCloudContactcenterinsightsV1alpha1OutputConfigGoogleSheetsDestination;
    }
    interface GoogleCloudContactcenterinsightsV1alpha1OutputConfigBigQueryDestination {
    ...
    interface GoogleCloudContactcenterinsightsV1alpha1OutputConfigGcsDestination {
      /** Required. The Cloud Storage URI to export the results to. */
      uri?: string;
    }
    interface GoogleCloudContactcenterinsightsV1alpha1OutputConfigGoogleSheetsDestination {
    ...
    interface GoogleCloudContactcenterinsightsV1alpha1SherlockStep {
      ...
      thought?: string;
      /** Output only. Deprecated: Use content instead. */
      toolCalls?: GoogleCloudContactcenterinsightsV1alpha1ToolCall[];
      /** Output only. Deprecated: Use content instead. */
      toolOutput?: {[P in string]: any};
    }
    ...
    interface GoogleCloudContactcenterinsightsV1alpha1ToolCall {
    ...
    interface GoogleCloudContactcenterinsightsV1BulkDownloadFeedbackLabelsRequestGcsDestination {
      ...
      format?: 'FORMAT_UNSPECIFIED' | 'CSV' | 'JSON';
    ...
    interface GoogleCloudContactcenterinsightsV1CesEndSessionAnnotation {
      /** End session signal from CES. */
      endSession?: GoogleCloudCesV1mainEndSession;
    }
    interface GoogleCloudContactcenterinsightsV1CesTurnAnnotation {
      /** The messages in the turn. */
      messages?: GoogleCloudCesV1mainMessage[];
      /** The root span of the action processing. */
      rootSpan?: GoogleCloudCesV1mainSpan;
    ...
    interface GoogleCloudContactcenterinsightsV1ChartAction {
      /** Redirect action. */
    ...
    interface GoogleCloudContactcenterinsightsV1ConversationDataSource {
      ...
      metadataUri?: string;
      /** Cloud Storage URIs that points to files that contain the conversation audio for each turn. Assume the order of the URIs is the same as the order of the transcript turns. */
      turnLevelAudios?: GoogleCloudContactcenterinsightsV1ConversationDataSourceTurnLevelAudio[];
    }
    ...
    interface GoogleCloudContactcenterinsightsV1DiagnoseConversationsMetadata {
      /** Output only. The list of conversation IDs that were selected for this diagnosis. */
      conversationIds?: string[];
      /** Output only. The time the operation was created. */
      createTime?: string;
      ...
      partialTrajectories?: string[];
      /** Output only. The intermediate trajectory updates. This can be used for live progress tracking of the agent's thoughts and actions as it works through the analysis. */
      partialTrajectorySteps?: GoogleCloudContactcenterinsightsV1SherlockStep[];
      /** Output only. The request that created the operation. */
      request?: GoogleCloudContactcenterinsightsV1DiagnoseConversationsRequest;
    }
    interface GoogleCloudContactcenterinsightsV1DiagnoseConversationsRequest {
      /** ces agent display name (e.g., "Steering", "Billing"). */
      agentDisplayName?: string;
      /** ces agent id to diagnose. */
      agentId?: string;
    ...
    interface GoogleCloudContactcenterinsightsV1DiagnoseConversationsResponse {
      /** Output only. Deprecated: Output only. The final, high-level answer or diagnostic summary returned by the Sherlock worker is deprecated. The persistent analysis summary is stored inside the Diagnostic resource instead. */
      answer?: string;
      /** Output only. Deprecated: Output only. If an external destination was requested, the URI of the exported data is deprecated. The persistent diagnostic details are stored inside the Diagnostic resource instead. */
      exportUri?: string;
      ...
      fullTrajectories?: string[];
      /** Output only. Deprecated: Output only. The complete sequence of thoughts and actions taken by the agent is deprecated under LRO response completions. Use the persistent details inside the Diagnostic resource instead. */
      fullTrajectorySteps?: GoogleCloudContactcenterinsightsV1SherlockStep[];
    }
    interface GoogleCloudContactcenterinsightsV1Diagnostic {
    ...
    interface GoogleCloudContactcenterinsightsV1DiagnosticReport {
      /** Output only. A map of conversation slices used in the report. */
      conversationSlices?: {
        [P in string]: GoogleCloudContactcenterinsightsV1DiagnosticReportConversationSlice;
      };
      /** Output only. Deprecated: Intent breakdowns are no longer used. */
      intentStats?: GoogleCloudContactcenterinsightsV1DiagnosticReportIntentStats[];
      /** Output only. A list of loss patterns identified for the entire project/dataset. */
      lossPatterns?: GoogleCloudContactcenterinsightsV1LossPattern[];
      /** Output only. Deprecated: The type of the metric. Metrics for Outcome Based Insights derived from QueryMetrics. */
      metrics?: {[P in string]: GoogleCloudContactcenterinsightsV1MetricValue};
      /** Output only. The final report in markdown format. */
      report?: string;
    }
    interface GoogleCloudContactcenterinsightsV1DiagnosticReportConversationSlice {
      /** The list of conversation IDs that match this slice. */
      conversationIds?: string[];
    }
    interface GoogleCloudContactcenterinsightsV1DiagnosticReportIntentStats {
      /** Output only. The number of conversations associated with this intent. */
      conversationCount?: number;
      /** Output only. The display name of the intent. */
      intentDisplayName?: string;
    ...
    interface GoogleCloudContactcenterinsightsV1GenerativeInsightsChartConversationMessageSystemMessageTextOutput {
      ...
      texts?: string[];
      /** The type of the text message. */
      type?: 'TYPE_UNSPECIFIED' | 'THOUGHT' | 'FINAL_RESPONSE' | 'PROGRESS';
    }
    ...
    interface GoogleCloudContactcenterinsightsV1ListDiagnosticsResponse {
      /** Optional. The diagnostics that match the request. */
      diagnostics?: GoogleCloudContactcenterinsightsV1Diagnostic[];
    ...
    interface GoogleCloudContactcenterinsightsV1LossPattern {
      /** Output only. A list of conversation IDs that match this loss pattern. */
      conversationIds?: string[];
      /** Output only. A markdown description of the loss pattern. */
      description?: string;
      ...
      id?: string;
      /** Output only. A list of links to conversations or bot instructions. */
      links?: GoogleCloudContactcenterinsightsV1LossPatternLink[];
      /** Output only. The percentage of conversations that match this loss pattern. */
      percentage?: number;
      /** Output only. A markdown description of the suggested fixes. */
      suggestedFixes?: string;
    }
    interface GoogleCloudContactcenterinsightsV1LossPatternLink {
      /** A link to a bot instruction. */
      botInstructionLink?: GoogleCloudContactcenterinsightsV1LossPatternLinkBotInstructionLink;
      /** A link to a conversation. */
      conversationLink?: GoogleCloudContactcenterinsightsV1LossPatternLinkConversationLink;
      /** The end byte index of the highlighted text (exclusive). */
      endByteIndex?: number;
      /** The text that is highlighted. (populated for debugging purposes) */
      highlightedText?: string;
    ...
    interface GoogleCloudContactcenterinsightsV1LossPatternLinkBotInstructionLink {
      /** The exclusive end line number of the instructions. */
      endLine?: number;
      /** The inclusive start line number of the instructions. */
      startLine?: number;
    ...
    interface GoogleCloudContactcenterinsightsV1LossPatternLinkConversationLink {
      /** The conversation ID. */
      conversationId?: string;
    }
    ...
    interface GoogleCloudContactcenterinsightsV1mainCesEndSessionAnnotation {
      /** End session signal from CES. */
      endSession?: GoogleCloudCesV1mainEndSession;
    }
    interface GoogleCloudContactcenterinsightsV1mainCesTurnAnnotation {
      /** The messages in the turn. */
      messages?: GoogleCloudCesV1mainMessage[];
      /** The root span of the action processing. */
      rootSpan?: GoogleCloudCesV1mainSpan;
    ...
    interface GoogleCloudContactcenterinsightsV1mainConversationDataSource {
      ...
      metadataUri?: string;
      /** Cloud Storage URIs that points to files that contain the conversation audio for each turn. Assume the order of the URIs is the same as the order of the transcript turns. */
      turnLevelAudios?: GoogleCloudContactcenterinsightsV1mainConversationDataSourceTurnLevelAudio[];
    }
    interface GoogleCloudContactcenterinsightsV1mainConversationDataSourceTurnLevelAudio {
      /** The duration of the audio. */
      audioDuration?: string;
      /** The Cloud Storage URI of the audio for any given turn. */
      audioGcsUri?: string;
    ...
    interface GoogleCloudContactcenterinsightsV1mainDiagnoseConversationsMetadata {
      /** Output only. The list of conversation IDs that were selected for this diagnosis. */
      conversationIds?: string[];
      /** Output only. The time the operation was created. */
      createTime?: string;
      ...
      partialTrajectories?: string[];
      /** Output only. The intermediate trajectory updates. This can be used for live progress tracking of the agent's thoughts and actions as it works through the analysis. */
      partialTrajectorySteps?: GoogleCloudContactcenterinsightsV1mainSherlockStep[];
      /** Output only. The request that created the operation. */
      request?: GoogleCloudContactcenterinsightsV1mainDiagnoseConversationsRequest;
    }
    interface GoogleCloudContactcenterinsightsV1mainDiagnoseConversationsRequest {
      /** ces agent display name (e.g., "Steering", "Billing"). */
      agentDisplayName?: string;
      /** ces agent id to diagnose. */
      agentId?: string;
    ...
    interface GoogleCloudContactcenterinsightsV1mainDiagnoseConversationsResponse {
      /** Output only. Deprecated: Output only. The final, high-level answer or diagnostic summary returned by the Sherlock worker is deprecated. The persistent analysis summary is stored inside the Diagnostic resource instead. */
      answer?: string;
      /** Output only. Deprecated: Output only. If an external destination was requested, the URI of the exported data is deprecated. The persistent diagnostic details are stored inside the Diagnostic resource instead. */
      exportUri?: string;
      ...
      fullTrajectories?: string[];
      /** Output only. Deprecated: Output only. The complete sequence of thoughts and actions taken by the agent is deprecated under LRO response completions. Use the persistent details inside the Diagnostic resource instead. */
      fullTrajectorySteps?: GoogleCloudContactcenterinsightsV1mainSherlockStep[];
    }
    interface GoogleCloudContactcenterinsightsV1mainDiagnosticReport {
      /** Output only. A map of conversation slices used in the report. */
      conversationSlices?: {
        [P in string]: GoogleCloudContactcenterinsightsV1mainDiagnosticReportConversationSlice;
      };
      /** Output only. Deprecated: Intent breakdowns are no longer used. */
      intentStats?: GoogleCloudContactcenterinsightsV1mainDiagnosticReportIntentStats[];
      /** Output only. A list of loss patterns identified for the entire project/dataset. */
      lossPatterns?: GoogleCloudContactcenterinsightsV1mainLossPattern[];
      /** Output only. Deprecated: The type of the metric. Metrics for Outcome Based Insights derived from QueryMetrics. */
      metrics?: {
        [P in string]: GoogleCloudContactcenterinsightsV1mainMetricValue;
      };
      /** Output only. The final report in markdown format. */
      report?: string;
    }
    interface GoogleCloudContactcenterinsightsV1mainDiagnosticReportConversationSlice {
      /** The list of conversation IDs that match this slice. */
      conversationIds?: string[];
    }
    interface GoogleCloudContactcenterinsightsV1mainDiagnosticReportIntentStats {
      /** Output only. The number of conversations associated with this intent. */
      conversationCount?: number;
      /** Output only. The display name of the intent. */
      intentDisplayName?: string;
    ...
    interface GoogleCloudContactcenterinsightsV1mainLossPattern {
      /** Output only. A list of conversation IDs that match this loss pattern. */
      conversationIds?: string[];
      /** Output only. A markdown description of the loss pattern. */
      description?: string;
      ...
      id?: string;
      /** Output only. A list of links to conversations or bot instructions. */
      links?: GoogleCloudContactcenterinsightsV1mainLossPatternLink[];
      /** Output only. The percentage of conversations that match this loss pattern. */
      percentage?: number;
      /** Output only. A markdown description of the suggested fixes. */
      suggestedFixes?: string;
    }
    interface GoogleCloudContactcenterinsightsV1mainLossPatternLink {
      /** A link to a bot instruction. */
      botInstructionLink?: GoogleCloudContactcenterinsightsV1mainLossPatternLinkBotInstructionLink;
      /** A link to a conversation. */
    ...
    interface GoogleCloudContactcenterinsightsV1mainLossPatternLinkBotInstructionLink {
      /** The exclusive end line number of the instructions. */
      endLine?: number;
      /** The inclusive start line number of the instructions. */
      startLine?: number;
    ...
    interface GoogleCloudContactcenterinsightsV1mainLossPatternLinkConversationLink {
      /** The conversation ID. */
      conversationId?: string;
    }
    interface GoogleCloudContactcenterinsightsV1mainMetricValue {
      /** Output only. The list of conversation names that contributed to this metric (hits). Format: `projects/{project}/locations/{location}/conversations/{conversation}` */
      conversations?: string[];
      /** Output only. The user-visible name of the metric (e.g., "Containment Rate"). */
      displayName?: string;
    ...
    interface GoogleCloudContactcenterinsightsV1mainOutputConfig {
      /** Optional. Export to BigQuery. */
      bigqueryDestination?: GoogleCloudContactcenterinsightsV1mainOutputConfigBigQueryDestination;
      /** Optional. Export to a Cloud Storage bucket. */
      gcsDestination?: GoogleCloudContactcenterinsightsV1mainOutputConfigGcsDestination;
      /** Optional. Export directly to a Google Sheet. */
      googleSheetsDestination?: GoogleCloudContactcenterinsightsV1mainOutputConfigGoogleSheetsDestination;
    }
    interface GoogleCloudContactcenterinsightsV1mainOutputConfigBigQueryDestination {
      /** Required. The name of the BigQuery dataset. */
      dataset?: string;
      /** Optional. A project ID or number. */
      projectId?: string;
    ...
    interface GoogleCloudContactcenterinsightsV1mainOutputConfigGcsDestination {
      /** Required. The Cloud Storage URI to export the results to. */
      uri?: string;
    }
    interface GoogleCloudContactcenterinsightsV1mainOutputConfigGoogleSheetsDestination {
      /** Optional. The sheet name. */
      sheet?: string;
      /** Optional. An existing Google Sheets ID. */
      spreadsheetId?: string;
    ...
    interface GoogleCloudContactcenterinsightsV1mainSherlockStep {
      /** Output only. The ID of the agent that produced/received this content. */
      agentId?: string;
      /** Output only. The content of the turn (either Model or User role). */
      content?: GoogleCloudAiplatformV1Content;
      ...
      thought?: string;
      /** Output only. Deprecated: Use content instead. */
      toolCalls?: GoogleCloudContactcenterinsightsV1mainToolCall[];
      /** Output only. Deprecated: Use content instead. */
      toolOutput?: {[P in string]: any};
    }
    ...
    interface GoogleCloudContactcenterinsightsV1mainToolCall {
      /** Output only. The input arguments to the tool. */
      input?: {[P in string]: any};
      /** Output only. The name of the tool being called. */
      toolName?: string;
    ...
    interface GoogleCloudContactcenterinsightsV1MetricDefinition {
      /** Output only. The user-visible name of the metric (e.g., "Containment Rate"). */
      displayName?: string;
      /** Output only. The resource name of the underlying Insights primitive (e.g., Tag or QaQuestion) used to calculate this metric. */
      sourceId?: string;
    }
    interface GoogleCloudContactcenterinsightsV1MetricValue {
      /** Output only. The list of conversation names that contributed to this metric (hits). Format: `projects/{project}/locations/{location}/conversations/{conversation}` */
      conversations?: string[];
      /** Output only. The user-visible name of the metric (e.g., "Containment Rate"). */
      displayName?: string;
    ...
    interface GoogleCloudContactcenterinsightsV1OutputConfig {
      /** Optional. Export to BigQuery. */
      bigqueryDestination?: GoogleCloudContactcenterinsightsV1OutputConfigBigQueryDestination;
      /** Optional. Export to a Cloud Storage bucket. */
      gcsDestination?: GoogleCloudContactcenterinsightsV1OutputConfigGcsDestination;
      /** Optional. Export directly to a Google Sheet. */
      googleSheetsDestination?: GoogleCloudContactcenterinsightsV1OutputConfigGoogleSheetsDestination;
    }
    interface GoogleCloudContactcenterinsightsV1OutputConfigBigQueryDestination {
      /** Required. The name of the BigQuery dataset. */
      dataset?: string;
      /** Optional. A project ID or number. */
      projectId?: string;
    ...
    interface GoogleCloudContactcenterinsightsV1OutputConfigGcsDestination {
      /** Required. The Cloud Storage URI to export the results to. */
      uri?: string;
    }
    interface GoogleCloudContactcenterinsightsV1OutputConfigGoogleSheetsDestination {
      /** Optional. The sheet name. */
      sheet?: string;
      /** Optional. An existing Google Sheets ID. */
      spreadsheetId?: string;
    ...
    interface GoogleCloudContactcenterinsightsV1RedirectAction {
      /** The query params to be added to the redirect path. */
      queryParams?: {[P in string]: string};
    ...
    interface GoogleCloudContactcenterinsightsV1SettingsDiagnosticMetricConfig {
      /** Optional. A map of diagnostic metrics. The key is a unique identifier for the metric (e.g., "containment"). */
      metrics?: {
        [P in string]: GoogleCloudContactcenterinsightsV1MetricDefinition;
      };
    }
    interface GoogleCloudContactcenterinsightsV1SherlockStep {
      /** Output only. The ID of the agent that produced/received this content. */
      agentId?: string;
      /** Output only. The content of the turn (either Model or User role). */
      content?: GoogleCloudAiplatformV1Content;
      ...
      thought?: string;
      /** Output only. Deprecated: Use content instead. */
      toolCalls?: GoogleCloudContactcenterinsightsV1ToolCall[];
      /** Output only. Deprecated: Use content instead. */
      toolOutput?: {[P in string]: any};
    }
    ...
    interface GoogleCloudContactcenterinsightsV1ToolCall {
      /** Output only. The input arguments to the tool. */
      input?: {[P in string]: any};
      /** Output only. The name of the tool being called. */
      toolName?: string;
    ...
    interface DiagnosticsResource {
      ...
      get(request?: {
        ...
        /** Legacy upload protocol for media (e.g. "media", "multipart"). */
        uploadType?: string;
      }): Request<GoogleCloudContactcenterinsightsV1Diagnostic>;
      /** Lists diagnostics. */
      list(request?: {
        /** V1 error format. */
        '$.xgafv'?: '1' | '2';
        ...
        pageSize?: number;
        /** Optional. A page token, received from a previous `ListDiagnostics` call. Provide this to retrieve the subsequent page. */
        pageToken?: string;
        ...
        /** Legacy upload protocol for media (e.g. "media", "multipart"). */
        uploadType?: string;
      }): Request<GoogleCloudContactcenterinsightsV1ListDiagnosticsResponse>;
    }
    ...
    interface LocationsResource {
      ...
      diagnoseConversations(request: {
        ...
        uploadType?: string;
        /** Request body */
        resource: GoogleCloudContactcenterinsightsV1DiagnoseConversationsRequest;
      }): Request<GoogleLongrunningOperation>;
