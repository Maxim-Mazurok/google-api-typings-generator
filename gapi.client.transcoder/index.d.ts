/* Type definitions for non-npm package Transcoder API v1 1.0 */
// Project: https://cloud.google.com/transcoder/docs/
...
// Generated from: https://transcoder.googleapis.com/$discovery/rest?version=v1
// Revision: 20220131
...
declare namespace gapi.client {
    ...
    function load(name: "transcoder", version: "v1"): PromiseLike<void>;
    function load(name: "transcoder", version: "v1", callback: () => any): void;
    ...
    namespace transcoder {
        ...
        interface H264CodecSettings {
            ...
            pixelFormat?: string;
            /**
             * Enforces the specified codec preset. The default is `veryfast`. The available options are [FFmpeg-compatible](https://trac.ffmpeg.org/wiki/Encode/H.264#Preset). Note that certain
             * values for this field may cause the transcoder to override other fields you set in the `H264CodecSettings` message.
             */
            preset?: string;
            /**
             * Enforces the specified codec profile. The following profiles are supported: * `baseline` * `main` * `high` (default) The available options are
             * [FFmpeg-compatible](https://trac.ffmpeg.org/wiki/Encode/H.264#Tune). Note that certain values for this field may cause the transcoder to override other fields you set in the
            ...
            /**
             * Enforces the specified codec tune. The available options are [FFmpeg-compatible](https://trac.ffmpeg.org/wiki/Encode/H.264#Tune). Note that certain values for this field may cause
        ...
        interface Input {
            ...
            /**
             * URI of the media. Input files must be at least 5 seconds in duration and stored in Cloud Storage (for example, `gs://bucket/inputs/file.mp4`). If empty, the value will be populated
             * from `Job.input_uri`.
             */
            uri?: string;
        }
        interface Job {
             ...
             * files must be at least 5 seconds in duration and stored in Cloud Storage (for example, `gs://bucket/inputs/file.mp4`).
             */
            inputUri?: string;
        ...
        interface JobTemplatesResource {
            ...
            body: JobTemplate): Request<JobTemplate>;
            ...
            list(request?: {
                ...
                /** Legacy upload protocol for media (e.g. "media", "multipart"). */
                uploadType?: string;
            }): Request<ListJobTemplatesResponse>;
        }
        interface LocationsResource {
            jobs: JobsResource;
            jobTemplates: JobTemplatesResource;
        }
