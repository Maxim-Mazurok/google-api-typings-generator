/* Type definitions for non-npm package Transcoder API v1beta1 1.0 */
...
// Generated from: https://transcoder.googleapis.com/$discovery/rest?version=v1beta1
// Revision: 20210401
...
declare namespace gapi.client {
    ...
    function load(name: "transcoder", version: "v1beta1"): PromiseLike<void>;
    function load(name: "transcoder", version: "v1beta1", callback: () => any): void;
    ...
    namespace transcoder {
        ...
        interface SegmentSettings {
            ...
            /**
             * Duration of the segments in seconds. The default is `"6.0s"`. Note that `segmentDuration` must be greater than or equal to [`gopDuration`](#videostream), and `segmentDuration` must
             * be divisible by [`gopDuration`](#videostream).
             */
        ...
        interface VideoStream {
             ...
             * parenthesis) and input FPS (in the first column): ``` | | (30) | (60) | (25) | (50) | |--------|--------|--------|------|------| | 240 | Fail | Fail | Fail | Fail | | 120 | 30 | 60
             * | 20 | 30 | | 100 | 25 | 50 | 20 | 30 | | 50 | 25 | 50 | 20 | 30 | | 60 | 30 | 60 | 20 | 30 | | 59.94 | 29.97 | 59.94 | 20 | 30 | | 48 | 24 | 48 | 20 | 30 | | 30 | 30 | 30 | 20 | 30
