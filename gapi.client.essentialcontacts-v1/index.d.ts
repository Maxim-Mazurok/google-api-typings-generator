/* Type definitions for non-npm package Essential Contacts API v1 0.0 */
...
declare namespace gapi.client {
    ...
    function load(urlOrObject: "https://essentialcontacts.googleapis.com/$discovery/rest?version=v1"): Promise<void>;
