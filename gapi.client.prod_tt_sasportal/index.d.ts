...
declare namespace gapi.client {
    ...
    namespace prod_tt_sasportal {
        ...
        interface SasPortalListDeploymentsResponse {
            ...
            /**
             * A pagination token returned from a previous call to ListDeployments that indicates from where listing should continue. If the field is missing or empty, it means there is no more
             * deployments.
             */
            nextPageToken?: string;
        }
        ...
        interface SasPortalMoveDeviceRequest {
            /** Required. The name of the new parent resource node [spectrum.sas.portal.v1alpha1.Node] or customer to reparent the device under. */
            destination?: string;
        }
