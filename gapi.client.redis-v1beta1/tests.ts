...
gapi.load('client', async () => {
  ...
  async function run() {
    ...
    await gapi.client.redis.projects.locations.getSharedRegionalCertificateAuthority(
      {
        name: 'Test string',
      },
    );
    ...
    await gapi.client.redis.projects.locations.aclPolicies.create(
      {
        aclPolicyId: 'Test string',
        parent: 'Test string',
        ...
        clusterAclPolicyAttachments: [
          {
            aclPolicyRevisionStatuses: [
              {
                aclPolicyRevision: 'Test string',
                aclPolicyRevisionNumber: 'Test string',
    ...
    await gapi.client.redis.projects.locations.aclPolicies.delete({
      etag: 'Test string',
      name: 'Test string',
      requestId: 'Test string',
    });
    /** Gets the details of a specific Redis Cluster ACL policy. */
    await gapi.client.redis.projects.locations.aclPolicies.get({
      name: 'Test string',
    });
    ...
    await gapi.client.redis.projects.locations.aclPolicies.list({
      pageSize: 42,
      pageToken: 'Test string',
      parent: 'Test string',
    });
    ...
    await gapi.client.redis.projects.locations.aclPolicies.patch(
      {
        name: 'Test string',
        requestId: 'Test string',
    ...
    await gapi.client.redis.projects.locations.aclPolicies.revisions.get({
      name: 'Test string',
    });
    /** Lists all ACL policy revisions in a given ACL policy. */
    await gapi.client.redis.projects.locations.aclPolicies.revisions.list({
      pageSize: 42,
      pageToken: 'Test string',
      parent: 'Test string',
    });
    ...
    await gapi.client.redis.projects.locations.clusters.addTokenAuthUser(
      {
        cluster: 'Test string',
      },
      {
        tokenAuthUser: 'Test string',
      },
    );
    ...
    await gapi.client.redis.projects.locations.clusters.create(
      ...
      },
      {
        ...
        aclPolicyInfo: {
          ...
          appliedAclPolicy: 'Test string',
          appliedAclPolicyRevision: 'Test string',
          appliedAclPolicyRevisionNumber: 'Test string',
        },
        aclPolicyInSync: true,
    ...
    await gapi.client.redis.projects.locations.clusters.tokenAuthUsers.addAuthToken(
      {
        tokenAuthUser: 'Test string',
      },
      {
    ...
    await gapi.client.redis.projects.locations.clusters.tokenAuthUsers.delete({
      force: true,
      name: 'Test string',
      requestId: 'Test string',
    });
    /** Gets a specific token auth user for a basic auth enabled cluster. */
    await gapi.client.redis.projects.locations.clusters.tokenAuthUsers.get({
      name: 'Test string',
    });
    /** Lists all the token auth users for a token based auth enabled cluster. */
    await gapi.client.redis.projects.locations.clusters.tokenAuthUsers.list({
      filter: 'Test string',
      orderBy: 'Test string',
      pageSize: 42,
      pageToken: 'Test string',
    ...
    await gapi.client.redis.projects.locations.clusters.tokenAuthUsers.authTokens.delete(
      {
        name: 'Test string',
      },
    );
    /** Gets a specific auth token for a specific token auth user. */
    await gapi.client.redis.projects.locations.clusters.tokenAuthUsers.authTokens.get(
      {
        name: 'Test string',
      },
    );
    /** Lists all the auth tokens for a specific token auth user. */
    await gapi.client.redis.projects.locations.clusters.tokenAuthUsers.authTokens.list(
      {
        filter: 'Test string',
        orderBy: 'Test string',
        pageSize: 42,
