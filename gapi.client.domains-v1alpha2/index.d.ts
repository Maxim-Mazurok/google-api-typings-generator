...
declare namespace gapi.client {
  ...
  function load(
    urlOrObject: 'https://domains.googleapis.com/$discovery/rest?version=v1alpha2',
  ): Promise<void>;
  ...
  namespace domains {
    ...
    interface InitiatePushTransferRequest {
    ...
    interface RegistrationsResource {
      ...
      initiatePushTransfer(request: {
        ...
        uploadType?: string;
        /** Request body */
        resource: InitiatePushTransferRequest;
      }): Request<Operation>;
      ...
      retrieveGoogleDomainsDnsRecords(request?: {
        ...
        /** Legacy upload protocol for media (e.g. "media", "multipart"). */
        uploadType?: string;
      }): Request<RetrieveGoogleDomainsDnsRecordsResponse>;
      ...
      retrieveGoogleDomainsForwardingConfig(request?: {
        ...
        /** Legacy upload protocol for media (e.g. "media", "multipart"). */
        uploadType?: string;
      }): Request<RetrieveGoogleDomainsForwardingConfigResponse>;
