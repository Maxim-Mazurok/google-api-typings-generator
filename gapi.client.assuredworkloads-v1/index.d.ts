...
declare namespace gapi.client {
  ...
  namespace assuredworkloads {
    ...
    interface GoogleCloudAssuredworkloadsV1AggregateDbFrameworkComplianceReportResponse {
      /** The list of aggregated compliance reports. */
      aggregatedComplianceReports?: GoogleCloudAssuredworkloadsV1AggregatedComplianceReport[];
    }
    interface GoogleCloudAssuredworkloadsV1AggregatedComplianceReport {
    ...
    interface GoogleCloudAssuredworkloadsV1ApplyWorkloadUpdateOperationMetadata {
    ...
    interface GoogleCloudAssuredworkloadsV1ApplyWorkloadUpdateResponse {
      /** The update that was applied. */
      appliedUpdate?: GoogleCloudAssuredworkloadsV1WorkloadUpdate;
    }
    interface GoogleCloudAssuredworkloadsV1ArchiveResourceEventsRequest {
    ...
    interface GoogleCloudAssuredworkloadsV1ArchiveResourceEventsResponse {
    ...
    interface GoogleCloudAssuredworkloadsV1BatchAcknowledgeViolationsRequest {
    ...
    interface GoogleCloudAssuredworkloadsV1BatchAcknowledgeViolationsResponse {
      /** Count of acknowledged violations. */
      acknowledgedViolationsCount?: number;
    }
    interface GoogleCloudAssuredworkloadsV1CELExpression {
    ...
    interface GoogleCloudAssuredworkloadsV1CloudControlAssessmentDetails {
    ...
    interface GoogleCloudAssuredworkloadsV1CloudControlReport {
      ...
      cloudControlType?: 'TYPE_UNSPECIFIED' | 'CUSTOM' | 'BUILT_IN';
      ...
      frameworkMajorRevisionIds?: string[];
      ...
      rules?: GoogleCloudAssuredworkloadsV1Rule[];
      /** The list of similar controls. */
      similarControls?: GoogleCloudAssuredworkloadsV1SimilarControls[];
    }
    interface GoogleCloudAssuredworkloadsV1ControlAssessmentDetails {
      /** The list of controls that were assessed and are passing. */
      assessedPassingControlIds?: string[];
    ...
    interface GoogleCloudAssuredworkloadsV1DbControlComplianceSummary {
      /** The list of cloud control reports. */
      cloudControlReports?: GoogleCloudAssuredworkloadsV1CloudControlReport[];
    ...
    interface GoogleCloudAssuredworkloadsV1DbFindingSummary {
    ...
    interface GoogleCloudAssuredworkloadsV1DbFrameworkComplianceSummary {
      /** The control assessment details of the framework. */
      controlAssessmentDetails?: GoogleCloudAssuredworkloadsV1ControlAssessmentDetails;
      ...
      frameworkType?: 'FRAMEWORK_TYPE_UNSPECIFIED' | 'BUILT_IN' | 'CUSTOM';
      ...
      targetResourceDetails?: GoogleCloudAssuredworkloadsV1TargetResourceDetails[];
    }
    interface GoogleCloudAssuredworkloadsV1EnableComplianceUpdatesResponse {}
    interface GoogleCloudAssuredworkloadsV1EnableResourceMonitoringResponse {}
    interface GoogleCloudAssuredworkloadsV1FetchDbFrameworkComplianceReportResponse {
      /** The control assessment details of the framework. */
      controlAssessmentDetails?: GoogleCloudAssuredworkloadsV1ControlAssessmentDetails;
      /** The name of the framework. */
      framework?: string;
    ...
    interface GoogleCloudAssuredworkloadsV1ListDbControlComplianceSummariesResponse {
      /** The list of control compliance details. */
      dbControlComplianceSummaries?: GoogleCloudAssuredworkloadsV1DbControlComplianceSummary[];
      /** Output only. The token to retrieve the next page of results. */
      nextPageToken?: string;
    }
    interface GoogleCloudAssuredworkloadsV1ListDbFindingSummariesResponse {
      /** List of finding summary by category. */
      dbFindingSummaries?: GoogleCloudAssuredworkloadsV1DbFindingSummary[];
      /** Output only. The token to retrieve the next page of results. */
      nextPageToken?: string;
    }
    interface GoogleCloudAssuredworkloadsV1ListDbFrameworkComplianceSummariesResponse {
      /** The list of framework compliance summaries. */
      dbFrameworkComplianceSummaries?: GoogleCloudAssuredworkloadsV1DbFrameworkComplianceSummary[];
      /** Output only. The token to retrieve the next page of results. */
      nextPageToken?: string;
    }
    ...
    interface GoogleCloudAssuredworkloadsV1ListWorkloadUpdatesResponse {
      ...
      workloadUpdates?: GoogleCloudAssuredworkloadsV1WorkloadUpdate[];
    }
    interface GoogleCloudAssuredworkloadsV1ManualCloudControlAssessmentDetails {
    ...
    interface GoogleCloudAssuredworkloadsV1OrgPolicyUpdate {
    ...
    interface GoogleCloudAssuredworkloadsV1RevertArchivedResourceEventsRequest {
    ...
    interface GoogleCloudAssuredworkloadsV1RevertArchivedResourceEventsResponse {
      /** The total number of events successfully moved to the original table. */
      movedEventsCount?: number;
    }
    interface GoogleCloudAssuredworkloadsV1Rule {
    ...
    interface GoogleCloudAssuredworkloadsV1SimilarControls {
      /** The ID of the control. */
      controlId?: string;
      /** The name of the framework. */
      framework?: string;
    }
    interface GoogleCloudAssuredworkloadsV1StringList {
      /** Required. The strings in the list. */
      values?: string[];
    }
    interface GoogleCloudAssuredworkloadsV1TargetResourceDetails {
    ...
    interface GoogleCloudAssuredworkloadsV1WorkloadWorkloadOptions {
    ...
    interface AssuredworkloadsResource {
      ...
      archiveResourceEvents(request: {
        ...
        uploadType?: string;
        /** Request body */
        resource: GoogleCloudAssuredworkloadsV1ArchiveResourceEventsRequest;
      }): Request<GoogleCloudAssuredworkloadsV1ArchiveResourceEventsResponse>;
      ...
      revertArchivedResourceEvents(request: {
        /** V1 error format. */
        '$.xgafv'?: '1' | '2';
        /** OAuth access token. */
        access_token?: string;
        ...
        uploadType?: string;
        /** Request body */
        resource: GoogleCloudAssuredworkloadsV1RevertArchivedResourceEventsRequest;
      }): Request<GoogleCloudAssuredworkloadsV1RevertArchivedResourceEventsResponse>;
    ...
    interface DbFindingSummariesResource {
      ...
      list(request?: {
        ...
        /** Legacy upload protocol for media (e.g. "media", "multipart"). */
        uploadType?: string;
      }): Request<GoogleCloudAssuredworkloadsV1ListDbFindingSummariesResponse>;
    }
    interface DbControlComplianceSummariesResource {
      ...
      list(request?: {
        ...
        /** Legacy upload protocol for media (e.g. "media", "multipart"). */
        uploadType?: string;
      }): Request<GoogleCloudAssuredworkloadsV1ListDbControlComplianceSummariesResponse>;
    }
    interface DbFrameworkComplianceReportsResource {
      ...
      aggregate(request?: {
        ...
        /** Legacy upload protocol for media (e.g. "media", "multipart"). */
        uploadType?: string;
      }): Request<GoogleCloudAssuredworkloadsV1AggregateDbFrameworkComplianceReportResponse>;
      ...
      fetch(request?: {
        ...
        /** Legacy upload protocol for media (e.g. "media", "multipart"). */
        uploadType?: string;
      }): Request<GoogleCloudAssuredworkloadsV1FetchDbFrameworkComplianceReportResponse>;
      dbControlComplianceSummaries: DbControlComplianceSummariesResource;
    }
    interface DbFrameworkComplianceSummariesResource {
      ...
      }): Request<GoogleCloudAssuredworkloadsV1ListDbFrameworkComplianceSummariesResponse>;
    }
    interface LocationsResource {
      dbFindingSummaries: DbFindingSummariesResource;
      dbFrameworkComplianceReports: DbFrameworkComplianceReportsResource;
      dbFrameworkComplianceSummaries: DbFrameworkComplianceSummariesResource;
    }
    ...
    interface UpdatesResource {
      ...
      apply(request: {
        ...
        uploadType?: string;
        /** Request body */
        resource: GoogleCloudAssuredworkloadsV1ApplyWorkloadUpdateRequest;
      }): Request<GoogleLongrunningOperation>;
      apply(
        request: {
          /** V1 error format. */
      ...
      list(request?: {
        ...
        /** Legacy upload protocol for media (e.g. "media", "multipart"). */
        uploadType?: string;
      }): Request<GoogleCloudAssuredworkloadsV1ListWorkloadUpdatesResponse>;
    }
    interface ViolationsResource {
      ...
      batchAcknowledgeViolations(request: {
        /** V1 error format. */
        '$.xgafv'?: '1' | '2';
        /** OAuth access token. */
        access_token?: string;
        ...
        uploadType?: string;
        /** Request body */
        resource: GoogleCloudAssuredworkloadsV1BatchAcknowledgeViolationsRequest;
      }): Request<GoogleCloudAssuredworkloadsV1BatchAcknowledgeViolationsResponse>;
    ...
    const assuredworkloads: AssuredworkloadsResource;
