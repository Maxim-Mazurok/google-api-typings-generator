...
declare namespace gapi.client {
    ...
    namespace classroom {
        interface Announcement {
            ...
            id?: string;
            /**
             * Identifiers of students with access to the announcement. This field is set only if `assigneeMode` is `INDIVIDUAL_STUDENTS`. If the `assigneeMode` is
             * `INDIVIDUAL_STUDENTS`, then only students specified in this field can see the announcement.
             */
        ...
        interface AssignmentSubmission {
            /**
             * Attachments added by the student. Drive files that correspond to materials with a share mode of STUDENT_COPY may not exist yet if the student has not
             * accessed the assignment in Classroom. Some attachment metadata is only populated if the requesting user has permission to access it. Identifier and
             * alternate_link fields are always available, but others (for example, title) may not be.
             */
        ...
        interface Course {
            ...
            creationTime?: string;
            /**
             * Optional description. For example, "We'll be learning about the structure of living creatures from a combination of textbooks, guest lectures, and lab
             * work. Expect to be excited!" If set, this field must be a valid UTF-8 string and no longer than 30,000 characters.
             */
            description?: string;
            /**
             * Optional heading for the description. For example, "Welcome to 10th Grade Biology." If set, this field must be a valid UTF-8 string and no longer than
             * 3600 characters.
             */
            ...
            /**
             * Identifier for this course assigned by Classroom. When creating a course, you may optionally set this identifier to an alias string in the request to
             * create a corresponding alias. The `id` is still assigned by Classroom and cannot be updated after the course is created. Specifying this field in a
            ...
            name?: string;
            /**
             * The identifier of the owner of a course. When specified as a parameter of a create course request, this field is required. The identifier can be one of
             * the following: &#42; the numeric identifier for the user &#42; the email address of the user &#42; the string literal `"me"`, indicating the requesting user This
             * must be set in a create request. Admins can also specify this field in a patch course request to transfer ownership. In other contexts, it is
             * read-only.
             */
            ownerId?: string;
            ...
            section?: string;
            /**
             * Information about a Drive Folder that is shared with all teachers of the course. This field will only be set for teachers of the course and domain
        ...
        interface CourseAlias {
            /**
             * Alias string. The format of the string indicates the desired alias scoping. &#42; `d:` indicates a domain-scoped alias. Example: `d:math_101` &#42; `p:`
             * indicates a project-scoped alias. Example: `p:abc123` This field has a maximum length of 256 characters.
             */
            alias?: string;
        }
        ...
        interface CourseWork {
            ...
            id?: string;
            /**
             * Identifiers of students with access to the coursework. This field is set only if `assigneeMode` is `INDIVIDUAL_STUDENTS`. If the `assigneeMode` is
             * `INDIVIDUAL_STUDENTS`, then only students specified in this field are assigned the coursework.
             */
            individualStudentsOptions?: IndividualStudentsOptions;
            ...
            maxPoints?: number;
            /**
             * Multiple choice question details. For read operations, this field is populated only when `work_type` is `MULTIPLE_CHOICE_QUESTION`. For write
             * operations, this field must be specified when creating course work with a `work_type` of `MULTIPLE_CHOICE_QUESTION`, and it must not be set otherwise.
             */
        ...
        interface Invitation {
            ...
            role?: string;
            /**
             * Identifier of the invited user. When specified as a parameter of a request, this identifier can be set to one of the following: &#42; the numeric
        ...
        interface Student {
            ...
            studentWorkFolder?: DriveFolder;
            /**
             * Identifier of the user. When specified as a parameter of a request, this identifier can be one of the following: &#42; the numeric identifier for the user
        ...
        interface StudentSubmission {
            ...
            alternateLink?: string;
            /**
             * Optional grade. If unset, no grade was set. This value must be non-negative. Decimal (that is, non-integer) values are allowed, but are rounded to two
            ...
            creationTime?: string;
            /**
             * Optional pending grade. If unset, no grade was set. This value must be non-negative. Decimal (that is, non-integer) values are allowed, but are rounded
             * to two decimal places. This is only visible to and modifiable by course teachers.
             */
            draftGrade?: number;
        ...
        interface Topic {
            ...
            courseId?: string;
            /**
             * The name of the topic, generated by the user. Leading and trailing whitespaces, if any, are trimmed. Also, multiple consecutive whitespaces are
             * collapsed into one inside the name. The result must be a non-empty string. Topic names are case sensitive, and must be no longer than 100 characters.
             */
            name?: string;
        ...
        interface UserProfile {
            ...
            photoUrl?: string;
            /**
             * Represents whether a G Suite for Education user's domain administrator has explicitly verified them as being a teacher. If the user is not a member of
        ...
        interface AliasesResource {
            ...
            list(request?: {
                ...
                oauth_token?: string;
                /**
                 * Maximum number of items to return. Zero or unspecified indicates that the server may assign a maximum. The server may return fewer than the specified
                 * number of results.
                 */
                pageSize?: number;
                /**
                 * nextPageToken value returned from a previous list call, indicating that the subsequent page of results should be returned. The list request must be
        ...
        interface AnnouncementsResource {
            ...
            list(request?: {
                 ...
                 * Supported direction keywords are `asc` and `desc`. If not specified, `updateTime desc` is the default behavior. Examples: `updateTime asc`,
                 * `updateTime`
                 */
                orderBy?: string;
                /**
            ...
            patch(request: {
                ...
                quotaUser?: string;
                /**
                 * Mask that identifies which fields on the announcement to update. This field is required to do an update. The update fails if invalid fields are
                 * specified. If a field supports empty values, it can be cleared by specifying it in the update mask and not in the Announcement object. If a field that
                 * does not support empty values is included in the update mask and not set in the Announcement object, an `INVALID_ARGUMENT` error is returned. The
                 * following fields may be specified by teachers: &#42; `text` &#42; `state` &#42; `scheduled_time`
                 */
                updateMask?: string;
                /** Upload protocol for media (e.g. "raw", "multipart"). */
                upload_protocol?: string;
        ...
        interface StudentSubmissionsResource {
            ...
            list(request?: {
                ...
                courseId: string;
                /**
                 * Identifier of the student work to request. This may be set to the string literal `"-"` to request student work for all course work in the specified
                 * course.
                 */
                courseWorkId: string;
                /** Selector specifying which fields to include in a partial response. */
                ...
                key?: string;
                /**
                 * Requested lateness value. If specified, returned student submissions are restricted by the requested value. If unspecified, submissions are returned
                ...
                uploadType?: string;
                /**
                 * Optional argument to restrict returned student work to those owned by the student with the specified identifier. The identifier can be one of the
                 * following: &#42; the numeric identifier for the user &#42; the email address of the user &#42; the string literal `"me"`, indicating the requesting user
                 */
                userId?: string;
            ...
            patch(request: {
                ...
                quotaUser?: string;
                /**
                 * Mask that identifies which fields on the student submission to update. This field is required to do an update. The update fails if invalid fields are
                 * specified. The following fields may be specified by teachers: &#42; `draft_grade` &#42; `assigned_grade`
                 */
                updateMask?: string;
                /** Upload protocol for media (e.g. "raw", "multipart"). */
                upload_protocol?: string;
            ...
            /**
             * Reclaims a student submission on behalf of the student that owns it. Reclaiming a student submission transfers ownership of attached Drive files to the
            ...
            /**
             * Returns a student submission. Returning a student submission transfers ownership of attached Drive files to the student and may also update the
        ...
        interface CourseWorkResource {
            ...
            list(request?: {
                ...
                courseId: string;
                /**
                 * Restriction on the work status to return. Only courseWork that matches is returned. If unspecified, items with a work status of `PUBLISHED` is
                 * returned.
                 */
                ...
                oauth_token?: string;
                /**
                 * Optional sort ordering for results. A comma-separated list of fields with an optional sort direction keyword. Supported fields are `updateTime` and
                 * `dueDate`. Supported direction keywords are `asc` and `desc`. If not specified, `updateTime desc` is the default behavior. Examples: `dueDate
            ...
            patch(request: {
                ...
                quotaUser?: string;
                /**
                 * Mask that identifies which fields on the course work to update. This field is required to do an update. The update fails if invalid fields are
                 * specified. If a field supports empty values, it can be cleared by specifying it in the update mask and not in the CourseWork object. If a field that
                 * does not support empty values is included in the update mask and not set in the CourseWork object, an `INVALID_ARGUMENT` error is returned. The
                 * following fields may be specified by teachers: &#42; `title` &#42; `description` &#42; `state` &#42; `due_date` &#42; `due_time` &#42; `max_points` &#42; `scheduled_time` &#42;
        ...
        interface StudentsResource {
            ...
            create(request: {
                ...
                courseId: string;
                /**
                 * Enrollment code of the course to create the student in. This code is required if userId corresponds to the requesting user; it may be omitted if the
            ...
            delete(request?: {
                ...
                uploadType?: string;
                /**
                 * Identifier of the student to delete. The identifier can be one of the following: &#42; the numeric identifier for the user &#42; the email address of the user
            ...
            get(request?: {
                ...
                uploadType?: string;
                /**
                 * Identifier of the student to return. The identifier can be one of the following: &#42; the numeric identifier for the user &#42; the email address of the user
                 * &#42; the string literal `"me"`, indicating the requesting user
                 */
                userId: string;
            }): Request<Student>;
        ...
        interface TeachersResource {
            ...
            delete(request?: {
                ...
                uploadType?: string;
                /**
                 * Identifier of the teacher to delete. The identifier can be one of the following: &#42; the numeric identifier for the user &#42; the email address of the user
                 * &#42; the string literal `"me"`, indicating the requesting user
                 */
                userId: string;
            }): Request<{}>;
            ...
            get(request?: {
                ...
                uploadType?: string;
                /**
                 * Identifier of the teacher to return. The identifier can be one of the following: &#42; the numeric identifier for the user &#42; the email address of the user
                 * &#42; the string literal `"me"`, indicating the requesting user
                 */
                userId: string;
            }): Request<Teacher>;
        ...
        interface TopicsResource {
            ...
            patch(request: {
                ...
                quotaUser?: string;
                /**
                 * Mask that identifies which fields on the topic to update. This field is required to do an update. The update fails if invalid fields are specified. If
                 * a field supports empty values, it can be cleared by specifying it in the update mask and not in the Topic object. If a field that does not support
                 * empty values is included in the update mask and not set in the Topic object, an `INVALID_ARGUMENT` error is returned. The following fields may be
                 * specified: &#42; `name`
                 */
                updateMask?: string;
                /** Upload protocol for media (e.g. "raw", "multipart"). */
        ...
        interface CoursesResource {
            ...
            list(request?: {
                ...
                quotaUser?: string;
                /**
                 * Restricts returned courses to those having a student with the specified identifier. The identifier can be one of the following: &#42; the numeric
                 * identifier for the user &#42; the email address of the user &#42; the string literal `"me"`, indicating the requesting user
                 */
                studentId?: string;
                /**
                 * Restricts returned courses to those having a teacher with the specified identifier. The identifier can be one of the following: &#42; the numeric
                 * identifier for the user &#42; the email address of the user &#42; the string literal `"me"`, indicating the requesting user
                 */
                teacherId?: string;
                /** Upload protocol for media (e.g. "raw", "multipart"). */
            ...
            patch(request: {
                ...
                quotaUser?: string;
                /**
                 * Mask that identifies which fields on the course to update. This field is required to do an update. The update will fail if invalid fields are
                 * specified. The following fields are valid: &#42; `name` &#42; `section` &#42; `descriptionHeading` &#42; `description` &#42; `room` &#42; `courseState` &#42; `ownerId` Note:
                 * patches to ownerId are treated as being effective immediately, but in practice it may take some time for the ownership transfer of all affected
                 * resources to complete. When set in a query parameter, this field should be specified as `updateMask=,,...`
                 */
                updateMask?: string;
                /** Upload protocol for media (e.g. "raw", "multipart"). */
                upload_protocol?: string;
        ...
        interface InvitationsResource {
            ...
            list(request?: {
                ...
                uploadType?: string;
                /**
                 * Restricts returned invitations to those for a specific user. The identifier can be one of the following: &#42; the numeric identifier for the user &#42; the
                 * email address of the user &#42; the string literal `"me"`, indicating the requesting user
                 */
                userId?: string;
        ...
        interface GuardianInvitationsResource {
            ...
            list(request?: {
                ...
                states?: string | string[];
                /**
                 * The ID of the student whose guardian invitations are to be returned. The identifier can be one of the following: &#42; the numeric identifier for the user
                 * &#42; the email address of the user &#42; the string literal `"me"`, indicating the requesting user &#42; the string literal `"-"`, indicating that results should
            ...
            patch(request: {
                ...
                studentId: string;
                /**
                 * Mask that identifies which fields on the course to update. This field is required to do an update. The update fails if invalid fields are specified.
                 * The following fields are valid: &#42; `state` When set in a query parameter, this field should be specified as `updateMask=,,...`
                 */
                updateMask?: string;
                /** Upload protocol for media (e.g. "raw", "multipart"). */
                upload_protocol?: string;
        ...
        interface GuardiansResource {
            ...
            delete(request?: {
                ...
                quotaUser?: string;
                /**
                 * The student whose guardian is to be deleted. One of the following: &#42; the numeric identifier for the user &#42; the email address of the user &#42; the string
            ...
            get(request?: {
                ...
                quotaUser?: string;
                /**
                 * The student whose guardian is being requested. One of the following: &#42; the numeric identifier for the user &#42; the email address of the user &#42; the string
                 * literal `"me"`, indicating the requesting user
                 */
                studentId: string;
                /** Upload protocol for media (e.g. "raw", "multipart"). */
            ...
            list(request?: {
                ...
                fields?: string;
                /**
                 * Filter results by the email address that the original invitation was sent to, resulting in this guardian link. This filter can only be used by domain
                 * administrators.
                 */
                invitedEmailAddress?: string;
                /** API key. Your API key identifies your project and provides you with API access, quota, and reports. Required unless you provide an OAuth 2.0 token. */
                ...
                quotaUser?: string;
                /**
                 * Filter results by the student who the guardian is linked to. The identifier can be one of the following: &#42; the numeric identifier for the user &#42; the
                 * email address of the user &#42; the string literal `"me"`, indicating the requesting user &#42; the string literal `"-"`, indicating that results should be
        ...
        interface UserProfilesResource {
            ...
            get(request?: {
                ...
                uploadType?: string;
                /**
                 * Identifier of the profile to return. The identifier can be one of the following: &#42; the numeric identifier for the user &#42; the email address of the user
                 * &#42; the string literal `"me"`, indicating the requesting user
                 */
                userId: string;
            }): Request<UserProfile>;
