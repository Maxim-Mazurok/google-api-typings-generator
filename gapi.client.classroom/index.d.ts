...
declare namespace gapi.client {
    ...
    namespace classroom {
        ...
        interface TeachersResource {
             ...
             * teacher of this course. * `FAILED_PRECONDITION` if the requested ID belongs to the owner of the course Drive folder. * `FAILED_PRECONDITION` if the course no longer has an active
             * owner.
             */
            delete(request?: {
                /** V1 error format. */
