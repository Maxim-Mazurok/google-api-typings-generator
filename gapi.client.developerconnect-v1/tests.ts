...
gapi.load('client', async () => {
  ...
  async function run() {
    ...
    await gapi.client.developerconnect.projects.locations.connections.processGitLabEnterpriseWebhook(
      {
        parent: 'Test string',
      },
      {
    ...
    await gapi.client.developerconnect.projects.locations.connections.processGitLabWebhook(
      {
        parent: 'Test string',
      },
      {
