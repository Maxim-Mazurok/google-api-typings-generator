...
gapi.load('client', async () => {
  ...
  async function run() {
    ...
    await gapi.client.notebooks.projects.locations.instances.checkAuthorization(
      {
        name: 'Test string',
      },
      {
    ...
    await gapi.client.notebooks.projects.locations.instances.generateAccessToken(
      {
        name: 'Test string',
      },
      {
