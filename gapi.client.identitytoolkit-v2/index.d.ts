...
declare namespace gapi.client {
    ...
    namespace identitytoolkit {
        ...
        interface GoogleCloudIdentitytoolkitAdminV2EmailPrivacyConfig {
            /**
             * Migrates the project to a state of improved email privacy. For example certain error codes are more generic to avoid giving away information on whether the account exists. In
        ...
        interface GoogleCloudIdentitytoolkitAdminV2PasskeyConfig {
        ...
        interface GoogleCloudIdentitytoolkitV2RecaptchaConfig {
            ...
            /**
             * The reCAPTCHA Enterprise key resource name, e.g. "projects/{project}/keys/{key}". This will only be returned when the reCAPTCHA enforcement state is AUDIT or ENFORCE on at least one
             * of the reCAPTCHA providers.
             */
            recaptchaKey?:
                string;
        }
        ...
        interface TenantsResource {
            ...
            getPasskeyConfig(request?: {
                ...
                uploadType?:
                    string;
            }): Request<GoogleCloudIdentitytoolkitAdminV2PasskeyConfig>;
            ...
            updatePasskeyConfig(request: {
                ...
                quotaUser?:
                    string;
                /**
                 * Optional. The update mask applies to the resource. Empty update mask will result in updating nothing. For the `FieldMask` definition, see
                 * https://developers.google.com/protocol-buffers/docs/reference/google.protobuf#fieldmask
                 */
                updateMask?:
                    string;
            ...
            body: GoogleCloudIdentitytoolkitAdminV2PasskeyConfig): Request<GoogleCloudIdentitytoolkitAdminV2PasskeyConfig>;
            defaultSupportedIdpConfigs:
