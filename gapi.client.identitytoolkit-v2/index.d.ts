...
declare namespace gapi.client {
  ...
  namespace identitytoolkit {
    ...
    interface GoogleCloudIdentitytoolkitAdminV2RecaptchaTollFraudManagedRule {
      /** The action taken if the reCAPTCHA score of a request is within the interval [start_score, end_score]. */
      action?: string;
      /** The start score (inclusive) for an action. A score of 0.0 indicates the safest request (likely legitimate), whereas 1.0 indicates the riskiest request (likely toll fraud). See https://cloud.google.com/recaptcha-enterprise/docs/sms-fraud-detection#create-assessment-sms. */
      startScore?: number;
    }
