...
gapi.load('client', async () => {
    ...
    async function run() {
        /**
         * Revokes a user's token from an Identity Provider (IdP). This is done by manually providing an IdP credential, and the token types for revocation. An [API
        ...
        await gapi.client.identitytoolkit.accounts.passkeyEnrollment.finalize({
        }, {
            authenticatorRegistrationResponse: {
                authenticatorAttestationResponse: {
                    attestationObject: "Test string",
                    clientDataJson: "Test string",
                    transports: [
                        "Test string"
                    ],
                },
        ...
        await gapi.client.identitytoolkit.accounts.passkeyEnrollment.start({
        }, {
            idToken: "Test string",
            tenantId: "Test string",
        });
        /** Verifies the passkey assertion and signs the user in. */
        await gapi.client.identitytoolkit.accounts.passkeySignIn.finalize({
        }, {
            authenticatorAuthenticationResponse: {
                authenticatorAssertionResponse: {
                    authenticatorData: "Test string",
                    clientDataJson: "Test string",
                    signature: "Test string",
                    userHandle: "Test string",
                },
                credentialId: "Test string",
                credentialType: "Test string",
            },
        ...
        await gapi.client.identitytoolkit.accounts.passkeySignIn.start({
        }, {
            sessionId: "Test string",
            tenantId: "Test string",
        });
