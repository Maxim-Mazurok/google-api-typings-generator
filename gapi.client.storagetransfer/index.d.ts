...
declare namespace gapi.client {
    ...
    namespace storagetransfer {
        ...
        interface AwsS3Data {
            ...
            path?: string;
            /**
             * Input only. The Amazon Resource Name (ARN) of the role to support temporary credentials via `AssumeRoleWithWebIdentity`. For more information about ARNs, see [IAM
