...
declare namespace gapi.client {
    ...
    namespace storagetransfer {
        ...
        interface TransferJob {
             ...
             * must start with `"transferJobs/"` prefix and end with a letter or a number, and should be no more than 128 characters. This name must not start with 'transferJobs/OPI'.
             * 'transferJobs/OPI' is a reserved prefix. Example: `"transferJobs/^(?!OPI)[A-Za-z0-9-._~]*[A-Za-z0-9]$"` Invalid job names fail with an INVALID_ARGUMENT error.
             */
            name?: string;
