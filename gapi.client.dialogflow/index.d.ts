...
declare namespace gapi.client {
    ...
    namespace dialogflow {
        ...
        interface GoogleCloudDialogflowCxV3beta1FormParameter {
            ...
            isList?: boolean;
            /**
             * Indicates whether the parameter content should be redacted in text and audio. If the flag is set to true, the parameter content will be replaced by parameter name in both request
             * and response. Note: the parameter content is subject to redaction if either parameter level redaction or entity type level redaction is enabled.
             */
            redact?: boolean;
            /**
