...
declare namespace gapi.client {
    ...
    namespace dialogflow {
        ...
        interface GoogleCloudDialogflowCxV3Experiment {
            ...
            endTime?: string;
            /**
             * LINT.IfChange(default_experiment_length) Maximum number of days to run the experiment/rollout. If auto-rollout is not enabled, default value and maximum will be 30 days. If
             * auto-rollout is enabled, default value and maximum will be 6 days. LINT.ThenChange(//depot/google3/cloud/ml/api/conversation/analytics/compute.cc:default_experiment_length)
             */
        ...
        interface GoogleCloudDialogflowCxV3SecuritySettings {
            ...
            displayName?: string;
            /**
             * Optional. Controls conversation exporting settings to Insights after conversation is completed. If retention_strategy is set to REMOVE_AFTER_CONVERSATION, Insights export is
             ...
             * will have one of the following formats: `projects//inspectTemplates/` OR `projects//locations//inspectTemplates/` OR `organizations//inspectTemplates/`
             */
        ...
        interface FlowsResource {
            ...
            /**
             * Imports the specified flow to the specified agent from a binary file. Note: You should always train a flow prior to sending it queries. See the [training
             * documentation](https://cloud.google.com/dialogflow/cx/docs/concept/training).
             */
            import(request: {
                /** V1 error format. */
            ...
            body: GoogleCloudDialogflowCxV3Flow): Request<GoogleCloudDialogflowCxV3Flow>;
            /**
             * Trains the specified flow. Note that only the flow in 'draft' environment is trained. Note: You should always train a flow prior to sending it queries. See the [training
             * documentation](https://cloud.google.com/dialogflow/cx/docs/concept/training).
             */
            train(request: {
                /** V1 error format. */
        ...
        interface AgentsResource {
             ...
             * removed. Note: You should always train flows prior to sending them queries. See the [training documentation](https://cloud.google.com/dialogflow/cx/docs/concept/training).
             */
            restore(request: {
                /** V1 error format. */
                "$.xgafv"?: string;
