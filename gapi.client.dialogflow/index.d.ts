...
declare namespace gapi.client {
    ...
    namespace dialogflow {
        ...
        interface GoogleCloudDialogflowCxV3beta1Page {
             ...
             * intent specified. * TransitionRoutes defined in flow with intent specified. * TransitionRoutes defined in the page with only condition specified. * TransitionRoutes defined in the
