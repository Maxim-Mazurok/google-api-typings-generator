...
declare namespace gapi.client {
    ...
    namespace dialogflow {
        interface GoogleCloudDialogflowCxV3Agent {
            ...
            avatarUri?: string;
            /**
             * Immutable. The default language of the agent as a language tag. See [Language Support](https://cloud.google.com/dialogflow/cx/docs/reference/language) for a list of the currently
        ...
        interface GoogleCloudDialogflowCxV3QueryParameters {
            ...
            /**
             * The unique identifier of the page to override the current page in the session. Format: `projects//locations//agents//pages/`. If `current_page` is specified, the previous state of
             * the session will be ignored by Dialogflow, including the previous page and the previous session parameters. In most cases, current_page and parameters should be configured together
             * to direct a session to a specific state.
             */
            currentPage?: string;
        ...
        interface PagesResource {
            ...
            get(request?: {
                 ...
                 * language is used. [Many languages](https://cloud.google.com/dialogflow/cx/docs/reference/language) are supported. Note: languages must be enabled in the agent before they can be
                 * used.
                 */
                languageCode?: string;
        ...
        interface FlowsResource {
            ...
            create(request: {
                 ...
                 * the agent's default language is used. [Many languages](https://cloud.google.com/dialogflow/cx/docs/reference/language) are supported. Note: languages must be enabled in the
