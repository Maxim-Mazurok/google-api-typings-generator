    ...
    namespace dialogflow {
        ...
        interface SessionsResource {
            ...
            detectIntent(request: {
                 ...
                 * more information, see the [API interactions guide](https://cloud.google.com/dialogflow/docs/api-overview). Note: Always use agent versions for production traffic. See [Versions
