# TypeScript typings for NetApp API v1beta1
...
{
  "compilerOptions": {
    "types": ["gapi", "gapi.auth2", "gapi.client", "gapi.client.netapp-v1beta1"]
  }
}
```
...
var client_id = '',
  scope = [
    // See, edit, configure, and delete your Google Cloud NetApp data and see the email address for your Google Account
...
For provenance information see [Provenance section on NPM](https://www.npmjs.com/package/@maxim_mazurok/gapi.client.netapp-v1beta1#Provenance:~:text=none-,Provenance,-Built%20and%20signed)
