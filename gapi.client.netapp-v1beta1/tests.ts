/* This is stub file for gapi.client.netapp-v1beta1 definition tests */
// IMPORTANT
  ...
  async function run() {
    ...
    await gapi.client.netapp.projects.locations.backupVaults.backups.create(
      ...
      },
      {
        ...
        name: 'Test string',
        ontapSource: {
          snapshotUuid: 'Test string',
          storagePool: 'Test string',
          volumeUuid: 'Test string',
        },
        satisfiesPzi: true,
        satisfiesPzs: true,
    ...
    await gapi.client.netapp.projects.locations.storagePools.restoreVolume(
      {
        name: 'Test string',
      },
      {
    ...
    await gapi.client.netapp.projects.locations.storagePools.updateBackupConfig(
      {
        name: 'Test string',
      },
      {
    ...
    await gapi.client.netapp.projects.locations.storagePools.backupConfigs.list(
      {
        filter: 'Test string',
        orderBy: 'Test string',
        pageSize: 42,
    ...
    await gapi.client.netapp.projects.locations.storagePools.ontap.executeOntapDelete(
      {
        ontapPath: 'Test string',
      },
    );
    /** `ExecuteOntapGet` sends the ONTAP `GET` request to the `StoragePool` cluster. */
    await gapi.client.netapp.projects.locations.storagePools.ontap.executeOntapGet(
      {
        ontapPath: 'Test string',
      },
    );
    /** `ExecuteOntapPatch` sends the ONTAP `PATCH` request to the `StoragePool` cluster. */
    await gapi.client.netapp.projects.locations.storagePools.ontap.executeOntapPatch(
      {
        ontapPath: 'Test string',
      },
      {
    ...
    await gapi.client.netapp.projects.locations.storagePools.ontap.executeOntapPost(
      {
        ontapPath: 'Test string',
      },
      {
    ...
    await gapi.client.netapp.projects.locations.volumes.create(
      ...
      },
      {
        ...
        capacityGib: 'Test string',
        cloneDetails: {
          sharedSpaceGib: 'Test string',
          sourceSnapshot: 'Test string',
          sourceVolume: 'Test string',
          splitState: 'Test string',
        },
    ...
    await gapi.client.netapp.projects.locations.volumes.getSplitStatus({
      name: 'Test string',
    });
    ...
    await gapi.client.netapp.projects.locations.volumes.startSplit(
      {
        name: 'Test string',
      },
      {},
