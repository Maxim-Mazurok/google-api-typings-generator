...
declare namespace gapi.client {
  ...
  namespace netapp {
    ...
    interface ExecuteOntapDeleteResponse {
      /** The raw `JSON` body of the response. */
      body?: {[P in string]: any};
    }
    interface ExecuteOntapGetResponse {
      /** The raw `JSON` body of the response. */
      body?: {[P in string]: any};
    }
    interface ExecuteOntapPatchRequest {
    ...
    interface ExecuteOntapPatchResponse {
      /** The raw `JSON` body of the response. */
      body?: {[P in string]: any};
    }
    interface ExecuteOntapPostRequest {
      /** Required. The raw `JSON` body of the request. The body should be in the format of the ONTAP resource. For example: ``` { "body": { "field1": "value1", "field2": "value2", } } ``` */
      body?: {[P in string]: any};
    }
    interface ExecuteOntapPostResponse {
      /** The raw `JSON` body of the response. */
      body?: {[P in string]: any};
    }
    ...
    interface LocationMetadata {
      ...
      flexPerformanceTier?: 'FLEX_PERFORMANCE_TIER_UNSPECIFIED' | 'LIMITED';
    ...
    interface RestoreVolumeRequest {
    ...
    interface TieringPolicy {
      ...
      tierAction?: 'TIER_ACTION_UNSPECIFIED' | 'ENABLED' | 'PAUSED';
    }
    ...
    interface Volume {
      ...
      restrictedActions?: 'RESTRICTED_ACTION_UNSPECIFIED' | 'DELETE'[];
    ...
    interface BackupConfigsResource {
      ...
      list(request?: {
        ...
        /** Legacy upload protocol for media (e.g. "media", "multipart"). */
        uploadType?: string;
      }): Request<ListBackupConfigsResponse>;
    }
    interface OntapResource {
      /** `ExecuteOntapDelete` sends the ONTAP `DELETE` request to the `StoragePool` cluster. */
      executeOntapDelete(request?: {
        /** V1 error format. */
        '$.xgafv'?: '1' | '2';
        /** OAuth access token. */
        access_token?: string;
      ...
      executeOntapPatch(request: {
        ...
        uploadType?: string;
        /** Request body */
        resource: ExecuteOntapPatchRequest;
      }): Request<ExecuteOntapPatchResponse>;
      executeOntapPatch(
        request: {
          /** V1 error format. */
          '$.xgafv'?: '1' | '2';
      ...
      executeOntapPost(request: {
        ...
        uploadType?: string;
        /** Request body */
        resource: ExecuteOntapPostRequest;
      }): Request<ExecuteOntapPostResponse>;
      executeOntapPost(
        request: {
          /** V1 error format. */
          '$.xgafv'?: '1' | '2';
    ...
    interface StoragePoolsResource {
      ...
      updateBackupConfig(request: {
        ...
        uploadType?: string;
        /** Request body */
        resource: UpdateBackupConfigRequest;
      }): Request<Operation>;
      updateBackupConfig(
        request: {
          /** V1 error format. */
      ...
      backupConfigs: BackupConfigsResource;
      ontap: OntapResource;
    }
