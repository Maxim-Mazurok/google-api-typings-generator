...
gapi.load('client', async () => {
  ...
  async function run() {
    ...
    await gapi.client.cloudidentity.allowlistedDomains.delete({
      name: 'Test string',
    });
    /** Retrieves a specific domain from the allowlist. */
    await gapi.client.cloudidentity.allowlistedDomains.get({
      name: 'Test string',
    });
      ...
      },
      {
        ...
        endpointVerificationSpecificAttributes: {
          ...
          browserAttributes: [
            {
              chromeBrowserInfo: {
                browserManagementState: 'Test string',
                browserVersion: 'Test string',
                isBuiltInDnsClientEnabled: true,
                isBulkDataEntryAnalysisEnabled: true,
                isChromeCleanupEnabled: true,
                isChromeRemoteDesktopAppBlocked: true,
                isFileDownloadAnalysisEnabled: true,
                isFileUploadAnalysisEnabled: true,
                isRealtimeUrlCheckEnabled: true,
                isSecurityEventAnalysisEnabled: true,
                isSiteIsolationEnabled: true,
                isThirdPartyBlockingEnabled: true,
                passwordProtectionWarningTrigger: 'Test string',
                safeBrowsingProtectionLevel: 'Test string',
              },
              chromeProfileId: 'Test string',
              lastProfileSyncTime: 'Test string',
            },
          ],
    ...
    await gapi.client.cloudidentity.inboundOidcSsoProfiles.create(
      {},
      {
        ...
        rpConfig: {
          ...
          redirectUris: ['Test string'],
        },
      },
    );
    /** Deletes an InboundOidcSsoProfile. */
    await gapi.client.cloudidentity.inboundOidcSsoProfiles.delete({
      name: 'Test string',
    });
    /** Gets an InboundOidcSsoProfile. */
    await gapi.client.cloudidentity.inboundOidcSsoProfiles.get({
      name: 'Test string',
    });
    ...
    await gapi.client.cloudidentity.inboundOidcSsoProfiles.patch(
      {
        name: 'Test string',
        updateMask: 'Test string',
      },
    ...
    await gapi.client.cloudidentity.inboundSsoAssignments.create(
      {},
      {
        ...
        name: 'Test string',
        oidcSsoInfo: {
          inboundOidcSsoProfile: 'Test string',
        },
        rank: 42,
        samlSsoInfo: {
    ...
    /** Delete a policy. */
    await gapi.client.cloudidentity.policies.delete({
      name: 'Test string',
    });
    /** Get a policy. */
    ...
    /** Update a policy. */
    await gapi.client.cloudidentity.policies.patch(
      {
        name: 'Test string',
      },
      {
