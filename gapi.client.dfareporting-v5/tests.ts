/* This is stub file for gapi.client.dfareporting-v5 definition tests */
// IMPORTANT
  ...
  async function run() {
    ...
    await gapi.client.dfareporting.floodlightActivities.insert(
      ...
      },
      {
        ...
        conversionCategory: 'Test string',
    ...
    await gapi.client.dfareporting.placements.generatetags({
      ...
      'tagProperties.dcDbmMacroIncluded': true,
      'tagProperties.gppMacrosIncluded': true,
      'tagProperties.tcfGdprMacrosIncluded': true,
    });
    ...
    await gapi.client.dfareporting.reportData.query(
      {
        profileId: 'Test string',
      },
      {
