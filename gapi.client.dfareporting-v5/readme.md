# TypeScript typings for Campaign Manager 360 API v5
...
gapi.client.load('dfareporting', 'v5', () => {
  // now we can use:
  // gapi.client.dfareporting
});
```
...
For provenance information see [Provenance section on NPM](https://www.npmjs.com/package/@maxim_mazurok/gapi.client.dfareporting-v5#Provenance:~:text=none-,Provenance,-Built%20and%20signed)
