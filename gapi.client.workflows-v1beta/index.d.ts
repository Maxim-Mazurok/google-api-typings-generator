/* Type definitions for non-npm package Workflows API v1beta 0.0 */
...
declare namespace gapi.client {
    ...
    function load(urlOrObject: "https://workflows.googleapis.com/$discovery/rest?version=v1beta"): Promise<void>;
    /** @deprecated Please load APIs with discovery documents. */
    function load(name: "workflows", version: "v1beta"): Promise<void>;
    /** @deprecated Please load APIs with discovery documents. */
