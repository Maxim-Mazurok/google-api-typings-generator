...
gapi.load('client', async () => {
  ...
  async function run() {
      ...
      },
      {
        ...
        condition: {
          dockerVersionSupportedCondition: {
            ...
            toolVersionSupportState: 'Test string',
          },
        ...
        toolVersions: {
          ...
          kpt: 'Test string',
          kubectl: 'Test string',
          kustomize: 'Test string',
          skaffold: 'Test string',
        },
        uid: 'Test string',
      },
    );
    ...
    /** Gets the access control policy for a resource. Returns an empty policy if the resource exists and does not have a policy set. */
    await gapi.client.clouddeploy.projects.locations.deployPolicies.getIamPolicy(
      {
        'options.requestedPolicyVersion': 42,
        resource: 'Test string',
      },
