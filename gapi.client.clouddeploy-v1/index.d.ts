...
declare namespace gapi.client {
  ...
  namespace clouddeploy {
    ...
    interface AlertPolicyCheckStatus {
      ...
      failedAlertPolicies?: FailedAlertPolicy[];
    ...
    interface DeployPolicyEvaluationEvent {
      ...
      invoker?: 'INVOKER_UNSPECIFIED' | 'USER' | 'DEPLOY_AUTOMATION';
    ...
    interface RepairRolloutRule {
      ...
      repairPhases?: RepairPhaseConfig[];
    }
    interface Retry {
    ...
    interface Target {
      ...
      associatedEntities?: {[P in string]: AssociatedEntities};
    ...
    interface TimedPromoteReleaseRule {
      /** Output only. Information around the state of the Automation rule. */
      condition?: AutomationRuleCondition;
