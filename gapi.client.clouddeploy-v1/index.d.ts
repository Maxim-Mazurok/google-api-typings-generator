...
declare namespace gapi.client {
  ...
  namespace clouddeploy {
    ...
    interface CustomTargetTypeNotificationEvent {
    ...
    interface DeliveryPipelineAttribute {
      /** ID of the `DeliveryPipeline`. The value of this field could be one of the following: * The last segment of a pipeline name. It only needs the ID to determine which pipeline is being referred to * "*", all delivery pipelines in a location. */
      id?: string;
    ...
    interface DeployPolicyEvaluationEvent {
    ...
    interface ListDeployPoliciesResponse {
    ...
    interface PolicyRule {
      ...
      restrictRollouts?: RestrictRollout;
    }
    ...
    interface RolloutsResource {
      ...
      create(request: {
        ...
        oauth_token?: string;
        /** Optional. Deploy policies to override. Format is `projects/{project}/locations/{location}/deployPolicies/{deployPolicy}`. */
        overrideDeployPolicy?: string | string[];
    ...
    interface DeployPoliciesResource {
      ...
      list(request?: {
        ...
        /** Legacy upload protocol for media (e.g. "media", "multipart"). */
        uploadType?: string;
      }): Request<ListDeployPoliciesResponse>;
    ...
    interface LocationsResource {
      ...
      deployPolicies: DeployPoliciesResource;
