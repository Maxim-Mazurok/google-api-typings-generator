...
declare namespace gapi.client {
    ...
    namespace reseller {
        ...
        interface Seats {
             ...
             * `numberOfSeats` value regardless of how many of these user licenses are assigned. *Note: *G Suite subscriptions automatically assign a license to every user.
             */
        ...
        interface Subscription {
            ...
            transferInfo?: {
                /**
                 * Sku id of the current resold subscription. This is populated only when customer has subscription with legacy sku and the subscription resource is populated with recommeded sku
                 * for transfer in.
                 */
        ...
        interface CustomersResource {
            /**
             * Get a customer account. Use this operation to see a customer account already in your reseller management, or to see the minimal account information for an existing customer that you
             * do not manage. For more information about the API response for existing customers, see [retrieving a customer account](/admin-sdk/reseller/v1/how-tos/manage_customers#get_customer).
             */
            get(request?: {
                /** V1 error format. */
                "$.xgafv"?: string;
                ...
                callback?: string;
                /**
                 * Either the customer's primary domain name or the customer's unique identifier. If using the domain name, we do not recommend using a `customerId` as a key for persistent data.
                 * If the domain name for a `customerId` is changed, the Google system automatically updates.
                 */
                customerId: string;
            ...
            /**
             * Order a new customer's account. Before ordering a new customer account, establish whether the customer account already exists using the
        ...
        interface SubscriptionsResource {
            ...
            /**
             * Update a subscription plan. Use this method to update a plan for a 30-day trial or a flexible plan subscription to an annual commitment plan with monthly or yearly payments. How a
            ...
            /**
             * Update a user license's renewal settings. This is applicable for accounts with annual commitment plans only. For more information, see the description in [manage
            ...
            /**
             * Update a subscription's user license settings. For more information about updating an annual commitment plan or a flexible plan subscription’s licenses, see [Manage
            ...
            /**
             * Create or transfer a subscription. Create a subscription for a customer's account that you ordered using the [Order a new customer
            ...
            /**
             * List of subscriptions managed by the reseller. The list can be all subscriptions, all of a customer's subscriptions, or all of a customer's transferable subscriptions. Optionally,
