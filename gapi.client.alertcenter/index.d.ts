...
declare namespace gapi.client {
    ...
    namespace alertcenter {
        interface GoogleAppsAlertcenterTypeAccountWarning {
             ...
             */
            loginDetails?: GoogleAppsAlertcenterTypeAccountWarningLoginDetails;
        }
        interface GoogleAppsAlertcenterTypeAccountWarningLoginDetails {
        ...
        interface GoogleAppsAlertcenterTypeActivityRule {
        ...
        interface GoogleAppsAlertcenterTypeAppMakerSqlSetupNotification {
            /** List of applications with requests for default SQL set up. */
            requestInfo?: GoogleAppsAlertcenterTypeAppMakerSqlSetupNotificationRequestInfo[];
        }
        interface GoogleAppsAlertcenterTypeAppMakerSqlSetupNotificationRequestInfo {
        ...
        interface GoogleAppsAlertcenterTypeAttachment {
            /** A CSV file attachment. */
            csv?: GoogleAppsAlertcenterTypeAttachmentCsv;
        }
        interface GoogleAppsAlertcenterTypeAttachmentCsv {
            /** The list of data rows in a CSV file, as string arrays rather than as a single comma-separated string. */
            dataRows?: GoogleAppsAlertcenterTypeAttachmentCsvCsvRow[];
            /** The list of headers for data columns in a CSV file. */
            headers?: string[];
        }
        interface GoogleAppsAlertcenterTypeAttachmentCsvCsvRow {
            /** The data entries in a CSV file row, as a string array rather than a single comma-separated string. */
            entries?: string[];
        }
        interface GoogleAppsAlertcenterTypeBadWhitelist {
            /** The domain ID. */
            domainId?: GoogleAppsAlertcenterTypeDomainId;
            /** The entity whose actions triggered a Gmail phishing alert. */
            maliciousEntity?: GoogleAppsAlertcenterTypeMaliciousEntity;
            /** The list of messages contained by this alert. */
            messages?: GoogleAppsAlertcenterTypeGmailMessageInfo[];
            /** The source IP address of the malicious email, for example, `127.0.0.1`. */
            sourceIp?: string;
        }
        interface GoogleAppsAlertcenterTypeDeviceCompromised {
            /** The email of the user this alert was created for. */
            email?: string;
            /** Required. The list of security events. */
            events?: GoogleAppsAlertcenterTypeDeviceCompromisedDeviceCompromisedSecurityDetail[];
        }
        interface GoogleAppsAlertcenterTypeDeviceCompromisedDeviceCompromisedSecurityDetail {
        ...
        interface GoogleAppsAlertcenterTypeDlpRuleViolation {
            /**
             ...
             */
            ruleViolationInfo?: GoogleAppsAlertcenterTypeRuleViolationInfo;
        }
        interface GoogleAppsAlertcenterTypeDomainId {
            /** The primary domain for the customer. */
            customerPrimaryDomain?: string;
        }
        interface GoogleAppsAlertcenterTypeDomainWideTakeoutInitiated {
            /** The email of the admin who initiated the takeout. */
            email?: string;
            /** The takeout request ID. */
            takeoutRequestId?: string;
        }
        interface GoogleAppsAlertcenterTypeGmailMessageInfo {
        ...
        interface GoogleAppsAlertcenterTypeGoogleOperations {
            ...
            attachmentData?: GoogleAppsAlertcenterTypeAttachment;
        ...
        interface GoogleAppsAlertcenterTypeMailPhishing {
            /** The domain ID. */
            domainId?: GoogleAppsAlertcenterTypeDomainId;
        ...
        interface GoogleAppsAlertcenterTypeMaliciousEntity {
            /** The header from display name. */
            displayName?: string;
            /** The actor who triggered a gmail phishing alert. */
            entity?: GoogleAppsAlertcenterTypeUser;
            /** The sender email address. */
            fromHeader?: string;
        }
        interface GoogleAppsAlertcenterTypePhishingSpike {
            /** The domain ID. */
            domainId?: GoogleAppsAlertcenterTypeDomainId;
            /** If `true`, the email originated from within the organization. */
            isInternal?: boolean;
        ...
        interface GoogleAppsAlertcenterTypeRuleViolationInfo {
            /** Source of the data. */
            dataSource?: string;
            /** List of matches that were found in the resource content. */
            matchInfo?: GoogleAppsAlertcenterTypeRuleViolationInfoMatchInfo[];
            /**
            ...
            resourceInfo?: GoogleAppsAlertcenterTypeRuleViolationInfoResourceInfo;
            /** Details of the violated rule. */
            ruleInfo?: GoogleAppsAlertcenterTypeRuleViolationInfoRuleInfo;
        ...
        interface GoogleAppsAlertcenterTypeRuleViolationInfoActionInfo {
        }
        interface GoogleAppsAlertcenterTypeRuleViolationInfoMatchInfo {
            /** For matched detector predefined by Google. */
            predefinedDetector?: GoogleAppsAlertcenterTypeRuleViolationInfoMatchInfoPredefinedDetectorInfo;
            /** For matched detector defined by administrators. */
            userDefinedDetector?: GoogleAppsAlertcenterTypeRuleViolationInfoMatchInfoUserDefinedDetectorInfo;
        }
        interface GoogleAppsAlertcenterTypeRuleViolationInfoMatchInfoPredefinedDetectorInfo {
            /** Name that uniquely identifies the detector. */
            detectorName?: string;
        }
        interface GoogleAppsAlertcenterTypeRuleViolationInfoMatchInfoUserDefinedDetectorInfo {
            /** Display name of the detector. */
            displayName?: string;
            /** Resource name that uniquely identifies the detector. */
            resourceName?: string;
        }
        interface GoogleAppsAlertcenterTypeRuleViolationInfoResourceInfo {
            /** Drive file ID. */
            documentId?: string;
            /** Title of the resource, for example email subject, or document title. */
            resourceTitle?: string;
        }
        interface GoogleAppsAlertcenterTypeRuleViolationInfoRuleInfo {
            /** User provided name of the rule. */
            displayName?: string;
            /** Resource name that uniquely identifies the rule. */
            resourceName?: string;
        }
        interface GoogleAppsAlertcenterTypeStateSponsoredAttack {
            /** The email of the user this incident was created for. */
            email?: string;
        }
        interface GoogleAppsAlertcenterTypeSuspiciousActivity {
            /** The email of the user this alert was created for. */
            email?: string;
            /** Required. The list of security events. */
            events?: GoogleAppsAlertcenterTypeSuspiciousActivitySuspiciousActivitySecurityDetail[];
        }
        interface GoogleAppsAlertcenterTypeSuspiciousActivitySuspiciousActivitySecurityDetail {
            /** Required. The device ID. */
            deviceId?: string;
            /** The model of the device. */
            deviceModel?: string;
        ...
        interface GoogleAppsAlertcenterTypeUser {
            /** Display name of the user. */
            displayName?: string;
            /** Email address of the user. */
            emailAddress?: string;
        }
        interface GoogleAppsAlertcenterV1beta1Alert {
            ...
            metadata?: GoogleAppsAlertcenterV1beta1AlertMetadata;
        ...
        interface GoogleAppsAlertcenterV1beta1AlertFeedback {
        ...
        interface GoogleAppsAlertcenterV1beta1AlertMetadata {
            /** Output only. The alert identifier. */
            alertId?: string;
        ...
        interface GoogleAppsAlertcenterV1beta1BatchDeleteAlertsRequest {
        ...
        interface GoogleAppsAlertcenterV1beta1BatchDeleteAlertsResponse {
            /** The status details for each failed alert_id. */
            failedAlertStatus?: { [P in string]: GoogleRpcStatus };
            /** The successful list of alert IDs. */
            successAlertIds?: string[];
        }
        interface GoogleAppsAlertcenterV1beta1BatchUndeleteAlertsRequest {
            /** Required. list of alert IDs. */
            alertId?: string[];
            /** Optional. The unique identifier of the Google Workspace organization account of the customer the alerts are associated with. */
            customerId?: string;
        }
        interface GoogleAppsAlertcenterV1beta1BatchUndeleteAlertsResponse {
            /** The status details for each failed alert_id. */
            failedAlertStatus?: { [P in string]: GoogleRpcStatus };
            /** The successful list of alert IDs. */
            successAlertIds?: string[];
        }
        interface GoogleAppsAlertcenterV1beta1ListAlertFeedbackResponse {
            /** The list of alert feedback. Feedback entries for each alert are ordered by creation time descending. */
            feedback?: GoogleAppsAlertcenterV1beta1AlertFeedback[];
        }
        interface GoogleAppsAlertcenterV1beta1ListAlertsResponse {
            /** The list of alerts. */
            alerts?: GoogleAppsAlertcenterV1beta1Alert[];
            /**
        ...
        interface GoogleAppsAlertcenterV1beta1Settings {
            /** The list of notifications. */
            notifications?: GoogleAppsAlertcenterV1beta1SettingsNotification[];
        }
        interface GoogleAppsAlertcenterV1beta1SettingsNotification {
            /** A Google Cloud Pub/sub topic destination. */
            cloudPubsubTopic?: GoogleAppsAlertcenterV1beta1SettingsNotificationCloudPubsubTopic;
        }
        interface GoogleAppsAlertcenterV1beta1SettingsNotificationCloudPubsubTopic {
        ...
        interface GoogleAppsAlertcenterV1beta1UndeleteAlertRequest {
        ...
        interface FeedbackResource {
            ...
            create(request: {
                ...
                uploadType?: string;
                /** Request body */
                resource: GoogleAppsAlertcenterV1beta1AlertFeedback;
            }): Request<GoogleAppsAlertcenterV1beta1AlertFeedback>;
            create(request: {
                /** V1 error format. */
                "$.xgafv"?: string;
                /** OAuth access token. */
            ...
            body: GoogleAppsAlertcenterV1beta1AlertFeedback): Request<GoogleAppsAlertcenterV1beta1AlertFeedback>;
            ...
            list(request?: {
                ...
                /** Legacy upload protocol for media (e.g. "media", "multipart"). */
                uploadType?: string;
            }): Request<GoogleAppsAlertcenterV1beta1ListAlertFeedbackResponse>;
        }
        interface AlertsResource {
            ...
            batchDelete(request: {
                ...
                uploadType?: string;
                /** Request body */
                resource: GoogleAppsAlertcenterV1beta1BatchDeleteAlertsRequest;
            }): Request<GoogleAppsAlertcenterV1beta1BatchDeleteAlertsResponse>;
            batchDelete(request: {
                /** V1 error format. */
                "$.xgafv"?: string;
                /** OAuth access token. */
            ...
            body: GoogleAppsAlertcenterV1beta1BatchDeleteAlertsRequest): Request<GoogleAppsAlertcenterV1beta1BatchDeleteAlertsResponse>;
            ...
            batchUndelete(request: {
                ...
                uploadType?: string;
                /** Request body */
                resource: GoogleAppsAlertcenterV1beta1BatchUndeleteAlertsRequest;
            }): Request<GoogleAppsAlertcenterV1beta1BatchUndeleteAlertsResponse>;
            batchUndelete(request: {
                /** V1 error format. */
                "$.xgafv"?: string;
                /** OAuth access token. */
            ...
            body: GoogleAppsAlertcenterV1beta1BatchUndeleteAlertsRequest): Request<GoogleAppsAlertcenterV1beta1BatchUndeleteAlertsResponse>;
            /**
            ...
            get(request?: {
                ...
                /** Legacy upload protocol for media (e.g. "media", "multipart"). */
                uploadType?: string;
            }): Request<GoogleAppsAlertcenterV1beta1Alert>;
            ...
            getMetadata(request?: {
                ...
                /** Legacy upload protocol for media (e.g. "media", "multipart"). */
                uploadType?: string;
            }): Request<GoogleAppsAlertcenterV1beta1AlertMetadata>;
            /** Lists the alerts. */
            list(request?: {
                /** V1 error format. */
                "$.xgafv"?: string;
                ...
                /** Legacy upload protocol for media (e.g. "media", "multipart"). */
                uploadType?: string;
            }): Request<GoogleAppsAlertcenterV1beta1ListAlertsResponse>;
            /**
            ...
            undelete(request: {
                ...
                uploadType?: string;
                /** Request body */
                resource: GoogleAppsAlertcenterV1beta1UndeleteAlertRequest;
            }): Request<GoogleAppsAlertcenterV1beta1Alert>;
            undelete(request: {
                /** V1 error format. */
                "$.xgafv"?: string;
            ...
            body: GoogleAppsAlertcenterV1beta1UndeleteAlertRequest): Request<GoogleAppsAlertcenterV1beta1Alert>;
        ...
        interface V1beta1Resource {
            ...
            getSettings(request?: {
                ...
                /** Legacy upload protocol for media (e.g. "media", "multipart"). */
                uploadType?: string;
            }): Request<GoogleAppsAlertcenterV1beta1Settings>;
            ...
            updateSettings(request: {
                ...
                uploadType?: string;
                /** Request body */
                resource: GoogleAppsAlertcenterV1beta1Settings;
            }): Request<GoogleAppsAlertcenterV1beta1Settings>;
            updateSettings(request: {
                /** V1 error format. */
                "$.xgafv"?: string;
            ...
            body: GoogleAppsAlertcenterV1beta1Settings): Request<GoogleAppsAlertcenterV1beta1Settings>;
        }
