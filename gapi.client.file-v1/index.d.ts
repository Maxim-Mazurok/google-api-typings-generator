...
declare namespace gapi.client {
    ...
    function load(urlOrObject: "https://file.googleapis.com/$discovery/rest?version=v1"): Promise<void>;
    ...
    namespace file {
        ...
        interface BackupsResource {
            ...
            create(request: {
                ...
                oauth_token?: string;
                /**
                 * Required. The backup's project and location, in the format `projects/{project_number}/locations/{location}`. In Filestore, backup locations map to Google Cloud regions, for
                 * example **us-west1**.
                 */
                parent: string;
            ...
            list(request?: {
                 ...
                 * to Google Cloud regions, for example **us-west1**. To retrieve backup information for all locations, use "-" for the `{location}` value.
                 */
                parent: string;
                /** Returns response with indentations and line breaks. */
                prettyPrint?: boolean;
