/* This is stub file for gapi.client.firebaserules-v1 definition tests */
// IMPORTANT
...
gapi.load('client', async () => {
    ...
    await gapi.client.load('https://firebaserules.googleapis.com/$discovery/rest?version=v1');
