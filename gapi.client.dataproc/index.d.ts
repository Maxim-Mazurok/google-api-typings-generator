...
declare namespace gapi.client {
    ...
    namespace dataproc {
        ...
        interface ClusterConfig {
            ...
            /**
             * Optional. BETA. The Kubernetes Engine config for Dataproc clusters deployed to Kubernetes. Setting this is considered mutually exclusive with Compute Engine-based options such as
             * gce_cluster_config, master_config, worker_config, secondary_worker_config, and autoscaling_config.
             */
        ...
        interface Policy {
             ...
             * member.The bindings in a Policy can refer to up to 1,500 members; up to 250 of these members can be Google groups. Each occurrence of a member counts towards these limits. For
             * example, if the bindings grant 50 different roles to user:alice@example.com, and not to any other member, then you can add another 1,450 members to the bindings in the Policy.
             */
            bindings?: Binding[];
            /**
