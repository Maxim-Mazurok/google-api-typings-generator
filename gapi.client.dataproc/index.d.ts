...
declare namespace gapi.client {
    ...
    namespace dataproc {
        ...
        interface GceClusterConfig {
             ...
             * (https://cloud.google.com/dataproc/docs/concepts/configuring-clusters/service-accounts#service_accounts_in_cloud_dataproc) (also see VM Data Plane
             * identity (https://cloud.google.com/dataproc/docs/concepts/iam/dataproc-principals#vm_service_account_data_plane_identity)) used by Dataproc cluster VM
             * instances to access Google Cloud Platform services.If not specified, the Compute Engine default service account
        ...
        interface SoftwareConfig {
             ...
             * (https://cloud.google.com/dataproc/docs/concepts/versioning/dataproc-versions#supported_cloud_dataproc_versions), such as "1.2" (including a subminor
