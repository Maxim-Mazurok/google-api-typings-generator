...
declare namespace gapi.client {
    ...
    namespace dataproc {
        ...
        interface GkeNodeConfig {
            ...
            /**
             * Optional. The Customer Managed Encryption Key (CMEK) (https://cloud.google.com/compute/docs/disks/customer-managed-encryption) used to encrypt the boot disk attached to each node in
             * the node pool. Specify the key using the following format: projects/KEY_PROJECT_ID /locations/LOCATION/keyRings/RING_NAME/cryptoKeys/KEY_NAME.
             */
