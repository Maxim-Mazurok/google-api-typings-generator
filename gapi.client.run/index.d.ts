...
declare namespace gapi.client {
    ...
    namespace run {
        ...
        interface ResourceRequirements {
            ...
            /**
             * (Optional) Only memory and CPU are supported. Note: The only supported values for CPU are '1', '2', and '4'. Requests describes the minimum amount of compute resources required. If
        ...
        interface SecretVolumeSource {
            /**
             * Integer representation of mode bits to use on created files by default. Must be a value between 01 and 0777 (octal). If 0 or not set, it will default to 0644. Directories within the
