...
declare namespace gapi.client {
    ...
    namespace run {
        ...
        interface ConfigurationSpec {
             ...
             * connections for the revision, use the "run.googleapis.com/cloudsql-instances" annotation key. To set a Serverless VPC Access connector for the revision, use the
             * "run.googleapis.com/vpc-access-connector" annotation key. Values should be comma separated.
             */
