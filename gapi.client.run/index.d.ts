...
declare namespace gapi.client {
    ...
    namespace run {
        interface GoogleCloudRunOpV2BinaryAuthorization {
            /**
        ...
        interface GoogleCloudRunOpV2CloudSqlInstance {
            /**
        ...
        interface GoogleCloudRunOpV2Condition {
        ...
        interface GoogleCloudRunOpV2Container {
            /**
             ...
             */
            ports?: GoogleCloudRunOpV2ContainerPort[];
            /** Compute Resource requirements by this container. More info: https://kubernetes.io/docs/concepts/storage/persistent-volumes#resources */
            resources?: GoogleCloudRunOpV2ResourceRequirements;
            /** Volume to mount into the container's filesystem. */
            volumeMounts?: GoogleCloudRunOpV2VolumeMount[];
        }
        interface GoogleCloudRunOpV2ContainerPort {
            /** Port number the container listens on. This must be a valid TCP port number, 0 < container_port < 65536. */
            containerPort?: number;
            /** If specified, used to specify which protocol to use. Allowed values are "http1" and "h2c". */
            name?: string;
        }
        interface GoogleCloudRunOpV2ContainerStatus {
        ...
        interface GoogleCloudRunOpV2EnvVar {
            ...
            valueSource?: GoogleCloudRunOpV2EnvVarSource;
        }
        interface GoogleCloudRunOpV2EnvVarSource {
            /** Selects a secret and a specific version from Cloud Secret Manager. */
            secretKeyRef?: GoogleCloudRunOpV2SecretKeySelector;
        }
        interface GoogleCloudRunOpV2ListRevisionsResponse {
            /** A token indicating there are more items than page_size. Use it in the next ListRevisions request to continue. */
            nextPageToken?: string;
            /** The resulting list of Revisions. */
            revisions?: GoogleCloudRunOpV2Revision[];
        }
        interface GoogleCloudRunOpV2ListServicesResponse {
            /** A token indicating there are more items than page_size. Use it in the next ListServices request to continue. */
            nextPageToken?: string;
            /** The resulting list of Services. */
            services?: GoogleCloudRunOpV2Service[];
        }
        interface GoogleCloudRunOpV2ResourceRequirements {
        ...
        interface GoogleCloudRunOpV2Revision {
             ...
             * defined at [Google Cloud Platform Launch Stages](http://cloud.google.com/terms/launch-stages).
             */
            launchStage?: string;
            ...
            scaling?: GoogleCloudRunOpV2RevisionScaling;
            ...
            volumes?: GoogleCloudRunOpV2Volume[];
            ...
            vpcAccess?: GoogleCloudRunOpV2VpcAccess;
        }
        interface GoogleCloudRunOpV2RevisionScaling {
            /** Maximum number of serving instances that this resource should have. */
            maxInstanceCount?: number;
            /** Minimum number of serving instances that this resource should have. */
            minInstanceCount?: number;
        }
        interface GoogleCloudRunOpV2RevisionTemplate {
            /** KRM-style annotations for the resource. */
            annotations?: { [P in string]: string };
        ...
        interface GoogleCloudRunOpV2SecretKeySelector {
            /**
        ...
        interface GoogleCloudRunOpV2SecretVolumeSource {
            /**
             ...
             */
            items?: GoogleCloudRunOpV2VersionToPath[];
            /**
        ...
        interface GoogleCloudRunOpV2Service {
            /**
            ...
            binaryAuthorization?: GoogleCloudRunOpV2BinaryAuthorization;
            ...
            /**
             * The launch stage as defined by [Google Cloud Platform Launch Stages](http://cloud.google.com/terms/launch-stages). Cloud Run supports `ALPHA`, `BETA`, and `GA`. If no value is
            ...
            template?: GoogleCloudRunOpV2RevisionTemplate;
            /**
             ...
             */
            terminalCondition?: GoogleCloudRunOpV2Condition;
            /**
             ...
             * Revision.
             */
            traffic?: GoogleCloudRunOpV2TrafficTarget[];
            ...
            trafficStatuses?: GoogleCloudRunOpV2TrafficTargetStatus[];
        ...
        interface GoogleCloudRunOpV2TrafficTarget {
        ...
        interface GoogleCloudRunOpV2TrafficTargetStatus {
        ...
        interface GoogleCloudRunOpV2VersionToPath {
            /**
        ...
        interface GoogleCloudRunOpV2Volume {
            /**
             ...
             * SQL and Cloud Run.
             */
            cloudSqlInstance?: GoogleCloudRunOpV2CloudSqlInstance;
            /** Required. Volume's name. */
            name?: string;
            /** Secret represents a secret that should populate this volume. More info: https://kubernetes.io/docs/concepts/storage/volumes#secret */
            secret?: GoogleCloudRunOpV2SecretVolumeSource;
        }
        interface GoogleCloudRunOpV2VolumeMount {
            /**
        ...
        interface GoogleCloudRunOpV2VpcAccess {
        ...
        interface RevisionsResource {
            ...
            get(request?: {
                ...
                /** Legacy upload protocol for media (e.g. "media", "multipart"). */
                uploadType?: string;
            }): Request<GoogleCloudRunOpV2Revision>;
            ...
            list(request?: {
                ...
                /** Legacy upload protocol for media (e.g. "media", "multipart"). */
                uploadType?: string;
            }): Request<GoogleCloudRunOpV2ListRevisionsResponse>;
        }
        interface ServicesResource {
            ...
            create(request: {
                ...
                validateOnly?: boolean;
                /** Request body */
                resource: GoogleCloudRunOpV2Service;
            }): Request<GoogleLongrunningOperation>;
            create(request: {
                /** V1 error format. */
                "$.xgafv"?: string;
            ...
            body: GoogleCloudRunOpV2Service): Request<GoogleLongrunningOperation>;
            ...
            get(request?: {
                ...
                /** Legacy upload protocol for media (e.g. "media", "multipart"). */
                uploadType?: string;
            }): Request<GoogleCloudRunOpV2Service>;
            ...
            list(request?: {
                ...
                /** Legacy upload protocol for media (e.g. "media", "multipart"). */
                uploadType?: string;
            }): Request<GoogleCloudRunOpV2ListServicesResponse>;
            /** Updates a Service. */
            patch(request: {
                /** V1 error format. */
                "$.xgafv"?: string;
