...
declare namespace gapi.client {
    ...
    namespace translate {
        ...
        interface BatchTranslateDocumentRequest {
             ...
             * Supported file format conversion includes: - `application/pdf` to `application/vnd.openxmlformats-officedocument.wordprocessingml.document` If nothing specified, output files will
             * be in the same format as the original file.
             */
            formatConversions?:
                { [P in string]: string };
