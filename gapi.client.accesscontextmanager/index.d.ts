...
declare namespace gapi.client {
    ...
    namespace accesscontextmanager {
        ...
        interface EgressTo {
            /**
             * A list of external resources that are allowed to be accessed. A request matches if it contains an external resource in this list (Example: s3://bucket/path). Currently '*' is not
             * allowed.
             */
