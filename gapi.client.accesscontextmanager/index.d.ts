...
declare namespace gapi.client {
    ...
    namespace accesscontextmanager {
        ...
        interface EgressTo {
            ...
            /**
             * A list of resources, currently only projects in the form `projects/`, that match this to stanza. A request matches if it contains a resource in this list. If `*` is specified for
             * resources, then this EgressTo rule will authorize access to all resources outside the perimeter.
             */
            resources?: string[];
        }
        // tslint:disable-next-line:no-empty-interface
        ...
        interface IngressSource {
             ...
             * calls with request origins within the perimeter. Example: `accessPolicies/MY_POLICY/accessLevels/MY_LEVEL`. If `*` is specified, then all IngressSources will be allowed.
             */
            accessLevel?: string;
            /**
        ...
        interface IngressTo {
             ...
             * IngressFrom. A request matches if it contains a resource in this list. If `*` is specified for resources, then this IngressTo rule will authorize access to all resources inside the
