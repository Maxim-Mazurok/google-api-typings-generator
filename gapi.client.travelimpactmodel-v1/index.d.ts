...
declare namespace gapi.client {
    ...
    namespace travelimpactmodel {
        ...
        interface FlightWithEmissions {
             ...
             * ComputeFlightEmissions. Note this field is currently equivalent to ttw_emissions_grams_per_pax until TIM version 1.X.0 which will update this to be total wtw emissions aka
