  ...
  async function run() {
    ...
    await gapi.client.cloudsupport.cases.create(
      ...
      },
      {
        ...
        state: 'Test string',
        subscriberEmailAddresses: ['Test string'],
        testCase: true,
    ...
    await gapi.client.cloudsupport.cases.attachments.get({
      name: 'Test string',
    });
    ...
    await gapi.client.cloudsupport.cases.comments.get({
      name: 'Test string',
    });
    ...
    await gapi.client.cloudsupport.organizations.supportEventSubscriptions.create(
      {
        parent: 'Test string',
      },
      {
    ...
    await gapi.client.cloudsupport.organizations.supportEventSubscriptions.delete(
      {
        name: 'Test string',
      },
    );
    ...
    await gapi.client.cloudsupport.organizations.supportEventSubscriptions.expunge(
      {
        name: 'Test string',
      },
      {},
    ...
    await gapi.client.cloudsupport.organizations.supportEventSubscriptions.get({
      name: 'Test string',
    });
    ...
    await gapi.client.cloudsupport.organizations.supportEventSubscriptions.list(
      {
        filter: 'Test string',
        pageSize: 42,
        pageToken: 'Test string',
    ...
    await gapi.client.cloudsupport.organizations.supportEventSubscriptions.patch(
      {
        name: 'Test string',
        updateMask: 'Test string',
      },
    ...
    await gapi.client.cloudsupport.organizations.supportEventSubscriptions.undelete(
      {
        name: 'Test string',
      },
      {},
