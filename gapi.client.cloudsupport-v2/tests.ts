...
gapi.load('client', async () => {
  ...
  async function run() {
    ...
    await gapi.client.cloudsupport.supportEventSubscriptions.delete({
      name: 'Test string',
    });
    /** Gets a support event subscription. */
    await gapi.client.cloudsupport.supportEventSubscriptions.get({
      name: 'Test string',
    });
    ...
    await gapi.client.cloudsupport.supportEventSubscriptions.patch(
      {
        name: 'Test string',
        updateMask: 'Test string',
      },
