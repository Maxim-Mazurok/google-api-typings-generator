...
declare namespace gapi.client {
  ...
  function load(
    urlOrObject: 'https://cloudsupport.googleapis.com/$discovery/rest?version=v2beta'
  ): Promise<void>;
  ...
  namespace cloudsupport {
    ...
    interface EmailMessage {
      ...
      actor?: Actor;
      /** Output only. The full email message body in both plaintext and richtext. The plaintext field of body_content will be elided in a best-effort attempt to remove extraneous reply threads. */
    ...
    interface TextContent {
      /** Content in this field should be rendered and interpreted as-is. If not provided on input, then rich_text must be provided and this field will contain the plain text extracted from the rich_text input. */
      plainText?: string;
      /** Content in this field should be rendered and interpreted as HTML. If not provided on input, then plain_text must be provided and this field will contain the escaped plain text content. Only a subset of HTML tags and styles are allowed on input, all other tags will be stripped/sanitized. Output will always contain safe and valid HTML. */
      richText?: string;
    }
