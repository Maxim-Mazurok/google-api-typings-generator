// Type definitions for non-npm package Google Play Game Services API v1 1.0
...
declare namespace gapi.client {
    ...
    namespace games {
        ...
        interface RoomsResource {
            ...
            body: RoomJoinRequest): Request<Room>;
            ...
            body: RoomP2PStatuses): Request<RoomStatus>;
        }
        ...
        interface TurnBasedMatchesResource {
            ...
            create(request: {
                ...
                userIp?: string;
                /** Request body */
                resource: TurnBasedMatchCreateRequest;
            ...
            finish(request: {
                ...
                userIp?: string;
                /** Request body */
                resource: TurnBasedMatchResults;
            }): Request<TurnBasedMatch>;
            finish(request: {
                /** Data format for the response. */
                alt?: string;
            ...
            body: TurnBasedMatchTurn): Request<TurnBasedMatch>;
        }
        ...
        const pushtokens: PushtokensResource;
        ...
        const turnBasedMatches: TurnBasedMatchesResource;
    }
}
