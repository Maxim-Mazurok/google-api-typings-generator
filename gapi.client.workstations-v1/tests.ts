  ...
  async function run() {
    ...
    await gapi.client.workstations.projects.locations.workstationClusters.create(
      ...
      },
      {
        ...
        workstationAuthorizationUrl: 'Test string',
        workstationLaunchUrl: 'Test string',
      },
    );
    ...
    await gapi.client.workstations.projects.locations.workstationClusters.workstationConfigs.create(
      ...
      },
      {
        ...
        etag: 'Test string',
        grantWorkstationAdminRoleOnCreate: true,
        host: {
          gceInstance: {
            accelerators: [
              {
        ...
        idleAction: 'Test string',
        idleTimeout: 'Test string',
        labels: {
          A: 'Test string',
        },
        maxUsableWorkstations: 42,
        name: 'Test string',
        persistentDirectories: [
          {
            gceHd: {
              archiveTimeout: 'Test string',
              maxSizeGb: 42,
    ...
    await gapi.client.workstations.projects.locations.workstationClusters.workstationConfigs.workstations.suspend(
      {
        name: 'Test string',
      },
      {
