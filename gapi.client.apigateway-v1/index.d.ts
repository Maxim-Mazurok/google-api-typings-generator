...
declare namespace gapi.client {
  ...
  function load(
    urlOrObject: 'https://apigateway.googleapis.com/$discovery/rest?version=v1',
  ): Promise<void>;
  /** @deprecated Please load APIs with discovery documents. */
  function load(name: 'apigateway', version: 'v1'): Promise<void>;
  /** @deprecated Please load APIs with discovery documents. */
  ...
  namespace apigateway {
    ...
    interface ApigatewayGateway {
      ...
      streamingMode?: 'STREAMING_MODE_UNSPECIFIED' | 'STREAMING_MODE_ENABLED';
      /** Output only. Updated time. */
      updateTime?: string;
    }
