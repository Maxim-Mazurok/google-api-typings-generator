...
declare namespace gapi.client {
    ...
    namespace gkebackup {
        ...
        interface Backup {
             ...
             * must be >= delete_lock_days. Once a Backup is created, this value may only be increased. Defaults to the parent BackupPlan's backup_retain_days value.
             */
            retainDays?: number;
        ...
        interface RetentionPolicy {
             ...
             * field does NOT affect existing Backups under it. Backups created AFTER a successful update will automatically pick up the new value. NOTE: backup_retain_days must be >=
        ...
        interface Schedule {
            /**
             * A standard [cron](https://wikipedia.com/wiki/cron) string that defines a repeating schedule for creating Backups via this BackupPlan. Default (empty): no automatic backup creation
             * will occur.
             */
            cronSchedule?: string;
