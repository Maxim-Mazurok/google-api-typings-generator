...
declare namespace gapi.client {
    ...
    namespace gkebackup {
        ...
        interface Backup {
             ...
             * days provided (measured from the creation time of the Backup). This value is inherited from the parent BackupPlan's retention_policy.backup_delete_lock_days value and may only be
             * increased (either at creation time or in a subsequent update). This field MUST be an integer value between 0-90 (inclusive). Default: inherited from BackupPlan.
             */
             ...
             * systems are expected to put that etag in the request to `UpdateBackup` to ensure that their change will be applied to the same version.
             */
            etag?: string;
            ...
            /**
             * The age (in days) after which this Backup will be automatically deleted. If not specified at Backup creation time, this value is inherited from the parent BackupPlan's
             * retention_policy.backup_retain_days value. Once a Backup is created, this value may only be increased. This must be an integer value >= 0. If 0, no automatic deletion will occur for
             * this Backup. If not 0, this must be >= delete_lock_days. Default: inherited from BackupPlan.
             */
            retainDays?: number;
        ...
        interface BackupPlan {
            ...
            /**
             * Required. Immutable. The source cluster from which Backups will be created via this BackupPlan. Possible formats: 1. projects/*‍/locations/*‍/clusters/* 2.
            ...
            createTime?: string;
            /**
             * This flag indicates whether this BackupPlan has been deactivated. Setting this field to True locks the BackupPlan such that no further updates will be allowed, including the
             * deactivated field. It also prevents any new Backups from being created via this BackupPlan (including scheduled Backups). Default: False
             */
            deactivated?: boolean;
             ...
             * `GetBackupPlan`, and systems are expected to put that etag in the request to `UpdateBackupPlan` to ensure that their change will be applied to the same version.
             */
            etag?: string;
            /** A set of custom labels supplied by user. */
            labels?: { [P in string]: string };
            /** Output only. [Output Only] The full name of the BackupPlan resource. Format: projects/*‍/locations/*‍/backupPlans/* */
            name?: string;
        ...
        interface ClusterMetadata {
            ...
            /**
             * The source cluster from which this Backup was created. Possible formats: 1. projects/*‍/locations/*‍/clusters/* 2. projects/*‍/zones/*‍/clusters/* This will be the same value as the
        ...
        interface ListBackupsResponse {
            ...
            backups?: Backup[];
            /**
             * A token which may be sent as `page_token` in a subsequent `ListBackups` call to retrieve the next page of results. If this field is omitted or empty, then there are no more results
             * to return.
             */
            nextPageToken?: string;
        }
        ...
        interface Restore {
            /**
             * Required. Immutable. The Backup used as the source from which this Restore will restore. Note that this Backup must be a sub-resource of the RestorePlan's backup_plan. Format:
             * projects/*‍/locations/*‍/backupPlans/*‍/backups/*.
             */
            backup?: string;
            /**
             * Output only. The target cluster into which this Restore will restore data. Possible formats: 1. projects/*‍/locations/*‍/clusters/* 2. projects/*‍/zones/*‍/clusters/* Inherited from
             * parent RestorePlan's cluster field.
             */
            cluster?: string;
             ...
             * and systems are expected to put that etag in the request to `UpdateRestore` to ensure that their change will be applied to the same version.
             */
            etag?: string;
            /** GCP Labels. */
            labels?: { [P in string]: string };
        ...
        interface RestoreConfig {
             ...
             * NAMESPACED_RESOURCE_RESTORE_MODE_UNSPECIFIED if any namespaced restoration is configured via namespaced_resource_restore_scope .
             */
        ...
        interface RestorePlan {
            /** Required. Immutable. The BackupPlan from which Backups may be used as the source for Restores created via this RestorePlan. Format: projects/*‍/locations/*‍/backupPlans/*. */
            backupPlan?: string;
            /**
             * Required. Immutable. The target cluster into which Restores created via this RestorePlan will restore data. NOTE: the cluster's region must be the same as the RestorePlan. Possible
             ...
             * `GetRestorePlan`, and systems are expected to put that etag in the request to `UpdateRestorePlan` to ensure that their change will be applied to the same version.
             */
            etag?: string;
            /** A set of custom labels supplied by user. */
            labels?: { [P in string]: string };
            /** Output only. [Output Only] The full name of the RestorePlan resource. Format: projects/*‍/locations/*‍/restorePlans/* */
            name?: string;
        ...
        interface RetentionPolicy {
            ...
            /**
             * The default maximum age of a Backup created via this BackupPlan. This field MUST be an integer value >= 0. If specified, a Backup created under this BackupPlan will be automatically
             * deleted after its age reaches create_time + backup_retain_days. If not specified, Backups created under this BackupPlan will NOT be subject to automatic deletion. Updating this
             * field does NOT affect existing Backups under it. Backups created AFTER a successful update will automatically pick up the new value. NOTE: Specifying a backup_retain_days smaller
             * than backup_delete_lock_days at creation/updating time will be considered as invalid, and the request will be rejected immediately. Default: 0 (no automatic deletion)
             */
        ...
        interface VolumeBackup {
            /**
             * Output only. [Output Only] The timestamp when the associated underlying volume backup operation completes - can be converted to and from
             ...
             * that systems make use of the `etag` in the read-modify-write cycle to perform volume backup updates in order to avoid race conditions: An `etag` is returned in the response to
             * `GetVolumeBackup', and systems are expected to put that etag in the request to `UpdateVolumeBackup` to ensure that their change will be applied to the same version.
             */
            etag?: string;
            /** Output only. The format used for the volume backup. */
            format?: string;
            /**
             * Output only. [Output Only] The full name of the VolumeBackup resource. Format: projects/*‍/locations/*‍/backupPlans/*‍/backups/*‍/volumeBackups/* Note that the last segment of the
             * name will have the format: 'pvc-'.
             */
            name?: string;
            ...
            updateTime?: string;
            /**
             * Output only. A storage system-specific opaque handle to the underlying volume backup. This field is interpreted by the volume backup and restore drivers running in the GKE cluster
             * and not by the service.
             */
        ...
        interface VolumeRestore {
             ...
             * suggested that systems make use of the `etag` in the read-modify-write cycle to perform volume restore updates in order to avoid race conditions: An `etag` is returned in the
             * response to `GetVolumeRestore', and systems are expected to put that etag in the request to `UpdateVolumeRestore` to ensure that their change will be applied to the same version.
             */
            etag?: string;
            /**
             * Output only. Full name of the VolumeRestore resource. Format: projects/*‍/locations/*‍/restorePlans/*‍/restores/*‍/volumeRestores/* Note that the last segment of the name will have
             * the format: 'pvc-'.
             */
            name?: string;
            ...
            volumeBackup?: string;
            /**
             * Output only. A storage system-specific opaque handler to the underlying volume created for the target PVC from the volume backup. This field is interpreted by the volume backup and
             * restore drivers running in the GKE cluster and not by the service.
             */
            volumeHandle?: string;
        ...
        interface BackupsResource {
            ...
            create(request: {
                ...
                alt?: string;
                /**
                 * The client-provided short name for the Backup resource. This name must: a. be between 1 and 63 characters long (inclusive) b. consist of only lower-case ASCII letters, numbers,
                 * and dashes c. start with a lower-case letter d. end with a lower-case letter or number e. be unique within the set of Backups in this BackupPlan
                 */
                backupId?: string;
                /** JSONP */
                callback?: string;
        ...
        interface BackupPlansResource {
            ...
            create(request: {
                ...
                alt?: string;
                /**
                 * Required. The client-provided short name for the BackupPlan resource. This name must: a. be between 1 and 63 characters long (inclusive) b. consist of only lower-case ASCII
                 * letters, numbers, and dashes c. start with a lower-case letter d. end with a lower-case letter or number e. be unique within the set of BackupPlans in this location
                 */
                backupPlanId?: string;
                /** JSONP */
                callback?: string;
        ...
        interface RestoresResource {
            ...
            create(request: {
                ...
                quotaUser?: string;
                /**
                 * Required. The client-provided short name for the Restore resource. This name must: a. be between 1 and 63 characters long (inclusive) b. consist of only lower-case ASCII
                 * letters, numbers, and dashes c. start with a lower-case letter d. end with a lower-case letter or number e. be unique within the set of Restores in this RestorePlan.
                 */
                restoreId?: string;
                /** Upload protocol for media (e.g. "raw", "multipart"). */
                upload_protocol?: string;
        ...
        interface RestorePlansResource {
            ...
            create(request: {
                ...
                quotaUser?: string;
                /**
                 * Required. The client-provided short name for the RestorePlan resource. This name must: a. be between 1 and 63 characters long (inclusive) b. consist of only lower-case ASCII
                 * letters, numbers, and dashes c. start with a lower-case letter d. end with a lower-case letter or number e. be unique within the set of RestorePlans in this location
                 */
