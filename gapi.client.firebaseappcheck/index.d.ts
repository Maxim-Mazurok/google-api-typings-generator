...
declare namespace gapi.client {
    ...
    function load(name: "firebaseappcheck", version: "v1beta"): PromiseLike<void>;
    function load(name: "firebaseappcheck", version: "v1beta", callback: () => any): void;

    namespace firebaseappcheck {
        interface GoogleFirebaseAppcheckV1betaAppAttestChallengeResponse {
            /** A one time use challenge for the client to pass to Apple's App Attest API. */
            challenge?: string;
            /**
             * The duration from the time this challenge is minted until it is expired. This field is intended to ease client-side token management, since the device may have clock skew, but is
             * still able to accurately measure a duration. This expiration is intended to minimize the replay window within which a single challenge may be reused. See AIP 142 for naming of this
             * field.
             */
            ttl?: string;
        }
        ...
        interface GoogleFirebaseAppcheckV1betaDebugToken {
            ...
            name?: string;
            /**
             * Input only. Immutable. The secret token itself. Must be provided during creation, and must be a UUID4, case insensitive. This field is immutable once set, and cannot be provided
             * during an UpdateDebugToken request. You can, however, delete this debug token using DeleteDebugToken to revoke it. For security reasons, this field will never be populated in any
             * response.
             */
            token?: string;
        }
        ...
        interface GoogleFirebaseAppcheckV1betaExchangeAppAttestAttestationRequest {
            /** The App Attest statement as returned by Apple's client-side App Attest API. This is the CBOR object returned by Apple, which will be Base64 encoded in the JSON API. */
        ...
        interface GoogleFirebaseAppcheckV1betaExchangeDeviceCheckTokenRequest {
            /**
             * The `device_token` as returned by Apple's client-side [DeviceCheck API](https://developer.apple.com/documentation/devicecheck/dcdevice). This is the Base64 encoded `Data` (Swift) or
             * `NSData` (ObjC) object.
             */
            deviceToken?: string;
        }
        ...
        interface GoogleFirebaseAppcheckV1betaUpdateServiceRequest {
             ...
             * Firebase) * `firebasedatabase.googleapis.com` (Firebase Realtime Database)
             */
        ...
        interface AppsResource {
            /**
             * Accepts a AppAttest Artifact and Assertion, and uses the developer's preconfigured auth token to verify the token with Apple. Returns an AttestationToken with the App ID as
             * specified by the `app` field included as attested claims.
             */
            ...
            }): Request<GoogleFirebaseAppcheckV1betaAttestationTokenResponse>;
            exchangeAppAttestAssertion(request: {
                /** V1 error format. */
                "$.xgafv"?: string;
                /** OAuth access token. */
            ...
            body: GoogleFirebaseAppcheckV1betaExchangeAppAttestAssertionRequest): Request<GoogleFirebaseAppcheckV1betaAttestationTokenResponse>;
            /**
             * Accepts a AppAttest CBOR Attestation, and uses the developer's preconfigured team and bundle IDs to verify the token with Apple. Returns an Attestation Artifact that can later be
             * exchanged for an AttestationToken in ExchangeAppAttestAssertion.
             */
            ...
            body: GoogleFirebaseAppcheckV1betaExchangeCustomTokenRequest): Request<GoogleFirebaseAppcheckV1betaAttestationTokenResponse>;
            /**
             * Validates a debug token secret that you have previously created using CreateDebugToken. If valid, returns an App Check token encapsulated in an AttestationTokenResponse. Note that a
             * restrictive quota is enforced on this method to prevent accidental exposure of the app to abuse.
             */
            ...
            body: GoogleFirebaseAppcheckV1betaExchangeDebugTokenRequest): Request<GoogleFirebaseAppcheckV1betaAttestationTokenResponse>;
            /**
             * Accepts a [`device_token`](https://developer.apple.com/documentation/devicecheck/dcdevice) issued by DeviceCheck, and attempts to validate it with Apple. If valid, returns an App
             * Check token encapsulated in an AttestationTokenResponse.
             */
            ...
            body: GoogleFirebaseAppcheckV1betaExchangeDeviceCheckTokenRequest): Request<GoogleFirebaseAppcheckV1betaAttestationTokenResponse>;
            ...
            body: GoogleFirebaseAppcheckV1betaExchangeRecaptchaTokenRequest): Request<GoogleFirebaseAppcheckV1betaAttestationTokenResponse>;
            /**
             * Validates a [SafetyNet token](https://developer.android.com/training/safetynet/attestation#request-attestation-step). If valid, returns an App Check token encapsulated in an
            ...
            body: GoogleFirebaseAppcheckV1betaExchangeSafetyNetTokenRequest): Request<GoogleFirebaseAppcheckV1betaAttestationTokenResponse>;
            ...
            }): Request<GoogleFirebaseAppcheckV1betaAppAttestChallengeResponse>;
            generateAppAttestChallenge(request: {
                /** V1 error format. */
                "$.xgafv"?: string;
                /** OAuth access token. */
            ...
            body: GoogleFirebaseAppcheckV1betaGenerateAppAttestChallengeRequest): Request<GoogleFirebaseAppcheckV1betaAppAttestChallengeResponse>;
