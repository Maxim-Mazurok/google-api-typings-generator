...
declare namespace gapi.client {
    ...
    namespace firebaseappcheck {
        ...
        interface AppsResource {
             ...
             * for an AttestationTokenResponse using ExchangeAppAttestAssertion. For convenience and performance, this method's response object will also contain an App Check token encapsulated in
