...
declare namespace gapi.client {
    ...
    namespace firebaseappcheck {
        ...
        interface AppsResource {
            /**
             * Accepts an App Attest assertion and an artifact previously obtained from ExchangeAppAttestAttestation and verifies those with Apple. If valid, returns an App Check token
            ...
            /**
             * Accepts an App Attest CBOR attestation and verifies it with Apple using the developer's preconfigured team and bundle IDs. If valid, returns an attestation artifact that can later
             * be exchanged for an AttestationTokenResponse using ExchangeAppAttestAssertion. For convenience and performance, this method's response object will also contain an App Check token
             * encapsulated in an AttestationTokenResponse (if the verification is successful).
             */
            ...
            body: GoogleFirebaseAppcheckV1betaExchangeRecaptchaEnterpriseTokenRequest): Request<GoogleFirebaseAppcheckV1betaAttestationTokenResponse>;
