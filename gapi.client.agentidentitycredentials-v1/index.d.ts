/* Type definitions for non-npm package Agent Identity Credentials API v1 0.0 */
...
// Generated from: https://agentidentitycredentials.googleapis.com/$discovery/rest?version=v1
// Revision: 20260717

/// <reference types="gapi.client" />

declare namespace gapi.client {
  /** Load Agent Identity Credentials API v1 */
  function load(
    urlOrObject: 'https://agentidentitycredentials.googleapis.com/$discovery/rest?version=v1',
  ): Promise<void>;
  /** @deprecated Please load APIs with discovery documents. */
  function load(name: 'agentidentitycredentials', version: 'v1'): Promise<void>;
  /** @deprecated Please load APIs with discovery documents. */
  function load(
  ...
  namespace agentidentitycredentials {
    interface GoogleCloudAgentidentitycredentialsV1_ConsentRejected {}
    ...
    interface GoogleCloudAgentidentitycredentialsV1_FinalizeCredentialsResponse {}
    interface GoogleCloudAgentidentitycredentialsV1_Pending {}
    ...
    interface GoogleCloudAgentidentitycredentialsV1_Success {
    ...
    interface CredentialsResource {
      ...
      finalize(request: {
        ...
        uploadType?: string;
        /** Request body */
        resource: GoogleCloudAgentidentitycredentialsV1_FinalizeCredentialsRequest;
      }): Request<{}>;
      finalize(
        request: {
          /** V1 error format. */
      ...
      retrieve(request: {
        ...
        uploadType?: string;
        /** Request body */
        resource: GoogleCloudAgentidentitycredentialsV1_RetrieveCredentialsRequest;
      }): Request<GoogleCloudAgentidentitycredentialsV1_RetrieveCredentialsResponse>;
      retrieve(
        request: {
          /** V1 error format. */
          '$.xgafv'?: '1' | '2';
