...
declare namespace gapi.client {
  ...
  namespace merchantapi {
    ...
    interface EnergyConsumption {
      ...
      unit?: 'UNIT_UNSPECIFIED' | 'KWHPER100KM';
    ...
    interface FuelConsumption {
      ...
      unit?: 'UNIT_UNSPECIFIED' | 'LPER100KM' | 'KGPER100KM';
    ...
    interface LeaseTerm {
      ...
      durationUnit?: 'DURATION_UNIT_UNSPECIFIED' | 'MONTHS' | 'WEEKS';
      /** The duration value of the lease term. */
      durationValue?: string;
      /** The type of lease term. */
      type?: 'LEASE_TERM_TYPE_UNSPECIFIED' | 'FIXED_TERM';
    }
    ...
    interface Mileage {
      ...
      unit?: 'UNIT_UNSPECIFIED' | 'MILES' | 'KM';
      /** The distance value. */
      value?: string;
    }
    interface PetPolicy {
    ...
    interface ProductAttributes {
      ...
      condition?: 'CONDITION_UNSPECIFIED' | 'NEW' | 'USED' | 'REFURBISHED';
      ...
      gender?: 'GENDER_UNSPECIFIED' | 'MALE' | 'FEMALE' | 'UNISEX';
      ...
      pause?: 'PAUSE_UNSPECIFIED' | 'ADS' | 'ALL';
    ...
    interface ProductInstallment {
      ...
      creditType?: 'CREDIT_TYPE_UNSPECIFIED' | 'FINANCE' | 'LEASE';
    ...
    interface ProductMinimumOrderValue {
    ...
    interface ProductSustainabilityIncentive {
      ...
      type?: 'TYPE_UNSPECIFIED' | 'EV_TAX_CREDIT' | 'EV_PRICE_DISCOUNT';
    }
    ...
    interface SubscriptionCost {
      ...
      period?: 'SUBSCRIPTION_PERIOD_UNSPECIFIED' | 'MONTH' | 'YEAR' | 'WEEK';
      /** The number of subscription periods the buyer has to pay. */
      periodLength?: string;
    }
    interface UnitArea {
      /** The unit of area. */
      unit?: 'UNIT_UNSPECIFIED' | 'SQM' | 'SQFT';
      /** The area value. */
      value?: number;
    }
