# TypeScript typings for Cloud Firestore API v1beta2
...
For provenance information see [Provenance section on NPM](https://www.npmjs.com/package/@maxim_mazurok/gapi.client.firestore-v1beta2#Provenance:~:text=none-,Provenance,-Built%20and%20signed)
