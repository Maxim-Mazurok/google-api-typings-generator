// Type definitions for non-npm package YouTube Data API v3 3.0
...
declare namespace gapi.client {
    ...
    namespace youtube {
        ...
        interface ChannelSnippet {
             ...
             *
             * When displaying thumbnails in your application, make sure that your code uses the image URLs exactly as they are returned in API responses. For
             * example, your application should not use the http domain instead of the https domain in a URL returned in an API response.
             *
             * Beginning in July 2018, channel thumbnail URLs will only be available in the https domain, which is how the URLs appear in API responses. After that
             * time, you might see broken images in your application if it tries to load YouTube images from the http domain.
             */
            thumbnails?: ThumbnailDetails;
            /** The channel's title. */
            title?: string;
        ...
        interface LiveBroadcastContentDetails {
            ...
            /**
             * The mesh for projecting the video if projection is mesh. The mesh value must be a UTF-8 string containing the base-64 encoding of 3D mesh data that
             * follows the  Spherical Video V2 RFC specification for an mshp box, excluding the box size and type but including the following four reserved zero bytes
        ...
        interface MembershipsDetails {
            /**
             * Ids of all levels that the user has access to. This includes the currently active level and all other levels that are included because of a higher
             * purchase.
             */
        ...
        interface SuperStickerMetadata {
            ...
            /**
             * Unique identifier of the Super Sticker. This is a shorter form of the alt_text that includes pack name and a recognizable characteristic of the
             * sticker.
             */
            stickerId?: string;
        }
        ...
        interface Video {
            ...
            player?: VideoPlayer;
            /**
             * The processingDetails object encapsulates information about YouTube's progress in processing the uploaded video file. The properties in the object
        ...
        interface VideoLiveStreamingDetails {
            ...
            concurrentViewers?: string;
            /**
             * The time that the broadcast is scheduled to end. The value is specified in ISO 8601 format. If the value is empty or the property is not present, then
        ...
        interface MembersResource {
            ...
            list(request?: {
                ...
                fields?: string;
                /**
                 * The filterByMemberChannelId parameter represents a comma separated list of channel IDs. Only data about members that are part of this list will be
                 * included in the response. It can be used to efficiently check whether specific users are entitled to perks offered via third parties.
                 */
                filterByMemberChannelId?: string;
                /**
                 * The hasAccessToLevel parameter specifies, when set, the ID of a pricing level that members from the results set should have access to. When not set,
        ...
        interface ThirdPartyLinkResource {
            ...
            update(request: {
                 ...
                 *
                 * Note that this method will override the existing values for mutable properties that are contained in any parts that the request body specifies. For
                 * example, a third-party account link's type is contained in the snippet part, which must be included in the request body. If the request does not
                 * specify a value for the snippet.type property, the third-party account link's existing type will be deleted.
                 */
                part: string;
                /** Returns response with indentations and line breaks. */
                prettyPrint?: boolean;
        ...
        interface ThirdPartyLinksResource {
            /**
             * Returns a collection of third-party account links that match the API request parameters. For example, you can retrieve all links that the authenticated
             * user owns, or you can retrieve one or more links by their unique IDs.
             */
            list(request?: {
                /** Data format for the response. */
                alt?: string;
                ...
                key?: string;
                /**
                 * The linkingToken parameter specifies a unique linking token for the resource that is being retrieved. In a thirdPartyLink resource, the linking_token
                 * property specifies the link's unique identifying token.
                 */
                linkingToken?: string;
                /** OAuth 2.0 token for the current user. */
                oauth_token?: string;
                 ...
                 *
                 * If the parameter identifies a property that contains child properties, the child properties will be included in the response. For example, in a
                 * thirdPartyLink resource, the snippet property contains properties like type, and link_content. As such, if you set part=snippet, the API response will
        ...
        const thirdPartyLink: ThirdPartyLinkResource;
