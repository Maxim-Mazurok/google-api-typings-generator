...
gapi.load('client', () => {
    ...
    async function run() {
        ...
        await gapi.client.youtube.liveBroadcasts.insertCuepoint({
            ...
            onBehalfOfContentOwnerChannel: "Test string",
            part: "Test string",
            "resource.cueType": "Test string",
            "resource.durationSecs": 42,
            "resource.etag": "Test string",
            "resource.id": "Test string",
            "resource.insertionOffsetTimeMs": "Test string",
            "resource.walltimeMs": "Test string",
        });
