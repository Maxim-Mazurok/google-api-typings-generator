...
declare namespace gapi.client {
    ...
    function load(urlOrObject: "https://policysimulator.googleapis.com/$discovery/rest?version=v1"): Promise<void>;
    ...
    namespace policysimulator {
        ...
        interface GoogleCloudPolicysimulatorV1alphaOrgPolicyOverlay {
             ...
             * determined as if all custom constraints in the overlay were instantiated. Only a single custom_constraint is supported in the overlay at a time. For evaluating multiple constraints,
             * multiple `GenerateOrgPolicyViolationsPreview` requests are made, where each request evaluates a single constraint.
             */
            customConstraints?:
        ...
        interface GoogleCloudPolicysimulatorV1alphaOrgPolicyViolationsPreview {
            ...
            createTime?:
                string;
            /**
             * Output only. The names of the constraints against which all `OrgPolicyViolations` were evaluated. If `OrgPolicyOverlay` only contains `PolicyOverlay` then it contains the name of
             * the configured custom constraint, applicable to the specified policies. Otherwise it contains the name of the constraint specified in `CustomConstraintOverlay`. Format:
