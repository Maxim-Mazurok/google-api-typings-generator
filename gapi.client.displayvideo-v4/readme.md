...
*/
await gapi.client.displayvideo.firstPartyAndPartnerAudiences.create({});

/*
Updates the member list of a Customer Match audience. Only supported for the following audience_type: * `CUSTOMER_MATCH_CONTACT_INFO` * `CUSTOMER_MATCH_DEVICE_ID`
*/
await gapi.client.displayvideo.firstPartyAndPartnerAudiences.editCustomerMatchMembers(
...
*/
await gapi.client.displayvideo.firstPartyAndPartnerAudiences.get({
  firstPartyAndPartnerAudienceId: 'firstPartyAndPartnerAudienceId',
});
...
*/
await gapi.client.displayvideo.firstPartyAndPartnerAudiences.list({});
...
*/
await gapi.client.displayvideo.firstPartyAndPartnerAudiences.patch({
  firstPartyAndPartnerAudienceId: 'firstPartyAndPartnerAudienceId',
});
