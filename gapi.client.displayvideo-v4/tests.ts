/* This is stub file for gapi.client.displayvideo-v4 definition tests */
// IMPORTANT
...
gapi.load('client', async () => {
  ...
  async function run() {
            ...
            assignedTargetingOptions: [
              {
                ...
                audienceGroupDetails: {
                  excludedFirstPartyAndPartnerAudienceGroup: {
                    settings: [
                      {
                        firstPartyAndPartnerAudienceId: 'Test string',
                        recency: 'Test string',
                      },
                    ],
                  },
    ...
    await gapi.client.displayvideo.advertisers.adAssets.bulkCreate(
      {
        advertiserId: 'Test string',
      },
      {
        adAssets: [
          {
            adAssetId: 'Test string',
            adAssetType: 'Test string',
            entityStatus: 'Test string',
            name: 'Test string',
            syntheticContentAttestationStatus: 'Test string',
            youtubeVideoAsset: {
              youtubeVideoId: 'Test string',
            },
          },
        ],
      },
    ...
    await gapi.client.displayvideo.advertisers.adAssets.create(
      {
        advertiserId: 'Test string',
      },
      {
    ...
    await gapi.client.displayvideo.advertisers.adAssets.patch(
      {
        adAssetId: 'Test string',
        advertiserId: 'Test string',
        updateMask: 'Test string',
    ...
    await gapi.client.displayvideo.advertisers.adAssets.upload(
      {
        advertiserId: 'Test string',
      },
      {
    ...
    await gapi.client.displayvideo.advertisers.adGroups.bulkListAssignedTargetingOptions(
      {
        adGroupIds: 'Test string',
        advertiserId: 'Test string',
        filter: 'Test string',
    ...
    await gapi.client.displayvideo.advertisers.adGroups.youtubeAssetTypes.youtubeAssetAssociations.create(
      {
        adGroupId: 'Test string',
        advertiserId: 'Test string',
        'linkedEntity.lineItemId': 'Test string',
        youtubeAssetType: 'Test string',
      },
      {
        linkedYoutubeAsset: {
          affiliateLocationAssetFilter: {
            ...
            affiliateLocationMatchingType: 'Test string',
            assetSetId: 'Test string',
          },
          locationAssetFilter: {
            assetSetId: 'Test string',
            locationMatchingFunction: {
              ...
              labels: ['Test string'],
              locationAssetIds: ['Test string'],
            },
            locationMatchingType: 'Test string',
          },
          sitelinkAsset: {
            assetId: 'Test string',
          },
    ...
    await gapi.client.displayvideo.advertisers.adGroups.youtubeAssetTypes.youtubeAssetAssociations.delete(
      {
        adGroupId: 'Test string',
        advertiserId: 'Test string',
        'linkedEntity.lineItemId': 'Test string',
        youtubeAssetAssociationId: 'Test string',
        youtubeAssetType: 'Test string',
      },
    );
    /** Lists the YouTube asset associations linked to the given resource. */
    await gapi.client.displayvideo.advertisers.adGroups.youtubeAssetTypes.youtubeAssetAssociations.list(
      {
        adGroupId: 'Test string',
        advertiserId: 'Test string',
        'linkedEntity.lineItemId': 'Test string',
    ...
    /** Creates a new association between the identified resource and a YouTube asset. Returns the newly-created association. *Warning:* This method is only available to an informed subset of users. */
    await gapi.client.displayvideo.advertisers.lineItems.youtubeAssetTypes.youtubeAssetAssociations.create(
      {
        advertiserId: 'Test string',
        lineItemId: 'Test string',
        'linkedEntity.adGroupId': 'Test string',
        youtubeAssetType: 'Test string',
      },
      {
        linkedYoutubeAsset: {
    ...
    /** Deletes an existing association between the identified resource and a YouTube asset. *Warning:* This method is only available to an informed subset of users. */
    await gapi.client.displayvideo.advertisers.lineItems.youtubeAssetTypes.youtubeAssetAssociations.delete(
      {
        advertiserId: 'Test string',
        lineItemId: 'Test string',
        'linkedEntity.adGroupId': 'Test string',
    ...
    /** Lists the YouTube asset associations linked to the given resource. */
    await gapi.client.displayvideo.advertisers.lineItems.youtubeAssetTypes.youtubeAssetAssociations.list(
      {
        advertiserId: 'Test string',
        lineItemId: 'Test string',
        'linkedEntity.adGroupId': 'Test string',
    ...
    await gapi.client.displayvideo.advertisers.reachForecast.generateReachForecast(
      {
        advertiserId: 'Test string',
      },
      {
        ...
        plannedProducts: [
          {
            advancedProductTargeting: {
              ...
              userInterestIds: ['Test string'],
              userListIds: ['Test string'],
              youtubeSelectSettings: {
                lineupId: 'Test string',
              },
            },
            budgetMicros: 'Test string',
            plannableProductCode: 'Test string',
          },
        ],
        targeting: {
          ageRange: 'Test string',
    ...
    await gapi.client.displayvideo.advertisers.reachForecast.retrievePlannableLocations(
      {
        advertiserId: 'Test string',
      },
    );
    /** Retrieves the list of products that can be planned for a location. */
    await gapi.client.displayvideo.advertisers.reachForecast.retrievePlannableProducts(
      {
        advertiserId: 'Test string',
    ...
    await gapi.client.displayvideo.advertisers.reachForecast.retrievePlannableUserInterests(
      {
        advertiserId: 'Test string',
    ...
    await gapi.client.displayvideo.advertisers.reachForecast.retrievePlannableUserLists(
      {
        advertiserId: 'Test string',
        filter: 'Test string',
        pageSize: 42,
    ...
    await gapi.client.displayvideo.customBiddingAlgorithms.create(
      {},
      {
        ...
        thirdPartyOptimizationPartner: 'Test string',
      },
    );
    ...
    await gapi.client.displayvideo.firstPartyAndPartnerAudiences.create(
      ...
      },
      {
        ...
        displayName: 'Test string',
        firstPartyAndPartnerAudienceId: 'Test string',
        firstPartyAndPartnerAudienceType: 'Test string',
