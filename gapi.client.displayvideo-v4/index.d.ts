...
declare namespace gapi.client {
  ...
  namespace displayvideo {
    ...
    interface AudienceGroupAssignedTargetingOptionDetails {
      ...
      /** The first party and partner audience ids and recencies of included first party and partner audience groups. Each first party and partner audience group contains first party and partner audience ids only. The relation between each first party and partner audience group is INTERSECTION, and the result is UNION'ed with other audience groups. Repeated groups with same settings will be ignored. */
    ...
    interface FirstPartyAndPartnerAudienceGroup {
      /** Required. All first party and partner audience targeting settings in first party and partner audience group. Repeated settings with same id are not allowed. */
    ...
    interface SdfUploadTaskMetadata {
      /** The time when the operation was created. */
      createTime?: string;
      /** The time when execution was completed. */
      endTime?: string;
    ...
    interface FirstPartyAndPartnerAudiencesResource {
      ...
      list(request?: {
        ...
        /** OAuth 2.0 token for the current user. */
        oauth_token?: string;
        /** Field by which to sort the list. Acceptable values are: * `FirstPartyAndPartnerAudienceId` (default) * `displayName` The default sorting order is ascending. To specify descending order for a field, a suffix "desc" should be added to the field name. Example: `displayName desc`. */
        orderBy?: string;
        ...
        pageSize?: number;
        /** A token identifying a page of results the server should return. Typically, this is the value of next_page_token returned from the previous call to `ListFirstPartyAndPartnerAudiences` method. If not specified, the first page of results will be returned. */
        pageToken?: string;
