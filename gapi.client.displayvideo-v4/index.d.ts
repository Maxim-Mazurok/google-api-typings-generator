...
declare namespace gapi.client {
  ...
  namespace displayvideo {
    ...
    interface AdGroupInventoryControl {
    ...
    interface AdvancedProductTargeting {
      ...
      genders?:
        ...
        | 'GENDER_FEMALE'
        | 'GENDER_UNKNOWN'[];
      /** Optional. The networks to target. */
      networks?:
    ...
    interface AudienceGroupAssignedTargetingOptionDetails {
      ...
      includedFirstPartyAndPartnerAudienceGroups?: FirstPartyAndPartnerAudienceGroup[];
    ...
    interface BulkEditAdGroupAssignedTargetingOptionsRequest {
    ...
    interface ContentThemeAssignedTargetingOptionDetails {
    ...
    interface EffectiveFrequencyBreakdown {
      /** The number of unique individuals, including co-viewers, exactly matching the targeting that were served the ad at least the number of times dictated by the effective_frequency. */
      effectiveCoviewReach?: string;
      /** The set effective frequency. */
      effectiveFrequency?: number;
      /** The total number of unique individuals, including co-viewers that were served the ad at least the number of times dictated by the effective_frequency. This includes individuals that may fall outside of targeting. */
      onTargetEffectiveCoviewReach?: string;
      /** The number of unique individuals exactly matching the targeting that were served the ad at least the number of times dictated by the effective_frequency. */
      onTargetReach?: string;
      /** The total number of unique individuals that were served the ad at least the number of times dictated by the effective_frequency. This includes individuals that may fall outside of targeting. */
      totalReach?: string;
    }
    interface Empty {}
    ...
    interface FirstPartyAndPartnerAudienceTargetingSetting {
    ...
    interface GenerateReachForecastRequest {
      /** Required. The duration of the planned campaign. */
      campaignDuration?: CampaignDuration;
      /** Required. The currency code for the plan in ISO 4217 format. */
      currencyCode?: string;
      /** Optional. The highest minimum effective frequency to include in PlannedProductForecast.effective_frequency_breakdowns. Must be between 1 and 10, inclusive. If not specified, PlannedProductForecast.effective_frequency_breakdowns will not be populated. If set, this value will also be used as the minimum effective frequency for reach metrics reporting. This field cannot be combined with the min_effective_frequency field. */
      effectiveFrequencyBreakdownLimit?: number;
      /** Optional. The minimum effective frequency for the reported reach metrics. This is the smallest number of times a customer must be exposed to the ad for it to be considered effective. This setting only impacts reporting. Must be between 1 and 10, inclusive. If not specified, a default of 1 is applied. This field cannot be combined with effective_frequency_breakdown_limit. */
    ...
    interface GenerateReachForecastResponse {
    ...
    interface ListAdGroupAssignedTargetingOptionsResponse {
      /** The list of assigned targeting options. This list will be absent if empty. */
      assignedTargetingOptions?: AssignedTargetingOption[];
    ...
    interface OnTargetAudienceMetrics {
    ...
    interface PlannableUserInterest {
    ...
    interface PlannedProductReachForecast {
    ...
    interface SurfaceTargetingCombination {
    ...
    interface SurfaceTargetingCombinations {
      ...
      validSurfaceCombinations?: SurfaceTargetingCombination[];
    }
    interface SurfaceTargetingSettings {
    ...
    interface AssignedTargetingOptionsResource {
      ...
      list(request?: {
        ...
        /** Legacy upload protocol for media (e.g. "media", "multipart"). */
        uploadType?: string;
      }): Request<ListAdGroupAssignedTargetingOptionsResponse>;
    }
    ...
    interface AdGroupsResource {
      ...
      bulkEditAssignedTargetingOptions(request: {
        ...
        uploadType?: string;
        /** Request body */
        resource: BulkEditAdGroupAssignedTargetingOptionsRequest;
      }): Request<BulkEditAdGroupAssignedTargetingOptionsResponse>;
    ...
    interface ReachForecastResource {
      ...
      generateReachForecast(request: {
        ...
        uploadType?: string;
        /** Request body */
        resource: GenerateReachForecastRequest;
      }): Request<GenerateReachForecastResponse>;
      ...
      retrievePlannableLocations(request?: {
        /** V1 error format. */
        '$.xgafv'?: '1' | '2';
        /** OAuth access token. */
        access_token?: string;
        ...
        /** Legacy upload protocol for media (e.g. "media", "multipart"). */
        uploadType?: string;
      }): Request<RetrievePlannableLocationsResponse>;
      /** Retrieves the list of products that can be planned for a location. */
      retrievePlannableProducts(request?: {
        /** V1 error format. */
        '$.xgafv'?: '1' | '2';
        /** OAuth access token. */
        access_token?: string;
        ...
        /** Legacy upload protocol for media (e.g. "media", "multipart"). */
        uploadType?: string;
      }): Request<RetrievePlannableProductsResponse>;
      /** Retrieves Google Audiences (User Interests) available for forecasting. */
      retrievePlannableUserInterests(request?: {
        /** V1 error format. */
        '$.xgafv'?: '1' | '2';
        /** OAuth access token. */
        access_token?: string;
        ...
        /** Legacy upload protocol for media (e.g. "media", "multipart"). */
        uploadType?: string;
      }): Request<RetrievePlannableUserInterestsResponse>;
      /** Retrieves first and third party user lists available for forecasting. */
      retrievePlannableUserLists(request?: {
        /** V1 error format. */
        '$.xgafv'?: '1' | '2';
        /** OAuth access token. */
        access_token?: string;
        ...
        /** Legacy upload protocol for media (e.g. "media", "multipart"). */
        uploadType?: string;
      }): Request<RetrievePlannableUserListsResponse>;
    }
    interface AssignedTargetingOptionsResource {
    ...
    interface AdvertisersResource {
      ...
      reachForecast: ReachForecastResource;
      targetingTypes: TargetingTypesResource;
    }
    ...
    interface RulesResource {
      ...
      }): Request<CustomBiddingAlgorithmRules>;
      create(
        request: {
          /** V1 error format. */
          '$.xgafv'?: '1' | '2';
    ...
    interface CustomBiddingAlgorithmsResource {
      ...
      uploadRules(request?: {
        ...
        /** Legacy upload protocol for media (e.g. "media", "multipart"). */
        uploadType?: string;
      }): Request<CustomBiddingAlgorithmRulesRef>;
    ...
    interface FirstPartyAndPartnerAudiencesResource {
      ...
      create(request: {
        ...
        uploadType?: string;
        /** Request body */
        resource: FirstPartyAndPartnerAudience;
      }): Request<FirstPartyAndPartnerAudience>;
      create(
        request: {
          /** V1 error format. */
          '$.xgafv'?: '1' | '2';
      ...
      list(request?: {
        ...
        /** Legacy upload protocol for media (e.g. "media", "multipart"). */
        uploadType?: string;
      }): Request<ListFirstPartyAndPartnerAudiencesResponse>;
    ...
    const firstPartyAndPartnerAudiences: FirstPartyAndPartnerAudiencesResource;
