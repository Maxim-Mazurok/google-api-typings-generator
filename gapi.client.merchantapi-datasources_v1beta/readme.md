...
```json
{
  "compilerOptions": {
    "types": [
      ...
      "gapi.auth2",
      "gapi.client",
      "gapi.client.merchantapi-datasources_v1beta"
    ]
  }
}
```
...
For provenance information see [Provenance section on NPM](https://www.npmjs.com/package/@maxim_mazurok/gapi.client.merchantapi-datasources_v1beta#Provenance:~:text=none-,Provenance,-Built%20and%20signed)
