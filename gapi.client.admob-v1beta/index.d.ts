...
declare namespace gapi.client {
    ...
    namespace admob {
        ...
        interface BatchUpdateCampaignsRequest {
            /** Required. The individual requests to update campaigns. Max 1000 allowed. */
            requests?:
                UpdateCampaignRequest[];
        }
        interface BatchUpdateCampaignsResponse {
        ...
        interface CampaignsResource {
            ...
            batchUpdate(request: {
                ...
                oauth_token?:
                    string;
                /**
                 * Required. Resource name of the account to list campaigns for. The `parent` field in the individual UpdateCampaignRequest messages should match the value set here. Example:
            ...
            }): Request<BatchUpdateCampaignsResponse>;
            batchUpdate(request: {
                /** V1 error format. */
                "$.xgafv"?:
                    string;
            ...
            body: BatchUpdateCampaignsRequest): Request<BatchUpdateCampaignsResponse>;
            ...
            list(request?: {
                ...
                fields?:
                    string;
                /**
                 * The filter string that uses [EBNF grammar syntax](https://google.aip.dev/assets/misc/ebnf-filtering.txt). Possible field to filter by is: - "CAMPAIGN_GOAL_TYPE" Possible filter
                ...
                pageSize?:
                    number;
                /**
                 * The value returned by the last `ListCampaignsResponse`; indicates that this is a continuation of a prior `ListGoogleBiddingAdUnits` call, and that the system should return the
                 * next page of data.
                 */
                pageToken?:
                    string;
