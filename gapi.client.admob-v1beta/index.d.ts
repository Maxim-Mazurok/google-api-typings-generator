...
declare namespace gapi.client {
    ...
    function load(urlOrObject: "https://admob.googleapis.com/$discovery/rest?version=v1beta"): Promise<void>;
    ...
    namespace admob {
        ...
        interface AdUnitMapping {
            ...
            adapterId?:
                string;
            /**
             * Settings for the specified ad unit to make an ad request to 3rd party ad network. Key-value pairs with values set by the user for the keys requested by the ad network. Please see
            ...
            displayName?:
                string;
            /**
             * Resource name of this ad unit mapping. Format is: accounts/{publisher_id}/adUnits/{ad_unit_id_fragment}/adUnitMappings/{ad_unit_mapping_id} Example:
        ...
        interface AppLinkedAppInfo {
            /**
             * Optional. The app store information for published Android apps. This field is only used for apps on the Android platform and will be ignored if the PLATFORM is set to iOS. The
             * default value is the Google Play App store. This field can be updated after app is created. If the app is not published, this field will not be included in the response.
             */
            androidAppStores?:
                string[];
            /**
        ...
        interface BatchCreateAdUnitMappingsRequest {
            /**
             * Required. The request message specifying the ad unit mappings to create. A maximum of 100 ad unit mappings can be created in a batch. If the number of ad unit mappings in the batch
             * request exceed 100, the entire request will be rejected and no ad unit mappings will be created.
             */
            requests?:
        ...
        interface MediationAbExperiment {
            ...
            experimentId?:
                string;
            /**
             * Resource name for this experiment. The format is accounts/{publisher_id}/ mediationGroups/{mediation_group_id}/mediationAbExperiment/ {mediation_group_experiment_id}. For example:
            ...
            treatmentMediationLines?:
                MediationAbExperimentExperimentMediationLine[];
            /**
             * The percentage of the mediation A/B experiment traffic that will be send to the treatment (variant B). The remainder is sent to the control (variant A). The percentage is expressed
             * as an integer in the inclusive range of [1,99]. See https://support.google.com/admob/answer/9572326 for details.
             */
        ...
        interface MediationGroup {
            ...
            mediationGroupLines?:
                { [P in string]: MediationGroupMediationGroupLine };
        ...
        interface MediationGroupMediationGroupLine {
            ...
            adSourceId?:
                string;
            /**
             * References of the ad unit mappings for each ad unit associated with this mediation line. Key is the ad unit ID, value is resource name of the ad unit mapping. For mediation lines
             * where the ad source id is the AdMob Network, ad unit mappings will be ignored.
             */
            adUnitMappings?:
                { [P in string]: string };
            /**
             * The CPM for this allocation line. $0.01 is the minimum allowed amount. For LIVE CPM modes, the default amount is $0.01. This value is ignored if `cpm_mode` is `LIVE`. **Warning:**
             * "USD" is the only supported currency at the moment. The unit is in micros.
             */
            cpmMicros?:
                string;
            /**
             * Indicates how the CPM for this mediation line is provided. Note that `MANUAL` and `LIVE` are the only fully-supported mode at the moment. Please use the AdMob UI
             * (https://admob.google.com) if you wish to create or update to other cpm modes.
             */
            cpmMode?:
                string;
        ...
        interface MediationGroupTargeting {
            ...
            format?:
                string;
            /**
             * The parameter can be used to target ad requests based on the availability of the IDFA. If set to ALL, the mediation group applies to all ad requests (with or without IDFA). If set
             * to AVAILABLE, the mediation group applies to ad requests with IDFA. If set to NOT_AVAILABLE, the mediation group applies to ad requests without IDFA. Doesn't need to be specified
            ...
            platform?:
                string;
            /**
             * The Unicode country/region code (CLDR) of a location, such as "US". Unset if this mediation group targets all available regions. For more information, see
        ...
        interface AdaptersResource {
            ...
            list(request?: {
                ...
                oauth_token?:
                    string;
                /**
                 * The maximum number of adapters to return. If unspecified or 0, at most 10,000 adapters will be returned. The maximum value is 20,000; values above 20,000 will be coerced to
                 * 20,000.
                 */
                pageSize?:
                    number;
        ...
        interface AdSourcesResource {
            ...
            list(request?: {
                ...
                oauth_token?:
                    string;
                /**
                 * The maximum number of ad sources to return. If unspecified or 0, at most 10,000 ad sources will be returned. The maximum value is 20,000; values above 10,000 will be coerced to
                 * 20,000.
                 */
                pageSize?:
                    number;
        ...
        interface AdUnitMappingsResource {
            ...
            batchCreate(request: {
                ...
                oauth_token?:
                    string;
                /**
                 * Required. The AdMob account which owns this collection of ad unit mappings. Format: accounts/{publisher_id} See https://support.google.com/admob/answer/2784578 for instructions
                 * on how to find your AdMob publisher ID.
                 */
                parent:
                    string;
                /** Returns response with indentations and line breaks. */
            ...
            body: BatchCreateAdUnitMappingsRequest): Request<BatchCreateAdUnitMappingsResponse>;
        }
        interface AdUnitMappingsResource {
            /**
            ...
            body: AdUnitMapping): Request<AdUnitMapping>;
            /**
             * List ad unit mappings under the specified AdMob account and ad unit. This method has limited access. If you see a 403 permission denied error, please reach out to your account
             * manager for access.
             */
            list(request?: {
                /** V1 error format. */
                ...
                fields?:
                    string;
                /**
                 * The filter string that uses [EBNF grammar syntax](https://google.aip.dev/assets/misc/ebnf-filtering.txt). Possible field to filter by is: - "DISPLAY_NAME" Possible filter
                 * function is: - `IN`: Used to filter fields that represent a singleton including "DISPLAY_NAME". The filter functions can be added together using `AND`. `OR` functionality is not
                 * supported. Example: filter: IN(DISPLAY_NAME, "Test Ad Unit Mapping 1", "Test Ad Unit Mapping 2")
                 */
                filter?:
                    string;
                /** API key. Your API key identifies your project and provides you with API access, quota, and reports. Required unless you provide an OAuth 2.0 token. */
                ...
                oauth_token?:
                    string;
                /**
                 * The maximum number of ad unit mappings to return. If unspecified or 0, at most 10,000 ad unit mappings will be returned. The maximum value is 20,000; values above 20,000 will be
                 * coerced to 20,000.
                 */
                pageSize?:
                    number;
        ...
        interface CampaignReportResource {
            ...
            body: GenerateCampaignReportRequest): Request<GenerateCampaignReportResponse>;
        }
        interface MediationAbExperimentsResource {
            /**
             * Create an A/B testing experiment for a specified AdMob account and a mediation group. This method has limited access. If you see a 403 permission denied error, please reach out to
            ...
            body: MediationAbExperiment): Request<MediationAbExperiment>;
            /**
             * Stop the mediation A/B experiment and choose a variant. This method has limited access. If you see a 403 permission denied error, please reach out to your account manager for
             * access.
             */
            stop(request: {
                /** V1 error format. */
            ...
            body: StopMediationAbExperimentRequest): Request<MediationAbExperiment>;
        }
        interface MediationGroupsResource {
            /**
             * Create a mediation group under the specific AdMob account. This method has limited access. If you see a 403 permission denied error, please reach out to your account manager for
             * access.
             */
            create(request: {
                /** V1 error format. */
            ...
            body: MediationGroup): Request<MediationGroup>;
            /**
             * List mediation groups under the specified AdMob account. This method has limited access. If you see a 403 permission denied error, please reach out to your account manager for
             * access.
             */
            list(request?: {
                /** V1 error format. */
                ...
                fields?:
                    string;
                /**
                 * The filter string that uses [EBNF grammar syntax](https://google.aip.dev/assets/misc/ebnf-filtering.txt). Possible fields to filter by are: - "AD_SOURCE_IDS" - "AD_UNIT_IDS" -
                 * "APP_IDS" - "DISPLAY_NAME" - "FORMAT" - "MEDIATION_GROUP_ID" - "PLATFORM" - "STATE" - "TARGETED_REGION_CODES" Possible filter functions are: - `IN`: Used to filter fields that
                 * represent a singleton including "MEDIATION_GROUP_ID", "DISPLAY_NAME", "STATE", "PLATFORM", and "FORMAT". - `CONTAINS_ANY`: Used to filter fields that represent a collection
                 * including "AD_SOURCE_IDS", "AD_UNIT_IDS", "APP_IDS", and "TARGETED_REGION_CODES". The filter functions can be added together using `AND`. `OR` functionality is not supported.
                 * Example: filter: IN(DISPLAY_NAME, "Test Group 1", "Test Group 2") AND IN(PLATFORM, "ANDROID") AND CONTAINS_ANY(AD_SOURCE_IDS, "5450213213286189855")
                 */
                filter?:
                    string;
                /** API key. Your API key identifies your project and provides you with API access, quota, and reports. Required unless you provide an OAuth 2.0 token. */
                ...
                oauth_token?:
                    string;
                /**
                 * The maximum number of mediation groups to return. If unspecified or 0, at most 10,000 mediation groups will be returned. The maximum value is 20,000; values above 20,000 will be
                 * coerced to 20,000.
                 */
                pageSize?:
                    number;
                /**
                 * The value returned by the last `ListMediationGroupsResponse`; indicates that this is a continuation of a prior `ListMediationGroups` call, and that the system should return the
                 * next page of data.
                 */
                pageToken?:
                    string;
            ...
            patch(request: {
                ...
                quotaUser?:
                    string;
                /**
                 * List of mediation group fields to be updated. Updates to repeated fields such as items in a list will fully replace the existing value(s) with the new value(s). Updates to
                 * individual values in a map can be done by indexing by the key. The following field masks are supported for mediation group updates: -
                 * "mediation_group_lines[\"{mediation_group_line_id}\"]" clang-format off - "mediation_group_lines[\"{mediation_group_line_id}\"].ad_unit_mappings[\"{ad_unit_id}\"]" clang-format
                 * on - "mediation_group_lines[\"{mediation_group_line_id}\"].cpm_micros" - "mediation_group_lines[\"{mediation_group_line_id}\"].cpm_mode" -
                 * "mediation_group_lines[\"{mediation_group_line_id}\"].state" - "mediation_group_lines[\"{mediation_group_line_id}\"].display_name" - "targeting.ad_unit_ids" To update a
                 * mediation group with a new mediation group line, use a distinct negative number for the "mediation_group_line_id". For Example: update_mask { paths:
            ...
            mediationAbExperiments:
                MediationAbExperimentsResource;
        }
