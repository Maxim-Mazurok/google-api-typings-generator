...
declare namespace gapi.client {
  ...
  namespace admob {
    ...
    interface AdUnitMapping {
      ...
      state?: 'STATE_UNSPECIFIED' | 'ENABLED';
    }
    ...
    interface MediationAbExperiment {
      ...
      state?: 'EXPERIMENT_STATE_UNSPECIFIED' | 'EXPIRED' | 'RUNNING' | 'ENDED';
    ...
    interface MediationGroupMediationGroupLine {
      ...
      cpmMode?: 'CPM_MODE_UNSPECIFIED' | 'LIVE' | 'MANUAL' | 'ANO';
      ...
      state?: 'STATE_UNSPECIFIED' | 'ENABLED' | 'DISABLED' | 'REMOVED';
    }
