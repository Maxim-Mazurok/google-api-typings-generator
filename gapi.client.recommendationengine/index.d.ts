...
// Project: https://cloud.google.com/recommendations/docs/
...
declare namespace gapi.client {
    ...
    function load(name: "recommendationengine", version: "v1beta1"): PromiseLike<void>;
    ...
    namespace recommendationengine {
        ...
        interface GoogleCloudRecommendationengineV1beta1BigQuerySource {
            ...
            datasetId?: string;
            /**
             * Optional. Intermediate Cloud Storage directory used for the import. Can be specified
             * if one wants to have the BigQuery export to a specific Cloud Storage
             * directory.
             */
            gcsStagingDir?: string;
            /**
             * Optional. The project id (can be project # or id) that the BigQuery source is in. If
        ...
        interface GoogleCloudRecommendationengineV1beta1GetCatalogItemsWithItemGroupIdResponse {
            /**
             * The canonical catalog item representing all items associated with the item
             * group id.
             */
            canonicalCatalogItem?: GoogleCloudRecommendationengineV1beta1CatalogItem;
        ...
        interface GoogleCloudRecommendationengineV1beta1ImportCatalogItemsRequest {
            ...
            requestId?: string;
            /**
             * Optional. Indicates which fields in the provided imported 'items' to update. If not
        ...
        interface GoogleCloudRecommendationengineV1beta1RejoinUserEventsRequest {
            /**
             * Required. The type of the catalog rejoin to define the scope and range of the user
        ...
        interface CatalogItemsResource {
            ...
            getGroupIdItems(request?: {
                ...
                /** Legacy upload protocol for media (e.g. "media", "multipart"). */
                uploadType?: string;
            }): Request<GoogleCloudRecommendationengineV1beta1GetCatalogItemsWithItemGroupIdResponse>;
            /**
