/* Type definitions for non-npm package Recommendations AI (Beta) v1beta1 1.0 */
...
declare namespace gapi.client {
    ...
    namespace recommendationengine {
        ...
        interface GoogleCloudRecommendationengineV1beta1UserInfo {
             ...
             * identify a visitor on a single device. This unique identifier should not change if the visitor logs in or out of the website. Maximum length 128 bytes. Cannot be empty.
             */
            visitorId?: string;
        }
