...
gapi.load('client', async () => {
  ...
  async function run() {
    ...
    await gapi.client.datalineage.folders.locations.config.get({
      name: 'Test string',
    });
    /** Update the Config for a given resource. */
    await gapi.client.datalineage.folders.locations.config.patch(
      {
        name: 'Test string',
      },
      {
    ...
    /** Get the Config for a given resource. */
    await gapi.client.datalineage.organizations.locations.config.get({
      name: 'Test string',
    });
    /** Update the Config for a given resource. */
    await gapi.client.datalineage.organizations.locations.config.patch(
      {
        name: 'Test string',
      },
      {
    ...
    await gapi.client.datalineage.projects.locations.searchLineageStreaming(
      {
        parent: 'Test string',
      },
      {
        ...
        filters: {
          dependencyTypes: ['Test string'],
          entitySet: 'Test string',
          timeRange: {
            endTime: 'Test string',
    ...
    /** Get the Config for a given resource. */
    await gapi.client.datalineage.projects.locations.config.get({
      name: 'Test string',
    });
    /** Update the Config for a given resource. */
    await gapi.client.datalineage.projects.locations.config.patch(
      {
        name: 'Test string',
      },
      {
