...
declare namespace gapi.client {
  ...
  namespace datalineage {
    ...
    interface GoogleCloudDatacatalogLineageConfigmanagementV1ConfigIngestion {
      /** Optional. List of rules for Data Lineage ingestion. */
      rules?: GoogleCloudDatacatalogLineageConfigmanagementV1ConfigIngestionIngestionRule[];
    }
    ...
    interface GoogleCloudDatacatalogLineageV1DependencyInfo {
      /** Required. Type of dependency. */
      dependencyType?: 'DEPENDENCY_TYPE_UNSPECIFIED' | 'EXACT_COPY' | 'OTHER';
    }
    ...
    interface GoogleCloudDatacatalogLineageV1LineageLink {
      /** Describes how the target entity is dependent on the source entity. */
      dependencyInfo?: GoogleCloudDatacatalogLineageV1LineageLinkDependencyInfo[];
      ...
      processes?: GoogleCloudDatacatalogLineageV1LineageLinkLineageProcess[];
      /** The entity that is the **source** of this link. */
      source?: GoogleCloudDatacatalogLineageV1EntityReference;
      /** The entity that is the **target** of this link. */
      target?: GoogleCloudDatacatalogLineageV1EntityReference;
    }
    interface GoogleCloudDatacatalogLineageV1LineageLinkDependencyInfo {
      /** The type of dependency. */
      dependencyType?: 'DEPENDENCY_TYPE_UNSPECIFIED' | 'EXACT_COPY' | 'OTHER';
    }
    interface GoogleCloudDatacatalogLineageV1LineageLinkLineageProcess {
    ...
    interface GoogleCloudDatacatalogLineageV1Link {
      ...
      dependencyInfo?: GoogleCloudDatacatalogLineageV1LinkDependencyInfo[];
    ...
    interface GoogleCloudDatacatalogLineageV1LinkDependencyInfo {
      /** The type of dependency. */
      dependencyType?: 'DEPENDENCY_TYPE_UNSPECIFIED' | 'EXACT_COPY' | 'OTHER';
    }
    ...
    interface GoogleCloudDatacatalogLineageV1MultipleEntityReference {
      /** Optional. The list of entities to search for links. The maximum number of entities is 20. */
      entities?: GoogleCloudDatacatalogLineageV1EntityReference[];
    }
    interface GoogleCloudDatacatalogLineageV1OperationMetadata {
      ...
      operationType?: 'TYPE_UNSPECIFIED' | 'DELETE' | 'CREATE';
    ...
    interface GoogleCloudDatacatalogLineageV1SearchLineageStreamingRequest {
      /** Required. Direction of the search. */
      direction?: 'SEARCH_DIRECTION_UNSPECIFIED' | 'DOWNSTREAM' | 'UPSTREAM';
    ...
    interface GoogleCloudDatacatalogLineageV1SearchLineageStreamingRequestRootCriteria {
    ...
    interface GoogleCloudDatacatalogLineageV1SearchLineageStreamingRequestSearchLimits {
    ...
    interface GoogleCloudDatacatalogLineageV1SearchLineageStreamingResponse {
      /** Output only. The lineage links that match the search criteria. Can be empty if no links match. */
      links?: GoogleCloudDatacatalogLineageV1LineageLink[];
    ...
    interface ConfigResource {
      ...
      get(request?: {
        ...
        uploadType?: string;
      }): Request<GoogleCloudDatacatalogLineageConfigmanagementV1Config>;
      ...
      patch(request: {
        ...
        uploadType?: string;
        /** Request body */
        resource: GoogleCloudDatacatalogLineageConfigmanagementV1Config;
      }): Request<GoogleCloudDatacatalogLineageConfigmanagementV1Config>;
      patch(
        request: {
          /** V1 error format. */
    ...
    interface LocationsResource {
      ...
      searchLineageStreaming(request: {
        /** V1 error format. */
        '$.xgafv'?: '1' | '2';
        /** OAuth access token. */
        access_token?: string;
        ...
        uploadType?: string;
        /** Request body */
        resource: GoogleCloudDatacatalogLineageV1SearchLineageStreamingRequest;
      }): Request<GoogleCloudDatacatalogLineageV1SearchLineageStreamingResponse>;
