...
declare namespace gapi.client {
    ...
    namespace mybusinessverifications {
        ...
        interface GenerateVerificationTokenRequest {
            /**
             * Required. The target location. Note: The location information should exactly match the target Location, otherwise the generated verification token won't be able to verify the target
             * Location.
             */
            location?: Location;
        }
