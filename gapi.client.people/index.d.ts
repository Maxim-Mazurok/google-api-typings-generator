    ...
    namespace people {
        ...
        interface PeopleResource {
            ...
            getBatchGet(request?: {
                 ...
                 * contact, specify the resource name that identifies the contact as returned by [`people.connections.list`](/people/api/rest/v1/people.connections/list). You can include up to 200
