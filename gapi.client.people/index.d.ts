...
declare namespace gapi.client {
    ...
    namespace people {
        ...
        interface OtherContactsResource {
             ...
             * specified, all other request parameters must match the first call. See example usage at [List the user's other contacts that have
        ...
        interface ConnectionsResource {
             ...
             * `PersonMetadata.deleted` set to true. When the `page_token` or `sync_token` is specified, all other request parameters must match the first call. See example usage at [List the
             * user's contacts that have changed](/people/v1/contacts#list_the_users_contacts_that_have_changed).
             */
            list(request?: {
                /** V1 error format. */
                "$.xgafv"?: string;
        ...
        interface PeopleResource {
             ...
             * be returned as a person with `PersonMetadata.deleted` set to true. When the `page_token` or `sync_token` is specified, all other request parameters must match the first call. See
             * example usage at [List the directory people that have changed](/people/v1/directory#list_the_directory_people_that_have_changed).
             */
