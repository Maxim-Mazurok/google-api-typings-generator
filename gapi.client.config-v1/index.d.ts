...
declare namespace gapi.client {
  ...
  namespace config {
    ...
    interface DeploymentGroupRevision {
    ...
    interface DeploymentOperationSummary {
    ...
    interface DeploymentUnitProgress {
    ...
    interface DeprovisionDeploymentGroupRequest {
    ...
    interface ListDeploymentGroupRevisionsResponse {
      /** The deployment group revisions from the specified collection. */
      deploymentGroupRevisions?: DeploymentGroupRevision[];
    ...
    interface ListDeploymentGroupsResponse {
    ...
    interface ProvisionDeploymentGroupOperationMetadata {
      /** Output only. Progress information for each deployment unit within the operation. */
      deploymentUnitProgresses?: DeploymentUnitProgress[];
    ...
    interface ProvisionDeploymentGroupRequest {
      ...
      deploymentSpecs?: {[P in string]: DeploymentSpec};
    }
    interface Resource {
    ...
    interface TerraformBlueprint {
      ...
      externalValues?: {[P in string]: ExternalValueSource};
    ...
    interface RevisionsResource {
      ...
      get(request?: {
        ...
        uploadType?: string;
      }): Request<DeploymentGroupRevision>;
      ...
      list(request?: {
        ...
        /** Legacy upload protocol for media (e.g. "media", "multipart"). */
        uploadType?: string;
      }): Request<ListDeploymentGroupRevisionsResponse>;
    }
    interface DeploymentGroupsResource {
      ...
      deprovision(request: {
        ...
        uploadType?: string;
        /** Request body */
        resource: DeprovisionDeploymentGroupRequest;
      }): Request<Operation>;
      deprovision(
        request: {
          /** V1 error format. */
      ...
      list(request?: {
        ...
        /** Legacy upload protocol for media (e.g. "media", "multipart"). */
        uploadType?: string;
      }): Request<ListDeploymentGroupsResponse>;
      ...
      provision(request: {
        ...
        uploadType?: string;
        /** Request body */
        resource: ProvisionDeploymentGroupRequest;
      }): Request<Operation>;
      provision(
        request: {
          /** V1 error format. */
    ...
    interface LocationsResource {
      ...
      deploymentGroups: DeploymentGroupsResource;
