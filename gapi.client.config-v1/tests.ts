...
gapi.load('client', async () => {
  ...
  async function run() {
    ...
    await gapi.client.config.projects.locations.deploymentGroups.create(
      {
        deploymentGroupId: 'Test string',
        parent: 'Test string',
      ...
      },
      {
        ...
        provisioningStateDescription: 'Test string',
        state: 'Test string',
    ...
    await gapi.client.config.projects.locations.deploymentGroups.delete({
      deploymentReferencePolicy: 'Test string',
      force: true,
      name: 'Test string',
      requestId: 'Test string',
    });
    ...
    await gapi.client.config.projects.locations.deploymentGroups.deprovision(
      {
        name: 'Test string',
      },
      {
    ...
    await gapi.client.config.projects.locations.deploymentGroups.get({
      name: 'Test string',
    });
    /** List DeploymentGroups for a given project and location. */
    await gapi.client.config.projects.locations.deploymentGroups.list({
      filter: 'Test string',
      orderBy: 'Test string',
      pageSize: 42,
      pageToken: 'Test string',
    ...
    await gapi.client.config.projects.locations.deploymentGroups.patch(
      {
        name: 'Test string',
        requestId: 'Test string',
        updateMask: 'Test string',
    ...
    await gapi.client.config.projects.locations.deploymentGroups.provision(
      {
        name: 'Test string',
      },
      {
    ...
    await gapi.client.config.projects.locations.deploymentGroups.revisions.get({
      name: 'Test string',
    });
    /** Lists DeploymentGroupRevisions in a given DeploymentGroup. */
    await gapi.client.config.projects.locations.deploymentGroups.revisions.list(
      {
        pageSize: 42,
        pageToken: 'Test string',
        parent: 'Test string',
