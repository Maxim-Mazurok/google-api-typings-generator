...
declare namespace gapi.client {
    /** Load Gmail API v1 */
    function load(urlOrObject: "https://gmail.googleapis.com/$discovery/rest?version=v1"): Promise<void>;
    ...
    namespace gmail {
        ...
        interface MessagesResource {
             ...
             * it might not work for some spam messages, such as those attempting to perform domain spoofing. This method does not send a message.
             */
            import(request: {
                /** V1 error format. */
                "$.xgafv"?:
            ...
            list(request?: {
                ...
                key?:
                    string;
                /**
                 * Only return messages with labels that match all of the specified label IDs. Messages in a thread might have labels that other messages in the same thread don't have. To learn
                 * more, see [Manage labels on messages and threads](https://developers.google.com/gmail/api/guides/labels#manage_labels_on_messages_threads).
                 */
                labelIds?:
                    string | string[];
        ...
        interface IdentitiesResource {
             ...
             * directory so that people within a Google Workspace organization can encrypt and send mail to the identity.
             */
            create(request: {
                /** V1 error format. */
                "$.xgafv"?:
        ...
        interface DelegatesResource {
             ...
             * your organization, but in general each user can have up to 25 delegates and up to 10 delegators. Note that a delegate user must be referred to by their primary email address, and
             * not an email alias. Also note that when a new delegate is created, there may be up to a one minute delay before the new delegate is available for use. This method is only available
