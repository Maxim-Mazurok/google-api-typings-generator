# TypeScript typings for Google Ads API v24
...
```
npm install @types/gapi.client.googleads-v24 --save-dev
```
...
{
  "compilerOptions": {
    "types": ["gapi", "gapi.auth2", "gapi.client", "gapi.client.googleads-v24"]
  }
}
```
...
gapi.client.load('googleads', 'v24', () => {
  // now we can use:
  // gapi.client.googleads
});
```
...
*/
await gapi.client.googleads.customers.generateAudienceDefinition({
  customerId: 'customerId',
});
...
*/
await gapi.client.googleads.customers.generateBenchmarksMetrics({
  customerId: 'customerId',
});
...
*/
await gapi.client.googleads.incentives.fetchIncentive({});
...
*/
await gapi.client.googleads.listBenchmarksAvailableDates({});
...
*/
await gapi.client.googleads.listBenchmarksLocations({});
...
*/
await gapi.client.googleads.listBenchmarksProducts({});
...
*/
await gapi.client.googleads.listBenchmarksSources({});
...
*/
await gapi.client.googleads.listPlannableUserInterests({});
...
For provenance information see [Provenance section on NPM](https://www.npmjs.com/package/@maxim_mazurok/gapi.client.googleads-v24#Provenance:~:text=none-,Provenance,-Built%20and%20signed)
