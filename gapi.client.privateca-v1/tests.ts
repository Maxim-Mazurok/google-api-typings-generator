  ...
  async function run() {
      ...
      },
      {
        ...
        issuancePolicy: {
          ...
          baselineValues: {
            ...
            nameConstraints: {
              critical: true,
              excludedDnsNames: ['Test string'],
              excludedEmailAddresses: ['Test string'],
              excludedIpRanges: ['Test string'],
              excludedUris: ['Test string'],
              permittedDnsNames: ['Test string'],
              permittedEmailAddresses: ['Test string'],
              permittedIpRanges: ['Test string'],
              permittedUris: ['Test string'],
            },
            policyIds: [
              {
                objectIdPath: [42],
    ...
    await gapi.client.privateca.projects.locations.caPools.certificateAuthorities.create(
      ...
      },
      {
        accessUrls: {
          ...
          crlAccessUrls: ['Test string'],
        },
        caCertificateDescriptions: [
          {
            aiaIssuingCertificateUrls: ['Test string'],
            authorityKeyId: {
              keyId: 'Test string',
            },
            certFingerprint: {
            ...
            crlDistributionPoints: ['Test string'],
            publicKey: {
              format: 'Test string',
              key: 'Test string',
            },
            ...
            tbsCertificateDigest: 'Test string',
            x509Description: {
              additionalExtensions: [
                {
                  critical: true,
    ...
    await gapi.client.privateca.projects.locations.caPools.certificates.create(
      ...
      },
      {
        ...
        pemCertificateChain: ['Test string'],
        pemCsr: 'Test string',
        requestedNotBeforeTime: 'Test string',
        revocationDetails: {
