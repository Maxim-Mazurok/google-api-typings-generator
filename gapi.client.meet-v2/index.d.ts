...
declare namespace gapi.client {
  ...
  namespace meet {
    ...
    interface SpaceConfig {
      ...
      accessType?: string;
      /** [Developer Preview](https://developers.google.com/workspace/preview): Configuration pertaining to the auto-generated artifacts that the meeting supports. */
      artifactConfig?: ArtifactConfig;
      /** [Developer Preview](https://developers.google.com/workspace/preview): Whether attendance report is enabled for the meeting space. */
      ...
      /** [Developer Preview](https://developers.google.com/workspace/preview): The pre-configured moderation mode for the Meeting. Default: Controlled by the user's policies. */
      moderation?: string;
      /** [Developer Preview](https://developers.google.com/workspace/preview): When moderation.ON, these restrictions go into effect for the meeting. When moderation.OFF, will be reset to default ModerationRestrictions. */
