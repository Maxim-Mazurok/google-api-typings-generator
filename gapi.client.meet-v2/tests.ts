...
gapi.load('client', async () => {
  ...
  async function run() {
    ...
    await gapi.client.meet.conferenceRecords.smartNotes.get({
      name: 'Test string',
    });
    /** Lists the set of smart notes from the conference record. By default, ordered by start time and in ascending order. */
    await gapi.client.meet.conferenceRecords.smartNotes.list({
      pageSize: 42,
      pageToken: 'Test string',
      parent: 'Test string',
    });
    ...
    await gapi.client.meet.spaces.members.batchUpdate(
      {
        parent: 'Test string',
      },
      {
    ...
    await gapi.client.meet.spaces.members.create(
      {
        parent: 'Test string',
      },
      {
    ...
    await gapi.client.meet.spaces.members.delete({
      name: 'Test string',
    });
    ...
    await gapi.client.meet.spaces.members.get({
      name: 'Test string',
    });
    ...
    await gapi.client.meet.spaces.members.list({
      pageSize: 42,
      pageToken: 'Test string',
      parent: 'Test string',
    });
    /** Updates a member. */
    await gapi.client.meet.spaces.members.patch(
      {
        name: 'Test string',
        updateMask: 'Test string',
      },
