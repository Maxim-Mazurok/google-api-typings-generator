...
declare namespace gapi.client {
    ...
    namespace monitoring {
        ...
        interface Criteria {
            /**
             * The specific AlertPolicy names for the alert that should be snoozed. The format is: projects/[PROJECT_ID_OR_NUMBER]/alertPolicies/[POLICY_ID] There is a limit of 100 policies per
        ...
        interface MetricThreshold {
            ...
            filter?: string;
            /**
             * When this field is present, the MetricThreshold condition forecasts whether the time series is predicted to violate the threshold within the forecast_horizion. When this field is
             * not set, the MetricThreshold tests the current value of the timeseries against the threshold.
             */
