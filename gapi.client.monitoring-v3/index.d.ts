...
declare namespace gapi.client {
    ...
    namespace monitoring {
        ...
        interface AlertPolicy {
             ...
             * project. The name is limited to 512 Unicode characters.The convention for the display_name of a PrometheusQueryLanguageCondition is "/", where the and should be taken from the
             * corresponding Prometheus configuration file. This convention is not enforced. In any case the display_name is not a unique key of the AlertPolicy.
             */
            displayName?:
                string;
            /**
             ...
             * Prometheus and are valid Prometheus label names (https://prometheus.io/docs/concepts/data_model/#metric-names-and-labels). This means that they cannot be stored as is in user
        ...
        interface PrometheusQueryLanguageCondition {
             ...
             * enough are considered pending. The default value is zero. Must be zero or positive.
             */
            duration?:
                string;
            /**
             * Required. How often this rule should be evaluated. Must be a positive multiple of 30 seconds or missing. The default value is 30 seconds. If this PrometheusQueryLanguageCondition
             * was generated from a Prometheus alerting rule, then this value should be taken from the enclosing rule group.
             */
            evaluationInterval?:
                string;
            /**
             ...
             * changes in the future.This field is optional. If this field is not empty, then it must be a valid Prometheus label name
             * (https://prometheus.io/docs/concepts/data_model/#metric-names-and-labels).
             */
            ruleGroup?:
                string;
