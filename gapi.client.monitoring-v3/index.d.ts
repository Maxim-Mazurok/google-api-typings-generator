...
declare namespace gapi.client {
    ...
    namespace monitoring {
        ...
        interface Criteria {
            /**
             * The specific AlertPolicy names for the alert that should be snoozed. The format is: projects/[PROJECT_ID_OR_NUMBER]/alertPolicies/[POLICY_ID] There is a limit of 10 policies per
