# TypeScript typings for Google Ads API v20
...
```
npm install @types/gapi.client.googleads-v20 --save-dev
```
...
{
  "compilerOptions": {
    "types": ["gapi", "gapi.auth2", "gapi.client", "gapi.client.googleads-v20"]
  }
}
```
...
```typescript
gapi.client.load(
  'https://googleads.googleapis.com/$discovery/rest?version=v20',
  () => {
    // now we can use:
...
gapi.client.load('googleads', 'v20', () => {
  // now we can use:
  // gapi.client.googleads
});
```
...
For provenance information see [Provenance section on NPM](https://www.npmjs.com/package/@maxim_mazurok/gapi.client.googleads-v20#Provenance:~:text=none-,Provenance,-Built%20and%20signed)
