...
declare namespace gapi.client {
    ...
    namespace chromepolicy {
        ...
        interface GoogleChromePolicyV1PolicySchema {
            ...
            /**
             * Output only. The full qualified name of the policy schema. This value is used to fill the field `policy_schema` in PolicyValue when calling BatchInheritOrgUnitPolicies or
        ...
        interface OrgunitsResource {
             ...
             * That is to say that they must point to the same target resource and must have the same keys specified in `additionalTargetKeyNames`. On failure the request will return the error
             ...
             * and must have the same keys specified in `additionalTargetKeyNames`. On failure the request will return the error details as part of the google.rpc.Status.
             */
            batchModify(request: {
                /** V1 error format. */
                "$.xgafv"?: string;
