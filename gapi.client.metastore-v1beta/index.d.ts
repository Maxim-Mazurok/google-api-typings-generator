...
declare namespace gapi.client {
    ...
    function load(urlOrObject: "https://metastore.googleapis.com/$discovery/rest?version=v1beta"): Promise<void>;
    /** @deprecated Please load APIs with discovery documents. */
    function load(name: "metastore", version: "v1beta"): Promise<void>;
    /** @deprecated Please load APIs with discovery documents. */
