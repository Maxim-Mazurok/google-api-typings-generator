...
declare namespace gapi.client {
    ...
    namespace sts {
        interface GoogleIdentityStsV1ExchangeTokenRequest {
            ...
            /**
             * Required. Input subject token. You can use a Google-issued OAuth 2.0 access token with this field to obtain an access token with new security attributes applied, such as an
             * AccessBoundary. Applying additional security attributes on access tokens that already contain security attributes is not allowed.
             */
            subjectToken?: string;
        ...
        interface GoogleIdentityStsV1ExchangeTokenResponse {
            ...
            access_token?: string;
            /**
             * The expiration time of `access_token` in seconds, measured from the time of issuance. This field is absent when the `subject_token` in the request is a Google-issued, short-lived
             * access token. In this case, the expiration time of the `access_token` is the same as the `subject_token`.
             */
            expires_in?: number;
