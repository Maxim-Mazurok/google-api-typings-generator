/* This is stub file for gapi.client.androidenterprise-v1 definition tests */
// IMPORTANT
...
gapi.load('client', async () => {
    ...
    await gapi.client.load('https://androidenterprise.googleapis.com/$discovery/rest?version=v1');
    ...
    async function run() {
        ...
        await gapi.client.androidenterprise.devices.update({
            ...
            device: "Test string",
            latestBuildFingerprint: "Test string",
            maker: "Test string",
        ...
        await gapi.client.androidenterprise.enterprises.enroll({
            ...
            googleAuthenticationSettings: {
                dedicatedDevicesAllowed: "Test string",
        ...
        /**
         * Retrieves the IDs of the users who have been granted entitlements under the license. **Note:** This item has been deprecated. New integrations cannot use this method and can refer to
        ...
        /**
         * Requests to remove an app from a device. A call to get or list will still show the app as installed on the device until it is actually removed. A successful response indicates that a
         * removal request has been sent to the device. The call will be considered successful even if the app is not present on the device (e.g. it was never installed, or was removed by the
         * user).
         */
         ...
         * managed Google Play to design and create a store layout to display approved products to your users, see Store Layout Design. **Note:** This item has been deprecated. New integrations
        ...
        /**
         * Finds approved products that match a query, or all approved products if there is no query. **Note:** This item has been deprecated. New integrations cannot use this method and can refer
