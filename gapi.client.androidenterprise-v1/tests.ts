...
gapi.load('client', async () => {
  ...
  async function run() {
                ...
                managedProperty: [
                  {
                    ...
                    valueStringArray: ['Test string'],
                  },
                ],
                productId: 'Test string',
              },
              productId: 'Test string',
              trackIds: ['Test string'],
              tracks: ['Test string'],
            },
          ],
        },
    ...
    await gapi.client.androidenterprise.enterprises.createEnrollmentToken({
      ...
      'enrollmentToken.duration': 'Test string',
      'enrollmentToken.enrollmentTokenType': 'Test string',
      'enrollmentToken.token': 'Test string',
      enterpriseId: 'Test string',
    });
