...
declare namespace gapi.client {
    ...
    namespace androidenterprise {
        ...
        interface Policy {
            /**
             * Controls when automatic app updates on the device can be applied. Recommended alternative: autoUpdateMode which is set per app, provides greater flexibility around update frequency.
             * When autoUpdateMode is set to AUTO_UPDATE_POSTPONED or AUTO_UPDATE_HIGH_PRIORITY, autoUpdatePolicy has no effect. "choiceToTheUser" allows the device's user to configure the app
             * update policy. "always" enables auto updates. "never" disables auto updates. "wifiOnly" enables auto updates only when the device is connected to wifi.
             */
            autoUpdatePolicy?:
                string;
        ...
        interface ProductPolicy {
            ...
            autoInstallPolicy?:
                AutoInstallPolicy;
            /**
             * The auto-update mode for the product. When autoUpdateMode is used, it always takes precedence over the user's choice. So when a user makes changes to the device settings manually,
             ...
             * happening in a private app using Android WebView. Authenticator app should already be the default handler for the authentication url on the device.
             */
        ...
        interface EnterprisesResource {
            ...
            /**
             * Returns a token for device enrollment. The DPC can encode this token within the QR/NFC/zero-touch enrollment payload or fetch it before calling the on-device API to authenticate the
             * user. The token can be generated for each device or reused across multiple devices.
             */
            createEnrollmentToken(request?: {
                /** V1 error format. */
                "$.xgafv"?:
                    string;
                /** OAuth access token. */
                ...
                uploadType?:
                    string;
            }): Request<CreateEnrollmentTokenResponse>;
            /**
            ...
            pullNotificationSet(request?: {
                 ...
                 * empty notification list if no notifications are present after some time. Specifying returnImmediately will cause the request to immediately return the pending notifications, or
        ...
        interface EntitlementsResource {
            ...
            /**
             * Lists all entitlements for the specified user. Only the ID is set. **Note:** This item has been deprecated. New integrations cannot use this method and can refer to our new
             * recommendations.
             */
            list(request?: {
                /** V1 error format. */
        ...
        interface GrouplicensesResource {
            /**
             * Retrieves details of an enterprise's group license for a product. **Note:** This item has been deprecated. New integrations cannot use this method and can refer to our new
             * recommendations.
             */
            get(request?: {
                /** V1 error format. */
            ...
            /**
             * Retrieves IDs of all products for which the enterprise has a group license. **Note:** This item has been deprecated. New integrations cannot use this method and can refer to our new
             * recommendations.
             */
            list(request?: {
                /** V1 error format. */
        ...
        interface GrouplicenseusersResource {
            /**
             * Retrieves the IDs of the users who have been granted entitlements under the license. **Note:** This item has been deprecated. New integrations cannot use this method and can refer
        ...
        interface InstallsResource {
            /**
             * Requests to remove an app from a device. A call to get or list will still show the app as installed on the device until it is actually removed. A successful response indicates that
             * a removal request has been sent to the device. The call will be considered successful even if the app is not present on the device (e.g. it was never installed, or was removed by
             * the user).
             */
            delete(request?: {
                /** V1 error format. */
        ...
        interface ProductsResource {
             ...
             * managed Google Play to design and create a store layout to display approved products to your users, see Store Layout Design. **Note:** This item has been deprecated. New
             ...
             * for up to 1 day. **Note:** This item has been deprecated. New integrations cannot use this method and can refer to our new recommendations.
             */
            ...
            /**
             * Finds approved products that match a query, or all approved products if there is no query. **Note:** This item has been deprecated. New integrations cannot use this method and can
            ...
            /**
             * Unapproves the specified product (and the relevant app permissions, if any) **Note:** This item has been deprecated. New integrations cannot use this method and can refer to our new
             * recommendations.
             */
            unapprove(request?: {
                /** V1 error format. */
        ...
        interface UsersResource {
            ...
            /**
             * Retrieves the set of products a user is entitled to access. **Note:** This item has been deprecated. New integrations cannot use this method and can refer to our new
             * recommendations.
             */
             ...
             * (products with revoked approval) can be whitelisted. **Note:** This item has been deprecated. New integrations cannot use this method and can refer to our new recommendations.
             */
