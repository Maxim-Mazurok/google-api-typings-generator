...
declare namespace gapi.client {
    ...
    namespace androidenterprise {
        ...
        interface Policy {
             ...
             * AUTO_UPDATE_HIGH_PRIORITY, this field has no effect. "choiceToTheUser" allows the device's user to configure the app update policy. "always" enables auto updates. "never" disables
             * auto updates. "wifiOnly" enables auto updates only when the device is connected to wifi.
             */
            autoUpdatePolicy?:
                string;
