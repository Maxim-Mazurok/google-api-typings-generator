...
declare namespace gapi.client {
  ...
  namespace cloudnumberregistry {
    ...
    interface ListOrgNumberRegistriesResponse {
      /** A token to retrieve the next page of results, or empty if there are no more results in the list. */
      nextPageToken?: string;
      /** The list of OrgNumberRegistries. */
      orgNumberRegistries?: OrgNumberRegistry[];
      /** Locations that could not be reached. */
      unreachable?: string[];
    }
    ...
    interface OrgNumberRegistriesResource {
      ...
      list(request?: {
        ...
        /** Legacy upload protocol for media (e.g. "media", "multipart"). */
        uploadType?: string;
      }): Request<ListOrgNumberRegistriesResponse>;
    }
    interface LocationsResource {
      operations: OperationsResource;
      orgNumberRegistries: OrgNumberRegistriesResource;
    }
