...
declare namespace gapi.client {
    ...
    function load(urlOrObject: "https://notebooks.googleapis.com/$discovery/rest?version=v1"): Promise<void>;
    ...
    namespace notebooks {
        ...
        interface DiagnoseRuntimeRequest {
            /** Required. Defines flags that are used to run the diagnostic tool */
            diagnosticConfig?:
                DiagnosticConfig;
            /** Optional. Maxmium amount of time in minutes before the operation times out. */
        ...
        interface Disk {
            ...
            boot?:
                boolean;
            /**
             * Indicates a unique device name of your choice that is reflected into the `/dev/disk/by-id/google-*` tree of a Linux operating system running within the instance. This name can be
             * used to reference the device for mounting, resizing, and so on, from within the instance. If not specified, the server chooses a default device name to apply to this disk, in the
             * form persistent-disk-x, where x is a number assigned by Google Compute Engine.This field is only applicable for persistent disks.
             */
            deviceName?:
                string;
            ...
            licenses?:
                string[];
            /**
             * The mode in which to attach this disk, either `READ_WRITE` or `READ_ONLY`. If not specified, the default is to attach the disk in `READ_WRITE` mode. Valid values: * `READ_ONLY` *
             * `READ_WRITE`
             */
            mode?:
                string;
        ...
        interface Instance {
            ...
            machineType?:
                string;
            /**
             * Custom metadata to apply to this instance. For example, to specify a Cloud Storage bucket for automatic backup, you can use the `gcs-data-bucket` metadata tag. Format:
        ...
        interface InstanceMigrationEligibility {
        ...
        interface MigrateInstanceRequest {
            /** Optional. Specifies the behavior of post startup script during migration. */
            postStartupScriptOption?:
                string;
        }
        interface MigrateRuntimeRequest {
            /**
             * Optional. Name of the VPC that the new Instance is in. This is required if the Runtime uses google-managed network. If the Runtime uses customer-owned network, it will reuse the
             * same VPC, and this field must be empty. Format: `projects/{project_id}/global/networks/{network_id}`
             */
            network?:
                string;
            /** Optional. Specifies the behavior of post startup script during migration. */
            ...
            requestId?:
                string;
            /**
             * Optional. The service account to be included in the Compute Engine instance of the new Workbench Instance when the Runtime uses "single user only" mode for permission. If not
             * specified, the [Compute Engine default service account](https://cloud.google.com/compute/docs/access/service-accounts#default_service_account) is used. When the Runtime uses service
             * account mode for permission, it will reuse the same service account, and this field must be empty.
             */
            serviceAccount?:
                string;
            /**
             * Optional. Name of the subnet that the new Instance is in. This is required if the Runtime uses google-managed network. If the Runtime uses customer-owned network, it will reuse the
             * same subnet, and this field must be empty. Format: `projects/{project_id}/regions/{region}/subnetworks/{subnetwork_id}`
             */
            subnet?:
                string;
        }
        ...
        interface ReportInstanceEventRequest {
        ...
        interface Runtime {
            ...
            healthState?:
                string;
            /**
             * Optional. The labels to associate with this Managed Notebook or Runtime. Label **keys** must contain 1 to 63 characters, and must conform to [RFC
             * 1035](https://www.ietf.org/rfc/rfc1035.txt). Label **values** may be empty, but, if present, must contain 1 to 63 characters, and must conform to [RFC
        ...
        interface RuntimeMigrationEligibility {
        ...
        interface SetInstanceAcceleratorRequest {
            /**
             * Required. Count of cores of this accelerator. Note that not all combinations of `type` and `core_count` are valid. See [GPUs on Compute
        ...
        interface UpgradeRuntimeRequest {
            /** Idempotent request UUID. */
            requestId?:
                string;
        }
        interface VertexAIParameters {
            ...
            env?:
                { [P in string]: string };
            /**
             * The full name of the Compute Engine [network](https://cloud.google.com/compute/docs/networks-and-firewalls#networks) to which the Job should be peered. For example,
             * `projects/12345/global/networks/myVPC`. [Format](https://cloud.google.com/compute/docs/reference/rest/v1/networks/insert) is of the form
             * `projects/{project}/global/networks/{network}`. Where `{project}` is a project number, as in `12345`, and `{network}` is a network name. Private services access must already be
        ...
        interface InstancesResource {
            ...
            body: MigrateInstanceRequest): Request<Operation>;
            /**
            ...
            body: ReportInstanceEventRequest): Request<Operation>;
        ...
        interface RuntimesResource {
            ...
            body: DiagnoseRuntimeRequest): Request<Operation>;
            ...
            body: MigrateRuntimeRequest): Request<Operation>;
            ...
            body: UpgradeRuntimeRequest): Request<Operation>;
        }
