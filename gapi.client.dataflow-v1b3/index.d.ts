...
declare namespace gapi.client {
  ...
  namespace dataflow {
    ...
    interface BoundedTrieNode {
      ...
      children?: {[P in string]: BoundedTrieNode};
    ...
    interface GetWorkerStacktracesResponse {
    ...
    interface ListConfigStoreSettingsResponse {
      /** The list of ConfigStoreSettings. */
      configStoreSettings?: ConfigStoreSetting[];
    ...
    interface MetricValue {
      ...
      metricLabels?: {[P in string]: string};
    ...
    interface ResolveConfigStoreSettingRequest {}
    interface ResolveConfigStoreSettingResponse {
      /** The list of settings that were considered during resolution. */
      choices?: ConfigStoreSetting[];
    ...
    interface ConfigStoreSettingsResource {
      ...
      create(request: {
        ...
        uploadType?: string;
        /** Request body */
        resource: ConfigStoreSetting;
      }): Request<ConfigStoreSetting>;
      create(
        request: {
          /** V1 error format. */
          '$.xgafv'?: '1' | '2';
      ...
      list(request?: {
        ...
        /** Legacy upload protocol for media (e.g. "media", "multipart"). */
        uploadType?: string;
      }): Request<ListConfigStoreSettingsResponse>;
      ...
      resolve(request: {
        ...
        uploadType?: string;
        /** Request body */
        resource: ResolveConfigStoreSettingRequest;
      }): Request<ResolveConfigStoreSettingResponse>;
      resolve(
        request: {
          /** V1 error format. */
          '$.xgafv'?: '1' | '2';
    ...
    interface LocationsResource {
      configStoreSettings: ConfigStoreSettingsResource;
    }
    ...
    interface DebugResource {
      ...
      getWorkerStacktraces(request: {
        ...
        uploadType?: string;
        /** Request body */
        resource: GetWorkerStacktracesRequest;
      }): Request<GetWorkerStacktracesResponse>;
