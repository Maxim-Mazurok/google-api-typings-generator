...
declare namespace gapi.client {
    ...
    function load(urlOrObject: "https://datastore.googleapis.com/$discovery/rest?version=v1"): Promise<void>;
    ...
    namespace datastore {
        ...
        interface CommitRequest {
            ...
            mutations?: Mutation[];
            /**
             * Options for beginning a new transaction for this request. The transaction is committed when the request completes. If specified, TransactionOptions.mode must be
        ...
        interface ReadOptions {
            /**
             * Options for beginning a new transaction for this request. The new transaction identifier will be returned in the corresponding response as either LookupResponse.transaction or
        ...
        interface RunAggregationQueryResponse {
            ...
            /**
             * The identifier of the transaction that was started as part of this RunAggregationQuery request. Set only when ReadOptions.begin_transaction was set in
