...
gapi.load('client', async () => {
  ...
  async function run() {
      ...
      },
      {
        blob: {
          ...
          blobstore2Info: {
            ...
            blobId: 'Test string',
            downloadExternalReadToken: 'Test string',
            downloadReadHandle: 'Test string',
            readToken: 'Test string',
            uploadFragmentListCreationInfo: 'Test string',
          ...
          contentTypeInfo: {
            ...
            fromFusionId: 'Test string',
            fromHeader: 'Test string',
            fromUrlPath: 'Test string',
            fusionIdDetectionMetadata: 'Test string',
          },
          cosmoBinaryReference: 'Test string',
          crc32cHash: 42,
    ...
    await gapi.client.firebaseappdistribution.projects.apps.releases.patch(
      ...
      {
        acceptedInvitationCount: 42,
        androidPackageRegistrationState: 'Test string',
        binaryDownloadUri: 'Test string',
        binaryType: 'Test string',
