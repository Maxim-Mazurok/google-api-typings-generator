...
gapi.load('client', async () => {
  ...
  async function run() {
    ...
    /** Gets a Boundary. */
    await gapi.client.apphub.projects.locations.getBoundary({
      name: 'Test string',
    });
    ...
    /** Updates a Boundary. */
    await gapi.client.apphub.projects.locations.updateBoundary(
      {
        name: 'Test string',
    ...
    await gapi.client.apphub.projects.locations.extendedMetadataSchemas.get({
      name: 'Test string',
    });
    /** Lists Extended Metadata Schemas available in a host project and location. */
    await gapi.client.apphub.projects.locations.extendedMetadataSchemas.list({
      pageSize: 42,
      pageToken: 'Test string',
      parent: 'Test string',
    });
