/* Type definitions for non-npm package App Hub API v1alpha 0.0 */
...
// Generated from: https://apphub.googleapis.com/$discovery/rest?version=v1alpha
// Revision: 20260610

/// <reference types="gapi.client" />

declare namespace gapi.client {
  /** Load App Hub API v1alpha */
  function load(
    urlOrObject: 'https://apphub.googleapis.com/$discovery/rest?version=v1alpha',
  ): Promise<void>;
  /** @deprecated Please load APIs with discovery documents. */
  function load(name: 'apphub', version: 'v1alpha'): Promise<void>;
  /** @deprecated Please load APIs with discovery documents. */
  function load(name: 'apphub', version: 'v1alpha', callback: () => any): void;
  ...
  namespace apphub {
    ...
    interface Boundary {
      ...
      type?: 'TYPE_UNSPECIFIED' | 'AUTOMATIC' | 'MANUAL' | 'MANAGED_AUTOMATIC';
      /** Output only. Update time. */
      updateTime?: string;
    }
    ...
    interface ExtendedMetadata {
      ...
      metadataStruct?: {[P in string]: any};
    }
    interface ExtendedMetadataSchema {
    ...
    interface FindUnregisteredServicesResponse {
    ...
    interface FindUnregisteredWorkloadsResponse {
    ...
    interface FunctionalType {
      ...
      type?: 'TYPE_UNSPECIFIED' | 'AGENT' | 'MCP_SERVER' | 'ENDPOINT';
    }
    interface Identity {
    ...
    interface ListExtendedMetadataSchemasResponse {
      /** List of Extended Metadata Schemas. */
      extendedMetadataSchemas?: ExtendedMetadataSchema[];
      /** A token identifying a page of results the server should return. */
      nextPageToken?: string;
    }
    ...
    interface RegistrationType {
      ...
      type?: 'TYPE_UNSPECIFIED' | 'EXCLUSIVE' | 'SHARED';
    }
    interface Scope {
      /** Required. Scope Type. */
      type?: 'TYPE_UNSPECIFIED' | 'REGIONAL' | 'GLOBAL';
    }
    interface Service {
      /** Optional. Consumer provided attributes. */
      attributes?: Attributes;
    ...
    interface ServiceProperties {
      ...
      extendedMetadata?: {[P in string]: ExtendedMetadata};
    ...
    interface DiscoveredServicesResource {
      ...
      findUnregistered(request?: {
        ...
        /** Legacy upload protocol for media (e.g. "media", "multipart"). */
        uploadType?: string;
      }): Request<FindUnregisteredServicesResponse>;
    ...
    interface DiscoveredWorkloadsResource {
      ...
      findUnregistered(request?: {
        ...
        /** Legacy upload protocol for media (e.g. "media", "multipart"). */
        uploadType?: string;
      }): Request<FindUnregisteredWorkloadsResponse>;
    ...
    interface ExtendedMetadataSchemasResource {
      ...
      get(request?: {
        ...
        /** Legacy upload protocol for media (e.g. "media", "multipart"). */
        uploadType?: string;
      }): Request<ExtendedMetadataSchema>;
      ...
      list(request?: {
        ...
        /** Legacy upload protocol for media (e.g. "media", "multipart"). */
        uploadType?: string;
      }): Request<ListExtendedMetadataSchemasResponse>;
    }
    ...
    interface LocationsResource {
      ...
      extendedMetadataSchemas: ExtendedMetadataSchemasResource;
