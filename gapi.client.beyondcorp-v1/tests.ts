...
gapi.load('client', async () => {
  ...
  async function run() {
    ...
    await gapi.client.beyondcorp.projects.locations.securityGateways.setPeering(
      {
        securityGateway: 'Test string',
      },
      {
        peerings: [
          {
            dnsZones: ['Test string'],
    ...
    /** Sets the access control policy on the specified resource. Replaces any existing policy. Can return `NOT_FOUND`, `INVALID_ARGUMENT`, and `PERMISSION_DENIED` errors. */
    await gapi.client.beyondcorp.v.projects.locations.securityGateways.setIamPolicy(
      {
        resource: 'Test string',
      },
      {
