...
gapi.load('client', async () => {
    ...
    async function run() {
        ...
        await gapi.client.beyondcorp.organizations.locations.global.tenants.getIamPolicy({
            "options.requestedPolicyVersion": 42,
            resource: "Test string",
        });
        /** Sets the access control policy on the specified resource. Replaces any existing policy. Can return `NOT_FOUND`, `INVALID_ARGUMENT`, and `PERMISSION_DENIED` errors. */
        await gapi.client.beyondcorp.organizations.locations.global.tenants.setIamPolicy({
            resource: "Test string",
        }, {
            policy: {
                auditConfigs: [
         ...
         */
        await gapi.client.beyondcorp.organizations.locations.global.tenants.testIamPermissions({
            resource: "Test string",
        }, {
            permissions: [
                "Test string"
        ...
        /** Gets the access control policy for a resource. Returns an empty policy if the resource exists and does not have a policy set. */
        await gapi.client.beyondcorp.organizations.locations.global.tenants.proxyConfigs.getIamPolicy({
            "options.requestedPolicyVersion": 42,
            resource: "Test string",
        });
        /** Sets the access control policy on the specified resource. Replaces any existing policy. Can return `NOT_FOUND`, `INVALID_ARGUMENT`, and `PERMISSION_DENIED` errors. */
        await gapi.client.beyondcorp.organizations.locations.global.tenants.proxyConfigs.setIamPolicy({
            resource: "Test string",
        }, {
            policy: {
                auditConfigs: [
         ...
         * operation is designed to be used for building permission-aware UIs and command-line tools, not for authorization checking. This operation may "fail open" without warning.
         */
        await gapi.client.beyondcorp.organizations.locations.global.tenants.proxyConfigs.testIamPermissions({
            resource: "Test string",
        }, {
            permissions: [
                "Test string"
