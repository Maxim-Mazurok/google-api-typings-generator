...
gapi.load('client', async () => {
  ...
  async function run() {
    ...
    await gapi.client.beyondcorp.projects.locations.securityGateways.create(
      ...
      {
        createTime: 'Test string',
        delegatingServiceAccount: 'Test string',
        displayName: 'Test string',
        ...
        name: 'Test string',
        proxyProtocolConfig: {
          allowedClientHeaders: ['Test string'],
          clientIp: true,
          contextualHeaders: {
            deviceInfo: {
              outputType: 'Test string',
            },
            groupInfo: {
              outputType: 'Test string',
            },
    ...
    await gapi.client.beyondcorp.projects.locations.securityGateways.applications.create(
      {
    ...
    await gapi.client.beyondcorp.projects.locations.securityGateways.applications.patch(
      {
        name: 'Test string',
        requestId: 'Test string',
        updateMask: 'Test string',
    ...
    /** Returns permissions that a caller has on the specified resource. If the resource does not exist, this will return an empty set of permissions, not a `NOT_FOUND` error. Note: This operation is designed to be used for building permission-aware UIs and command-line tools, not for authorization checking. This operation may "fail open" without warning. */
    await gapi.client.beyondcorp.projects.locations.securityGateways.applications.testIamPermissions(
      {
        resource: 'Test string',
      },
      {
