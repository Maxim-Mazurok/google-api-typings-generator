...
declare namespace gapi.client {
  ...
  namespace beyondcorp {
    ...
    interface GoogleCloudBeyondcorpSecuritygatewaysV1Hub {
      ...
      natGatewayConfig?: GoogleCloudBeyondcorpSecuritygatewaysV1NatGatewayConfig;
    }
    interface GoogleCloudBeyondcorpSecuritygatewaysV1ListApplicationsResponse {
      /** A list of BeyondCorp Application in the project. */
      applications?: GoogleCloudBeyondcorpSecuritygatewaysV1Application[];
      /** A token to retrieve the next page of results, or empty if there are no more results in the list. */
      nextPageToken?: string;
      /** A list of locations that could not be reached. */
      unreachable?: string[];
    }
    interface GoogleCloudBeyondcorpSecuritygatewaysV1ListSecurityGatewaysResponse {
      /** A token to retrieve the next page of results, or empty if there are no more results in the list. */
      nextPageToken?: string;
      /** A list of BeyondCorp SecurityGateway in the project. */
      securityGateways?: GoogleCloudBeyondcorpSecuritygatewaysV1SecurityGateway[];
      /** A list of locations that could not be reached. */
      unreachable?: string[];
    }
    interface GoogleCloudBeyondcorpSecuritygatewaysV1NatGatewayConfig {
      /** Output only. List of NAT IPs that will be used for establishing connection to the endpoints. */
      natIps?: string[];
    }
    interface GoogleCloudBeyondcorpSecuritygatewaysV1Peering {
    ...
    interface GoogleCloudBeyondcorpSecuritygatewaysV1SetPeeringRequest {
      /** Optional. An optional request ID to identify requests. Specify a unique request ID so that if you must retry your request, the server will know to ignore the request if it has already been completed. The server will guarantee that for at least 60 minutes since the first request. For example, consider a situation where you make an initial request and the request times out. If you make the request again with the same request ID, the server can check if original operation with the same request ID was received, and if so, will ignore the second request. This prevents clients from accidentally creating duplicate commitments. The request ID must be a valid UUID with the exception that zero UUID is not supported (00000000-0000-0000-0000-000000000000). */
      requestId?: string;
      /** Optional. If set, validates request by executing a dry-run which would not alter the resource in any way. */
      validateOnly?: boolean;
      /** Required. List of Peering connection information. */
      vpcPeerings?: GoogleCloudBeyondcorpSecuritygatewaysV1Peering[];
    }
    ...
    interface ApplicationsResource {
      ...
      get(request?: {
        ...
        /** Legacy upload protocol for media (e.g. "media", "multipart"). */
        uploadType?: string;
      }): Request<GoogleCloudBeyondcorpSecuritygatewaysV1Application>;
    ...
    interface SecurityGatewaysResource {
      ...
      create(request: {
        ...
        uploadType?: string;
        /** Request body */
        resource: GoogleCloudBeyondcorpSecuritygatewaysV1SecurityGateway;
      }): Request<GoogleLongrunningOperation>;
      create(
        request: {
          /** V1 error format. */
      ...
      get(request?: {
        ...
        /** Legacy upload protocol for media (e.g. "media", "multipart"). */
        uploadType?: string;
      }): Request<GoogleCloudBeyondcorpSecuritygatewaysV1SecurityGateway>;
      ...
      list(request?: {
        ...
        /** Legacy upload protocol for media (e.g. "media", "multipart"). */
        uploadType?: string;
      }): Request<GoogleCloudBeyondcorpSecuritygatewaysV1ListSecurityGatewaysResponse>;
      ...
      setPeering(request: {
        ...
        uploadType?: string;
        /** Request body */
        resource: GoogleCloudBeyondcorpSecuritygatewaysV1SetPeeringRequest;
      }): Request<GoogleLongrunningOperation>;
      setPeering(
        request: {
          /** V1 error format. */
        ...
        body: GoogleCloudBeyondcorpSecuritygatewaysV1SetPeeringRequest
      ): Request<GoogleLongrunningOperation>;
      applications: ApplicationsResource;
    }
    interface LocationsResource {
