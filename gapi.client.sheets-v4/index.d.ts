    ...
    namespace sheets {
        ...
        interface ValuesResource {
            ...
            get(request?: {
                ...
                key?: string;
                /**
                 * The major dimension that results should use. For example, if the spreadsheet data in Sheet1 is: `A1=1,B1=2,A2=3,B2=4`, then requesting `range=Sheet1!A1:B2?majorDimension=ROWS`
                 * returns `[[1,2],[3,4]]`, whereas requesting `range=Sheet1!A1:B2?majorDimension=COLUMNS` returns `[[1,3],[2,4]]`.
                 */
                majorDimension?: string;
                /** OAuth 2.0 token for the current user. */
                oauth_token?: string;
