# TypeScript typings for Authorized Buyers Marketplace API v1beta
...
```
npm install @types/gapi.client.authorizedbuyersmarketplace-v1beta --save-dev
```
...
```json
{
  "compilerOptions": {
    "types": [
      ...
      "gapi.auth2",
      "gapi.client",
      "gapi.client.authorizedbuyersmarketplace-v1beta"
    ]
  }
}
```
...
gapi.client.load('authorizedbuyersmarketplace', 'v1beta', () => {
  // now we can use:
  // gapi.client.authorizedbuyersmarketplace
});
```
