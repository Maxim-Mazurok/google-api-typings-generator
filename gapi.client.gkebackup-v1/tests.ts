...
gapi.load('client', async () => {
  ...
  async function run() {
    ...
    await gapi.client.gkebackup.projects.locations.backupPlans.getTags({
      name: 'Test string',
    });
    ...
    await gapi.client.gkebackup.projects.locations.backupPlans.setTags(
      {
        name: 'Test string',
      },
      {
    ...
    /** Returns tags directly bound to a GCP resource. */
    await gapi.client.gkebackup.projects.locations.restorePlans.getTags({
      name: 'Test string',
    });
    ...
    /** Updates tags directly bound to a GCP resource. */
    await gapi.client.gkebackup.projects.locations.restorePlans.setTags(
      {
        name: 'Test string',
      },
      {
