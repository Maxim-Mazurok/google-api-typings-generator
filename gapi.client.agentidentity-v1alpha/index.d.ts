/* Type definitions for non-npm package Agent Identity API v1alpha 0.0 */
...
// Generated from: https://agentidentity.googleapis.com/$discovery/rest?version=v1alpha
// Revision: 20260722

/// <reference types="gapi.client" />

declare namespace gapi.client {
  /** Load Agent Identity API v1alpha */
  function load(
    urlOrObject: 'https://agentidentity.googleapis.com/$discovery/rest?version=v1alpha',
  ): Promise<void>;
  /** @deprecated Please load APIs with discovery documents. */
  function load(name: 'agentidentity', version: 'v1alpha'): Promise<void>;
  /** @deprecated Please load APIs with discovery documents. */
  function load(
    name: 'agentidentity',
    version: 'v1alpha',
