    ...
    namespace iap {
        ...
        interface DestGroupsResource {
            ...
            create(request: {
                ...
                quotaUser?: string;
                /**
                 * Required. The ID to use for the TunnelDestGroup, which will become the final component of the resource name. This value should be 4-63 characters, and valid characters are
                 * /a-z-/.
                 */
            ...
            list(request?: {
                ...
                oauth_token?: string;
                /**
                 * The maximum number of groups to return. The service may return fewer than this value. If unspecified, at most 100 groups will be returned. The maximum value is 1000; values
                 * above 1000 will be coerced to 1000.
                 */
                pageSize?: number;
                /**
                ...
                pageToken?: string;
                /**
                 * Required. GCP Project number/id and location. In the following format: projects/{project_number/id}/iap_tunnel/locations/{location}. A `-` can be used for the location to group
