/* Type definitions for non-npm package Apigee Registry API v1 1.0 */
...
declare namespace gapi.client {
    ...
    function load(name: "apigeeregistry", version: "v1"): PromiseLike<void>;
    ...
    namespace apigeeregistry {
        ...
        interface DeploymentsResource {
            ...
            patch(request: {
                ...
                quotaUser?: string;
                /**
                 * The list of fields to be updated. If omitted, all fields are updated that are set in the request message (fields set to default values are ignored). If a "*" is specified, all
        ...
        interface SpecsResource {
            ...
            /**
             * GetApiSpecContents returns the contents of a specified spec. If specs are stored with GZip compression, the default behavior is to return the spec uncompressed (the mime_type
