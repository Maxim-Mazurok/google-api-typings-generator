...
declare namespace gapi.client {
    ...
    namespace bigquery {
        ...
        interface Model {
            ...
            creationTime?: string;
            /**
             * Output only. The default trial_id to use in TVFs when the trial_id is not passed in. For single-objective hyperparameter tuning, this is the best trial id. For multi-objective
            ...
            modelType?: string;
            /**
             * Output only. For single-objective hyperparameter tuning, it only contains the best trial. For multi-objective hyperparameter tuning, it contains all Pareto optimal trials sorted by
             * trial_id.
             */
