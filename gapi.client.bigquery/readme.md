...
*/
await gapi.client.routines.delete({ datasetId: "datasetId", routineId: "routineId", projectId: "projectId",  }); 
...
role.  
*/
await gapi.client.routines.list({ projectId: "projectId", datasetId: "datasetId",  }); 
