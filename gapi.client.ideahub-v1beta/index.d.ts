/* Type definitions for non-npm package Idea Hub API v1beta 0.0 */
...
declare namespace gapi.client {
    ...
    function load(urlOrObject: "https://ideahub.googleapis.com/$discovery/rest?version=v1beta"): Promise<void>;
    /** @deprecated Please load APIs with discovery documents. */
    function load(name: "ideahub", version: "v1beta"): Promise<void>;
    /** @deprecated Please load APIs with discovery documents. */
