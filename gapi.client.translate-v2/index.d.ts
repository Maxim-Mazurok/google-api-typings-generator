...
declare namespace gapi.client {
    ...
    function load(urlOrObject: "https://translation.googleapis.com/$discovery/rest?version=v2"): Promise<void>;
    ...
    namespace language {
        ...
        interface LanguagesListResponse {
            /**
             * List of source/target languages supported by the translation API. If target parameter is unspecified, the list is sorted by the ASCII code point order of the language code. If
             * target parameter is specified, the list is sorted by the collation order of the language name in the target language.
             */
        ...
        interface DetectionsResource {
            ...
            detect(request: {
                ...
                prettyPrint?: boolean;
                /**
                 * Available to use for quota purposes for server-side applications. Can be any arbitrary string assigned to a user, but should not exceed 40 characters. Overrides userIp if both
                 * are provided.
                 */
                quotaUser?: string;
