/* Type definitions for non-npm package Cloud Location Finder API v1alpha 0.0 */
...
// Generated from: https://cloudlocationfinder.googleapis.com/$discovery/rest?version=v1alpha
// Revision: 20260909

/// <reference types="gapi.client" />

declare namespace gapi.client {
  /** Load Cloud Location Finder API v1alpha */
  function load(
    urlOrObject: 'https://cloudlocationfinder.googleapis.com/$discovery/rest?version=v1alpha',
  ): Promise<void>;
  /** @deprecated Please load APIs with discovery documents. */
  function load(name: 'cloudlocationfinder', version: 'v1alpha'): Promise<void>;
  /** @deprecated Please load APIs with discovery documents. */
  function load(
  ...
  namespace cloudlocationfinder {
    ...
    interface GcpAttributes {
      ...
      zoneType?: 'GCP_ZONE_TYPE_UNSPECIFIED' | 'GENERAL_PURPOSE' | 'AI_ZONE';
    }
