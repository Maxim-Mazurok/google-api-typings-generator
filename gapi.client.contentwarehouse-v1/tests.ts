...
gapi.load('client', async () => {
    ...
    async function run() {
        ...
        await gapi.client.contentwarehouse.projects.locations.dataExportJobs.archiveDataExportJob({
            name: "Test string",
        });
        /** Creates a data export job. */
        await gapi.client.contentwarehouse.projects.locations.dataExportJobs.create({
            parent: "Test string",
        }, {
