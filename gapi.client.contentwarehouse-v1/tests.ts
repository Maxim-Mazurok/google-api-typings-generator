...
gapi.load('client', async () => {
    ...
    async function run() {
        ...
        await gapi.client.contentwarehouse.projects.locations.collections.create({
            parent: "Test string",
        }, {
            allowLinkDocuments: true,
            attributes: {
                A: 42
            },
            ...
            name: "Test string",
            parentCollectionId: "Test string",
            revokeDocEditPermission: true,
            updateTime: "Test string",
        });
        /** Deletes a collection. */
        await gapi.client.contentwarehouse.projects.locations.collections.delete({
            name: "Test string",
        });
        /**
         * Gets the access control policy for the collection. Returns NOT_FOUND error if the collection does not exist. Returns an empty policy if the collection exists but does not have a policy
         * set.
         */
        await gapi.client.contentwarehouse.projects.locations.collections.fetchCollectionAcl({
            name: "Test string",
        }, {
            requestMetadata: {
                userInfo: {
        ...
        /** Gets a collection. */
        await gapi.client.contentwarehouse.projects.locations.collections.get({
            name: "Test string",
        });
        ...
        await gapi.client.contentwarehouse.projects.locations.collections.search({
            parent: "Test string",
        }, {
            pageSize: 42,
        ...
        await gapi.client.contentwarehouse.projects.locations.collections.setCollectionAcl({
            name: "Test string",
        }, {
            policy: {
                auditConfigs: [
        ...
        /** Creates a link. */
        await gapi.client.contentwarehouse.projects.locations.links.create({
            parent: "Test string",
        }, {
            attributes: {
                A: 42
        ...
        await gapi.client.contentwarehouse.projects.locations.links.delete({
            name: "Test string",
        });
        /** Gets a link. */
        await gapi.client.contentwarehouse.projects.locations.links.get({
            name: "Test string",
        });
        /** Updates the link using provided UpdateLinkRequest. */
        await gapi.client.contentwarehouse.projects.locations.links.patch({
            linksId: "Test string",
            name: "Test string",
        }, {
            attributes: {
