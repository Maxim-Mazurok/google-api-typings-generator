/* Type definitions for non-npm package Cloud Source Repositories API v1 0.0 */
...
declare namespace gapi.client {
    ...
    function load(urlOrObject: "https://sourcerepo.googleapis.com/$discovery/rest?version=v1"): Promise<void>;
    /** @deprecated Please load APIs with discovery documents. */
    function load(name: "sourcerepo", version: "v1"): Promise<void>;
    /** @deprecated Please load APIs with discovery documents. */
    ...
    namespace sourcerepo {
        ...
        interface ProjectConfig {
            ...
            pubsubConfigs?: { [P in string]: PubsubConfig };
        }
        ...
        interface ReposResource {
            ...
            body: UpdateRepoRequest): Request<Repo>;
            ...
            body: SyncRepoRequest): Request<Operation>;
        ...
        interface ProjectsResource {
            ...
            updateConfig(request: {
                ...
                uploadType?: string;
                /** Request body */
                resource: UpdateProjectConfigRequest;
            }): Request<ProjectConfig>;
            updateConfig(request: {
                /** V1 error format. */
                "$.xgafv"?: string;
            ...
            body: UpdateProjectConfigRequest): Request<ProjectConfig>;
            repos: ReposResource;
        }
