/* This is stub file for gapi.client.datafusion-v1 definition tests */
// IMPORTANT
  ...
  async function run() {
    ...
    await gapi.client.datafusion.projects.locations.instances.create(
      ...
      },
      {
        ...
        dataplexDataLineageIntegrationEnabled: true,
        dataprocServiceAccount: 'Test string',
        description: 'Test string',
        disabledReason: ['Test string'],
        ...
        loggingConfig: {
          enableInstanceV2Logs: true,
          instanceCloudLoggingDisabled: true,
        },
        maintenanceEvents: [
          {
            endTime: 'Test string',
        ...
        networkConfig: {
          ...
          privateServiceConnectConfig: {
            effectiveUnreachableCidrBlock: 'Test string',
            networkAttachment: 'Test string',
            unreachableCidrBlock: 'Test string',
          },
        },
        options: {
          A: 'Test string',
