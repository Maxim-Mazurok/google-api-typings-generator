...
gapi.load('client', async () => {
  ...
  async function run() {
    ...
    await gapi.client.documentai.projects.locations.processors.create(
      ...
      {
        activeSchemaVersion: 'Test string',
    ...
    await gapi.client.documentai.projects.locations.processors.process(
      ...
      },
      {
        ...
        inlineDocument: {
          ...
          entitiesRevisionId: 'Test string',
          entitiesRevisions: [
            {
              entities: [
                {
              ...
              entityValidationOutput: {
                ...
                validationResults: [
                  {
                    rule: 'Test string',
                    ruleDescription: 'Test string',
                    ruleName: 'Test string',
                    validationDetails: 'Test string',
                    validationResultType: 'Test string',
                  },
                ],
              },
              provenance: {
    ...
    await gapi.client.documentai.projects.locations.processors.processorVersions.train(
      ...
      },
      {
        ...
        foundationModelTuningOptions: {
          ...
          previousFineTunedProcessorVersionName: 'Test string',
          trainSteps: 42,
        },
        inputData: {
          testDocuments: {
        ...
        processorVersion: {
          ...
          genAiModelInfo: {
            customGenAiModelInfo: {
              baseProcessorVersionId: 'Test string',
              customModelType: 'Test string',
            },
            foundationGenAiModelInfo: {
              finetuningAllowed: true,
              minTrainLabeledDocuments: 42,
            },
          },
          googleManaged: true,
          kmsKeyName: 'Test string',
    ...
    /** Creates a schema. */
    await gapi.client.documentai.projects.locations.schemas.create(
      {
        parent: 'Test string',
      },
      {
    ...
    /** Deletes a schema. */
    await gapi.client.documentai.projects.locations.schemas.delete({
      force: true,
      name: 'Test string',
    });
    /** Gets a schema. */
    await gapi.client.documentai.projects.locations.schemas.get({
      name: 'Test string',
    });
    /** Lists Schemas. */
    await gapi.client.documentai.projects.locations.schemas.list({
      pageSize: 42,
      pageToken: 'Test string',
      parent: 'Test string',
    });
    /** Updates a schema. Editable fields are: - `display_name` - `labels` */
    await gapi.client.documentai.projects.locations.schemas.patch(
      {
        name: 'Test string',
    ...
    await gapi.client.documentai.projects.locations.schemas.schemaVersions.create(
      {
        parent: 'Test string',
      },
      {
    ...
    await gapi.client.documentai.projects.locations.schemas.schemaVersions.delete(
      {
        name: 'Test string',
      },
    );
    /** Generates a schema version. */
    await gapi.client.documentai.projects.locations.schemas.schemaVersions.generate(
      {
        parent: 'Test string',
      },
      {
        baseSchemaVersion: 'Test string',
        gcsDocuments: {
          documents: [
            {
              gcsUri: 'Test string',
    ...
    await gapi.client.documentai.projects.locations.schemas.schemaVersions.get({
      name: 'Test string',
    });
    /** Lists SchemaVersions. */
    await gapi.client.documentai.projects.locations.schemas.schemaVersions.list(
      {
        pageSize: 42,
        pageToken: 'Test string',
        parent: 'Test string',
    ...
    await gapi.client.documentai.projects.locations.schemas.schemaVersions.patch(
      {
        name: 'Test string',
        updateMask: 'Test string',
      },
