...
gapi.load('client', async () => {
  ...
  async function run() {
    ...
    await gapi.client.health.shl.m.getShlManifest(
      {
        externalShlId: 'Test string',
      },
      {
        embeddedLengthMax: 42,
        passcode: 'Test string',
        recipient: 'Test string',
      },
    );
    /** Forward a resource request for a given SHL */
    await gapi.client.health.shl.r.get({
      externalShlId: 'Test string',
      resourceToken: 'Test string',
    });
    ...
    await gapi.client.health.users.dataTypes.dataPoints.create(
      ...
      },
      {
        ...
        heartRateVariability: {
          metadata: {
            highFrequencyPower: 42,
            lowFrequencyPower: 42,
          },
