...
declare namespace gapi.client {
  ...
  namespace checks {
    ...
    interface GoogleChecksAisafetyV1alphaClassifyContentRequest {
      ...
      policies?: GoogleChecksAisafetyV1alphaClassifyContentRequestPolicyConfig[];
    }
    ...
    interface GoogleChecksAisafetyV1alphaClassifyContentResponsePolicyResult {
      /** Type of the policy. */
      policyType?: string;
    ...
    interface GoogleChecksRepoScanV1alphaCliAnalysis {
      /** Optional. Requested code scans resulting from preliminary CLI analysis. */
      codeScans?: GoogleChecksRepoScanV1alphaCodeScan[];
      /** Optional. Data sources detected in the scan. */
      sources?: GoogleChecksRepoScanV1alphaSource[];
    }
    ...
    interface GoogleChecksRepoScanV1alphaCodeScan {
      /** Optional. Data type classification requests. */
      dataTypeClassifications?: GoogleChecksRepoScanV1alphaCodeScanDataTypeClassification[];
      /** Required. Source code to analyze. */
      sourceCode?: GoogleChecksRepoScanV1alphaSourceCode;
    }
    interface GoogleChecksRepoScanV1alphaCodeScanDataTypeClassification {
    ...
    interface GoogleChecksRepoScanV1alphaListRepoScansResponse {
      /** A token which can be sent as `page_token` to retrieve the next page. If this field is omitted, there are no subsequent pages. */
      nextPageToken?: string;
      /** The repo scans for the specified app. */
      repoScans?: GoogleChecksRepoScanV1alphaRepoScan[];
    }
    ...
    interface GoogleChecksRepoScanV1alphaSource {
    ...
    interface ScansResource {
      ...
      generate(request: {
        ...
        uploadType?: string;
        /** Request body */
        resource: GoogleChecksRepoScanV1alphaGenerateScanRequest;
      }): Request<Operation>;
      generate(
        request: {
          /** V1 error format. */
      ...
      get(request?: {
        ...
        /** Legacy upload protocol for media (e.g. "media", "multipart"). */
        uploadType?: string;
      }): Request<GoogleChecksRepoScanV1alphaRepoScan>;
      ...
      list(request?: {
        ...
        /** Legacy upload protocol for media (e.g. "media", "multipart"). */
        uploadType?: string;
      }): Request<GoogleChecksRepoScanV1alphaListRepoScansResponse>;
    }
    ...
    interface AisafetyResource {
      ...
      classifyContent(request: {
        ...
        uploadType?: string;
        /** Request body */
        resource: GoogleChecksAisafetyV1alphaClassifyContentRequest;
    ...
    const aisafety: AisafetyResource;
