...
declare namespace gapi.client {
  ...
  namespace dataproc {
    ...
    interface AnalyzeOperationMetadata {
      ...
      analyzedWorkloadType?: 'WORKLOAD_TYPE_UNSPECIFIED' | 'BATCH';
    ...
    interface AttachmentOperationMetadata {
    ...
    interface AutoscalingPolicy {
      ...
      clusterType?: 'CLUSTER_TYPE_UNSPECIFIED' | 'STANDARD' | 'ZERO_SCALE';
    ...
    interface ClusterConfig {
      ...
      engine?: 'ENGINE_UNSPECIFIED' | 'DEFAULT' | 'LIGHTNING';
    ...
    interface ClusterOperationStatus {
      ...
      state?: 'UNKNOWN' | 'PENDING' | 'RUNNING' | 'DONE';
    ...
    interface CohortInfo {
      ...
      cohortSource?: 'COHORT_SOURCE_UNSPECIFIED' | 'USER_PROVIDED' | 'AIRFLOW';
    }
    interface ComputeTuningConfigResponse {
      /** Recommended Spark properties for the query (e.g., {"spark.sql.shuffle.partitions": "500"}). */
      recommendedProperties?: {[P in string]: string};
    }
    ...
    interface DiskConfig {
      ...
      attachedDiskConfigs?: AttachedDiskConfig[];
    ...
    interface InstanceFlexibilityPolicy {
      ...
      instanceMachineTypes?: {[P in string]: string};
    ...
    interface Session {
      ...
      stateHistory?: SessionStateHistory[];
    ...
    interface SparkApplicationsResource {
      ...
      computeTuningConfig(request?: {
        ...
        /** Legacy upload protocol for media (e.g. "media", "multipart"). */
        uploadType?: string;
      }): Request<ComputeTuningConfigResponse>;
    ...
    interface SessionsResource {
      ...
      terminate(request: {
        ...
        uploadType?: string;
        /** Request body */
        resource: TerminateSessionRequest;
      }): Request<Operation>;
      terminate(
        request: {
          /** V1 error format. */
    ...
    interface LocationsResource {
      ...
      sessionTemplates: SessionTemplatesResource;
