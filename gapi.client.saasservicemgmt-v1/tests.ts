/* This is stub file for gapi.client.saasservicemgmt-v1 definition tests */
// IMPORTANT
  ...
  async function run() {
    ...
    await gapi.client.saasservicemgmt.projects.locations.rollouts.create(
      ...
      },
      {
        ...
        stats: {
          estimatedTotalUnitCount: 'Test string',
          operationsByState: [
            {
              count: 42,
              group: 'Test string',
    ...
    await gapi.client.saasservicemgmt.projects.locations.saasReleases.create(
      {
        parent: 'Test string',
        requestId: 'Test string',
        saasReleaseId: 'Test string',
        validateOnly: true,
      },
      {
        annotations: {
    ...
    await gapi.client.saasservicemgmt.projects.locations.saasReleases.delete({
      etag: 'Test string',
      name: 'Test string',
      requestId: 'Test string',
      validateOnly: true,
    ...
    await gapi.client.saasservicemgmt.projects.locations.saasReleases.get({
      name: 'Test string',
    });
    /** Retrieve a collection of saas releases. */
    await gapi.client.saasservicemgmt.projects.locations.saasReleases.list({
      filter: 'Test string',
      orderBy: 'Test string',
      pageSize: 42,
      pageToken: 'Test string',
    ...
    await gapi.client.saasservicemgmt.projects.locations.unitGroupOperations.create(
      {
        parent: 'Test string',
        requestId: 'Test string',
        unitGroupOperationId: 'Test string',
        validateOnly: true,
      },
      {
        annotations: {
    ...
    await gapi.client.saasservicemgmt.projects.locations.unitGroupOperations.delete(
      {
        etag: 'Test string',
        name: 'Test string',
        requestId: 'Test string',
    ...
    await gapi.client.saasservicemgmt.projects.locations.unitGroupOperations.get(
      {
        name: 'Test string',
      },
    );
    /** Retrieve a collection of unit group operations. */
    await gapi.client.saasservicemgmt.projects.locations.unitGroupOperations.list(
      {
        filter: 'Test string',
        orderBy: 'Test string',
        pageSize: 42,
    ...
    await gapi.client.saasservicemgmt.projects.locations.unitGroups.create(
      {
        parent: 'Test string',
        requestId: 'Test string',
        unitGroupId: 'Test string',
        validateOnly: true,
      },
      {
        annotations: {
    ...
    await gapi.client.saasservicemgmt.projects.locations.unitGroups.delete({
      etag: 'Test string',
      name: 'Test string',
      requestId: 'Test string',
      validateOnly: true,
    ...
    await gapi.client.saasservicemgmt.projects.locations.unitGroups.get({
      name: 'Test string',
    });
    /** Retrieve a collection of unit groups. */
    await gapi.client.saasservicemgmt.projects.locations.unitGroups.list({
      filter: 'Test string',
      orderBy: 'Test string',
      pageSize: 42,
      pageToken: 'Test string',
    ...
    await gapi.client.saasservicemgmt.projects.locations.unitKinds.create(
      ...
      },
      {
        ...
        boundaryType: 'Test string',
        createTime: 'Test string',
        defaultFlagRevisions: ['Test string'],
