...
gapi.load('client', async () => {
  ...
  async function run() {
    ...
    await gapi.client.saasservicemgmt.operations.cancel(
      {
        name: 'Test string',
      },
      {},
    ...
    await gapi.client.saasservicemgmt.operations.delete({
      name: 'Test string',
    });
    /** Gets the latest state of a long-running operation. Clients can use this method to poll the operation result at intervals as recommended by the API service. */
    await gapi.client.saasservicemgmt.operations.get({
      name: 'Test string',
    });
    /** Lists operations that match the specified filter in the request. If the server doesn't support this method, it returns `UNIMPLEMENTED`. */
    await gapi.client.saasservicemgmt.operations.list({
      filter: 'Test string',
      name: 'Test string',
      pageSize: 42,
    ...
    await gapi.client.saasservicemgmt.projects.locations.saasTypes.create(
      {
        parent: 'Test string',
        requestId: 'Test string',
        saasTypeId: 'Test string',
        validateOnly: true,
      },
      {
        annotations: {
    ...
    await gapi.client.saasservicemgmt.projects.locations.saasTypes.delete({
      etag: 'Test string',
      name: 'Test string',
      requestId: 'Test string',
      validateOnly: true,
    ...
    await gapi.client.saasservicemgmt.projects.locations.saasTypes.get({
      name: 'Test string',
    });
    /** Retrieve a collection of saas types. */
    await gapi.client.saasservicemgmt.projects.locations.saasTypes.list({
      filter: 'Test string',
      orderBy: 'Test string',
      pageSize: 42,
      pageToken: 'Test string',
    ...
    await gapi.client.saasservicemgmt.projects.locations.saasTypes.patch(
      {
        name: 'Test string',
        requestId: 'Test string',
        updateMask: 'Test string',
