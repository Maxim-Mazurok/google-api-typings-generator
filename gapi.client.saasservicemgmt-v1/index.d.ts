/* Type definitions for non-npm package SaaS Runtime API v1 0.0 */
...
// Generated from: https://saasservicemgmt.googleapis.com/$discovery/rest?version=v1
// Revision: 20260225

/// <reference types="gapi.client" />

declare namespace gapi.client {
  /** Load SaaS Runtime API v1 */
  function load(
    urlOrObject: 'https://saasservicemgmt.googleapis.com/$discovery/rest?version=v1',
  ): Promise<void>;
  /** @deprecated Please load APIs with discovery documents. */
  function load(name: 'saasservicemgmt', version: 'v1'): Promise<void>;
  /** @deprecated Please load APIs with discovery documents. */
  function load(
  ...
  namespace saasservicemgmt {
    ...
    interface ListSaasTypesResponse {
      /** If present, the next page token can be provided to a subsequent ListSaasTypes call to list the next page. If empty, there are no more pages. */
      nextPageToken?: string;
      /** The resulting saas types. */
      saasTypes?: SaasType[];
      /** Locations that could not be reached. */
      unreachable?: string[];
    }
    ...
    interface SaasTypesResource {
      ...
      create(request: {
        ...
        /** An optional request ID to identify requests. Specify a unique request ID so that if you must retry your request, the server will know to ignore the request if it has already been completed. The server will guarantee that for at least 60 minutes since the first request. For example, consider a situation where you make an initial request and the request times out. If you make the request again with the same request ID, the server can check if original operation with the same request ID was received, and if so, will ignore the second request. This prevents clients from accidentally creating duplicate commitments. The request ID must be a valid UUID with the exception that zero UUID is not supported (00000000-0000-0000-0000-000000000000). */
        requestId?: string;
        /** Required. The ID value for the new saas type. */
        saasTypeId?: string;
        /** Upload protocol for media (e.g. "raw", "multipart"). */
        upload_protocol?: string;
        /** Legacy upload protocol for media (e.g. "media", "multipart"). */
      ...
      list(request?: {
        ...
        /** Order results as specified in https://google.aip.dev/132. */
        orderBy?: string;
        /** The maximum number of saas types to send per page. */
        pageSize?: number;
        /** The page token: If the next_page_token from a previous response is provided, this request will send the subsequent page. */
        pageToken?: string;
        /** Required. The parent of the saas type. */
