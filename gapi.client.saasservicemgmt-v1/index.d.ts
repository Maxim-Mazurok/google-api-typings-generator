/* Type definitions for non-npm package App Lifecycle Manager API v1 0.0 */
...
declare namespace gapi.client {
  /** Load App Lifecycle Manager API v1 */
  function load(
  ...
  namespace saasservicemgmt {
    ...
    interface DeprovisionUnitGroup {}
    interface DetachUnitGroup {}
    interface Empty {}
    ...
    interface TierMapping {
      /** Required. The tier. */
      tier?: string;
      unitKinds?: TierUnitKind[];
    }
    interface TierUnitKind {
