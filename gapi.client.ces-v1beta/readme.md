# TypeScript typings for Gemini Enterprise for Customer Experience API v1beta
...
```
npm install @types/gapi.client.ces-v1beta --save-dev
```
...
{
  "compilerOptions": {
    "types": ["gapi", "gapi.auth2", "gapi.client", "gapi.client.ces-v1beta"]
  }
}
```
...
For provenance information see [Provenance section on NPM](https://www.npmjs.com/package/@maxim_mazurok/gapi.client.ces-v1beta#Provenance:~:text=none-,Provenance,-Built%20and%20signed)
