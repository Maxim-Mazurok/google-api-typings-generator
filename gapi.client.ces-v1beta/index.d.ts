...
// Project: https://docs.cloud.google.com/customer-engagement-ai/conversational-agents/ps
...
declare namespace gapi.client {
  ...
  namespace ces {
    ...
    interface AgentRegistryDeployment {
    ...
    interface AudioProcessingConfig {
      ...
      customVoiceSamples?: CustomVoiceSample[];
    ...
    interface ChannelProfileInstagramConfig {
    ...
    interface ChannelProfileWhatsAppConfig {
      /** Output only. The description of the Meta business page or profile. */
      description?: string;
      /** Output only. The fetched Meta business page name. */
      displayName?: string;
    ...
    interface Citations {
      ...
      inlineCitations?: CitationsInlineCitation[];
    }
    ...
    interface CitationsInlineCitation {
    ...
    interface DataStoreToolSnippetsConfig {
    ...
    interface DeployChannelResponse {
    ...
    interface Empty {}
    interface EndpointControlPolicy {
    ...
    interface ErrorHandlingSettingsEndSessionConfig {
    ...
    interface ErrorHandlingSettingsFallbackResponseConfig {
      ...
      customFallbackMessages?: {[P in string]: string};
    ...
    interface EvaluationConfig {
      ...
      evaluationChannel?: 'EVALUATION_CHANNEL_UNSPECIFIED' | 'TEXT' | 'AUDIO';
    ...
    interface EvaluationMetricsConfig {
    ...
    interface EvaluationMetricsConfigHallucinationMetricsConfig {
      /** Optional. Whether to calculate hallucination metrics for the evaluation. */
      enableHallucinationMetrics?: boolean;
    }
    interface EvaluationMetricsConfigScenarioMetricsConfig {
    ...
    interface EvaluationResult {
      ...
      evaluationStatus?: 'OUTCOME_UNSPECIFIED' | 'PASS' | 'FAIL' | 'SKIPPED';
      ...
      goldenRunMethod?: 'GOLDEN_RUN_METHOD_UNSPECIFIED' | 'STABLE' | 'NAIVE';
      ...
      outcomeMetadata?: 'OUTCOME_METADATA_UNSPECIFIED' | 'GRACEFUL_HANDOFF';
    ...
    interface EvaluationResultEvaluationExpectationResult {
      ...
      outcome?: 'OUTCOME_UNSPECIFIED' | 'PASS' | 'FAIL' | 'SKIPPED';
    ...
    interface EvaluationResultGoldenExpectationOutcome {
      ...
      observedPayload?: {[P in string]: any};
    ...
    interface EvaluationRunCachingSettings {
    ...
    interface ExperimentConfigVersionRelease {
      /** Optional. State of the version release. */
      state?: 'STATE_UNSPECIFIED' | 'PENDING' | 'RUNNING' | 'DONE' | 'EXPIRED';
      /** Optional. Traffic allocations for the version release. */
      trafficAllocations?: ExperimentConfigVersionReleaseTrafficAllocation[];
    }
    interface ExperimentConfigVersionReleaseTrafficAllocation {
    ...
    interface ExportEvaluationResultsRequest {
    ...
    interface ExportEvaluationResultsResponse {
    ...
    interface ExportEvaluationsRequest {
    ...
    interface ExportEvaluationsResponse {
      ...
      failedEvaluations?: {[P in string]: string};
    }
    ...
    interface FileContextFileBytes {
    ...
    interface GenerateAppResourceRequest {
      ...
      evaluationPersonasGenerationConfig?: any;
      ...
      refineInstructions?: GenerateAppResourceRequestRefineInstructions[];
    ...
    interface GenerateAppResourceRequestAppGenerationConfig {
    ...
    interface GenerateAppResourceRequestAppVersionContext {
    ...
    interface GenerateAppResourceRequestEvaluationGenerationConfig {
    ...
    interface GenerateAppResourceRequestEvaluationPersonasGenerationConfig {}
    interface GenerateAppResourceRequestHillClimbingFixConfig {
      /** Required. The quality report used to inform the instruction following fix. */
      qualityReport?: QualityReport;
    }
    interface GenerateAppResourceRequestQualityReportGenerationConfig {
    ...
    interface GenerateAppResourceRequestRefineInstructions {
    ...
    interface GenerateAppResourceRequestToolGenerationConfig {
    ...
    interface GenerateAppResourceRequestToolGenerationConfigOpenApiToolsetGenerationConfig {
      /** Required. The list of operations to be added to the Open API schema. */
      operationGenerationConfigs?: GenerateAppResourceRequestToolGenerationConfigOpenApiToolsetGenerationConfigOperationGenerationConfig[];
      /** Required. The base uri of the tool. */
      uri?: string;
    }
    interface GenerateAppResourceRequestToolGenerationConfigOpenApiToolsetGenerationConfigOperationGenerationConfig {
    ...
    interface GenerateEvaluationRequest {
      ...
      evaluationType?: 'EVALUATION_TYPE_UNSPECIFIED' | 'GOLDEN' | 'SCENARIO';
    ...
    interface GuardrailSupervisor {
      /** Optional. The detection mode of the supervisor. */
      detectionMode?:
        'DETECTION_MODE_UNSPECIFIED' | 'NON_BLOCKING' | 'BLOCKING';
    ...
    interface LfA2aV1AgentCapabilities {
      /** Indicates if the agent supports providing an extended agent card when authenticated. */
      extendedAgentCard?: boolean;
      /** A list of protocol extensions supported by the agent. */
      extensions?: LfA2aV1AgentExtension[];
      /** Indicates if the agent supports sending push notifications for asynchronous task updates. */
      pushNotifications?: boolean;
      /** Indicates if the agent supports streaming responses. */
      streaming?: boolean;
    }
    interface LfA2aV1AgentCard {
      ...
      securityRequirements?: LfA2aV1SecurityRequirement[];
      /** The security scheme details used for authenticating with this agent. */
      securitySchemes?: {[P in string]: LfA2aV1SecurityScheme};
      /** JSON Web Signatures computed for this `AgentCard`. */
      signatures?: LfA2aV1AgentCardSignature[];
      ...
      skills?: LfA2aV1AgentSkill[];
      /** Required. Ordered list of supported interfaces. The first entry is preferred. */
      supportedInterfaces?: LfA2aV1AgentInterface[];
      /** Required. The version of the agent. Example: "1.0.0" */
      version?: string;
    }
    interface LfA2aV1AgentCardSignature {
    ...
    interface LfA2aV1AgentExtension {
    ...
    interface LfA2aV1AgentInterface {
      /** Required. The protocol binding supported at this URL. This is an open form string, to be easily extended for other protocol bindings. The core ones officially supported are `JSONRPC`, `GRPC` and `HTTP+JSON`. */
      protocolBinding?: string;
      /** Required. The version of the A2A protocol this interface exposes. Use the latest supported minor version per major version. Examples: "0.3", "1.0" */
      protocolVersion?: string;
    ...
    interface LfA2aV1AgentProvider {
    ...
    interface LfA2aV1APIKeySecurityScheme {
    ...
    interface LfA2aV1AuthenticationInfo {
    ...
    interface LfA2aV1AuthorizationCodeOAuthFlow {
    ...
    interface LfA2aV1ClientCredentialsOAuthFlow {
      /** The URL to be used for obtaining refresh tokens. */
      refreshUrl?: string;
      /** Required. The available scopes for the OAuth2 security scheme. */
      scopes?: {[P in string]: string};
    ...
    interface LfA2aV1DeviceCodeOAuthFlow {
    ...
    interface LfA2aV1HTTPAuthSecurityScheme {
    ...
    interface LfA2aV1ImplicitOAuthFlow {
    ...
    interface LfA2aV1MutualTlsSecurityScheme {
      /** An optional description for the security scheme. */
      description?: string;
    }
    interface LfA2aV1OAuth2SecurityScheme {
      /** An optional description for the security scheme. */
      description?: string;
    ...
    interface LfA2aV1OpenIdConnectSecurityScheme {
      /** An optional description for the security scheme. */
      description?: string;
    ...
    interface LfA2aV1PasswordOAuthFlow {
      /** The URL to be used for obtaining refresh tokens. This MUST be in the form of a URL. The OAuth2 standard requires the use of TLS. */
      refreshUrl?: string;
      /** The available scopes for the OAuth2 security scheme. A map between the scope name and a short description for it. The map MAY be empty. */
      scopes?: {[P in string]: string};
    ...
    interface LfA2aV1SecurityRequirement {
      /** A map of security schemes to the required scopes. */
      schemes?: {[P in string]: LfA2aV1StringList};
    }
    interface LfA2aV1SecurityScheme {
    ...
    interface LfA2aV1SendMessageConfiguration {
    ...
    interface LfA2aV1SendMessageRequest {
    ...
    interface LfA2aV1SendMessageResponse {
      /** A message from the agent. */
      message?: LfA2aV1Message;
      /** The task created or updated by the message. */
      task?: LfA2aV1Task;
    }
    interface LfA2aV1StreamResponse {
    ...
    interface LfA2aV1StringList {
      /** The individual string values. */
      list?: string[];
    }
    interface LfA2aV1Task {
      /** A set of output artifacts for a `Task`. */
      artifacts?: LfA2aV1Artifact[];
    ...
    interface LfA2aV1TaskArtifactUpdateEvent {
    ...
    interface LfA2aV1TaskPushNotificationConfig {
    ...
    interface LfA2aV1TaskStatusUpdateEvent {
    ...
    interface McpTool {
      ...
      customHeaders?: {[P in string]: string};
      ...
      state?: 'STATE_UNSPECIFIED' | 'ACTIVE' | 'INACTIVE' | 'STALE';
    ...
    interface QualityReport {
      ...
      generalIssues?: QualityReportIssue[];
      /** Optional. The issues grouped by agent. */
      issues?: QualityReportAgentIssues[];
    }
    interface QualityReportAgentIssues {
    ...
    interface RunEvaluationResultMetricsRequest {}
    interface RunEvaluationResultMetricsResponse {
      /** Output only. The status of the evaluation result metrics calculation. */
      status?: 'OUTCOME_UNSPECIFIED' | 'PASS' | 'FAIL' | 'SKIPPED';
    }
    ...
    interface UploadEvaluationAudioRequest {
    ...
    interface UploadEvaluationAudioResponse {
    ...
    interface WidgetToolTextResponseConfig {
      ...
      type?: 'TYPE_UNSPECIFIED' | 'NONE' | 'LLM_GENERATED' | 'STATIC';
    }
    ...
    interface MessageResource {
      ...
      send(request: {
        ...
        uploadType?: string;
        /** Request body */
        resource: LfA2aV1SendMessageRequest;
      }): Request<LfA2aV1SendMessageResponse>;
      send(
        request: {
          /** V1 error format. */
          '$.xgafv'?: '1' | '2';
    ...
    interface EvaluationRunsResource {
      ...
      export(request: {
        ...
        uploadType?: string;
        /** Request body */
        resource: ExportEvaluationRunsRequest;
      }): Request<Operation>;
      export(
        request: {
          /** V1 error format. */
    ...
    interface ResultsResource {
      ...
      export(request: {
        ...
        uploadType?: string;
        /** Request body */
        resource: ExportEvaluationResultsRequest;
      }): Request<Operation>;
      export(
        request: {
          /** V1 error format. */
      ...
      runEvaluationResultMetrics(request: {
        /** V1 error format. */
        '$.xgafv'?: '1' | '2';
        /** OAuth access token. */
        access_token?: string;
        ...
        uploadType?: string;
        /** Request body */
        resource: RunEvaluationResultMetricsRequest;
      }): Request<Operation>;
    ...
    interface EvaluationsResource {
      ...
      export(request: {
        ...
        uploadType?: string;
        /** Request body */
        resource: ExportEvaluationsRequest;
      }): Request<Operation>;
      export(
        request: {
          /** V1 error format. */
      ...
      uploadEvaluationAudio(request: {
        ...
        uploadType?: string;
        /** Request body */
        resource: UploadEvaluationAudioRequest;
      }): Request<UploadEvaluationAudioResponse>;
    ...
    interface AppsResource {
      ...
      generateAppResource(request: {
        ...
        uploadType?: string;
        /** Request body */
        resource: GenerateAppResourceRequest;
      }): Request<Operation>;
      generateAppResource(
        request: {
          /** V1 error format. */
