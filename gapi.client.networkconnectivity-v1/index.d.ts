...
declare namespace gapi.client {
    ...
    namespace networkconnectivity {
        interface AcceptSpokeRequest {
            /**
             * Optional. A unique request ID (optional). If you specify this ID, you can use it in cases when you need to retry your request. When you need to retry, this ID lets the server know
             * that it can ignore the request if it has already been completed. The server guarantees that for at least 60 minutes after the first request. For example, consider a situation where
             * you make an initial request and the request times out. If you make the request again with the same request ID, the server can check to see whether the original operation was
             * received. If it was, the server ignores the second request. This behavior prevents clients from mistakenly creating duplicate commitments. The request ID must be a valid UUID, with
        ...
        interface Route {
             ...
             * name is created, the new route is assigned a different unique_id.
             */
            uid?:
                string;
        ...
        interface RouteTable {
             ...
             * created, the new route table is assigned a different unique_id.
             */
            uid?:
                string;
