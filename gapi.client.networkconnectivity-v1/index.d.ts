...
declare namespace gapi.client {
  ...
  namespace networkconnectivity {
    ...
    interface DestinationEndpoint {
      ...
      state?: 'STATE_UNSPECIFIED' | 'VALID' | 'INVALID';
    ...
    interface Filter {
      ...
      protocolVersion?: 'PROTOCOL_VERSION_UNSPECIFIED' | 'IPV4' | 'IPV6';
    ...
    interface Gateway {
      ...
      ipRangeReservations?: IpRangeReservation[];
    ...
    interface GatewayAdvertisedRoute {
    ...
    interface ListGatewayAdvertisedRoutesResponse {
      /** The requested gateway advertised routes. */
      gatewayAdvertisedRoutes?: GatewayAdvertisedRoute[];
    ...
    interface ListRemoteTransportProfilesResponse {
      /** A token identifying a page of results the server should return. */
      nextPageToken?: string;
      /** The list of RemoteTransportProfiles. */
      remoteTransportProfiles?: RemoteTransportProfile[];
    ...
    interface ListTransportsResponse {
      /** A token identifying a page of results the server should return. */
      nextPageToken?: string;
    ...
    interface RemoteTransportProfile {
      ...
      orderState?: 'STATE_UNSPECIFIED' | 'CLOSED' | 'OPEN';
      ...
      sla?: 'SERVICE_LEVEL_AVAILABILITY_UNSPECIFIED' | 'HIGH' | 'MAXIMUM';
    ...
    interface RemoteTransportProfilesResource {
      ...
      get(request?: {
        ...
        /** Legacy upload protocol for media (e.g. "media", "multipart"). */
        uploadType?: string;
      }): Request<RemoteTransportProfile>;
      ...
      list(request?: {
        ...
        /** Legacy upload protocol for media (e.g. "media", "multipart"). */
        uploadType?: string;
      }): Request<ListRemoteTransportProfilesResponse>;
    }
    ...
    interface GatewayAdvertisedRoutesResource {
      ...
      get(request?: {
        ...
        /** Legacy upload protocol for media (e.g. "media", "multipart"). */
        uploadType?: string;
      }): Request<GatewayAdvertisedRoute>;
      ...
      list(request?: {
        ...
        /** Legacy upload protocol for media (e.g. "media", "multipart"). */
        uploadType?: string;
      }): Request<ListGatewayAdvertisedRoutesResponse>;
    ...
    interface SpokesResource {
      ...
      gatewayAdvertisedRoutes: GatewayAdvertisedRoutesResource;
    }
    interface TransportsResource {
