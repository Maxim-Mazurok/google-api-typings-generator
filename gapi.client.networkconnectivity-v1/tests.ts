...
gapi.load('client', async () => {
  ...
  async function run() {
    ...
    await gapi.client.networkconnectivity.projects.locations.pscAuthorizationPolicies.create(
      {
        parent: 'Test string',
        pscAuthorizationPolicyId: 'Test string',
        requestId: 'Test string',
      },
      {
        authorizationMode: 'Test string',
        authorizedClientResources: ['Test string'],
        createTime: 'Test string',
        description: 'Test string',
        etag: 'Test string',
        labels: {
        ...
        name: 'Test string',
        targetResourceUri: 'Test string',
        uid: 'Test string',
        updateTime: 'Test string',
      },
    );
    /** Deletes a single PscAuthorizationPolicy. */
    await gapi.client.networkconnectivity.projects.locations.pscAuthorizationPolicies.delete(
      {
        etag: 'Test string',
        name: 'Test string',
        requestId: 'Test string',
    ...
    await gapi.client.networkconnectivity.projects.locations.pscAuthorizationPolicies.get(
      {
        name: 'Test string',
      },
    );
    /** Lists PscAuthorizationPolicies in a given project and location. */
    await gapi.client.networkconnectivity.projects.locations.pscAuthorizationPolicies.list(
      {
        filter: 'Test string',
        orderBy: 'Test string',
        pageSize: 42,
    ...
    await gapi.client.networkconnectivity.projects.locations.remoteTransportProfiles.get(
      {
        name: 'Test string',
      },
    );
    /** Lists RemoteTransportProfiles in a given project and location. */
    await gapi.client.networkconnectivity.projects.locations.remoteTransportProfiles.list(
      {
        filter: 'Test string',
        orderBy: 'Test string',
        pageSize: 42,
    ...
    await gapi.client.networkconnectivity.projects.locations.spokes.create(
      ...
      },
      {
        ...
        gateway: {
          capacity: 'Test string',
          cloudRouters: ['Test string'],
          ipRangeReservations: [
            {
              ipRange: 'Test string',
            },
          ],
          sacAttachment: 'Test string',
        },
        group: 'Test string',
        hub: 'Test string',
        labels: {
        ...
        linkedInterconnectAttachments: {
          ...
          excludeImportRanges: ['Test string'],
    ...
    await gapi.client.networkconnectivity.projects.locations.spokes.gatewayAdvertisedRoutes.create(
      {
        gatewayAdvertisedRouteId: 'Test string',
        parent: 'Test string',
        requestId: 'Test string',
      },
      {
    ...
    await gapi.client.networkconnectivity.projects.locations.spokes.gatewayAdvertisedRoutes.delete(
      {
        name: 'Test string',
        requestId: 'Test string',
      },
    ...
    await gapi.client.networkconnectivity.projects.locations.spokes.gatewayAdvertisedRoutes.get(
      {
        name: 'Test string',
      },
    );
    /** List GatewayAdvertisedRoutes */
    await gapi.client.networkconnectivity.projects.locations.spokes.gatewayAdvertisedRoutes.list(
      {
        filter: 'Test string',
        orderBy: 'Test string',
        pageSize: 42,
    ...
    await gapi.client.networkconnectivity.projects.locations.spokes.gatewayAdvertisedRoutes.patch(
      {
        name: 'Test string',
        requestId: 'Test string',
        updateMask: 'Test string',
    ...
    await gapi.client.networkconnectivity.projects.locations.transports.create(
      {
        parent: 'Test string',
        requestId: 'Test string',
        transportId: 'Test string',
      },
      {
        advertisedRoutes: ['Test string'],
        autoAccept: true,
        bandwidth: 'Test string',
        createTime: 'Test string',
        description: 'Test string',
        generatedActivationKey: 'Test string',
        hub: 'Test string',
        labels: {
          A: 'Test string',
        },
        ...
        name: 'Test string',
        network: 'Test string',
        peeringNetwork: 'Test string',
        providedActivationKey: 'Test string',
        pscRoutingEnabled: true,
        remoteAccountId: 'Test string',
        remoteProfile: 'Test string',
    ...
    await gapi.client.networkconnectivity.projects.locations.transports.delete({
      name: 'Test string',
      requestId: 'Test string',
    });
    /** Gets details of a single Transport. */
    await gapi.client.networkconnectivity.projects.locations.transports.get({
      name: 'Test string',
    });
    /** Lists Transports in a given project and location. */
    await gapi.client.networkconnectivity.projects.locations.transports.list({
      filter: 'Test string',
      orderBy: 'Test string',
      pageSize: 42,
      pageToken: 'Test string',
    ...
    await gapi.client.networkconnectivity.projects.locations.transports.patch(
      {
        name: 'Test string',
        requestId: 'Test string',
        updateMask: 'Test string',
