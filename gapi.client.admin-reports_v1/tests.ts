...
gapi.load('client', async () => {
  ...
  async function run() {
    ...
    await gapi.client.reports.activities.list({
      ...
      agentInfoFilter: 'Test string',
      applicationInfoFilter: 'Test string',
      applicationName: 'Test string',
      customerId: 'Test string',
      deviceFilter: 'Test string',
      endTime: 'Test string',
      ...
      maxResults: 42,
      networkInfoFilter: 'Test string',
      orgUnitID: 'Test string',
      pageToken: 'Test string',
      resourceDetailsFilter: 'Test string',
      startTime: 'Test string',
      statusFilter: 'Test string',
      userKey: 'Test string',
    });
