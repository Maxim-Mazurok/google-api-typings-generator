...
// Project: https://developers.google.com/workspace/admin/
...
declare namespace gapi.client {
  ...
  namespace admin {
    ...
    interface ActivityUserDeviceInfo {
    ...
    interface AgentAttributionInfo {
      /** The ID of the agent. */
      agentId?: string;
    ...
    interface AgentAttributionInfoAgentOwner {
