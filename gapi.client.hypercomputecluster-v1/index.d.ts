...
// Project: https://cloud.google.com/ai-hypercomputer/docs/cluster-director
...
declare namespace gapi.client {
  ...
  namespace hypercomputecluster {
    ...
    interface SlurmLoginNodes {
      ...
      machineType?: string;
      /** Optional. [Startup script](https://cloud.google.com/compute/docs/instances/startup-scripts/linux) to be run on each login node instance. Max 256KB. */
      startupScript?: string;
