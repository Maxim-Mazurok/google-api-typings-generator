...
declare namespace gapi.client {
  ...
  namespace baremetalsolution {
    ...
    interface DisableHyperthreadingRequest {}
    interface DisableInteractiveSerialConsoleRequest {}
    interface DisableInteractiveSerialConsoleResponse {}
    interface Empty {}
    interface EnableHyperthreadingRequest {}
    interface EnableInteractiveSerialConsoleRequest {}
    interface EnableInteractiveSerialConsoleResponse {}
    interface EvictLunRequest {}
    interface EvictVolumeRequest {}
    ...
    interface LoadInstanceAuthInfoResponse {
      ...
      userAccounts?: {[P in string]: UserAccount};
    }
    interface Location {
    ...
    interface RenameNfsShareRequest {
      /** Required. The new `id` of the nfsshare. */
      newNfsshareId?: string;
    }
    interface RenameVolumeRequest {
    ...
    interface InstancesResource {
      ...
      disableHyperthreading(request: {
        ...
        uploadType?: string;
        /** Request body */
        resource: DisableHyperthreadingRequest;
      }): Request<Operation>;
      ...
      enableHyperthreading(request: {
        ...
        uploadType?: string;
        /** Request body */
        resource: EnableHyperthreadingRequest;
      }): Request<Operation>;
      ...
      loadAuthInfo(request?: {
        ...
        /** Legacy upload protocol for media (e.g. "media", "multipart"). */
        uploadType?: string;
      }): Request<LoadInstanceAuthInfoResponse>;
      ...
      reimage(request: {
        ...
        uploadType?: string;
        /** Request body */
        resource: ReimageInstanceRequest;
      }): Request<Operation>;
      reimage(
        request: {
          /** V1 error format. */
      ...
      rename(request: {
        ...
        uploadType?: string;
        /** Request body */
        resource: RenameInstanceRequest;
      }): Request<Instance>;
      rename(
        request: {
          /** V1 error format. */
    ...
    interface NfsSharesResource {
      ...
      rename(request: {
        ...
        uploadType?: string;
        /** Request body */
        resource: RenameNfsShareRequest;
      }): Request<NfsShare>;
      rename(
        request: {
          /** V1 error format. */
