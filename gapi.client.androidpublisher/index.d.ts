...
declare namespace gapi.client {
    ...
    namespace androidpublisher {
        ...
        interface AutoRenewingBasePlanType {
            ...
            /**
             * Whether the renewing base plan is compatible with legacy version of the Play Billing Library (prior to version 3) or not. Only one renewing base plan can be marked as legacy
