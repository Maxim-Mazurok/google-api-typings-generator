...
declare namespace gapi.client {
    ...
    namespace androidpublisher {
        ...
        interface InAppProduct {
            ...
            purchaseType?: string;
            /**
             * Whether or not the developer wants the specific subscription to be resubscribable. If the developer doesn't use PBL2.0, this value is ignored since the
             * feature is only for developers using PBL2.0. This feature allows users to resubscribe to an expired subscription directly from the subscription center
             * by clicking on a "Resubscribe" CTA under the entry for the expired subscription.
             */
            resubscribeEligibility?: string;
        ...
        interface TrackRelease {
             ...
             * between [0, 5]. 5 is the highest priority. Default priority is 0. in_app_update_priority can not be updated once the release is rolled out. See
