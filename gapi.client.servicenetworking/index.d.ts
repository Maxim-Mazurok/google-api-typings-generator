...
declare namespace gapi.client {
    ...
    namespace servicenetworking {
        ...
        interface MetricRule {
            /**
             * Metrics to update when the selected methods are called. The key of the map is the metric name, the value is the DynamicCostType to specify how to calculate the cost from the
             * request. The cost amount will be increased for the metric against which the quota limits are defined. It is only implemented in CloudESF(go/cloudesf)
             */
            dynamicMetricCosts?: { [P in string]: string };
            /**
