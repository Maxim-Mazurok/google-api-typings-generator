...
// Generated from: https://bigqueryreservation.googleapis.com/$discovery/rest?version=v1beta1
// Revision: 20220819

/// <reference types="gapi.client" />

declare namespace gapi.client {
    /** Load BigQuery Reservation API v1beta1 */
    function load(urlOrObject: "https://bigqueryreservation.googleapis.com/$discovery/rest?version=v1beta1"): Promise<void>;
    /** @deprecated Please load APIs with discovery documents. */
    function load(name: "bigqueryreservation", version: "v1beta1"): Promise<void>;
    /** @deprecated Please load APIs with discovery documents. */
    function load(name: "bigqueryreservation", version: "v1beta1", callback: () => any): void;
    ...
    namespace bigqueryreservation {
        ...
        interface CapacityCommitment {
             ...
             * applicable for ANNUAL commitments.
             */
            renewalPlan?: string;
        ...
        interface ReservationsResource {
            ...
            list(request?: {
                ...
                fields?: string;
                /**
                 * Can be used to filter out reservations based on names, capacity, etc, e.g.: filter="reservation.slot_capacity > 200" filter="reservation.name = \"*dev/*\"" Advanced filtering
