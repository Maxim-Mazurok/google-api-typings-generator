...
gapi.load('client', async () => {
  ...
  async function run() {
    ...
    await gapi.client.firebasehosting.projects.sites.customDomains.create(
      {
        customDomainId: 'Test string',
        parent: 'Test string',
        validateOnly: true,
      },
      {
        ...
        cert: {
          ...
          verification: {
            ...
            http: {
              ...
              desired: 'Test string',
              discovered: 'Test string',
              lastCheckTime: 'Test string',
              path: 'Test string',
            },
          },
        },
        certPreference: 'Test string',
        createTime: 'Test string',
        deleteTime: 'Test string',
        etag: 'Test string',
        expireTime: 'Test string',
    ...
    await gapi.client.firebasehosting.projects.sites.customDomains.get({
      name: 'Test string',
    });
    ...
    await gapi.client.firebasehosting.projects.sites.customDomains.list({
      pageSize: 42,
      pageToken: 'Test string',
      parent: 'Test string',
      showDeleted: true,
    ...
    await gapi.client.firebasehosting.projects.sites.customDomains.patch(
      {
        allowMissing: true,
        name: 'Test string',
        updateMask: 'Test string',
    ...
    await gapi.client.firebasehosting.projects.sites.domains.create(
      ...
      },
      {
        ...
        provisioning: {
          certChallengeDiscoveredTxt: ['Test string'],
          certChallengeDns: {
            domainName: 'Test string',
            token: 'Test string',
          },
          ...
          discoveredIps: ['Test string'],
          dnsFetchTime: 'Test string',
          dnsStatus: 'Test string',
          expectedIps: ['Test string'],
        },
        site: 'Test string',
        status: 'Test string',
        updateTime: 'Test string',
