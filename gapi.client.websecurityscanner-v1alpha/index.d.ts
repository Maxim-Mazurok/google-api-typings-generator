...
declare namespace gapi.client {
    ...
    function load(urlOrObject: "https://websecurityscanner.googleapis.com/$discovery/rest?version=v1alpha"): Promise<void>;
    /** @deprecated Please load APIs with discovery documents. */
    function load(name: "websecurityscanner", version: "v1alpha"): Promise<void>;
    /** @deprecated Please load APIs with discovery documents. */
    function load(name: "websecurityscanner", version: "v1alpha", callback: () => any): void;
