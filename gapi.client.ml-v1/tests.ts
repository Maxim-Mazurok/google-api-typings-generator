/* This is stub file for gapi.client.ml-v1 definition tests */
// IMPORTANT
      ...
      },
      {
        ...
        trainingInput: {
          ...
          evaluatorConfig: {
            ...
            containerArgs: ['Test string'],
            containerCommand: ['Test string'],
            diskConfig: {
              bootDiskSizeGb: 42,
