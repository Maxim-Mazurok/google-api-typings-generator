...
declare namespace gapi.client {
    ...
    namespace policysimulator {
        ...
        interface GoogleCloudPolicysimulatorV1alphaAccessStateDiff {
        ...
        interface GoogleCloudPolicysimulatorV1alphaAccessTuple {
            /**
        ...
        interface GoogleCloudPolicysimulatorV1alphaBindingExplanation {
            /**
             ...
             */
            memberships?:
                { [P in string]: GoogleCloudPolicysimulatorV1alphaBindingExplanationAnnotatedMembership };
        ...
        interface GoogleCloudPolicysimulatorV1alphaBindingExplanationAnnotatedMembership {
        ...
        interface GoogleCloudPolicysimulatorV1alphaExplainedAccess {
        ...
        interface GoogleCloudPolicysimulatorV1alphaExplainedPolicy {
            /**
        ...
        interface GoogleCloudPolicysimulatorV1alphaListOrgPolicyViolationsPreviewsResponse {
        ...
        interface GoogleCloudPolicysimulatorV1alphaListOrgPolicyViolationsResponse {
            /** A token that you can use to retrieve the next page of results. If this field is omitted, there are no subsequent pages. */
            nextPageToken?:
                string;
        ...
        interface GoogleCloudPolicysimulatorV1alphaListReplayResultsResponse {
        ...
        interface GoogleCloudPolicysimulatorV1alphaListReplaysResponse {
            /** A token that you can use to retrieve the next page of results. If this field is omitted, there are no subsequent pages. */
            nextPageToken?:
                string;
        ...
        interface GoogleCloudPolicysimulatorV1alphaOrgPolicyViolation {
        ...
        interface GoogleCloudPolicysimulatorV1alphaReplay {
        ...
        interface GoogleCloudPolicysimulatorV1alphaReplayConfig {
        ...
        interface GoogleCloudPolicysimulatorV1alphaReplayDiff {
            /**
        ...
        interface GoogleCloudPolicysimulatorV1alphaReplayResult {
        ...
        interface GoogleCloudPolicysimulatorV1alphaReplayResultsSummary {
        ...
        interface GoogleCloudPolicysimulatorV1alphaResourceContext {
            /**
        ...
        interface ResultsResource {
            ...
            list(request?: {
                ...
                uploadType?:
                    string;
            }): Request<GoogleCloudPolicysimulatorV1alphaListReplayResultsResponse>;
        }
        interface ReplaysResource {
            ...
            body: GoogleCloudPolicysimulatorV1alphaReplay): Request<GoogleLongrunningOperation>;
            ...
            get(request?: {
                ...
                uploadType?:
                    string;
            }): Request<GoogleCloudPolicysimulatorV1alphaReplay>;
            ...
            list(request?: {
                ...
                pageSize?:
                    number;
                /**
                 * A page token, received from a previous Simulator.ListReplays call. Provide this to retrieve the subsequent page. When paginating, all other parameters provided to
                 * Simulator.ListReplays must match the call that provided the page token.
                 */
                pageToken?:
                    string;
                /**
                 * Required. The parent resource, in the following format: `{projects|folders|organizations}/{resource-id}/locations/global`, where `{resource-id}` is the ID of the project,
                 * folder, or organization that owns the Replay. Example: `projects/my-example-project/locations/global` Only `Replay` objects that are direct children of the provided parent are
                 * listed. In other words, `Replay` objects that are children of a project will not be included when the parent is a folder of that project.
                 */
                parent:
                    string;
                /** Returns response with indentations and line breaks. */
                ...
                uploadType?:
                    string;
            }): Request<GoogleCloudPolicysimulatorV1alphaListReplaysResponse>;
            operations:
                OperationsResource;
            results:
                ResultsResource;
        ...
        interface OrgPolicyViolationsResource {
            ...
            list(request?: {
                ...
                uploadType?:
                    string;
            }): Request<GoogleCloudPolicysimulatorV1alphaListOrgPolicyViolationsResponse>;
        }
        interface OrgPolicyViolationsPreviewsResource {
            ...
            get(request?: {
                ...
                uploadType?:
                    string;
            }): Request<GoogleCloudPolicysimulatorV1alphaOrgPolicyViolationsPreview>;
            ...
            list(request?: {
                ...
                uploadType?:
                    string;
            }): Request<GoogleCloudPolicysimulatorV1alphaListOrgPolicyViolationsPreviewsResponse>;
            operations:
                OperationsResource;
            orgPolicyViolations:
