...
declare namespace gapi.client {
  ...
  function load(
    urlOrObject: 'https://policysimulator.googleapis.com/$discovery/rest?version=v1alpha'
  ): Promise<void>;
  ...
  namespace policysimulator {
    ...
    interface GoogleCloudPolicysimulatorV1alphaExplainedAccess {
      ...
      policies?: GoogleCloudPolicysimulatorV1alphaExplainedPolicy[];
    }
    interface GoogleCloudPolicysimulatorV1alphaExplainedPolicy {
      ...
      bindingExplanations?: GoogleCloudPolicysimulatorV1alphaBindingExplanation[];
    ...
    interface GoogleCloudPolicysimulatorV1alphaListOrgPolicyViolationsPreviewsResponse {
      ...
      orgPolicyViolationsPreviews?: GoogleCloudPolicysimulatorV1alphaOrgPolicyViolationsPreview[];
    }
    interface GoogleCloudPolicysimulatorV1alphaListOrgPolicyViolationsResponse {
      /** A token that you can use to retrieve the next page of results. If this field is omitted, there are no subsequent pages. */
      nextPageToken?: string;
      /** The list of OrgPolicyViolations */
      orgPolicyViolations?: GoogleCloudPolicysimulatorV1alphaOrgPolicyViolation[];
    }
    interface GoogleCloudPolicysimulatorV1alphaListReplayResultsResponse {
      ...
      replayResults?: GoogleCloudPolicysimulatorV1alphaReplayResult[];
    }
    ...
    interface ReplaysResource {
      ...
      create(request: {
        ...
        uploadType?: string;
        /** Request body */
        resource: GoogleCloudPolicysimulatorV1alphaReplay;
      }): Request<GoogleLongrunningOperation>;
      create(
        request: {
          /** V1 error format. */
    ...
    interface OrgPolicyViolationsPreviewsResource {
      ...
      create(request: {
        ...
        uploadType?: string;
        /** Request body */
        resource: GoogleCloudPolicysimulatorV1alphaOrgPolicyViolationsPreview;
      }): Request<GoogleLongrunningOperation>;
      create(
        request: {
          /** V1 error format. */
