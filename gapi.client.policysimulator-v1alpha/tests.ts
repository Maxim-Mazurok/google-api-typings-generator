...
gapi.load('client', async () => {
  ...
  async function run() {
    ...
    await gapi.client.policysimulator.folders.locations.accessPolicySimulations.operations.get(
      {
        name: 'Test string',
      },
    );
    ...
    /** Gets the latest state of a long-running operation. Clients can use this method to poll the operation result at intervals as recommended by the API service. */
    await gapi.client.policysimulator.organizations.locations.accessPolicySimulations.operations.get(
      {
        name: 'Test string',
      },
    );
    ...
    /** Gets the latest state of a long-running operation. Clients can use this method to poll the operation result at intervals as recommended by the API service. */
    await gapi.client.policysimulator.projects.locations.accessPolicySimulations.operations.get(
      {
        name: 'Test string',
      },
    );
