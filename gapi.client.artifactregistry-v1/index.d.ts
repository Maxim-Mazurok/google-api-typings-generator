...
declare namespace gapi.client {
  ...
  namespace artifactregistry {
    ...
    interface Attachment {
      /** Optional. User annotations. These attributes can only be set and used by the user, and not by Artifact Registry. See https://google.aip.dev/128#annotations for more details such as format and size limitations. Client specified annotations. */
      ...
      createTime?: string;
      /** Required. The files that blong to this Attachment. If the file ID part contains slashes, they are escaped. E.g. "projects/p1/locations/us-central1/repositories/repo1/files/sha:". */
      files?: string[];
    ...
    interface PromoteArtifactMetadata {}
    ...
    interface RemoteRepositoryConfig {
      ...
      /** Common remote repository settings. Used as the RR upstream URL instead of Predefined and Custom remote repositories. UI and Gcloud will map all the new remote repositories to this field. */
