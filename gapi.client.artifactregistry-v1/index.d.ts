...
declare namespace gapi.client {
    ...
    function load(urlOrObject: "https://artifactregistry.googleapis.com/$discovery/rest?version=v1"): Promise<void>;
    ...
    namespace artifactregistry {
        ...
        interface KfpArtifact {
            /**
             * Output only. Resource name of the KFP artifact. Since users don't directly interact with this resource, the name will be derived from the associated version. For example, when
             * version = ".../versions/sha256:abcdef...", the name will be ".../kfpArtifacts/sha256:abcdef...".
             */
            name?:
                string;
        ...
        interface Repository {
            /**
             * Optional. Cleanup policies for this repository. Cleanup policies indicate when certain package versions can be automatically deleted. Map keys are policy IDs supplied by users
             * during policy creation. They must unique within a repository and be under 128 characters in length.
             */
            cleanupPolicies?:
                { [P in string]: CleanupPolicy };
        ...
        interface GoModulesResource {
            ...
            body: UploadGoModuleRequest): Request<UploadGoModuleMediaResponse>;
        }
        ...
        interface KfpArtifactsResource {
            /**
             * Directly uploads a KFP artifact. The returned Operation will complete once the resource is uploaded. Package, Version, and File resources will be created based on the uploaded
             * artifact. Uploaded artifacts that conflict with existing resources will be overwritten.
             */
            upload(request: {
                /** V1 error format. */
                "$.xgafv"?:
            ...
            body: UploadKfpArtifactRequest): Request<UploadKfpArtifactMediaResponse>;
        }
        ...
        interface VersionsResource {
            ...
            body: BatchDeleteVersionsRequest): Request<Operation>;
        ...
        interface RepositoriesResource {
            ...
            dockerImages:
                DockerImagesResource;
            files:
                FilesResource;
            goModules:
                GoModulesResource;
            googetArtifacts:
                GoogetArtifactsResource;
            kfpArtifacts:
                KfpArtifactsResource;
            mavenArtifacts:
                MavenArtifactsResource;
            npmPackages:
                NpmPackagesResource;
            packages:
                PackagesResource;
            pythonPackages:
                PythonPackagesResource;
            yumArtifacts:
        ...
        interface LocationsResource {
            ...
            body: VPCSCConfig): Request<VPCSCConfig>;
            operations:
                OperationsResource;
            repositories:
