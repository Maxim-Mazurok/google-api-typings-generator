...
declare namespace gapi.client {
  ...
  function load(
    urlOrObject: 'https://artifactregistry.googleapis.com/$discovery/rest?version=v1',
  ): Promise<void>;
  /** @deprecated Please load APIs with discovery documents. */
  function load(name: 'artifactregistry', version: 'v1'): Promise<void>;
  /** @deprecated Please load APIs with discovery documents. */
  function load(
  ...
  namespace artifactregistry {
    ...
    interface CheckPrewarmedArtifactRequest {
    ...
    interface CheckPrewarmedArtifactResponse {
    ...
    interface CommonRemoteRepository {
    ...
    interface DockerRepositoryConfig {
    ...
    interface GoogleDevtoolsArtifactregistryV1Rule {
    ...
    interface ImportGoogetArtifactsErrorInfo {
      /** The detailed error status. */
      error?: Status;
      /** Google Cloud Storage location requested. */
    ...
    interface ImportGoogetArtifactsMetadata {}
    ...
    interface ImportGoogetArtifactsResponse {
      /** Detailed error info for packages that were not imported. */
      errors?: ImportGoogetArtifactsErrorInfo[];
    ...
    interface ListPrewarmedArtifactsResponse {
      ...
      prewarmedArtifacts?: PrewarmedArtifact[];
    }
    ...
    interface ListRulesResponse {
      ...
      nextPageToken?: string;
      /** The rules returned. */
      rules?: GoogleDevtoolsArtifactregistryV1Rule[];
    }
    ...
    interface PlatformLogsConfig {
      /** Optional. The state of the platform logs: enabled or disabled. */
      loggingState?: 'LOGGING_STATE_UNSPECIFIED' | 'ENABLED' | 'DISABLED';
    ...
    interface PrewarmArtifactRequest {
    ...
    interface PrewarmArtifactResponse {
      /** The prewarmed artifact that was prewarmed. */
      prewarmedArtifact?: PrewarmedArtifact;
    }
    interface PrewarmedArtifact {
    ...
    interface RemovePrewarmedArtifactRequest {
      /** Optional. The location of the prewarmed artifact. multi-region is not supported for this field. */
      streamLocation?: string;
      /** Optional. The artifact tag Format:projects/{project}/locations/{location}/repositories/{repository}/packages/{package}/tags/{tag} */
      tag?: string;
    ...
    interface UploadFileMediaResponse {
    ...
    interface UploadFileRequest {
      ...
      fileType?: 'ATTACHMENT' | 'ARTIFACT';
    }
    interface UploadGenericArtifactMediaResponse {
      /** Operation that will be returned to the user. */
      operation?: Operation;
    }
    interface UploadGenericArtifactMetadata {}
    interface UploadGenericArtifactRequest {
      ...
      versionAnnotations?: {[P in string]: string};
    ...
    interface UploadGoModuleMetadata {}
    interface UploadGoModuleRequest {}
    interface UploadGoogetArtifactMediaResponse {
      /** Operation to be returned to the user. */
      operation?: Operation;
    }
    interface UploadGoogetArtifactMetadata {}
    ...
    interface UploadKfpArtifactMetadata {}
    ...
    interface FilesResource {
      ...
      patch(request: {
        ...
        uploadType?: string;
        /** Request body */
        resource: GoogleDevtoolsArtifactregistryV1File;
      }): Request<GoogleDevtoolsArtifactregistryV1File>;
      patch(
        request: {
          /** V1 error format. */
      ...
      upload(request: {
        ...
        uploadType?: string;
        /** Request body */
        resource: UploadFileRequest;
      }): Request<UploadFileMediaResponse>;
      upload(
        request: {
          /** V1 error format. */
          '$.xgafv'?: '1' | '2';
    ...
    interface GenericArtifactsResource {
      ...
      upload(request: {
        ...
        uploadType?: string;
        /** Request body */
        resource: UploadGenericArtifactRequest;
      }): Request<UploadGenericArtifactMediaResponse>;
      upload(
        request: {
          /** V1 error format. */
          '$.xgafv'?: '1' | '2';
    ...
    interface GoModulesResource {
      ...
      upload(request: {
        ...
        uploadType?: string;
        /** Request body */
        resource: UploadGoModuleRequest;
      }): Request<UploadGoModuleMediaResponse>;
      upload(
        request: {
          /** V1 error format. */
          '$.xgafv'?: '1' | '2';
    ...
    interface KfpArtifactsResource {
      ...
      upload(request: {
        ...
        uploadType?: string;
        /** Request body */
        resource: UploadKfpArtifactRequest;
      }): Request<UploadKfpArtifactMediaResponse>;
      upload(
        request: {
          /** V1 error format. */
          '$.xgafv'?: '1' | '2';
    ...
    interface VersionsResource {
      ...
      batchDelete(request: {
        ...
        uploadType?: string;
        /** Request body */
        resource: BatchDeleteVersionsRequest;
      }): Request<Operation>;
      batchDelete(
        request: {
          /** V1 error format. */
    ...
    interface PrewarmedArtifactsResource {
      ...
      list(request?: {
        ...
        /** Legacy upload protocol for media (e.g. "media", "multipart"). */
        uploadType?: string;
      }): Request<ListPrewarmedArtifactsResponse>;
    }
    ...
    interface RulesResource {
      ...
      create(request: {
        ...
        uploadType?: string;
        /** Request body */
        resource: GoogleDevtoolsArtifactregistryV1Rule;
      }): Request<GoogleDevtoolsArtifactregistryV1Rule>;
      create(
        request: {
          /** V1 error format. */
          '$.xgafv'?: '1' | '2';
    ...
    interface RepositoriesResource {
      ...
      checkPrewarmedArtifact(request: {
        /** V1 error format. */
        '$.xgafv'?: '1' | '2';
        /** OAuth access token. */
        access_token?: string;
        ...
        uploadType?: string;
        /** Request body */
        resource: CheckPrewarmedArtifactRequest;
      }): Request<CheckPrewarmedArtifactResponse>;
      ...
      prewarmArtifact(request: {
        ...
        uploadType?: string;
        /** Request body */
        resource: PrewarmArtifactRequest;
      }): Request<Operation>;
      prewarmArtifact(
        request: {
          /** V1 error format. */
      ...
      removePrewarmedArtifact(request: {
        /** V1 error format. */
        '$.xgafv'?: '1' | '2';
        /** OAuth access token. */
        access_token?: string;
        ...
        uploadType?: string;
        /** Request body */
        resource: RemovePrewarmedArtifactRequest;
      }): Request<RemovePrewarmedArtifactResponse>;
      ...
      files: FilesResource;
      genericArtifacts: GenericArtifactsResource;
      goModules: GoModulesResource;
      googetArtifacts: GoogetArtifactsResource;
      kfpArtifacts: KfpArtifactsResource;
      mavenArtifacts: MavenArtifactsResource;
      npmPackages: NpmPackagesResource;
      packages: PackagesResource;
      prewarmedArtifacts: PrewarmedArtifactsResource;
