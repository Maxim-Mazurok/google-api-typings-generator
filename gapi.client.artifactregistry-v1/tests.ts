...
gapi.load('client', async () => {
  ...
  async function run() {
    ...
    await gapi.client.artifactregistry.projects.locations.getProjectConfig({
      name: 'Test string',
    });
    ...
    await gapi.client.artifactregistry.projects.locations.updateProjectConfig(
      {
        name: 'Test string',
        updateMask: 'Test string',
      },
      {
        name: 'Test string',
        platformLogsConfig: {
          loggingState: 'Test string',
          severityLevel: 'Test string',
        },
      },
    );
    ...
    await gapi.client.artifactregistry.projects.locations.operations.cancel(
      {
        name: 'Test string',
      },
      {},
    ...
    await gapi.client.artifactregistry.projects.locations.repositories.checkPrewarmedArtifact(
      {
        repository: 'Test string',
      },
      {
        streamLocation: 'Test string',
        tag: 'Test string',
        version: 'Test string',
      },
    );
    ...
    await gapi.client.artifactregistry.projects.locations.repositories.exportArtifact(
      {
        repository: 'Test string',
      },
      {
        gcsPath: 'Test string',
        sourceTag: 'Test string',
    ...
    await gapi.client.artifactregistry.projects.locations.repositories.prewarmArtifact(
      {
        repository: 'Test string',
      },
      {
    ...
    await gapi.client.artifactregistry.projects.locations.repositories.removePrewarmedArtifact(
      {
        repository: 'Test string',
      },
      {
    ...
    await gapi.client.artifactregistry.projects.locations.repositories.prewarmedArtifacts.list(
      {
        filter: 'Test string',
        pageSize: 42,
        pageToken: 'Test string',
