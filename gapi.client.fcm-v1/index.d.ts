...
declare namespace gapi.client {
    ...
    namespace fcm {
        ...
        interface ApnsConfig {
             ...
             * `apns-expiration` and `apns-priority`. The backend sets a default value for `apns-expiration` of 30 days and a default value for `apns-priority` of 10 if not explicitly set.
             */
