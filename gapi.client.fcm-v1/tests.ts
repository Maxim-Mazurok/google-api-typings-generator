...
gapi.load('client', async () => {
  ...
  async function run() {
    ...
    await gapi.client.fcm.projects.registrations.topicSubscriptions.create(
      {
        parent: 'Test string',
    ...
    await gapi.client.fcm.projects.registrations.topicSubscriptions.delete({
      allowMissing: true,
      name: 'Test string',
    });
    /** Gets a TopicSubscription. */
    await gapi.client.fcm.projects.registrations.topicSubscriptions.get({
      name: 'Test string',
    });
    /** Lists TopicSubscriptions for a given app instance. */
    await gapi.client.fcm.projects.registrations.topicSubscriptions.list({
      pageSize: 42,
    ...
    await gapi.client.fcm.projects.registrations.topicSubscriptions.patch(
      {
        allowMissing: true,
        name: 'Test string',
      },
