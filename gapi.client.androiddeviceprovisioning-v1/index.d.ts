    ...
    namespace androiddeviceprovisioning {
        ...
        interface Configuration {
            ...
            dpcResourcePath?:
                string;
            /**
             * Optional. The timeout before forcing factory reset the device if the device doesn't go through provisioning in the setup wizard, usually due to lack of network connectivity during
             * setup wizard. Ranges from 0-6 hours, with 2 hours being the default if unset.
             */
            forcedResetTime?:
                string;
            /**
        ...
        interface DeviceIdentifier {
            ...
            imei?:
                string;
            /**
             * The device manufacturer’s name. Matches the device's built-in value returned from `android.os.Build.MANUFACTURER`. Allowed values are listed in [Android
            ...
            meid?:
                string;
            /**
             * The device model's name. Allowed values are listed in [Android models](/zero-touch/resources/manufacturer-names#model-names) and [Chrome OS
        ...
        interface DevicesResource {
            ...
            body: GetDeviceSimLockStateRequest): Request<GetDeviceSimLockStateResponse>;
