...
declare namespace gapi.client {
  ...
  namespace firebaseapphosting {
    ...
    interface ListSupportedRuntimesResponse {
    ...
    interface SupportedRuntimesResource {
      ...
      list(request?: {
        ...
        /** Legacy upload protocol for media (e.g. "media", "multipart"). */
        uploadType?: string;
      }): Request<ListSupportedRuntimesResponse>;
    }
    interface LocationsResource {
      ...
      supportedRuntimes: SupportedRuntimesResource;
    }
