...
declare namespace gapi.client {
    ...
    namespace sts {
        ...
        interface V1Resource {
             ...
             * access token. Note that workforce pools do not support Credential Access Boundary at the moment. When you call this method, do not send the `Authorization` HTTP header in the
             * request. This method does not require the `Authorization` header, and using the header can cause the request to fail.
             */
            token(request: {
                /** V1 error format. */
                "$.xgafv"?: string;
