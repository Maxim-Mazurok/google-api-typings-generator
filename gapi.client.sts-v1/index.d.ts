...
declare namespace gapi.client {
  ...
  function load(
    urlOrObject: 'https://sts.googleapis.com/$discovery/rest?version=v1',
  ): Promise<void>;
  ...
  namespace sts {
    ...
    interface GoogleIdentityStsV1Jwk {
    ...
    interface GoogleIdentityStsV1Jwks {
      /** The JWKS for this OP. */
      keys?: GoogleIdentityStsV1Jwk[];
    }
    interface GoogleIdentityStsV1OpenIdProviderConfig {
    ...
    interface OpenidResource {
      ...
      getJwks(request?: {
        ...
        uploadType?: string;
      }): Request<GoogleIdentityStsV1Jwks>;
    }
    interface WellKnownResource {
      ...
      'getOpenid-configuration'(request?: {
        ...
        /** Legacy upload protocol for media (e.g. "media", "multipart"). */
        uploadType?: string;
      }): Request<GoogleIdentityStsV1OpenIdProviderConfig>;
    }
    interface WorkloadIdentityPoolsResource {
      openid: OpenidResource;
