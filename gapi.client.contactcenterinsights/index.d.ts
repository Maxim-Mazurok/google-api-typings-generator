    ...
    namespace contactcenterinsights {
        ...
        interface ConversationsResource {
            ...
            create(request: {
                 ...
                 * This value should be 4-32 characters and must match the regular expression /^[a-z0-9-]{4,32}$/. Valid characters are /a-z-/
                 */
            ...
            list(request?: {
                ...
                oauth_token?: string;
                /**
                 * The maximum number of conversations to return in the response. If this value is zero, the service will select a default size. A call might return fewer objects than requested. A
                 * non-empty `next_page_token` in the response indicates that more data is available.
                 */
                pageSize?: number;
                /**
