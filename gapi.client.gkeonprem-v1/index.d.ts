...
declare namespace gapi.client {
  ...
  namespace gkeonprem {
    ...
    interface BareMetalAdminBgpLbConfig {
      ...
      addressPools?: BareMetalAdminLoadBalancerAddressPool[];
      ...
      bgpPeerConfigs?: BareMetalAdminBgpPeerConfig[];
    ...
    interface BareMetalAdminBgpPeerConfig {
    ...
    interface BareMetalAdminLoadBalancerAddressPool {
    ...
    interface BareMetalAdminLoadBalancerNodePoolConfig {
    ...
    interface BareMetalAdminMultipleNetworkInterfacesConfig {
