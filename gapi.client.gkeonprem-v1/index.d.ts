...
declare namespace gapi.client {
    ...
    namespace gkeonprem {
        interface Authorization {
            /**
             * Required. For VMware and bare metal user clusters, users will be granted the cluster-admin role on the cluster, which provides full administrative access to the cluster. For bare
             * metal admin clusters, users will be granted the cluster-view role, which limits users to read-only access.
             */
            adminUsers?:
                ClusterUser[];
        }
        ...
        interface BareMetalAdminControlPlaneConfig {
            ...
            /**
             * Required. Configures the node pool running the control plane. If specified the corresponding NodePool will be created for the cluster's control plane. The NodePool will have the
        ...
        interface BareMetalParallelUpgradeConfig {
            ...
            concurrentNodes?:
                number;
            /**
             * The minimum number of nodes that should be healthy and available during an upgrade. If set to the default value of 0, it is possible that none of the nodes will be available during
             * an upgrade.
             */
        ...
        interface EnrollBareMetalAdminClusterRequest {
             ...
             * 409 if the cluster already exists. (https://tools.ietf.org/html/rfc1123) format.
             */
        ...
        interface EnrollBareMetalClusterRequest {
             ...
             * if the cluster already exists. (https://tools.ietf.org/html/rfc1123) format.
             */
            bareMetalClusterId?:
                string;
            /**
             * Optional. The object name of the bare metal cluster custom resource on the associated admin cluster. This field is used to support conflicting resource names when enrolling existing
             * clusters to the API. When not provided, this field will resolve to the bare_metal_cluster_id. Otherwise, it must match the object name of the bare metal cluster custom resource. It
        ...
        interface EnrollVmwareClusterRequest {
            ...
            adminClusterMembership?:
                string;
            /**
             * Optional. The object name of the VMware OnPremUserCluster custom resource on the associated admin cluster. This field is used to support conflicting resource names when enrolling
             * existing clusters to the API. When not provided, this field will resolve to the vmware_cluster_id. Otherwise, it must match the object name of the VMware OnPremUserCluster custom
        ...
        interface BareMetalAdminClustersResource {
            ...
            get(request?: {
                ...
                uploadType?:
                    string;
                /**
                 * View for bare metal admin cluster. When `BASIC` is specified, only the cluster resource name and membership are returned. The default/unset value `CLUSTER_VIEW_UNSPECIFIED` is
            ...
            unenroll(request?: {
                ...
                fields?:
                    string;
                /**
                 * If set to true, the unenrollment of a bare metal admin cluster resource will succeed even if errors occur during unenrollment. This parameter can be used when you want to
                 * unenroll admin cluster resource and the on-prem admin cluster is disconnected / unreachable. WARNING: Using this parameter when your admin cluster still exists may result in a
                 * deleted GCP admin cluster but existing resourcelink in on-prem admin cluster and membership.
                 */
                ignoreErrors?:
                    boolean;
                /** API key. Your API key identifies your project and provides you with API access, quota, and reports. Required unless you provide an OAuth 2.0 token. */
        ...
        interface BareMetalNodePoolsResource {
            ...
            get(request?: {
                ...
                uploadType?:
                    string;
                /**
                 * View for bare metal node pool. When `BASIC` is specified, only the node pool resource name is returned. The default/unset value `NODE_POOL_VIEW_UNSPECIFIED` is the same as
            ...
            list(request?: {
                ...
                uploadType?:
                    string;
                /**
                 * View for bare metal node pools. When `BASIC` is specified, only the node pool resource name is returned. The default/unset value `NODE_POOL_VIEW_UNSPECIFIED` is the same as
                 * `FULL', which returns the complete node pool configuration details.
                 */
                view?:
                    string;
            ...
            patch(request: {
                ...
                access_token?:
                    string;
                /**
                 * If set to true, and the bare metal node pool is not found, the request will create a new bare metal node pool with the provided configuration. The user must have both create and
        ...
        interface BareMetalClustersResource {
            ...
            get(request?: {
                ...
                uploadType?:
                    string;
                /**
                 * View for bare metal user cluster. When `BASIC` is specified, only the cluster resource name and admin cluster membership are returned. The default/unset value
        ...
        interface VmwareAdminClustersResource {
            ...
            get(request?: {
                ...
                uploadType?:
                    string;
                /**
                 * View for VMware admin cluster. When `BASIC` is specified, only the cluster resource name and membership are returned. The default/unset value `CLUSTER_VIEW_UNSPECIFIED` is the
        ...
        interface VmwareNodePoolsResource {
            ...
            get(request?: {
                ...
                uploadType?:
                    string;
                /**
                 * View for VMware node pool. When `BASIC` is specified, only the node pool resource name is returned. The default/unset value `NODE_POOL_VIEW_UNSPECIFIED` is the same as `FULL',
            ...
            list(request?: {
                ...
                uploadType?:
                    string;
                /**
                 * View for VMware node pools. When `BASIC` is specified, only the node pool resource name is returned. The default/unset value `NODE_POOL_VIEW_UNSPECIFIED` is the same as `FULL',
                 * which returns the complete node pool configuration details.
                 */
                view?:
                    string;
        ...
        interface VmwareClustersResource {
            ...
            get(request?: {
                ...
                uploadType?:
                    string;
                /**
                 * View for VMware user cluster. When `BASIC` is specified, only the cluster resource name and admin cluster membership are returned. The default/unset value
                 * `CLUSTER_VIEW_UNSPECIFIED` is the same as `FULL', which returns the complete cluster configuration details.
                 */
                view?:
                    string;
