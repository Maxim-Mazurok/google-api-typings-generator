...
declare namespace gapi.client {
    ...
    namespace chat {
        ...
        interface GoogleAppsCardV1Action {
             ...
             * are made by the user while the action is being processed. Not supported by Google Chat apps.
             */
        ...
        interface GoogleAppsCardV1Card {
            /**
             * The card's actions. Actions are added to the card's generated toolbar menu. Not supported by Google Chat apps. For example, the following JSON constructs a card action menu with
             * Settings and Send Feedback options: ``` "card_actions": [ { "actionLabel": "Settings", "onClick": { "action": { "functionName": "goToView", "parameters": [ { "key": "viewType",
             * "value": "SETTING" } ], "loadIndicator": "LoadIndicator.SPINNER" } } }, { "actionLabel": "Send Feedback", "onClick": { "openLink": { "url": "https://example.com/feedback" } } } ]
             * ```
             */
        ...
        interface ConversationsResource {
            ...
            messages(request: {
                ...
                requestId?: string;
                /**
                 * Optional. Deprecated: Use thread_key instead. Opaque thread identifier. To start or add to a thread, create a message and specify a `threadKey` or the thread.name. For example
                 * usage, see [Start or reply to a message thread](/chat/api/guides/crudl/messages#start_or_reply_to_a_message_thread).
                 */
                threadKey?: string;
        ...
        interface MessagesResource {
            ...
            body: Message): Request<Message>;
            /**
             * Deletes a message. Requires [service account authentication](https://developers.google.com/chat/api/guides/auth/service-accounts). [Developer
             * Preview](https://developers.google.com/workspace/preview): Deletes a message. Requires [user authentication](https://developers.google.com/chat/api/guides/auth/users) and the
            ...
            /**
             * Returns a message. Requires [service account authentication](https://developers.google.com/chat/api/guides/auth/service-accounts). [Developer
             * Preview](https://developers.google.com/workspace/preview): Returns a message. Requires [user authentication](https://developers.google.com/chat/api/guides/auth/users) and the
             * `chat.messages` or `chat.messages.readonly` authorization scope. Messages from a blocked member or messages from a blocked space can also be fetched.
             */
            get(request?: {
                /** V1 error format. */
                "$.xgafv"?: string;
