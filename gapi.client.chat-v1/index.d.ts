    ...
    namespace chat {
        ...
        interface Message {
            ...
            space?:
                Space;
            /**
             * Plain-text body of the message. The first link to an image, video, or web page generates a preview chip. You can also @mention a Google Chat user, or everyone in the space. To learn
             * about creating text messages, see [Create a text message](https://developers.google.com/chat/api/guides/message-formats/text).
             */
            text?:
                string;
            /**
        ...
        interface Space {
            ...
            displayName?:
                string;
            /**
             * Immutable. Whether this space permits any Google Chat user as a member. Input when creating a space in a Google Workspace organization. For Google Chat users that use a Google
             * Account, omit this field when creating a space (By default, the space permits any Google Chat user). For existing spaces, this field is output only.
             */
            externalUserAllowed?:
                boolean;
        ...
        interface MembersResource {
             ...
             * `users/app`. Unable to add other apps to the space. - To add a human user, use `users/{user}`, where `{user}` can be the email address for the user. For users in the same Workspace
             * organization `{user}` can also be the `{person_id}` for the person from the People API, or the `id` for the user in the Directory API. For example, if the People API Person
             * `resourceName` for `user@example.com` is `people/123456789`, you can add the user to the space by setting the `membership.member.name` to `users/user@example.com` or
             * `users/123456789`.
             */
            create(request: {
                /** V1 error format. */
        ...
        interface MessagesResource {
             ...
             * [authentication](https://developers.google.com/chat/api/guides/auth). Fully supports [service account
             * authentication](https://developers.google.com/chat/api/guides/auth/service-accounts) and [user authentication](https://developers.google.com/chat/api/guides/auth/users). [User
             * authentication](https://developers.google.com/chat/api/guides/auth/users) requires the `chat.messages` authorization scope. Requests authenticated with service accounts can only
             ...
             * Requires [user authentication](https://developers.google.com/chat/api/guides/auth/users) and the `chat.messages` or `chat.messages.readonly` authorization scope.
             */
            list(request?: {
                /** V1 error format. */
                "$.xgafv"?:
        ...
        interface SpacesResource {
             ...
             * display name. Requires [user authentication](https://developers.google.com/chat/api/guides/auth/users) and the `chat.spaces.create` or `chat.spaces` scope.
             */
            create(request: {
                /** V1 error format. */
                "$.xgafv"?:
             ...
             * name. Requires [user authentication](https://developers.google.com/chat/api/guides/auth/users) and the `chat.spaces.create` or `chat.spaces` scope.
             */
            setup(request: {
                /** V1 error format. */
                "$.xgafv"?:
