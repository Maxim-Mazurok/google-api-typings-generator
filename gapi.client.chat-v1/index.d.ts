...
declare namespace gapi.client {
    ...
    namespace chat {
        ...
        interface Message {
             ...
             * [dialogs](https://developers.google.com/chat/how-tos/dialogs). `cards_v2` and `cards` can have a maximum size of 32 KB. The `cardId` is a unique identifier among cards in the same
             * message and for identifying user input values. Currently supported widgets include: - `TextParagraph` - `DecoratedText` - `Image` - `ButtonList` - `Divider` - `TextInput` -
