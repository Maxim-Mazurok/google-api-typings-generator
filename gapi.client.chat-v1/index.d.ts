...
declare namespace gapi.client {
  ...
  namespace chat {
    ...
    interface AccessPermissionSetting {
      /** Optional. Unordered list. Allowed principals for this permission. */
      principals?: Principal[];
    }
    interface AccessPermissionSettings {
      ...
      viewSpaceMembershipSetting?: AccessPermissionSetting;
    }
    interface AccessSettings {
      ...
      accessState?: 'ACCESS_STATE_UNSPECIFIED' | 'PRIVATE' | 'DISCOVERABLE';
    ...
    interface DoNotDisturbMetadata {
    ...
    interface Empty {}
    interface FindGroupChatsResponse {
    ...
    interface GoogleAppsCardV1ChipList {
      ...
      layout?: 'LAYOUT_UNSPECIFIED' | 'WRAPPED' | 'HORIZONTAL_SCROLLABLE';
    }
    ...
    interface GoogleAppsCardV1TextParagraph {
      ...
      textSyntax?: 'TEXT_SYNTAX_UNSPECIFIED' | 'HTML' | 'MARKDOWN';
    }
    ...
    interface GoogleAppsCardV1UpdateVisibilityAction {
      /** The new visibility. */
      visibility?: 'VISIBILITY_UNSPECIFIED' | 'VISIBLE' | 'HIDDEN';
    }
    ...
    interface ListMessagePinsResponse {
    ...
    interface ListSectionItemsResponse {
    ...
    interface MarkAsAwayRequest {}
    interface MarkAsDoNotDisturbRequest {
    ...
    interface MeetSpaceLinkData {
      ...
      type?: 'TYPE_UNSPECIFIED' | 'MEETING' | 'HUDDLE';
    }
    ...
    interface PermissionSettings {
      ...
      viewSpaceMembership?: PermissionSetting;
    }
    interface PositionSectionRequest {
    ...
    interface PositionSectionResponse {
      /** The updated section. */
    ...
    interface QuotedMessageMetadata {
      ...
      quoteType?: 'QUOTE_TYPE_UNSPECIFIED' | 'REPLY' | 'FORWARD';
    }
    ...
    interface SearchMessageResult {
      ...
      spaceMuteSetting?: 'MUTE_SETTING_UNSPECIFIED' | 'UNMUTED' | 'MUTED';
    }
    ...
    interface SpaceNotificationSetting {
      ...
      muteSetting?: 'MUTE_SETTING_UNSPECIFIED' | 'UNMUTED' | 'MUTED';
    ...
    interface WorkflowDataSourceMarkup {
      ...
      type?: 'UNKNOWN' | 'USER' | 'SPACE' | 'USER_WITH_FREE_FORM';
    }
    ...
    interface MessagePinsResource {
      ...
      list(request?: {
        ...
        /** Legacy upload protocol for media (e.g. "media", "multipart"). */
        uploadType?: string;
      }): Request<ListMessagePinsResponse>;
    }
    ...
    interface MessagesResource {
      ...
      search(request: {
        ...
        uploadType?: string;
        /** Request body */
        resource: SearchMessagesRequest;
    ...
    interface SpacesResource {
      ...
      findGroupChats(request?: {
        ...
        users?: string | string[];
      }): Request<FindGroupChatsResponse>;
      ...
      messagePins: MessagePinsResource;
    ...
    interface AvailabilityResource {
      ...
      markAsDoNotDisturb(request: {
        ...
        uploadType?: string;
        /** Request body */
        resource: MarkAsDoNotDisturbRequest;
      }): Request<Availability>;
      markAsDoNotDisturb(
        request: {
          /** V1 error format. */
    ...
    interface ItemsResource {
      ...
      list(request?: {
        ...
        /** Legacy upload protocol for media (e.g. "media", "multipart"). */
        uploadType?: string;
      }): Request<ListSectionItemsResponse>;
      ...
      move(request: {
        ...
        uploadType?: string;
        /** Request body */
        resource: MoveSectionItemRequest;
      }): Request<MoveSectionItemResponse>;
      move(
        request: {
          /** V1 error format. */
          '$.xgafv'?: '1' | '2';
    ...
    interface SectionsResource {
      ...
      create(request: {
        ...
        uploadType?: string;
        /** Request body */
        resource: GoogleChatV1Section;
      }): Request<GoogleChatV1Section>;
      create(
        request: {
          /** V1 error format. */
          '$.xgafv'?: '1' | '2';
      ...
      position(request: {
        ...
        uploadType?: string;
        /** Request body */
        resource: PositionSectionRequest;
      }): Request<PositionSectionResponse>;
      position(
        request: {
          /** V1 error format. */
          '$.xgafv'?: '1' | '2';
