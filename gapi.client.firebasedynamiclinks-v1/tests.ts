/* This is stub file for gapi.client.firebasedynamiclinks-v1 definition tests */
// IMPORTANT
...
gapi.load('client', async () => {
    ...
    await gapi.client.load('https://firebasedynamiclinks.googleapis.com/$discovery/rest?version=v1');
