...
declare namespace gapi.client {
  ...
  namespace civicinfo {
    interface CivicinfoApiprotosV2DivisionByAddressResponse {
      divisions?: {[P in string]: CivicinfoSchemaV2GeographicDivision};
      /** The normalized version of the requested address. */
      normalizedInput?: CivicinfoSchemaV2SimpleAddressType;
    }
    interface CivicinfoApiprotosV2DivisionSearchResponse {
      /** Identifies what kind of resource this is. Value: the fixed string "civicinfo#divisionSearchResponse". */
      kind?: string;
      results?: CivicinfoApiprotosV2DivisionSearchResult[];
    }
    interface CivicinfoApiprotosV2DivisionSearchResult {
    ...
    interface CivicinfoApiprotosV2RepresentativeInfoData {
      ...
      offices?: CivicinfoSchemaV2Office[];
      /** Officials holding the offices listed above. Will only be present if includeOffices was true in the request. */
      officials?: CivicinfoSchemaV2Official[];
    }
    interface CivicinfoApiprotosV2RepresentativeInfoResponse {
      /** A map of political geographic divisions that contain the requested address, keyed by the unique Open Civic Data identifier for this division. */
      divisions?: {[P in string]: CivicinfoSchemaV2GeographicDivision};
    ...
    interface CivicinfoApiprotosV2VoterInfoResponse {
      /** Contests that will appear on the voter's ballot. */
      contests?: CivicinfoSchemaV2Contest[];
      /** Locations where a voter is eligible to drop off a completed ballot. The voter must have received and completed a ballot prior to arriving at the location. The location may not have ballots available on the premises. These locations could be open on or before election day as indicated in the pollingHours field. */
      dropOffLocations?: CivicinfoSchemaV2PollingLocation[];
      /** Locations where the voter is eligible to vote early, prior to election day. */
      earlyVoteSites?: CivicinfoSchemaV2PollingLocation[];
      ...
      otherElections?: CivicinfoSchemaV2Election[];
      /** Locations where the voter is eligible to vote on election day. */
      pollingLocations?: CivicinfoSchemaV2PollingLocation[];
      precinctId?: string;
      ...
      precincts?: CivicinfoSchemaV2Precinct[];
      /** Local Election Information for the state that the voter votes in. For the US, there will only be one element in this array. */
      state?: CivicinfoSchemaV2AdministrationRegion[];
    }
    ...
    interface CivicinfoSchemaV2AdministrativeBody {
      ...
      electionOfficials?: CivicinfoSchemaV2ElectionOfficial[];
    ...
    interface CivicinfoSchemaV2Contest {
      /** A number specifying the position of this contest on the voter's ballot. */
      ballotPlacement?: string;
      /** The official title on the ballot for this contest, only where available. */
      ballotTitle?: string;
      /** The candidate choices for this contest. */
      candidates?: CivicinfoSchemaV2Candidate[];
    ...
    interface CivicinfoSchemaV2Election {
    ...
    interface CivicinfoSchemaV2ElectoralDistrict {
    ...
    interface CivicinfoSchemaV2Office {
    ...
    interface CivicinfoSchemaV2Official {
    ...
    interface CivicinfoSchemaV2PollingLocation {
    ...
    interface CivicinfoSchemaV2Precinct {
    ...
    interface CivicinfoSchemaV2SimpleAddressType {
    ...
    interface CivicinfoSchemaV2Source {
    ...
    interface DivisionsResource {
      ...
      queryDivisionByAddress(request?: {
        ...
        uploadType?: string;
      }): Request<CivicinfoApiprotosV2DivisionByAddressResponse>;
      ...
      search(request?: {
        ...
        /** Legacy upload protocol for media (e.g. "media", "multipart"). */
        uploadType?: string;
      }): Request<CivicinfoApiprotosV2DivisionSearchResponse>;
    }
    interface ElectionsResource {
      ...
      electionQuery(request?: {
        ...
        /** Legacy upload protocol for media (e.g. "media", "multipart"). */
        uploadType?: string;
      }): Request<CivicinfoApiprotosV2ElectionsQueryResponse>;
      ...
      voterInfoQuery(request?: {
        ...
        /** Legacy upload protocol for media (e.g. "media", "multipart"). */
        uploadType?: string;
      }): Request<CivicinfoApiprotosV2VoterInfoResponse>;
    }
    interface RepresentativesResource {
      ...
      representativeInfoByAddress(request?: {
        ...
        /** Legacy upload protocol for media (e.g. "media", "multipart"). */
        uploadType?: string;
      }): Request<CivicinfoApiprotosV2RepresentativeInfoResponse>;
      ...
      representativeInfoByDivision(request?: {
        ...
        /** Legacy upload protocol for media (e.g. "media", "multipart"). */
        uploadType?: string;
      }): Request<CivicinfoApiprotosV2RepresentativeInfoData>;
    }
