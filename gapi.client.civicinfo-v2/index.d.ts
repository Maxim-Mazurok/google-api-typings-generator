...
declare namespace gapi.client {
    ...
    function load(urlOrObject: "https://civicinfo.googleapis.com/$discovery/rest?version=v2"): Promise<void>;
    ...
    namespace civicinfo {
        ...
        interface RepresentativeInfoData {
            ...
            divisions?:
                { [P in string]: GeographicDivision };
        ...
        interface ElectionsResource {
            ...
            voterInfoQuery(request?: {
                ...
                prettyPrint?:
                    boolean;
                /**
                 * Whether to include data that has not been vetted yet. Should only be made available to internal IPs or trusted partners. This is a non-discoverable parameter in the One Platform
                 * API config.
                 */
                productionDataOnly?:
                    boolean;
