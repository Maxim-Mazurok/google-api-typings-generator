    ...
    namespace composer {
        ...
        interface EnvironmentsResource {
            ...
            patch(request: {
                 ...
                 * WebServerNetworkAccessControl. config.databaseConfig Replace the environment's current DatabaseConfig. config.webServerConfig Replace the environment's current WebServerConfig.
