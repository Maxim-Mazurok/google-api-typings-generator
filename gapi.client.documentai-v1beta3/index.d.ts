...
declare namespace gapi.client {
    ...
    namespace documentai {
        ...
        interface GoogleCloudDocumentaiV1beta1Document {
            ...
            /**
             * Optional. Currently supports Google Cloud Storage URI of the form `gs://bucket_name/object_name`. Object versioning is not supported. For more information, refer to [Google Cloud
             * Storage Request URIs](https://cloud.google.com/storage/docs/reference-uris).
             */
            uri?:
                string;
        }
        ...
        interface GoogleCloudDocumentaiV1beta3BatchProcessRequestBatchInputConfig {
            ...
            gcsSource?:
                string;
            /**
             * Media type (MIME type) of the input. If the input is a raw document, refer to [supported file types](https://cloud.google.com/document-ai/docs/file-types) for the list of media
        ...
        interface GoogleCloudDocumentaiV1beta3ProcessRequest {
            ...
            /**
             * Specifies which fields to include in the ProcessResponse.document output. Only supports top-level document and pages field, so it must be in the form of `{document_field_name}` or
             * `pages.{page_field_name}`.
             */
            fieldMask?:
                string;
        ...
        interface GoogleCloudDocumentaiV1beta3ProcessResponse {
            ...
            document?:
                GoogleCloudDocumentaiV1beta3Document;
            /**
             * The name of the operation triggered by the processed document. If the human review process isn't triggered, this field is empty. It has the same response type and metadata as the
        ...
        interface ProcessorVersionsResource {
            ...
            list(request?: {
                ...
                oauth_token?:
                    string;
                /**
                 * The maximum number of processor versions to return. If unspecified, at most `10` processor versions will be returned. The maximum value is `20`. Values above `20` will be
                 * coerced to `20`.
                 */
                pageSize?:
                    number;
        ...
        interface ProcessorTypesResource {
            ...
            list(request?: {
                ...
                oauth_token?:
                    string;
                /**
                 * The maximum number of processor types to return. If unspecified, at most `100` processor types will be returned. The maximum value is `500`. Values above `500` will be coerced
                 * to `500`.
                 */
                pageSize?:
                    number;
