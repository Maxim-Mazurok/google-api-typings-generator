    ...
    namespace bigqueryreservation {
        ...
        interface CapacityCommitmentsResource {
            ...
            create(request: {
                 ...
                 * characters or dash. Max length is 64 characters. NOTE: this ID won't be kept if the capacity commitment is split or merged.
                 */
        ...
        interface AssignmentsResource {
            ...
            create(request: {
                ...
                alt?: string;
                /**
                 * The optional assignment ID. Assignment name will be generated automatically if this field is empty. This field must only contain lower case alphanumeric characters or dash. Max
