...
declare namespace gapi.client {
    ...
    namespace bigqueryreservation {
        interface Assignment {
            ...
            jobType?: string;
            /**
             * Output only. Name of the resource. E.g.: `projects/myproject/locations/US/reservations/team1-prod/assignments/123`. For the assignment id, it must only contain lower case
             * alphanumeric characters or dashes and the max length is 64 characters.
             */
            name?: string;
        ...
        interface CapacityCommitment {
            ...
            /**
             * Output only. The resource name of the capacity commitment, e.g., `projects/myproject/locations/US/capacityCommitments/123` For the commitment id, it must only contain lower case
        ...
        interface Reservation {
            ...
            multiRegionAuxiliary?: boolean;
            /**
             * The resource name of the reservation, e.g., `projects/*‍/locations/*‍/reservations/team1-prod`. For the reservation id, it must only contain lower case alphanumeric characters or
             ...
             * more slots during runtime if ignore_idle_slots is set to false. If the new reservation's slot capacity exceed the project's slot capacity or if total slot capacity of the new
             * reservation and its siblings exceeds the project's slot capacity, the request will fail with `google.rpc.Code.RESOURCE_EXHAUSTED`. NOTE: for reservations in US or EU multi-regions
             * slot capacity constraints are checked separately for default and auxiliary regions. See multi_region_auxiliary flag for more details.
             */
            slotCapacity?: string;
        ...
        interface ReservationsResource {
            ...
            patch(request: {
                ...
                key?: string;
                /**
                 * The resource name of the reservation, e.g., `projects/*‍/locations/*‍/reservations/team1-prod`. For the reservation id, it must only contain lower case alphanumeric characters
                 * or dashes.It must start with a letter and must not end with a dash. Its maximum length is 64 characters.
                 */
                name: string;
                /** OAuth 2.0 token for the current user. */
                oauth_token?: string;
