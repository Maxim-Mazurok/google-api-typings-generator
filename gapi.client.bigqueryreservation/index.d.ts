...
declare namespace gapi.client {
    ...
    namespace bigqueryreservation {
        ...
        interface Reservation {
             ...
             * more slots during runtime if ignore_idle_slots is set to false. If the new reservation's slot capacity exceeds the project's slot capacity or if total slot capacity of the new
