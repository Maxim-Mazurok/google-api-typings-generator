/* Type definitions for non-npm package Managed Service for Microsoft Active Directory API v1alpha1 0.0 */
...
declare namespace gapi.client {
    ...
    function load(urlOrObject: "https://managedidentities.googleapis.com/$discovery/rest?version=v1alpha1"): Promise<void>;
    /** @deprecated Please load APIs with discovery documents. */
    function load(name: "managedidentities", version: "v1alpha1"): Promise<void>;
    /** @deprecated Please load APIs with discovery documents. */
    function load(name: "managedidentities", version: "v1alpha1", callback: () => any): void;
