...
declare namespace gapi.client {
    ...
    function load(name: "dfareporting", version: "v4"): PromiseLike<void>;
    function load(name: "dfareporting", version: "v4", callback: () => any): void;
    ...
    namespace dfareporting {
        ...
        interface BillingAssignmentsResource {
            ...
            body: BillingAssignment): Request<BillingAssignment>;
        ...
        interface BillingProfilesResource {
            ...
            body: BillingProfile): Request<BillingProfile>;
        }
