...
// Generated from: https://www.googleapis.com/discovery/v1/apis/dfareporting/v3.4/rest
// Revision: 20200306

/// <reference types="gapi.client" />

declare namespace gapi.client {
    /** Load DCM/DFA Reporting And Trafficking API v3.4 */
    function load(name: "dfareporting", version: "v3.4"): PromiseLike<void>;
    function load(name: "dfareporting", version: "v3.4", callback: () => any): void;
    ...
    namespace dfareporting {
        ...
        interface CreativeAsset {
             ...
             * TRANSCODED_VIDEO refers to videos transcoded by Campaign Manager from PARENT_VIDEO assets and is applicable to INSTREAM_VIDEO and VPAID_LINEAR_VIDEO
             * creatives.
             * ALTERNATE_VIDEO refers to the Campaign Manager representation of child asset videos from Studio, and is applicable to VPAID_LINEAR_VIDEO creatives.
             * These cannot be added or removed within Campaign Manager.
        ...
        interface CustomEvent {
            /**
             * Annotate an impression. This field is mutually exclusive with insertEvent and annotateImpressionEvent. This or insertEvent and annotateImpressionEvent
             * is a required field.
             */
            ...
            floodlightConfigurationId?: string;
            /**
             * Annotate an impression. This field is mutually exclusive with annotateClickEvent and annotateImpressionEvent. This or annotateClickEvent and
        ...
        interface ObaIcon {
            ...
            program?: string;
            /** OBA icon resource script URL. Campaign Manager only supports image, JavaScript, and Flash icons. Learn more */
            resourceUrl?: string;
            /** OBA icon size. */
            size?: Size;
        ...
        interface ConversionsResource {
            ...
            body: ConversionsBatchInsertRequest): Request<ConversionsBatchInsertResponse>;
            ...
            body: ConversionsBatchUpdateRequest): Request<ConversionsBatchUpdateResponse>;
        }
        ...
        interface CustomEventsResource {
            ...
            batchinsert(request: {
                ...
                userIp?: string;
                /** Request body */
                resource: CustomEventsBatchInsertRequest;
            }): Request<CustomEventsBatchInsertResponse>;
            batchinsert(request: {
                /** Data format for the response. */
                alt?: string;
                /** Selector specifying which fields to include in a partial response. */
            ...
            body: CustomEventsBatchInsertRequest): Request<CustomEventsBatchInsertResponse>;
        }
        interface DimensionValuesResource {
            ...
            body: DimensionValueRequest): Request<DimensionValueList>;
        }
        ...
        interface CompatibleFieldsResource {
            ...
            body: Report): Request<CompatibleFields>;
        }
        interface FilesResource {
        ...
        const customEvents: CustomEventsResource;
        ...
        const inventoryItems: InventoryItemsResource;
