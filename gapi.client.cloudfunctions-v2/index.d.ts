...
declare namespace gapi.client {
    ...
    namespace cloudfunctions {
        ...
        interface BuildConfig {
             ...
             * `docker_repository` field is specified, this field will be automatically set as `ARTIFACT_REGISTRY`. If unspecified, it currently defaults to `CONTAINER_REGISTRY`. This field may be
        ...
        interface ServiceConfig {
            ...
            /**
             * The number of CPUs used in a single container instance. Default value is calculated from available memory. Supports the same values as Cloud Run, see
