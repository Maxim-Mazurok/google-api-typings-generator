# TypeScript typings for Developer Knowledge API v1
...
```
npm install @types/gapi.client.developerknowledge-v1 --save-dev
```
...
```json
{
  "compilerOptions": {
    "types": [
      ...
      "gapi.auth2",
      "gapi.client",
      "gapi.client.developerknowledge-v1"
    ]
  }
}
```
...
gapi.client.load('developerknowledge', 'v1', () => {
  // now we can use:
  // gapi.client.developerknowledge
});
```
