...
// Generated from: https://cloudfunctions.googleapis.com/$discovery/rest?version=v2beta
// Revision: 20220805

/// <reference types="gapi.client" />

declare namespace gapi.client {
    /** Load Cloud Functions API v2beta */
    function load(urlOrObject: "https://cloudfunctions.googleapis.com/$discovery/rest?version=v2beta"): Promise<void>;
    /** @deprecated Please load APIs with discovery documents. */
    function load(name: "cloudfunctions", version: "v2beta"): Promise<void>;
    /** @deprecated Please load APIs with discovery documents. */
    function load(name: "cloudfunctions", version: "v2beta", callback: () => any): void;
