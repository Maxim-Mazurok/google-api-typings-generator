...
// Generated from: https://books.googleapis.com/$discovery/rest?version=v1
// Revision: 20230711
...
declare namespace gapi.client {
    /** Load Books API v1 */
    function load(urlOrObject: "https://books.googleapis.com/$discovery/rest?version=v1"): Promise<void>;
    ...
    namespace books {
        ...
        interface DictionaryAnnotationdata {
            ...
            geo?:
                {
                    ...
                    /**
                     * The Zoom level to use for the map. Zoom levels between 0 (the lowest zoom level, in which the entire world can be seen on one map) to 21+ (down to individual buildings).
            ...
            accessInfo?:
                {
                    ...
                    /**
                     * Whether this volume requires that the client explicitly request offline download license rather than have it done automatically when loading the content, if the client
                     * supports it.
                     */
                    ...
                    familySharing?:
                        {
                            ...
                            familyRole?:
                                string;
                            /**
                             * Whether or not this volume can be shared with the family by the user. This includes sharing eligibility of both the volume and the user. If the value is true, the
                             * user can initiate a family sharing action.
                             */
                            isSharingAllowed?:
                                boolean;
        ...
        interface CloudloadingResource {
            ...
            body: BooksCloudloadingResource): Request<BooksCloudloadingResource>;
        }
        ...
        interface AnnotationDataResource {
            ...
            get(request?: {
                ...
                w?:
                    number;
            }): Request<DictionaryAnnotationdata>;
        ...
        interface MyconfigResource {
            ...
            body: Usersettings): Request<Usersettings>;
        }
        ...
        const bookshelves: BookshelvesResource;

        const cloudloading: CloudloadingResource;

        const dictionary: DictionaryResource;

        const familysharing: FamilysharingResource;

        const layers: LayersResource;

        const myconfig: MyconfigResource;

        const mylibrary: MylibraryResource;

        const notification: NotificationResource;

        const onboarding: OnboardingResource;

        const personalizedstream: PersonalizedstreamResource;

        const promooffer: PromoofferResource;

        const series: SeriesResource;

        const volumes: VolumesResource;
    }
}
