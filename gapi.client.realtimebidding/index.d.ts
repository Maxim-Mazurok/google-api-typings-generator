...
declare namespace gapi.client {
    ...
    namespace realtimebidding {
        ...
        interface Creative {
            ...
            /**
             * Name of the creative. Follows the pattern `buyers/{buyer}/creatives/{creative}`, where `{buyer}` represents the account ID of the buyer who owns the creative, and `{creative}` is
             * the buyer-specific creative ID that references this creative in the bid response.
             */
            name?: string;
            /** A native creative. */
        ...
        interface CreativesResource {
            ...
            patch(request: {
                ...
                key?: string;
                /**
                 * Name of the creative. Follows the pattern `buyers/{buyer}/creatives/{creative}`, where `{buyer}` represents the account ID of the buyer who owns the creative, and `{creative}`
