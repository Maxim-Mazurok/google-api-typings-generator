...
declare namespace gapi.client {
    ...
    namespace cloudsearch {
        ...
        interface Item {
             ...
             * length for this field is 1024 bytes. See [this guide](https://developers.devsite.corp.google.com/cloud-search/docs/guides/operations) to understand how item version affects
             * reindexing after delete item.
             */
            version?: string;
        }
        interface ItemAcl {
        ...
        interface ItemsResource {
            ...
            delete(request?: {
                 ...
                 * version of the currently indexed item. The maximum length for this field is 1024 bytes. See [this
                 * guide](https://developers.devsite.corp.google.com/cloud-search/docs/guides/operations) to understand how item version affects reindexing after delete item.
                 */
                version?: string;
            }): Request<Operation>;
            /**
