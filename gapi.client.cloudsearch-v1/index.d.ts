...
declare namespace gapi.client {
  ...
  namespace cloudsearch {
    ...
    interface SuggestSuggestRequestRequestData {
      ...
      longitude?: number;
      /** If true, only fetch lookahead buffer and ignore suggest_results. */
      lookaheadAdditionalResultsOnly?: boolean;
      /** If set, sends enough suggest results to cover the specified ratio of probable next characters the user will type. */
      lookaheadCoverage?: number;
