...
declare namespace gapi.client {
    ...
    namespace cloudsearch {
        ...
        interface UserInfo {
            ...
            /**
             * The display name of the updater for clients to show used for Gmail items. This (along with the updater fields above) will be populated in the thread pipeline
             * (http://shortn/_rPS0GCp94Y) when converting Activity Feed message attributes into client-renderable Activity Feed items.
             */
