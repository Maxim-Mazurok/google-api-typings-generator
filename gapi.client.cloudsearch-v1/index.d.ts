...
declare namespace gapi.client {
    ...
    namespace cloudsearch {
        ...
        interface UserInfo {
             ...
             * only be used to fetch user avatars when updater_to_show_email is not populated. This field is not set for non-Drive Notification items. This is not the actual sender of the email,
             * as the sender is always comments-noreply@docs.google.com.
             */
             ...
             * for the user, the fallback string will be the email address. For Drive Notification items, this is the email of the user who triggered the Drive notification email. This field will
             * be populated if we can extract such information from the Drive Notification email. This is not the actual sender of the email, as the sender is always
             * comments-noreply@docs.google.com.
             */
