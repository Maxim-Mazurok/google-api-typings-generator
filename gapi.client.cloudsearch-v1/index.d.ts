...
// Project: https://developers.google.com/workspace/cloud-search/docs/guides/
...
declare namespace gapi.client {
  ...
  namespace cloudsearch {
    ...
    interface EnterpriseTopazFrontendTeamsPersonCorePhoneNumber {
      ...
      type?: 'UNKNOWN' | 'MOBILE' | 'OFFICE' | 'OTHER';
    }
    ...
    interface EnterpriseTopazSidekickMeetingNotesCardRequest {
      ...
      canCreateFor?: 'UNKNOWN' | 'MYSELF' | 'ALL_ATTENDEES'[];
    ...
    interface EnterpriseTopazSidekickPersonProfileCardRelatedPeople {
      ...
      /** Relation type. */
      relation?: 'UNKNOWN' | 'MANAGER' | 'DIRECT_REPORT';
    }
