...
declare namespace gapi.client {
    ...
    namespace cloudsearch {
        ...
        interface UpdateDataSourceRequest {
            ...
            source?: DataSource;
            /**
             * Update mask to control which fields to update. If update_mask is non-empty then only the fields specified in the update_mask are updated. If you specify a field in the update_mask,
             * but don't specify its value in the source that field will be cleared. If the update_mask is not present or empty or has the value * then all fields will be updated. Some example
             * field paths: name, display_name
             */
            updateMask?: string;
        }
        ...
        interface DatasourcesResource {
            ...
            patch(request: {
                ...
                quotaUser?: string;
                /**
                 * Update mask to control which fields to update. If update_mask is non-empty then only the fields specified in the update_mask are updated. If you specify a field in the
                 * update_mask, but don't specify its value in the source that field will be cleared. If the update_mask is not present or empty or has the value * then all fields will be updated.
        ...
        interface SearchapplicationsResource {
            ...
            patch(request: {
                ...
                /**
                 * Update mask to control which fields to update. If update_mask is non-empty then only the fields specified in the update_mask are updated. If you specify a field in the
                 * update_mask, but don't specify its value in the search_application then that field will be cleared. If the update_mask is not present or empty or has the value * then all fields
                 * will be updated. Some example field paths: search_application.name, search_application.display_name
                 */
                updateMask?: string;
                /** Upload protocol for media (e.g. "raw", "multipart"). */
                upload_protocol?: string;
