...
gapi.load('client', async () => {
  ...
  async function run() {
          ...
          objectDefinitions: [
            {
              ...
              options: {
                ...
                suggestionFilteringOperators: ['Test string'],
              },
              propertyDefinitions: [
                {
    ...
    await gapi.client.cloudsearch.query.removeActivity(
      ...
      {
        requestOptions: {
          clientDisplayLanguageCode: 'Test string',
    ...
    await gapi.client.cloudsearch.query.sources.list({
      pageToken: 'Test string',
      'requestOptions.clientDisplayLanguageCode': 'Test string',
      'requestOptions.countryCode': 'Test string',
    ...
    await gapi.client.cloudsearch.settings.datasources.create(
      {},
      {
        ...
        indexingServiceAccounts: ['Test string'],
        itemsVisibility: [
          {
            gsuiteDomain: true,
            gsuiteGroupEmail: 'Test string',
