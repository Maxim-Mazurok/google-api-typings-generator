...
declare namespace gapi.client {
    ...
    namespace cloudresourcemanager {
        ...
        interface Folder {
            ...
            createTime?: string;
            /**
             * The folder’s display name. A folder’s display name must be unique amongst its siblings, e.g. no two folders with the same parent can share the same
             * display name. The display name must start and end with a letter or digit, may contain letters, digits, spaces, hyphens and underscores and can be no
             * longer than 30 characters. This is captured by the regular expression: [\p{L}\p{N}]([\p{L}\p{N}_- ]{0,28}[\p{L}\p{N}])?.
             */
            displayName?: string;
        ...
        interface MoveFolderRequest {
            /**
             * Required. The resource name of the Folder or Organization to reparent the folder under. Must be of the form `folders/{folder_id}` or
        ...
        interface ProjectCreationStatus {
            ...
            createTime?: string;
            /**
             * True if the project can be retrieved using GetProject. No other operations on the project are guaranteed to work until the project creation is
             * complete.
             */
            gettable?: boolean;
        ...
        interface SearchFoldersRequest {
            ...
            pageToken?: string;
            /**
             * Search criteria used to select the Folders to return. If no search criteria is specified then all accessible folders will be returned. Query
             * expressions can be used to restrict results based upon displayName, lifecycleState and parent, where the operators `=`, `NOT`, `AND` and `OR` can be
             * used along with the suffix wildcard symbol `&#42;`. The displayName field in a query expression should use escaped quotes for values that include
             * whitespace to prevent unexpected behavior. Some example queries are: &#42; Query `displayName=Test&#42;` returns Folder resources whose display name starts
             * with "Test". &#42; Query `lifecycleState=ACTIVE` returns Folder resources with `lifecycleState` set to `ACTIVE`. &#42; Query `parent=folders/123` returns
             * Folder resources that have `folders/123` as a parent resource. &#42; Query `parent=folders/123 AND lifecycleState=ACTIVE` returns active Folder resources
             * that have `folders/123` as a parent resource. &#42; Query `displayName=\\"Test String\\"` returns Folder resources with display names that include both
             * "Test" and "String".
             */
            query?: string;
        }
        ...
        interface FoldersResource {
            ...
            list(request?: {
                ...
                pageToken?: string;
                /**
                 * Required. The resource name of the Organization or Folder whose Folders are being listed. Must be of the form `folders/{folder_id}` or
                 * `organizations/{org_id}`. Access to this method is controlled by checking the `resourcemanager.folders.list` permission on the `parent`.
                 */
                parent?: string;
                /** Returns response with indentations and line breaks. */
                prettyPrint?: boolean;
