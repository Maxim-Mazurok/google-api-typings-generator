...
declare namespace gapi.client {
    ...
    namespace cloudresourcemanager {
        ...
        interface ListTagBindingsResponse {
            /**
             * A pagination token returned from a previous call to `ListTagBindings` that indicates from where listing should continue. This is currently not used, but the server may at any point
        ...
        interface ListTagKeysResponse {
            /**
             * A pagination token returned from a previous call to `ListTagKeys` that indicates from where listing should continue. This is currently not used, but the server may at any point
             * start supplying a valid token.
             */
            nextPageToken?: string;
        ...
        interface TagValuesResource {
            ...
            list(request?: {
                ...
                oauth_token?: string;
                /**
                 * Optional. The maximum number of TagValues to return in the response. This is currently not used by the server and will return the full page even if a size is specified
                 * currently.
                 */
                pageSize?: number;
