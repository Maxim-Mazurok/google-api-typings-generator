...
// Generated from: https://networkservices.googleapis.com/$discovery/rest?version=v1
// Revision: 20220616
...
declare namespace gapi.client {
    ...
    function load(name: "networkservices", version: "v1"): PromiseLike<void>;
    function load(name: "networkservices", version: "v1", callback: () => any): void;
    ...
    namespace networkservices {
        ...
        interface EndpointMatcherMetadataLabelMatcherMetadataLabels {
        ...
        interface HttpRoutesResource {
            ...
            list(request?: {
                ...
                pageSize?: number;
                /**
                 * The value returned by the last `ListHttpRoutesResponse` Indicates that this is a continuation of a prior `ListRouters` call, and that the system should return the next page of
                 * data.
                 */
                pageToken?: string;
        ...
        interface TcpRoutesResource {
            ...
            list(request?: {
                ...
                pageSize?: number;
                /**
                 * The value returned by the last `ListTcpRoutesResponse` Indicates that this is a continuation of a prior `ListRouters` call, and that the system should return the next page of
                 * data.
                 */
                pageToken?: string;
        ...
        interface TlsRoutesResource {
            ...
            list(request?: {
                ...
                pageSize?: number;
                /**
                 * The value returned by the last `ListTlsRoutesResponse` Indicates that this is a continuation of a prior `ListRouters` call, and that the system should return the next page of
                 * data.
                 */
                pageToken?: string;
        ...
        interface LocationsResource {
            ...
            edgeCacheKeysets: EdgeCacheKeysetsResource;
            edgeCacheOrigins: EdgeCacheOriginsResource;
            edgeCacheServices: EdgeCacheServicesResource;
