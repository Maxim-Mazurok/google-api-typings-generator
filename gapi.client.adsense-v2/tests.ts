...
gapi.load('client', async () => {
    ...
    async function run() {
         ...
         * only be created for ad clients with an "AFC" product code. For more info see the [AdClient resource](/adsense/management/reference/rest/v2/accounts.adclients). For now, this method can
        ...
        await gapi.client.adsense.accounts.policyIssues.get({
            name: "Test string",
        });
        /** Lists all the policy issues for the specified account. */
        await gapi.client.adsense.accounts.policyIssues.list({
            pageSize: 42,
            pageToken: "Test string",
            parent: "Test string",
        });
