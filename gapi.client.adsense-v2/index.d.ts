    ...
    namespace adsense {
        ...
        interface PolicyIssue {
            ...
            action?:
                string;
            /**
             * Optional. List of ad clients associated with the policy issue (either as the primary ad client or an associated host/secondary ad client). In the latter case, this will be an ad
            ...
            policyTopics?:
                PolicyTopic[];
            /**
             * Required. Hostname/domain of the entity (for example "foo.com" or "www.foo.com"). This _should_ be a bare domain/host name without any protocol. This will be present for all policy
             * issues.
             */
            site?:
                string;
            /**
             * Optional. Prefix of the site-section having policy issues (For example "foo.com/bar-section"). This will be present if the `entity_type` is `SITE_SECTION` and will be absent for
             * other entity types.
             */
            siteSection?:
                string;
            /**
             * Optional. URI of the page having policy violations (for example "foo.com/bar" or "www.foo.com/bar"). This will be present if the `entity_type` is `PAGE` and will be absent for other
             * entity types.
             */
            uri?:
                string;
            /**
             * Optional. The date (in the America/Los_Angeles timezone) when the entity will have ad serving demand restricted or ad serving disabled. This is present only for issues with a
             * `WARNED` enforcement action. See https://support.google.com/adsense/answer/11066888.
             */
        ...
        interface PolicyTopic {
            /**
             * Required. Indicates if this is a policy violation or not. When the value is true, issues that are instances of this topic must be addressed to remain in compliance with the
             * partner's agreements with Google. A false value indicates that it's not mandatory to fix the issues but advertising demand might be restricted.
             */
            mustFix?:
                boolean;
        ...
        interface AdunitsResource {
            /**
             * Creates an ad unit. This method can only be used by projects enabled for the [AdSense for Platforms](https://developers.google.com/adsense/platforms/) product. Note that ad units
             * can only be created for ad clients with an "AFC" product code. For more info see the [AdClient resource](/adsense/management/reference/rest/v2/accounts.adclients). For now, this
             * method can only be used to create `DISPLAY` ad units. See: https://support.google.com/adsense/answer/9183566
             */
            create(request: {
                /** V1 error format. */
                "$.xgafv"?:
            ...
            /**
             * Updates an ad unit. This method can only be used by projects enabled for the [AdSense for Platforms](https://developers.google.com/adsense/platforms/) product. For now, this method
             * can only be used to update `DISPLAY` ad units. See: https://support.google.com/adsense/answer/9183566
             */
            patch(request: {
                /** V1 error format. */
                "$.xgafv"?:
        ...
        interface CustomchannelsResource {
            ...
            body: CustomChannel): Request<CustomChannel>;
        ...
        interface PolicyIssuesResource {
            ...
            list(request?: {
                ...
                oauth_token?:
                    string;
                /**
                 * The maximum number of policy issues to include in the response, used for paging. If unspecified, at most 10000 policy issues will be returned. The maximum value is 10000; values
                 * above 10000 will be coerced to 10000.
                 */
                pageSize?:
                    number;
                /**
                 * A page token, received from a previous `ListPolicyIssues` call. Provide this to retrieve the subsequent page. When paginating, all other parameters provided to
                ...
                uploadType?:
                    string;
            }): Request<ListPolicyIssuesResponse>;
        }
        interface SavedResource {
            ...
            list(request?: {
                ...
                pageSize?:
                    number;
                /**
                 * A page token, received from a previous `ListSavedReports` call. Provide this to retrieve the subsequent page. When paginating, all other parameters provided to
        ...
        interface AccountsResource {
            ...
            listChildAccounts(request?: {
                ...
                pageSize?:
                    number;
                /**
                 * A page token, received from a previous `ListChildAccounts` call. Provide this to retrieve the subsequent page. When paginating, all other parameters provided to
