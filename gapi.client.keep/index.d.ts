...
// Project: https://support.google.com/keep
...
declare namespace gapi.client {
    ...
    namespace keep {
        ...
        interface Note {
            ...
            trashed?: boolean;
            /**
             * Output only. If this note has been trashed, when that happened. If trashed, the note will eventually be deleted. If the note is not trashed, this is not set (and the trashed field
             * is false).
             */
            trashTime?: string;
        ...
        interface Permission {
            ...
            deleted?: boolean;
            /**
             * The email associated with the member. If set on create, the email field in the User or Group message must either be empty or match this field. On read, may be unset if the member
        ...
        interface PermissionsResource {
            /**
             * Creates one or more permission on the note. Only permissions with the `WRITER` role may be created. If adding any permission fails, then the entire request fails and no changes are
             * made.
             */
            batchCreate(request: {
                /** V1 error format. */
        ...
        interface NotesResource {
            ...
            list(request?: {
                ...
                fields?: string;
                /**
                 * Filter for list results. If no filter is supplied, the "-trashed" filter is applied by default. Valid fields to filter by are: - `create_time` - `update_time` - `trash_time` -
