...
declare namespace gapi.client {
    ...
    namespace jobs {
        ...
        interface GoogleCloudTalentV4BatchCreateJobsRequest {
            /** Required. The jobs to be created. A maximum of 200 jobs can be created in a batch. */
            jobs?: GoogleCloudTalentV4Job[];
        }
        interface GoogleCloudTalentV4BatchCreateJobsResponse {
            ...
            jobResults?: GoogleCloudTalentV4JobResult[];
        }
        interface GoogleCloudTalentV4BatchDeleteJobsRequest {
            /**
        ...
        interface GoogleCloudTalentV4BatchDeleteJobsResponse {
        ...
        interface GoogleCloudTalentV4BatchOperationMetadata {
            /** The time when the batch operation is created. */
            createTime?: string;
            /** The time when the batch operation is finished and google.longrunning.Operation.done is set to `true`. */
            endTime?: string;
        ...
        interface GoogleCloudTalentV4BatchUpdateJobsRequest {
        ...
        interface GoogleCloudTalentV4BatchUpdateJobsResponse {
        ...
        interface GoogleCloudTalentV4ClientEvent {
            ...
            jobEvent?: GoogleCloudTalentV4JobEvent;
        ...
        interface GoogleCloudTalentV4CommuteFilter {
            /**
        ...
        interface GoogleCloudTalentV4Company {
            /** The URI to employer's career site or careers page on the employer's web site, for example, "https://careers.google.com". */
            careerSiteUri?: string;
            /** Output only. Derived details about the company. */
            derivedInfo?: GoogleCloudTalentV4CompanyDerivedInfo;
        ...
        interface GoogleCloudTalentV4CompanyDerivedInfo {
            /** A structured headquarters location of the company, resolved from Company.headquarters_address if provided. */
            headquartersLocation?: GoogleCloudTalentV4Location;
        }
        interface GoogleCloudTalentV4CompensationFilter {
        ...
        interface GoogleCloudTalentV4CompensationInfo {
            /**
             * Output only. Annualized base compensation range. Computed as base compensation entry's CompensationEntry.amount times CompensationEntry.expected_units_per_year. See
             * CompensationEntry for explanation on compensation annualization.
             */
            ...
            /** Job compensation information. At most one entry can be of type CompensationInfo.CompensationType.BASE, which is referred as **base compensation entry** for the job. */
            entries?: GoogleCloudTalentV4CompensationInfoCompensationEntry[];
        }
        interface GoogleCloudTalentV4CompensationInfoCompensationEntry {
            /** Compensation amount. */
            amount?: Money;
            /** Compensation description. For example, could indicate equity terms or provide additional context to an estimated bonus. */
            description?: string;
        ...
        interface GoogleCloudTalentV4CompensationInfoCompensationRange {
            /** The maximum amount of compensation. If left empty, the value is set to a maximal compensation value and the currency code is set to match the currency code of min_compensation. */
            maxCompensation?: Money;
            /** The minimum amount of compensation. If left empty, the value is set to zero and the currency code is set to match the currency code of max_compensation. */
            minCompensation?: Money;
        }
        interface GoogleCloudTalentV4CompleteQueryResponse {
            /** Results of the matching job/company candidates. */
            completionResults?: GoogleCloudTalentV4CompleteQueryResponseCompletionResult[];
            /** Additional information for the API invocation, such as the request tracking id. */
            metadata?: GoogleCloudTalentV4ResponseMetadata;
        }
        interface GoogleCloudTalentV4CompleteQueryResponseCompletionResult {
        ...
        interface GoogleCloudTalentV4CustomAttribute {
            /**
             * If the `filterable` flag is true, the custom field values may be used for custom attribute filters JobQuery.custom_attribute_filter. If false, these values may not be used for
             * custom attribute filters. Default is false.
             */
        ...
        interface GoogleCloudTalentV4HistogramQueryResult {
            /**
        ...
        interface GoogleCloudTalentV4Job {
            /**
             ...
             */
            customAttributes?: { [P in string]: GoogleCloudTalentV4CustomAttribute };
        ...
        interface GoogleCloudTalentV4JobApplicationInfo {
            /** Use this field to specify email address(es) to which resumes or applications can be sent. The maximum number of allowed characters for each entry is 255. */
            emails?: string[];
            /**
             * Use this field to provide instructions, such as "Mail your application to ...", that a candidate can follow to apply for the job. This field accepts and sanitizes HTML input, and
        ...
        interface GoogleCloudTalentV4JobDerivedInfo {
            /** Job categories derived from Job.title and Job.description. */
            jobCategories?: string[];
            /** Structured locations of the job, resolved from Job.addresses. locations are exactly matched to Job.addresses in the same order. */
            locations?: GoogleCloudTalentV4Location[];
        }
        interface GoogleCloudTalentV4JobEvent {
            /**
        ...
        interface GoogleCloudTalentV4JobProcessingOptions {
        ...
        interface GoogleCloudTalentV4JobQuery {
            /**
             ...
             */
            commuteFilter?: GoogleCloudTalentV4CommuteFilter;
            /**
            ...
            companies?: string[];
            /**
             * This filter specifies the exact company Company.display_name of the jobs to search against. If a value isn't specified, jobs within the search results are associated with any
             ...
             */
            compensationFilter?: GoogleCloudTalentV4CompensationFilter;
            /**
             ...
             */
            locationFilters?: GoogleCloudTalentV4LocationFilter[];
            /** Jobs published within a range specified by this filter are searched against. */
            publishTimeRange?: GoogleCloudTalentV4TimestampRange;
        ...
        interface GoogleCloudTalentV4JobResult {
        ...
        interface GoogleCloudTalentV4ListCompaniesResponse {
            /** Companies for the current client. */
            companies?: GoogleCloudTalentV4Company[];
            /** Additional information for the API invocation, such as the request tracking id. */
            metadata?: GoogleCloudTalentV4ResponseMetadata;
            /** A token to retrieve the next page of results. */
            nextPageToken?: string;
        }
        interface GoogleCloudTalentV4ListJobsResponse {
        ...
        interface GoogleCloudTalentV4ListTenantsResponse {
            /** Additional information for the API invocation, such as the request tracking id. */
            metadata?: GoogleCloudTalentV4ResponseMetadata;
            /** A token to retrieve the next page of results. */
            nextPageToken?: string;
            /** Tenants for the current client. */
            tenants?: GoogleCloudTalentV4Tenant[];
        }
        interface GoogleCloudTalentV4Location {
        ...
        interface GoogleCloudTalentV4LocationFilter {
            ...
            latLng?: LatLng;
            /**
             * CLDR region code of the country/region of the address. This is used to address ambiguity of the user-input location, for example, "Liverpool" against "Liverpool, NY, US" or
             * "Liverpool, UK". Set this field to bias location resolution toward a specific country or territory. If this field is not set, application behavior is biased toward the United States
             * by default. See https://www.unicode.org/cldr/charts/30/supplemental/territory_information.html for details. Example: "CH" for Switzerland.
             */
            regionCode?: string;
            /**
             ...
             * not set or set to TelecommutePreference.TELECOMMUTE_EXCLUDED, telecommute job are not searched. This filter can be used by itself to search exclusively for telecommuting jobs, or it
             * can be combined with another location filter to search for a combination of job locations, such as "Mountain View" or "telecommuting" jobs. However, when used in combination with
             * other location filters, telecommuting jobs can be treated as less relevant than other jobs in the search response. This field is only used for job search requests.
             */
            telecommutePreference?: string;
        }
        interface GoogleCloudTalentV4RequestMetadata {
            /**
            ...
            deviceInfo?: GoogleCloudTalentV4DeviceInfo;
            /**
        ...
        interface GoogleCloudTalentV4ResponseMetadata {
            /** A unique id associated with this call. This id is logged for tracking purposes. */
            requestId?: string;
        }
        interface GoogleCloudTalentV4SearchJobsRequest {
            /** Controls over how job documents get ranked on top of existing relevance score (determined by API algorithm). */
            customRankingInfo?: GoogleCloudTalentV4SearchJobsRequestCustomRankingInfo;
            /**
             * Controls whether to disable exact keyword match on Job.title, Job.description, Job.company_display_name, Job.addresses, Job.qualifications. When disable keyword match is turned off,
             * a keyword match returns jobs that do not match given category filters when there are matching keywords. For example, for the query "program manager," a result is returned even if
             * the job posting has the title "software developer," which doesn't fall into "program manager" ontology, but does have "program manager" appearing in its description. For queries
             * like "cloud" that don't contain title or location specific ontology, jobs with "cloud" keyword matches are returned regardless of this flag's value. Use
             ...
             * Count the number of matching entities within each bucket. Data types: * Histogram facet: facet names with format a-zA-Z+. * String: string like "any string with backslash escape for
             * quote(\")." * Number: whole number and floating point number like 10, -1 and -0.01. * List: list of elements with comma(,) separator surrounded by square brackets, for example, [1,
             * 2, 3] and ["one", "two", "three"]. Built-in constants: * MIN (minimum number similar to java Double.MIN_VALUE) * MAX (maximum number similar to java Double.MAX_VALUE) Built-in
             * functions: * bucket(start, end[, label]): bucket built-in function creates a bucket with range of start, end). Note that the end is exclusive, for example, bucket(1, MAX, "positive
             * number") or bucket(1, 10). Job histogram facets: * company_display_name: histogram by [Job.company_display_name. * employment_type: histogram by Job.employment_types, for example,
             * "FULL_TIME", "PART_TIME". * company_size: histogram by CompanySize, for example, "SMALL", "MEDIUM", "BIG". * publish_time_in_month: histogram by the Job.posting_publish_time in
             * months. Must specify list of numeric buckets in spec. * publish_time_in_year: histogram by the Job.posting_publish_time in years. Must specify list of numeric buckets in spec. *
             * degree_types: histogram by the Job.degree_types, for example, "Bachelors", "Masters". * job_level: histogram by the Job.job_level, for example, "Entry Level". * country: histogram
             * by the country code of jobs, for example, "US", "FR". * admin1: histogram by the admin1 code of jobs, which is a global placeholder referring to the state, province, or the
             * particular term a country uses to define the geographic structure below the country level, for example, "CA", "IL". * city: histogram by a combination of the "city name, admin1
             * code". For example, "Mountain View, CA", "New York, NY". * admin1_country: histogram by a combination of the "admin1 code, country", for example, "CA, US", "IL, US". *
             * city_coordinate: histogram by the city center's GPS coordinates (latitude and longitude), for example, 37.4038522,-122.0987765. Since the coordinates of a city center can change,
             * customers may need to refresh them periodically. * locale: histogram by the Job.language_code, for example, "en-US", "fr-FR". * language: histogram by the language subtag of the
             * Job.language_code, for example, "en", "fr". * category: histogram by the JobCategory, for example, "COMPUTER_AND_IT", "HEALTHCARE". * base_compensation_unit: histogram by the
             ...
             */
            histogramQueries?: GoogleCloudTalentV4HistogramQuery[];
            /** Query used to search against jobs, such as keyword, location filters, etc. */
            jobQuery?: GoogleCloudTalentV4JobQuery;
             ...
             */
            requestMetadata?: GoogleCloudTalentV4RequestMetadata;
            /** Mode of a search. Defaults to SearchMode.JOB_SEARCH. */
            searchMode?: string;
        }
        interface GoogleCloudTalentV4SearchJobsRequestCustomRankingInfo {
             ...
             * calculation precedence. The expression must be < 100 characters in length. The expression is considered invalid for a job if the expression references custom attributes that are not
        ...
        interface GoogleCloudTalentV4SearchJobsResponse {
            /**
            ...
            histogramQueryResults?: GoogleCloudTalentV4HistogramQueryResult[];
            /**
             ...
             */
            locationFilters?: GoogleCloudTalentV4Location[];
            /** The Job entities that match the specified SearchJobsRequest. */
            matchingJobs?: GoogleCloudTalentV4SearchJobsResponseMatchingJob[];
            /** Additional information for the API invocation, such as the request tracking id. */
            metadata?: GoogleCloudTalentV4ResponseMetadata;
            /** The token that specifies the starting position of the next page of results. This field is empty if there are no more results. */
            nextPageToken?: string;
            /** The spell checking result, and correction. */
            spellCorrection?: GoogleCloudTalentV4SpellingCorrection;
            /** Number of jobs that match the specified query. Note: This size is precise only if the total is less than 100,000. */
            totalSize?: number;
        }
        interface GoogleCloudTalentV4SearchJobsResponseCommuteInfo {
            /** Location used as the destination in the commute calculation. */
            jobLocation?: GoogleCloudTalentV4Location;
            /**
        ...
        interface GoogleCloudTalentV4SearchJobsResponseMatchingJob {
            /** Commute information which is generated based on specified CommuteFilter. */
            commuteInfo?: GoogleCloudTalentV4SearchJobsResponseCommuteInfo;
        ...
        interface GoogleCloudTalentV4SpellingCorrection {
        ...
        interface GoogleCloudTalentV4Tenant {
        ...
        interface GoogleCloudTalentV4TimestampRange {
        ...
        interface Job {
            ...
            /**
             * Required. The resource name of the company listing the job. The format is "projects/{project_id}/tenants/{tenant_id}/companies/{company_id}". For example,
             * "projects/foo/tenants/bar/companies/baz". If tenant id is unspecified, the default tenant is used. For example, "projects/foo/companies/bar".
             */
            company?: string;
            /** Output only. Display name of the company listing the job. */
            companyDisplayName?: string;
            ...
            /**
             * Required during job update. The resource name for the job. This is generated by the service when a job is created. The format is
             * "projects/{project_id}/tenants/{tenant_id}/jobs/{job_id}". For example, "projects/foo/tenants/bar/jobs/baz". If tenant id is unspecified, the default tenant is used. For example,
             * "projects/foo/jobs/bar". Use of this field in job queries and API calls is preferred over the use of requisition_id since this value is unique.
             */
            name?: string;
            /** Output only. The timestamp when this job posting was created. */
            postingCreateTime?: string;
        ...
        interface ClientEventsResource {
            ...
            create(request: {
                ...
                uploadType?: string;
                /** Request body */
                resource: GoogleCloudTalentV4ClientEvent;
            }): Request<GoogleCloudTalentV4ClientEvent>;
            create(request: {
                /** V1 error format. */
                "$.xgafv"?: string;
                /** OAuth access token. */
            ...
            body: GoogleCloudTalentV4ClientEvent): Request<GoogleCloudTalentV4ClientEvent>;
        }
        interface CompaniesResource {
            ...
            create(request: {
                ...
                uploadType?: string;
                /** Request body */
                resource: GoogleCloudTalentV4Company;
            }): Request<GoogleCloudTalentV4Company>;
            create(request: {
                /** V1 error format. */
                "$.xgafv"?: string;
                /** OAuth access token. */
            ...
            body: GoogleCloudTalentV4Company): Request<GoogleCloudTalentV4Company>;
            ...
            list(request?: {
                ...
                /** Legacy upload protocol for media (e.g. "media", "multipart"). */
                uploadType?: string;
            }): Request<GoogleCloudTalentV4ListCompaniesResponse>;
        ...
        interface JobsResource {
            ...
            batchCreate(request: {
                ...
                uploadType?: string;
                /** Request body */
                resource: GoogleCloudTalentV4BatchCreateJobsRequest;
            }): Request<Operation>;
            batchCreate(request: {
                /** V1 error format. */
                "$.xgafv"?: string;
            ...
            body: GoogleCloudTalentV4BatchCreateJobsRequest): Request<Operation>;
            ...
            batchDelete(request: {
                ...
                uploadType?: string;
                /** Request body */
                resource: GoogleCloudTalentV4BatchDeleteJobsRequest;
            }): Request<Operation>;
            batchDelete(request: {
                /** V1 error format. */
                "$.xgafv"?: string;
            ...
            body: GoogleCloudTalentV4BatchDeleteJobsRequest): Request<Operation>;
            ...
            batchUpdate(request: {
                ...
                uploadType?: string;
                /** Request body */
                resource: GoogleCloudTalentV4BatchUpdateJobsRequest;
            }): Request<Operation>;
            batchUpdate(request: {
                /** V1 error format. */
                "$.xgafv"?: string;
            ...
            body: GoogleCloudTalentV4BatchUpdateJobsRequest): Request<Operation>;
            ...
            create(request: {
                ...
                uploadType?: string;
                /** Request body */
                resource: GoogleCloudTalentV4Job;
            }): Request<GoogleCloudTalentV4Job>;
            create(request: {
                /** V1 error format. */
                "$.xgafv"?: string;
                /** OAuth access token. */
            ...
            body: GoogleCloudTalentV4Job): Request<GoogleCloudTalentV4Job>;
            ...
            list(request?: {
                 ...
                 * `status` Available values: OPEN, EXPIRED, ALL. Defaults to OPEN if no value is specified. Sample Query: * companyName = "projects/foo/tenants/bar/companies/baz" * companyName =
                 * "projects/foo/tenants/bar/companies/baz" AND requisitionId = "req-1" * companyName = "projects/foo/tenants/bar/companies/baz" AND status = "EXPIRED"
                 */
                filter?: string;
                ...
                /** Legacy upload protocol for media (e.g. "media", "multipart"). */
                uploadType?: string;
            }): Request<GoogleCloudTalentV4ListJobsResponse>;
            ...
            search(request: {
                ...
                uploadType?: string;
                /** Request body */
                resource: GoogleCloudTalentV4SearchJobsRequest;
            }): Request<GoogleCloudTalentV4SearchJobsResponse>;
            search(request: {
                /** V1 error format. */
                "$.xgafv"?: string;
                /** OAuth access token. */
            ...
            body: GoogleCloudTalentV4SearchJobsRequest): Request<GoogleCloudTalentV4SearchJobsResponse>;
            /**
        ...
        interface TenantsResource {
            ...
            completeQuery(request?: {
                ...
                /** Legacy upload protocol for media (e.g. "media", "multipart"). */
                uploadType?: string;
            }): Request<GoogleCloudTalentV4CompleteQueryResponse>;
            ...
            create(request: {
                ...
                uploadType?: string;
                /** Request body */
                resource: GoogleCloudTalentV4Tenant;
            }): Request<GoogleCloudTalentV4Tenant>;
            create(request: {
                /** V1 error format. */
                "$.xgafv"?: string;
                /** OAuth access token. */
            ...
            body: GoogleCloudTalentV4Tenant): Request<GoogleCloudTalentV4Tenant>;
            ...
            list(request?: {
                ...
                /** Legacy upload protocol for media (e.g. "media", "multipart"). */
                uploadType?: string;
            }): Request<GoogleCloudTalentV4ListTenantsResponse>;
