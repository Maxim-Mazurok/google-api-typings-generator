...
declare namespace gapi.client {
    ...
    namespace jobs {
        ...
        interface JobQuery {
             ...
             * SUBSTRING_MATCH(google) If a value isn't specified, jobs within the search results are associated with any company. If multiple values are specified, jobs within the search results
             * may be associated with any of the specified companies. At most 20 company display name filters are allowed.
             */
