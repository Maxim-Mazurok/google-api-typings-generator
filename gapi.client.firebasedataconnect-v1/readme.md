...
```json
{
  "compilerOptions": {
    "types": [
      ...
      "gapi.auth2",
      "gapi.client",
      "gapi.client.firebasedataconnect-v1"
    ]
  }
}
```
...
gapi.client.load('firebasedataconnect', 'v1', () => {
  // now we can use:
  // gapi.client.firebasedataconnect
});
```
...
For provenance information see [Provenance section on NPM](https://www.npmjs.com/package/@maxim_mazurok/gapi.client.firebasedataconnect-v1#Provenance:~:text=none-,Provenance,-Built%20and%20signed)
