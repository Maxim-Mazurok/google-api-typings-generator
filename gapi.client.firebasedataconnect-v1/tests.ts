...
gapi.load('client', async () => {
  ...
  async function run() {
    ...
    await gapi.client.firebasedataconnect.projects.locations.services.generateQuery(
      {
        name: 'Test string',
      },
      {
    ...
    await gapi.client.firebasedataconnect.projects.locations.services.generateSchema(
      {
        name: 'Test string',
      },
      {
