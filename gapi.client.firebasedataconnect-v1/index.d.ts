/* Type definitions for non-npm package Firebase Data Connect API v1 0.0 */
...
// Generated from: https://firebasedataconnect.googleapis.com/$discovery/rest?version=v1
// Revision: 20260510

/// <reference types="gapi.client" />

declare namespace gapi.client {
  /** Load Firebase Data Connect API v1 */
  function load(
    urlOrObject: 'https://firebasedataconnect.googleapis.com/$discovery/rest?version=v1',
  ): Promise<void>;
  /** @deprecated Please load APIs with discovery documents. */
  function load(name: 'firebasedataconnect', version: 'v1'): Promise<void>;
  /** @deprecated Please load APIs with discovery documents. */
  function load(
  ...
  namespace firebasedataconnect {
    ...
    interface ServicesResource {
      ...
      generateQuery(request: {
        ...
        uploadType?: string;
        /** Request body */
        resource: GenerateQueryRequest;
      }): Request<GenerateQueryResponse>;
      generateQuery(
        request: {
          /** V1 error format. */
          '$.xgafv'?: '1' | '2';
      ...
      generateSchema(request: {
        ...
        uploadType?: string;
        /** Request body */
        resource: GenerateSchemaRequest;
      }): Request<GenerateSchemaResponse>;
      generateSchema(
        request: {
          /** V1 error format. */
          '$.xgafv'?: '1' | '2';
