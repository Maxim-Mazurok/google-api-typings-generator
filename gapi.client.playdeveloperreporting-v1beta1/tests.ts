...
gapi.load('client', async () => {
  ...
  async function run() {
    ...
    await gapi.client.playdeveloperreporting.vitals.anonrssandswapmemoryusage.get(
      {
        name: 'Test string',
      },
    );
    /** Queries the metrics in the metric set. */
    await gapi.client.playdeveloperreporting.vitals.anonrssandswapmemoryusage.query(
      {
        name: 'Test string',
      },
      {
    ...
    /** Describes the properties of the metric set. */
    await gapi.client.playdeveloperreporting.vitals.bitmapmemoryusage.get({
      name: 'Test string',
    });
    /** Queries the metrics in the metric set. */
    await gapi.client.playdeveloperreporting.vitals.bitmapmemoryusage.query(
      {
        name: 'Test string',
      },
      {
    ...
    /** Describes the properties of the metric set. */
    await gapi.client.playdeveloperreporting.vitals.lmkrate.get({
      name: 'Test string',
    });
    /** Queries the metrics in the metric set. */
    await gapi.client.playdeveloperreporting.vitals.lmkrate.query(
      {
        name: 'Test string',
      },
      {
