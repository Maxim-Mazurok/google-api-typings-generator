...
declare namespace gapi.client {
  ...
  namespace playdeveloperreporting {
    ...
    interface GooglePlayDeveloperReportingV1beta1LmkRateMetricSet {
      /** Summary about data freshness in this resource. */
      freshnessInfo?: GooglePlayDeveloperReportingV1beta1FreshnessInfo;
    ...
    interface GooglePlayDeveloperReportingV1beta1QueryRatingsMetricSetRequest {
    ...
    interface GooglePlayDeveloperReportingV1beta1QueryRatingsMetricSetResponse {
    ...
    interface GooglePlayDeveloperReportingV1beta1RatingsMetricSet {
    ...
    interface RatingsResource {
      ...
      get(request?: {
        ...
        /** Legacy upload protocol for media (e.g. "media", "multipart"). */
        uploadType?: string;
      }): Request<GooglePlayDeveloperReportingV1beta1RatingsMetricSet>;
      ...
      query(request: {
        ...
        uploadType?: string;
        /** Request body */
        resource: GooglePlayDeveloperReportingV1beta1QueryRatingsMetricSetRequest;
      }): Request<GooglePlayDeveloperReportingV1beta1QueryRatingsMetricSetResponse>;
      query(
        request: {
          /** V1 error format. */
          '$.xgafv'?: '1' | '2';
        ...
        body: GooglePlayDeveloperReportingV1beta1QueryRatingsMetricSetRequest,
      ): Request<GooglePlayDeveloperReportingV1beta1QueryRatingsMetricSetResponse>;
    }
    ...
    interface LmkrateResource {
      ...
      get(request?: {
        ...
        /** Legacy upload protocol for media (e.g. "media", "multipart"). */
        uploadType?: string;
      }): Request<GooglePlayDeveloperReportingV1beta1LmkRateMetricSet>;
      /** Queries the metrics in the metric set. */
      query(request: {
        /** V1 error format. */
        '$.xgafv'?: '1' | '2';
        ...
        uploadType?: string;
        /** Request body */
        resource: GooglePlayDeveloperReportingV1beta1QueryLmkRateMetricSetRequest;
      }): Request<GooglePlayDeveloperReportingV1beta1QueryLmkRateMetricSetResponse>;
      query(
        request: {
          /** V1 error format. */
          '$.xgafv'?: '1' | '2';
