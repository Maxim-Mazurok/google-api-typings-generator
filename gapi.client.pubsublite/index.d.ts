...
declare namespace gapi.client {
    ...
    namespace pubsublite {
        ...
        interface ComputeMessageStatsResponse {
            ...
            /** The minimum publish timestamp across these messages. Note that publish timestamps within a partition are non-decreasing. The timestamp will be unset if there are no messages. */
