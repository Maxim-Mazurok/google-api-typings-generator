...
declare namespace gapi.client {
    ...
    namespace pubsublite {
        ...
        interface TopicsResource {
            /**
             * Compute the head cursor for the partition. The head cursor’s offset is guaranteed to be before or equal to all messages which have not yet been acknowledged to be published, and
             * greater than the offset of any message whose publish has already been acknowledged. It is 0 if there have never been messages on the partition.
             */
