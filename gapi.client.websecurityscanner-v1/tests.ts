/* This is stub file for gapi.client.websecurityscanner-v1 definition tests */
// IMPORTANT
...
gapi.load('client', async () => {
    ...
    await gapi.client.load('https://websecurityscanner.googleapis.com/$discovery/rest?version=v1');
