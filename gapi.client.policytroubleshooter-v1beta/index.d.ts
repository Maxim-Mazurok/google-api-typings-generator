/* Type definitions for non-npm package Policy Troubleshooter API v1beta 0.0 */
...
// Generated from: https://policytroubleshooter.googleapis.com/$discovery/rest?version=v1beta
// Revision: 20220821

/// <reference types="gapi.client" />

declare namespace gapi.client {
    /** Load Policy Troubleshooter API v1beta */
    function load(urlOrObject: "https://policytroubleshooter.googleapis.com/$discovery/rest?version=v1beta"): Promise<void>;
    /** @deprecated Please load APIs with discovery documents. */
    function load(name: "policytroubleshooter", version: "v1beta"): Promise<void>;
    /** @deprecated Please load APIs with discovery documents. */
    function load(name: "policytroubleshooter", version: "v1beta", callback: () => any): void;

    namespace policytroubleshooter {
        interface GoogleCloudPolicytroubleshooterV1betaAccessTuple {
            /**
        ...
        interface GoogleCloudPolicytroubleshooterV1betaBindingExplanation {
            /**
             * Indicates whether _this binding_ provides the specified permission to the specified member for the specified resource. This field does _not_ indicate whether the member actually has
