...
declare namespace gapi.client {
    ...
    namespace retail {
        ...
        interface GoogleCloudRetailV2UserEvent {
             ...
             * "pageCategories" : ["Sales > 2017 Black Friday Deals"]. Required for `category-page-view` events. Other event types should not set this field. Otherwise, an INVALID_ARGUMENT error
             * is returned.
             */
             ...
             * search_query or filter is required for `search` events. Other event types should not set this field. Otherwise, an INVALID_ARGUMENT error is returned.
             */
            searchQuery?: string;
            /**
