...
declare namespace gapi.client {
    ...
    namespace retail {
        ...
        interface GoogleCloudRetailV2Product {
             ...
             * or age of a customer. For example: `{ "vendor": {"text": ["vendor123", "vendor456"]}, "lengths_cm": {"numbers":[2.3, 15.4]}, "heights_cm": {"numbers":[8.1, 6.4]} }`. A maximum of
             * 150 attributes are allowed. Otherwise, an INVALID_ARGUMENT error is returned. The key must be a UTF-8 encoded string with a length limit of 5,000 characters. Otherwise, an
             * INVALID_ARGUMENT error is returned.
             */
        ...
        interface GoogleCloudRetailV2UserEvent {
            ...
            referrerUri?: string;
            /**
             * The user's search query. The value must be a UTF-8 encoded string with a length limit of 5,000 characters. Otherwise, an INVALID_ARGUMENT error is returned. Required for `search`
