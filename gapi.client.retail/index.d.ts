...
declare namespace gapi.client {
    ...
    namespace retail {
        ...
        interface GoogleCloudRetailV2SearchRequestSpellCorrectionSpec {
        ...
        interface GoogleCloudRetailV2SearchResponse {
            ...
            attributionToken?: string;
            /**
             * Contains the spell corrected query, if found. If the spell correction type is AUTOMATIC, then the search results are based on corrected_query. Otherwise the original query will be
             * used for search.
             */
        ...
        interface ProductsResource {
             ...
             * information can only be updated with SetInventory, ProductService.AddFulfillmentPlaces, and RemoveFulfillmentPlaces. This feature is only available for users who have Retail Search
