...
declare namespace gapi.client {
    ...
    namespace retail {
        ...
        interface CompletionDataResource {
             ...
             * suggestions are indexed successfully and ready for serving. The process takes hours. This feature is only available for users who have Retail Search enabled. Please submit a form
             * [here](https://cloud.google.com/contact) to contact cloud sales if you are interested in using Retail Search.
             */
            import(request: {
                /** V1 error format. */
