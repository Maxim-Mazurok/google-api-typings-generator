...
declare namespace gapi.client {
    ...
    namespace retail {
        ...
        interface GoogleCloudRetailV2BigQuerySource {
             ...
             * Product.id. * `product_merchant_center`: See [Importing catalog data from Merchant Center](/retail/recommendations-ai/docs/upload-catalog#mc). Supported values for user events
             * imports: * `user_event` (default): One JSON UserEvent per line. * `user_event_ga360`: Using https://support.google.com/analytics/answer/3437719?hl=en.
             */
            dataSchema?: string;
        ...
        interface GoogleCloudRetailV2Product {
            ...
            type?: string;
            /**
             * Canonical URL directly linking to the product detail page. This field must be a UTF-8 encoded string with a length limit of 5,000 characters. Otherwise, an INVALID_ARGUMENT error is
             * returned. Google Merchant Center property [link](https://support.google.com/merchants/answer/6324416). Schema.org property [Offer.url](https://schema.org/url).
             */
            uri?: string;
        }
