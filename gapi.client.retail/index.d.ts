    ...
    namespace retail {
        ...
        interface PlacementsResource {
            ...
            predict(request: {
                ...
                oauth_token?: string;
                /**
                 * Required. Full resource name of the format: `{name=projects/*‍/locations/global/catalogs/default_catalog/placements/*}` The ID of the Recommendations AI placement. Before you
                 * can request predictions from your model, you must create at least one placement for it. For more information, see [Managing
