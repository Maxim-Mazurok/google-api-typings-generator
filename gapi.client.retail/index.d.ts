...
declare namespace gapi.client {
    ...
    namespace retail {
        ...
        interface GoogleCloudRetailV2Product {
             ...
             * needs to pass all below criteria, otherwise an INVALID_ARGUMENT error is returned: * Max entries count: 150 by default; 100 for Type.VARIANT. * Max indexable entries count: 150 by
             * default; 40 for Type.VARIANT. * Max searchable entries count: 30. * The key must be a UTF-8 encoded string with a length limit of 128 characters.
             */
            ...
            id?: string;
            /**
             * Product images for the product. A maximum of 300 images are allowed. Google Merchant Center property [image_link](https://support.google.com/merchants/answer/6324350). Schema.org
            ...
            tags?: string[];
            /**
             * Required. Product title. This field must be a UTF-8 encoded string with a length limit of 128 characters. Otherwise, an INVALID_ARGUMENT error is returned. Google Merchant Center
        ...
        interface GoogleCloudRetailV2UserEvent {
             ...
             * `detail-page-view`: Products detail page viewed. * `home-page-view`: Homepage viewed. * `purchase-complete`: User finishing a purchase. * `search`: Product search. *
