...
declare namespace gapi.client {
    ...
    namespace retail {
        ...
        interface GoogleCloudRetailV2AddLocalInventoriesRequest {
            /**
        ...
        interface GoogleCloudRetailV2BigQuerySource {
             ...
             * https://support.google.com/analytics/answer/3437719. * `user_event_ga4`: This feature is in private preview. Please contact the support team for importing Google Analytics 4 events.
             * The schema is available here: https://support.google.com/analytics/answer/7029846. Supported values for auto-completion imports: * `suggestions` (default): One JSON completion
             * suggestion per line. * `denylist`: One JSON deny suggestion per line. * `allowlist`: One JSON allow suggestion per line.
             */
            dataSchema?: string;
        ...
        interface GoogleCloudRetailV2CustomAttribute {
            /**
             * This field will only be used when AttributesConfig.attribute_config_level of the Catalog is 'PRODUCT_LEVEL_ATTRIBUTE_CONFIG', if true, custom attribute values are indexed, so that
             * it can be filtered, faceted or boosted in SearchService.Search. This field is ignored in a UserEvent. See SearchRequest.filter, SearchRequest.facet_specs and
            ...
            numbers?: number[];
            /**
             * This field will only be used when AttributesConfig.attribute_config_level of the Catalog is 'PRODUCT_LEVEL_ATTRIBUTE_CONFIG', if true, custom attribute values are searchable by text
             * queries in SearchService.Search. This field is ignored in a UserEvent. Only set if type text is set. Otherwise, a INVALID_ARGUMENT error is returned.
             */
            searchable?: boolean;
            /**
        ...
        interface GoogleCloudRetailV2LocalInventory {
            /**
        ...
        interface GoogleCloudRetailV2PredictRequest {
             ...
             * `PredictRequest.params` to receive empty results instead. Note that the API will never return items with storageStatus of "EXPIRED" or "DELETED" regardless of filter choices.
             */
            filter?: string;
            /**
        ...
        interface GoogleCloudRetailV2Product {
            ...
            categories?: string[];
            /**
             * The id of the collection members when type is Type.COLLECTION. Non-existent product ids are allowed. The type of the members must be either Type.PRIMARY or Type.VARIANT otherwise
             * and INVALID_ARGUMENT error is thrown. Should not set it for other types. A maximum of 1000 values are allowed. Otherwise, an INVALID_ARGUMENT error is return.
             */
        ...
        interface GoogleCloudRetailV2Promotion {
            /**
             * ID of the promotion. For example, "free gift". The value must be a UTF-8 encoded string with a length limit of 128 characters, and match the pattern: `a-zA-Z*`. For example,
        ...
        interface GoogleCloudRetailV2RemoveLocalInventoriesRequest {
            /**
        ...
        interface GoogleCloudRetailV2SearchRequestPersonalizationSpec {
        ...
        interface GoogleCloudRetailV2SetInventoryRequest {
             ...
             * of inventory information while ignoring timestamps is needed, UpdateProduct should be invoked instead.
             */
        ...
        interface GoogleCloudRetailV2UserInfo {
            ...
            userAgent?: string;
            /**
             * Highly recommended for logged-in users. Unique identifier for logged-in user, such as a user name. Always use a hashed value for this ID. The field must be a UTF-8 encoded string
        ...
        interface ProductsResource {
             ...
             * the Product queried by GetProduct or ListProducts. This feature is only available for users who have Retail Search enabled. Please enable Retail Search on Cloud Console before using
             * this feature.
             */
             ...
             * is returned, updates are not immediately manifested in the Product queried by GetProduct or ListProducts. Local inventory information can only be modified using this method.
             * CreateProduct and UpdateProduct has no effect on local inventories. This feature is only available for users who have Retail Search enabled. Please enable Retail Search on Cloud
            ...
            addLocalInventories(request: {
                ...
                uploadType?: string;
                /** Request body */
                resource: GoogleCloudRetailV2AddLocalInventoriesRequest;
            }): Request<GoogleLongrunningOperation>;
            addLocalInventories(request: {
                /** V1 error format. */
                "$.xgafv"?: string;
            ...
            body: GoogleCloudRetailV2AddLocalInventoriesRequest): Request<GoogleLongrunningOperation>;
            /** Creates a Product. */
            create(request: {
                /** V1 error format. */
                "$.xgafv"?: string;
             ...
             * manifested in the Product queried by GetProduct or ListProducts. This feature is only available for users who have Retail Search enabled. Please enable Retail Search on Cloud
             * Console before using this feature.
             */
             ...
             * processed downstream. As a consequence, when a response is returned, removals are not immediately manifested in the Product queried by GetProduct or ListProducts. Local inventory
             * information can only be removed using this method. CreateProduct and UpdateProduct has no effect on local inventories. This feature is only available for users who have Retail
            ...
            removeLocalInventories(request: {
                ...
                uploadType?: string;
                /** Request body */
                resource: GoogleCloudRetailV2RemoveLocalInventoriesRequest;
            }): Request<GoogleLongrunningOperation>;
            removeLocalInventories(request: {
                /** V1 error format. */
                "$.xgafv"?: string;
            ...
            body: GoogleCloudRetailV2RemoveLocalInventoriesRequest): Request<GoogleLongrunningOperation>;
            /**
             ...
             * for this product will be used. If no inventory fields are set in SetInventoryRequest.set_mask, then any existing inventory information will be preserved. Pre-existing inventory
        ...
        interface PlacementsResource {
            ...
            predict(request: {
                ...
                oauth_token?: string;
                /**
                 * Required. Full resource name of the format: {name=projects/*‍/locations/global/catalogs/default_catalog/placements/*} or
                 * {name=projects/*‍/locations/global/catalogs/default_catalog/servingConfigs/*} The ID of the Recommendations AI placement. Before you can request predictions from your model, you
                 * must create at least one placement for it. For more information, see [Managing placements](https://cloud.google.com/retail/recommendations-ai/docs/manage-placements). The full
                 * list of available placements can be seen at https://console.cloud.google.com/recommendation/catalogs/default_catalog/placements
                 */
                placement: string;
                /** Returns response with indentations and line breaks. */
                prettyPrint?: boolean;
            ...
            search(request: {
                ...
                oauth_token?: string;
                /**
                 * Required. The resource name of the search engine placement, such as `projects/*‍/locations/global/catalogs/default_catalog/placements/default_search` or
                 * `projects/*‍/locations/global/catalogs/default_catalog/servingConfigs/default_serving_config` This field is used to identify the serving configuration name and the set of models
        ...
        interface CatalogsResource {
            ...
            completeQuery(request?: {
                ...
                key?: string;
                /**
                 * The language filters applied to the output suggestions. If set, it should contain the language of the query. If not set, suggestions are returned without considering language
                 * restrictions. This is the BCP-47 language code, such as "en-US" or "sr-Latn". For more information, see [Tags for Identifying Languages](https://tools.ietf.org/html/bcp47). The
