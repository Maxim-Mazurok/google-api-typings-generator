...
declare namespace gapi.client {
    ...
    namespace toolresults {
        ...
        const clusters: ClustersResource;

        const environments: EnvironmentsResource;

        const executions: ExecutionsResource;

        const histories: HistoriesResource;

        const perfMetricsSummary: PerfMetricsSummaryResource;

        const perfSampleSeries: PerfSampleSeriesResource;

        const projects: ProjectsResource;

        const samples: SamplesResource;

        const steps: StepsResource;

        const testCases: TestCasesResource;
