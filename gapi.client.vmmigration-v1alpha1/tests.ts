  ...
  async function run() {
    ...
    await gapi.client.vmmigration.projects.locations.groups.create(
      ...
      },
      {
        ...
        migrationTargetType: 'Test string',
        name: 'Test string',
    ...
    await gapi.client.vmmigration.projects.locations.imageImports.create(
      {
        imageImportId: 'Test string',
        parent: 'Test string',
        requestId: 'Test string',
      },
      {
        cloudStorageUri: 'Test string',
        createTime: 'Test string',
        diskImageTargetDefaults: {
          additionalLicenses: ['Test string'],
          dataDiskImageImport: {
            guestOsFeatures: ['Test string'],
          },
          description: 'Test string',
          encryption: {
            kmsKey: 'Test string',
          ...
          osAdaptationParameters: {
            ...
            bootConversion: 'Test string',
            generalize: true,
            licenseType: 'Test string',
          },
          singleRegionStorage: true,
    ...
    await gapi.client.vmmigration.projects.locations.imageImports.delete({
      name: 'Test string',
      requestId: 'Test string',
    });
    /** Gets details of a single ImageImport. */
    await gapi.client.vmmigration.projects.locations.imageImports.get({
      name: 'Test string',
    });
    /** Lists ImageImports in a given project. */
    await gapi.client.vmmigration.projects.locations.imageImports.list({
      filter: 'Test string',
      orderBy: 'Test string',
      pageSize: 42,
      pageToken: 'Test string',
    ...
    await gapi.client.vmmigration.projects.locations.imageImports.imageImportJobs.cancel(
      {
        name: 'Test string',
      },
      {},
    ...
    await gapi.client.vmmigration.projects.locations.imageImports.imageImportJobs.get(
      {
        name: 'Test string',
      },
    );
    /** Lists ImageImportJobs in a given project. */
    await gapi.client.vmmigration.projects.locations.imageImports.imageImportJobs.list(
      {
        filter: 'Test string',
        orderBy: 'Test string',
        pageSize: 42,
    ...
    await gapi.client.vmmigration.projects.locations.sources.create(
      ...
      },
      {
        aws: {
          ...
          inventorySecurityGroupNames: ['Test string'],
          inventoryTagList: [
            {
              key: 'Test string',
              value: 'Test string',
        ...
        vmware: {
          ...
          resolvedVcenterHost: 'Test string',
    ...
    await gapi.client.vmmigration.projects.locations.sources.fetchStorageInventory(
      {
        forceRefresh: true,
        pageSize: 42,
        pageToken: 'Test string',
    ...
    await gapi.client.vmmigration.projects.locations.sources.diskMigrationJobs.cancel(
      {
        name: 'Test string',
      },
      {},
    ...
    await gapi.client.vmmigration.projects.locations.sources.diskMigrationJobs.create(
      {
        diskMigrationJobId: 'Test string',
        parent: 'Test string',
        requestId: 'Test string',
      },
      {
    ...
    await gapi.client.vmmigration.projects.locations.sources.diskMigrationJobs.delete(
      {
        name: 'Test string',
      },
    );
    /** Gets details of a single DiskMigrationJob. */
    await gapi.client.vmmigration.projects.locations.sources.diskMigrationJobs.get(
      {
        name: 'Test string',
      },
    );
    /** Lists DiskMigrationJobs in a given Source. */
    await gapi.client.vmmigration.projects.locations.sources.diskMigrationJobs.list(
      {
        filter: 'Test string',
        orderBy: 'Test string',
        pageSize: 42,
    ...
    await gapi.client.vmmigration.projects.locations.sources.diskMigrationJobs.patch(
      {
        name: 'Test string',
        requestId: 'Test string',
        updateMask: 'Test string',
    ...
    await gapi.client.vmmigration.projects.locations.sources.diskMigrationJobs.run(
      {
        name: 'Test string',
      },
      {},
    ...
    await gapi.client.vmmigration.projects.locations.sources.migratingVms.create(
      ...
      },
      {
        awsSourceVmDetails: {
          ...
          vmCapabilitiesInfo: {
            lastOsCapabilitiesUpdateTime: 'Test string',
            osCapabilities: ['Test string'],
          },
        },
        ...
        cutoverForecast: {
          estimatedCutoverJobDuration: 'Test string',
        },
        description: 'Test string',
        displayName: 'Test string',
        error: {
    ...
    await gapi.client.vmmigration.projects.locations.sources.migratingVms.extendMigration(
      {
        migratingVm: 'Test string',
      },
      {},
