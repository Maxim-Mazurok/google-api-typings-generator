/* Type definitions for non-npm package Migrate to Virtual Machines API v1alpha1 0.0 */
...
declare namespace gapi.client {
    /** Load Migrate to Virtual Machines API v1alpha1 */
    ...
    namespace vmmigration {
        ...
        interface AwsSourceDetails {
            ...
            inventoryTags?: { [P in string]: string };
            /**
