...
declare namespace gapi.client {
  ...
  function load(
    urlOrObject: 'https://vmmigration.googleapis.com/$discovery/rest?version=v1alpha1',
  ): Promise<void>;
  ...
  namespace vmmigration {
    ...
    interface AzureSourceVmDetails {
      /** Output only. The VM architecture. */
      architecture?: string;
      /** Output only. The total size of the disks being migrated in bytes. */
      committedStorageBytes?: string;
    ...
    interface CancelDiskMigrationJobRequest {}
    interface CancelImageImportJobRequest {}
    ...
    interface ComputeEngineTargetDefaults {
      ...
      adaptationModifiers?: AdaptationModifier[];
    ...
    interface CopyingSourceDiskSnapshotStep {}
    interface CreatingImageStep {}
    interface CreatingSourceDiskSnapshotStep {}
    ...
    interface DisksMigrationDisksTargetDefaults {}
    interface DisksMigrationDisksTargetDetails {}
    ...
    interface ExtendMigrationRequest {}
    ...
    interface ImageImport {
      ...
      recentImageImportJobs?: ImageImportJob[];
    }
    ...
    interface InitializingImageImportStep {}
    ...
    interface ListImageImportJobsResponse {
    ...
    interface ListImageImportsResponse {
      /** Output only. The list of target response. */
    ...
    interface LoadingImageSourceFilesStep {}
    ...
    interface PersistentDiskDefaults {
      ...
      additionalLabels?: {[P in string]: string};
    ...
    interface ProvisioningTargetDiskStep {}
    ...
    interface RunDiskMigrationJobRequest {}
    ...
    interface SourceStorageResource {
    ...
    interface ImageImportJobsResource {
      ...
      cancel(request: {
        ...
        uploadType?: string;
        /** Request body */
        resource: CancelImageImportJobRequest;
      }): Request<Operation>;
      cancel(
        request: {
          /** V1 error format. */
      ...
      list(request?: {
        ...
        /** Legacy upload protocol for media (e.g. "media", "multipart"). */
        uploadType?: string;
      }): Request<ListImageImportJobsResponse>;
    }
    interface ImageImportsResource {
      ...
      list(request?: {
        ...
        /** Legacy upload protocol for media (e.g. "media", "multipart"). */
        uploadType?: string;
      }): Request<ListImageImportsResponse>;
      imageImportJobs: ImageImportJobsResource;
    }
    ...
    interface DiskMigrationJobsResource {
      ...
      cancel(request: {
        ...
        uploadType?: string;
        /** Request body */
        resource: CancelDiskMigrationJobRequest;
      }): Request<Operation>;
      cancel(
        request: {
          /** V1 error format. */
      ...
      list(request?: {
        ...
        /** Legacy upload protocol for media (e.g. "media", "multipart"). */
        uploadType?: string;
      }): Request<ListDiskMigrationJobsResponse>;
      ...
      run(request: {
        ...
        uploadType?: string;
        /** Request body */
        resource: RunDiskMigrationJobRequest;
      }): Request<Operation>;
      run(
        request: {
          /** V1 error format. */
    ...
    interface MigratingVmsResource {
      ...
      extendMigration(request: {
        ...
        uploadType?: string;
        /** Request body */
        resource: ExtendMigrationRequest;
      }): Request<Operation>;
      extendMigration(
        request: {
          /** V1 error format. */
    ...
    interface SourcesResource {
      ...
      fetchStorageInventory(request?: {
        ...
        /** Legacy upload protocol for media (e.g. "media", "multipart"). */
        uploadType?: string;
      }): Request<FetchStorageInventoryResponse>;
      ...
      diskMigrationJobs: DiskMigrationJobsResource;
    ...
    interface LocationsResource {
      ...
      imageImports: ImageImportsResource;
