/* This is stub file for gapi.client.websecurityscanner-v1beta definition tests */
// IMPORTANT
...
gapi.load('client', async () => {
    ...
    await gapi.client.load('https://websecurityscanner.googleapis.com/$discovery/rest?version=v1beta');
    ...
    async function run() {
        ...
        await gapi.client.websecurityscanner.projects.scanConfigs.create({
            ...
            authentication: {
                ...
                iapCredential: {
                    iapTestServiceAccountInfo: {
                        targetAudienceClientId: "Test string",
                    },
                },
            },
            blacklistPatterns: [
            ...
            exportToSecurityCommandCenter: "Test string",
            ignoreHttpStatusErrors: true,
            latestRun: {
                endTime: "Test string",
                errorTrace: {
                    code: "Test string",
                    mostCommonHttpErrorCode: 42,
                    scanConfigError: {
                        code: "Test string",
