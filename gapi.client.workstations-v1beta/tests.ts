...
gapi.load('client', async () => {
  ...
  async function run() {
    ...
    await gapi.client.workstations.projects.locations.workstationClusters.workstationConfigs.create(
      ...
      },
      {
        ...
        httpOptions: {
          ...
          disableLocalhostReplacement: true,
        },
    ...
    await gapi.client.workstations.projects.locations.workstationClusters.workstationConfigs.workstations.pushCredentials(
      {
        workstation: 'Test string',
      },
      {
