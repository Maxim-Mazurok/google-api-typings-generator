    ...
    namespace tagmanager {
        ...
        interface Container {
            ...
            publicId?:
                string;
            /**
             * List of server-side container URLs for the Container. If multiple URLs are provided, all URL paths must match. @mutable tagmanager.accounts.containers.create @mutable
        ...
        interface GtagConfig {
            ...
            tagManagerUrl?:
                string;
            /**
             * Google tag config type. @required tagmanager.accounts.containers.workspaces.gtag_config.create @required tagmanager.accounts.containers.workspaces.gtag_config.update @mutable
             * tagmanager.accounts.containers.workspaces.gtag_config.create @mutable tagmanager.accounts.containers.workspaces.gtag_config.update
             */
            type?:
                string;
        ...
        interface Parameter {
            /**
             * Whether or not a reference type parameter is strongly or weakly referenced. Only used by Transformations. @mutable tagmanager.accounts.containers.workspaces.transformations.create
        ...
        interface Gtag_configResource {
            ...
            body: GtagConfig): Request<GtagConfig>;
            ...
            list(request?: {
                ...
                uploadType?:
                    string;
            }): Request<ListGtagConfigResponse>;
