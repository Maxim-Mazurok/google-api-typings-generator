...
declare namespace gapi.client {
    ...
    namespace tagmanager {
        ...
        interface Parameter {
            /**
             * Whether or not a reference type parameter is strongly or weakly referenced. @mutable tagmanager.accounts.containers.workspaces.transformations.create @mutable
