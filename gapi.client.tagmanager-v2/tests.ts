...
gapi.load('client', async () => {
  ...
  async function run() {
        ...
        customTemplate: [
          {
            ...
            fingerprint: 'Test string',
            galleryReference: {
              galleryTemplateId: 'Test string',
              host: 'Test string',
              isModified: true,
              owner: 'Test string',
              repository: 'Test string',
              signature: 'Test string',
              templateDeveloperId: 'Test string',
              version: 'Test string',
            },
            name: 'Test string',
            path: 'Test string',
    ...
    await gapi.client.tagmanager.accounts.containers.workspaces.bulk_update(
      {
        path: 'Test string',
      },
      {
    ...
    await gapi.client.tagmanager.accounts.containers.workspaces.templates.import_from_gallery(
      {
        acknowledgePermissions: true,
        galleryOwner: 'Test string',
        galleryRepository: 'Test string',
        gallerySha: 'Test string',
        parent: 'Test string',
      },
    );
