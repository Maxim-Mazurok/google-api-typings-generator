...
declare namespace gapi.client {
  ...
  namespace firebaseml {
    ...
    interface GoogleCloudAiplatformV1beta1AudioResponseFormat {
      /** Optional. Bit rate in bits per second (bps). Only applicable for compressed formats (MP3, Opus). */
      bitRate?: number;
      /** Optional. Delivery mode for the generated content. */
      delivery?: 'DELIVERY_UNSPECIFIED' | 'INLINE' | 'URI';
    ...
    interface GoogleCloudAiplatformV1beta1AudioTranscription {
      ...
      words?: GoogleCloudAiplatformV1beta1AudioTranscriptionWordInfo[];
    }
    interface GoogleCloudAiplatformV1beta1AudioTranscriptionConfig {
    ...
    interface GoogleCloudAiplatformV1beta1AudioTranscriptionConfigLanguageAuto {}
    interface GoogleCloudAiplatformV1beta1AudioTranscriptionConfigLanguageHints {
      /** Required. Deprecated: Use top-level `language_codes` instead. BCP-47 language codes. At least one must be specified. */
      languageCodes?: string[];
    }
    interface GoogleCloudAiplatformV1beta1AudioTranscriptionWordInfo {
    ...
    interface GoogleCloudAiplatformV1beta1GenerationConfig {
      ...
      responseFormat?: GoogleCloudAiplatformV1beta1ResponseFormat[];
    ...
    interface GoogleCloudAiplatformV1beta1GoogleMapsGroundingTypes {
    ...
    interface GoogleCloudAiplatformV1beta1GoogleMapsPlaces {}
    interface GoogleCloudAiplatformV1beta1GoogleMapsRouting {}
    ...
    interface GoogleCloudAiplatformV1beta1GroundingChunkImage {
    ...
    interface GoogleCloudAiplatformV1beta1GroundingChunkMapsRoute {
    ...
    interface GoogleCloudAiplatformV1beta1ImageResponseFormat {
      ...
      mimeType?: 'MIME_TYPE_UNSPECIFIED' | 'IMAGE_JPEG';
    }
    ...
    interface GoogleCloudAiplatformV1beta1ResponseFormat {
      /** Audio output format. */
    ...
    interface GoogleCloudAiplatformV1beta1TextResponseFormat {
      /** Optional. The IANA standard MIME type of the response. */
      mimeType?: 'MIME_TYPE_UNSPECIFIED' | 'APPLICATION_JSON' | 'TEXT_PLAIN';
    ...
    interface GoogleCloudAiplatformV1beta1ToolExaAiSearch {
    ...
    interface GoogleCloudAiplatformV1beta1ToolGoogleSearchImageSearch {}
    interface GoogleCloudAiplatformV1beta1ToolGoogleSearchSearchTypes {
    ...
    interface GoogleCloudAiplatformV1beta1ToolGoogleSearchWebSearch {}
    ...
    interface GoogleCloudAiplatformV1beta1TranslationConfig {
    ...
    interface GoogleCloudAiplatformV1beta1VideoResponseFormat {
