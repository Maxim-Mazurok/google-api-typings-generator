// Type definitions for non-npm package Search Console API v3 3.0
    ...
    namespace webmasters {
        ...
        interface SitesResource {
            ...
            delete(request?: {
                ...
                quotaUser?: string;
                /**
                 * The URI of the property as defined in Search Console. Examples: http://www.example.com/ or android-app://com.example/ Note: for property-sets, use the
