    ...
    namespace civicinfo {
        ...
        interface DivisionsResource {
            ...
            search(request: {
                ...
                userIp?: string;
                /** Request body */
                resource: DivisionSearchRequest;
            ...
            body: DivisionSearchRequest): Request<DivisionSearchResponse>;
        }
        interface ElectionsResource {
            ...
            electionQuery(request: {
                ...
                userIp?: string;
                /** Request body */
                resource: ElectionsQueryRequest;
            ...
            body: ElectionsQueryRequest): Request<ElectionsQueryResponse>;
            ...
            voterInfoQuery(request: {
                ...
                alt?: string;
                /**
                 * The unique ID of the election to look up. A list of election IDs can be obtained at https://www.googleapis.com/civicinfo/{version}/electionsIf no
            ...
            body: VoterInfoRequest): Request<VoterInfoResponse>;
        }
        interface RepresentativesResource {
            ...
            representativeInfoByAddress(request: {
                ...
                userIp?: string;
                /** Request body */
                resource: RepresentativeInfoRequest;
            ...
            body: RepresentativeInfoRequest): Request<RepresentativeInfoResponse>;
            ...
            representativeInfoByDivision(request: {
                ...
                userIp?: string;
                /** Request body */
                resource: DivisionRepresentativeInfoRequest;
            ...
            body: DivisionRepresentativeInfoRequest): Request<RepresentativeInfoData>;
        }
