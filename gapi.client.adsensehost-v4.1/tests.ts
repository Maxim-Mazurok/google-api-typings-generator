/* This is stub file for gapi.client.adsensehost-v4.1 definition tests */
// IMPORTANT
...
gapi.load('client', async () => {
    ...
    await gapi.client.load('https://adsensehost.googleapis.com/$discovery/rest?version=v4.1');
