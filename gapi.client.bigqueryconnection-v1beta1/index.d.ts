/* Type definitions for non-npm package BigQuery Connection API v1beta1 0.0 */
...
declare namespace gapi.client {
    ...
    function load(urlOrObject: "https://bigqueryconnection.googleapis.com/$discovery/rest?version=v1beta1"): Promise<void>;
    /** @deprecated Please load APIs with discovery documents. */
    function load(name: "bigqueryconnection", version: "v1beta1"): Promise<void>;
    /** @deprecated Please load APIs with discovery documents. */
