...
declare namespace gapi.client {
    ...
    function load(urlOrObject: "https://runtimeconfig.googleapis.com/$discovery/rest?version=v1"): Promise<void>;
    /** @deprecated Please load APIs with discovery documents. */
    function load(name: "runtimeconfig", version: "v1"): Promise<void>;
    /** @deprecated Please load APIs with discovery documents. */
