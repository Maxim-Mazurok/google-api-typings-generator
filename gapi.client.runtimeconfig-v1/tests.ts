/* This is stub file for gapi.client.runtimeconfig-v1 definition tests */
// IMPORTANT
...
gapi.load('client', async () => {
    ...
    await gapi.client.load('https://runtimeconfig.googleapis.com/$discovery/rest?version=v1');
