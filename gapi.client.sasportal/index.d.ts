...
declare namespace gapi.client {
    ...
    namespace sasportal {
        ...
        interface SasPortalDeployment {
            ...
            name?: string;
            /** User id used by the devices belonging to this deployment. Each deployment should be associated with one unique user_id. */
            sasUserIds?: string[];
        }
        ...
        interface SasPortalListDeploymentsResponse {
            ...
            /**
             * A pagination token returned from a previous call to ListDeployments method that indicates from where listing should continue. If the field is missing or empty, it means there is no
             * more deployments.
             */
            nextPageToken?: string;
        }
        ...
        interface DeploymentsResource {
            ...
            list(request?: {
                ...
                pageSize?: number;
                /** A pagination token returned from a previous call to ListDeployments method that indicates where this listing should continue from. */
                pageToken?: string;
