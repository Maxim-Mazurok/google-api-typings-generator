...
// Generated from: https://sasportal.googleapis.com/$discovery/rest?version=v1alpha1
// Revision: 20200401
...
declare namespace gapi.client {
    ...
    function load(name: "sasportal", version: "v1alpha1"): PromiseLike<void>;
    function load(name: "sasportal", version: "v1alpha1", callback: () => any): void;
    ...
    namespace sasportal {
        ...
        interface SasPortalBulkCreateDeviceRequest {
            /**
        ...
        interface SasPortalBulkCreateDeviceResponse {
        ...
        interface SasPortalCreateSignedDeviceRequest {
             ...
             * must be the JSON encoding of the [Device]. The user_id must be set.
             */
        ...
        interface SasPortalListCustomersResponse {
            ...
            /**
             * A pagination token returned from a previous call to ListCustomers method that indicates from
        ...
        interface SasPortalUpdateSignedDeviceRequest {
             ...
             * of the device. The user_id must be set.
             */
            encodedDevice?: string;
            /**
        ...
        interface DevicesResource {
            ...
            bulk(request: {
                ...
                uploadType?: string;
                /** Request body */
                resource: SasPortalBulkCreateDeviceRequest;
            }): Request<SasPortalBulkCreateDeviceResponse>;
            bulk(request: {
                /** V1 error format. */
                "$.xgafv"?: string;
                /** OAuth access token. */
            ...
            body: SasPortalBulkCreateDeviceRequest): Request<SasPortalBulkCreateDeviceResponse>;
