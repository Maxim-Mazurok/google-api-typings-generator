...
gapi.load('client', async () => {
  ...
  async function run() {
    ...
    await gapi.client.calendar.calendarList.insert(
      ...
      },
      {
        ...
        conferenceProperties: {
          allowedConferenceSolutionTypes: ['Test string'],
        },
        dataOwner: 'Test string',
        defaultReminders: [
          {
            method: 'Test string',
            minutes: 42,
     ...
     */
    await gapi.client.calendar.calendars.transferOwnership({
      calendarId: 'Test string',
      newDataOwner: 'Test string',
      useAdminAccess: true,
    });
          ...
          entryPoints: [
            {
              ...
              entryPointFeatures: ['Test string'],
