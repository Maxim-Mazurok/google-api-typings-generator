...
declare namespace gapi.client {
    ...
    function load(name: "analyticshub", version: "v1beta1"): PromiseLike<void>;
    ...
    namespace analyticshub {
        ...
        interface DataExchange {
            ...
            description?: string;
            /**
             * Required. Human-readable display name of the data exchange. The display name must contain only Unicode letters, numbers (0-9), underscores (_), dashes (-), spaces ( ), and must not
             * start or end with spaces. Default value is an empty string. Max length: 63 bytes.
             */
            displayName?: string;
        ...
        interface Listing {
            ...
            description?: string;
            /**
             * Required. Human-readable display name of the listing. The display name must contain only Unicode letters, numbers (0-9), underscores (_), dashes (-), spaces ( ), and can't start or
