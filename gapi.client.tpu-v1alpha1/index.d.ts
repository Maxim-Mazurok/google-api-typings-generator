...
// Generated from: https://tpu.googleapis.com/$discovery/rest?version=v1alpha1
// Revision: 20220907

/// <reference types="gapi.client" />

declare namespace gapi.client {
    /** Load Cloud TPU API v1alpha1 */
    function load(urlOrObject: "https://tpu.googleapis.com/$discovery/rest?version=v1alpha1"): Promise<void>;
    /** @deprecated Please load APIs with discovery documents. */
    function load(name: "tpu", version: "v1alpha1"): Promise<void>;
    /** @deprecated Please load APIs with discovery documents. */
    function load(name: "tpu", version: "v1alpha1", callback: () => any): void;
