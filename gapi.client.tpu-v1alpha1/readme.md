# TypeScript typings for Cloud TPU API v1alpha1
...
{
  "compilerOptions": {
    "types": ["gapi", "gapi.auth2", "gapi.client", "gapi.client.tpu-v1alpha1"]
  }
}
```
...
For provenance information see [Provenance section on NPM](https://www.npmjs.com/package/@maxim_mazurok/gapi.client.tpu-v1alpha1#Provenance:~:text=none-,Provenance,-Built%20and%20signed)
