...
declare namespace gapi.client {
    ...
    namespace adexchangebuyer {
        ...
        interface TargetingValueDemogAgeCriteria {
            demogAgeCriteriaIds?: string[];
        }
        interface TargetingValueDemogGenderCriteria {
            demogGenderCriteriaIds?: string[];
        }
        interface TargetingValueRequestPlatformTargeting {
        ...
        interface MarketplacedealsResource {
            ...
            delete(request: {
                ...
                userIp?: string;
                /** Request body */
                resource: DeleteOrderDealsRequest;
            ...
            body: DeleteOrderDealsRequest): Request<DeleteOrderDealsResponse>;
            ...
            update(request: {
                ...
                userIp?: string;
                /** Request body */
                resource: EditAllOrderDealsRequest;
            ...
            body: EditAllOrderDealsRequest): Request<EditAllOrderDealsResponse>;
        }
        ...
        interface MarketplaceprivateauctionResource {
            ...
            updateproposal(request: {
                ...
                userIp?: string;
                /** Request body */
                resource: UpdatePrivateAuctionProposalRequest;
            }): Request<void>;
            updateproposal(request: {
                /** Data format for the response. */
                alt?: string;
            ...
            body: UpdatePrivateAuctionProposalRequest): Request<void>;
        }
        ...
        interface ProposalsResource {
            ...
            body: CreateOrdersRequest): Request<CreateOrdersResponse>;
        ...
        const billingInfo: BillingInfoResource;

        const budget: BudgetResource;

        const creatives: CreativesResource;

        const marketplacedeals: MarketplacedealsResource;

        const marketplacenotes: MarketplacenotesResource;

        const marketplaceprivateauction: MarketplaceprivateauctionResource;

        const performanceReport: PerformanceReportResource;

        const pretargetingConfig: PretargetingConfigResource;

        const products: ProductsResource;

        const proposals: ProposalsResource;

        const pubprofiles: PubprofilesResource;
    }
}
