/* Type definitions for non-npm package API Discovery Service v1 0.0 */
...
declare namespace gapi.client {
    ...
    function load(urlOrObject: "https://discovery.googleapis.com/$discovery/rest?version=v1"): Promise<void>;
