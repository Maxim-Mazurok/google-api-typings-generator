...
declare namespace gapi.client {
  ...
  namespace dialogflow {
    ...
    interface GoogleCloudDialogflowV2beta1ConversationGeneratorContext {
      generatorType?:
    ...
    interface GoogleCloudDialogflowV2beta1Generator {
      ...
      cesAppSpecs?: GoogleCloudDialogflowV2beta1CesAppSpec[];
      cesToolSpecs?: GoogleCloudDialogflowV2beta1CesToolSpec[];
      createTime?: string;
      description?: string;
      ...
      tools?: string[];
      toolsetTools?: GoogleCloudDialogflowV2beta1ToolsetTool[];
      triggerEvent?:
        | 'TRIGGER_EVENT_UNSPECIFIED'
        | 'END_OF_UTTERANCE'
        | 'MANUAL_CALL'
    ...
    interface GoogleCloudDialogflowV2beta1PhoneNumberAllowedSipTrunks {
      carrierIds?: string[];
      sipTrunks?: string[];
    }
    interface GoogleCloudDialogflowV2beta1ProbeDetails {
      initTime?: string;
    ...
    interface GoogleCloudDialogflowV2beta1SipHostname {
      connectionState?:
    ...
    interface GoogleCloudDialogflowV2beta1SipHostnameHostnameErrorDetails {
      certificateState?:
    ...
    interface GoogleCloudDialogflowV2beta1SipTrunk {
      ...
      name?: string;
      peerHostnames?: GoogleCloudDialogflowV2beta1SipHostname[];
    }
    ...
    interface GoogleCloudDialogflowV2beta1SpeechToTextConfigGeminiAsrConfig {
