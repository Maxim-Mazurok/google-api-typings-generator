...
gapi.load('client', async () => {
  ...
  async function run() {
      ...
      },
      {
        ...
        queryInput: {
          audioConfig: {
            ...
            enableWordInfo: true,
            geminiAsrConfig: {
              endOfSpeechSensitivity: 'Test string',
              modelId: 'Test string',
              prefixPaddingMs: 42,
              silenceDurationMs: 42,
              startOfSpeechSensitivity: 'Test string',
            },
            languageCode: 'Test string',
            model: 'Test string',
    ...
    await gapi.client.dialogflow.projects.conversationProfiles.create(
      ...
      },
      {
            ...
            featureConfigs: [
              {
                ...
                disableQuerySearchContext: true,
                ...
                suggestionTriggerEvent: 'Test string',
        ...
        sipConfig: {
          ...
          copyInboundCallLegHeaders: ['Test string'],
          createConversationOnTheFly: true,
          ignoreReinviteMediaDirection: true,
          inactiveStart: true,
          keepConversationRunning: true,
          maxAudioRecordingDuration: 'Test string',
        },
        sttConfig: {
          audioEncoding: 'Test string',
          enableWordInfo: true,
    ...
    await gapi.client.dialogflow.projects.generators.create(
      ...
      },
      {
        ...
        cesAppSpecs: [
          {
            cesApp: 'Test string',
            confirmationRequirement: 'Test string',
    ...
    await gapi.client.dialogflow.projects.locations.phoneNumbers.patch(
      ...
      {
        allowedSipTrunks: {
          carrierIds: ['Test string'],
          sipTrunks: ['Test string'],
        },
        conversationProfile: 'Test string',
        lifecycleState: 'Test string',
        name: 'Test string',
    ...
    await gapi.client.dialogflow.projects.locations.sipTrunks.create(
      ...
      },
      {
        ...
        googleRootCertFile: 'Test string',
        name: 'Test string',
        peerHostnames: [
          {
            ...
            peerHostname: 'Test string',
            peerSocketAddress: 'Test string',
            pingInterval: 'Test string',
            probeDetails: {
              initTime: 'Test string',
              optionsLatency: 'Test string',
              probeStatus: 'Test string',
            },
          },
        ],
      },
