...
gapi.load('client', async () => {
    ...
    async function run() {
        ...
        /**
         * Updates a log bucket.If the bucket has a lifecycle_state of DELETE_REQUESTED, then FAILED_PRECONDITION will be returned.After a bucket has been created, the bucket's location cannot be
         * changed.
         */
