...
declare namespace gapi.client {
    ...
    namespace monitoring {
        ...
        interface TextLocator {
            ...
            /**
             * If source, start_position, and end_position describe a call on some object (e.g. a macro in the time series query language text) and a location is to be designated in that object's
             * text, nested_locator identifies the location within that object.
             */
            nestedLocator?: TextLocator;
            /**
             * When nested_locator is set, this field gives the reason for the nesting. Usually, the reason is a macro invocation. In that case, the macro name (including the leading '@') signals
             * the location of the macro call in the text and a macro argument name (including the leading '$') signals the location of the macro argument inside the macro body that got
             * substituted away.
             */
            nestingReason?: string;
            /**
             * The source of the text. The source may be a field in the request, in which case its format is the format of the google.rpc.BadRequest.FieldViolation.field field in
             * https://cloud.google.com/apis/design/errors#error_details. It may also be be a source other than the request field (e.g. a macro definition referenced in the text of the query), in
             * which case this is the name of the source (e.g. the macro name).
             */
            source?: string;
