...
declare namespace gapi.client {
    ...
    namespace monitoring {
        ...
        interface UptimeCheckConfig {
             ...
             * uptime_url, gce_instance, gae_app, aws_ec2_instance, aws_elb_load_balancer k8s_service servicedirectory_service
             */
        ...
        interface AlertPoliciesResource {
            ...
            create(request: {
                 ...
                 * this field names the parent container in which the alerting policy will be written, not the name of the created policy. |name| must be a host project of a workspace, otherwise
                 * INVALID_ARGUMENT error will return. The alerting policy that is returned will have a name that contains a normalized representation of this name as a prefix but adds a suffix of
        ...
        interface MetricDescriptorsResource {
            /**
             * Creates a new metric descriptor. The creation is executed asynchronously and callers may check the returned operation to track its progress. User-created metric descriptors define
        ...
        interface ServicesResource {
            ...
            list(request?: {
                ...
                pageToken?: string;
                /**
                 * Required. Resource name of the parent containing the listed services, either a project (https://cloud.google.com/monitoring/api/v3#project_name) or a Monitoring Workspace. The
