...
declare namespace gapi.client {
    ...
    namespace monitoring {
        ...
        interface HttpCheck {
            ...
            /**
             * The request body associated with the HTTP request. If content_type is URL_ENCODED, the body passed in must be URL-encoded. Users can provide a
             * Content-Length header via the headers field or the API will do so. The maximum byte size is 1 megabyte. Note: As with all bytes fields JSON
        ...
        interface AlertPoliciesResource {
            ...
            create(request: {
                 ...
                 * Note that this field names the parent container in which the alerting policy will be written, not the name of the created policy. |name| must be a host
                 * project of a workspace, otherwise INVALID_ARGUMENT error will return. The alerting policy that is returned will have a name that contains a normalized
                 * representation of this name as a prefix but adds a suffix of the form /alertPolicies/[ALERT_POLICY_ID], identifying the policy in the container.
                 */
                name: string;
        ...
        interface MonitoredResourceDescriptorsResource {
            ...
            list(request?: {
                 ...
                 * descriptor's type and labels. For example, the following filter returns only Google Compute Engine descriptors that have an id label:
        ...
        interface TimeSeriesResource {
            ...
            list(request?: {
                 ...
                 * specify a single metric type, and can additionally specify metric labels and other information. For example:
