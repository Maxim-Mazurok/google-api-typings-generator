...
declare namespace gapi.client {
    ...
    namespace monitoring {
        ...
        interface MetricAbsence {
             ...
             * similar to the one that is specified in the ListTimeSeries request (that call is useful to verify the time series that will be retrieved / processed)
             * and must specify the metric type and optionally may contain restrictions on resource type, resource labels, and metric labels. This field may not
