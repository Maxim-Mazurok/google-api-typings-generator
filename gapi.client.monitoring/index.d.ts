...
declare namespace gapi.client {
    ...
    namespace monitoring {
        ...
        interface Condition {
            ...
            /** A condition that uses the time series query language format to define alerts. If set, no other conditions can be present. */
        ...
        interface TimeSeriesQueryLanguageCondition {
            /** A query in the time series query language format that generates time series indicating points in time that the condition should be considered active. */
            query?: string;
