/* This is stub file for gapi.client.deploymentmanager-v2 definition tests */
// IMPORTANT
      ...
      },
      {
        ...
        operation: {
          ...
          firewallPolicyRuleOperationMetadata: {
            allocatedPriority: 42,
          },
          getHealthOperationMetadata: {
            healthInfo: {
              availabilitySloStatus: 'Test string',
              healthStatus: 'Test string',
              repairCategory: 'Test string',
              unhealthyReason: 'Test string',
          ...
          instancesTroubleshootOperationMetadata: {
            troubleshootOutput: 'Test string',
          },
          kind: 'Test string',
          name: 'Test string',
