...
declare namespace gapi.client {
    ...
    namespace recommender {
        ...
        interface GoogleCloudRecommenderV1Operation {
             ...
             * Example: { "/bindings/∗/role": "roles/admin" "/bindings/∗/condition" : null } * Example: { "/bindings/∗/role": "roles/admin" "/bindings/∗/members/*" : ["x@google.com",
             * "y@google.com"] } When both path_filters and path_value_matchers are set, an implicit AND must be performed.
             */
        ...
        interface InsightsResource {
            ...
            list(request?: {
                 ...
                 * LOCATION here refers to GCP Locations: https://cloud.google.com/about/locations/ INSIGHT_TYPE_ID refers to supported insight types:
