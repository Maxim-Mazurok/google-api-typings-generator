...
declare namespace gapi.client {
  ...
  namespace smartdevicemanagement {
    ...
    interface GoogleHomeEnterpriseSdmV1ParentRelation {
      ...
      displayName?: string;
      /** Output only. The Home APIs name of the relation -- e.g., structure/room where the device is assigned to. For example: "homegraph.googleapis.com/Structure/ABC" or "homegraph.googleapis.com/Room/ABC" */
      ghpParent?: string;
