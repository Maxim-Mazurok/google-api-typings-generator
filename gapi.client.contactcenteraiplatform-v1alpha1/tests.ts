...
gapi.load('client', async () => {
    ...
    async function run() {
        ...
        await gapi.client.contactcenteraiplatform.projects.locations.contactCenters["getAuthentication-config"]({
            name: "Test string",
        });
        ...
        await gapi.client.contactcenteraiplatform.projects.locations.contactCenters["updateAuthentication-config"]({
            name: "Test string",
            updateMask: "Test string",
        }, {
            basicAuthSetting: {
