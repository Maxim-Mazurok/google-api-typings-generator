/* Type definitions for non-npm package OS Config API v2 0.0 */
...
// Generated from: https://osconfig.googleapis.com/$discovery/rest?version=v2
// Revision: 20260129

/// <reference types="gapi.client" />

declare namespace gapi.client {
  /** Load OS Config API v2 */
  function load(
    urlOrObject: 'https://osconfig.googleapis.com/$discovery/rest?version=v2',
  ): Promise<void>;
  /** @deprecated Please load APIs with discovery documents. */
  function load(name: 'osconfig', version: 'v2'): Promise<void>;
  /** @deprecated Please load APIs with discovery documents. */
  function load(name: 'osconfig', version: 'v2', callback: () => any): void;
  ...
  namespace osconfig {
    ...
    interface PolicyOrchestratorsResource {
      ...
      create(request: {
        ...
        uploadType?: string;
        /** Request body */
        resource: GoogleCloudOsconfigV2__PolicyOrchestrator;
      }): Request<Operation>;
      create(
        request: {
          /** V1 error format. */
      ...
      get(request?: {
        ...
        /** Legacy upload protocol for media (e.g. "media", "multipart"). */
        uploadType?: string;
      }): Request<GoogleCloudOsconfigV2__PolicyOrchestrator>;
      ...
      list(request?: {
        ...
        /** Legacy upload protocol for media (e.g. "media", "multipart"). */
        uploadType?: string;
      }): Request<GoogleCloudOsconfigV2__ListPolicyOrchestratorsResponse>;
