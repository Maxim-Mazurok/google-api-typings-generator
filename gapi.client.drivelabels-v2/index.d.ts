...
declare namespace gapi.client {
    ...
    namespace drivelabels {
        ...
        interface GoogleAppsDriveLabelsV2BatchDeleteLabelPermissionsRequest {
        ...
        interface GoogleAppsDriveLabelsV2BatchUpdateLabelPermissionsResponse {
        ...
        interface GoogleAppsDriveLabelsV2DeltaUpdateLabelRequestCreateFieldRequest {
        ...
        interface GoogleAppsDriveLabelsV2DeltaUpdateLabelRequestUpdateFieldPropertiesRequest {
        ...
        interface GoogleAppsDriveLabelsV2DeltaUpdateLabelResponseCreateSelectionChoiceResponse {
        ...
        interface GoogleAppsDriveLabelsV2DeltaUpdateLabelResponseDeleteFieldResponse {
        }
        // tslint:disable-next-line:no-empty-interface
        interface GoogleAppsDriveLabelsV2DeltaUpdateLabelResponseDeleteSelectionChoiceResponse {
        }
        // tslint:disable-next-line:no-empty-interface
        interface GoogleAppsDriveLabelsV2DeltaUpdateLabelResponseDisableFieldResponse {
        }
        // tslint:disable-next-line:no-empty-interface
        interface GoogleAppsDriveLabelsV2DeltaUpdateLabelResponseDisableSelectionChoiceResponse {
        }
        // tslint:disable-next-line:no-empty-interface
        interface GoogleAppsDriveLabelsV2DeltaUpdateLabelResponseEnableFieldResponse {
        }
        // tslint:disable-next-line:no-empty-interface
        interface GoogleAppsDriveLabelsV2DeltaUpdateLabelResponseEnableSelectionChoiceResponse {
        }
        interface GoogleAppsDriveLabelsV2DeltaUpdateLabelResponseResponse {
            /** Creates a new Field. */
        ...
        // tslint:disable-next-line:no-empty-interface
        interface GoogleAppsDriveLabelsV2DeltaUpdateLabelResponseUpdateFieldTypeResponse {
        }
        // tslint:disable-next-line:no-empty-interface
        interface GoogleAppsDriveLabelsV2DeltaUpdateLabelResponseUpdateLabelPropertiesResponse {
        }
        ...
        interface GoogleAppsDriveLabelsV2FieldLongTextOptions {
        ...
        interface GoogleAppsDriveLabelsV2IntegerLimits {
        ...
        interface GoogleAppsDriveLabelsV2ListLimits {
        ...
        interface GoogleAppsDriveLabelsV2PublishLabelRequest {
            /** The BCP-47 language code to use for evaluating localized field labels. When not specified, values in the default configured language will be used. */
            languageCode?: string;
            /** Set to `true` in order to use the user's admin credentials. The server will verify the user is an admin for the Label before allowing access. */
            useAdminAccess?: boolean;
        ...
        interface GoogleAppsDriveLabelsV2UserLimits {
            /** Limits for list-variant of a Field type. */
            listLimits?: GoogleAppsDriveLabelsV2ListLimits;
        }
        ...
        interface LocksResource {
            ...
            list(request?: {
                ...
                uploadType?: string;
            }): Request<GoogleAppsDriveLabelsV2ListLabelLocksResponse>;
        }
        interface PermissionsResource {
            ...
            batchDelete(request: {
                ...
                oauth_token?: string;
                /**
                 * Required. The parent Label resource name shared by all permissions being deleted. Format: labels/{label} If this is set, the parent field in the UpdateLabelPermissionRequest
                ...
                uploadType?: string;
                /** Request body */
                resource: GoogleAppsDriveLabelsV2BatchDeleteLabelPermissionsRequest;
            }): Request<{}>;
            batchDelete(request: {
                /** V1 error format. */
                "$.xgafv"?: string;
            ...
            body: GoogleAppsDriveLabelsV2BatchDeleteLabelPermissionsRequest): Request<{}>;
            /**
            ...
            batchUpdate(request: {
                ...
                uploadType?: string;
                /** Request body */
                resource: GoogleAppsDriveLabelsV2BatchUpdateLabelPermissionsRequest;
            ...
            body: GoogleAppsDriveLabelsV2BatchUpdateLabelPermissionsRequest): Request<GoogleAppsDriveLabelsV2BatchUpdateLabelPermissionsResponse>;
            /**
            ...
            create(request: {
                ...
                useAdminAccess?: boolean;
                /** Request body */
                resource: GoogleAppsDriveLabelsV2LabelPermission;
            ...
            body: GoogleAppsDriveLabelsV2LabelPermission): Request<GoogleAppsDriveLabelsV2LabelPermission>;
            ...
            list(request?: {
                ...
                /** Set to `true` in order to use the user's admin credentials. The server will verify the user is an admin for the Label before allowing access. */
                useAdminAccess?: boolean;
            }): Request<GoogleAppsDriveLabelsV2ListLabelPermissionsResponse>;
        }
        interface LocksResource {
            /** Lists the LabelLocks on a Label. */
            list(request?: {
        ...
        interface LabelsResource {
            ...
            create(request: {
                ...
                useAdminAccess?: boolean;
                /** Request body */
                resource: GoogleAppsDriveLabelsV2Label;
            ...
            body: GoogleAppsDriveLabelsV2Label): Request<GoogleAppsDriveLabelsV2Label>;
            /**
            ...
            delta(request: {
                ...
                uploadType?: string;
                /** Request body */
                resource: GoogleAppsDriveLabelsV2DeltaUpdateLabelRequest;
            ...
            body: GoogleAppsDriveLabelsV2DeltaUpdateLabelRequest): Request<GoogleAppsDriveLabelsV2DeltaUpdateLabelResponse>;
            /**
            ...
            disable(request: {
                ...
                uploadType?: string;
                /** Request body */
                resource: GoogleAppsDriveLabelsV2DisableLabelRequest;
            }): Request<GoogleAppsDriveLabelsV2Label>;
            disable(request: {
                /** V1 error format. */
                "$.xgafv"?: string;
            ...
            body: GoogleAppsDriveLabelsV2DisableLabelRequest): Request<GoogleAppsDriveLabelsV2Label>;
            /**
            ...
            enable(request: {
                ...
                uploadType?: string;
                /** Request body */
                resource: GoogleAppsDriveLabelsV2EnableLabelRequest;
            }): Request<GoogleAppsDriveLabelsV2Label>;
            enable(request: {
                /** V1 error format. */
                "$.xgafv"?: string;
            ...
            body: GoogleAppsDriveLabelsV2EnableLabelRequest): Request<GoogleAppsDriveLabelsV2Label>;
            /**
            ...
            publish(request: {
                ...
                uploadType?: string;
                /** Request body */
                resource: GoogleAppsDriveLabelsV2PublishLabelRequest;
            }): Request<GoogleAppsDriveLabelsV2Label>;
            publish(request: {
                /** V1 error format. */
                "$.xgafv"?: string;
            ...
            body: GoogleAppsDriveLabelsV2PublishLabelRequest): Request<GoogleAppsDriveLabelsV2Label>;
            ...
            updateLabelCopyMode(request: {
                ...
                uploadType?: string;
                /** Request body */
                resource: GoogleAppsDriveLabelsV2UpdateLabelCopyModeRequest;
            }): Request<GoogleAppsDriveLabelsV2Label>;
            updateLabelCopyMode(request: {
                /** V1 error format. */
                "$.xgafv"?: string;
            ...
            body: GoogleAppsDriveLabelsV2UpdateLabelCopyModeRequest): Request<GoogleAppsDriveLabelsV2Label>;
            /**
             * Updates a Label's permissions. If a permission for the indicated principal doesn't exist, a new Label Permission is created, otherwise the existing permission is updated.
             * Permissions affect the Label resource as a whole, are not revisioned, and do not require publishing.
             */
        ...
        interface LimitsResource {
            ...
            getLabel(request?: {
                ...
                /** Legacy upload protocol for media (e.g. "media", "multipart"). */
                uploadType?: string;
            }): Request<GoogleAppsDriveLabelsV2LabelLimits>;
        }
        interface UsersResource {
            ...
            getCapabilities(request?: {
                ...
                /** Legacy upload protocol for media (e.g. "media", "multipart"). */
                uploadType?: string;
            }): Request<GoogleAppsDriveLabelsV2UserCapabilities>;
        }
