...
// Generated from: https://vision.googleapis.com/$discovery/rest?version=v1p1beta1
// Revision: 20220904
...
declare namespace gapi.client {
    ...
    function load(urlOrObject: "https://vision.googleapis.com/$discovery/rest?version=v1p1beta1"): Promise<void>;
    /** @deprecated Please load APIs with discovery documents. */
    function load(name: "vision", version: "v1p1beta1"): Promise<void>;
    /** @deprecated Please load APIs with discovery documents. */
    function load(name: "vision", version: "v1p1beta1", callback: () => any): void;
    ...
    namespace vision {
        ...
        interface GoogleCloudVisionV1p1beta1AnnotateFileRequest {
        ...
        interface GoogleCloudVisionV1p1beta1AnnotateImageRequest {
            /** Requested features. */
            features?: GoogleCloudVisionV1p1beta1Feature[];
        ...
        interface GoogleCloudVisionV1p1beta1AsyncAnnotateFileRequest {
            /** Required. Requested features. */
            features?: GoogleCloudVisionV1p1beta1Feature[];
            /** Additional context that may accompany the image(s) in the file. */
            imageContext?: GoogleCloudVisionV1p1beta1ImageContext;
        ...
        interface GoogleCloudVisionV1p1beta1AsyncBatchAnnotateFilesRequest {
            /**
        ...
        interface GoogleCloudVisionV1p1beta1AsyncBatchAnnotateImagesRequest {
            /** Required. The desired output location and metadata (e.g. format). */
            outputConfig?: GoogleCloudVisionV1p1beta1OutputConfig;
            /**
             * Optional. Target project and location to make a call. Format: `projects/{project-id}/locations/{location-id}`. If no parent is specified, a region will be chosen automatically.
        ...
        interface GoogleCloudVisionV1p1beta1BatchAnnotateFilesRequest {
            /**
             * Optional. Target project and location to make a call. Format: `projects/{project-id}/locations/{location-id}`. If no parent is specified, a region will be chosen automatically.
             * Supported location-ids: `us`: USA country only, `asia`: East asia areas, like Japan, Taiwan, `eu`: The European Union. Example: `projects/project-A/locations/eu`.
             */
        ...
        interface GoogleCloudVisionV1p1beta1BatchAnnotateFilesResponse {
            /** The list of file annotation responses, each response corresponding to each AnnotateFileRequest in BatchAnnotateFilesRequest. */
            responses?: GoogleCloudVisionV1p1beta1AnnotateFileResponse[];
        }
        interface GoogleCloudVisionV1p1beta1BatchAnnotateImagesRequest {
            /**
             * Optional. Target project and location to make a call. Format: `projects/{project-id}/locations/{location-id}`. If no parent is specified, a region will be chosen automatically.
             * Supported location-ids: `us`: USA country only, `asia`: East asia areas, like Japan, Taiwan, `eu`: The European Union. Example: `projects/project-A/locations/eu`.
             */
        ...
        interface GoogleCloudVisionV1p1beta1BatchAnnotateImagesResponse {
        ...
        interface GoogleCloudVisionV1p1beta1CropHintsParams {
            /**
        ...
        interface GoogleCloudVisionV1p1beta1Feature {
        ...
        interface GoogleCloudVisionV1p1beta1Image {
            /**
        ...
        interface GoogleCloudVisionV1p1beta1ImageContext {
        ...
        interface GoogleCloudVisionV1p1beta1ImageSource {
            /**
        ...
        interface GoogleCloudVisionV1p1beta1LatLongRect {
            /** Max lat/long pair. */
            maxLatLng?: LatLng;
            /** Min lat/long pair. */
            minLatLng?: LatLng;
        ...
        interface GoogleCloudVisionV1p1beta1ProductSearchParams {
        ...
        interface GoogleCloudVisionV1p1beta1TextDetectionParams {
        ...
        interface GoogleCloudVisionV1p1beta1WebDetectionParams {
        ...
        interface FilesResource {
            ...
            annotate(request: {
                ...
                uploadType?: string;
                /** Request body */
                resource: GoogleCloudVisionV1p1beta1BatchAnnotateFilesRequest;
            ...
            body: GoogleCloudVisionV1p1beta1BatchAnnotateFilesRequest): Request<GoogleCloudVisionV1p1beta1BatchAnnotateFilesResponse>;
            /**
            ...
            asyncBatchAnnotate(request: {
                ...
                uploadType?: string;
                /** Request body */
                resource: GoogleCloudVisionV1p1beta1AsyncBatchAnnotateFilesRequest;
            }): Request<Operation>;
            asyncBatchAnnotate(request: {
                /** V1 error format. */
                "$.xgafv"?: string;
            ...
            body: GoogleCloudVisionV1p1beta1AsyncBatchAnnotateFilesRequest): Request<Operation>;
        }
        interface ImagesResource {
            ...
            annotate(request: {
                ...
                uploadType?: string;
                /** Request body */
                resource: GoogleCloudVisionV1p1beta1BatchAnnotateImagesRequest;
            ...
            body: GoogleCloudVisionV1p1beta1BatchAnnotateImagesRequest): Request<GoogleCloudVisionV1p1beta1BatchAnnotateImagesResponse>;
            /**
            ...
            asyncBatchAnnotate(request: {
                ...
                uploadType?: string;
                /** Request body */
                resource: GoogleCloudVisionV1p1beta1AsyncBatchAnnotateImagesRequest;
            }): Request<Operation>;
            asyncBatchAnnotate(request: {
                /** V1 error format. */
                "$.xgafv"?: string;
            ...
            body: GoogleCloudVisionV1p1beta1AsyncBatchAnnotateImagesRequest): Request<Operation>;
        }
        interface FilesResource {
            /**
             * Service that performs image detection and annotation for a batch of files. Now only "application/pdf", "image/tiff" and "image/gif" are supported. This service will extract at most
