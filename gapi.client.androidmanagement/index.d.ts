...
declare namespace gapi.client {
    ...
    namespace androidmanagement {
        ...
        interface SigninDetail {
             ...
             * a URL in the form of https://enterprise.google.com/android/enroll?et=<token> for a successful login, or
        ...
        interface UserFacingMessage {
            ...
            /**
             * A map containing <locale, message> pairs, where locale is a well-formed BCP 47 language (https://www.w3.org/International/articles/language-tags/)
        ...
        interface WebAppIcon {
            /**
             * The actual bytes of the image in a base64url encoded string (c.f. RFC4648, section 5 "Base 64 Encoding with URL and Filename Safe Alphabet"). <ul>
             * <li>The image type can be png or jpg. <li>The image should ideally be square. <li>The image should ideally have a size of 512x512. </ul>
             */
            imageData?: string;
        }
        interface WebToken {
             ...
             * things to note: <ul> <li> If no features are listed here, all features are enabled — this is the  default behavior where you give access to all
             * features to your admins. <li> This must not contain any FEATURE_UNSPECIFIED values. <li> Repeated values are ignored </ul>
             */
        ...
        interface DevicesResource {
            ...
            delete(request?: {
                ...
                /**
                 * Optional short message displayed to the user before wiping the work profile on personal devices. This has no effect on company owned devices. The
