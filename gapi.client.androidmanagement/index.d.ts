...
declare namespace gapi.client {
    ...
    namespace androidmanagement {
        ...
        interface Policy {
            ...
            /**
             * Password requirements. The field password_requirements.require_password_unlock must not be set. DEPRECATED - Use password_policies.Note:Complexity-based values of PasswordQuality,
             * that is, COMPLEXITY_LOW, COMPLEXITY_MEDIUM, and COMPLEXITY_HIGH, cannot be used here.
             */
