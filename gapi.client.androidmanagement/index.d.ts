...
declare namespace gapi.client {
    ...
    namespace androidmanagement {
        ...
        interface ExtensionConfig {
            ...
            /**
             * Hex-encoded SHA256 hash of the signing certificate of the extension app. Only hexadecimal string representations of 64 characters are valid.If not specified, the signature for the
        ...
        interface PasswordRequirements {
            ...
            /**
             * Controls whether a unified lock is allowed for the device and the work profile, on devices running Android 9 and above with a work profile. This has no effect on other devices. This
             * can be set only if password_scope is set to SCOPE_PROFILE, the policy will be rejected otherwise. If user has not set a separate work lock and this field is set to
