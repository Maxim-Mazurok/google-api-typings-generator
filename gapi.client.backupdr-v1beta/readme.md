# TypeScript typings for Backup and DR Service API v1beta
...
```
npm install @types/gapi.client.backupdr-v1beta --save-dev
```
...
gapi.client.load('backupdr', 'v1beta', () => {
  // now we can use:
  // gapi.client.backupdr
});
```
...
For provenance information see [Provenance section on NPM](https://www.npmjs.com/package/@maxim_mazurok/gapi.client.backupdr-v1beta#Provenance:~:text=none-,Provenance,-Built%20and%20signed)
