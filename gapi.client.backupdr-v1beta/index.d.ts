/* Type definitions for non-npm package Backup and DR Service API v1beta 0.0 */
...
// Generated from: https://backupdr.googleapis.com/$discovery/rest?version=v1beta
// Revision: 20260826

/// <reference types="gapi.client" />

declare namespace gapi.client {
  /** Load Backup and DR Service API v1beta */
  function load(
    urlOrObject: 'https://backupdr.googleapis.com/$discovery/rest?version=v1beta',
  ): Promise<void>;
  /** @deprecated Please load APIs with discovery documents. */
  function load(name: 'backupdr', version: 'v1beta'): Promise<void>;
  /** @deprecated Please load APIs with discovery documents. */
  function load(name: 'backupdr', version: 'v1beta', callback: () => any): void;
  ...
  namespace backupdr {
    ...
    interface AppliedAutoProtectionPolicy {
      ...
      backupPlanDetails?: BackupPlanDetail[];
    ...
    interface AutoProtectionDetails {
    ...
    interface AutoProtectionPolicy {
    ...
    interface AutoProtectionPolicyBinding {
    ...
    interface BindingEvaluationSummary {
    ...
    interface BindingMatchingResource {
    ...
    interface Criteria {
      ...
      matchingConditions?: MatchingCondition[];
    }
    ...
    interface GoogleCloudBackupdrV1betaOperationMetadata {
    ...
    interface InitiateDeleteAutoProtectionPolicyBindingRequest {}
    ...
    interface ListAppliedAutoProtectionPoliciesResponse {
      /** A list of the AppliedAutoProtectionPolicy resources found. */
      appliedAutoProtectionPolicies?: AppliedAutoProtectionPolicy[];
      /** A token that can be sent as `page_token` to retrieve the next page. */
      nextPageToken?: string;
      /** Unordered list. Locations that could not be reached. */
      unreachable?: string[];
    }
    interface ListAutoProtectionPoliciesResponse {
      /** A list of the AutoProtectionPolicy resources found. */
      autoProtectionPolicies?: AutoProtectionPolicy[];
      /** A token that can be sent as `page_token` to retrieve the next page. If this field is omitted, there are no subsequent pages. */
      nextPageToken?: string;
      /** Locations that could not be reached. */
      unreachable?: string[];
    }
    interface ListAutoProtectionPolicyBindingsResponse {
      /** A list of the AutoProtectionPolicyBindings resources found. */
      autoProtectionPolicyBindings?: AutoProtectionPolicyBinding[];
      /** A token that can be sent as `page_token` to retrieve the next page. If this field is omitted, there are no subsequent pages. */
      nextPageToken?: string;
      /** Unordered list. Locations that could not be reached. */
      unreachable?: string[];
    ...
    interface ListBindingMatchingResourcesResponse {
      /** The list of `BindingMatchingResources` in the project,location for the specified binding. */
      matchingResources?: BindingMatchingResource[];
    ...
    interface AppliedAutoProtectionPoliciesResource {
      ...
      list(request?: {
        ...
        /** Legacy upload protocol for media (e.g. "media", "multipart"). */
        uploadType?: string;
      }): Request<ListAppliedAutoProtectionPoliciesResponse>;
    }
    interface MatchingResourcesResource {
      ...
      get(request?: {
        ...
        /** Legacy upload protocol for media (e.g. "media", "multipart"). */
        uploadType?: string;
      }): Request<BindingMatchingResource>;
      ...
      list(request?: {
        ...
        /** Legacy upload protocol for media (e.g. "media", "multipart"). */
        uploadType?: string;
      }): Request<ListBindingMatchingResourcesResponse>;
    }
    interface BindingsResource {
      ...
      initiateDelete(request: {
        ...
        uploadType?: string;
        /** Request body */
        resource: InitiateDeleteAutoProtectionPolicyBindingRequest;
      }): Request<Operation>;
      initiateDelete(
        request: {
          /** V1 error format. */
      ...
      list(request?: {
        ...
        /** Legacy upload protocol for media (e.g. "media", "multipart"). */
        uploadType?: string;
      }): Request<ListAutoProtectionPolicyBindingsResponse>;
      matchingResources: MatchingResourcesResource;
    }
    interface AutoProtectionPoliciesResource {
      ...
      list(request?: {
        ...
        /** Legacy upload protocol for media (e.g. "media", "multipart"). */
        uploadType?: string;
      }): Request<ListAutoProtectionPoliciesResponse>;
    ...
    interface LocationsResource {
      ...
      appliedAutoProtectionPolicies: AppliedAutoProtectionPoliciesResource;
      autoProtectionPolicies: AutoProtectionPoliciesResource;
