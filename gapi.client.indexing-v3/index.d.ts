/* Type definitions for non-npm package Web Search Indexing API v3 0.0 */
...
declare namespace gapi.client {
    ...
    function load(urlOrObject: "https://indexing.googleapis.com/$discovery/rest?version=v3"): Promise<void>;
