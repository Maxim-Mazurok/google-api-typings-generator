...
gapi.load('client', async () => {
    ...
    async function run() {
        ...
        /**
         * Lists the results of all functional test executions. The response includes the same information as the [execution
         * log](https://cloud.google.com/application-integration/docs/viewing-logs) in the Integration UI.
         */
        ...
        /** Delete the selected integration and all versions inside */
        await gapi.client.integrations.projects.locations.products.integrations.delete({
            name: "Test string",
        });
        /**
         * Executes integrations synchronously by passing the trigger id in the request body. The request is not returned until the requested executions are either fulfilled or experienced an
        ...
        await gapi.client.integrations.projects.locations.products.integrations.versions.testCases.list({
            filter: "Test string",
            orderBy: "Test string",
            pageSize: 42,
            pageToken: "Test string",
