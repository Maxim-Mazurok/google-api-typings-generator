...
declare namespace gapi.client {
  ...
  function load(
    urlOrObject: 'https://integrations.googleapis.com/$discovery/rest?version=v1alpha'
  ): Promise<void>;
  ...
  namespace integrations {
    ...
    interface GoogleCloudIntegrationsV1alphaAssertionResult {
    ...
    interface GoogleCloudIntegrationsV1alphaDownloadIntegrationVersionResponse {
      ...
      files?: GoogleCloudIntegrationsV1alphaSerializedFile[];
    }
    ...
    interface GoogleCloudIntegrationsV1alphaExecuteTestCaseResponse {
      ...
      assertionResults?: GoogleCloudIntegrationsV1alphaAssertionResult[];
      /** The id of the execution corresponding to this run of integration. */
      executionId?: string;
      /** OUTPUT parameters in format of Map. Where Key is the name of the parameter. Note: Name of the system generated parameters are wrapped by backtick(`) to distinguish them from the user defined parameters. */
      outputParameters?: {[P in string]: any};
      /** State of the test case execution */
      testExecutionState?: string;
    }
    ...
    interface GoogleCloudIntegrationsV1alphaListTestCasesResponse {
      ...
      testCases?: GoogleCloudIntegrationsV1alphaTestCase[];
    }
    ...
    interface GoogleCloudIntegrationsV1alphaPublishIntegrationVersionRequest {
      ...
      configParameters?: {[P in string]: any};
    }
    ...
    interface GoogleCloudIntegrationsV1alphaTestCase {
      ...
      /** Auto-generated. */
      updateTime?: string;
      /** ID of the workflow with which this test case is associated Deprecated. Please read the workflow_id from name or parent. */
      workflowId?: string;
    }
    ...
    interface TestCasesResource {
      ...
      create(request: {
        ...
        uploadType?: string;
        /** Request body */
        resource: GoogleCloudIntegrationsV1alphaTestCase;
      ...
      executeTest(request: {
        ...
        uploadType?: string;
        /** Request body */
        resource: GoogleCloudIntegrationsV1alphaExecuteTestCaseRequest;
