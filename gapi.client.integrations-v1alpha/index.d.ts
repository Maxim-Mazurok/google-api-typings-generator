...
declare namespace gapi.client {
    ...
    namespace integrations {
        ...
        interface GoogleCloudConnectorsV1ResourceRequests {
        ...
        interface GoogleCloudIntegrationsV1alphaAssertion {
        ...
        interface GoogleCloudIntegrationsV1alphaExecuteTestCaseRequest {
            /** Optional. Input parameters used by test case execution. */
            inputParameters?:
                { [P in string]: GoogleCloudIntegrationsV1alphaValueType };
        }
        interface GoogleCloudIntegrationsV1alphaExecuteTestCaseResponse {
            /** The id of the execution corresponding to this run of integration. */
            executionId?:
                string;
            /**
        ...
        interface GoogleCloudIntegrationsV1alphaListTestCaseExecutionsResponse {
            /** The detailed information of requested executions */
            executions?:
                GoogleCloudIntegrationsV1alphaExecution[];
            /** The token used to retrieve the next page results. */
        ...
        interface GoogleCloudIntegrationsV1alphaListTestCasesResponse {
            /** A token, which can be sent as `page_token` to retrieve the next page. If this field is omitted, there are no subsequent pages. */
            nextPageToken?:
                string;
        ...
        interface GoogleCloudIntegrationsV1alphaMockConfig {
        ...
        interface GoogleCloudIntegrationsV1alphaTestCase {
            /** Auto-generated. */
            createTime?:
                string;
            ...
            name?:
                string;
            /**
             * Optional. Parameters that are expected to be passed to the test case when the test case is triggered. This gives the user the ability to provide default values. This should include
             * all the output variables of the trigger as input variables.
             */
            testInputParameters?:
                GoogleCloudIntegrationsV1alphaIntegrationParameter[];
        ...
        interface GoogleCloudIntegrationsV1alphaTestTaskConfig {
            /**
             * Optional. List of conditions or expressions which should be evaluated to true unless there is a bug/problem in the integration. These are evaluated one the task execution is
             * completed as per the mock strategy in test case
             */
            assertions?:
        ...
        interface GoogleInternalCloudCrmEventbusV3PostToQueueWithTriggerIdRequest {
            ...
            triggerId?:
                string;
            /**
             * This is a unique id provided by the method caller. If provided this will be used as the execution_id when a new execution info is created. This is a string representation of a UUID.
        ...
        interface TestCasesResource {
            ...
            body: GoogleCloudIntegrationsV1alphaTestCase): Request<GoogleCloudIntegrationsV1alphaTestCase>;
            /** Deletes a test case */
            delete(request?: {
                /** V1 error format. */
                "$.xgafv"?:
            ...
            body: GoogleCloudIntegrationsV1alphaExecuteTestCaseRequest): Request<GoogleCloudIntegrationsV1alphaExecuteTestCaseResponse>;
            /** Get a test case */
            get(request?: {
                /** V1 error format. */
                "$.xgafv"?:
            ...
            listExecutions(request?: {
                ...
                fields?:
                    string;
                /**
                 * Optional. Standard filter field, we support filtering on following fields: test_case_id: the ID of the test case. CreateTimestamp: the execution created time.
                 * event_execution_state: the state of the executions. execution_id: the id of the execution. trigger_id: the id of the trigger. parameter_type: the type of the parameters involved
                 * in the execution. All fields support for EQUALS, in additional: CreateTimestamp support for LESS_THAN, GREATER_THAN ParameterType support for HAS For example: "parameter_type"
                 * HAS \"string\" Also supports operators like AND, OR, NOT For example, trigger_id=\"id1\" AND test_case_id=\"testCaseId\"
                 */
                filter?:
                    string;
                /** API key. Your API key identifies your project and provides you with API access, quota, and reports. Required unless you provide an OAuth 2.0 token. */
                ...
                uploadType?:
                    string;
            }): Request<GoogleCloudIntegrationsV1alphaListTestCaseExecutionsResponse>;
            /** Updates a test case */
            patch(request: {
                /** V1 error format. */
                "$.xgafv"?:
        ...
        interface TestCasesResource {
            ...
            list(request?: {
                ...
                oauth_token?:
                    string;
                /**
                 * Optional. The results would be returned in order specified here. Currently supported sort keys are: Descending sort order for "last_modified_time", "created_time". Ascending
                 * sort order for "name".
                 */
                orderBy?:
                    string;
                ...
                pageSize?:
                    number;
                /**
                 * Optional. A page token, received from a previous `ListTestCases` call. Provide this to retrieve the subsequent page. When paginating, all other parameters provided to
                ...
                uploadType?:
                    string;
            }): Request<GoogleCloudIntegrationsV1alphaListTestCasesResponse>;
        }
        interface VersionsResource {
            /** Create a integration with a draft version in the specified project. */
            create(request: {
