...
declare namespace gapi.client {
    ...
    namespace integrations {
        ...
        interface GoogleCloudIntegrationsV1alphaErrorCatcherConfig {
            ...
            /**
             * Required. An error catcher id is string representation for the error catcher config. Within a workflow, error_catch_id uniquely identifies an error catcher config among all error
