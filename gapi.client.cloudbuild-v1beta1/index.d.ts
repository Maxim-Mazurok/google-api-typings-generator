/* Type definitions for non-npm package Cloud Build API v1beta1 0.0 */
...
// Generated from: https://cloudbuild.googleapis.com/$discovery/rest?version=v1beta1
// Revision: 20220818

/// <reference types="gapi.client" />

declare namespace gapi.client {
    /** Load Cloud Build API v1beta1 */
    function load(urlOrObject: "https://cloudbuild.googleapis.com/$discovery/rest?version=v1beta1"): Promise<void>;
    /** @deprecated Please load APIs with discovery documents. */
    function load(name: "cloudbuild", version: "v1beta1"): Promise<void>;
    /** @deprecated Please load APIs with discovery documents. */
    function load(name: "cloudbuild", version: "v1beta1", callback: () => any): void;
    ...
    namespace cloudbuild {
        ...
        interface WorkerConfig {
            /**
             * Size of the disk attached to the worker, in GB. See [Worker pool config file](https://cloud.google.com/cloud-build/docs/custom-workers/worker-pool-config-file). Specify a value of
             * up to 1000. If `0` is specified, Cloud Build will use a standard disk size.
             */
            diskSizeGb?: string;
            /**
             * Machine type of a worker, such as `n1-standard-1`. See [Worker pool config file](https://cloud.google.com/cloud-build/docs/custom-workers/worker-pool-config-file). If left blank,
