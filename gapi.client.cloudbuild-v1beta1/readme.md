# TypeScript typings for Cloud Build API v1beta1
...
```
npm install @types/gapi.client.cloudbuild-v1beta1 --save-dev
```
...
```typescript
gapi.client.load('https://cloudbuild.googleapis.com/$discovery/rest?version=v1beta1', () => {
  // now we can use:
...
gapi.client.load('cloudbuild', 'v1beta1', () => {
  // now we can use:
  // gapi.client.cloudbuild
});
```
