    ...
    await gapi.client.jobs.projects.companies.create(
      ...
      },
      {
        company: {
          ...
          keywordSearchableJobCustomAttributes: ['Test string'],
          name: 'Test string',
          size: 'Test string',
          suspended: true,
      ...
      },
      {
        job: {
          ...
          customAttributes: {
            A: {
              filterable: true,
              longValues: ['Test string'],
              stringValues: ['Test string'],
            },
          },
          degreeTypes: ['Test string'],
          department: 'Test string',
          derivedInfo: {
            jobCategories: ['Test string'],
            locations: [
              {
                latLng: {
                  latitude: 42,
    ...
    await gapi.client.jobs.projects.jobs.search(
      ...
      },
      {
        ...
        histogramFacets: {
          ...
          simpleHistogramFacets: ['Test string'],
        },
        histogramQueries: [
          {
        ...
        jobQuery: {
          ...
          companyDisplayNames: ['Test string'],
          companyNames: ['Test string'],
          compensationFilter: {
