...
declare namespace gapi.client {
    ...
    namespace androidenterprise {
        ...
        interface WebApp {
             ...
             *
             * Possible values include:
             * - "minimalUi", the device's status bar, navigation bar, the app's URL, and a refresh button are visible when the app is open. For HTTP URLs, you can
             * only select this option.
             * - "standalone", the device's status bar and navigation bar are visible when the app is open.
             * - "fullScreen", the app opens in full screen mode, hiding the device's status and navigation bars. All browser UI elements, page URL, system status bar
             * and back button are not visible, and the web app takes up the entirety of the available display area.
             */
            displayMode?: string;
             ...
             *
             *
             * Note that the version can automatically increase during the lifetime of the web app, while Google does internal housekeeping to keep the web app
             * up-to-date.
             */
            versionCode?: string;
            /**
