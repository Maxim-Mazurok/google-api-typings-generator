...
*/
await gapi.client.devices.forceReportUpload({ deviceId: "deviceId", enterpriseId: "enterpriseId", userId: "userId",  });
...
*/
await gapi.client.devices.update({ deviceId: "deviceId", enterpriseId: "enterpriseId", userId: "userId",  });
...
*/
await gapi.client.managedconfigurationssettings.list({ enterpriseId: "enterpriseId", productId: "productId",  });
...
*/
await gapi.client.webapps.delete({ enterpriseId: "enterpriseId", webAppId: "webAppId",  });

/*
Gets an existing web app.
*/
await gapi.client.webapps.get({ enterpriseId: "enterpriseId", webAppId: "webAppId",  });

/*
Creates a new web app for the enterprise.
*/
await gapi.client.webapps.insert({ enterpriseId: "enterpriseId",  });
...
*/
await gapi.client.webapps.update({ enterpriseId: "enterpriseId", webAppId: "webAppId",  });
```
