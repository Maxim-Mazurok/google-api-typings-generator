...
declare namespace gapi.client {
  ...
  namespace youtube {
    ...
    interface AudioTrack {
      /** Etag of this resource. */
      etag?: string;
      /** The ID that YouTube uses to uniquely identify the AudioTrack. This could be a generated AudioTrack ID. */
      id?: string;
    ...
    interface ChannelToStoreLinkDetailsBillingDetails {
    ...
    interface ChannelToStoreLinkDetailsMerchantAffiliateProgramDetails {
    ...
    interface ListAudioTracksResponse {
    ...
    interface LiveBroadcastMonetizationDetails {
    ...
    interface PlaylistImageListResponse {
      items?: PlaylistImage[];
    ...
    interface PlaylistImageSnippet {
      /** The image height. */
      height?: number;
    ...
    interface ThirdPartyLinkListResponse {
      /** Etag of this resource. */
      etag?: string;
    ...
    interface VideoPaidProductPlacementDetails {
    ...
    interface MediaResource {
      ...
      upload(request: {
        ...
        /** OAuth 2.0 token for the current user. */
        oauth_token?: string;
        /** Optional. The `part` parameter specifies the `AudioTrack` resource parts that the API response will include. The `part` names that you can include in the parameter value are `id` and `snippet`. */
        part?: string | string[];
        /** Returns response with indentations and line breaks. */
        prettyPrint?: boolean;
        /** Available to use for quota purposes for server-side applications. Can be any arbitrary string assigned to a user, but should not exceed 40 characters. */
    ...
    interface PlaylistImagesResource {
      /** Deletes a resource. */
      delete(request?: {
        /** V1 error format. */
        '$.xgafv'?: '1' | '2';
      ...
      list(request?: {
        ...
        /** Legacy upload protocol for media (e.g. "media", "multipart"). */
        uploadType?: string;
      }): Request<PlaylistImageListResponse>;
      /** Updates an existing resource. */
      update(request: {
        /** V1 error format. */
        '$.xgafv'?: '1' | '2';
    ...
    interface ThirdPartyLinksResource {
      ...
      list(request?: {
        ...
        /** Legacy upload protocol for media (e.g. "media", "multipart"). */
        uploadType?: string;
      }): Request<ThirdPartyLinkListResponse>;
      /** Updates an existing resource. */
      update(request: {
        /** V1 error format. */
        '$.xgafv'?: '1' | '2';
    ...
    interface AudiotracksResource {
      ...
      list(request?: {
        ...
        /** OAuth 2.0 token for the current user. */
        oauth_token?: string;
        /** Optional. The `part` parameter specifies a comma-separated list of one or more `AudioTrack` resource parts that the API response will include. The `part` names that you can include in the parameter value are `id` and `snippet`. */
        part?: string | string[];
        /** Returns response with indentations and line breaks. */
        prettyPrint?: boolean;
        /** Available to use for quota purposes for server-side applications. Can be any arbitrary string assigned to a user, but should not exceed 40 characters. */
        ...
        /** Required. The external YouTube video ID. */
        videoId?: string;
      }): Request<ListAudioTracksResponse>;
    }
    ...
    interface V3Resource {
      ...
      audiotracks: AudiotracksResource;
    ...
    const playlistImages: PlaylistImagesResource;
    ...
    const videoTrainability: VideoTrainabilityResource;
