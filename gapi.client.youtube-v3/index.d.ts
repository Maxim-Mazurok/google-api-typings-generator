...
declare namespace gapi.client {
    ...
    function load(urlOrObject: "https://youtube.googleapis.com/$discovery/rest?version=v3"): Promise<void>;
    ...
    namespace youtube {
        ...
        interface Channel {
            ...
            localizations?:
                { [P in string]: ChannelLocalization };
            ...
            relatedPlaylists?:
                {
                    ...
                    likes?:
                        string;
                    /**
                     * The ID of the playlist that contains the channel"s uploaded videos. Use the videos.insert method to upload new videos and the videos.delete method to delete previously
                     * uploaded videos.
                     */
                    uploads?:
                        string;
        ...
        interface ChannelSection {
            ...
            /** Localizations for different languages */
            localizations?:
                { [P in string]: ChannelSectionLocalization };
        ...
        interface Playlist {
            ...
            /** Localizations for different languages */
            localizations?:
                { [P in string]: PlaylistLocalization };
        ...
        interface CommentsResource {
            ...
            setModerationStatus(request?: {
                 ...
                 * as 'likely spam'. Valid values: 'heldForReview', 'published' or 'rejected'.
                 */
                moderationStatus:
                    string;
                /** OAuth 2.0 token for the current user. */
        ...
        interface LiveBroadcastsResource {
            ...
            body: Cuepoint): Request<Cuepoint>;
        ...
        interface PlaylistImagesResource {
            ...
            body: PlaylistImage): Request<PlaylistImage>;
            /** Retrieves a list of resources, possibly filtered. */
            list(request?: {
                /** V1 error format. */
                "$.xgafv"?:
                ...
                parent?:
                    string;
                /**
                 * The *part* parameter specifies a comma-separated list of one or more playlistImage resource properties that the API response will include. If the parameter identifies a property
                 * that contains child properties, the child properties will be included in the response.
                 */
                part?:
                    string | string[];
                /** Returns response with indentations and line breaks. */
