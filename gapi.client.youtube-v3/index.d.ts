...
declare namespace gapi.client {
  ...
  namespace youtube {
    ...
    interface AvailabilityConfigGlobalConfig {
    ...
    interface AvailabilityConfigRegionsConfig {
      ...
      regionIntervals?: AvailabilityConfigRegionsConfigRegionInterval[];
    }
    interface AvailabilityConfigRegionsConfigRegionInterval {
    ...
    interface ChannelToAffiliateProgramLinkDetails {
