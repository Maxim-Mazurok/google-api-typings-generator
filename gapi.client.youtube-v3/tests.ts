...
gapi.load('client', async () => {
  ...
  async function run() {
      ...
      },
      {
        ...
        brandingSettings: {
          channel: {
            ...
            featuredChannelsUrls: ['Test string'],
        ...
        status: {
          isChannelMonetizationEnabled: true,
          isLinked: true,
      ...
      },
      {
        ...
        snippet: {
          ...
          giftDetails: {
            altText: 'Test string',
            comboCount: 42,
            giftDuration: 'Test string',
            giftName: 'Test string',
            giftUrl: 'Test string',
      ...
      },
      {
        ...
        contentDetails: {
          ...
          contentRating: {
            ...
            djctqRatingReasons: ['Test string'],
        ...
        suggestions: {
          editorSuggestions: ['Test string'],
          processingErrors: ['Test string'],
          processingHints: ['Test string'],
          processingWarnings: ['Test string'],
          tagSuggestions: [
            {
              categoryRestricts: ['Test string'],
              tag: 'Test string',
            },
          ],
        },
        topicDetails: {
          relevantTopicIds: ['Test string'],
          topicCategories: ['Test string'],
          topicIds: ['Test string'],
        },
      },
    ...
    await gapi.client.youtube.youtube.v3.deleteAudiotracks({
      audioTrackId: 'Test string',
      part: 'Test string',
      videoId: 'Test string',
    });
    /** Updates an existing resource. */
    ...
    await gapi.client.youtube.youtube.v3.audiotracks.list({
      language: 'Test string',
      part: 'Test string',
      videoId: 'Test string',
    });
    /** Allows a user to load live chat through a server-streamed RPC. */
    await gapi.client.youtube.youtube.v3.liveChat.messages.stream({
      hl: 'Test string',
      liveChatId: 'Test string',
      maxResults: 42,
      pageToken: 'Test string',
