...
```typescript
gapi.client.load('https://youtube.googleapis.com/$discovery/rest?version=v3', () => {
  // now we can use:
  // gapi.client.youtube
});
```
...
After that you can use YouTube Data API v3 resources: <!-- TODO: make this work for multiple namespaces -->
