...
declare namespace gapi.client {
  ...
  namespace connectors {
    interface AdminFilters {
      ...
      filterType?: 'FILTER_TYPE_UNSPECIFIED' | 'INCLUSION' | 'EXCLUSION';
    ...
    interface ConfigVariableTemplate {
      ...
      enumSource?: 'ENUM_SOURCE_UNSPECIFIED' | 'EVENT_TYPES_API';
    ...
    interface EgressControlConfig {
      ...
      accessMode?: 'ACCESS_MODE_UNSPECIFIED' | 'RESTRICTED' | 'ALLOW_ALL';
      ...
      allowlistedProjectNumbers?: string[];
    ...
    interface EndUserAuthentication {
      /** Optional. Config variables for the EndUserAuthentication. */
      configVariables?: EndUserAuthenticationConfigVariable[];
      /** Output only. Created time. */
      createTime?: string;
      ...
      roles?: 'ROLE_UNSPECIFIED' | 'READER' | 'READER_DOMAIN_WIDE_ACCESSIBLE'[];
    ...
    interface EndUserAuthenticationConfig {
      /** Optional. List containing additional auth configs. */
      additionalVariables?: EndUserAuthenticationConfigVariable[];
      /** Identifier key for auth config */
      authKey?: string;
      /** The type of authentication configured. */
      authType?:
    ...
    interface EndUserAuthenticationConfigOauth2AuthCodeFlow {
    ...
    interface EndUserAuthenticationConfigOauth2AuthCodeFlowGoogleManaged {
      /** Optional. Authorization code to be exchanged for access and refresh tokens. */
      authCode?: string;
      /** Auth Code Data */
      oauthTokenData?: OAuthTokenData;
    ...
    interface EndUserAuthenticationConfigOauth2ClientCredentials {
      /** The client identifier. */
      clientId?: string;
      /** Required. string value or secret version containing the client secret. */
      clientSecret?: EUASecret;
    }
    interface EndUserAuthenticationConfigOauth2JwtBearer {
    ...
    interface EndUserAuthenticationConfigOauth2JwtBearerJwtClaims {
    ...
    interface EndUserAuthenticationConfigSshPublicKey {
    ...
    interface EndUserAuthenticationConfigUserPassword {
      /** Required. string value or secret version reference containing the password. */
      password?: EUASecret;
      /** Username. */
      username?: string;
    }
    interface EndUserAuthenticationConfigVariable {
      /** Value is a bool. */
      boolValue?: boolean;
      /** Value is an integer */
      intValue?: string;
    ...
    interface EndUserAuthenticationEndUserAuthenticationStatus {
      /** Output only. Description of the state. */
      description?: string;
      /** Output only. State of Event Subscription resource. */
      state?: 'STATE_UNSPECIFIED' | 'ACTIVE' | 'ERROR';
    }
    interface EndUserAuthenticationNotifyEndpointDestination {
    ...
    interface EndUserAuthenticationNotifyEndpointDestinationEndPoint {
      /** Required. The URI of the Endpoint. */
      endpointUri?: string;
      /** Optional. List of Header to be added to the Endpoint. */
      headers?: EndUserAuthenticationNotifyEndpointDestinationEndPointHeader[];
    }
    interface EndUserAuthenticationNotifyEndpointDestinationEndPointHeader {
    ...
    interface EventSubscriptionDestination {
      ...
      type?: 'TYPE_UNSPECIFIED' | 'ENDPOINT' | 'GCS' | 'PUBSUB';
    }
    ...
    interface FetchConnectionToolspecOverrideRequest {
      /** Required. List of tools for which the tool spec override is to be generated. */
      toolNames?: ToolName[];
    }
    interface FetchConnectionToolspecOverrideResponse {
    ...
    interface FieldComparison {
      ...
      comparator?: 'COMPARATOR_UNSPECIFIED' | 'EQUALS' | 'NOT_EQUALS';
      /** Integer value */
      intValue?: string;
    ...
    interface GenerateConnectionToolspecOverrideRequest {
      /** Required. List of tools for which the tool spec override is to be generated. */
      toolNames?: ToolName[];
    }
    interface GenerateConnectionToolspecOverrideResponse {
      /** Toolspec overrides for the connection. */
      toolspecOverride?: ToolspecOverride;
    }
    interface Header {
    ...
    interface JsonSchema {
      ...
      default?: any;
      /** Definitions for the schema. */
      definitions?: {[P in string]: JsonSchema};
      /** Dependencies for the schema. */
      dependencies?: {[P in string]: any};
      ...
      patternProperties?: {[P in string]: JsonSchema};
    ...
    interface ListEndUserAuthenticationsResponse {
      /** Subscriptions. */
      endUserAuthentications?: EndUserAuthentication[];
      /** Next page token. */
      nextPageToken?: string;
      /** Locations that could not be reached. */
      unreachable?: string[];
    ...
    interface LogicalExpression {
      ...
      logicalOperator?: 'OPERATOR_UNSPECIFIED' | 'AND' | 'OR';
    }
    ...
    interface ModifyConnectionToolspecOverrideRequest {
      /** Required. Toolspec overrides to be modified. */
      toolspecOverride?: ToolspecOverride;
    }
    interface ModifyConnectionToolspecOverrideResponse {
      /** Toolspec overrides for the connection. */
    ...
    interface NetworkConfig {
      ...
      egressMode?: 'NETWORK_EGRESS_MODE_UNSPECIFIED' | 'AUTO_IP' | 'STATIC_IP';
    }
    interface NetworkEgressModeOverride {
    ...
    interface RemoveConnectionToolspecOverrideRequest {}
    ...
    interface RoleGrant {
      ...
      principal?: 'PRINCIPAL_UNSPECIFIED' | 'CONNECTOR_SA';
    ...
    interface SslConfigTemplate {
      ...
      sslType?: 'SSL_TYPE_UNSPECIFIED' | 'TLS' | 'MTLS';
    }
    ...
    interface EndUserAuthenticationsResource {
      ...
      create(request: {
        ...
        uploadType?: string;
        /** Request body */
        resource: EndUserAuthentication;
      }): Request<Operation>;
      create(
        request: {
          /** V1 error format. */
      ...
      list(request?: {
        ...
        /** Legacy upload protocol for media (e.g. "media", "multipart"). */
        uploadType?: string;
      }): Request<ListEndUserAuthenticationsResponse>;
    ...
    interface ConnectionsResource {
      ...
      fetchToolspecOverride(request: {
        ...
        uploadType?: string;
        /** Request body */
        resource: FetchConnectionToolspecOverrideRequest;
      }): Request<FetchConnectionToolspecOverrideResponse>;
      ...
      generateToolspecOverride(request: {
        /** V1 error format. */
        '$.xgafv'?: '1' | '2';
        /** OAuth access token. */
        access_token?: string;
        ...
        uploadType?: string;
        /** Request body */
        resource: GenerateConnectionToolspecOverrideRequest;
      }): Request<GenerateConnectionToolspecOverrideResponse>;
      ...
      get(request?: {
        ...
        view?: 'CONNECTION_VIEW_UNSPECIFIED' | 'BASIC' | 'FULL';
      }): Request<Connection>;
      ...
      modifyToolspecOverride(request: {
        /** V1 error format. */
        '$.xgafv'?: '1' | '2';
        /** OAuth access token. */
        access_token?: string;
        ...
        uploadType?: string;
        /** Request body */
        resource: ModifyConnectionToolspecOverrideRequest;
      }): Request<ModifyConnectionToolspecOverrideResponse>;
      ...
      removeToolspecOverride(request: {
        /** V1 error format. */
        '$.xgafv'?: '1' | '2';
        /** OAuth access token. */
        access_token?: string;
        ...
        uploadType?: string;
        /** Request body */
        resource: RemoveConnectionToolspecOverrideRequest;
      }): Request<{}>;
      ...
      endUserAuthentications: EndUserAuthenticationsResource;
