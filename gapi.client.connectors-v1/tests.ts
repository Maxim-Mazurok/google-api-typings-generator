  ...
  async function run() {
    ...
    await gapi.client.connectors.projects.locations.connections.create(
      ...
      },
      {
        adminFilters: [
          {
            filterKey: 'Test string',
            filterType: 'Test string',
            intValue: 'Test string',
            stringListValues: {
              listValues: ['Test string'],
            },
        ...
        eventingRuntimeData: {
          ...
          webhookData: {
            ...
            createTime: 'Test string',
            eventSubscriptions: ['Test string'],
    ...
    await gapi.client.connectors.projects.locations.connections.fetchToolspecOverride(
      {
        name: 'Test string',
      },
      {
