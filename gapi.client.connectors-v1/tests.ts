...
gapi.load('client', async () => {
    ...
    async function run() {
        ...
        await gapi.client.connectors.projects.locations.global.customConnectors.customConnectorVersions.delete({
            name: "Test string",
        });
        ...
        await gapi.client.connectors.projects.locations.global.customConnectors.customConnectorVersions.patch({
            name: "Test string",
            updateMask: "Test string",
        }, {
            authConfig: {
