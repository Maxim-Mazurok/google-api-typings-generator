...
gapi.load('client', async () => {
  ...
  async function run() {
    ...
    await gapi.client.bigtableadmin.projects.instances.create(
      ...
      },
      {
        ...
        instance: {
          ...
          edition: 'Test string',
          knowledgeCatalogRegion: 'Test string',
          labels: {
            A: 'Test string',
          },
          name: 'Test string',
    ...
    await gapi.client.bigtableadmin.projects.instances.clusters.getMemoryLayer({
      name: 'Test string',
    });
    ...
    await gapi.client.bigtableadmin.projects.instances.clusters.updateMemoryLayer(
      {
        name: 'Test string',
        updateMask: 'Test string',
      },
    ...
    await gapi.client.bigtableadmin.projects.instances.clusters.memoryLayers.list(
      {
        pageSize: 42,
        pageToken: 'Test string',
        parent: 'Test string',
    ...
    await gapi.client.bigtableadmin.projects.instances.tables.create(
      ...
      },
      {
        ...
        table: {
          ...
          columnFamilies: {
            A: {
              ...
              stats: {
                ...
                logicalDataHddBytes: 'Test string',
                logicalDataSsdBytes: 'Test string',
              },
              valueType: {
                aggregateType: {
                  hllppUniqueCount: {},
                ...
                dateType: {},
                enumType: {
                  enumName: 'Test string',
                  schemaBundleId: 'Test string',
                },
                float32Type: {},
                float64Type: {},
                geographyType: {},
          ...
          tieredStorageConfig: {
            infrequentAccess: {
              includeIfOlderThan: 'Test string',
            },
          },
        },
        tableId: 'Test string',
    ...
    await gapi.client.bigtableadmin.projects.instances.tables.schemaBundles.create(
      {
        parent: 'Test string',
        schemaBundleId: 'Test string',
      },
    ...
    await gapi.client.bigtableadmin.projects.instances.tables.schemaBundles.delete(
      {
        etag: 'Test string',
        name: 'Test string',
      },
    ...
    await gapi.client.bigtableadmin.projects.instances.tables.schemaBundles.get(
      {
        name: 'Test string',
      },
    );
    /** Gets the access control policy for a Bigtable resource. Returns an empty policy if the resource exists but does not have a policy set. */
    await gapi.client.bigtableadmin.projects.instances.tables.schemaBundles.getIamPolicy(
      {
        resource: 'Test string',
      },
      {
    ...
    await gapi.client.bigtableadmin.projects.instances.tables.schemaBundles.list(
      {
        pageSize: 42,
        pageToken: 'Test string',
        parent: 'Test string',
    ...
    await gapi.client.bigtableadmin.projects.instances.tables.schemaBundles.patch(
      {
        ignoreWarnings: true,
        name: 'Test string',
        updateMask: 'Test string',
    ...
    /** Sets the access control policy on a Bigtable resource. Replaces any existing policy. */
    await gapi.client.bigtableadmin.projects.instances.tables.schemaBundles.setIamPolicy(
      {
        resource: 'Test string',
      },
      {
    ...
    /** Returns permissions that the caller has on the specified Bigtable resource. */
    await gapi.client.bigtableadmin.projects.instances.tables.schemaBundles.testIamPermissions(
      {
        resource: 'Test string',
      },
      {
