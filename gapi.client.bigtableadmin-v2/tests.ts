...
gapi.load('client', async () => {
    ...
    async function run() {
        ...
        /** Gets the access control policy for a Table resource. Returns an empty policy if the resource exists but does not have a policy set. */
        await gapi.client.bigtableadmin.projects.instances.tables.views.getIamPolicy({
            resource: "Test string",
        }, {
            options: {
                requestedPolicyVersion: 42,
        ...
        /** Sets the access control policy on a Table resource. Replaces any existing policy. */
        await gapi.client.bigtableadmin.projects.instances.tables.views.setIamPolicy({
            resource: "Test string",
        }, {
            policy: {
                auditConfigs: [
        ...
        /** Returns permissions that the caller has on the specified table resource. */
        await gapi.client.bigtableadmin.projects.instances.tables.views.testIamPermissions({
            resource: "Test string",
        }, {
            permissions: [
                "Test string"
