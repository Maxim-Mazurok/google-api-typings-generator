...
declare namespace gapi.client {
  ...
  namespace bigtableadmin {
    ...
    interface Backup {
      ...
      backupType?: 'BACKUP_TYPE_UNSPECIFIED' | 'STANDARD' | 'HOT';
    ...
    interface CreateLogicalViewMetadata {
    ...
    interface CreateLogicalViewRequest {
    ...
    interface CreateMaterializedViewMetadata {
    ...
    interface CreateSchemaBundleMetadata {
      /** The time at which the operation failed or was completed successfully. */
      finishTime?: string;
    ...
    interface DataBoostReadLocalWrites {}
    ...
    interface GoogleBigtableAdminV2AuthorizedViewSubsetView {
      ...
      familySubsets?: {
        [P in string]: GoogleBigtableAdminV2AuthorizedViewFamilySubsets;
      };
      /** Row prefixes to be included in the AuthorizedView. To provide access to all rows, include the empty string as a prefix (""). */
      rowPrefixes?: string[];
    }
    interface GoogleBigtableAdminV2MaterializedViewClusterState {
      /** Output only. The state of the materialized view in this cluster. */
      replicationState?: 'STATE_NOT_KNOWN' | 'INITIALIZING' | 'READY';
    }
    interface GoogleBigtableAdminV2MemoryLayerMemoryConfig {
    ...
    interface GoogleBigtableAdminV2TypeAggregateHyperLogLogPlusPlusUniqueCount {}
    interface GoogleBigtableAdminV2TypeAggregateMax {}
    interface GoogleBigtableAdminV2TypeAggregateMin {}
    interface GoogleBigtableAdminV2TypeAggregateSum {}
    ...
    interface GoogleBigtableAdminV2TypeDate {}
    ...
    interface GoogleBigtableAdminV2TypeFloat32 {}
    interface GoogleBigtableAdminV2TypeFloat64 {}
    interface GoogleBigtableAdminV2TypeGeography {}
    interface GoogleBigtableAdminV2TypeInt32 {
      /** The encoding to use when converting to or from lower level types. */
    ...
    interface GoogleBigtableAdminV2TypeInt32EncodingBigEndianBytes {}
    interface GoogleBigtableAdminV2TypeInt32EncodingOrderedCodeBytes {}
    interface GoogleBigtableAdminV2TypeInt64 {
      /** The encoding to use when converting to or from lower level types. */
    ...
    interface GoogleBigtableAdminV2TypeString {
      /** The encoding to use when converting to or from lower level types. */
      encoding?: GoogleBigtableAdminV2TypeStringEncoding;
    }
    interface GoogleBigtableAdminV2TypeStringEncoding {
    ...
    interface GoogleBigtableAdminV2TypeStringEncodingUtf8Raw {}
    ...
    interface GoogleBigtableAdminV2TypeStructEncoding {
    ...
    interface GoogleBigtableAdminV2TypeStructEncodingDelimitedBytes {
    ...
    interface GoogleBigtableAdminV2TypeStructEncodingOrderedCodeBytes {}
    interface GoogleBigtableAdminV2TypeStructEncodingSingleton {}
    ...
    interface ListSchemaBundlesResponse {
      /** A token, which can be sent as `page_token` to retrieve the next page. If this field is omitted, there are no subsequent pages. */
      nextPageToken?: string;
      /** The schema bundles from the specified table. */
      schemaBundles?: SchemaBundle[];
    }
    ...
    interface MaterializedView {
      ...
      clusterStates?: {
        [P in string]: GoogleBigtableAdminV2MaterializedViewClusterState;
      };
    ...
    interface Table {
      ...
      granularity?: 'TIMESTAMP_GRANULARITY_UNSPECIFIED' | 'MILLIS' | 'MICROS';
    ...
    interface UpdateAuthorizedViewRequest {
    ...
    interface UpdateLogicalViewMetadata {
      /** DEPRECATED: Use finish_time instead. */
      endTime?: string;
      /** The time at which the operation failed or was completed successfully. */
      finishTime?: string;
    ...
    interface UpdateLogicalViewRequest {
    ...
    interface UpdateMemoryLayerMetadata {
      /** The time at which the operation failed or was completed successfully. */
      finishTime?: string;
    ...
    interface UpdateMemoryLayerRequest {
    ...
    interface UpdateSchemaBundleMetadata {
      /** The time at which the operation failed or was completed successfully. */
      finishTime?: string;
      /** The unique name identifying this schema bundle. Values are of the form `projects/{project}/instances/{instance}/tables/{table}/schemaBundles/{schema_bundle}` */
      name?: string;
    ...
    interface MemoryLayersResource {
      ...
      list(request?: {
        ...
        /** Legacy upload protocol for media (e.g. "media", "multipart"). */
        uploadType?: string;
      }): Request<ListMemoryLayersResponse>;
    }
    interface ClustersResource {
      ...
      memoryLayers: MemoryLayersResource;
    }
    interface LogicalViewsResource {
      ...
      list(request?: {
        ...
        /** Legacy upload protocol for media (e.g. "media", "multipart"). */
        uploadType?: string;
      }): Request<ListLogicalViewsResponse>;
    ...
    interface MaterializedViewsResource {
      ...
      list(request?: {
        ...
        view?: 'VIEW_UNSPECIFIED' | 'SCHEMA_VIEW' | 'REPLICATION_VIEW' | 'FULL';
      }): Request<ListMaterializedViewsResponse>;
    ...
    interface AuthorizedViewsResource {
      ...
      list(request?: {
        ...
        view?: 'RESPONSE_VIEW_UNSPECIFIED' | 'NAME_ONLY' | 'BASIC' | 'FULL';
      }): Request<ListAuthorizedViewsResponse>;
    ...
    interface SchemaBundlesResource {
      ...
      list(request?: {
        ...
        view?:
          'SCHEMA_BUNDLE_VIEW_UNSPECIFIED' | 'NAME_ONLY' | 'BASIC' | 'FULL';
      }): Request<ListSchemaBundlesResponse>;
    ...
    interface TablesResource {
      ...
      schemaBundles: SchemaBundlesResource;
    }
    interface InstancesResource {
      ...
      logicalViews: LogicalViewsResource;
      materializedViews: MaterializedViewsResource;
