...
declare namespace gapi.client {
    ...
    namespace classroom {
        ...
        interface Course {
             ...
             * asynchronously when the course is set to `CourseState.ACTIVE` for the first time (at creation time or when it is updated to `ACTIVE` through the UI or the API). The Calendar ID will
