...
declare namespace gapi.client {
  ...
  namespace classroom {
    ...
    interface AddOnAttachmentStudentSubmission {
      ...
      /** Identifier for the student that owns this submission. Requires the user to be a teacher in the course and have permission to read student submissions. */
      userId?: string;
    }
    ...
    interface ListStudentGroupMembersResponse {
      /** Token identifying the next page of results to return. If empty, no further results are available. */
      nextPageToken?: string;
      /** The student group members. */
      studentGroupMembers?: StudentGroupMember[];
    }
    interface ListStudentGroupsResponse {
      /** Token identifying the next page of results to return. If empty, no further results are available. */
      nextPageToken?: string;
      /** The student groups. */
    ...
    interface StudentGroupMembersResource {
      ...
      list(request?: {
        ...
        /** Legacy upload protocol for media (e.g. "media", "multipart"). */
        uploadType?: string;
      }): Request<ListStudentGroupMembersResponse>;
    }
    interface StudentGroupsResource {
      ...
      list(request?: {
        ...
        /** Legacy upload protocol for media (e.g. "media", "multipart"). */
        uploadType?: string;
      }): Request<ListStudentGroupsResponse>;
      ...
      studentGroupMembers: StudentGroupMembersResource;
    }
    ...
    interface CoursesResource {
      ...
      posts: PostsResource;
      studentGroups: StudentGroupsResource;
