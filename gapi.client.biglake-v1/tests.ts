...
gapi.load('client', async () => {
  ...
  async function run() {
    ...
    await gapi.client.biglake.projects.catalogs.getIamPolicy({
      'options.requestedPolicyVersion': 42,
      resource: 'Test string',
    });
    /** Sets the IAM policy for the specified catalog. */
    await gapi.client.biglake.projects.catalogs.setIamPolicy(
      {
        resource: 'Test string',
      },
      {
    ...
    await gapi.client.biglake.projects.catalogs.testIamPermissions(
      {
        resource: 'Test string',
      },
      {
    ...
    /** Gets the IAM policy for the specified Catalog. */
    await gapi.client.biglake.projects.catalogs.namespaces.getIamPolicy({
      'options.requestedPolicyVersion': 42,
      resource: 'Test string',
    });
    /** Sets the IAM policy for the specified catalog. */
    await gapi.client.biglake.projects.catalogs.namespaces.setIamPolicy(
      {
        resource: 'Test string',
      },
      {
    ...
    await gapi.client.biglake.projects.catalogs.namespaces.testIamPermissions(
      {
        resource: 'Test string',
      },
      {
    ...
    /** Gets the IAM policy for the specified Catalog. */
    await gapi.client.biglake.projects.catalogs.namespaces.tables.getIamPolicy({
      'options.requestedPolicyVersion': 42,
      resource: 'Test string',
    });
    /** Sets the IAM policy for the specified catalog. */
    await gapi.client.biglake.projects.catalogs.namespaces.tables.setIamPolicy(
      {
        resource: 'Test string',
      },
      {
    ...
    await gapi.client.biglake.projects.catalogs.namespaces.tables.testIamPermissions(
      {
        resource: 'Test string',
      },
      {
