...
declare namespace gapi.client {
  ...
  namespace developerknowledge {
    ...
    interface AnswerQueryRequest {
      /** Required. The query to answer. */
      query?: string;
    }
    interface AnswerQueryResponse {
    ...
    interface DocumentsResource {
      ...
      searchDocumentChunks(request?: {
        ...
        /** OAuth 2.0 token for the current user. */
        oauth_token?: string;
        /** Optional. Specifies the maximum number of results to return. The service may return fewer than this value. If unspecified, at most 5 results will be returned. The maximum value is 100; values above 100 will result in an INVALID_ARGUMENT error. */
        pageSize?: number;
    ...
    interface V1alphaResource {
      ...
      answerQuery(request: {
        ...
        uploadType?: string;
        /** Request body */
        resource: AnswerQueryRequest;
      }): Request<AnswerQueryResponse>;
      answerQuery(
        request: {
          /** V1 error format. */
          '$.xgafv'?: '1' | '2';
