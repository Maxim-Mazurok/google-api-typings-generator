# TypeScript typings for Bare Metal Solution API v1alpha1
...
```
npm install @types/gapi.client.baremetalsolution-v1alpha1 --save-dev
```
...
```typescript
gapi.client.load('https://baremetalsolution.googleapis.com/$discovery/rest?version=v1alpha1', () => {
  // now we can use:
...
gapi.client.load('baremetalsolution', 'v1alpha1', () => {
  // now we can use:
  // gapi.client.baremetalsolution
});
```
