/* Type definitions for non-npm package Fact Check Tools API v1alpha1 0.0 */
...
declare namespace gapi.client {
    ...
    function load(urlOrObject: "https://factchecktools.googleapis.com/$discovery/rest?version=v1alpha1"): Promise<void>;
