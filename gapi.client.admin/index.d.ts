...
declare namespace gapi.client {
    ...
    namespace admin {
        ...
        interface Activity {
            ...
            events?: Array<{
                /**
                 * Name of the event. This is the specific name of the activity reported by the API. And each `eventName` is related to a specific G Suite service or feature which the API
                ...
                /**
                 * Type of event. The G Suite service or feature that an administrator changes is identified in the `type` property which identifies an event using the `eventName` property. For a
                 * full list of the API's `type` categories, see the list of event names for various applications above in `applicationName`.
                 */
                type?: string;
            }>;
        ...
        interface ActivitiesResource {
            ...
            list(request?: {
                 ...
                 * When an administrator changes a Calendar setting, the API reports this activity in the Calendar Settings `type` and `eventName` parameters. For more information about
                 * `eventName` query strings and parameters, see the list of event names for various applications above in `applicationName`.
                 */
                eventName?: string;
