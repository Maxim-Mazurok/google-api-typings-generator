...
declare namespace gapi.client {
    ...
    namespace cloudidentity {
        ...
        interface GoogleAppsCloudidentityDevicesV1ClientState {
             ...
             * The suffix is any string the caller specifies. This string will be displayed verbatim in the administration console.
             */
            name?: string;
        ...
        interface ClientStatesResource {
            ...
            patch(request: {
                 ...
                 * your customer id. The suffix is any string the caller specifies. This string will be displayed verbatim in the administration console.
                 */
                name: string;
                /** OAuth 2.0 token for the current user. */
                oauth_token?: string;
