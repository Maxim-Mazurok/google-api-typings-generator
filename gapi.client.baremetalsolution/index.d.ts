...
declare namespace gapi.client {
    ...
    namespace baremetalsolution {
        ...
        interface Instance {
            ...
            createTime?: string;
            /** True if hyperthreading enabled for the instance, false otherwise. The default value is false. */
            hyperthreadingEnabled?: boolean;
            /** Labels as key value pairs. */
            labels?: { [P in string]: string };
            /** List of luns associated with this instance. */
            luns?: Lun[];
            /** The type of this Instance. [Available Instance types](https://cloud.google.com/bare-metal/docs/bms-planning#server_configurations) */
            machineType?: string;
            /**
        ...
        interface SnapshotReservationDetail {
            ...
            /**
             * The percent of reserved snapshot space on this Volume that is actually used by snapshot copies. This may be higher than 100% if snapshot copies are occupying more space than has
        ...
        interface Volume {
            /** The size, in GiB, that this Volume has expanded as a result of an auto grow policy. In the absence of auto-grow, the value is 0. */
            autoGrownSizeGib?: string;
            /**
             * The current size of this Volume, in GiB, including space reserved for snapshots. This size may be different than the requested size if the Volume has been configured with auto grow
             * or auto shrink.
             */
