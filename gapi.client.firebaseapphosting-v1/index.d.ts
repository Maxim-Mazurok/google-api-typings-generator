/* Type definitions for non-npm package Firebase App Hosting API v1 0.0 */
...
// Generated from: https://firebaseapphosting.googleapis.com/$discovery/rest?version=v1
// Revision: 20260205

/// <reference types="gapi.client" />

declare namespace gapi.client {
  /** Load Firebase App Hosting API v1 */
  function load(
    urlOrObject: 'https://firebaseapphosting.googleapis.com/$discovery/rest?version=v1',
  ): Promise<void>;
  /** @deprecated Please load APIs with discovery documents. */
  function load(name: 'firebaseapphosting', version: 'v1'): Promise<void>;
  /** @deprecated Please load APIs with discovery documents. */
  function load(
