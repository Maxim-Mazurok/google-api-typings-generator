# TypeScript typings for Firebase App Hosting API v1
...
```
npm install @types/gapi.client.firebaseapphosting-v1 --save-dev
```
...
```json
{
  "compilerOptions": {
    "types": [
      ...
      "gapi.auth2",
      "gapi.client",
      "gapi.client.firebaseapphosting-v1"
    ]
  }
}
```
...
gapi.client.load('firebaseapphosting', 'v1', () => {
  // now we can use:
  // gapi.client.firebaseapphosting
});
```
...
For provenance information see [Provenance section on NPM](https://www.npmjs.com/package/@maxim_mazurok/gapi.client.firebaseapphosting-v1#Provenance:~:text=none-,Provenance,-Built%20and%20signed)
