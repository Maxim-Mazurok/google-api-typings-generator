/* Type definitions for non-npm package GKE Hub API v2 0.0 */
...
// Generated from: https://gkehub.googleapis.com/$discovery/rest?version=v2
// Revision: 20260126
...
declare namespace gapi.client {
  /** Load GKE Hub API v2 */
  function load(
    urlOrObject: 'https://gkehub.googleapis.com/$discovery/rest?version=v2',
  ): Promise<void>;
  /** @deprecated Please load APIs with discovery documents. */
  function load(name: 'gkehub', version: 'v2'): Promise<void>;
  /** @deprecated Please load APIs with discovery documents. */
  function load(name: 'gkehub', version: 'v2', callback: () => any): void;
