/* This is stub file for gapi.client.people-v1 definition tests */
// IMPORTANT
    ...
    await gapi.client.people.contactGroups.create(
      {},
      {
        contactGroup: {
          ...
          memberCount: 42,
          memberResourceNames: ['Test string'],
          metadata: {
            deleted: true,
        ...
        contacts: [
          {
            contactPerson: {
              ...
              metadata: {
                deleted: true,
                linkedPeopleResourceNames: ['Test string'],
                objectType: 'Test string',
                previousResourceNames: ['Test string'],
                sources: [
                  {
                    etag: 'Test string',
                    id: 'Test string',
