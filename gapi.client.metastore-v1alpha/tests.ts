/* This is stub file for gapi.client.metastore-v1alpha definition tests */
// IMPORTANT
  ...
  async function run() {
    ...
    await gapi.client.metastore.projects.locations.services.create(
      ...
      },
      {
        ...
        multiRegionConfig: {
          ...
          customRegionConfig: {
            readOnlyRegions: ['Test string'],
            readWriteRegions: ['Test string'],
          },
        },
        name: 'Test string',
        network: 'Test string',
    ...
    await gapi.client.metastore.projects.locations.services.startMigration(
      ...
      },
      {
        migrationExecution: {
          biglakeMetastoreMigrationConfig: {
            backfillStatus: {
                    ...
                    databaseSummaries: [
                      {
                        ...
                        planAction: 'Test string',
                        resultStatus: 'Test string',
                        tableSummary: {
                          partitionDiscoveredCount: 'Test string',
                          partitionFailedCount: 'Test string',
                          partitionSuccessCount: 'Test string',
                          planCounts: {
                            A: 'Test string',
                          },
                          resultCounts: {
              ...
              reportPath: 'Test string',
              state: 'Test string',
            },
            conflictPolicy: 'Test string',
            dryRun: true,
            hiveConfig: {
              catalog: 'Test string',
        ...
        migrationExecutionId: 'Test string',
        requestId: 'Test string',
      },
    );
    /** Returns permissions that a caller has on the specified resource. If the resource does not exist, this will return an empty set of permissions, not a NOT_FOUND error.Note: This operation is designed to be used for building permission-aware UIs and command-line tools, not for authorization checking. This operation may "fail open" without warning. */
