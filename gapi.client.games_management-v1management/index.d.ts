/* Type definitions for non-npm package Google Play Games Services Management API v1management 0.0 */
...
declare namespace gapi.client {
  /** Load Google Play Games Services Management API v1management */
  function load(
