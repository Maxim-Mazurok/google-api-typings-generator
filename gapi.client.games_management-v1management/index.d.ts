...
declare namespace gapi.client {
    ...
    function load(urlOrObject: "https://gamesmanagement.googleapis.com/$discovery/rest?version=v1management"): Promise<void>;
    /** @deprecated Please load APIs with discovery documents. */
    function load(name: "gamesManagement", version: "v1management"): Promise<void>;
    /** @deprecated Please load APIs with discovery documents. */
