...
declare namespace gapi.client {
    ...
    namespace homegraph {
        ...
        interface Device {
            ...
            name?: DeviceNames;
            /**
             * See description for "traits". For Smart Home Entertainment Devices (SHED) devices, some traits can only be executed on 3P cloud, e.g. "non_local_traits": [ { "trait":
             * "action.devices.traits.MediaInitiation" }, { "trait": "action.devices.traits.Channel" } ] go/shed-per-trait-routing.
             */
            nonLocalTraits?: NonLocalTrait[];
            /**
        ...
        interface RequestLinkRequestPayload {
        ...
        interface DevicesResource {
            ...
            body: RequestLinkRequest): Request<{}>;
            /**
