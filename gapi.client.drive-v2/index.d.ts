...
declare namespace gapi.client {
  ...
  namespace drive {
    ...
    interface GenoaUser {
      ...
      customerId?: string;
      /** The domain name of this user or group. As per FlexOrgs M2 compliance, usage of domain is not allowed. This field will continue to exist/be populated with the organization's display name (which is not necessarily the domain) to support mobile clients that use this field for display purposes. For more information please see: b/133505341 */
      domain?: string;
      /** The sharing settings for the domain of this user or group. Deprecated, see go/trust-rules-api-surface */
      domainSharingSettings?: DomainSharingSettings;
      /** The email address of the user */
      emailAddress?: string;
      /** The primary email address of the user from GAIA. */
      emailAddressFromGaia?: string;
