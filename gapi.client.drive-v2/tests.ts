      ...
      },
      {
        ...
        genoaAuthor: {
          ...
          domainSharingSettings: {
            maxAllUsersRole: 'Test string',
            maxDomainRole: 'Test string',
            shareInPolicy: 'Test string',
            shareOutPolicy: 'Test string',
          },
          emailAddress: 'Test string',
          emailAddressFromGaia: 'Test string',
          id: 'Test string',
          isRequestingUser: true,
          name: 'Test string',
          organizationDisplayName: 'Test string',
          permissionId: 'Test string',
          photo: {
            height: 42,
            url: 'Test string',
