  ...
  async function run() {
    ...
    await gapi.client.firestore.projects.databases.create(
      ...
      },
      {
        ...
        etag: 'Test string',
        firestoreDataAccessMode: 'Test string',
        freeTier: true,
        keyPrefix: 'Test string',
        locationId: 'Test string',
        mongodbCompatibleDataAccessMode: 'Test string',
        name: 'Test string',
        pointInTimeRecoveryEnablement: 'Test string',
        previousId: 'Test string',
        realtimeUpdatesMode: 'Test string',
        sourceInfo: {
          backup: {
            backup: 'Test string',
          },
    ...
    await gapi.client.firestore.projects.databases.changeStreams.create(
      {
        changeStreamId: 'Test string',
        parent: 'Test string',
      },
      {
        collectionGroupScope: {
          collectionGroupId: 'Test string',
        },
        createTime: 'Test string',
        databaseScope: {},
        etag: 'Test string',
    ...
    await gapi.client.firestore.projects.databases.changeStreams.delete({
      etag: 'Test string',
      name: 'Test string',
    });
    /** Gets information about a change stream. */
    await gapi.client.firestore.projects.databases.changeStreams.get({
      name: 'Test string',
    });
    /** Lists all change streams in a database. */
    await gapi.client.firestore.projects.databases.changeStreams.list({
      parent: 'Test string',
    });
          ...
          indexes: [
            {
              ...
              searchIndexOptions: {
                textLanguage: 'Test string',
                textLanguageOverrideFieldPath: 'Test string',
              },
              shardCount: 42,
              state: 'Test string',
              unique: true,
                    ...
                    values: [
                      {
                        ...
                        doubleValue: 42,
                        fieldReferenceValue: 'Test string',
                        functionValue: {
                          args: undefined,
                          name: 'Test string',
                          options: undefined,
                        ...
                        variableReferenceValue: 'Test string',
                      },
                    ],
                  },
                  fieldPath: 'Test string',
    ...
    await gapi.client.firestore.projects.databases.documents.createDocument(
      {
        ...
        parent: 'Test string',
        'requestOptions.requestTags': 'Test string',
      },
      {
        createTime: 'Test string',
        fields: {
    ...
    await gapi.client.firestore.projects.databases.documents.executePipeline(
      {
        database: 'Test string',
      },
      {
