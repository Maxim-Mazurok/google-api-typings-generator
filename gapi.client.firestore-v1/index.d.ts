...
declare namespace gapi.client {
  ...
  namespace firestore {
    ...
    interface GoogleFirestoreAdminV1BackupSource {
    ...
    interface GoogleFirestoreAdminV1ChangeStream {
    ...
    interface GoogleFirestoreAdminV1CloneDatabaseRequest {
    ...
    interface GoogleFirestoreAdminV1CollectionGroupScope {
    ...
    interface GoogleFirestoreAdminV1DatabaseScope {}
    interface GoogleFirestoreAdminV1DeleteDatabaseMetadata {}
    interface GoogleFirestoreAdminV1DisableUserCredsRequest {}
    interface GoogleFirestoreAdminV1EnableUserCredsRequest {}
    ...
    interface GoogleFirestoreAdminV1ListBackupSchedulesResponse {
      ...
      backupSchedules?: GoogleFirestoreAdminV1BackupSchedule[];
    }
    interface GoogleFirestoreAdminV1ListBackupsResponse {
      /** List of all backups for the project. */
      backups?: GoogleFirestoreAdminV1Backup[];
    ...
    interface GoogleFirestoreAdminV1ListChangeStreamsResponse {
      /** The list of change streams. */
      changeStreams?: GoogleFirestoreAdminV1ChangeStream[];
    }
    ...
    interface GoogleFirestoreAdminV1ListUserCredsResponse {
      /** The user creds for the database. */
      userCreds?: GoogleFirestoreAdminV1UserCreds[];
    }
    ...
    interface GoogleFirestoreAdminV1ResetUserPasswordRequest {}
    interface GoogleFirestoreAdminV1ResourceIdentity {
    ...
    interface BackupSchedulesResource {
      ...
      create(request: {
        ...
        uploadType?: string;
        /** Request body */
        resource: GoogleFirestoreAdminV1BackupSchedule;
    ...
    interface ChangeStreamsResource {
      ...
      create(request: {
        ...
        uploadType?: string;
        /** Request body */
        resource: GoogleFirestoreAdminV1ChangeStream;
      }): Request<GoogleFirestoreAdminV1ChangeStream>;
      create(
        request: {
          /** V1 error format. */
          '$.xgafv'?: '1' | '2';
      ...
      list(request?: {
        ...
        /** Legacy upload protocol for media (e.g. "media", "multipart"). */
        uploadType?: string;
      }): Request<GoogleFirestoreAdminV1ListChangeStreamsResponse>;
    }
    ...
    interface UserCredsResource {
      ...
      create(request: {
        ...
        userCredsId?: string;
        /** Request body */
        resource: GoogleFirestoreAdminV1UserCreds;
      ...
      disable(request: {
        ...
        uploadType?: string;
        /** Request body */
        resource: GoogleFirestoreAdminV1DisableUserCredsRequest;
      }): Request<GoogleFirestoreAdminV1UserCreds>;
      disable(
        request: {
          /** V1 error format. */
      ...
      enable(request: {
        ...
        uploadType?: string;
        /** Request body */
        resource: GoogleFirestoreAdminV1EnableUserCredsRequest;
      }): Request<GoogleFirestoreAdminV1UserCreds>;
      enable(
        request: {
          /** V1 error format. */
      ...
      list(request?: {
        ...
        /** Legacy upload protocol for media (e.g. "media", "multipart"). */
        uploadType?: string;
      }): Request<GoogleFirestoreAdminV1ListUserCredsResponse>;
      ...
      resetPassword(request: {
        ...
        uploadType?: string;
        /** Request body */
        resource: GoogleFirestoreAdminV1ResetUserPasswordRequest;
      }): Request<GoogleFirestoreAdminV1UserCreds>;
      resetPassword(
        request: {
          /** V1 error format. */
    ...
    interface DatabasesResource {
      ...
      clone(request: {
        ...
        uploadType?: string;
        /** Request body */
        resource: GoogleFirestoreAdminV1CloneDatabaseRequest;
      }): Request<GoogleLongrunningOperation>;
      clone(
        request: {
          /** V1 error format. */
      ...
      restore(request: {
        ...
        uploadType?: string;
        /** Request body */
        resource: GoogleFirestoreAdminV1RestoreDatabaseRequest;
      }): Request<GoogleLongrunningOperation>;
      restore(
        request: {
          /** V1 error format. */
      ...
      changeStreams: ChangeStreamsResource;
      collectionGroups: CollectionGroupsResource;
      documents: DocumentsResource;
      operations: OperationsResource;
      userCreds: UserCredsResource;
    }
