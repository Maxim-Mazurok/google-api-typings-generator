...
declare namespace gapi.client {
  ...
  namespace threatintelligence {
    ...
    interface CustomThreatScenarioConfig {
    ...
    interface DocumentQuery {
      ...
      dataModel?: 'DATA_MODEL_UNSPECIFIED' | 'DATA_MODEL_GTI';
      /** Required. The query string. */
      query?: string;
      /** Required. The type of query. */
      queryType?: 'QUERY_TYPE_UNSPECIFIED' | 'QUERY_TYPE_LUCENE';
    }
    interface DomainConfiguration {
      /** Optional. A list of settings for individual domains. */
      domainSettings?: DomainSetting[];
    }
    interface DomainMonitoringFeatureConfig {
