...
declare namespace gapi.client {
    ...
    namespace displayvideo {
        ...
        interface FirstAndThirdPartyAudience {
             ...
             * set value must be greater than 0 and less than or equal to 540. Only applicable to first party audiences. This field is required for the following audience_type: *
