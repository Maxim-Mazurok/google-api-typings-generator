    ...
    namespace displayvideo {
        ...
        interface LineItemsResource {
            ...
            list(request?: {
                 ...
                 * be LESS THAN (<). * The operators used on all other fields must be `EQUALS (=)`. * Supported fields: - `campaignId` - `displayName` - `insertionOrderId` - `entityStatus` -
                 * `lineItemId` - `lineItemType` - `flight.dateRange.endDate` (input formatted as YYYY-MM-DD) Examples: * All line items under an insertion order: `insertionOrderId="1234"` * All
                 ...
                 * `flight.dateRange.endDate<"2019-03-28"` The length of this field should be no more than 500 characters.
                 */
                filter?: string;
                /** API key. Your API key identifies your project and provides you with API access, quota, and reports. Required unless you provide an OAuth 2.0 token. */
                key?: string;
        ...
        interface AdvertisersResource {
            ...
            list(request?: {
                 ...
                 * Supported fields: . - `advertiserId` . - `displayName` - `entityStatus` Examples: * All active advertisers under a partner: `entityStatus="ENTITY_STATUS_ACTIVE"` The length of
