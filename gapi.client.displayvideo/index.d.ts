    ...
    namespace displayvideo {
        ...
        interface LineItemsResource {
            ...
            list(request?: {
                 ...
                 * combined by `AND` or `OR` logical operators. A sequence of restrictions implicitly uses `AND`. &#42; A restriction has the form of `{field} {operator}
                 * {value}`. &#42; The operator must be `EQUALS (=)`. &#42; Supported fields: - `campaignId` - `insertionOrderId` - `entityStatus` - `lineItemType` Examples: &#42;
                 * All line items under an insertion order: `insertionOrderId="1234"` &#42; All `ENTITY_STATUS_ACTIVE` or `ENTITY_STATUS_PAUSED` and
                 ...
                 * lineItemType="LINE_ITEM_TYPE_DISPLAY_DEFAULT"` The length of this field should be no more than 500 characters.
                 */
                filter?: string;
                /** API key. Your API key identifies your project and provides you with API access, quota, and reports. Required unless you provide an OAuth 2.0 token. */
                key?: string;
