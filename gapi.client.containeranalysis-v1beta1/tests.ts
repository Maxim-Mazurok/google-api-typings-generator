...
gapi.load('client', async () => {
  ...
  async function run() {
    ...
    await gapi.client.containeranalysis.projects.locations.notes.batchCreate(
      {
        parent: 'Test string',
      },
      {
        notes: {
          A: {
            ...
            vulnerability: {
              advisoryPublishTime: 'Test string',
              cvssScore: 42,
              cvssV2: {
                attackComplexity: 'Test string',
                attackRequirements: 'Test string',
                ...
                exploitMaturity: 'Test string',
                impactScore: 42,
                integrityImpact: 'Test string',
                privilegesRequired: 'Test string',
                scope: 'Test string',
                subsequentSystemAvailabilityImpact: 'Test string',
                subsequentSystemConfidentialityImpact: 'Test string',
                subsequentSystemIntegrityImpact: 'Test string',
                userInteraction: 'Test string',
                vulnerableSystemAvailabilityImpact: 'Test string',
                vulnerableSystemConfidentialityImpact: 'Test string',
                vulnerableSystemIntegrityImpact: 'Test string',
              },
              cvssV3: {
                attackComplexity: 'Test string',
                attackVector: 'Test string',
    ...
    await gapi.client.containeranalysis.projects.locations.notes.getIamPolicy(
      {
    ...
    await gapi.client.containeranalysis.projects.locations.notes.patch(
      {
        name: 'Test string',
        ...
        occurrences: [
          {
            aiSkillAnalysis: {
              ...
              maxSeverity: 'Test string',
              perScannerVerdict: {
                maliciousContentLlmResult: {
                  maxSeverity: 'Test string',
                  modelId: 'Test string',
                  scanStatus: 'Test string',
                  tokenUsage: {
                    cacheCount: 'Test string',
                    candidateCount: 'Test string',
                    promptCount: 'Test string',
                    thinkingCount: 'Test string',
                    toolUsePromptCount: 'Test string',
                  },
                },
            ...
            discovered: {
              discovered: {
                ...
                lastVulnerabilityUpdateTime: 'Test string',
                sbomStatus: {
                  error: 'Test string',
    ...
    /** Gets the access control policy for a note or an occurrence resource. Requires `containeranalysis.notes.setIamPolicy` or `containeranalysis.occurrences.setIamPolicy` permission if the resource is a note or occurrence, respectively. The resource takes the format `projects/[PROJECT_ID]/notes/[NOTE_ID]` for notes and `projects/[PROJECT_ID]/occurrences/[OCCURRENCE_ID]` for occurrences. */
    await gapi.client.containeranalysis.projects.locations.occurrences.getIamPolicy(
      {
        resource: 'Test string',
      },
      {
    ...
    await gapi.client.containeranalysis.projects.locations.occurrences.patch(
      {
        name: 'Test string',
        updateMask: 'Test string',
      },
