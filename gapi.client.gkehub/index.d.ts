...
declare namespace gapi.client {
    ...
    namespace gkehub {
        ...
        interface PolicyControllerMembershipSpec {
            /** Policy Controller configuration for the cluster. */
            policyControllerHubConfig?: PolicyControllerPolicyControllerHubConfig;
        ...
        interface PolicyControllerMembershipState {
            ...
            policyControllerHubState?: PolicyControllerPolicyControllerHubState;
            /** The lifecycle state Policy Controller is in. */
            state?: string;
        }
        interface PolicyControllerPolicyControllerHubConfig {
            /** Sets the interval for Policy Controller Audit Scans (in seconds). When set to 0, this disables audit functionality altogether. */
            auditIntervalSeconds?: string;
            /** The set of namespaces that are excluded from Policy Controller checks. Namespaces do not need to currently exist on the cluster. */
            exemptableNamespaces?: string[];
        ...
        interface PolicyControllerPolicyControllerHubState {
            ...
            /** The version of Gatekeeper Policy Controller deployed. */
            version?: PolicyControllerPolicyControllerHubVersion;
        }
        interface PolicyControllerPolicyControllerHubVersion {
            /** The gatekeeper image tag that is composed of ACM version, git tag, build number. */
            version?: string;
        }
