...
declare namespace gapi.client {
  ...
  namespace healthcare {
    ...
    interface DicomNotificationConfig {
    ...
    interface FhirStore {
      ...
      version?: 'VERSION_UNSPECIFIED' | 'DSTU2' | 'STU3' | 'R4' | 'R5';
    }
    ...
    interface FhirStoresResource {
      ...
      bulkDelete(request: {
        ...
        uploadType?: string;
        /** Request body */
        resource: BulkDeleteResourcesRequest;
      }): Request<Operation>;
      bulkDelete(
        request: {
          /** V1 error format. */
