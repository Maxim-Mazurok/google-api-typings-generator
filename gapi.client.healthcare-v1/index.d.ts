...
declare namespace gapi.client {
  ...
  function load(
    urlOrObject: 'https://healthcare.googleapis.com/$discovery/rest?version=v1',
  ): Promise<void>;
  ...
  namespace healthcare {
    interface AccessDeterminationLogConfig {
    ...
    interface ApplyAdminConsentsRequest {
    ...
    interface ApplyAdminConsentsResponse {
    ...
    interface ApplyConsentsRequest {
    ...
    interface ApplyConsentsResponse {
    ...
    interface ConsentAccessorScope {
    ...
    interface DicomStore {
      ...
      streamConfigs?: GoogleCloudHealthcareV1DicomStreamConfig[];
    }
    ...
    interface ExplainDataAccessConsentInfo {
      ...
      matchingAccessorScopes?: ConsentAccessorScope[];
    ...
    interface ExplainDataAccessConsentScope {
      ...
      enforcingConsents?: ExplainDataAccessConsentInfo[];
      /** Other consent scopes that created exceptions within this scope. */
      exceptions?: ExplainDataAccessConsentScope[];
    }
    interface ExplainDataAccessResponse {
      ...
      consentScopes?: ExplainDataAccessConsentScope[];
    ...
    interface RollbackFhirResourceFilteringFields {
    ...
    interface RollbackFhirResourcesResponse {
    ...
    interface SearchResourcesRequest {
      /** Optional. The FHIR resource type to search, such as Patient or Observation. For a complete list, see the FHIR Resource Index ([DSTU2](https://hl7.org/fhir/DSTU2/resourcelist.html), [STU3](https://hl7.org/fhir/STU3/resourcelist.html), [R4](https://hl7.org/fhir/R4/resourcelist.html)). */
      resourceType?: string;
    }
    interface Segment {
    ...
    interface SetBlobStorageSettingsRequest {
    ...
    interface SetBlobStorageSettingsResponse {}
    ...
    interface StructuredStorageInfo {
    ...
    interface DataMapperWorkspacesResource {
      /** Gets the access control policy for a resource. Returns an empty policy if the resource exists and does not have a policy set. */
      getIamPolicy(request?: {
        /** V1 error format. */
        '$.xgafv'?: string;
    ...
    interface FhirResource {
      ...
      conditionalDelete(request?: {
        ...
        /** Available to use for quota purposes for server-side applications. Can be any arbitrary string assigned to a user, but should not exceed 40 characters. */
        quotaUser?: string;
        /** Required. The FHIR resource type to delete, such as Patient or Observation. For a complete list, see the FHIR Resource Index ([DSTU2](https://hl7.org/fhir/DSTU2/resourcelist.html), [STU3](https://hl7.org/fhir/STU3/resourcelist.html), [R4](https://hl7.org/fhir/R4/resourcelist.html)). */
        type: string;
        /** Upload protocol for media (e.g. "raw", "multipart"). */
        upload_protocol?: string;
        /** Legacy upload protocol for media (e.g. "media", "multipart"). */
      ...
      conditionalPatch(request: {
        ...
        /** Available to use for quota purposes for server-side applications. Can be any arbitrary string assigned to a user, but should not exceed 40 characters. */
        quotaUser?: string;
        /** Required. The FHIR resource type to update, such as Patient or Observation. For a complete list, see the FHIR Resource Index ([DSTU2](https://hl7.org/fhir/DSTU2/resourcelist.html), [STU3](https://hl7.org/fhir/STU3/resourcelist.html), [R4](https://hl7.org/fhir/R4/resourcelist.html)). */
        type: string;
        /** Upload protocol for media (e.g. "raw", "multipart"). */
        upload_protocol?: string;
        /** Legacy upload protocol for media (e.g. "media", "multipart"). */
      ...
      'Consent-enforcement-status'(request?: {
        /** V1 error format. */
        '$.xgafv'?: string;
        /** OAuth access token. */
        access_token?: string;
      ...
      'Patient-consent-enforcement-status'(request?: {
    ...
    interface OperationsResource {
      ...
      'get-fhir-operation-status'(request?: {
        /** V1 error format. */
        '$.xgafv'?: string;
        /** OAuth access token. */
        access_token?: string;
    ...
    interface FhirStoresResource {
      ...
      applyAdminConsents(request: {
        ...
        uploadType?: string;
        /** Request body */
        resource: ApplyAdminConsentsRequest;
      }): Request<Operation>;
      applyAdminConsents(
        request: {
          /** V1 error format. */
      ...
      explainDataAccess(request?: {
        ...
        /** Legacy upload protocol for media (e.g. "media", "multipart"). */
        uploadType?: string;
      }): Request<ExplainDataAccessResponse>;
      ...
      rollback(request: {
        ...
        uploadType?: string;
        /** Request body */
        resource: RollbackFhirResourcesRequest;
      }): Request<Operation>;
      rollback(
        request: {
          /** V1 error format. */
    ...
    interface DatasetsResource {
      ...
      dataMapperWorkspaces: DataMapperWorkspacesResource;
