    ...
    namespace cloudfunctions {
        ...
        interface OperationsResource {
            ...
            list(request?: {
                ...
                fields?: string;
                /**
                 * Required. A filter for matching the requested operations.<br><br> The supported formats of <b>filter</b> are:<br> To query for a specific function:
                 * <code>project:&#42;,location:&#42;,function:&#42;</code><br> To query for all of the latest operations for a project: <code>project:&#42;,latest:true</code>
                 */
                filter?: string;
                /** API key. Your API key identifies your project and provides you with API access, quota, and reports. Required unless you provide an OAuth 2.0 token. */
                key?: string;
                ...
                oauth_token?: string;
                /**
                 * The maximum number of records that should be returned.<br> Requested page size cannot exceed 100. If not set, the default page size is 100.<br><br>
                 * Pagination is only supported when querying for a specific function.
                 */
                pageSize?: number;
                /**
                 * Token identifying which result to start with, which is returned by a previous list call.<br><br> Pagination is only supported when querying for a
                 * specific function.
                 */
                pageToken?: string;
                /** Returns response with indentations and line breaks. */
