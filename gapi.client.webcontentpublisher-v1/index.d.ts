...
declare namespace gapi.client {
  ...
  namespace webcontentpublisher {
    ...
    interface GeneratePlatformSiteTokensRequest {}
    interface GeneratePlatformSiteTokensResponse {
    ...
    interface UsersResource {
      ...
      generatePlatformSiteTokens(request: {
        /** V1 error format. */
        '$.xgafv'?: '1' | '2';
        /** OAuth access token. */
        access_token?: string;
        ...
        uploadType?: string;
        /** Request body */
        resource: GeneratePlatformSiteTokensRequest;
      }): Request<GeneratePlatformSiteTokensResponse>;
