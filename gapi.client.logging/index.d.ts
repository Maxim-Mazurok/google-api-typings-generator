...
declare namespace gapi.client {
    ...
    namespace logging {
        ...
        interface LogView {
            ...
            name?: string;
            /** Describes the schema of the logs stored in the bucket that are accessible via this view.This field is only populated for views in analytics-enabled buckets. */
            schema?: TableSchema;
        ...
        interface TableFieldSchema {
            ...
            name?: string;
            /**
             * Required. The field data type. Possible values include: STRING INTEGER (or INT64) FLOAT (or FLOAT64) BOOLEAN (or BOOL) TIMESTAMP RECORD (or STRUCT)Use of RECORD/STRUT indicates that
