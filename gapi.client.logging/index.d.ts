...
declare namespace gapi.client {
    ...
    namespace logging {
        ...
        interface CopyLogEntriesMetadata {
             ...
             * operation will be cancelled. Example: "serviceAccount:foo@bar.com"
             */
        ...
        interface CopyLogEntriesRequest {
            ...
            filter?: string;
            /** Required. Bucket from which to copy logs. e.g. "projects/my-project/locations/my-location/buckets/my-source-bucket */
            name?: string;
        }
