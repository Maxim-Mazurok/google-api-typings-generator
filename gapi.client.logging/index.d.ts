...
declare namespace gapi.client {
    ...
    namespace logging {
        ...
        interface LogBucket {
            ...
            locked?: boolean;
            /**
             * Output only. The resource name of the bucket. For example: "projects/my-project-id/locations/my-location/buckets/my-bucket-id" The supported locations are: global, us-central1,
             * us-east1, us-west1, asia-east1, europe-west1.For the location of global it is unspecified where logs are actually stored. Once a bucket has been created, the location can not be
             * changed.
             */
            name?: string;
            /**
        ...
        interface LogEntry {
            ...
            /**
             * Optional. A set of user-defined (key, value) data that provides additional information about the log entry.Cloud Logging truncates label keys that exceed 512 B and label values that
             * exceed 64 KB upon their associated log entry being written. The truncation is indicated by an ellipsis at the end of the character string.
             */
            labels?: { [P in string]: string };
            /**
             ...
             * the labels field with a key prefix of k8s-pod/. The system labels that were present in the metadata.systemLabels field will no longer be available in the log entry.
             */
        ...
        interface ViewsResource {
            ...
            get(request?: {
                ...
                key?: string;
                /**
                 * Required. The resource name of the policy: "projects/[PROJECT_ID]/locations/[LOCATION_ID]/buckets/[BUCKET_ID]/views/[VIEW_ID]" Example:
        ...
        interface ViewsResource {
            ...
            create(request: {
                ...
                oauth_token?: string;
                /**
                 * Required. The bucket in which to create the view "projects/[PROJECT_ID]/locations/[LOCATION_ID]/buckets/[BUCKET_ID]" Example:
            ...
            delete(request?: {
                ...
                key?: string;
                /**
                 * Required. The full resource name of the view to delete: "projects/[PROJECT_ID]/locations/[LOCATION_ID]/buckets/[BUCKET_ID]/views/[VIEW_ID]" Example:
                 * "projects/my-project-id/locations/my-location/buckets/my-bucket-id/views/my-view-id".
                 */
                name: string;
                /** OAuth 2.0 token for the current user. */
        ...
        interface LogsResource {
            ...
            delete(request?: {
                 ...
                 * billingAccounts/[BILLING_ACCOUNT_ID]/logs/[LOG_ID] folders/[FOLDER_ID]/logs/[LOG_ID][LOG_ID] must be URL-encoded. For example, "projects/my-project-id/logs/syslog".For more
