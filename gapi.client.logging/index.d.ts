...
declare namespace gapi.client {
    ...
    namespace logging {
        ...
        interface LogSink {
             ...
             * For more information, see Exporting Logs with Sinks (https://cloud.google.com/logging/docs/api/tasks/exporting-logs).
             */
            destination?: string;
             ...
             * the resource owning the sink and that match the filter. For example:
        ...
        interface MetricDescriptor {
             ...
             * The maximum length of a label name is 100 characters.For example, the appengine.googleapis.com/http/server/response_latencies metric type has a label
             * for the HTTP response code, response_code, so you can look at latencies for successful responses or just for responses that failed.
             */
             ...
             * format of {service name}/{relative metric name}, such as cloudsql.googleapis.com/database/cpu/utilization. The relative metric name must follow:
             * Only upper and lower-case letters, digits, '/' and underscores '_' are  allowed.
             * The maximum number of characters allowed for the relative_metric_name is  100.All user-defined metric types have the DNS name custom.googleapis.com,
             * external.googleapis.com, or logging.googleapis.com/user/.Metric types should use a natural hierarchical grouping. For example:
        ...
        interface MonitoredResourceDescriptor {
             ...
             * Only upper and lower-case letters, digits and underscores (_) are  allowed.
             * Label name must start with a letter or digit.
             * The maximum length of a label name is 100 characters.For example, an individual Google Cloud SQL database is identified by values for the labels
             ...
             * The maximum number of characters allowed for the relative_resource_name  is 100.Note there are legacy service monitored resources not following this
             * rule.
             */
            type?: string;
        }
