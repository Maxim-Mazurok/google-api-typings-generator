...
declare namespace gapi.client {
    ...
    namespace logging {
        ...
        interface LogEntry {
            ...
            logName?: string;
            /**
             * Deprecated. Output only. Additional metadata about the monitored resource.Only k8s_container, k8s_pod, and k8s_node MonitoredResources have this field
             ...
             * 16-character hexadecimal encoding of an 8-byte array, such as <code>"000000000000004a"</code>.
             */
            spanId?: string;
        ...
        interface WriteLogEntriesRequest {
             ...
             * The permission <code>logging.logEntries.create</code> is needed on each project, organization, billing account, or folder that is receiving new log
             * entries, whether the resource is specified in <code>logName</code> or in an individual log entry.
             */
            logName?: string;
            /**
