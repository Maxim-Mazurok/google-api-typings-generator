    ...
    namespace logging {
        ...
        interface OrganizationsResource {
            ...
            updateCmekSettings(request: {
                 ...
                 * "billingAccounts/BILLING_ACCOUNT_ID/cmekSettings" "folders/FOLDER_ID/cmekSettings"Example: "organizations/12345/cmekSettings".Note: CMEK for the Logs Router can currently only
                 * be configured for GCP organizations. Once configured, it applies to all projects and folders in the GCP organization.
                 */
                name: string;
                /** OAuth 2.0 token for the current user. */
                oauth_token?: string;
