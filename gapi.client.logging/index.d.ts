...
declare namespace gapi.client {
    ...
    namespace logging {
        ...
        interface WriteLogEntriesRequest {
             ...
             * failed, then the response status is the response status is the status of one of the failed entries. The response will include error details keyed by the entries' zero-based index in
