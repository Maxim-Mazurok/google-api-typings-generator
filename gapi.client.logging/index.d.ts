...
declare namespace gapi.client {
    ...
    namespace logging {
        ...
        interface CmekSettings {
             ...
             * example:"projects/my-project/locations/us-central1/keyRings/my-ring/cryptoKeys/my-key"To enable CMEK for the Logs Router, set this field to a valid kms_key_name for which the
             ...
             * the Logs Router, set this field to an empty string.See Enabling CMEK for Logs Router (https://cloud.google.com/logging/docs/routing/managed-encryption) for more information.
             */
            kmsKeyName?: string;
            /** Output only. The resource name of the CMEK settings. */
            name?: string;
            /**
             * Output only. The service account that will be used by the Logs Router to access your Cloud KMS key.Before enabling CMEK for Logs Router, you must first assign the
             * cloudkms.cryptoKeyEncrypterDecrypter role to the service account that the Logs Router will use to access your Cloud KMS key. Use GetCmekSettings to obtain the service account ID.See
        ...
        interface CopyLogEntriesResponse {
        ...
        interface LogSink {
            ...
            updateTime?: string;
            /**
             * Output only. An IAM identity—a service account or group—under which Cloud Logging writes the exported log entries to the sink's destination. This field is set by sinks.create and
             ...
             * Consult the destination service's documentation to determine the appropriate IAM roles to assign to the identity.Sinks that have a destination that is a log bucket in the same
             * project as the sink do not have a writer_identity and no additional permissions are required.
             */
            writerIdentity?: string;
        }
        interface LogView {
        ...
        interface TailLogEntriesResponse {
        ...
        interface EntriesResource {
            ...
            copy(request: {
                ...
                uploadType?: string;
                /** Request body */
                resource: CopyLogEntriesRequest;
            }): Request<Operation>;
            copy(request: {
                /** V1 error format. */
                "$.xgafv"?: string;
            ...
            body: CopyLogEntriesRequest): Request<Operation>;
            /**
            ...
            tail(request: {
                ...
                uploadType?: string;
                /** Request body */
                resource: TailLogEntriesRequest;
        ...
        interface OrganizationsResource {
            /**
             * Gets the Logs Router CMEK settings for the given resource.Note: CMEK for the Logs Router can currently only be configured for Google Cloud organizations. Once configured, it applies
             * to all projects and folders in the Google Cloud organization.See Enabling CMEK for Logs Router (https://cloud.google.com/logging/docs/routing/managed-encryption) for more
             * information.
             */
            getCmekSettings(request?: {
                 ...
                 * "billingAccounts/[BILLING_ACCOUNT_ID]/cmekSettings" "folders/[FOLDER_ID]/cmekSettings" For example:"organizations/12345/cmekSettings"Note: CMEK for the Logs Router can currently
            ...
            /**
             * Updates the Logs Router CMEK settings for the given resource.Note: CMEK for the Logs Router can currently only be configured for Google Cloud organizations. Once configured, it
             ...
             * the required roles/cloudkms.cryptoKeyEncrypterDecrypter role assigned for the key, or 3) access to the key is disabled.See Enabling CMEK for Logs Router
