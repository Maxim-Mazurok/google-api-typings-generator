...
gapi.load('client', () => {
    ...
    async function run() {
        ...
        /** Gets a log bucket. */
        await gapi.client.logging.billingAccounts.buckets.get({
            name: "Test string",
        });
        /** Gets a view on a log bucket.. */
        await gapi.client.logging.billingAccounts.buckets.views.get({
            name: "Test string",
        });
        ...
        await gapi.client.logging.billingAccounts.operations.get({
            name: "Test string",
        });
        /**
