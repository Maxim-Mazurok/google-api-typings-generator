/* Type definitions for non-npm package Merchant API issueresolution_v1 0.0 */
...
declare namespace gapi.client {
  /** Load Merchant API issueresolution_v1 */
  function load(
    urlOrObject: 'https://merchantapi.googleapis.com/$discovery/rest?version=issueresolution_v1',
  ): Promise<void>;
