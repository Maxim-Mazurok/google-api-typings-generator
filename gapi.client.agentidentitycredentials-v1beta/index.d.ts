/* Type definitions for non-npm package Agent Identity Credentials API v1beta 0.0 */
...
// Generated from: https://agentidentitycredentials.googleapis.com/$discovery/rest?version=v1beta
// Revision: 20260717

/// <reference types="gapi.client" />

declare namespace gapi.client {
  /** Load Agent Identity Credentials API v1beta */
  function load(
    urlOrObject: 'https://agentidentitycredentials.googleapis.com/$discovery/rest?version=v1beta',
  ): Promise<void>;
  ...
  namespace agentidentitycredentials {
    interface GoogleCloudAgentidentitycredentialsV1beta_ConsentRejected {}
    interface GoogleCloudAgentidentitycredentialsV1beta_FinalizeCredentialsRequest {
    ...
    interface GoogleCloudAgentidentitycredentialsV1beta_FinalizeCredentialsResponse {}
    interface GoogleCloudAgentidentitycredentialsV1beta_Pending {}
    interface GoogleCloudAgentidentitycredentialsV1beta_RetrieveCredentialsRequest {
    ...
    interface GoogleCloudAgentidentitycredentialsV1beta_RetrieveCredentialsResponse {
    ...
    interface GoogleCloudAgentidentitycredentialsV1beta_Success {
    ...
    interface GoogleCloudAgentidentitycredentialsV1beta_UriConsentRequired {
    ...
    interface CredentialsResource {
      ...
      finalize(request: {
        ...
        uploadType?: string;
        /** Request body */
        resource: GoogleCloudAgentidentitycredentialsV1beta_FinalizeCredentialsRequest;
      }): Request<{}>;
      finalize(
        request: {
          /** V1 error format. */
      ...
      retrieve(request: {
        ...
        uploadType?: string;
        /** Request body */
        resource: GoogleCloudAgentidentitycredentialsV1beta_RetrieveCredentialsRequest;
      }): Request<GoogleCloudAgentidentitycredentialsV1beta_RetrieveCredentialsResponse>;
      retrieve(
        request: {
          /** V1 error format. */
          '$.xgafv'?: '1' | '2';
