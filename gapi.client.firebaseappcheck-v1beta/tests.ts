...
gapi.load('client', async () => {
  ...
  async function run() {
    ...
    await gapi.client.firebaseappcheck.projects.apps.mintAppCheckToken(
      {
        app: 'Test string',
      },
      {
    ...
    await gapi.client.firebaseappcheck.projects.apps.playIntegrityConfig.patch(
      ...
      },
      {
        ...
        deviceIntegrity: {
          minDeviceRecognitionLevel: 'Test string',
        },
        name: 'Test string',
        tokenTtl: 'Test string',
      },
    ...
    await gapi.client.firebaseappcheck.projects.services.resourcePolicies.list({
      filter: 'Test string',
      pageSize: 42,
      pageToken: 'Test string',
      parent: 'Test string',
    ...
    await gapi.client.firebaseappcheck.projects.services.resourcePolicies.patch(
      {
        name: 'Test string',
        updateMask: 'Test string',
      },
