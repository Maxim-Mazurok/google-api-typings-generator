# TypeScript typings for Cloud OS Login API v1alpha
...
For provenance information see [Provenance section on NPM](https://www.npmjs.com/package/@maxim_mazurok/gapi.client.oslogin-v1alpha#Provenance:~:text=none-,Provenance,-Built%20and%20signed)
