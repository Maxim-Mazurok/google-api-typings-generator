...
declare namespace gapi.client {
  /** Load Cloud OS Login API v1alpha */
  function load(
    urlOrObject: 'https://oslogin.googleapis.com/$discovery/rest?version=v1alpha',
  ): Promise<void>;
  /** @deprecated Please load APIs with discovery documents. */
  function load(name: 'oslogin', version: 'v1alpha'): Promise<void>;
  /** @deprecated Please load APIs with discovery documents. */
  function load(name: 'oslogin', version: 'v1alpha', callback: () => any): void;

  namespace oslogin {
    interface Empty {}
    interface GoogleCloudOsloginControlplaneRegionalV1alphaSignSshPublicKeyRequest {
    ...
    interface GoogleCloudOsloginControlplaneRegionalV1alphaSignSshPublicKeyResponse {
    ...
    interface LocationsResource {
      ...
      signSshPublicKey(request: {
        ...
        uploadType?: string;
        /** Request body */
        resource: GoogleCloudOsloginControlplaneRegionalV1alphaSignSshPublicKeyRequest;
      }): Request<GoogleCloudOsloginControlplaneRegionalV1alphaSignSshPublicKeyResponse>;
      signSshPublicKey(
        request: {
          /** V1 error format. */
          '$.xgafv'?: '1' | '2';
    ...
    interface UsersResource {
      ...
      getLoginProfile(request?: {
        ...
        view?: 'LOGIN_PROFILE_VIEW_UNSPECIFIED' | 'BASIC' | 'SECURITY_KEY';
