...
declare namespace gapi.client {
    ...
    function load(urlOrObject: "https://oslogin.googleapis.com/$discovery/rest?version=v1alpha"): Promise<void>;
        ...
        interface ZonesResource {
            ...
            signSshPublicKey(request: {
                ...
                oauth_token?:
                    string;
                /**
                 * The parent project and zone for the signing request. This is needed to properly ensure per-organization ISS processing and potentially to provide for the possibility of
            ...
            body: SignSshPublicKeyRequest): Request<SignSshPublicKeyResponse>;
        }
