...
declare namespace gapi.client {
    ...
    namespace content {
        ...
        interface OrderreturnsRefundOperation {
            /**
             * If true, the item will be fully refunded. // Allowed only when payment_type is FOP. Merchant can choose this refund option to indicate the full remaining amount of corresponding
             * object to be refunded to the customer via FOP.
             */
            fullRefund?: boolean;
