...
declare namespace gapi.client {
    ...
    namespace content {
        ...
        interface DeliveryAreaPostalCodeRange {
             ...
             * must have the same length as firstPostalCode: if firstPostalCode is a postal code then lastPostalCode must be a postal code too; if firstPostalCode is a pattern then lastPostalCode
             * must be a pattern with the same prefix length. Ignored if not set, then the area is defined as being all the postal codes matching firstPostalCode.
             */
        ...
        interface ProductDeliveryTime {
            /** Required. A set of associations between DeliveryAreas and DeliveryTimes. The total number of areaDeliveryTimes can be at most 100. */
        ...
        interface AccountsbyexternalselleridResource {
        ...
        interface AccountstatusesbyexternalselleridResource {
        ...
        interface ProductdeliverytimeResource {
            ...
            body: ProductDeliveryTime): Request<ProductDeliveryTime>;
        ...
        const accountsbyexternalsellerid: AccountsbyexternalselleridResource;

        const accountstatuses: AccountstatusesResource;

        const accountstatusesbyexternalsellerid: AccountstatusesbyexternalselleridResource;
