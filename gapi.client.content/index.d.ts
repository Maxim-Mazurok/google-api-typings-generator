...
declare namespace gapi.client {
    ...
    namespace content {
        ...
        interface AccountsCustomBatchRequestEntryLinkRequest {
            ...
            linkType?: string;
            /**
             * Provided services. Acceptable values are: - "`shoppingAdsProductManagement`" - "`shoppingAdsOther`" - "`shoppingActionsProductManagement`" - "`shoppingActionsOrderManagement`" -
        ...
        interface Collection {
             ...
             * (for collections). Provide up to 10 featuredProduct (for Shoppable Images only) with ID and X and Y coordinates. featured_product attribute
             */
