...
declare namespace gapi.client {
    ...
    namespace content {
        ...
        interface AccountsLinkRequest {
            ...
            linkType?: string;
            /**
             * Acceptable values are: - "`shoppingAdsProductManagement`" - "`shoppingAdsOther`" - "`shoppingActionsProductManagement`" - "`shoppingActionsOrderManagement`" -
        ...
        interface BuyongoogleprogramsResource {
             ...
             * Calling this method is only possible if the authenticated account is the same as the merchant id in the request. Calling this method multiple times will only accept Terms of Service
             * if the latest version is not currently signed.
             */
            onboard(request: {
                /** V1 error format. */
                "$.xgafv"?: string;
