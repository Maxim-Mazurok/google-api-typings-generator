...
declare namespace gapi.client {
    ...
    namespace content {
        ...
        interface FreeListingsProgramStatusRegionStatus {
            /**
             * Date by which `eligibility_status` will go from `WARNING` to `DISAPPROVED`. It will be present when `eligibility_status` is `WARNING`. Date will be provided in ISO 8601 format:
             * YYYY-MM-DD
             */
            ...
            /**
             * This contains additional information specific to review ineligibility reasons. If review is ineligible because of `IN_COOLDOWN_PERIOD`, it will contain timestamp for cooldown
             * period.
             */
