...
gapi.load('client', async () => {
  ...
  async function run() {
    ...
    await gapi.client.networkservices.projects.locations.cdnEdgeExtensions.create(
      {
        cdnEdgeExtensionId: 'Test string',
        parent: 'Test string',
        requestId: 'Test string',
      },
      {
    ...
    await gapi.client.networkservices.projects.locations.cdnEdgeExtensions.delete(
      {
        name: 'Test string',
        requestId: 'Test string',
      },
    ...
    await gapi.client.networkservices.projects.locations.cdnEdgeExtensions.get({
      name: 'Test string',
    });
    /** Lists `CdnEdgeExtensions` resources in a given project and location. */
    await gapi.client.networkservices.projects.locations.cdnEdgeExtensions.list(
      {
        filter: 'Test string',
        orderBy: 'Test string',
        pageSize: 42,
    ...
    await gapi.client.networkservices.projects.locations.cdnEdgeExtensions.patch(
      {
        name: 'Test string',
        requestId: 'Test string',
        updateMask: 'Test string',
    ...
    await gapi.client.networkservices.projects.locations.lbTcpExtensions.create(
      {
        lbTcpExtensionId: 'Test string',
        parent: 'Test string',
        requestId: 'Test string',
      },
      {
        ...
        loadBalancingScheme: 'Test string',
        name: 'Test string',
        networks: ['Test string'],
        updateTime: 'Test string',
      },
    );
    /** Deletes the specified `LbTcpExtension` resource. */
    await gapi.client.networkservices.projects.locations.lbTcpExtensions.delete(
      {
        name: 'Test string',
        requestId: 'Test string',
      },
    ...
    await gapi.client.networkservices.projects.locations.lbTcpExtensions.get({
      name: 'Test string',
    });
    /** Lists `LbTcpExtension` resources in a given project and location. */
    await gapi.client.networkservices.projects.locations.lbTcpExtensions.list({
      filter: 'Test string',
      orderBy: 'Test string',
      pageSize: 42,
      pageToken: 'Test string',
    ...
    await gapi.client.networkservices.projects.locations.lbTcpExtensions.patch(
      {
        name: 'Test string',
        requestId: 'Test string',
        updateMask: 'Test string',
