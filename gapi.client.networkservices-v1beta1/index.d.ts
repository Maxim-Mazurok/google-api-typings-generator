...
declare namespace gapi.client {
    ...
    namespace networkservices {
        ...
        interface Gateway {
            /**
             * Optional. Zero or one IPv4-address on which the Gateway will receive the traffic. When no address is provided, an IP from the subnetwork is allocated This field only applies to
             * gateways of type 'SECURE_WEB_GATEWAY'. Gateways of type 'OPEN_MESH' listen on 0.0.0.0.
             */
            addresses?:
                string[];
            /**
