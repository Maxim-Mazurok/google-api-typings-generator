...
declare namespace gapi.client {
  ...
  namespace networkservices {
    interface AgentConnectivityTemplate {
      ...
      accessTypes?: 'ACCESS_TYPE_UNSPECIFIED' | 'PUBLIC' | 'PRIVATE'[];
      /** Optional. The compute environment where the agent is hosted. Exactly one type of compute must be chosen. */
      agentCompute?: 'AGENT_COMPUTE_UNSPECIFIED' | 'GKE' | 'CLOUD_RUN' | 'BORG';
    ...
    interface AgentGateway {
      ...
      /** Optional. Deprecated. */
      protocols?: 'PROTOCOL_UNSPECIFIED' | 'MCP'[];
    ...
    interface AgentGatewayAgentGatewayOutputCard {
    ...
    interface AgentGatewayNetworkConfigDnsPeeringConfig {
    ...
    interface CdnEdgeExtensionTarget {
    ...
    interface ExtensionBinding {
      ...
      matchConditions?: ExtensionBindingMatchCondition[];
    ...
    interface ExtensionBindingMatchCondition {
    ...
    interface ExtensionBindingMatchConditionHeaderMatch {
    ...
    interface ExtensionBindingMatchConditionStringMatch {
    ...
    interface ExtensionBindingMatchConditionTo {
    ...
    interface ExtensionBindingMatchConditionToDestination {
      ...
      hosts?: ExtensionBindingMatchConditionStringMatch[];
      ...
      paths?: ExtensionBindingMatchConditionStringMatch[];
      ...
      resources?: ExtensionBindingMatchConditionStringMatch[];
    }
    interface ExtensionBindingMatchConditionToDestinationHeaderSet {
      ...
      headers?: ExtensionBindingMatchConditionHeaderMatch[];
    }
    interface ExtensionBindingTarget {
    ...
    interface ExtensionBindingTargetScope {
    ...
    interface Gateway {
      ...
      routingMode?: 'EXPLICIT_ROUTING_MODE' | 'NEXT_HOP_ROUTING_MODE';
    ...
    interface ListAgentConnectivityTemplatesResponse {
      /** List of AgentConnectivityTemplate resources. */
      agentConnectivityTemplates?: AgentConnectivityTemplate[];
    ...
    interface ListAgentGatewaysResponse {
    ...
    interface ListCdnEdgeExtensionsResponse {
      /** The list of `CdnEdgeExtension` resources. */
      cdnEdgeExtensions?: CdnEdgeExtension[];
      /** A token identifying a page of results that the server returns. */
      nextPageToken?: string;
      /** Locations that could not be reached. */
      unreachable?: string[];
    ...
    interface ListExtensionBindingsResponse {
      /** List of `ExtensionBinding` resources. */
      extensionBindings?: ExtensionBinding[];
      /** If there might be more results than those appearing in this response, then `next_page_token` is included. To get the next set of results, call this method again using the value of `next_page_token` as `page_token`. */
      nextPageToken?: string;
    ...
    interface ListProducerExtensionsResponse {
      /** If there might be more results than those appearing in this response, then `next_page_token` is included. To get the next set of results, call this method again using the value of `next_page_token` as `page_token`. */
      nextPageToken?: string;
      /** List of `ProducerExtension` resources. */
      producerExtensions?: ProducerExtension[];
    ...
    interface ProducerExtension {
      ...
      phase?: 'PHASE_UNSPECIFIED' | 'TRAFFIC' | 'AUTHZ';
      /** Output only. The timestamp when the resource was updated. */
      updateTime?: string;
    }
    interface ProducerExtensionExtensionSettings {
    ...
    interface ServiceLbPolicyIsolationConfig {
      ...
      isolationGranularity?: 'ISOLATION_GRANULARITY_UNSPECIFIED' | 'REGION';
      /** Optional. The isolation mode of the load balancer. */
      isolationMode?: 'ISOLATION_MODE_UNSPECIFIED' | 'NEAREST' | 'STRICT';
    }
    interface Status {
    ...
    interface AgentConnectivityTemplatesResource {
      ...
      create(request: {
        ...
        uploadType?: string;
        /** Request body */
        resource: AgentConnectivityTemplate;
      }): Request<Operation>;
      create(
        request: {
          /** V1 error format. */
      ...
      get(request?: {
        ...
        /** Legacy upload protocol for media (e.g. "media", "multipart"). */
        uploadType?: string;
      }): Request<AgentConnectivityTemplate>;
      ...
      list(request?: {
        ...
        /** Legacy upload protocol for media (e.g. "media", "multipart"). */
        uploadType?: string;
      }): Request<ListAgentConnectivityTemplatesResponse>;
    ...
    interface AgentGatewaysResource {
      ...
      list(request?: {
        ...
        /** Legacy upload protocol for media (e.g. "media", "multipart"). */
        uploadType?: string;
      }): Request<ListAgentGatewaysResponse>;
    ...
    interface CdnEdgeExtensionsResource {
      ...
      list(request?: {
        ...
        /** Legacy upload protocol for media (e.g. "media", "multipart"). */
        uploadType?: string;
      }): Request<ListCdnEdgeExtensionsResponse>;
    ...
    interface ExtensionBindingsResource {
      ...
      list(request?: {
        ...
        /** Legacy upload protocol for media (e.g. "media", "multipart"). */
        uploadType?: string;
      }): Request<ListExtensionBindingsResponse>;
    ...
    interface ProducerExtensionsResource {
      ...
      list(request?: {
        ...
        /** Legacy upload protocol for media (e.g. "media", "multipart"). */
        uploadType?: string;
      }): Request<ListProducerExtensionsResponse>;
    }
    ...
    interface LocationsResource {
      ...
      agentConnectivityTemplates: AgentConnectivityTemplatesResource;
      agentGateways: AgentGatewaysResource;
      authzExtensions: AuthzExtensionsResource;
      cdnEdgeExtensions: CdnEdgeExtensionsResource;
      endpointPolicies: EndpointPoliciesResource;
      extensionBindings: ExtensionBindingsResource;
      ...
      producerExtensions: ProducerExtensionsResource;
