...
declare namespace gapi.client {
    ...
    function load(urlOrObject: "https://serviceconsumermanagement.googleapis.com/$discovery/rest?version=v1"): Promise<void>;
    /** @deprecated Please load APIs with discovery documents. */
    function load(name: "serviceconsumermanagement", version: "v1"): Promise<void>;
    /** @deprecated Please load APIs with discovery documents. */
