/* This is stub file for gapi.client.serviceconsumermanagement-v1 definition tests */
// IMPORTANT
...
gapi.load('client', async () => {
    ...
    await gapi.client.load('https://serviceconsumermanagement.googleapis.com/$discovery/rest?version=v1');
