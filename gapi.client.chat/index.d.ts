...
declare namespace gapi.client {
    ...
    namespace chat {
        ...
        interface ActionResponse {
            /** A response to an event related to a [dialog](https://developers.google.com/chat/how-tos/dialogs). Must be accompanied by `ResponseType.Dialog`. */
        ...
        interface DeprecatedEvent {
            ...
            threadKey?: string;
            /**
             * A secret value that Chat apps can use to verify if a request is from Google. The token is randomly generated by Google, remains static, and can be obtained from the Google Chat API
        ...
        interface DialogAction {
            /**
             * Status for a request to either invoke or submit a [dialog](https://developers.google.com/chat/how-tos/dialogs). Displays a status and message to users, if necessary. For example, in
        ...
        interface Membership {
            ...
            createTime?: string;
            /**
             * A user in Google Chat. Represents a [person](https://developers.google.com/people/api/rest/v1/people) in the People API or a
             * [user](https://developers.google.com/admin-sdk/directory/reference/rest/v1/users) in the Admin SDK Directory API. Format: `users/{user}`
             */
            member?: User;
            name?: string;
        ...
        interface ConversationsResource {
            ...
            messages(request: {
                 ...
                 * is created. Subsequent messages with the same thread identifier will be posted into the same thread. This relieves Chat apps and webhooks from having to store the Google Chat
                 * thread ID of a thread (created earlier by them) to post further updates to it. Has no effect if thread field, corresponding to an existing thread, is set in message.
                 */
                threadKey?: string;
