...
declare namespace gapi.client {
    ...
    namespace chat {
        ...
        interface Message {
            ...
            cards?: Card[];
            /**
             * Rich, formatted and interactive cards that can be used to display UI elements and editable widgets, such as: formatted text, buttons, clickable images, checkboxes, radio buttons.
             * Cards are normally displayed below the plain-text body of the message. This v2 allows input widgets. The string key is a unique identifier among cards in the same message for
             * identifying inputs.
             */
            cardsV2?: CardWithId[];
