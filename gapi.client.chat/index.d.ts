...
declare namespace gapi.client {
    ...
    namespace chat {
        ...
        interface DialogAction {
            /**
             * Status for a request to either invoke or submit a [dialog](https://developers.google.com/chat/how-tos/bot-dialogs). Displays a status and message to users, if necessary. For
        ...
        interface User {
            ...
            isAnonymous?: boolean;
            /** Resource name for a Google Chat user. Formatted as `users/{user}`. Represents a [person](https://developers.google.com/people/api/rest/v1/people#Person) in the People API. */
            name?: string;
            /** User type. */
            type?: string;
        }
