...
*/
await gapi.client.databases.patch({ instance: "instance", project: "project", database: "database",  }); 
...
initial creation.  
*/
await gapi.client.sslCerts.get({ project: "project", sha1Fingerprint: "sha1Fingerprint", instance: "instance",  }); 
