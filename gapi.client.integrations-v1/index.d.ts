...
declare namespace gapi.client {
  ...
  namespace integrations {
    ...
    interface GoogleCloudIntegrationsV1alphaIntegrationVersionTemplate {
      /** Required. Config parameters which are required for the integration template. These config parameters would be requested by users while creating integration. */
      configParameters?: GoogleCloudIntegrationsV1alphaIntegrationConfigParameter[];
