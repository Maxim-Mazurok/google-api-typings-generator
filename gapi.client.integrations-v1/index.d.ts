...
declare namespace gapi.client {
    ...
    function load(urlOrObject: "https://integrations.googleapis.com/$discovery/rest?version=v1"): Promise<void>;
    ...
    namespace integrations {
        ...
        interface GoogleCloudIntegrationsV1alphaCloudKmsConfig {
            ...
            kmsLocation?: string;
            /**
             * Required. A key ring organizes keys in a specific Google Cloud location and allows you to manage access control on groups of keys. A key ring's name does not need to be unique
             * across a Google Cloud project, but must be unique within a given location.
             */
            kmsRing?: string;
        }
        ...
        interface GoogleCloudIntegrationsV1alphaTestIntegrationsRequest {
            ...
            parameters?: EnterpriseCrmFrontendsEventbusProtoEventParameters;
            /**
             * Optional. Can be specified in the event request, otherwise false (default). If true, enables tasks with condition "test_mode = true". If false, disables tasks with condition
             * "test_mode = true" if global test mode (set by platform) is also false {@link EventBusConfig}.
             */
            testMode?: boolean;
            /**
             * Required. The trigger id of the integration trigger config. If both trigger_id and client_id is present, the integration is executed from the start tasks provided by the matching
             * trigger config otherwise it is executed from the default start tasks.
             */
            triggerId?: string;
        }
        ...
        interface IntegrationsResource {
            ...
            body: GoogleCloudIntegrationsV1alphaMonitorExecutionStatsRequest): Request<{}>;
