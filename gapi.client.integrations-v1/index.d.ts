...
declare namespace gapi.client {
  ...
  namespace integrations {
    ...
    interface GoogleCloudConnectorsV1Connection {
      ...
      subscriptionType?: 'SUBSCRIPTION_TYPE_UNSPECIFIED' | 'PAY_G' | 'PAID';
    ...
    interface GoogleCloudIntegrationsV1alphaAssertionResult {
      ...
      status?: 'ASSERTION_STATUS_UNSPECIFIED' | 'SUCCEEDED' | 'FAILED';
    ...
    interface GoogleCloudIntegrationsV1alphaExecuteTestCaseResponse {
      ...
      testExecutionState?: 'STATE_UNSPECIFIED' | 'PASSED' | 'FAILED';
    }
    ...
    interface GoogleCloudIntegrationsV1alphaTemplateComponent {
      ...
      type?: 'TYPE_UNSPECIFIED' | 'TRIGGER' | 'TASK' | 'CONNECTOR';
    }
