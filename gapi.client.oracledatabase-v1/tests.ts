...
gapi.load('client', async () => {
  ...
  async function run() {
    ...
    await gapi.client.oracledatabase.projects.locations.autonomousDatabases.create(
      ...
      },
      {
        ...
        sourceConfig: {
          ...
          autonomousDatabaseBackup: 'Test string',
          autoRefreshFrequencySeconds: 42,
          autoRefreshPointLagSeconds: 42,
          autoRefreshStartTime: 'Test string',
          backupTime: 'Test string',
          cloneType: 'Test string',
          refreshableMode: 'Test string',
    ...
    await gapi.client.oracledatabase.projects.locations.autonomousDatabases.getRefreshableClones(
      {
        name: 'Test string',
      },
    );
    ...
    await gapi.client.oracledatabase.projects.locations.autonomousDatabases.refresh(
      {
        name: 'Test string',
      },
      {
        refreshCutoffTime: 'Test string',
      },
    );
    ...
    await gapi.client.oracledatabase.projects.locations.cloudVmClusters.create(
      ...
      },
      {
        ...
        properties: {
          ...
          vmBackupStorageType: 'Test string',
          vmFileSystemStorageType: 'Test string',
        },
      },
    );
