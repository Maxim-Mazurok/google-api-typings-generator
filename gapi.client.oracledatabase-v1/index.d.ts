...
declare namespace gapi.client {
  ...
  namespace oracledatabase {
    ...
    interface AutonomousDatabase {
      ...
      name?: string;
      /** Required. The name of the VPC network used by the Autonomous Database. Format: projects/{project}/global/networks/{network} */
      network?: string;
    ...
    interface CloudVmCluster {
      ...
      /** Output only. GCP location where Oracle Exadata is hosted. It is same as GCP Oracle zone of Exadata infrastructure. */
      gcpOracleZone?: string;
    ...
    interface EntitlementsResource {
      ...
      list(request?: {
        ...
        /** Optional. A token identifying a page of results the server should return. */
        pageToken?: string;
        /** Required. The parent value for Entitlement in the following format: projects/{project}/locations/{location}. */
        parent: string;
        /** Returns response with indentations and line breaks. */
        prettyPrint?: boolean;
        /** Available to use for quota purposes for server-side applications. Can be any arbitrary string assigned to a user, but should not exceed 40 characters. */
