...
declare namespace gapi.client {
  ...
  namespace oracledatabase {
    ...
    interface AutonomousDatabaseRefreshableClone {
    ...
    interface AutonomousDatabaseRefreshableClones {
      /** The list of Autonomous Database refreshable clones. */
      autonomousDatabaseRefreshableClones?: AutonomousDatabaseRefreshableClone[];
    }
    ...
    interface ConfigureExascaleCloudExadataInfrastructureRequest {
    ...
    interface RefreshAutonomousDatabaseRequest {
    ...
    interface SourceConfig {
      ...
      cloneType?: 'CLONE_TYPE_UNSPECIFIED' | 'FULL' | 'METADATA';
    ...
    interface AutonomousDatabasesResource {
      ...
      getRefreshableClones(request?: {
        ...
        /** Legacy upload protocol for media (e.g. "media", "multipart"). */
        uploadType?: string;
      }): Request<AutonomousDatabaseRefreshableClones>;
      ...
      refresh(request: {
        ...
        uploadType?: string;
        /** Request body */
        resource: RefreshAutonomousDatabaseRequest;
      }): Request<Operation>;
      refresh(
        request: {
          /** V1 error format. */
    ...
    interface CloudExadataInfrastructuresResource {
      ...
      configureExascale(request: {
        ...
        uploadType?: string;
        /** Request body */
        resource: ConfigureExascaleCloudExadataInfrastructureRequest;
      }): Request<Operation>;
      configureExascale(
        request: {
          /** V1 error format. */
