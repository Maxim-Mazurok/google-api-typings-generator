/* Type definitions for non-npm package Campaign Manager 360 API v4 0.0 */
...
declare namespace gapi.client {
    ...
    function load(urlOrObject: "https://dfareporting.googleapis.com/$discovery/rest?version=v4"): Promise<void>;
    ...
    namespace dfareporting {
                    ...
                    reportProperties?:
                        {
                            ...
                            includeAttributedIPConversions?:
                                boolean;
                            /**
                             * Include conversions of users with a DoubleClick cookie but without an exposure. That means the user did not click or see an ad from the advertiser within the
                             * Floodlight group, or that the interaction happened outside the lookback window.
                             */
                            includeUnattributedCookieConversions?:
                                boolean;
                            /**
                             * Include conversions that have no associated cookies and no exposures. It’s therefore impossible to know how the user was exposed to your ads during the lookback
                             * window prior to a conversion.
                             */
            ...
            pathToConversionCriteria?:
                {
                    ...
                    reportProperties?:
                        {
                            /**
                             * CM360 checks to see if a click interaction occurred within the specified period of time before a conversion. By default the value is pulled from Floodlight or you
                             * can manually enter a custom value. Valid values: 1-90.
                             */
                            clicksLookbackWindow?:
                                number;
                            /**
                             * CM360 checks to see if an impression interaction occurred within the specified period of time before a conversion. By default the value is pulled from Floodlight or
                            ...
                            includeUnattributedIPConversions?:
                                boolean;
                            /**
                             * The maximum number of click interactions to include in the report. Advertisers currently paying for E2C reports get up to 200 (100 clicks, 100 impressions). If
                             * another advertiser in your network is paying for E2C, you can have up to 5 total exposures per report.
                             */
            ...
            schedule?:
                {
                    ...
                    expirationDate?:
                        string;
                    /**
                     * The interval for which the report is repeated. Note: - "DAILY" also requires field "every" to be set. - "WEEKLY" also requires fields "every" and "repeatsOnWeekDays" to be
                     * set. - "MONTHLY" also requires fields "every" and "runsOnDayOfMonth" to be set.
                     */
                    repeats?:
                        string;
                     ...
                     * Example: If 'startDate' is Monday, April 2nd 2012 (2012-04-02), "DAY_OF_MONTH" would run subsequent reports on the 2nd of every Month, and "WEEK_OF_MONTH" would run
                     * subsequent reports on the first Monday of the month.
                     */
                    runsOnDayOfMonth?:
                        string;
                    startDate?:
        ...
        interface ReportsConfiguration {
            ...
            lookbackConfiguration?:
                LookbackConfiguration;
            /**
             * Report generation time zone ID of this account. This is a required field that cannot be changed on update. Acceptable values are: - "1" for "America/New_York" - "2" for
