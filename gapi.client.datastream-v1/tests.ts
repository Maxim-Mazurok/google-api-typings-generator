      ...
      },
      {
            ...
            customizationRules: [
              {
                ...
                bigqueryPartitioning: {
                  ingestionTimePartition: {
                    partitioningTimeGranularity: 'Test string',
                  },
        ...
        sourceConfig: {
          ...
          salesforceMarketingCloudSourceConfig: {
            ...
            fullRefreshPollingInterval: 'Test string',
            includeObjects: {
              objects: [
                {
                  objectName: 'Test string',
          ...
          spannerSourceConfig: {
            backfillDataBoostEnabled: true,
            changeStreamName: 'Test string',
            excludeObjects: {
              schemas: [
                {
                  schema: 'Test string',
            ...
            maxConcurrentBackfillTasks: 42,
            maxConcurrentCdcTasks: 42,
            spannerRpcPriority: 'Test string',
          },
