...
declare namespace gapi.client {
  ...
  namespace datastream {
    ...
    interface SpannerSourceConfig {
      ...
      /** Optional. Spanner objects to avoid retrieving. If some objects are both included and excluded, an error will be thrown. */
      excludeObjects?: SpannerDatabase;
      /** Optional. The FGAC role to use for the stream. */
      fgacRole?: string;
      /** Optional. Spanner objects to retrieve from the data source. If some objects are both included and excluded, an error will be thrown. */
