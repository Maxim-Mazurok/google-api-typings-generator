/* This is stub file for gapi.client.games-v1 definition tests */
// IMPORTANT
...
gapi.load('client', async () => {
  ...
  async function run() {
    ...
    await gapi.client.games.gameStats.batchRecordEvents(
      {
        playerId: 'Test string',
      },
      {
        droidGuardBlob: 'Test string',
        events: [
          {
            eventId: 'Test string',
    ...
    await gapi.client.games.recall.gamesPlayerTokens({
      applicationIds: 'Test string',
    ...
    await gapi.client.games.recall.linkPersona(
      {},
      {
        cardinalityConstraint: 'Test string',
        conflictingLinksResolutionPolicy: 'Test string',
