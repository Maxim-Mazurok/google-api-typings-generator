...
declare namespace gapi.client {
    ...
    function load(urlOrObject: "https://games.googleapis.com/$discovery/rest?version=v1"): Promise<void>;
    ...
    namespace games {
        ...
        interface PlayersResource {
             ...
             * players that actually have an id (scoped or otherwise) with that game.
             */
        ...
        interface RecallResource {
            ...
            body: LinkPersonaRequest): Request<LinkPersonaResponse>;
            ...
            body: ResetPersonaRequest): Request<ResetPersonaResponse>;
            /**
             * Retrieve all Recall tokens associated with the PGS Player principal encoded in the provided recall session id. The API is only available for users that have active PGS Player
             * profile.
             */
            retrieveTokens(request?: {
                ...
                uploadType?:
                    string;
            }): Request<RetrievePlayerTokensResponse>;
            ...
            body: UnlinkPersonaRequest): Request<UnlinkPersonaResponse>;
        }
        interface RevisionsResource {
            ...
            check(request?: {
                ...
                callback?:
                    string;
                /**
                 * Required. The revision of the client SDK used by your application. Format: `[PLATFORM_TYPE]:[VERSION_NUMBER]`. Possible values of `PLATFORM_TYPE` are: * `ANDROID` - Client is
                 * running the Android SDK. * `IOS` - Client is running the iOS SDK. * `WEB_APP` - Client is running as a Web App.
                 */
                clientRevision:
                    string;
                /** Selector specifying which fields to include in a partial response. */
        ...
        interface ScoresResource {
            ...
            submit(request?: {
                ...
                quotaUser?:
                    string;
                /**
                 * Required. The score you're submitting. The submitted score is ignored if it is worse than a previously submitted score, where worse depends on the leaderboard sort order. The
                 * meaning of the score value depends on the leaderboard format type. For fixed-point, the score represents the raw value. For time, the score represents elapsed time in
