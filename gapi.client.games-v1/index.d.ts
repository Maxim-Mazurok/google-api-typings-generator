/* Type definitions for non-npm package Google Play Games Services API v1 0.0 */
...
declare namespace gapi.client {
  /** Load Google Play Games Services API v1 */
  function load(
  ...
  namespace games {
    ...
    interface BatchRecordEventsResponse {
      ...
      failedRequests?: {[P in string]: Status};
    }
    interface Category {
      /** The category name. */
      category?: string;
    ...
    interface GeneratePlayGroupingApiTokenResponse {
      /** Token for accessing the Play Grouping API. */
      token?: PlayGroupingApiToken;
    }
    interface GenerateRecallPlayGroupingApiTokenResponse {
      /** Token for accessing the Play Grouping API. */
      token?: PlayGroupingApiToken;
    }
    ...
    interface PlayerGameEvent {
      ...
      eventProperties?: {[P in string]: PropertyValue};
    ...
    interface AccesstokensResource {
      ...
      generatePlayGroupingApiToken(request?: {
        ...
        uploadType?: string;
      }): Request<GeneratePlayGroupingApiTokenResponse>;
      ...
      generateRecallPlayGroupingApiToken(request?: {
        ...
        /** Legacy upload protocol for media (e.g. "media", "multipart"). */
        uploadType?: string;
      }): Request<GenerateRecallPlayGroupingApiTokenResponse>;
    }
    ...
    interface PlayerGameEventsResource {
      ...
      batchRecordEvents(request: {
        ...
        uploadType?: string;
        /** Request body */
        resource: BatchRecordEventsRequest;
      }): Request<BatchRecordEventsResponse>;
      batchRecordEvents(
        request: {
          /** V1 error format. */
          '$.xgafv'?: '1' | '2';
    ...
    interface RecallResource {
      ...
      gamesPlayerTokens(request?: {
        ...
        /** Legacy upload protocol for media (e.g. "media", "multipart"). */
        uploadType?: string;
      }): Request<RetrieveGamesPlayerTokensResponse>;
      ...
      lastTokenFromAllDeveloperGames(request?: {
        ...
        /** Legacy upload protocol for media (e.g. "media", "multipart"). */
        uploadType?: string;
      }): Request<RetrieveDeveloperGamesLastPlayerTokenResponse>;
    ...
    const accesstokens: AccesstokensResource;
    ...
    const playerGameEvents: PlayerGameEventsResource;
