...
declare namespace gapi.client {
  ...
  namespace accesscontextmanager {
    ...
    interface SupportedService {
      /** True if the service is available on the restricted VIP. Services on the restricted VIP typically either support {{vpcsvcctl_name_short}} or are core infrastructure services required for the functioning of Google Cloud. */
