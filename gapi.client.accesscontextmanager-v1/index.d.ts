...
declare namespace gapi.client {
  ...
  function load(
    urlOrObject: 'https://accesscontextmanager.googleapis.com/$discovery/rest?version=v1',
  ): Promise<void>;
  ...
  namespace accesscontextmanager {
    ...
    interface Condition {
      ...
      vpcNetworkSources?: VpcNetworkSource[];
    }
    ...
    interface ListSupportedPermissionsResponse {
    ...
    interface LookupConfiguredServicePerimeterResponse {
    ...
    interface PrivateServiceConnectEndpoint {
    ...
    interface VpcAccessibleServices {
      ...
      allowedServicePatterns?: ServicePattern[];
    ...
    interface FoldersResource {
      ...
      lookupConfiguredServicePerimeter(request?: {
        /** V1 error format. */
        '$.xgafv'?: '1' | '2';
        /** OAuth access token. */
        access_token?: string;
        ...
        /** Legacy upload protocol for media (e.g. "media", "multipart"). */
        uploadType?: string;
      }): Request<LookupConfiguredServicePerimeterResponse>;
    }
    ...
    interface PermissionsResource {
      ...
      list(request?: {
        ...
        /** Legacy upload protocol for media (e.g. "media", "multipart"). */
        uploadType?: string;
      }): Request<ListSupportedPermissionsResponse>;
    }
    ...
    interface ServicesResource {
      ...
      list(request?: {
        ...
        /** Legacy upload protocol for media (e.g. "media", "multipart"). */
        uploadType?: string;
      }): Request<ListSupportedServicesResponse>;
    }
