...
gapi.load('client', async () => {
  ...
  async function run() {
      ...
      },
      {
        ...
        spec: {
          ...
          vpcAccessibleServices: {
            ...
            servicePatternsEnforcementScopes: ['Test string'],
          },
        },
        status: {
          accessLevels: ['Test string'],
    ...
    await gapi.client.accesscontextmanager.accessPolicies.servicePerimeters.get(
      {
        deletedPrincipalSyntax: 'Test string',
        name: 'Test string',
      },
    );
    ...
    await gapi.client.accesscontextmanager.organizations.gcpUserAccessBindings.create(
      ...
      {
        accessLevels: ['Test string'],
        dryRunAccessLevels: ['Test string'],
        groupKey: 'Test string',
        name: 'Test string',
        principal: {
          federatedPrincipal: 'Test string',
          serviceAccount: 'Test string',
          serviceAccountProjectNumber: 'Test string',
        },
        scopedAccessSettings: [
          {
            activeSettings: {
              accessLevels: ['Test string'],
              sessionSettings: {
                maxInactivity: 'Test string',
                sessionLength: 'Test string',
