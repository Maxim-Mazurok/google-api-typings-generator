...
declare namespace gapi.client {
    ...
    namespace redis {
        interface Cluster {
            ...
            /**
             * Optional. Redis configuration parameters, according to http://redis.io/topics/config. Currently, the only supported parameters are: Redis version 6.x and newer: * lfu-decay-time *
        ...
        interface Instance {
            ...
            /**
             * Optional. Additional ip ranges for node placement, beyond those specified in reserved_ip_range. At most 1 secondary IP range is supported. The mask value must not exceed /28. Not
             * supported for BASIC tier. Updates can only add new ranges, once added ranges cannot be changed or deleted. Values in this list cannot overlap with the reserved_ip_range. Not
             * supported during instance creation.
             */
