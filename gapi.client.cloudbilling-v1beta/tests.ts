...
gapi.load('client', async () => {
  ...
  async function run() {
    ...
    await gapi.client.cloudbilling.billingAccounts.anomalies.get({
      name: 'Test string',
    });
    /** Lists anomalies for a billing account or a project. */
    await gapi.client.cloudbilling.billingAccounts.anomalies.list({
      filter: 'Test string',
      pageSize: 42,
    ...
    /** Gets an anomaly for a billing account or a project. */
    await gapi.client.cloudbilling.projects.anomalies.get({
      name: 'Test string',
    });
    /** Lists anomalies for a billing account or a project. */
    await gapi.client.cloudbilling.projects.anomalies.list({
      filter: 'Test string',
      pageSize: 42,
      pageToken: 'Test string',
      parent: 'Test string',
