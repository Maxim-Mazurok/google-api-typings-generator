...
gapi.load('client', async () => {
  ...
  async function run() {
    ...
    await gapi.client.analyticsadmin.properties.provisionSubproperty(
      {},
      {
        customDimensionAndMetricSynchronizationMode: 'Test string',
        subproperty: {
          account: 'Test string',
          createTime: 'Test string',
          currencyCode: 'Test string',
    ...
    await gapi.client.analyticsadmin.properties.submitUserDeletion(
      {
        name: 'Test string',
      },
      {
        appInstanceId: 'Test string',
        clientId: 'Test string',
        userId: 'Test string',
        userProvidedData: 'Test string',
      },
    );
    ...
    await gapi.client.analyticsadmin.properties.reportingDataAnnotations.create(
      {
        parent: 'Test string',
      },
      {
    ...
    await gapi.client.analyticsadmin.properties.reportingDataAnnotations.delete(
      {
        name: 'Test string',
      },
    );
    /** Lookup a single Reporting Data Annotation. */
    await gapi.client.analyticsadmin.properties.reportingDataAnnotations.get({
      name: 'Test string',
    });
    /** List all Reporting Data Annotations on a property. */
    await gapi.client.analyticsadmin.properties.reportingDataAnnotations.list({
      filter: 'Test string',
      pageSize: 42,
      pageToken: 'Test string',
      parent: 'Test string',
    ...
    await gapi.client.analyticsadmin.properties.reportingDataAnnotations.patch(
      {
        name: 'Test string',
        updateMask: 'Test string',
      },
    ...
    await gapi.client.analyticsadmin.properties.subpropertySyncConfigs.get({
      name: 'Test string',
    });
    /** List all `SubpropertySyncConfig` resources for a property. */
    await gapi.client.analyticsadmin.properties.subpropertySyncConfigs.list({
      pageSize: 42,
      pageToken: 'Test string',
      parent: 'Test string',
    });
    /** Updates a `SubpropertySyncConfig`. */
    await gapi.client.analyticsadmin.properties.subpropertySyncConfigs.patch(
      {
        name: 'Test string',
        updateMask: 'Test string',
      },
      {
        applyToProperty: 'Test string',
        customDimensionAndMetricSyncMode: 'Test string',
        name: 'Test string',
      },
    );
  }
