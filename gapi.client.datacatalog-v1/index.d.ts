...
declare namespace gapi.client {
  ...
  function load(
    urlOrObject: 'https://datacatalog.googleapis.com/$discovery/rest?version=v1',
  ): Promise<void>;
  ...
  namespace datacatalog {
    ...
    interface GoogleCloudDatacatalogV1OrganizationConfig {
      ...
      config?: {[P in string]: GoogleCloudDatacatalogV1MigrationConfig};
    }
    ...
    interface GoogleCloudDatacatalogV1SetConfigRequest {
      /** Opt-in status for the UI switch to Dataplex Universal Catalog. */
      catalogUiExperience?: string;
      /** Opt-in status for the migration of Tag Templates to Dataplex Universal Catalog. */
      tagTemplateMigration?: string;
    ...
    interface LocationsResource {
      ...
      retrieveConfig(request?: {
        ...
        /** Legacy upload protocol for media (e.g. "media", "multipart"). */
        uploadType?: string;
      }): Request<GoogleCloudDatacatalogV1OrganizationConfig>;
      ...
      retrieveEffectiveConfig(request?: {
        /** V1 error format. */
        '$.xgafv'?: string;
        /** OAuth access token. */
        access_token?: string;
        ...
        /** Legacy upload protocol for media (e.g. "media", "multipart"). */
        uploadType?: string;
      }): Request<GoogleCloudDatacatalogV1MigrationConfig>;
      ...
      setConfig(request: {
        ...
        uploadType?: string;
        /** Request body */
        resource: GoogleCloudDatacatalogV1SetConfigRequest;
      }): Request<GoogleCloudDatacatalogV1MigrationConfig>;
      setConfig(
        request: {
          /** V1 error format. */
