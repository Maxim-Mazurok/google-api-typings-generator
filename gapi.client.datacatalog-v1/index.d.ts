...
declare namespace gapi.client {
    ...
    namespace datacatalog {
        ...
        interface EntriesResource {
            ...
            /**
             * Imports entries from a source, such as data previously dumped into a Cloud Storage bucket, into Data Catalog. `ImportEntries` accepts source data snapshots of third-party system
             * state. Import of entries is a sync operation that reconciles the state of the third-party system with Data Catalog. `ImportEntries` returns a long-running operation resource that
             * can be queried with Operations.GetOperation to return ImportEntriesMetadata and an ImportEntriesResponse message.
             */
            import(request: {
                /** V1 error format. */
                "$.xgafv"?: string;
