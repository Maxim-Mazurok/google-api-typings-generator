...
declare namespace gapi.client {
    ...
    namespace datacatalog {
        ...
        interface GoogleCloudDatacatalogV1ReconcileTagsRequest {
            /**
             * If set to true deletes from the entry tags related to given tag template and not mentioned in the tags source. If set to false only creates and updates of the tags mentioned in the
             * source will take place. Other tags in that entry using the same tag template will be retained instead of being deleted.
             */
            forceDeleteMissing?: boolean;
            /**
             * A list of tags to be applied on a given entry. Individual tags may specify tag template, but it must be the same as the one in the ReconcileTagsRequest. The sole entry and each of
             * its columns must be mentioned at most once.
             */
            tags?: GoogleCloudDatacatalogV1Tag[];
        ...
        interface TagsResource {
             ...
             * operation is also able to delete tags not mentioned in the tag list. It can be achieved by setting force_delete_missing parameter. Reconciliation is a long-running operation done in
             * the background, so this method returns long-running operation resource. The resource can be queried with Operations.GetOperation which contains metadata and response.
             */
            reconcile(request: {
                /** V1 error format. */
                "$.xgafv"?: string;
                ...
                uploadType?: string;
                /** Request body */
                resource: GoogleCloudDatacatalogV1ReconcileTagsRequest;
            }): Request<Operation>;
            reconcile(request: {
                /** V1 error format. */
                "$.xgafv"?: string;
        ...
        interface EntriesResource {
             ...
             * Data Catalog. Import of entries is a sync operation that reconciles state of the third-party system and Data Catalog. ImportEntries is a long-running operation done in the
            ...
            import(request: {
                ...
                uploadType?: string;
                /** Request body */
                resource: GoogleCloudDatacatalogV1ImportEntriesRequest;
            }): Request<Operation>;
            import(request: {
                /** V1 error format. */
                "$.xgafv"?: string;
