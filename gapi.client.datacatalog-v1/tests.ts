          ...
          edgeTables: [
            {
              ...
              destinationNodeReference: {
                edgeTableColumns: ['Test string'],
                nodeAlias: 'Test string',
                nodeTableColumns: ['Test string'],
              },
              dynamicLabelColumn: 'Test string',
              dynamicPropertiesColumn: 'Test string',
              elementKeys: ['Test string'],
              inputSource: 'Test string',
              kind: 'Test string',
              labelAndProperties: [
                {
                  label: 'Test string',
