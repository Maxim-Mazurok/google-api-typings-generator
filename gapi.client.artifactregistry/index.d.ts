...
declare namespace gapi.client {
    ...
    namespace artifactregistry {
        ...
        interface ImportGooGetArtifactsRequest {
            /** Google Cloud Storage location where input content is located. */
        ...
        // tslint:disable-next-line:no-empty-interface
        interface UploadGooGetArtifactRequest {
        }
        ...
        interface GoogetArtifactsResource {
            /**
            ...
            upload(request: {
                ...
                uploadType?: string;
                /** Request body */
                resource: UploadGooGetArtifactRequest;
            }): Request<UploadGooGetArtifactMediaResponse>;
            upload(request: {
                /** V1 error format. */
                "$.xgafv"?: string;
                /** OAuth access token. */
            ...
            body: UploadGooGetArtifactRequest): Request<UploadGooGetArtifactMediaResponse>;
        }
        interface GooGetArtifactsResource {
            /**
            ...
            import(request: {
                ...
                uploadType?: string;
                /** Request body */
                resource: ImportGooGetArtifactsRequest;
            }): Request<Operation>;
            import(request: {
                /** V1 error format. */
                "$.xgafv"?: string;
            ...
            body: ImportGooGetArtifactsRequest): Request<Operation>;
        }
        ...
        interface RepositoriesResource {
            ...
            files: FilesResource;
            googetArtifacts: GoogetArtifactsResource;
            gooGetArtifacts: GooGetArtifactsResource;
