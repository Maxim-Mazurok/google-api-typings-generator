...
declare namespace gapi.client {
    ...
    namespace artifactregistry {
        ...
        interface DockerImage {
             ...
             * which can be easily used with the JavaScript Date constructor and keeps the Version timestamps returned via OnePlatform consistent, as JSON marshals google.protobuf.Timestamp into
             * an RFC 3339 string. (http://google3/cloud/containers/artifacts/metadata/v1beta2/builder/data.go?l=158-159&rcl=364878183).
             */
            buildTime?: string;
