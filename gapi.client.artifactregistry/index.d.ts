...
// Generated from: https://artifactregistry.googleapis.com/$discovery/rest?version=v1beta1
// Revision: 20201107
...
declare namespace gapi.client {
    ...
    function load(name: "artifactregistry", version: "v1beta1"): PromiseLike<void>;
    function load(name: "artifactregistry", version: "v1beta1", callback: () => any): void;
    ...
    namespace artifactregistry {
        ...
        interface GoogleDevtoolsArtifactregistryV1alpha1ErrorInfo {
            /** The detailed error status. */
            error?: Status;
            /** Google Cloud Storage location requested. */
            gcsSource?: GoogleDevtoolsArtifactregistryV1alpha1GcsSource;
        }
        interface GoogleDevtoolsArtifactregistryV1alpha1GcsSource {
            /** Cloud Storage paths URI (e.g., gs://my_bucket//my_object). */
            uris?: string[];
            /** Supports URI wildcards for matching multiple objects from a single URI. */
            useWildcards?: boolean;
        }
        interface GoogleDevtoolsArtifactregistryV1alpha1ImportArtifactsResponse {
            /** Detailed error info for packages that were not imported. */
            errors?: GoogleDevtoolsArtifactregistryV1alpha1ErrorInfo[];
            /** The packages updated. */
            packages?: GoogleDevtoolsArtifactregistryV1alpha1Package[];
        }
        interface GoogleDevtoolsArtifactregistryV1alpha1Package {
