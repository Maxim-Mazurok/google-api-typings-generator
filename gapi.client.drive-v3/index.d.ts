...
declare namespace gapi.client {
    ...
    namespace drive {
        ...
        interface File {
            ...
            /**
             * The size of the file's content in bytes. This field is populated for files with binary content stored in Google Drive and for Docs Editors files; it is not populated for shortcuts
             * or folders.
             */
            size?: string;
