...
declare namespace gapi.client {
  ...
  namespace drive {
    ...
    interface ApproveApprovalRequest {
      /** Optional. A message to accompany the reviewer response on the Approval. This message will be included in notifications for the action and in the Approval activity log. */
      message?: string;
    }
    interface CancelApprovalRequest {
      /** Optional. A message to accompany the cancellation of the Approval. This message will be included in notifications for the action and in the Approval activity log. */
      message?: string;
    }
    interface Change {
    ...
    interface CommentApprovalRequest {
      /** Required. A message to comment on the Approval. This message will be included in notifications for the action and in the Approval activity log. */
      message?: string;
    }
    ...
    interface DeclineApprovalRequest {
      /** Optional. A message to accompany the reviewer response on the Approval. This message will be included in notifications for the action and in the Approval activity log. */
      message?: string;
    }
    ...
    interface ReassignApprovalRequest {
      ...
      replaceReviewers?: ReplaceReviewer[];
    }
    interface ReplaceReviewer {
      /** Required. The email of the reviewer to add. */
      addedReviewerEmail?: string;
    ...
    interface ApprovalsResource {
      ...
      approve(request: {
        ...
        uploadType?: string;
        /** Request body */
        resource: ApproveApprovalRequest;
      }): Request<Approval>;
      approve(
        request: {
          /** V1 error format. */
      ...
      cancel(request: {
        ...
        uploadType?: string;
        /** Request body */
        resource: CancelApprovalRequest;
      }): Request<Approval>;
      cancel(
        request: {
          /** V1 error format. */
      ...
      comment(request: {
        ...
        uploadType?: string;
        /** Request body */
        resource: CommentApprovalRequest;
      }): Request<Approval>;
      comment(
        request: {
          /** V1 error format. */
      ...
      decline(request: {
        ...
        uploadType?: string;
        /** Request body */
        resource: DeclineApprovalRequest;
      }): Request<Approval>;
      decline(
        request: {
          /** V1 error format. */
      ...
      reassign(request: {
        ...
        uploadType?: string;
        /** Request body */
        resource: ReassignApprovalRequest;
      }): Request<Approval>;
      reassign(
        request: {
          /** V1 error format. */
