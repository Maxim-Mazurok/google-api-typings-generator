...
gapi.load('client', async () => {
  ...
  async function run() {
    ...
    await gapi.client.drive.approvals.approve(
      {
    ...
    await gapi.client.drive.approvals.cancel(
      {
        approvalId: 'Test string',
        fileId: 'Test string',
      },
    ...
    await gapi.client.drive.approvals.comment(
      {
        approvalId: 'Test string',
        fileId: 'Test string',
      },
    ...
    await gapi.client.drive.approvals.decline(
      {
        approvalId: 'Test string',
        fileId: 'Test string',
      },
    ...
    await gapi.client.drive.approvals.reassign(
      {
        approvalId: 'Test string',
        fileId: 'Test string',
      },
      {
        addReviewers: [
          {
            addedReviewerEmail: 'Test string',
          },
        ],
        message: 'Test string',
        replaceReviewers: [
          {
            addedReviewerEmail: 'Test string',
            removedReviewerEmail: 'Test string',
          },
        ],
      },
    );
    ...
    await gapi.client.drive.approvals.start(
      {
        fileId: 'Test string',
      },
      {
        dueTime: 'Test string',
        fileContentChangeBehavior: 'Test string',
        lockFile: true,
        message: 'Test string',
        reviewerEmails: ['Test string'],
      },
    );
    ...
    await gapi.client.drive.files.copy(
      ...
      },
      {
        ...
        clientEncryptionDetails: {
          decryptionMetadata: {
            aes256GcmChunkSize: 'Test string',
            encryptionResourceKeyHash: 'Test string',
            jwt: 'Test string',
            kaclsId: 'Test string',
            kaclsName: 'Test string',
            keyFormat: 'Test string',
