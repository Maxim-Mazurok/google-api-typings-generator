/* This is stub file for gapi.client.alloydb-v1beta definition tests */
// IMPORTANT
...
gapi.load('client', async () => {
  ...
  async function run() {
    ...
    await gapi.client.alloydb.projects.locations.clusters.instances.create(
      ...
      },
      {
        ...
        connectionPoolConfig: {
          authproxyPoolerCount: 42,
          authproxyPoolerScalingType: 'Test string',
          enabled: true,
          flags: {
            A: 'Test string',
          },
          poolerCount: 42,
          poolerScalingType: 'Test string',
        },
        createTime: 'Test string',
        ...
        pscInstanceConfig: {
          ...
          pscAutoConnectionPolicyState: 'Test string',
          pscAutoConnections: [
            {
              ...
              dnsAutomationInfos: [
                {
                  fullyQualifiedDomainName: 'Test string',
                  state: 'Test string',
                },
              ],
              ipAddress: 'Test string',
              serviceConnectionPolicy: 'Test string',
              serviceConnectionPolicyCreationState: 'Test string',
              status: 'Test string',
            },
          ],
          pscAutoDnsState: 'Test string',
        ...
        pscInstanceInfo: {
          effectivePscAutoConnectionPolicy: true,
          effectivePscAutoDnsEnabled: true,
          pscAutoDnsNames: ['Test string'],
          serviceConnectionPolicy: 'Test string',
        },
    ...
    await gapi.client.alloydb.projects.locations.endpoints.create(
      {
      ...
      },
      {
        ...
        dnsConfig: {
          dnsName: 'Test string',
          dnsRecordType: 'Test string',
        },
        effectiveTargetInstances: ['Test string'],
        endpointType: 'Test string',
        etag: 'Test string',
        name: 'Test string',
        reconciling: true,
        state: 'Test string',
        targetInstances: ['Test string'],
        uid: 'Test string',
        updateTime: 'Test string',
      },
    );
    /** Deletes a single Endpoint. */
    await gapi.client.alloydb.projects.locations.endpoints.delete({
      etag: 'Test string',
      name: 'Test string',
      requestId: 'Test string',
      validateOnly: true,
    ...
    await gapi.client.alloydb.projects.locations.endpoints.get({
      name: 'Test string',
    });
    /** Lists Endpoints in a given project and location. */
    await gapi.client.alloydb.projects.locations.endpoints.list({
      filter: 'Test string',
      orderBy: 'Test string',
      pageSize: 42,
      pageToken: 'Test string',
    ...
    await gapi.client.alloydb.projects.locations.endpoints.patch(
      {
        allowMissing: true,
        name: 'Test string',
        requestId: 'Test string',
