...
declare namespace gapi.client {
    ...
    function load(urlOrObject: "https://recommender.googleapis.com/$discovery/rest?version=v1"): Promise<void>;
    ...
    namespace recommender {
        ...
        interface GoogleCloudRecommenderV1Operation {
             ...
             */
            pathValueMatchers?:
                { [P in string]: GoogleCloudRecommenderV1ValueMatcher };
        ...
        interface GoogleCloudRecommenderV1RecommenderConfig {
            /**
             * Allows clients to store small amounts of arbitrary data. Annotations must follow the Kubernetes syntax. The total size of all keys and values combined is limited to 256k. Key can
             * have 2 segments: prefix (optional) and name (required), separated by a slash (/). Prefix must be a DNS subdomain. Name must be 63 characters or less, begin and end with
             * alphanumerics, with dashes (-), underscores (_), dots (.), and alphanumerics between.
        ...
        interface InsightsResource {
            ...
            list(request?: {
                ...
                fields?:
                    string;
                /**
                 * Optional. Filter expression to restrict the insights returned. Supported filter fields: * `stateInfo.state` * `insightSubtype` * `severity` * `targetResources` Examples: *
                 * `stateInfo.state = ACTIVE OR stateInfo.state = DISMISSED` * `insightSubtype = PERMISSIONS_USAGE` * `severity = CRITICAL OR severity = HIGH` * `targetResources :
                 * //compute.googleapis.com/projects/1234/zones/us-central1-a/instances/instance-1` * `stateInfo.state = ACTIVE AND (severity = CRITICAL OR severity = HIGH)` The max allowed filter
                 * length is 500 characters. (These expressions are based on the filter language described at https://google.aip.dev/160)
                 */
                filter?:
                    string;
                /** API key. Your API key identifies your project and provides you with API access, quota, and reports. Required unless you provide an OAuth 2.0 token. */
        ...
        interface InsightTypesResource {
            ...
            getConfig(request?: {
                ...
                key?:
                    string;
                /**
                 * Required. Name of the InsightTypeConfig to get. Acceptable formats: * `projects/[PROJECT_NUMBER]/locations/[LOCATION]/insightTypes/[INSIGHT_TYPE_ID]/config` *
                 * `projects/[PROJECT_ID]/locations/[LOCATION]/insightTypes/[INSIGHT_TYPE_ID]/config` * `organizations/[ORGANIZATION_ID]/locations/[LOCATION]/insightTypes/[INSIGHT_TYPE_ID]/config`
            ...
            body: GoogleCloudRecommenderV1InsightTypeConfig): Request<GoogleCloudRecommenderV1InsightTypeConfig>;
            insights:
                InsightsResource;
        }
        interface RecommendationsResource {
            ...
            list(request?: {
                ...
                fields?:
                    string;
                /**
                 * Filter expression to restrict the recommendations returned. Supported filter fields: * `state_info.state` * `recommenderSubtype` * `priority` * `targetResources` Examples: *
                 * `stateInfo.state = ACTIVE OR stateInfo.state = DISMISSED` * `recommenderSubtype = REMOVE_ROLE OR recommenderSubtype = REPLACE_ROLE` * `priority = P1 OR priority = P2` *
                 * `targetResources : //compute.googleapis.com/projects/1234/zones/us-central1-a/instances/instance-1` * `stateInfo.state = ACTIVE AND (priority = P1 OR priority = P2)` The max
                 * allowed filter length is 500 characters. (These expressions are based on the filter language described at https://google.aip.dev/160)
                 */
                filter?:
                    string;
                /** API key. Your API key identifies your project and provides you with API access, quota, and reports. Required unless you provide an OAuth 2.0 token. */
            ...
            body: GoogleCloudRecommenderV1MarkRecommendationDismissedRequest): Request<GoogleCloudRecommenderV1Recommendation>;
            /**
        ...
        interface RecommendersResource {
            ...
            body: GoogleCloudRecommenderV1RecommenderConfig): Request<GoogleCloudRecommenderV1RecommenderConfig>;
            recommendations:
