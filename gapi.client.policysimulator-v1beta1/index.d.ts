...
declare namespace gapi.client {
    ...
    function load(urlOrObject: "https://policysimulator.googleapis.com/$discovery/rest?version=v1beta1"): Promise<void>;
    /** @deprecated Please load APIs with discovery documents. */
    function load(name: "policysimulator", version: "v1beta1"): Promise<void>;
    /** @deprecated Please load APIs with discovery documents. */
    ...
    namespace policysimulator {
        ...
        interface GoogleCloudPolicysimulatorV1beta1ReplayDiff {
            /**
             * A summary and comparison of the member's access under the current (baseline) policies and the proposed (simulated) policies for a single access tuple. The evaluation of the member's
        ...
        interface GoogleCloudPolicysimulatorV1beta1ReplayResult {
            ...
            /**
             * The difference between the member's access under the current (baseline) policies and the member's access under the proposed (simulated) policies. This field is only included for
             * access tuples that were successfully replayed and had different results under the current policies and the proposed policies.
             */
