...
// Generated from: https://iam.googleapis.com/$discovery/rest?version=v2
// Revision: 20230202

/// <reference types="gapi.client" />

declare namespace gapi.client {
    /** Load Identity and Access Management (IAM) API v2 */
    function load(urlOrObject: "https://iam.googleapis.com/$discovery/rest?version=v2"): Promise<void>;
    /** @deprecated Please load APIs with discovery documents. */
    function load(name: "iam", version: "v2"): Promise<void>;
    /** @deprecated Please load APIs with discovery documents. */
    function load(name: "iam", version: "v2", callback: () => any): void;
    ...
    namespace iam {
        ...
        interface PoliciesResource {
            ...
            body: GoogleIamV2Policy): Request<GoogleLongrunningOperation>;
            ...
            listPolicies(request?: {
                ...
                /** Legacy upload protocol for media (e.g. "media", "multipart"). */
                uploadType?: string;
            }): Request<GoogleIamV2ListPoliciesResponse>;
            /**
