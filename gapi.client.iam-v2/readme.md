# TypeScript typings for Identity and Access Management (IAM) API v2
...
{
  "compilerOptions": {
    "types": ["gapi", "gapi.auth2", "gapi.client", "gapi.client.iam-v2"]
  }
}
```
...
For provenance information see [Provenance section on NPM](https://www.npmjs.com/package/@maxim_mazurok/gapi.client.iam-v2#Provenance:~:text=none-,Provenance,-Built%20and%20signed)
