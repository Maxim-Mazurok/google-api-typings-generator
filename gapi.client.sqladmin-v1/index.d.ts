...
declare namespace gapi.client {
  ...
  namespace sql {
    ...
    interface BlueGreenDeployment {
      ...
      deploymentMappings?: SourceTargetPairedNode[];
    ...
    interface BlueGreenDeploymentInfo {
      ...
      state?: 'STATE_UNSPECIFIED' | 'PRE_SWITCHOVER' | 'POST_SWITCHOVER';
    ...
    interface DiskEncryptionConfiguration {
      ...
      cmekSourceLogEncryptionEnforced?: boolean;
    ...
    interface InstancesRestoreBackupRequest {
      ...
      ignoreMaintenanceVersion?: boolean;
    ...
    interface ListBlueGreenDeploymentsResponse {
    ...
    interface Operation {
      ...
      startWorkloadCaptureContext?: StartWorkloadCaptureContext;
      ...
      startWorkloadReplayContext?: StartWorkloadReplayContext;
      ...
      stopWorkloadCaptureContext?: StopWorkloadCaptureContext;
      ...
      stopWorkloadReplayContext?: StopWorkloadReplayContext;
    ...
    interface PointInTimeRestoreContext {
      ...
      targetInstanceClearSettingsFieldNames?: string[];
    ...
    interface SourceTargetPairedNode {
    ...
    interface StartWorkloadCaptureContext {
    ...
    interface StartWorkloadReplayContext {
    ...
    interface StopWorkloadCaptureContext {
      ...
      abortLiveReplay?: boolean;
    }
    interface StopWorkloadReplayContext {
      /** Required. The name of the Cloud SQL instance where the captured workload (SQL queries) is being executed, excluding the project ID (for example, `my-replay-instance`). The instance name must start with a lowercase letter and contain only lowercase letters, numbers, and hyphens. The combined length of `project-ID:instance-name` must be 98 characters or less. */
      replayInstance?: string;
    ...
    interface WorkloadCapture {
      ...
      workloadCaptureState?:
        'STATE_UNSPECIFIED' | 'RUNNING' | 'COMPLETED' | 'FAILED';
      /** Output only. The ID of the captured workload. */
      workloadId?: string;
    }
    interface WorkloadCapturesListResponse {
      /** This is always `sql#workloadCapturesList`. */
      kind?: string;
      /** List of captured workloads for the instance. */
      workloadCaptures?: WorkloadCapture[];
    }
    ...
    interface BlueGreenDeploymentsResource {
      ...
      get(request?: {
        ...
        view?: 'BLUE_GREEN_DEPLOYMENT_VIEW_UNSPECIFIED' | 'BASIC' | 'DETAILED';
      }): Request<BlueGreenDeployment>;
      ...
      list(request?: {
        ...
        /** Legacy upload protocol for media (e.g. "media", "multipart"). */
        uploadType?: string;
      }): Request<ListBlueGreenDeploymentsResponse>;
      ...
      switchover(request: {
        ...
        uploadType?: string;
        /** Request body */
        resource: SwitchoverBlueGreenDeploymentRequest;
      }): Request<Operation>;
      switchover(
        request: {
          /** V1 error format. */
        ...
        body: SwitchoverBlueGreenDeploymentRequest,
      ): Request<Operation>;
    }
    ...
    interface WorkloadCapturesResource {
      ...
      list(request?: {
        ...
        /** Legacy upload protocol for media (e.g. "media", "multipart"). */
        uploadType?: string;
      }): Request<WorkloadCapturesListResponse>;
      ...
      start(request: {
        ...
        uploadType?: string;
        /** Request body */
        resource: SqlWorkloadCapturesStartRequest;
      }): Request<Operation>;
      start(
        request: {
          /** V1 error format. */
        ...
        body: SqlWorkloadCapturesStartRequest,
      ): Request<Operation>;
      ...
      startReplay(request: {
        ...
        workloadId: string;
        /** Request body */
        resource: SqlWorkloadCapturesStartReplayRequest;
      }): Request<Operation>;
      startReplay(
        request: {
          /** V1 error format. */
        ...
        body: SqlWorkloadCapturesStartReplayRequest,
      ): Request<Operation>;
      ...
      stop(request: {
        ...
        uploadType?: string;
        /** Request body */
        resource: SqlWorkloadCapturesStopRequest;
      }): Request<Operation>;
      stop(
        request: {
          /** V1 error format. */
        ...
        body: SqlWorkloadCapturesStopRequest,
      ): Request<Operation>;
      ...
      stopReplay(request: {
        ...
        workloadId: string;
        /** Request body */
        resource: SqlWorkloadCapturesStopReplayRequest;
      }): Request<Operation>;
      stopReplay(
        request: {
          /** V1 error format. */
        ...
        body: SqlWorkloadCapturesStopReplayRequest,
      ): Request<Operation>;
    }
    ...
    const blueGreenDeployments: BlueGreenDeploymentsResource;
    ...
    const workloadCaptures: WorkloadCapturesResource;
  }
}
