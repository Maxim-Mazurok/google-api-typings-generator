            ...
            sqlExportOptions?:
                {
                    ...
                    mysqlExportOptions?:
                        {
                            /**
                             * Option to include SQL statement required to set up replication. If set to `1`, the dump file includes a CHANGE MASTER TO statement with the binary log coordinates,
                             * and --set-gtid-purged is set to ON. If set to `2`, the CHANGE MASTER TO statement is written as a SQL comment and has no effect. If set to any value other than `1`,
                    ...
                    schemaOnly?:
                        boolean;
                    /**
                     * Tables to export, or that were exported, from the specified database. If you specify tables, specify one and only one database. For PostgreSQL instances, you can specify
                     * only one table.
                     */
                    tables?:
                        string[];
            ...
            bakImportOptions?:
                {
                    ...
                    encryptionOptions?:
                        {
                            /**
                             * Path to the Certificate (.cer) in Cloud Storage, in the form `gs://bucketName/fileName`. The instance must have write permissions to the bucket and read access to
                             * the file.
                             */
                            certPath?:
                                string;
                            ...
                            pvkPassword?:
                                string;
                            /**
                             * Path to the Certificate Private Key (.pvk) in Cloud Storage, in the form `gs://bucketName/fileName`. The instance must have write permissions to the bucket and read
                             * access to the file.
                             */
                            pvkPath?:
                                string;
                    ...
                    noRecovery?:
                        boolean;
                    /**
                     * Whether or not the backup importing request will just bring database online without downloading Bak content only one of "no_recovery" and "recovery_only" can be true
                     * otherwise error will return. Applies only to Cloud SQL for SQL Server.
                     */
                    recoveryOnly?:
                        boolean;
