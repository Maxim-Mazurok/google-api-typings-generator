...
gapi.load('client', async () => {
  ...
  async function run() {
        ...
        instanceSettings: {
              ...
              pscAutoConnections: [
                {
                  ...
                  instanceAutoDnsStatus: 'Test string',
                  ipAddress: 'Test string',
                  serviceConnectionPolicy: 'Test string',
                  serviceConnectionPolicyCreationResult: 'Test string',
                  status: 'Test string',
                  writeEndpointAutoDnsStatus: 'Test string',
                },
              ],
          ...
          settings: {
            ...
            performanceCaptureConfig: {
              cpuUtilizationThresholdPercent: 42,
              enabled: true,
              historyListLengthThresholdCount: 42,
              memoryUsageThresholdPercent: 42,
              probeThreshold: 42,
              probingIntervalSeconds: 42,
              runningThreadsThreshold: 42,
              secondsBehindSourceThreshold: 42,
              semaphoreWaitThresholdCount: 42,
              transactionDurationThreshold: 42,
              transactionKillExcludedUserHosts: ['Test string'],
              transactionKillThresholdSeconds: 42,
              transactionKillType: 'Test string',
              transactionLockWaitThresholdCount: 42,
            },
    ...
    await gapi.client.sql.blueGreenDeployments.create(
      {
        blueGreenDeploymentId: 'Test string',
        parent: 'Test string',
      },
      {
        createTime: 'Test string',
        deploymentMappings: [
          {
            diffs: [
              {
                field: 'Test string',
                sourceValue: 'Test string',
                targetValue: 'Test string',
              },
            ],
            source: {
        ...
        state: 'Test string',
        switchoverTargetInstance: 'Test string',
      },
    );
    /** Deletes a blue-green deployment. */
    await gapi.client.sql.blueGreenDeployments.delete({
      deleteOldSource: true,
      name: 'Test string',
    });
    /** Retrieves a blue-green deployment resource under a given project and location. */
    await gapi.client.sql.blueGreenDeployments.get({
      name: 'Test string',
      view: 'Test string',
    });
    /** Lists blue-green deployments under a given project. */
    await gapi.client.sql.blueGreenDeployments.list({
      filter: 'Test string',
      orderBy: 'Test string',
      pageSize: 42,
      pageToken: 'Test string',
    ...
    await gapi.client.sql.blueGreenDeployments.switchover(
      {
        name: 'Test string',
      },
      {},
    ...
    await gapi.client.sql.instances.clone(
      ...
      },
      {
        cloneContext: {
          ...
          destinationNetwork: 'Test string',
    ...
    await gapi.client.sql.instances.patch(
      {
        ...
        location: 'Test string',
        project: 'Test string',
        reconcilePscNetworking: true,
        reconcilePscNetworkingForce: true,
      },
      {
        availableMaintenanceVersions: ['Test string'],
        backendType: 'Test string',
    ...
    await gapi.client.sql.instances.pointInTimeRestore(
      ...
      },
      {
        ...
        targetInstanceClearSettingsFieldNames: ['Test string'],
    ...
    await gapi.client.sql.users.update(
      {
        ...
        revokeExistingServerRoles: true,
        serverRoles: 'Test string',
      },
      {
        databaseRoles: ['Test string'],
    ...
    await gapi.client.sql.workloadCaptures.start(
      ...
      },
      {
        startWorkloadCaptureContext: {
          enableLiveReplay: true,
          replayInstance: 'Test string',
        },
      },
    );
