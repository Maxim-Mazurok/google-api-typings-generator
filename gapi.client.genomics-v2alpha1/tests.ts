/* This is stub file for gapi.client.genomics-v2alpha1 definition tests */
// IMPORTANT
...
gapi.load('client', async () => {
    ...
    await gapi.client.load('https://genomics.googleapis.com/$discovery/rest?version=v2alpha1');
    ...
    async function run() {
         ...
         */
        await gapi.client.genomics.projects.operations.cancel({
            name: "Test string",
        }, {
        });
        /**
         ...
         */
        await gapi.client.genomics.projects.operations.get({
            name: "Test string",
        });
        ...
        await gapi.client.genomics.projects.operations.list({
            filter: "Test string",
            name: "Test string",
            pageSize: 42,
        ...
        await gapi.client.genomics.projects.workers.checkIn({
            id: "Test string",
        }, {
            deadlineExpired: {
            },
