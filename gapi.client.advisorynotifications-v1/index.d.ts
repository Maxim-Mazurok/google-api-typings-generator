...
declare namespace gapi.client {
    ...
    namespace advisorynotifications {
        ...
        interface GoogleCloudAdvisorynotificationsV1Settings {
            /**
             * Required. Fingerprint for optimistic concurrency returned in Get requests. Must be provided for Update requests. If the value provided does not match the value known to the server,
             * ABORTED will be thrown, and the client should retry the read-modify-write cycle.
             */
            etag?:
                string;
        ...
        interface LocationsResource {
            ...
            body: GoogleCloudAdvisorynotificationsV1Settings): Request<GoogleCloudAdvisorynotificationsV1Settings>;
            notifications:
