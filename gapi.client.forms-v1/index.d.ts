...
// Project: https://developers.google.com/workspace/forms/api
...
declare namespace gapi.client {
  ...
  namespace forms {
    ...
    interface SetPublishSettingsRequest {
    ...
    interface FormsResource {
      ...
      setPublishSettings(request: {
        ...
        uploadType?: string;
        /** Request body */
        resource: SetPublishSettingsRequest;
      }): client.Request<SetPublishSettingsResponse>;
      setPublishSettings(
        request: {
          /** V1 error format. */
          '$.xgafv'?: string;
