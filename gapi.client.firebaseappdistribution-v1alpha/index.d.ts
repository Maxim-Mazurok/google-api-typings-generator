...
declare namespace gapi.client {
  ...
  namespace firebaseappdistribution {
    ...
    interface GoogleFirebaseAppdistroV1alphaDeviceExecution {
      ...
      /** Identifier. The name of the device execution resource. Format: `projects/{project_number}/apps/{app_id}/releases/{release_id}/tests/{test_id}/deviceExecutions/{device_execution}` */
      name?: string;
