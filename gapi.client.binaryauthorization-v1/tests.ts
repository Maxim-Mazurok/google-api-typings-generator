/* This is stub file for gapi.client.binaryauthorization-v1 definition tests */
// IMPORTANT
...
gapi.load('client', async () => {
    ...
    async function run() {
        ...
        /**
         * Creates a platform policy, and returns a copy of it. Returns NOT_FOUND if the project or platform doesn't exist, INVALID_ARGUMENT if the request is malformed, ALREADY_EXISTS if the
         * policy already exists, and INVALID_ARGUMENT if the policy contains a platform-specific policy that does not match the platform value specified in the URL.
         */
