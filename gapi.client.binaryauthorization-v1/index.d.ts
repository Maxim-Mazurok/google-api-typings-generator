...
declare namespace gapi.client {
  ...
  namespace binaryauthorization {
    ...
    interface SigstorePublicKey {
      /** The public key material in PEM format. */
      publicKeyPem?: string;
    }
    interface SigstorePublicKeySet {
      /** Required. `public_keys` must have at least one entry. */
      publicKeys?: SigstorePublicKey[];
    }
    interface SigstoreSignatureCheck {
    ...
    interface PoliciesResource {
      ...
      evaluate(request: {
        ...
        uploadType?: string;
        /** Request body */
        resource: EvaluateGkePolicyRequest;
