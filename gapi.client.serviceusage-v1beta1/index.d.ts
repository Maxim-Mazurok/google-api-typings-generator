...
declare namespace gapi.client {
  ...
  namespace serviceusage {
    ...
    interface ContentSecurity {
      ...
      contentSecurityProviders?: ContentSecurityProvider[];
    }
    ...
    interface ContentSecurityProvider {
    ...
    interface GoogleApiServiceusageV2alphaConsumerPolicy {
      ...
      enableRules?: GoogleApiServiceusageV2alphaEnableRule[];
    ...
    interface GoogleApiServiceusageV2betaAnalysisResult {
      /** Blocking information that would prevent the policy changes at runtime. */
      blockers?: GoogleApiServiceusageV2betaImpact[];
      /** Warning information indicating that the policy changes might be unsafe, but will not block the changes at runtime. */
      warnings?: GoogleApiServiceusageV2betaImpact[];
    }
    interface GoogleApiServiceusageV2betaAnalyzeConsumerPolicyMetadata {}
    interface GoogleApiServiceusageV2betaAnalyzeConsumerPolicyResponse {
      /** The list of analyses returned from performing the intended policy update analysis. The analysis is grouped by service name and different analysis types. The empty analysis list means that the consumer policy can be updated without any warnings or blockers. */
      analysis?: GoogleApiServiceusageV2betaAnalysis[];
    }
    interface GoogleApiServiceusageV2betaConsumerPolicy {
      /** Output only. The time the policy was created. For singleton policies, this is the first touch of the policy. */
      createTime?: string;
      /** Enable rules define usable services, groups, and categories. There can currently be at most one `EnableRule`. This restriction will be lifted in later releases. */
      enableRules?: GoogleApiServiceusageV2betaEnableRule[];
      /** An opaque tag indicating the current version of the policy, used for concurrency control. */
      etag?: string;
      /** Output only. The resource name of the policy. Only the `default` policy is supported: `projects/12345/consumerPolicies/default`, `folders/12345/consumerPolicies/default`, `organizations/12345/consumerPolicies/default`. */
      name?: string;
    ...
    interface GoogleApiServiceusageV2betaEnableRule {
      /** The names of the services that are enabled. Example: `services/storage.googleapis.com`. */
      services?: string[];
    }
    interface GoogleApiServiceusageV2betaImpact {
      /** Output only. User friendly impact detail in a free form message. */
      detail?: string;
      /** Output only. The type of impact. */
      impactType?:
    ...
    interface GoogleApiServiceusageV2betaMcpEnableRule {
      /** List of enabled MCP services. */
      mcpServices?: GoogleApiServiceusageV2betaMcpService[];
    }
    interface GoogleApiServiceusageV2betaMcpPolicy {
      ...
      mcpEnableRules?: GoogleApiServiceusageV2betaMcpEnableRule[];
    ...
    interface GoogleApiServiceusageV2betaMcpService {
      /** The names of the services that are enabled for MCP. Example: `services/library-example.googleapis.com` */
      service?: string;
    }
    interface GoogleApiServiceusageV2betaUpdateConsumerPolicyMetadata {}
    interface GoogleApiServiceusageV2betaUpdateMcpPolicyMetadata {}
    ...
    interface MetricRule {
      ...
      agenticMetricCosts?: {[P in string]: string};
      ...
      nonagenticMetricCosts?: {[P in string]: string};
      /** Selects the methods to which this rule applies. Refer to selector for syntax details. */
      selector?: string;
    }
    interface Mixin {
