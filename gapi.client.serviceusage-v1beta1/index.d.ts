...
declare namespace gapi.client {
    ...
    namespace serviceusage {
        ...
        interface OAuthRequirements {
            /**
             * UNIMPLEMENTED: If enabled, ESF will allow OAuth credentials with any scope, more details in http://go/esf-oauth-any-scope. WARNING: Enabling this option will bring security risks.
             * Customers enabling this feature accidentally may have the risk of losing authentication enforcement. Please reach out to api-auth@ and esf-team@ for approval and allowlisting before
