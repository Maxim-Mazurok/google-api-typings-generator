...
declare namespace gapi.client {
    ...
    namespace dialogflow {
        ...
        interface GoogleCloudDialogflowCxV3TextToSpeechSettings {
             ...
             * affect: - The synthesize configuration used in [phone gateway](https://cloud.google.com/dialogflow/cx/docs/concept/integration/phone-gateway). - You no longer need to specify
             * OutputAudioConfig.synthesize_speech_config when invoking API calls. Your agent will use the pre-configured options for speech synthesizing.
             */
