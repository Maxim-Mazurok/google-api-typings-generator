...
declare namespace gapi.client {
    ...
    namespace dialogflow {
        ...
        interface GoogleCloudDialogflowCxV3SecuritySettings {
             ...
             * than Dialogflow's default 365d TTL (time to live). Setting a value higher than that has no effect. A missing value or setting to 0 also means we use Dialogflow's default TTL.
             */
