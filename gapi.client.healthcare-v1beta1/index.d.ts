...
declare namespace gapi.client {
    ...
    namespace healthcare {
        ...
        interface RollbackFhirResourceFilteringFields {
            /**
             * Optional. A string to use for filtering resource metadata. Complies with AIP-160 except without the has operator. Additionally, supports 2 functions: hastag("system") = "code" for
             * tag filtering and extension_ts_value("uri") = timestamp for filtering extensions with timestamp, which is given as a unix timestamp. extension_ts_url can be used with >, <, <=, >=,
             * != comparisons as well.
             */
            metadataFilter?:
                string;
        ...
        interface SeriesResource {
             ...
             * DeleteSeries, see [Deleting a study, series, or instance](https://cloud.google.com/healthcare/docs/how-tos/dicomweb#deleting_a_study_series_or_instance).
             */
            delete(request?: {
                /** V1 error format. */
                "$.xgafv"?:
