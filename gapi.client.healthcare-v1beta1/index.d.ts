...
declare namespace gapi.client {
    ...
    namespace healthcare {
        ...
        interface DeidentifyConfig {
             ...
             * `LOCATION` or `ORGANIZATION_NAME` infoTypes. If the deprecated [`DicomConfig`](google.cloud.healthcare.v1beta1.deidentify.DeidentifyConfig.dicom_config) or
             * [`FhirConfig`](google.cloud.healthcare.v1beta1.deidentify.DeidentifyConfig.fhir_config) are used, then `LOCATION` must be excluded within `TextConfig`, and must also be excluded
        ...
        interface DicomStore {
            ...
            notificationConfig?:
                NotificationConfig;
            /**
             * A list of streaming configs used to configure the destination of streaming exports for every DICOM instance insertion in this DICOM store. After a new config is added to
