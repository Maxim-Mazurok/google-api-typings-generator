...
declare namespace gapi.client {
  ...
  function load(
    urlOrObject: 'https://healthcare.googleapis.com/$discovery/rest?version=v1beta1',
  ): Promise<void>;
  ...
  namespace healthcare {
    ...
    interface ExportResourcesHistoryRequest {
    ...
    interface GoogleCloudHealthcareV1beta1DicomChangeDataCaptureConfig {}
    ...
    interface GoogleCloudHealthcareV1beta1FhirChangeDataCaptureConfig {
    ...
    interface ImportResourcesHistoryRequest {
    ...
    interface FhirStoresResource {
      ...
      exportHistory(request: {
        ...
        uploadType?: string;
        /** Request body */
        resource: ExportResourcesHistoryRequest;
      }): Request<Operation>;
      exportHistory(
        request: {
          /** V1 error format. */
      ...
      importHistory(request: {
        ...
        uploadType?: string;
        /** Request body */
        resource: ImportResourcesHistoryRequest;
      }): Request<Operation>;
      importHistory(
        request: {
          /** V1 error format. */
