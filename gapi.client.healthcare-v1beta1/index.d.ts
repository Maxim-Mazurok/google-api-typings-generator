...
declare namespace gapi.client {
    ...
    namespace healthcare {
        ...
        interface DeidentifyConfig {
             ...
             * `LOCATION` or `ORGANIZATION_NAME` infoTypes. If the deprecated `DicomConfig` or `FhirConfig` are used, then `LOCATION` must be excluded within `TextConfig`, and must also be
        ...
        interface FhirOutput {
             ...
             * must set `enable_update_create` to true. The destination store must use FHIR version R4. Writing these resources will consume FHIR operations quota from the project containing the
