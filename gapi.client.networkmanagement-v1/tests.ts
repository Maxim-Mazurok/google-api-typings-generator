...
gapi.load('client', async () => {
  ...
  async function run() {
    ...
    await gapi.client.networkmanagement.organizations.locations.operations.cancel(
      {
        name: 'Test string',
      },
      {},
    ...
    await gapi.client.networkmanagement.organizations.locations.operations.delete(
      {
        name: 'Test string',
      },
    );
    /** Gets the latest state of a long-running operation. Clients can use this method to poll the operation result at intervals as recommended by the API service. */
    await gapi.client.networkmanagement.organizations.locations.operations.get({
      name: 'Test string',
    });
    /** Lists operations that match the specified filter in the request. If the server doesn't support this method, it returns `UNIMPLEMENTED`. */
    await gapi.client.networkmanagement.organizations.locations.operations.list(
      {
        filter: 'Test string',
        name: 'Test string',
        pageSize: 42,
