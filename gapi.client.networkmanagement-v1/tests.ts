...
gapi.load('client', async () => {
  ...
  async function run() {
    ...
    await gapi.client.networkmanagement.projects.locations.global.connectivityTests.create(
      ...
      },
      {
        ...
        destination: {
          ...
          cloudRunJob: 'Test string',
          cloudRunRevision: {
            serviceUri: 'Test string',
            uri: 'Test string',
            workerPoolUri: 'Test string',
          },
          cloudSqlInstance: 'Test string',
          dmsPrivateConnection: 'Test string',
              ...
              steps: [
                {
                  ...
                  forwardingRule: {
                    displayName: 'Test string',
                    envoyHealthCheckFirewallsConfigState: 'Test string',
                  ...
                  ngfwPacketInspection: {
                    securityProfileGroupUri: 'Test string',
                  },
                  projectId: 'Test string',
                  proxyConnection: {
                    networkUri: 'Test string',
    ...
    await gapi.client.networkmanagement.projects.locations.networkMonitoringProviders.create(
      {
        networkMonitoringProviderId: 'Test string',
        parent: 'Test string',
      },
      {
        createTime: 'Test string',
        ...
        providerUri: 'Test string',
        state: 'Test string',
        updateTime: 'Test string',
      },
    );
    /** Deletes a NetworkMonitoringProvider resource and all of its child resources. */
    await gapi.client.networkmanagement.projects.locations.networkMonitoringProviders.delete(
      {
        force: true,
        name: 'Test string',
      },
    ...
    await gapi.client.networkmanagement.projects.locations.networkMonitoringProviders.generateMonitoringPointConfig(
      {
        name: 'Test string',
    ...
    await gapi.client.networkmanagement.projects.locations.networkMonitoringProviders.generateProviderAccessToken(
      {
        gcpAccessToken: 'Test string',
        name: 'Test string',
      },
    );
    /** Gets the NetworkMonitoringProvider resource. */
    await gapi.client.networkmanagement.projects.locations.networkMonitoringProviders.get(
      {
        name: 'Test string',
      },
    );
    /** Lists NetworkMonitoringProviders for a given project and location. */
    await gapi.client.networkmanagement.projects.locations.networkMonitoringProviders.list(
      {
        pageSize: 42,
        pageToken: 'Test string',
        parent: 'Test string',
    ...
    await gapi.client.networkmanagement.projects.locations.networkMonitoringProviders.monitoringPoints.downloadInstallScript(
      {
        _password: 'Test string',
        hostname: 'Test string',
        monitoringPointType: 'Test string',
        ntpServerAddress: 'Test string',
        ntpServerSecondaryAddress: 'Test string',
        parent: 'Test string',
        privateConnectivityEnabled: true,
        'staticIpAddress.dnsServerAddress': 'Test string',
        'staticIpAddress.dnsServerSecondaryAddress': 'Test string',
        'staticIpAddress.domain': 'Test string',
        'staticIpAddress.gatewayAddress': 'Test string',
        'staticIpAddress.ipAddress': 'Test string',
        'staticIpAddress.netmask': 'Test string',
        'timeZone.id': 'Test string',
        'timeZone.version': 'Test string',
        useDhcp: true,
      },
    );
    /** Downloads an install script for a specific Container MonitoringPoint. */
    await gapi.client.networkmanagement.projects.locations.networkMonitoringProviders.monitoringPoints.downloadRecreateInstallScript(
      {
        hostname: 'Test string',
        name: 'Test string',
      },
    ...
    await gapi.client.networkmanagement.projects.locations.networkMonitoringProviders.monitoringPoints.downloadServerConnectConfig(
      {
        parent: 'Test string',
      },
    );
    /** Gets the MonitoringPoint resource. */
    await gapi.client.networkmanagement.projects.locations.networkMonitoringProviders.monitoringPoints.get(
      {
        name: 'Test string',
      },
    );
    /** Lists MonitoringPoints for a given network monitoring provider. */
    await gapi.client.networkmanagement.projects.locations.networkMonitoringProviders.monitoringPoints.list(
      {
        pageSize: 42,
        pageToken: 'Test string',
        parent: 'Test string',
    ...
    await gapi.client.networkmanagement.projects.locations.networkMonitoringProviders.networkPaths.get(
      {
        name: 'Test string',
      },
    );
    /** Lists NetworkPaths for a given network monitoring provider. */
    await gapi.client.networkmanagement.projects.locations.networkMonitoringProviders.networkPaths.list(
      {
        pageSize: 42,
        pageToken: 'Test string',
        parent: 'Test string',
    ...
    await gapi.client.networkmanagement.projects.locations.networkMonitoringProviders.webPaths.get(
      {
        name: 'Test string',
      },
    );
    /** Lists WebPaths for a given network monitoring provider. */
    await gapi.client.networkmanagement.projects.locations.networkMonitoringProviders.webPaths.list(
      {
        pageSize: 42,
        pageToken: 'Test string',
        parent: 'Test string',
