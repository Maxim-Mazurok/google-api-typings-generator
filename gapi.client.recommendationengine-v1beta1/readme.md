...
```typescript
gapi.client.load('https://recommendationengine.googleapis.com/$discovery/rest?version=v1beta1', () => {
  // now we can use:
...
After that you can use Recommendations AI (Beta) resources: <!-- TODO: make this work for multiple namespaces -->
