/* This is stub file for gapi.client.agentidentitycredentials-v1alpha definition tests */
// IMPORTANT
...
gapi.load('client', async () => {
  ...
  async function run() {
    ...
    await gapi.client.agentidentitycredentials.projects.locations.authProviders.credentials.exchange(
      {
        authProvider: 'Test string',
      },
      {
        scopes: ['Test string'],
        sourceCredential: 'Test string',
        targetTokenType: 'Test string',
        tokenBinding: {
