...
gapi.load('client', async () => {
  ...
  async function run() {
    ...
    await gapi.client.managedkafka.projects.locations.clusters.create(
      ...
      {
        bootstrapAddress: 'Test string',
        brokerCapacityConfig: {
          diskSizeGib: 'Test string',
        },
        brokerDetails: [
          {
        ...
        effectiveCapacityConfig: {
          brokerCount: 'Test string',
          brokerDiskSizeGib: 'Test string',
        },
        gcpConfig: {
          accessConfig: {
            networkConfigs: [
            ...
            publicClusterConfig: {
              allowedSourceIpRanges: ['Test string'],
            },
          },
          kmsKey: 'Test string',
        },
        ...
        publicClusterDetails: {
          discoveryDnsRecords: ['Test string'],
          externalIpAddresses: ['Test string'],
        },
        rebalanceConfig: {
          mode: 'Test string',
        },
