...
declare namespace gapi.client {
  ...
  namespace managedkafka {
    ...
    interface BrokerCapacityConfig {
    ...
    interface EffectiveCapacityConfig {
    ...
    interface PublicClusterDetails {
    ...
    interface SchemaMode {
      ...
      mode?: 'NONE' | 'READONLY' | 'READWRITE' | 'IMPORT';
    }
