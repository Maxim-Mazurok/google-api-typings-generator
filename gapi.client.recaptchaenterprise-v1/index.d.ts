...
declare namespace gapi.client {
    ...
    namespace recaptchaenterprise {
        ...
        interface GoogleCloudRecaptchaenterpriseV1AppleDeveloperId {
            ...
            keyId?:
                string;
            /** Required. Input only. A private key (downloaded as a text file with a .p8 file extension) generated for your Apple Developer account. */
            privateKey?:
                string;
        ...
        interface GoogleCloudRecaptchaenterpriseV1IOSKeySettings {
            ...
            allowedBundleIds?:
                string[];
            /**
             * Apple Developer account details for the app the reCAPTCHA key will protect. reCAPTCHA Enterprise leverages platform specific checks like Apple AppAttest and Apple DeviceCheck to
             * protect your app from abuse. Providing these fields allows reCAPTCHA Enterprise to get a better assessment of the integrity of your app.
             */
            appleDeveloperId?:
        ...
        interface GoogleCloudRecaptchaenterpriseV1SearchRelatedAccountGroupMembershipsRequest {
            /**
             * Optional. The unique stable hashed user identifier we should search connections to. The identifier should correspond to a `hashed_account_id` provided in a previous
