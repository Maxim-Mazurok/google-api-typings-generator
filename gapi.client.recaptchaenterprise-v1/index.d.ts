    ...
    namespace recaptchaenterprise {
        ...
        interface GoogleCloudRecaptchaenterpriseV1IOSKeySettings {
            ...
            allowedBundleIds?:
                string[];
            /**
             * Apple Developer account details for the app that is protected by the reCAPTCHA Key. reCAPTCHA Enterprise leverages platform specific checks like Apple AppAttest and Apple
