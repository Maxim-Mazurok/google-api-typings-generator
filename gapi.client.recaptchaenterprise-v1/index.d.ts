...
declare namespace gapi.client {
  ...
  namespace recaptchaenterprise {
    ...
    interface GoogleCloudRecaptchaenterpriseV1AccountDefenderAssessmentAccountTakeoverVerdict {
      ...
      riskReasons?: GoogleCloudRecaptchaenterpriseV1AccountDefenderAssessmentAccountRiskReason[];
      ...
      trustReasons?: GoogleCloudRecaptchaenterpriseV1AccountDefenderAssessmentAccountTrustReason[];
    }
    ...
    interface GoogleCloudRecaptchaenterpriseV1AddIpOverrideRequest {
      /** Required. IP override added to the key. */
      ipOverrideData?: GoogleCloudRecaptchaenterpriseV1IpOverrideData;
    }
    interface GoogleCloudRecaptchaenterpriseV1AddIpOverrideResponse {}
    ...
    interface GoogleCloudRecaptchaenterpriseV1ChallengeRule {
    ...
    interface GoogleCloudRecaptchaenterpriseV1ChallengeRuleChallengeOutcome {
    ...
    interface GoogleCloudRecaptchaenterpriseV1ChallengeRuleEvaluation {}
    interface GoogleCloudRecaptchaenterpriseV1ChallengeRuleGroup {
      ...
      challengeRules?: GoogleCloudRecaptchaenterpriseV1ChallengeRule[];
    }
    interface GoogleCloudRecaptchaenterpriseV1ChallengeRuleNoChallengeOutcome {}
    interface GoogleCloudRecaptchaenterpriseV1ClientSettings {
    ...
    interface GoogleCloudRecaptchaenterpriseV1ExpressKeySettings {}
    ...
    interface GoogleCloudRecaptchaenterpriseV1FraudPreventionAssessment {
      ...
      riskReasons?: GoogleCloudRecaptchaenterpriseV1FraudPreventionAssessmentRiskReason[];
    ...
    interface GoogleCloudRecaptchaenterpriseV1IpOverrideData {
    ...
    interface GoogleCloudRecaptchaenterpriseV1ListIpOverridesResponse {
      ...
      ipOverrides?: GoogleCloudRecaptchaenterpriseV1IpOverrideData[];
    ...
    interface GoogleCloudRecaptchaenterpriseV1PhoneFraudAssessment {
    ...
    interface GoogleCloudRecaptchaenterpriseV1Policy {
      ...
      challengeRuleGroups?: GoogleCloudRecaptchaenterpriseV1ChallengeRuleGroup[];
    ...
    interface GoogleCloudRecaptchaenterpriseV1PolicyEvaluation {
    ...
    interface GoogleCloudRecaptchaenterpriseV1ProtectedEndpoint {
    ...
    interface GoogleCloudRecaptchaenterpriseV1ProtectedEndpointGroup {
      ...
      protectedEndpoints?: GoogleCloudRecaptchaenterpriseV1ProtectedEndpoint[];
    }
    ...
    interface GoogleCloudRecaptchaenterpriseV1RemoveIpOverrideRequest {
      /** Required. IP override to be removed from the key. */
      ipOverrideData?: GoogleCloudRecaptchaenterpriseV1IpOverrideData;
    }
    interface GoogleCloudRecaptchaenterpriseV1RemoveIpOverrideResponse {}
    ...
    interface GoogleCloudRecaptchaenterpriseV1RiskAnalysis {
      ...
      verifiedBots?: GoogleCloudRecaptchaenterpriseV1Bot[];
    }
    ...
    interface GoogleCloudRecaptchaenterpriseV1UniversalKeySettings {}
    ...
    interface KeysResource {
      ...
      addIpOverride(request: {
        ...
        uploadType?: string;
        /** Request body */
        resource: GoogleCloudRecaptchaenterpriseV1AddIpOverrideRequest;
      }): Request<{}>;
      addIpOverride(
        request: {
          /** V1 error format. */
      ...
      getPolicy(request?: {
        ...
        /** Legacy upload protocol for media (e.g. "media", "multipart"). */
        uploadType?: string;
      }): Request<GoogleCloudRecaptchaenterpriseV1Policy>;
      ...
      listIpOverrides(request?: {
        ...
        /** Legacy upload protocol for media (e.g. "media", "multipart"). */
        uploadType?: string;
      }): Request<GoogleCloudRecaptchaenterpriseV1ListIpOverridesResponse>;
      ...
      removeIpOverride(request: {
        ...
        uploadType?: string;
        /** Request body */
        resource: GoogleCloudRecaptchaenterpriseV1RemoveIpOverrideRequest;
      }): Request<{}>;
      removeIpOverride(
        request: {
          /** V1 error format. */
      ...
      updatePolicy(request: {
        ...
        uploadType?: string;
        /** Request body */
        resource: GoogleCloudRecaptchaenterpriseV1Policy;
      }): Request<GoogleCloudRecaptchaenterpriseV1Policy>;
      updatePolicy(
        request: {
          /** V1 error format. */
