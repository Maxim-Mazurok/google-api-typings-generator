...
gapi.load('client', async () => {
  ...
  async function run() {
    ...
    await gapi.client.recaptchaenterprise.projects.keys.getPolicy({
      name: 'Test string',
    });
    ...
    await gapi.client.recaptchaenterprise.projects.keys.listIpOverrides({
      pageSize: 42,
      pageToken: 'Test string',
      parent: 'Test string',
    });
    ...
    await gapi.client.recaptchaenterprise.projects.keys.updatePolicy(
      {
        name: 'Test string',
        updateMask: 'Test string',
      },
